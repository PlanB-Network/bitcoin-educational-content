...
- **Wiadomości plotkarskie**: Są one używane do wykrywania i aktualizowania topologii sieci.
...
- **Blitz Wallet**: Open-source, self-custody, wymaga płynność zarządzaną przez użytkownika, oferuje obszerne informacje dla zaawansowanych użytkowników.
