...
Parameters configurable in `bitcoin.conf` include: the mempool size, network connection restrictions, minimum transaction relay fees, and various security and performance options.