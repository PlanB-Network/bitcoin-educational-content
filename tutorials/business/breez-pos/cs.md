---
name: Breez - POS
description: Společnost Breez usnadňuje výběr plateb Bitcoin pro vaši firmu.
---
...
Od pandemie COVID-19 se bezkontaktní digitální platby rozšířily i v těch nejmenších obchodech. Během tohoto období mnoho podniků objevilo praktičnost hotovostních řešení Bitcoin, která jim umožňují přijímat platby z celého světa. Tato řešení jsou však někdy obtížně použitelná nebo nevhodná pro malé podniky. V tomto návodu se podíváme na platební terminál Breez, řešení, které vyniká snadným používáním a zároveň poskytuje úplnou kontrolu nad správou bitcoinů.
...
Různé možnosti zařízení Breez Wallet si můžete prohlédnout podle našeho níže uvedeného návodu. Tento krok vám pomůže lépe porozumět ekosystému prodejních míst a osvojit si osvědčené postupy pro efektivní zabezpečení bitcoinů spojených s vaším seed.
...
V nabídce "*Místo prodeje*" najdete položku Interface pro výběr plateb. Je rozdělena na dvě části:
...
První částí je klávesnice pro přímé inkaso. Tento Interface je vhodný pro výběr jednorázové platby, pokud znáte celkový objem nákupů svých zákazníků nebo pokud ve svém podnikání nepotřebujete pevný katalog produktů (např. služby na volné noze).
...
Druhou částí je katalog produktů. Tento Interface je ideální, pokud máte katalog produktů s předem definovanými cenami. Zde si můžete předem nastavit produkty a následně je použít do faktur generate, abyste zlepšili sledovatelnost vašich pokladních dokladů.
...
Každou položku z tohoto okna Interface můžete ručně nakonfigurovat kliknutím na tlačítko "**Plus**" a následným zadáním názvu, ceny a identifikátoru této položky.
...
Ve stejné sekci můžete definovat dobu platnosti faktur Lightning. Od této chvíle mají vaši zákazníci u všech vašich faktur `N` sekund na provedení platby, pokud tak neučiní, budete muset vygenerovat nový Lightning Invoice.
