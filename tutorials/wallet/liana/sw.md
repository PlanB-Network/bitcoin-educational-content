---
name: Liana
description: Kuweka na kutumia Wallet kwenye Liana
---
...
- Angalau njia moja ya kurejesha, ambayo inapatikana baada ya muda fulani.


Mchoro hapa chini unaonyesha utendakazi wa Wallet na njia mbili za matumizi:
...
- Barua ya urithi, iliyo na maagizo ya kurejesha fedha;
- Mfuko uliotiwa nambari, ili kuhakikisha kuwa kifaa cha kurejesha (Jade) hakijatumiwa.


## Ufungaji na usanidi


Tembelea tovuti rasmi ya Wizardsardine na upakue Liana katika https://wizardsardine.com/Liana/. Unaweza pia kupakua toleo jipya zaidi [kutoka hazina ya GitHub](https://github.com/wizardsardine/Liana/releases), ambapo unaweza kuangalia uhalisi wa programu. Toleo lililotumika katika somo hili ni 0.9.
...
Chagua aina yako ya Wallet. Iwapo ungependa kusanidi hifadhi rudufu iliyoimarishwa kwa muda wa urejeshaji, unaweza kuchagua chaguo la "*Unda yako mwenyewe*" na uchague mpango chaguomsingi. Hii itafanya kazi kwa njia sawa, isipokuwa kwamba hutahitaji kuhifadhi maneno ya kurejesha ya Hardware Wallet.


Tunapuuza hapa kesi ya *Kupanua Multisig*, ambayo inaweka usanidi changamano zaidi.


Kwa madhumuni ya somo hili, tutakuwa tukitumia urithi rahisi.


![Choisir type de portefeuille](assets/fr/04.webp)


Ufafanuzi wa haraka unafuata.


![Rapide explication](assets/fr/05.webp)


Mara tu unaposoma maelezo, utaweza kusanidi funguo za Liana Wallet yako. Hii ni hatua muhimu, kwani huamua sifa za matumizi ya akaunti yako.
...
Kisha, sanidi ufunguo wako msingi (*ufunguo msingi*). Ufunguo huu (au tuseme, seti hii ya funguo) itatumika kwa matumizi ya sasa ya fedha, ambayo si chini ya masharti yoyote ya muda. Kwa kubofya "*Weka*", unaweza kuchagua *kifaa cha kusaini* kinacholingana. Kwa upande wetu, tumechagua Ledger Nano S Plus Hardware Wallet.


Idhinisha ushiriki wa ufunguo wa umma uliopanuliwa kutoka kwa kifaa. Ipe ufunguo huu jina la maana (katika kesi hii, "Nano S+"). Kumbuka kwamba programu zote zilizosakinishwa kwenye kifaa zitaendelea kufanya kazi kwa kawaida.
...
Hatimaye, weka ufunguo wa mali isiyohamishika. Ufunguo huu (au tuseme, seti ya funguo) itatumika kurejesha fedha katika tukio la kutoweka kwako. Bofya kwenye "*Weka*", chagua kifaa cha kutia sahihi na uthibitishe kushiriki kwa ufunguo uliopanuliwa wa umma juu yake.


Kwa somo hili, tumechagua Jade. Toa ufunguo jina la kusisimua (hapa "Jade"). Kama ilivyo kwa kifaa cha kwanza, akaunti za kawaida zitaendelea kufanya kazi.


![Configurer clé de succession](assets/fr/10.webp)


Mara tu vitendo hivi vyote vimekamilishwa, hakikisha kuwa kila kitu kiko sawa na ubofye "*Endelea*" ili kuthibitisha chaguo zako.
...
Kifafanuzi chetu (ambacho kimechanganuliwa mwishoni mwa somo) ni kama ifuatavyo:
...
Fanya vivyo hivyo kwa kila kifaa kinachotia sahihi. Utahitaji kuangalia na kuthibitisha kuwa kifafanuzi kimeongezwa kwa kila Hardware Wallet.
...
- Cable ya USB ya kuunganisha na kurejesha kifaa;
- Nakala ya karatasi ya sentensi katika tukio la kutofanya kazi vizuri au uharibifu wa kifaa (kumbuka kuwa kati inaweza pia kuwa chuma, na kwa hivyo kulindwa kutoka kwa Elements, kama ilivyo kwa vidonge vya Cryptosteel, kwa mfano);
- Kitufe cha USB kilicho na kifafanuzi cha Wallet;
- Hifadhi rudufu ya karatasi ya kifafanuzi, ikitokea hitilafu au uharibifu wa ufunguo wa USB (chelezo hiki hakijapigwa picha hapa);
- Barua ya urithi inayoelezea hatua zinazopaswa kuchukuliwa ili kurejesha fedha hizo.


![Éléments de récupération](assets/fr/18.webp)


Na tunaweka vitu hivi chini ya Seal!
...
Skrini kuu ya Liana huonyesha salio lako na miamala (ya zamani na ya sasa) iliyounganishwa kwenye Wallet yako. Kwa upande wetu, usawa ni sifuri, ambayo ni ya kawaida.
...
Unahitaji kuthibitisha Address hii kwenye Hardware Wallet yako kwa kubofya "*Thibitisha kwenye kifaa cha maunzi*".
...
Unaweza kuangalia hali ya mwisho wa matumizi ya pesa zako kwa kwenda kwenye kichupo cha "*Sarafu*". Kichupo hiki kinakuonyesha sarafu tofauti (UTXO) kwenye Wallet yako. Hapa, tunaweza kuona kwamba sarafu ya satoshi 50,000 iliyoundwa na muamala wetu inaisha muda siku hiyo hiyo (saa moja).
...
Liana pia inatoa "udhibiti wa sarafu": unaonyesha ni sarafu gani (UTXO) ungependa kutumia. Hapa, tumechagua sarafu ya satoshi 50,000 iliyoundwa hapo awali.


![Envoyer fonds clé principale](assets/fr/25.webp)


Kisha utie sahihi muamala ukitumia sahihi kifaa chako kilichounganishwa na ufunguo mkuu kwa kubofya "*Saini*". Utahitaji kuthibitisha na kuthibitisha muamala kwenye Hardware Wallet yako. Hapa, tumetumia Nano S Plus kusaini muamala.


![Signer transaction clé principale](assets/fr/26.webp)


Hatimaye, tangaza muamala kwenye mtandao kwa kubofya "*Tangaza*". Kumbuka kuwa kutuma pesa kutaweka upya muda wa kurejesha pesa zilizotumika.


![Diffuser transaction clé principale](assets/fr/27.webp)


Muamala utaonekana kwenye skrini kuu na salio lako litasasishwa.
...
Wakati tarehe ya mwisho inakaribia, kitufe kitaonekana kukuhimiza usasishe pesa zinazohusika.


![Actualiser pièces depuis l'écran principal](assets/fr/30.webp)


Ili kusasisha sarafu zako, nenda kwenye kichupo cha "*Sarafu*" na ubofye "*Onyesha upya sarafu*" katika kisanduku cha sarafu kinacholingana. Ikiwa una sarafu kadhaa, unapaswa kuburudisha moja kwa moja, na kwa muda mfupi, kwa sababu za usiri. Ili kupunguza gharama, unaweza kuunganisha pesa zako kwa kutuma Wallet nzima kwa Address mpya inayopokea, lakini hii itaathiri usiri wako.


![Actualiser pièce](assets/fr/31.webp)


Onyesha kiwango cha ada unachotaka cha muamala. Kwa kuwa huu ni uhamisho kwako mwenyewe, unaweza kuweka kiwango cha ada cha chini, hasa ikiwa unafanya siku kadhaa kabla ya kumalizika muda wake.


![Transfert à soi-même](assets/fr/32.webp)


Muamala (ulioitwa "*kujituma*") utaonekana tu kwenye kichupo cha "*Miamala*".


![Transactions après auto-transfert](assets/fr/33.webp)


Baada ya kuthibitishwa, sarafu yako iko salama! Unaweza kupumzika kwa urahisi hadi tarehe inayofuata ya mwisho wa matumizi.
...
Liana kisha inakuomba uweke neno la Mnemonic. Ikiwa una kifaa cha saini kinachofanya kazi (Hardware Wallet), ruka sehemu hii. Ikiwa kifaa chako hakipo au kimeharibika, lakini una maneno 12 au 24 yanayolingana, bado unaweza kutumia chaguo hili. Ili kuwa katika upande salama (ikiwa kiasi cha kurejesha ni kikubwa), bado tunapendekeza upate Hardware Wallet mpya na utumie Mnemonic kurejesha funguo zilizomo.


Kwa upande wetu, tunatumia Blockstream Jade Hardware Wallet kama kifaa cha uokoaji na kuchagua kuruka ("*Ruka*") hatua hii.


![Passer phrase mnémotechnique](assets/fr/37.webp)


Angalia na uhifadhi kifafanuzi kwenye kifaa chako cha sahihi kwa kukichagua kwenye skrini. Ikiwa Hardware Wallet yako haionekani, angalia ikiwa imeunganishwa na kufunguliwa. Angalia na uthibitishe kuwa maelezo haya yameongezwa kwenye kifaa chako.
...
Ili kurejesha pesa katika Wallet, nenda kwenye Mipangilio ("*Mipangilio*") chini kushoto na ubofye "*Rejesha*".


![Récupération dans paramètres](assets/fr/41.webp)


Tumia sarafu katika Wallet kwa kuweka alama kwenye sanduku linalofaa. Onyesha BTC Address ambayo ungependa kutuma pesa, pamoja na kiwango cha ada ya ununuzi. Kisha bonyeza "*Next*".


![Récupération des pièces](assets/fr/42.webp)


Tia sahihi muamala kwa kubofya "*Saini*" na kuthibitisha muamala kwenye Hardware Wallet yako.


![Signer transaction clé de récupération](assets/fr/43.webp)


Kisha itangaze kwenye mtandao kwa kubofya "*Matangazo*".
