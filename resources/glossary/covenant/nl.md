...
> in het Frans is er geen term die precies de betekenis van het woord "verbond" weergeeft. Men zou kunnen spreken van "clausule", "pact", of "Commitment", maar deze zouden niet precies overeenkomen met de term "convenant". Deze term is ontleend aan juridische terminologie waarmee een contractuele clausule kan worden beschreven die blijvende verplichtingen oplegt aan een eigendom.*