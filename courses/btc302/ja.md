...
このトレーニングの目的は、Bitcoinコミュニティまたはミートアップを効果的に作成し、組織化するために必要なすべての鍵を提供することです。地域での取り組みを構築したい場合でも、オンライングループを成長させたい場合でも、このコースは、視覚的なアイデンティティの作成から定期的なイベントの実施、通信チャネルの管理に至るまで、各ステップを具体的にガイドします。

**セクション 1 : はじめに**  
まず、Bitcoinを中心に人々を集めることの重要性を再確認します。オンラインコミュニティであれ、ローカルなミートアップであれ、なぜ自分のコミュニティを立ち上げるべきなのか、どこで始めるべきなのか、また成長と持続可能性を確保するための明確な目標をどのように定義するかを学びます。

**セクション 2 : Bitcoinコミュニティに固有のアイデンティティを設計する**  
新しいメンバーを引きつけ、帰属意識を確立するためには、ユニークなアイデンティティを作成することが重要です。このセクションでは、あなたのBitcoinコミュニティの精神を忠実に反映するロゴ、ポスター、またはバナーの設計方法を学びます。

**セクション 3 : Bitcoinコミュニティのための通信チャネルを作成する**  
コミュニケーションはすべてのコミュニティの中心です。ここでは、優先すべき通信チャネルと、TelegramグループやDiscordサーバーを効率的に設定する方法について説明します。また、コミュニティ管理を容易にする多機能ボットの統合についても説明します。

**セクション 4 : ソーシャルネットワークの立ち上げ**  
コミュニティの発展には可視性が重要です。専用のTwitterプロファイルの作成方法、近隣の他のミートアップとの接続の確立方法、およびbtcmap.orgなどのプラットフォームを使用して可視性を高め、新しいメンバーを引きつける方法を学びます。

**セクション 5 : Bitcoinミートアップの開催**  
このセクションでは、適切な場所の選定からイベントの開催まで、ミートアップの組織化に焦点を当てます。また、参加者を維持し、コミュニティの持続可能な発展を確保する方法についても学びます。

**セクション 6 : プロジェクトとイニシアチブの例**  
単なる集まりを超えて、具体的で独創的なプロジェクト例を提供します。テーマ別イベント、ワークショップ、教育コンテンツの作成、地域のコラボレーションなどを紹介します。また、コミュニティを促進するための物理的およびデジタル資料の作成方法も学びます。

**セクション 7 : 将来を予測する**  
最後に、コミュニティの自然な発展について説明します。グループが急速に成長した場合はどうするか？組織をどのように分散化するか？規制環境が敵対的になった場合、どのように対応するか？このセクションでは、将来の課題を予測するのに役立ちます。

**セクション 8 : ビットコイナーを集める**  
この最後のセクションでは、あなたのプロジェクトの本質、つまり共通のビジョンのもとにBitcoin愛好家を集めることについて取り扱います。新しいメンバーを引きつけ維持するためのアプローチを構築する方法、グループ内でのタスクの委任方法、およびコミュニティを持続的に成長させる方法を学びます。

強くてダイナミックなBitcoinコミュニティを作り上げる方法を学ぶ準備はできましたか？始めましょう！
...
ウサギの穴に落ちると、私たちの人生観が変わります。  
それは私たちの内面の深いところから、もっと先へ進みたいという気持ちを促します。同じ精神的な作業を行い、同様に理解している他の人たちを発見したいと思わせます。

それは私たちに動機を与え、私たちの発見であるビットコインを共有することで、**自分の役割を果たしたいという欲求をさらに強くします**。

また、**明日の世界、私たちが築きたい世界、そしてそれを築いているコミュニティについて考えるよう促します**。

**コミュニティを作るというこの長いギャラリーの中で、あなたは動機、戦略、献身、そして時間を示す必要があります**。それは時に報われない仕事です。この冒険の中で、傷つかないように物事を一歩一歩進めるのが賢明です。  
**ですから、自分自身や自分の限界について考えてください**。そしてビットコインが昼夜あなたを駆り立てるかもしれませんが、**すべてを一人でやろうとせず、そうしないと疲れ果ててしまいます**。

逆に、**すでに同じギャラリーを通り抜け、同じ道を探検し、同じツールを作ったビットコイナーに助けを求めてください**。それはあなたの多くの時間を節約します。

**また、この冒険であなたに続く人々に手伝いを申し出てもらい、たとえいくつかのタスクを委任することになってもかまいません**。これらのタスクにはより多くの時間がかかるかもしれません。長い目で見れば、あなたのコミュニティはより結束し、成熟するでしょう。

![image](assets/fr/60.webp)

一人でいると、確かにビットコインというウサギの穴の多くのギャラリーの一つを素早く探検することができます。しかし、まだ探検すべき多くの他の方向があることを忘れてはなりません。

一方で、**ビットコイナーのコミュニティを作り、または参加し、定期的に彼らと共有し交流することで、あなたは同時に穴のすべての方向に進むことになります**。

## BTC302 トレーニング、続き
<chapterId>8bf10b77-80ee-5d50-87bc-0ef32574a675</chapterId>

このBTC302トレーニングでは、コミュニティ作りのステップ、ミートアップの設立、そして多くのプロジェクトの立ち上げについて詳細に説明しました。

あなたのコミュニティが次のレベルに進む準備ができたら、**協会を設立することが可能です**。  
例えばフランスでは、およそ60のコミュニティやミートアップの中で、ほぼ10の協会があります。

協会を設立する利点は二つあります：  
- 一つには、協会のステータスにより、**公式の地位を持ち、協会の銀行口座を開設し、報道機関やメディア、助成金からの一定の認知を得ることができます**。  
- もう一つには、**コミュニティの運営やプロジェクトの実施をより真剣に組織でき、特に特定の役割を定義することができます**。

これを行うことで、**すでに自分たちのイベントを開催したフランスのいくつかのコミュニティの経験、例えば** **BEF（Bitcoin Economic Forum、5月、ブルターニュ）、B-only（11月、アヌシー）、Be On Lille（9月、リール）** に基づきます。

![image](assets/fr/chapter38/62.webp)

もちろん、**他の国では、法律や協会の運営は異なります**。  
**したがって、他の国際的なビットコイナーがそれぞれの国の特有の情報でこのトレーニングを補完してくれることを期待しています**。
