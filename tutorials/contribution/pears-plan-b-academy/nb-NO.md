...
Pears er programvaren som gjør det mulig for oss å kjøre Plan ₿ Academy-plattformen uten å være avhengig av et sentralisert nettsted. I denne veiledningen skal vi installere Pears på datamaskinen din for å få tilgang til Plan ₿ Academy gjennom Pears.
...
#### 1.2.3. Installer Node.js og npm via NVM
...
### 1.3. Slik installerer du Pears på Windows


Det er like enkelt å installere Pears på Windows som på Linux, men det krever noen spesifikke verktøy.


*Hvis du bruker Linux og allerede har installert Pears, kan du hoppe direkte til **Steg 2**


#### 1.3.1. Åpne PowerShell som administrator
...
#### 1.3.4. Verifiser installasjoner
...
#### 1.3.6. Verifisere og initialisere Pears
...
### 1.4. Slik installerer du Pears på macOS
...
*Hvis du bruker Linux eller Windows og allerede har installert Pears, kan du hoppe direkte til **Steg 2**


#### 1.4.1. Kontroller systemforutsetningene
...
#### 1.4.3. Installer Node.js og npm
...
## 2. Slik bruker du Plan ₿ Academy på pærer
...
## 3. Hvordan seed Plan ₿ Academy on Pears
