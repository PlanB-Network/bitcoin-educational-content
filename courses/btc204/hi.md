...
objectives: 
  ...
  - समझने के लिए जरूरी सैद्धांतिक अवधारणाएँ (Theoretical Concepts Needed to Understand Privacy Issues):

1. **गोपनीयता (Privacy)**: व्यक्तिगत जानकारी को सुरक्षित रखने और उस पर नियंत्रण रखने का अधिकार।  
2. **सहमति (Consent)**: किसी की निजी जानकारी इस्तेमाल करने से पहले उनकी मंजूरी लेना।  
3. **डेटा संरक्षण (Data Protection)**: डेटा को गलत इस्तेमाल, चोरी या नुकसान से बचाने के उपाय।  
4. **पहचान की सुरक्षा (Identity Security)**: व्यक्ति की पहचान से जुड़ी जानकारी को सुरक्षित रखना।  
5. **सूचना का अधिकार (Right to Information)**: अपने बारे में जमा डेटा तक पहुँच और उसे संशोधित करने का अधिकार।  
6. **डिजिटल पदचिह्न (Digital Footprint)**: ऑनलाइन गतिविधियों से बनने वाला डेटा जो उपयोगकर्ता के व्यवहार को दर्शाता है।  
7. **एनोनिमिटी (Anonymity)**: बिना पहचान जाहिर किए कार्य करने की स्थिति।  
8. **पारदर्शिता (Transparency)**: यह जानना कि कौन, कब और कैसे आपकी जानकारी इस्तेमाल कर रहा है।  
9. **साइबर सुरक्षा (Cybersecurity)**: डिजिटल सिस्टम्स और डेटा को हैकिंग या दुरुपयोग से बचाना।  
10. **निगरानी (Surveillance)**: व्यक्ति की गतिविधियों पर नजर रखना, जो गोपनीयता को प्रभावित कर सकता है।  

ये अवधारणाएँ गोपनीयता से जुड़े मुद्दों को समझने और उनका विश्लेषण करने में मदद करती हैं।
  - जीडब्ल्यू-2 यूजर्स के लिए गोपनीयता के नुकसान से जुड़े जोखिमों की पहचान करें और उन्हें कम करें
  - Bitcoin पर अपनी प्राइवेसी को सुरक्षित रखने के तरीके और टूल्स का इस्तेमाल करें
  - चेन एनालिसिस के तरीकों को समझें और रक्षा रणनीतियाँ विकसित करें
...
एक HD Wallet सैद्धांतिक रूप से `2^(32/2)` तक अलग-अलग खाते निकाल सकता है। शुरुआती खाता, जो सभी Bitcoin वॉलेट्स पर डिफ़ॉल्ट रूप से इस्तेमाल होता है, `0'` इंडेक्स से मेल खाता है।
...
फिर लेन-देन को पूरे नेटवर्क में "कैपिट्युलेशन" चरण में बांट दिया जाता है।

![BTC204](assets/fr/206.webp)

तना और फूल का सिरा लेन-देन के नेटवर्क में फैलने के व्यवहार को दर्शाता है, जो सिंघाड़े के आकार जैसा दिखता है।

इस तरह, जासूस नोड्स संभावित रूप से लेन-देन को उस नोड तक ट्रैक कर सकते हैं जिसने आत्मसमर्पण चरण (बड़े पैमाने पर प्रसारण) शुरू किया था, लेकिन यह नोड वह नहीं है जिसने पहली बार लेन-देन का प्रसारण किया था, क्योंकि उसे यह स्टेम पर आखिरी नोड से प्राप्त हुआ था। अगर जासूस नोड्स स्टेम को ट्रैक नहीं कर पाते, तो वे स्रोत नोड की भी पहचान नहीं कर सकते।
