...
![kuva](assets/Concept/chapitre0/4.jpeg)
...
Bitcoin oli enemmän kuin vain digitaalinen valuutta; se edusti cypherpunk-ihanteiden saavutusta. Sen teknologian lisäksi se symboloi vallankumousta perinteisiä rahoitusjärjestelmiä vastaan ja tarjosi vaihtoehdon, joka perustui läpinäkyvyyteen, hajautukseen ja yksilön suvereniteettiin.
...
![kuva](assets/Concept/chapitre2/4.jpeg)
...
Kun omistat bitcoineja, varojesi turvallisuus on suuri huolenaihe. Paras tapa määritellä tilanteeseesi sopiva turvallisuus on esittää (ja vastata) joukko kysymyksiä; turvallisuusmallisi riippuu vastauksistasi. Aloittakaamme:
...
![kuva](assets/Concept/chapitre9/3.png)
...
Sen jälkeen Bitcoinin käyttö laajeni pimeän verkon markkinapaikoille, kuten Silk Roadille, sen hallitsemattoman ja pseudonyymin luonteen vuoksi. Tämä sivusto kiinnitti huomiota Bitcoinin hallitsemattomaan ja pseudonyymiin luonteeseen, mikä houkutteli joitakin rikollisia toimijoita käyttämään sitä. On kuitenkin huomattava, että työkalun käyttö, ei itse työkalu, määrittää sen laillisuuden tai laittomuuden. On huomattava, että Bitcoinin laiton käyttö ei itsessään tee henkilöstä rikollista. Se on käyttö, ei työkalu, joka voidaan luokitella laittomaksi. Esimerkiksi Bitcoinin käyttö tiettyjen huumeiden ostamiseen voi olla laillista tai laitonta riippuen siitä, missä toiminta tapahtuu.
- ICO-huuma ja yleisön saapuminen.
Vuosi 2017 merkittiin merkittävällä spekulatiivisella kuplalla kryptovaluuttojen maailmassa, erityisesti tuhansien alkuperäisten kolikontarjousten (ICOs) lanseerauksen myötä. Monilla näistä uusista kryptovaluutoista ei kuitenkaan ollut konkreettista kehitystä tai hyötyä ja ne katosivat nopeasti. Tätä 2017 kuplaa seurasi voimakas korjausliike vuosina 2018-2019.

- NFT-kupla ja DeFi

Sitten jälleen vuonna 2020, markkina koki toisen spekulatiivisen kuplan, joka nosti Bitcoinin hinnan 60 000 dollariin. Tämä kupla erottuu aiemmista suuremmalla sijoittajien monimuotoisuudella, mukaan lukien rahoituslaitokset ja suuret yritykset. Mutta jälleen kerran, voimakkaat korjaukset tapahtuvat kerran kun euphoria laantuu.

### Bitcoin & Volatiliteetti

Aiempien syklien perusteella vaikuttaa siltä, että Bitcoinin taloudellisten syklien periodisuus vastaa kahta halvennusta. Ehkä siksi, että halvennustapahtuma toimii laukaisijana puolittaen uusien bitcoinien emission.

Nämä merkittävät vaihtelut ovat luoneet Bitcoinille maineen erittäin vaarallisena omaisuutena, joka saa käyttäjänsä menettämään rahaa. Vaikka hinta voi laskea 10-20 tai jopa 50% muutamassa päivässä, on tärkeää ymmärtää, että Bitcoin-protokolla ei ole hinnanmuutoksista kärsivä.

Tämä merkittävä volatiliteetti hyväksytään täysin tänään Bitcoin-toimijoiden keskuudessa ja sitä voidaan lieventää useilla ratkaisuilla, kuten taloudellisilla suojauksilla (stablecoins), vahvalla pitkän aikavälin uskolla (hodling) tai yksinkertaisesti sijoittamalla 100% rahoistaan Bitcoiniin ymmärtämättä mitään. Ymmärtäminen, miksi Bitcoinin hinta vaihtelee niin paljon, on siis olennaista pystyäkseen edistymään tässä teollisuudessa, koska loppujen lopuksi se on hinta ja syklit, jotka jossain määrin hillitsevät ja säätelevät markkinaamme. Voimme kuitenkin huomata, että Bitcoinin kasvaessa ja kypsyessä, volatiliteetti muuttuu vähemmän merkittäväksi.

![kuva](assets/Concept/chapitre14/5.png)

Vaikka btc/dollar-pari vaihtelee lyhyellä aikavälillä, Bitcoin seuraa yleistä nousutrendiä lähes mekaanisella tavalla rajoitetun 21 miljoonan bitcoinin määränsä ja halvennusprosessinsa ansiosta (rahoituksen luominen puolittuu keskimäärin joka neljäs vuosi). Tietysti, kuten mikä tahansa rahoitusomaisuus, Bitcoin on taloudellisten syklien alainen, mukaan lukien euphorian kaudet, spekulatiiviset kuplat ja korjaukset. Tämä ilmiö on melko yleinen nousevissa teknologioissa, joissa markkina ei aina ole rationaalinen tai tehokas.

### Ainutlaatuinen markkina

Nämä spekulatiivisten kuplien syklit ovat melko ainutlaatuisia maailmassa, koska on erittäin harvinaista, että sama omaisuuserä kokee niin monta kuplaa peräkkäin. Tämä voidaan selittää yksinkertaisesti sillä, että Bitcoin ei ole kupla, joka katoaa, vaan valuutta, jota todella käytetään kaikkialla maailmassa. Bitcoin-protokolla on ainutlaatuinen siinä, että se toimii globaalilla tasolla, 24 tuntia vuorokaudessa, 7 päivää viikossa, mikä tekee rahoitusviranomaisten sääntelystä vaikeaa.

![kuva](assets/Concept/chapitre14/4.png)

Tänään, vuonna 2023, Bitcoin jatkaa selviytymistään ja kasvuaan integroitumalla yhä enemmän perinteiseen markkinaan. Bitcoin ETF:ien tuleva saapuminen, selkeämpi sääntely ja paremmat hankinta- tai säilytystyökalut vain rohkaisevat tätä suuntausta. Bitcoin on JÄLLEEN kerran selvinnyt spekulatiivisesta kuplastaan, joten ehkä se ei olekaan pelkkää höyryä!

![kuva](assets/Concept/chapitre14/3.png)

## Bitcoinien hankkiminen työskentelemällä

![bitcoinien hankkiminen työskentelemällä](https://youtu.be/sHkadVRUQF8)

### Kehittyy rinnakkainen talous
Bitcoinia voidaan pitää rinnakkaisena taloutena fiat-valuutoille. Tämä tarkoittaa, että on mahdollista myydä tavaroita tai palveluita ja saada maksu Bitcoinina. Transaktiot voidaan suorittaa suoraan Bitcoinina, ilman tarvetta käyttää vaihtoalustaa, yksinkertaisesti Bitcoin-lompakosta toiseen Bitcoin-lompakkoon.
Bitcoin-talous on olemassa ja kehittyy tietyillä maailman alueilla, kuten El Salvadorissa, jossa Bitcoin on ollut laillinen maksuväline vuodesta 2021 lähtien. Lisäksi jotkut yksityishenkilöt, yritykset ja organisaatiot hyväksyvät jo Bitcoinin maksuvälineenä tuotteilleen tai palveluilleen.

![kuva](assets/Concept/chapitre16/6.png)

Lisäksi Bitcoinin käytön helpottamiseksi jokapäiväisissä transaktioissa on käynnistetty avoimen lähdekoodin ja yhteistyöhön perustuva projekti: BTCMap (https://btcmap.org/map#2/21.28937/5.46680). Tämä alusta listaa kaikki kauppiaat, jotka hyväksyvät Bitcoinin sekä eri Bitcoin-yhteisöt ympäri maailmaa. Voit vierailla heidän verkkosivuillaan tutustuaksesi sinua ympäröivään Bitcoin-ekosysteemiin. Näin ollen, huolimatta vaikeuksista ja epäröinneistä, on aloitteita kuten BTCMap, jotka edistävät Bitcoin-talouden saavutettavuutta ja mukavuutta kaikille.

### Miksi hyväksyä Bitcoinia ostamisen sijaan?

Bitcoineja voi hankkia ostamalla niitä alustoilta, joita säätelevät organisaatiot kuten Ranskan AMF (Autorité des Marchés Financiers). Tämä menetelmä sisältää tiettyjä riskejä ja transaktioidesi jäljitettävyyden. Toinen tapa hankkia bitcoineja on hyväksyä ne maksuvälineenä tarjoamistasi tuotteista tai palveluista. Tämä menetelmä mahdollistaa bitcoinien hankkimisen työsi kautta olematta jatkuvasti huolissasi Bitcoinin hinnasta.

Lisäksi Bitcoinin hyväksymisellä kauppiaana on useita etuja, mukaan lukien sensuurin vastustuskyky, pienemmät transaktiomaksut, lisääntynyt tehokkuus, suojautuminen inflaatiolta sekä taloudellinen vapaus ja suvereniteetti.

![kuva](assets/Concept/chapitre16/3.png)

### Kuinka edetä:

Bitcoinin hyväksymiseksi on tarpeen tutkia eri saatavilla olevia ratkaisuja ja valita se, joka sopii parhaiten liiketoimintaasi. Täydellistä ratkaisua ei ole olemassa, ja valintaa tehdessä on otettava huomioon useita tekijöitä, kuten odotettu transaktiovolyymi, käytettävissä oleva budjetti ja liiketoiminnan tyyppi (verkossa tai fyysinen).

Käsittelemme tätä aihetta yksityiskohtaisemmin toisessa koulutuksessa, mutta yksinkertaistaaksemme voimme harkita useita yrityskategorioita ja siten niihin liittyviä ratkaisuja:

- Yksinkertainen online-ratkaisu: OpenNode
- Ratkaisu harrastelijakauppiaille: Swiss Bitcoin Pay
- Ratkaisu suurille rakenteille tai intohimoisille bitcoinisteille: BTCpay Server

## Säästäminen Bitcoinilla

![säästäminen bitcoinissa](https://youtu.be/Ir5zzYc95IQ)

### Varoitus ennen aloittamista!

Bitcoin on tullut merkittäväksi finanssiomaisuudeksi, pääasiassa sen rajallisen tarjonnan ja kasvavan kysynnän vuoksi. Bitcoinin ostaminen kuitenkin sisältää riskejä, jotka vaativat erityistä huomiota. Siksi on suositeltavaa tehdä oma tutkimus ja oppia lisää aiheesta, jotta voit tutustua teknologiaan ennen sijoittamista.

- Sijoita vain sen verran, kuin voit varaa menettää.
- Bitcoin on erittäin volatiili finanssiomaisuus; sen hinta voi laskea nollaan.
- Menneet tulokset eivät ole tae tulevasta suorituskyvystä.
- Ota tarvittaessa yhteyttä taloudelliseen neuvonantajaasi.
...
Ennen kuin sukellat Bitcoinin ostamiseen, varmista, että sinulla on:

- Turvallinen lompakko.
- Vankka ymmärrys Bitcoinista.
- Seurattava säästösuunnitelma.
- Pitkän aikavälin näkemys.

Jos aihe on edelleen epäselvä, BTC102-kurssi opastaa sinua turvaamaan ja hankkimaan ensimmäiset bitcoinisi. Tässä me vain raapaisemme aihetta pinnalta.

Käytännössä on kaksi kysymystä, jotka sinun tulee itseltäsi kysyä:
- Minkä hankintastrategian valita: asteittain vai kaikki kerralla?
- Mitä alustaa käyttää: säänneltyä vai sääntelemätöntä?

### Hankintastrategiat

- Dollar Cost Average (DCA)

Toistuvat ostot tarkoittavat pienten Bitcoin-määrien ostamista säännöllisin väliajoin. Tämä menetelmä tasoittaa hintaa ajan myötä ja tarjoaa jatkuvaa kasvua omistettavan Bitcoin-määrän suhteen. Se on ihanteellinen ratkaisu pitkäaikaiseen säästämiseen ilman huolta Bitcoinin hinnasta ja volatiliteetista. Aseta se käyntiin ja unohda se.

![kuva](assets/Concept/chapitre15/2.png)

> Varo UTXO:ja: Muista yhdistää UTXO:si lompakoissasi ajoittain. Tämä käytäntö on olennainen tehokkaan Bitcoinien hallinnan ja tarpeettomien maksujen välttämisen kannalta siirtojen aikana.

- Spontaani ostos

Spontaania ostosta käytetään saavuttamaan välitön altistuminen Bitcoinille. Olipa kyseessä ostaminen romahduksen aikana tai bonuksen hyödyntäminen, päätös on sinun. Sinun on kerättävä rohkeutesi ja painettava ostonappia.

Bitcoinin merkittävän volatiliteetin vuoksi on kiinnitettävä erityistä huomiota tunteisiisi. FOMO (Fear of Missing Out) ja FUD (Fear, Uncertainty, Doubt) ovat pahimpia vihollisiasi tässä yhteydessä! Pysy rauhallisena ja noudata etukäteen määrittelemääsi strategiaa välttääksesi impulsiiviset ja mahdollisesti haitalliset päätökset.

### Keneltä meidän pitäisi ostaa Bitcoinimme?

Bitcoinien hankkimiseen on useita tapoja, joilla kullakin on omat sääntelynsä. Jotkut alustat vaativat tunnistautumisen vahvistusta varten, toiset eivät. On tärkeää ymmärtää kunkin alustan liittyvät säännökset.

- DCA-alustat

Yleinen tapa kerryttää Bitcoineja on Dollar Cost Averaging (DCA), joka sisältää säännölliset pienet sijoitukset. Useat alustat tarjoavat tätä palvelua, kuten ne, jotka on listattu [omistetulla sivullamme](https://sovereignuniversity.org/tutorials/exchange). DCA:n helppouden lisäksi nostot lompakkoosi ovat yleensä automaattisia, mikä tarkoittaa, että sinulla on aina hallinta omaisuudestasi.

Nykyään lähes kaikki DCA-ratkaisut ovat suhteellisen tehokkaita ja niiden maksut ovat lähes samankaltaiset, joten valinta riippuu enemmän saatavuudesta maassasi.

- Välittäjäalustat

Suurten sijoitusten osalta suositellaan säänneltyjä ja tunnustettuja alustoja, kuten Kraken, Bitstamp ja Paymium. Nämä alustat tarjoavat turvallisen ja turvatun ympäristön suurten transaktioiden tekemiseen.

Niiden käyttö on yksinkertaista ja kaikkien saavutettavissa:

1. Perusta KYC/\* tili
2. Siirrä varoja tilillesi
3. Osta Bitcoinia
4. Nosta Bitcoin lompakkoosi

![kuva](assets/Concept/chapitre15/1.png)

Oston jälkeen on suositeltavaa välittömästi nostaa Bitcoinit vaihtoalustoilta minimoidaksesi hakkeroinnin ja varojen jäädyttämisen riskit. Nostomaksut voivat olla korkeat, joskus jopa 25 euroa alustasta riippuen.

> Know Your Customer (KYC) -säännökset vaativat käyttäjiä toimittamaan tunnistetiedot terrorismin rahoituksen, veronkierron ja rahanpesun torjumiseksi.

On tärkeää huomata, että KYC on tärkeä aihe alallamme, koska sen tehokkuus on helposti kyseenalaistettavissa, kun taas sen kielteiset puolet ovat lukuisia. Monissa yliopistomme koulutusohjelmissa ja sisällöissä neuvomme välttämään täydellisiä KYC-alustoja, jos olet jo edistynyt käyttäjä.

### Ei-KYC Ratkaisu

Lisäksi on useita [markkinapaikkoja](https://sovereignuniversity.org/tutorials/exchange) ostaa ja myydä bitcoineja vertaisverkossa. Jos olet kiinnostunut näistä, voit osallistua BTC 205 -kurssillemme aiheesta. Yleensä nämä ratkaisut ovat:

- Bitcoin-automaatit
- Fyysiset tapaamiset muiden bitcoin-entusiastien kanssa
- Laittomat ja sääntelemättömät alustat
- Vertaisverkkoon perustuvat yhdistämispalvelut
- Neopankit, jotka toimivat Bitcoin-ystävällisissä maissa.
On tärkeää huomata, että verotus voi tulla sovellettavaksi alueellasi. Kehotamme sinua tutustumaan maasi säädöksiin ennen minkään toimenpiteen toteuttamista, joka saattaisi asettaa sinut riskiin.

## Hyper-bitcoinisaatio

![hyper-bitcoinisaatio](https://youtu.be/lLxndxrzXR0)

### Villi kilpajuoksu on vasta alkanut!

Kuten mikä tahansa uusi teknologia, Bitcoinin omaksuminen noudattaa S-käyrää. Olemme ohittaneet varhaisen omaksujien aikakauden, ja indikaattorit näyttävät viittaavan Bitcoinin täydelliseen demokratisoitumiseen. Se on virusteknologiaa, jota ei voi pysäyttää. El Salvador on ottanut rohkean askeleen omaksuessaan Bitcoinin kokonaisuudessaan ja julistamalla sen lailliseksi maksuvälineeksi. Kuitenkin jokainen maa reagoi tähän teknologiaan eri tavoin. Jotkut ovat kieltäneet ja kriminalisoineet sen käytön, mikä lisää Bitcoinin omaksumisen monimutkaisuutta kulttuurien, aikakausien ja kansakuntien perusteella.

![kuva](assets/Concept/chapitre17/2.png)

Bitcoinin nousu pakottaa yritykset, yliopistot, sääntelijät ja yksilöt ottamaan huomioon tämän uuden teknologian. Uusia työkaluja on luotava, palveluja on mukautettava ja innovaatioiden on jatkuttava niiden selviytymisen varmistamiseksi. Tämä konteksti herättää monia kysymyksiä liittyen eri aloihin, mukaan lukien kryptografia, peliteoria, taloustiede ja rahapolitiikka, tietojenkäsittelytiede, filosofia, energia, lait ja sääntely. Lyhyesti sanottuna, Bitcoin on monitieteellinen kohde.

![kuva](assets/Concept/chapitre17/1.png)

### Bitcoin on 0:sta 1:een

Kutsumme sinut pohtimaan tätä uutta rahavallankumousta. Bitcoinin kanssa tutkittavaa on niin paljon, että kaiken omaksuminen kerralla on monimutkaista. Ota aikasi, Bitcoin ei ole katoamassa. Päinvastoin, vallankumous on vasta alkanut. Uskomme yhdessä, että kykenemme luomaan maailman, jonka haluamme jättää lapsillemme. Maailman, jossa ihmisen suvereniteetti on oikeus, yksityisyys kunnioitetaan oletuksena, ja jossa rahaa ei manipuloida. Toivomme, että saavutamme tämän yhdessä.

![kuva](assets/Concept/chapitre17/3.png)

Jos haluat laajentaa tietämystäsi Bitcoinista, suuri joukko kirjailijoita, ajattelijoita ja esseistejä on myötävaikuttanut Bitcoinin koulutuskerrokseen. Viime vuosina olemme listanneet ja luokitelleet nämä teokset tarjotaksemme [kirjasto resursseja](https://sovereignuniversity.org/resources) kaikkein uteliaimmille teistä. Löydät parhaat podcastit, verkkosivustot, artikkelit, tutoriaalit, kirjat ja muun sisällön.

> Milton Friedman, tunnettu taloustieteilijä, ennusti vuonna 1999: "Luulen, että Internet tulee olemaan yksi merkittävimmistä voimista hallituksen roolin vähentämisessä. Ainoa asia, joka puuttuu, mutta joka pian kehitetään, on luotettava sähköinen raha - menetelmä, jonka avulla Internetissä voit siirtää varoja A:sta B:hen ilman, että A tietää B:stä tai B tietää A:sta."

# Bitcoinin tulevaisuus: Salamaverkko

## Lyhyt johdanto Salamaverkkoon

![Salamaverkko](https://youtu.be/HFv3NN4z450)

Nyt kun meillä on perustiedot Bitcoin-protokollasta, esittelemme maksuverkon, joka käyttää Bitcoin-protokollaa mahdollistaakseen salamannopeat transaktiot. Puhumme tietenkin Salamaverkosta!

### Pähkinänkuoressa

Salamaverkko on vallankumouksellinen teknologia, joka on syvästi muuttanut käsitystämme Bitcoinista. Se on ratkaisu, joka käsittelee Bitcoinin skaalautuvuusongelmaa.

Ymmärtääksemme Salamaverkon täysin, on tärkeää ymmärtää, miten Bitcoin kehittyy. Bitcoin kehittyy infrastruktuurikerroksissa: ensimmäinen kerros on lohkoketju, ja toinen kerros on Salamaverkko.
![kuva](assets/Concept/chapitre18/6.png)
Tunnustettuna Bitcoinin kerroksena, Lightning Network vahvistettiin ja otettiin käyttöön vuonna 2017. Se mahdollistaa välittömät, edulliset Bitcoin-siirrot, ratkaisten näin Bitcoinin skaalautuvuusongelman. Mutta mikä on tämä skaalautuvuusongelma, jota Bitcoin kohtaa?

### Lohkoketju Ei Voi Kasvaa Loputtomiin

Skaalautuvuusongelma viittaa haasteeseen toteuttaa rahajärjestelmä, joka kykenee tarjoamaan jatkuvasti kasvavan määrän siirtoja sekunnissa sen käyttöönoton myötä. Tämä liittyy lohkoketjun trilemmaan. Kuvittele kolmio, jonka kärkinä ovat hajauttaminen, turvallisuus ja skaalautuvuus.

![kuva](assets/Concept/chapitre18/5.png)

Lohkoketjuun perustuva protokolla voi tyydyttää vain kaksi näistä kolmesta näkökohdasta. Bitcoin-protokollassa on tehty valintoja hajauttamisen/turvallisuuden hyväksi. Toisaalta 1MB:n lohkokoko ja kahden lohkon välinen aika (keskimäärin 10 minuuttia) mahdollistavat Bitcoin-solmun pyörittämisen pienemmin kustannuksin, suosien hajauttamista. Toisaalta lohkojen tuottaminen Proof-of-Workin kautta tekee huijaukset protokollassa erittäin kalliiksi samalla kun se helpottaa verifioimista verkoston solmujen toimesta, suosien näin turvallisuutta. Kuitenkin nämä valinnat asettavat rajoituksen keskimääräiselle siirtojen määrälle lohkossa, mikä vastaa suunnilleen muutamaa siirtoa sekunnissa. Tämä määrä on naurettava verrattuna maksunvälittäjien, kuten VISAn, käsittelykapasiteettiin, joka on 1700/s. Tämä rajoitus on kuitenkin välttämätön, jotta Bitcoinilla voidaan tehdä siirtoja sensuurinkestävästi ja luottamuksettomasti. Siitä huolimatta Bitcoinin kehittäjät ovat pohtineet tätä ongelmaa alusta alkaen.

### Lightning Yläkerroksena

Vuosiensa pohdinnan ja useiden yritysten jälkeen Lightning-protokolla syntyy. Tiettyjen määrittelyjen avulla tämä protokolla mahdollistaa vertaisverkkomaksujärjestelmän rakentamisen hyödyntäen Bitcoinin siirtoprotokollan turvallisuutta ja ohjelmoitavuutta. Lightning Network toimii maksukanavien verkostona, mahdollistaen välittömät siirrot pienin kuluin lähettäjälle. Tämä maksukanavien verkosto mahdollistaa jopa siirrot yksilöiden välillä, joilla ei ole suoraa kanavayhteyttä.

![kuva](assets/Concept/chapitre18/4.png)

Perinteiset rahansiirtopalvelut kuten Western Union, keskuspankit, Visa ja Mastercard saattavat kadota, jos ne eivät ota käyttöön Lightning Network -teknologiaa. Lightning Network on tehokkaampi ja kustannustehokkaampi kuin nykyiset maksujärjestelmät. Todellakin, Lightning Network mahdollistaa lähes rajattomat siirrot kahden kanavaa jakavan osapuolen välillä ilman energiakustannuksia peruslohkoketjussa muuta kuin kanavan luomisilmoituksen siirto.

![kuva](assets/Concept/chapitre18/7.png)

Siirrot ovat turvattuja kryptografian kautta ja epäsuorasti Bitcoinin louhijoiden kuluttaman energian kautta. Siirrot voidaan tehdä välittömästi, ilman maantieteellisiä rajoituksia, ja kulut ovat erittäin alhaiset, usein alle 0,5%.

Yhteenvetona, Lightning Network on lupaava yritys toteuttaa tehokas maksujärjestelmä Bitcoin-siirtoihin. Saatavilla on jo lukuisia Lightning-lompakoita, joita voit tutkia opetusosiossamme tai Lightning Network -koulutuksemme kautta.

## Lightning Networkin Käyttötapaukset

![LN:n käyttötapaukset](https://youtu.be/_UV2jmQ8TQM)

Kuten juuri näimme, Bitcoin-protokolla, vaikka se onkin vallankumouksellinen, kohtaa merkittäviä haasteita skaalautuvuuden suhteen, jotta se voisi käsitellä kaikki päivittäiset siirtomme. Näiden ongelmien ratkaisemiseksi ehdotettiin toisen kerroksen ratkaisua, tunnetaan nimellä Lightning Network, joka esiteltiin vuonna 2016 ja jolla on nyt useita eri toteutuksia, jotka kaikki ovat yhteensopivia:

- Core-lightning Blockstreamilta
- Eclair Acinqilta
- LND Lightning strikelta
Tämä vertaisverkko pyrkii helpottamaan mikromaksuja, jotka ovat erittäin pieniarvoisia transaktioita, jotka muuten olisivat epäkäytännöllisiä korkeiden kulujen ja pitkien vahvistusaikojen vuoksi Bitcoin-lohkoketjussa.
### Mitkä ovat verkon käyttötapaukset?

Tämä teknologia avaa oven laajalle valikoimalle potentiaalisia sovelluksia Bitcoinille, jotka aiemmin olivat saavuttamattomissa Bitcoinin turvallisuuden ja hajauttamisen varmistamiseksi tarvittavien rajoitusten vuoksi. Näihin arkipäivän sovelluksiin kuuluvat välitön laskutus kaupassa (sekä fyysisessä että verkossa), rahansiirto reaaliaikaisesti ja mikrolahjoitukset sisällölle. Käyttöönottamalla verkko lähes välittömistä, turvallisista ja edullisista transaktioista (keskimäärin alle 0,5 %), monet aiemmin kuvittelemattomat liiketoimintamallit voidaan toteuttaa. Tämä on mahdollista, koska Lightning Network käyttää satseja (bitcoinin desimaali) toimiakseen.

![kuva](assets/Concept/chapitre18/9.png)

Videopeliala tarjoaa erityisen mielenkiintoisen esimerkin siitä, miten Lightning Networkia voidaan käyttää olemassa olevien liiketoimintamallien muuttamiseen. "Skin in the game" -konsepti on idea, joka on äskettäin saanut suosiota tässä yhteydessä. Se tarkoittaa käytännössä taloudellisen panoksen asettamista pelin lopputulokseen.
Lightning Network mahdollistaa pelaajille hyvin pienten rahamäärien panostamisen pelatessa, kuten muutaman satoshin (noin murto-osan eurosentistä). Tämä mahdollistaa panoksen asettamisen, joka stimuloi kilpailua samalla merkittävästi lisäten bottien käyttöönoton kustannuksia.

![kuva](assets/Concept/chapitre18/2.png)

Yhteenvetona voidaan sanoa, että Bitcoinin mikromaksujen tulevaisuus näyttää lupaavalta innovaatioiden, kuten Lightning Networkin, ansiosta. Kun nämä teknologiat jatkavat kehittymistään ja kypsymistään, voimme odottaa näkevämme uusia ja jännittäviä sovelluksia lähitulevaisuudessa. Ota esimerkiksi "rahan suoratoisto" -konsepti. Lightning Networkin avulla voimme tehdä mikromaksuja joka minuutti (mahdollisesti ilman luotettua kolmatta osapuolta), mikä avaa oven kokeilla talousmalleja, joissa kuluttajat maksavat sisällöstä sen mukaan, mitä he kuluttavat.

![kuva](assets/Concept/chapitre18/8.png)

Tällaisessa järjestelmässä raha jaetaan automaattisesti, ennalta määritellyn prosenttiosuuden mukaan, palvelun tai tuotteen eri osallistujien kesken. Tämä voisi mullistaa tapamme ajatella maksu malleja. Esimerkiksi käyttäjiltä voitaisiin veloittaa minuutti- tai jopa sekuntikohtaisesti siitä ajasta, jonka he viettävät palvelua käyttäen, sen sijaan, että he maksaisivat kuukausitilauksesta. Tällainen talousmalli voisi olla syvällisiä vaikutuksia sisällöntuottajille, jotka olisivat kannustettuja tuottamaan laadukasta sisältöä pitääkseen käyttäjien huomion. Käyttäjät puolestaan maksaisivat vain kuluttamastaan sisällöstä, poistaen näin etukäteen maksettavat tilausmaksut. On jopa kuviteltavissa, että tätä järjestelmää voitaisiin käyttää tavaroiden vuokraamiseen.

![kuva](assets/Concept/chapitre18/3.png)

Yhteenvetona voidaan sanoa, että Lightning Network avaa monia jännittäviä käyttötapauksia Bitcoin-käyttäjille. Tuloksena olevat talousmallit ja liiketoimintamahdollisuudet ovat lukuisia ja moninaisia. Kannustamme sinua kokeilemaan sitä itse kokeilemalla podcast-sovellusta [Fountain](https://www.fountain.fm/), joka mahdollistaa sinun saada palkkiona muutaman satsin kuunnellessasi lempipodcastejasi!

## Punainen vai sininen pilleri?

![punainen pilleri](https://youtu.be/nCRVIoyyyck)

Kuten Morpheus sanoi Neolle: "Jos otat sinisen pillerin, tarina päättyy, heräät sängyssäsi ja uskot mitä haluat uskoa. Jos otat punaisen pillerin, pysyt Ihmemaassa, ja minä näytän kuinka syvälle kaninkolo menee." Oletko valmis tutkimaan Bitcoinin kaninkoloa? Ole varovainen, sillä saatat löytää uudelleen taloudellisen vapaudesi!
![punainen pilleri](assets/posters/fr/2_pilluleorange.png)
### Teknologisen tulevaisuuden vaikutukset

Teknologia kehittyy eksponentiaalisesti, eikä kukaan voi ennustaa sen tulevia kehityskulkuja varmuudella. Maailman yhteydet ja tekoäly jatkavat kehittymistään. Tieto, jonka yksilö voi hankkia internetin kautta, muuttuu ajan myötä yhä mittaamattomammaksi.

Otetaan esimerkiksi tekoäly. Nämä teknologiat ovat jo ylittäneet tai lähestyvät ihmisen tason suorituskykyä yhä useammalla alueella, kuten videopelit, kuvien ja tekstien tuottaminen sekä datan analysointi. Yksi mahdollinen seuraus on, että yli 80% työpaikoista katoaa tekoälyn ja automaation myötä. Meillä on useita vaihtoehtoja, kuten teknologisen kehityksen hillitseminen tai hyödyntäminen lisääntyneestä pääomasta, jonka tekoälyn tuottavuusvoitot luovat.

Oleellisia kysymyksiä ovat:

- Miten hallitsemme yhteiskuntaa, jossa 80% työpaikoista katoaa?
- Miten elvytämme väestön?
- Tarvitaanko yhtä monta opettajaa?
- Automaation geopoliittisia, poliittisia ja inhimillisiä seurauksia ei ole keskusteltu riittävästi.
  Tietokoneet, internet, suoratoisto ja VR muuttavat koulutusta. Voisimme olla yleinen kurssi kaikille ranskalaisille opiskelijoille, jota hallitus ja opettajat hallinnoivat, ja opettajat eivät enää luennoi vaan seuraavat suoraan opiskelijoita. Lapset voisivat siirtyä virtuaalimaailmaan ja saada siellä opastusta historian oppimisessa.

- Missä on raja opettajan ja tekoälyn välillä?
- Miten voimme taata yhteiskunnan, joka elää vauraudessa?

Nämä perustavanlaatuiset kysymykset tulevaisuudestamme on keskusteltava ja päätettävä yhdessä. Mutta mikä on yhteys Bitcoinin kanssa? Kuten internet viestintätapojen osalta, Bitcoin on teknologinen vallankumous uusien suuren mittakaavan organisaatioiden muotojen osalta, tuoden meille mahdollisuuden vaihtaa arvoa ilman luotettua kolmatta osapuolta. Haluammeko estää rahajärjestelmän teknologisen kehityksen vai hyödyntää pääoman kasvua kymmenkertaisen tuottavuusvoiton kautta Bitcoinin ja Lightning-protokollien käytöstä?

### Mikä on rahoituksen tulevaisuus?

Nämä pohdinnat herättävät myös kysymyksiä siitä, kenen tulisi hallita, valtuuttaa ja jäljittää käyttämäämme rahaa. Tavoitteena on päättää suljetun järjestelmän, jossa on valitsemattomia johtajia, ja avoimen järjestelmän, jossa ei ole luotettuja kolmansia osapuolia ja jossa vallitsee puolueettomuus, välillä.

- Onko valuutta yksityisomaisuuden muoto?
- Voivatko mielenosoittajien tilit olla estettyjä ilman korkeimman oikeuden määräystä?
- Kuka takaa rahoitusjärjestelmän?
- Miten yksilö voi olla suvereeni rahansa suhteen ja luottaa luotettuun kolmanteen osapuoleen?
- Voiko rahaa lähettää maailman toiselle puolelle ilman maksuja tai välittäjiä?

Näiden uusien teknologioiden hyväksyminen voisi tuottaa valtavia mittakaavaetuja maailmanlaajuisesti. Pitäisikö meidän sallia pääomavirtojen vapaa liikkuvuus? Kansainvälisillä saartoilla on taloudellisia ja poliittisia seurauksia. Onko eettistä käyttää rahoitusvälittäjiä kuten Western Union, joka joskus perii jopa 25% maksuja? Uskomme, että yhä digitaalisemmassa maailmassa rahan tulisi olla demokratisoitu ja pidettävä kansan yhteisenä hyvänä valtion tai läpinäkymättömien rahoituslaitosten sijaan.

Kysymys siitä, kenen tulisi hallita pankkijärjestelmää, on ratkaiseva, koska pankkijärjestelmän säännöt eivät ole läpinäkyviä ja ymmärrettäviä kaikille, mikä mahdollistaa poliitikkojen ja sääntelijöiden kastin otteen järjestelmästä. On tärkeää kysyä, pitäisikö vapaan markkinan vai joukon intellektuelleja hallita pankkijärjestelmää.

### Vapautemme ovat vaakalaudalla.

Myös sensuuria on kyseenalaistettava, sillä kuka tietää, mikä tulisi sensuroida tai ei? Media on muuttanut kantaansa tietyistä tiedoista ja ihmisistä, jotka aiemmin sensuroitiin, eivät enää ole sensuurin kohteena.

- Kuka päättää, mikä on sensuuria tai propagandaa?
- Kuka hallitsee jumalallista kättä järjestelmässämme?
Sensuurin sietäminen voi tuhota sananvapauden ja kokoontumisvapauden. Sensuurin toteuttaminen on teknisesti vaikeaa ilman, että luodaan täydellinen dystopia. Mikä taho tulisi olla sensuurin vallassa? Sensuurin kysymys on monimutkainen, ja on vaikea tietää, kuka tulisi sensuroida tai ei. Sensuurilla voi olla negatiivinen vaikutus innovaatioon ja vapauteen ryhtyä toimiin.
Maailmassa on 2,4 miljardia ihmistä ilman pankkitiliä, mikä väistämättä luo maantieteellisiä epätasa-arvoisuuksia. Bitcoin mahdollistaa tasa-arvon transaktioissa riippumatta sosiaalisesta asemastasi tai poliittisesta asemastasi. Bitcoin-protokolla on apoliittinen eikä anna erityisoikeuksia presidentille tai muille toimijoille. Johtajien tulisi saada samat oikeudet kuin tavallisilla ihmisillä, jotta kehitys voisi edetä ylöspäin sen sijaan, että jotkut jäisivät huipulle ja toiset pohjalle. Pitäisikö kaikilla olla sama valuutta riippumatta heidän sosiaalisesta asemastaan? On tärkeää miettiä, millaisen maailman haluamme jättää lapsillemme. Haluamme jättää avoimen maailman, jossa he ovat vapaita tekemään mitä haluavat rahoillaan.

Bitcoin on tärkeä eikä sitä tulisi pitää vain onnenpelinä. On ratkaisevan tärkeää jatkaa Bitcoinia koskevien kysymysten esittämistä.

### Bitcoin: vallankumouksellinen protokolla

![Johtopäätös](https://youtu.be/BoZL_D7uLAg)

Kuten edellisessä luvussa näimme, Bitcoin-protokolla on neutraali kaikkia käyttäjiään kohtaan. Konsensus sääntöjen ja kryptografian ansiosta voimme kirjata transaktiot muuttumattomasti globaaliin julkiseen kirjanpitoon, taaten rahansiirrot ilman luotettua kolmatta osapuolta. Toisen kerroksen infrastruktuuri (ja pian kolmas kerros, RGB:n kanssa) mahdollistaa verkon skaalautuvuuden ja uusien toiminnallisuuksien kehittämisen, erityisesti skaalausongelmien ratkaisemiseksi.

Bitcoinilla on kaikki tarvittavat ominaisuudet ollakseen tehokas ja terve valuutta: jaettavissa, välittömästi siirrettävissä, sensuroimaton, vahvistuskustannukset ovat merkityksettömät, ja sillä on jo vuosisadoiksi asetettu rahapolitiikka näiden 21 miljoonan yksikön kanssa. Bitcoin on pseudonyymi ja sitä voidaan vaihtaa missä päin maailmaa tahansa ilman minkään tahon lupaa, tarvitset vain omat yksityiset avaimet - kuten sanonta kuuluu "Ei sinun avaimiasi, ei sinun bitcoinejasi".

Bitcoinia käyttävät monenlaiset ihmisryhmät, kryptografeista libertaareihin perinteisiin yrityksiin ja jopa maahan. Bitcoin on kuitenkin kaikille, ja sen käyttäjien määrä kasvaa, kuten myös Bitcoin-noodien määrä, jotka toimivat transaktiohistorian vartijoina varmistaen sen hajautetun luonteen.

Bitcoinia ei voi enää pysäyttää eikä sensuroida. Se on rauhanomainen vallankumous muuttaa rahajärjestelmää ja mahdollistaa taloudellisen osallisuuden. Käyttäjät voivat saada bitcoineja hyväksymällä niitä kaupankäynnissään tai ostamalla niitä säänneltyjen tai sääntelemättömien alustojen kautta. Bitcoineja voidaan säilyttää lompakoissa, mobiilisovelluksissa tai fyysisissä laitteissa. Bitcoinissa ei ole luotettua välittäjää, Bitcoin kannattaa läpinäkyvyyttä, vapautta ja yksilöllistä vastuuta - kuten sanonta kuuluu "Älä luota, varmista".

Rahoitusjärjestelmän muuttaminen vaatii valuutan muuttamista. Satoshi loi Bitcoinin vuonna 2008 ehdottaakseen yritystä tässä. Helppoon ja "taianomaiseen" rahaan pääsy turmelee. Bitcoin on siis vaihtoehto uuden neutraalin rahajärjestelmän rakentamiseen. Bitcoin mahdollistaa irtautumisen pankkijärjestelmästä. Se on sosiaalinen ilmiö, joka johdattaa meidät osallistumaan rauhanomaiseen vallankumoukseen. Oletko valmis liittymään?

## Kiitokset ja jatka kaninkolon tutkimista

### Mene pidemmälle

![kiitokset ja jatka kaninkolon tutkimista](https://youtu.be/A2P5GdkgB-M)

Onnittelut BTC 101 -kurssin suorittamisesta! Toivon vilpittömästi, että nautit siitä ja se avasi sinulle ovia. Bitcoinin löytäminen on vasta alussa, ja kutsun sinut tutkimaan kaikkia muita yliopistossa saatavilla olevia kursseja.
- [BTC 102](https://sovereignuniversity.org/course/btc102/fr) auttaa sinua luomaan bitcoin-suunnitelmasi
- [LN 201](https://sovereignuniversity.org/course/ln201/fr) ja [LN 202](https://sovereignuniversity.org/course/ln202/fr) mahdollistavat sinulle Lightning Networkin, toisen kerroksen maksuverkon, löytämisen
- [ECON 201](https://sovereignuniversity.org/course/econ201/fr) käsittelee itävaltalaista taloustiedettä
- [SECU 101](https://sovereignuniversity.org/course/secu101/fr) auttaa sinua päivittämään digitaalisen turvallisuutesi
- [MINAGE 201](https://sovereignuniversity.org/course/min201/fr) oppiaksesi lisää louhinnasta
- ja paljon muuta...
...
Koulutuksen arviointijärjestelmä integroidaan pian tähän uuteen E-oppimisalustaan! Siihen asti, suurkiitos kurssin suorittamisesta ja jos pidit siitä, harkitse sen jakamista muiden kanssa.
