...
*Ledgerは2025年6月25日をもって従来型Nano Sのソフトウェアサポート終了を発表しました。このデバイスは今後セキュリティアップデートや新機能への対応がなくなり、ユーザーは脆弱性や将来的な非互換性のリスクにさらされます。ただし、資産はニーモニックフレーズを使えば引き出せますが、ビットコインの安全性と将来の利用を確保するためにも新しいモデルへ移行することを強く推奨します。なお、これは**旧Nano S**についてであり、**Nano S Plus**は引き続きサポートされます。*
