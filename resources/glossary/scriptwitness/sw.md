...
> ► *Kuwa mwangalifu usichanganye `script Witness` na `witnessScript`. Ingawa `script Witness` ina data ya shahidi ya ingizo lolote la SegWit, `witnessScript` inafafanua masharti ya matumizi ya P2WSH au P2SH-P2WSH UTXO na kuunda hati yenyewe, sawa na `redeemscript` kwa pato la P2SH.*