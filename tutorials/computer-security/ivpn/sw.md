...
Katika somo hili, ninawasilisha suluhisho rahisi, la ufanisi na la bei ya VPN ambalo halihitaji maelezo ya kibinafsi kwa matumizi yake.
...
## Jinsi ya kufunga IPP kwenye kompyuta?

Pakua [toleo jipya zaidi la programu](https://www.ivpn.net/en/apps-windows/) kwa mfumo wako wa uendeshaji, kisha uendelee na usakinishaji kwa kufuata hatua katika kichawi cha usakinishaji. ![IVPN](assets/notext/02.webp)

Kwa watumiaji wa Linux, rejelea maagizo mahususi kwa usambazaji wako unaopatikana kwenye [ukurasa huu](https://www.ivpn.net/en/apps-linux/).

![IVPN](assets/notext/03.webp)

Mara usakinishaji ukamilika, utahitaji kuingiza kitambulisho cha akaunti yako. Tutaona jinsi ya kuipata katika sehemu zifuatazo za somo hili.

![IVPN](assets/notext/04.webp)

## Jinsi ya kufunga IPP kwenye smartphone?


Pakua IVPN kutoka duka lako la programu, iwe ni [AppStore](https://apps.apple.com/us/app/ivpn-secure-vpn-for-privacy/id1193122683) kwa watumiaji wa iOS, [Google Play Store](https://play.google.com/store/apps/details?id=net.ivpn) ya Android,auclick. [F-Droid](https://f-droid.org/en/packages/net.ivpn.client). Ikiwa unatumia Android, pia una chaguo la kupakua faili ya `.apk` moja kwa moja kutoka [tovuti ya IVPN](https://www.ivpn.net/en/apps-android/).
...
Sasa, hebu tuendelee na kuwezesha IVPN kwenye vifaa vyako.


## Jinsi ya kulipia na kuwezesha IVPN?


Nenda kwenye tovuti rasmi ya IPP [kwenye ukurasa wa malipo](https://www.ivpn.net/en/pricing/).

![IVPN](assets/notext/07.webp)

Chagua mpango unaofaa zaidi mahitaji yako. Kwa somo hili, tutachagua mpango wa Kawaida, ambao unatuwezesha kuwezesha VPN kwenye kompyuta na smartphone yetu, kwa mfano.
...
Katika ukurasa huo huo, chagua muda wa usajili wako kwa huduma.
...
Akaunti yako sasa inaonekana kama "*Inayotumika*," na unaweza kuona tarehe ambayo ufikiaji wako wa VPN ni halali. Baada ya tarehe hii, utahitaji kufanya upya malipo yako.

![IVPN](assets/notext/15.webp)

Ili kuwezesha muunganisho wako kupitia IPP kwenye Kompyuta yako, nakili kitambulisho cha akaunti yako.

![IVPN](assets/notext/16.webp)

Na ubandike kwenye programu uliyopakua hapo awali.
...
Bofya alama ya kuteua ili kuamilisha muunganisho wa VPN, na hapo ulipo, trafiki ya mtandao ya kompyuta yako sasa imesimbwa kwa njia fiche na kupitishwa kupitia seva ya IVPN.

![IVPN](assets/notext/19.webp)

Kwa smartphone yako, utaratibu ni sawa. Bandika kitambulisho cha akaunti yako au changanua msimbo wa QR unaohusishwa na akaunti yako ya IVPN inayopatikana kutoka kwa tovuti. Kisha, bofya alama ya kuangalia ili kuanzisha muunganisho.
...
Pia una chaguo la kusitisha VPN yako kwa muda maalum.
...
Inawezekana pia kuwezesha au kulemaza ngome iliyounganishwa pamoja na kitendakazi cha kupambana na kifuatiliaji.

![IVPN](assets/notext/24.webp)

Ili kufikia mipangilio ya ziada, bofya kwenye ikoni ya mipangilio.
...
Katika kichupo cha "*Jumla*", kuna mipangilio kadhaa ya mteja. Ninakushauri uangalie chaguo za "*Zindua unapoingia*" na "*Inapozindua*" katika sehemu ya "*Unganisha kiotomatiki*" ili utambue kiotomatiki muunganisho wa VPN unapowasha mashine yako.

![IVPN](assets/notext/27.webp)

Katika kichupo cha "*Connection*", utapata chaguo mbalimbali zinazohusiana na uunganisho. Hapa ndipo unaweza kubadilisha itifaki ya VPN inayotumiwa.

![IVPN](assets/notext/28.webp)

Kichupo cha "*IVPN Firewall*" hukuruhusu kuwezesha ngome kwa utaratibu mwanzoni mwa kompyuta, na kuhakikisha kuwa hakuna muunganisho wowote unaowekwa nje ya VPN.

![IVPN](assets/notext/29.webp)

Kichupo cha "*Split Tunnel*" kinatoa uwezekano wa kutenga programu fulani kutoka kwa muunganisho wa VPN. Programu zinazoongezwa hapa zitaendelea kufanya kazi kwa muunganisho wa kawaida wa intaneti hata VPN ikiwa imewashwa.

![IVPN](assets/notext/30.webp)

Katika kichupo cha "*WiFi control*", una chaguo la kusanidi vitendo maalum kulingana na mitandao ambayo umeunganishwa. Kwa mfano, unaweza kuteua mtandao wako wa nyumbani kama "*Inayoaminika*" na usanidi VPN ili isiwashe kwenye mtandao huu, lakini iwashe kiotomatiki kwenye mtandao mwingine wowote wa WiFi.

![IVPN](assets/notext/31.webp)

Katika menyu ya "*AntiTracker*", chagua wasifu wa kuzuia wa kifuatiliaji chako. Hii imeundwa kuzuia matangazo, programu hasidi na vifuatiliaji data kwa kuzuia maombi ya huduma za ufuatiliaji unapovinjari Mtandao. Hii huongeza faragha yako kwa kuzuia makampuni kukusanya na kuuza data yako ya kuvinjari. "*Hardcore Mode*" inapatikana pia ili kuzuia kabisa vikoa vyote vinavyomilikiwa na Google na Meta, pamoja na huduma zote tegemezi.
...
Ikiwa una nia ya kugundua mtoa huduma mwingine wa VPN sawa na IVPN, kwa suala la vipengele na bei, ninapendekeza pia kuangalia mafunzo yetu kwenye Mullvad:
