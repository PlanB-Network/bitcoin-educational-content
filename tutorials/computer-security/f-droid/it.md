...
Nell'era digitale, le grandi aziende e le istituzioni stanno lavorando per rendere Internet più centralizzato, mettendone il controllo nelle proprie mani e ostacolando così la privacy e la libertà di tutti gli utenti. Non è un'utopia, sta già accadendo. Come bitcoiner, la decentralizzazione, il rispetto della privacy e delle libertà individuali sono principi che vi stanno a cuore, soprattutto negli strumenti che utilizzate quotidianamente. Android, a differenza di iOS, ha permesso per anni la coesistenza di diversi app store all'interno del suo ecosistema, dandovi la libertà di trovare e installare applicazioni dalle vostre fonti preferite.
...
È possibile scaricare F-droid da [il sito ufficiale](https://f-droid.org/) in formato APK e installarlo manualmente sul proprio telefono Android.
...
Su Android, assicurarsi di concedere i permessi di installazione per il browser da cui si è scaricato F-Droid.
...
Nell'Application Store troverete diverse categorie di applicazioni adatte alle vostre esigenze. Nella scheda **Categorie** troverete oltre 20 tipi di applicazioni, dai browser agli editor di testo libero, e tutte richiedono il minimo di informazioni da parte vostra.



Desiderate installare un'applicazione specifica? Fate clic sul pulsante **Ricerca**, quindi inserite il nome dell'applicazione che state cercando.
...
F-Droid fornisce tutte le informazioni necessarie per decidere se l'utilizzo di un'applicazione protegge i vostri dati e migliora la vostra privacy. Esaminate tutte le applicazioni che desiderate utilizzare, quindi fate clic sul pulsante **Installa** per scaricare e installare l'applicazione.


Concedere i diritti di installazione di F-Droid abilitando l'opzione nelle impostazioni.
...
## Exchange le vostre applicazioni
...
Nella scheda **Aggiornamento**, consultate l'elenco degli aggiornamenti disponibili e assicuratevi di leggere anche le informazioni sulle nuove versioni di ciascuna applicazione per conoscere eventuali modifiche importanti alla versione in uso.
...
È inoltre possibile aggiornare l'elenco delle applicazioni disponibili aggiornando la pagina (scorrere verso il basso).
...
Nella sezione **Sviluppatori** della [documentazione](https://f-droid.org/en/docs/), troverete tutte le risorse necessarie per pubblicare e mantenere le vostre applicazioni su F-Droid.
...
Mettere un'applicazione in open source è spesso sinonimo di maggiore sicurezza, ma anche di notevoli rischi. Come si può garantire che non vi siano alterazioni dannose nel codice sorgente di un'applicazione disponibile su F-Droid?
...
Se vi è piaciuto questo tutorial, scoprite di più sul nostro corso di sicurezza informatica e gestione dei dati:
