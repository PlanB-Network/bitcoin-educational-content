...
這些加密交換需要在 Cahoots 參與者之間建立連線和驗證。Soroban 的通訊依賴使用者的 Paynyms。如果您不熟悉 Paynyms，我邀請您參考這篇文章以瞭解更多詳細資訊：[BIP47 - PAYNYM](https://planb.academy/tutorials/privacy/on-chain/paynym-bip47-a492a70b-50eb-4f95-a766-bae2c5535093)
