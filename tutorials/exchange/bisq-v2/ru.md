...
Это руководство посвящено исключительно «Bisq Easy» — единственному протоколу, доступному в настоящее время. Bisq Easy был специально разработан для новых пользователей Биткойна. Этот протокол позволяет пользователям покупать и продавать биткойны за фиатные валюты на децентрализованной платформе peer-to-peer. Сделки ограничены эквивалентом 600 долларов США (минимум 6 долларов), а безопасность обмена основана на репутации продавцов BTC. В Bisq Easy нет торговых комиссий и требований по внесению залога. Ожидается, что Bisq Easy заменит Bisq 1 для фиатных сделок ниже 600 долларов США (или эквивалента).
...
- Покупатель осуществляет оплату в фиатной валюте и уведомляет продавца
