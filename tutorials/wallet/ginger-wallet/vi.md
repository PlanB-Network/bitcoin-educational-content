...
CoinJoin** là một loại cấu trúc giao dịch đặc biệt của Bitcoin, tập hợp nhiều bên tham gia vào một giao dịch hợp tác duy nhất. Cơ chế này trộn lẫn các mục nhập của nhiều người dùng khác nhau vào một giao dịch chung, khiến việc theo dõi nguồn tiền trở nên cực kỳ khó khăn - nếu không muốn nói là thường không thể thực hiện được - nếu được thực hiện đúng cách. Kết quả là, người quan sát bên ngoài gần như không thể xác định chắc chắn nguồn gốc và đích đến của số bitcoin liên quan, không giống như trong các giao dịch Bitcoin thông thường.



Đối với bạn, người dùng, CoinJoin giúp bảo vệ tính bảo mật của bạn. Ví dụ: nếu bạn nhận được khoản quyên góp 10.000 Sats trên Bitcoin Address, người gửi có thể theo dõi số tiền này và, trong một số trường hợp, suy ra rằng bạn nắm giữ một lượng bitcoin lớn hơn, hoặc theo dõi các hoạt động của bạn. Bằng cách thực hiện CoinJoin sau khoản quyên góp 10.000 Sats này, bạn đã phá vỡ khả năng theo dõi: người gửi sẽ không còn có thể lấy được bất kỳ thông tin nào về bạn từ khoản thanh toán này nữa.



Chaumian CoinJoin mang lại mức độ bảo mật cao, vì tiền luôn nằm dưới sự kiểm soát độc quyền của người dùng. Ngay cả người vận hành máy chủ điều phối cũng không thể chuyển hướng bitcoin của người tham gia trong bất kỳ trường hợp nào. Cả người dùng và người điều phối đều không cần tin tưởng lẫn nhau: mỗi bên đều nắm quyền kiểm soát khóa riêng của mình và chỉ được phép xác thực giao dịch. Do đó, không bên thứ ba nào có thể chiếm đoạt bitcoin của bạn trong CoinJoin, cũng như không thể thiết lập liên kết trực tiếp giữa dữ liệu đầu vào và đầu ra của bạn.
...
Ngay từ đầu, Ginger đã nhắc bạn về chi phí liên quan đến quy trình CoinJoin.
...
Sau khi thêm vào, passphrase này sẽ được yêu cầu mỗi khi bạn truy cập vào danh mục đầu tư của mình.
...
Sau khi tạo xong danh mục đầu tư đầu tiên, bạn sẽ được chuyển đến Interface Wallet của Ginger.
...
Ginger hỗ trợ việc sử dụng danh mục phần cứng thông qua tiêu chuẩn Bitcoin core Interface, mặc dù khả năng tích hợp trực tiếp từ hoặc đến danh mục phần cứng vẫn chưa khả dụng.
...
Tab này cho phép bạn kích hoạt Bitcoin Knots chạy khi ứng dụng khởi động, chọn mạng (Main/RegTest) và nhà cung cấp mức phí (Mempool Space/BLOCKSTREAM info/Full node), v.v.
...
- trong CoinJoin, người điều phối có thể liên kết đầu vào và đầu ra của bạn với IP Address;
- khi phát sóng một giao dịch, một nút độc hại mà bạn kết nối có thể liên kết giao dịch của bạn với IP của bạn.



Đừng quên nhấn **Xong** (ở góc dưới bên phải Coin) mỗi lần để lưu cài đặt. Một số cài đặt yêu cầu phải khởi động lại Ginger Wallet để có hiệu lực.
...
- CoinJoin** (nơi bạn có thể tùy chỉnh cài đặt CoinJoin của danh mục đầu tư này);
...
- Nhập tên nguồn mà bạn muốn liên kết với Address. Đây là nhãn để theo dõi các khoản thanh toán của bạn. Nhãn này không liên quan gì đến On-Chain; nó chỉ đơn giản là thông tin truy xuất nguồn gốc được lưu trữ cục bộ trong ứng dụng của bạn;
...
- nhấp vào mũi tên nhỏ bên trái **generate** để chọn định dạng Address của bạn (**SegWit** /**Taproot**), sau đó nhấp vào **generate**, để generate và Address và mã QR.
...
Người gửi sẽ sử dụng mã Address hoặc mã QR này để gửi bitcoin cho bạn.
...
Video hướng dẫn cách gửi qua Ginger Wallet.
...
- Nhấn nút **Gửi**;
- nhập mã Address của người nhận, số tiền cần gửi và nhãn;
...
- Nhấn nút **Mua**. Nút này vẫn hiển thị ngay cả khi Wallet đã hết hàng.
...
- Hãy chọn quốc gia hoặc thậm chí tiểu bang của bạn (ở một số khu vực, chẳng hạn như Canada) trước khi tiến hành mua Bitcoin. Trên thực tế, khi bạn nhấp vào chức năng **Mua** lần đầu tiên, bạn cũng cần chỉ định khu vực của mình.
...
Coin góc trên bên phải màn hình với nhãn **Tất cả** cho phép bạn lọc ưu đãi theo phương thức thanh toán. Phương thức thanh toán bạn chọn sẽ được đặt mặc định, nhưng bạn có thể thay đổi bất cứ lúc nào.
...
- Bây giờ bạn cần hoàn tất giao dịch:
 ...
 - Vào một thời điểm nào đó, bạn sẽ nhận được người nhận Address và số tiền chính xác cần gửi;
...
Thao tác này sẽ mở màn hình **Gửi** với mã Address và số tiền đã được điền sẵn của người nhận. Bạn cũng có thể sử dụng nút **Gửi** trên màn hình chính. Mặc dù bạn có thể gửi giao dịch theo cách thủ công, chúng tôi khuyên bạn nên hoàn tất giao dịch thông qua hộp thoại để tối ưu hóa quy trình.



## Tạo CoinJoin trên Ginger Wallet
...
Bảo vệ tính bảo mật của bitcoin của bạn với **CoinJoin**, được tích hợp trực tiếp vào Ginger Wallet. Wallet sử dụng **WABISABI**, một giao thức Chaumian CoinJoin được thiết kế để tạo điều kiện cho việc kết nối coinjoin dễ dàng và hiệu quả hơn.
...
Ginger CoinJoin đã sẵn sàng sử dụng ngay sau khi bạn tải xuống (không cần thực hiện thêm bước nào). Ginger CoinJoin sẽ tự động chạy nền để bảo vệ quyền riêng tư của bạn trong mọi giao dịch. Trên thực tế, trình đọc CoinJoin sẽ xuất hiện bất cứ khi nào bạn có số dư có thể ẩn danh.



Đối với việc khởi động thủ công CoinJoin, chỉ cần một cú nhấp chuột. Bắt đầu vòng chơi và chờ giao dịch CoinJoin được xây dựng và xác nhận. Bạn sẽ thấy điểm ẩn danh trong Interface.
...
Theo mặc định, Ginger sử dụng bộ điều phối riêng với tất cả các tham số được cấu hình sẵn và phí được đảm bảo. Việc kết hợp coinjoin các token có giá trị hơn 0,03 BTC sẽ phải chịu phí điều phối 0,3% ngoài phí Mining. Các khoản đầu tư từ 0,03 BTC trở xuống, cũng như các giao dịch phối lại, được miễn phí điều phối, ngay cả sau một giao dịch duy nhất. Do đó, khoản thanh toán được thực hiện bằng quỹ CoinJoin cho phép cả người gửi và người nhận phối lại coin của họ mà không phải chịu phí điều phối.



Ginger thích coinjoin với nhiều người tham gia hơn là các vòng nhỏ hơn, nhanh hơn. Coinjoin lớn hơn mang lại tính ẩn danh cao hơn, chi phí thấp hơn và hiệu quả hơn trong không gian BLOCK.
...
- Sử dụng Address khác nhau cho mỗi lần tiếp nhận để tránh việc sử dụng lại địa chỉ;
...
Nếu bạn thấy hướng dẫn này hữu ích, vui lòng để lại cho tôi một hình ảnh Green bên dưới. Đừng ngần ngại chia sẻ bài viết này qua các nền tảng mạng xã hội của bạn. Cảm ơn bạn rất nhiều!
