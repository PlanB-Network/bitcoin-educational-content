...
Kontrola monet jest szczególnie przydatna do zarządzania opłatami transakcyjnymi i zwiększania prywatności. W rzeczywistości, wybierając UTXO do konsumpcji, użytkownicy mogą uniknąć łączenia UTXO z różnych źródeł, co mogłoby ujawnić informacje o ich wszystkich funduszach (CIOH). Funkcja ta często wiąże się z możliwością oznaczania wyników transakcji.