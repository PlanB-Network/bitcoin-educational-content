...
資金の割り当てを想像する別の方法は、チャネル内で資金がどこにあるかを示す**カーソル**を思い描くことです。最初は、アリスに100,000サトシ、ボブに30,000サトシある場合、カーソルはボブ側にあります。なぜなら、アリスの方がはるかに多くの資金を持っているからです。40,000サトシの取引後、カーソルはわずかにアリス側に移動し、アリスは現在70,000サトシを所有しています。
