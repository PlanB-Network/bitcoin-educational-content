...
Pour expliquer de manière simplifiée le concept du [minage](https://planb.academy/resources/glossary/mining), une analogie pertinente peut être employée : celle du puzzle. Tout comme un puzzle, le minage est une tâche complexe à réaliser, mais facile à vérifier une fois complétée. Dans le contexte du minage de Bitcoin, les [mineurs](https://planb.academy/resources/glossary/miner) s'efforcent de résoudre rapidement un puzzle numérique. Le premier mineur à résoudre le puzzle présente sa solution au réseau entier, qui peut alors facilement vérifier sa validité. Cette vérification réussie permet au mineur de valider un nouveau [bloc](https://planb.academy/resources/glossary/block) et de l'ajouter à la Timechain de Bitcoin. En reconnaissance de leur travail, qui implique des coûts significatifs, le mineur est récompensé par un certain nombre de bitcoins. Cette récompense constitue une incitation financière pour les mineurs à continuer leur travail de validation des [transactions](https://planb.academy/resources/glossary/transaction-tx) et de sécurisation du réseau Bitcoin.
...
La centralisation du minage est abordée comme un défi majeur. De grands acteurs, tels que Foundry, dominent le marché, ce qui peut potentiellement entraîner la censure des transactions. Cette centralisation peut également rendre le réseau vulnérable à des attaques, notamment l'[attaque des 51%](https://planb.academy/resources/glossary/51-percent-attack), où un acteur ou un groupe contrôle plus de 50% de la puissance de hachage du réseau, leur permettant ainsi de contrôler et de manipuler le réseau.
...
La guerre des blocs a révélé l'incertitude et la tension inhérentes à la gestion du réseau Bitcoin. Bien que [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core) soit actuellement la chaîne dominante, le débat sur la gouvernance et la gestion du réseau persiste.
...
La possibilité de miner des bitcoins vierges tout en évitant les procédures de connaissance du client ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)) est une autre valeur ajoutée. De nombreux pools de minage ne demandent pas l'identité des mineurs, permettant ainsi d'acquérir des bitcoins sans passer par de fastidieuses vérifications d'identité. Les bitcoins vierges sont perçus comme "blancs", ne portant aucune histoire ni association passée. Ils sont particulièrement recherchés par les gros acteurs institutionnels qui peuvent garantir la légitimité de leurs actifs numériques face aux autorités de régulation. Cependant, malgré ces avantages, il est crucial de reconnaître que l'industrie du minage reste extrêmement compétitive et volatile et que des incidents imprévus peuvent perturber les opérations de minage.
...
Ensuite copiez l’adresse [Stratum](https://planb.academy/resources/glossary/stratum) ainsi que votre username :
