...
![mauvaise interprétation stonewall x2](assets/fr/4.png)
...
![demande paynym samourai](assets/fr/8.png)

Cliquez ensuite sur le `+` bleu en bas à droite de l'écran.
![ajouter paynym collaborateur](assets/fr/9.png)
...
![coller identifiant paynym](assets/fr/10.png)

Cliquez sur le bouton `SUIVRE`.
![suivre paynym](assets/fr/11.png)
Validez en cliquant sur `YES`.
![valider suivre paynym](assets/fr/12.png)
...
![connecter paynym](assets/fr/13.png)
...
![demande paynym sparrow](assets/fr/14.png)
...
![ajouter paynym contact](assets/fr/15.png)
