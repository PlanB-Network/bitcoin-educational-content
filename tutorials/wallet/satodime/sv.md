...
**Satodime**, utvecklat av **[Satochip](https://satochip.io/fr/)**, är ett säkert innehavarkort för att lagra Bitcoin på ett konkret och enkelt sätt. Det fungerar som en självförvarad Hardware Wallet, där du har full kontroll över dina privata nycklar utan att vara beroende av en tredje part. Open-source och EAL6+-certifierad, den stöder upp till tre oberoende kassaskåp.
...
Satodime, ett **carte au porteur, tillhör den som fysiskt innehar det**, utan behov av föregående registrering eller identifiering. Det uppfyller behovet av säker, portabel Bitcoin-lagring, vilket gör att alla som har kortet kan använda det eller överföra bitcoins genom att skanna det via mobilappen för att ta det i besittning eller öppna kassaskåp. Till skillnad från en papperssedel använder det ett säkert chip för att Seal de privata nycklarna, som avslöjas först efter att förseglingen har öppnats, vilket gör att kortet liknar kontanter där Ownership bestäms av fysisk besittning. Det är idealiskt för att ge bitcoins som gåvor och underlättar säker överföring av bitcoins från hand till hand, medan mobilapplikationen utnyttjar NFC för tillgänglig smartphone-interaktion.
...
- Varning**: Detta steg är irreversibelt. Se [artikeln *Ownership*] (https://satochip.io/satodime-Ownership-explained/).
...
- Välj Blockchain (Bitcoin).
- Klicka på "*Create & Seal*".
- Skanna kortet till generate och Seal den privata nyckeln (okänd tills den öppnas).
...
- Kopiera den offentliga Address eller skanna QR-koden.
- Skicka pengar från en annan Wallet.
- Kontrollera saldot efter bekräftelse på Blockchain.
...
Om kassaskåpet återställs raderas den tillhörande privata nyckeln på ett oåterkalleligt sätt. Med andra ord, om du inte har säkrat en kopia av din privata nyckel eller importerat den till en annan Wallet, kommer en återställning av kassaskåpet att leda till en oåterkallelig förlust av pengarna i det.
...
- Överför Satss dit,
- Överföra kort Ownership: nästa person som skannar kortet blir dess ägare,
- Ge Satodime-kortet till den person du väljer och uppmana dem att ladda ner applikationen och sedan skanna kortet för att ta Ownership av det - och därmed få tillgång till de bitcoins som "lagras" på det.
...
- Kontrollera status**: Skanna alltid för att bekräfta kort Ownership och förseglad/ej förseglad status för kassaskåp.
...
- Återvinning**: Om kortet förloras men ägs finns pengarna på Blockchain; använd den privata nyckeln om den inte är förseglad.
...
[Plan ₿ Network] (https://planb.network/) för handledning om självförtroende, privata nycklar etc.
...
**Satochip** är ett belgiskt företag som utvecklar hård- och mjukvarulösningar för hantering och lagring av bitcoins och andra kryptovalutor. Företagets flaggskeppsprodukt, Satochip Hardware Wallet, är ett NFC-kort utrustat med en EAL6+-certifierad secure element. Tillsammans med Seedkeeper, en Mnemonic fras- och hemlighetshanterare, och Satodime, ett innehavarkort, erbjuder Satochip ett omfattande sortiment som är skräddarsytt för användarnas behov. Enheterna, som drivs av programvara med öppen källkod, syftar till att demokratisera säkerheten på Bitcoin.