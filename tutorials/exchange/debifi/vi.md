...
Trong nhiều thế kỷ, hoạt động cho vay truyền thống đã giúp tài trợ cho nhiều dự án. Tuy nhiên, hình thức này vẫn còn chậm, tốn kém và chưa thực sự toàn diện, đặc biệt là đối với những người chưa tiếp cận được cơ sở hạ tầng ngân hàng vững chắc.
...
Debifi là một nền tảng cho vay phi lưu ký được hỗ trợ bởi Bitcoin, nghĩa là bạn vẫn giữ quyền kiểm soát khóa riêng tư của mình. Nền tảng này cho phép người dùng mở khóa thanh khoản trong Exchange để thế chấp bằng bitcoin bị khóa của họ. Không giống như các khoản vay ngân hàng truyền thống, Debifi sử dụng hệ thống ký quỹ đa chữ ký (3/4) và không chấp nhận thế chấp tài sản thế chấp, đảm bảo tính bảo mật và minh bạch cao hơn.



Trên thực tế, điều này có nghĩa là cả Debifi lẫn người cho vay cá nhân đều không thể chi tiêu BTC của bạn mà không có sự đồng ý của ba bên (bạn, người cho vay và một bên thứ ba đáng tin cậy). Điều này làm cho hệ thống an toàn hơn: nếu bạn vay trên Debifi, bạn sẽ giữ lại Ownership trong số Bitcoin của mình cho đến khi khoản vay được hoàn trả đầy đủ.
...
Với Debifi, bạn sẽ được hưởng các khoản vay thế chấp, bảo mật Blockchain (đa chữ ký, 2FA), lựa chọn stablecoin/thanh khoản, tính bảo mật và quyền kiểm soát hoàn toàn Bitcoin. Debifi "cho phép bạn giữ tiền" (khóa của bạn, tiền của bạn), đồng thời cung cấp lãi suất cạnh tranh và quyền truy cập toàn cầu vào các khoản vay được hỗ trợ bằng BTC.
...
- Bitcoin Wallet: nơi bạn giữ BTC của mình (tốt nhất là không lưu ký, ví dụ: Hardware Wallet hoặc Wallet di động đáng tin cậy). Bạn sẽ gửi tài sản thế chấp Bitcoin đến Debifi và nhận tiền từ Wallet này.





- Stablecoin hoặc tiền pháp định: Debifi cho vay stablecoin và một số loại tiền pháp định. Các loại stablecoin chính được sử dụng là USDT và USDC.
...
- Ứng dụng xác thực hai yếu tố: Debifi yêu cầu mã Authenticator cho mọi hành động quan trọng. Đây là một biện pháp bảo mật bổ sung Layer. Trong hướng dẫn này, chúng ta sẽ sử dụng Google Authenticator. Ngoài ra, bạn có thể sử dụng các phương thức khác tùy ý.
...
Sau đó nhấp vào **Đăng nhập hoặc tạo tài khoản** để tạo tài khoản bằng email Address của bạn.
...
- Tiếp theo, hãy thiết lập xác thực hai yếu tố (2FA) để liên kết thiết bị của bạn với tài khoản bằng mã 2FA.
...
- Tỷ lệ LTV bảo thủ (20% - 40%), tương ứng với khoản vay rủi ro thấp, lý tưởng để tối đa hóa sự an toàn trước biến động giá Bitcoin;
...
- Ưu đãi tích cực (LTV từ 70% - 85%), mang lại tính thanh khoản cao hơn, nhưng đi kèm rủi ro thanh lý rất cao trong thời kỳ thị trường suy thoái. Việc theo dõi sát sao tình hình thị trường Bitcoin là điều bắt buộc khi lựa chọn đợt này.
...
Lịch trình trả nợ cho các khoản vay thường linh hoạt và được điều chỉnh theo nhu cầu của người dùng. Việc thanh toán có thể được thực hiện bất kỳ lúc nào miễn là đáp ứng các yêu cầu về tài sản thế chấp. Các khoản thanh toán cho vay thường bao gồm lãi suất trong suốt thời hạn vay, và gốc phải trả khi đáo hạn.
...
Do giá Bitcoin biến động, một khoản vay có trách nhiệm bao gồm các chính sách yêu cầu ký quỹ cụ thể trong hợp đồng. Chính sách này cho phép người vay được thông báo để cung cấp thêm tài sản thế chấp hoặc trả một phần khoản vay.
...
7. Phải nhập Ethereum USDC Address được sử dụng để nhận tiền.
...
Bước tiếp theo là ký Contract. Vẫn trong ứng dụng di động, hãy nhấn '' **Ký Contract** ''
...
Khi bạn hoàn tất việc ký Contract, Debifi sẽ tự động tạo một Bitcoin Address đa chữ ký duy nhất (ký quỹ 3-sur-4) cho Contract của bạn. Miễn là bitcoin của bạn vẫn còn trong ký quỹ, chúng sẽ không thể được sử dụng ở nơi khác.
...
Bước cuối cùng là gửi tài sản thế chấp Bitcoin của bạn vào hệ thống ký quỹ đa chữ ký. Sau đó, Debifi sẽ hiển thị cho bạn tài sản ký quỹ Address (B) và số lượng BTC (A) cần gửi (tài sản thế chấp + hoa hồng).
...
Ngay khi khoản tiền gửi của bạn được xác nhận, bên cho vay sẽ trả số tiền vay vào người nhận Address mà bạn đã chỉ định, hoàn tất giao dịch và cung cấp cho bạn quyền truy cập vào số tiền bạn cần.
...
Trên thực tế, sau khi Contract được tạo, phí cho vay sẽ tự động được khấu trừ từ tài sản thế chấp được người vay ký quỹ trong hợp đồng ký quỹ nhiều chữ ký Address.
...
Phí cho vay áp dụng là 1,5-2%, tùy thuộc vào thời hạn của Contract. Nền tảng chỉ tính phí hoa hồng cho Bitcoin.
...
Sau khi khoản vay được xử lý, Debifi cho phép bạn theo dõi Contract của mình theo thời gian thực. Trong Interface, bạn sẽ thấy:
...
- Tỷ lệ LTV (Lãi suất cho vay trên Giá trị) hiện tại: LTV tăng nếu giá BTC giảm (vì giá trị tài sản thế chấp của bạn thấp hơn). Ngưỡng cảnh báo (thường là 90%) được thiết lập. Nếu LTV của bạn vượt quá ngưỡng này, có nguy cơ bị thanh lý bắt buộc. Debifi sau đó sẽ cho bạn 24 giờ để phản hồi.



Người vay sẽ được thông báo về việc giảm giá. Thông tin này cũng sẽ có sẵn trên trang tóm tắt Contract. Để khôi phục tỷ lệ cho vay trên giá trị ban đầu của khoản vay, người vay phải:





- hoặc gửi thêm tiền bảo lãnh;
- trả toàn bộ hoặc một phần nợ.



Trong trường hợp giá tài sản thế chấp tăng, người vay sẽ được giữ lại bất kỳ khoản lãi vốn nào trên tài sản thế chấp. Người vay chỉ nợ số tiền vay, được xác định trước và không phụ thuộc vào giá Bitcoin.
...
- Truy cập Contract của bạn và nhấp vào **Thực hiện thanh toán**. Nhập tổng số tiền phải trả (gốc + lãi).





- Gửi stablecoin từ Wallet của bạn đến Address của bên cho vay được chỉ định và quay lại để xác nhận việc hoàn trả trên nền tảng bằng cách sao chép **ID** của giao dịch hoàn trả vào tab chuyên dụng. Điều này giúp Debifi dễ dàng thực hiện kiểm tra hơn.



Sau khi bên cho vay (và bạn) xác nhận khoản thanh toán, Debifi sẽ yêu cầu bạn **hoàn tiền**. Tài sản thế chấp Bitcoin của bạn sẽ được giải phóng và bạn có thể trả lại từ tài khoản ký quỹ vào danh mục đầu tư của mình. Đừng quên thu thập tất cả Bitcoin của bạn.



Ngay khi bạn nhận được bitcoin, khoản vay Contract sẽ thay đổi thành **Contract đã hoàn tất**.
...
Kiểm soát khóa của bạn. Giữ BTC của bạn trong một ví Wallet an toàn (tốt nhất là phần cứng hoặc một ví Wallet uy tín). Không đặt mã PIN liên quan đến một ngày quan trọng trong cuộc đời bạn và không bao giờ chia sẻ cụm từ khôi phục. Trên Debifi, bạn sẽ nhập khóa riêng tư của mình vào ứng dụng - Debifi không biết điều đó.
...
Tôi khuyên bạn nên tham gia khóa học này, khóa học sẽ cung cấp cái nhìn sâu sắc về Bitcoin, Stablecoin và sự đóng góp của chúng cho chủ quyền.
