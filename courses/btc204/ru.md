...
Затем транзакция распространяется по всей сети на этапе "капитуляции".

![BTC204](assets/fr/206.webp)

Стебель и головка цветка - это отсылки к поведению транзакции, распространяющейся по сети, которая напоминает форму одуванчика.

Таким образом, узлы-шпионы потенциально могут отследить транзакцию до узла, запустившего фазу капитуляции (массовую трансляцию), но этот узел не является тем, кто первым передал транзакцию, поскольку он получил ее от последнего узла на стебле. Если узлы-шпионы не могут отследить стебель, они не могут определить и узел-источник.
