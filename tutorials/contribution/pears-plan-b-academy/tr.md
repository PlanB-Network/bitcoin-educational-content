...
#### 1.2.3. NVM aracılığıyla Node.js ve npm yükleyin
...
#### 1.2.4. Pears'ı npm ile yükleyin
...
#### 1.2.6. Armutları Keet ile Test Edin
...
### 1.3. Windows'ta Pears Nasıl Kurulur


Pears'ı Windows'a yüklemek Linux'ta olduğu kadar basittir ancak birkaç özel araç gerektirir.


*Linux kullanıyorsanız ve Pears'ı zaten yüklediyseniz, doğrudan **Adım 2**'ye geçebilirsiniz


#### 1.3.1. PowerShell'i Yönetici Olarak Açın
...
#### 1.3.5. Pears'ı npm ile yükleyin
...
#### 1.3.6. Armutları Doğrulama ve Başlatma
...
#### 1.3.7. Armutları Keet ile Test Edin
...
### 1.4. MacOS'ta Pears Nasıl Kurulur
...
*Linux veya Windows kullanıyorsanız ve Pears'ı zaten yüklediyseniz, doğrudan **Adım 2**'ye geçebilirsiniz.*


#### 1.4.1. Sistem Ön Koşullarını Kontrol Edin
...
#### 1.4.4. Pears'ı npm ile yükleyin
...
#### 1.4.6. Armutları Keet ile Test Edin
...
## 2. Armutlarda Plan ₿ Akademi Nasıl Kullanılır
...
## 3. seed Planı Nasıl Yapılır ₿ Armut Akademisi
