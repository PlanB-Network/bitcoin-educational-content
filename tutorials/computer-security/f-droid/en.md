---
name: F-Droid
description: The catalog of free and open-source applications.
---
...
You can download F-droid from [the official website](https://f-droid.org/) in APK format and install it manually on your Android phone.
...
You must then prepare a YAML file (the metadata) describing your application, including all the information and permissions required for its use, following the [metadata template](https://f-droid.org/docs/Build_Metadata_Reference/) proposed by F-Droid.


In the **Developers** section of the [documentation](https://f-droid.org/en/docs/), you'll find all the resources you need to publish and maintain your applications on F-Droid.
