...
- Linux (Debian)** → Jakso **1.2**
- Ikkunat** → kohta **1.3**
- macOS** → jakso **1.4**


### 1.2. Kuinka asentaa Pears Linuxiin (Debian)?
...
#### 1.2.3. Asenna Node.js ja npm NVM:n kautta
...
### 1.3. Kuinka asentaa Pears Windowsiin
...
#### 1.3.1. Avaa PowerShell järjestelmänvalvojana
...
#### 1.3.4. Asennusten tarkistaminen
...
#### 1.3.6. Päärynöiden tarkistaminen ja alustaminen
...
Pearsin asentaminen macOS-käyttöjärjestelmään on samanlaista kuin Linuxissa, mutta se vaatii muutamia Applen ympäristölle ominaisia muutoksia. Käydään nämä vaiheet läpi yhdessä.


*Jos käytät Linuxia tai Windowsia ja olet jo asentanut Pearsin, voit siirtyä suoraan **vaiheeseen 2**.*


#### 1.4.1. Tarkista järjestelmän edellytykset
...
## 2. Plan ₿ Academyn käyttö päärynöissä
...
## 3. Miten seed suunnitelma ₿ Academy on Pears (päärynät)
