---
name: Breez - POS
description: Breez giúp bạn dễ dàng thu tiền thanh toán Bitcoin cho doanh nghiệp của mình.
---
...
Breez POS là dịch vụ tự quản lý được cung cấp bởi Breez Wallet. Tiện ích của dịch vụ này là cho phép các thương nhân thu tiền qua Bitcoin trong khi vẫn duy trì hoạt động trên Interface đơn giản, rất giống với các ví Lightning khác. Breez POS có sẵn trên các nền tảng tải xuống [Google Play Store](https://play.google.com/store/apps/details?id=com.breez.client) (Android) và [App Store](https://apps.apple.com/app/breez-lightning-client-pos/id1463604142) (iOS).
...
Trong menu "*Điểm bán hàng*", bạn sẽ thấy biểu tượng Interface để thu tiền. Biểu tượng này được chia thành hai phần:
...
Phần đầu tiên là bàn phím ghi nợ trực tiếp. Interface này rất tiện lợi để thu một khoản thanh toán duy nhất khi bạn biết tổng số tiền mua hàng của khách hàng, hoặc khi bạn không cần một danh mục sản phẩm cố định trong doanh nghiệp của mình (ví dụ: dịch vụ tự do).
...
Để sử dụng Breez POS lần đầu tiên, bạn sẽ cần thanh toán hơn 2.500 satoshi (khoảng 3 euro theo tỷ giá Exchange hiện tại). Số tiền này, chỉ được thanh toán trong lần rút tiền đầu tiên của bạn, thể hiện chi phí tạo kênh thanh toán để bạn có thể giao tiếp với các nút Lightning Network khác và gửi/nhận satoshi.
...
Phần thứ hai là danh mục sản phẩm. Phần mềm Interface này lý tưởng khi bạn có danh mục sản phẩm với giá được định sẵn. Tại đây, bạn có thể cấu hình trước sản phẩm và sau đó sử dụng chúng để xuất hóa đơn generate nhằm cải thiện khả năng truy xuất nguồn gốc biên lai thu tiền.
...
Bạn có thể cấu hình thủ công từng mục từ Interface này bằng cách nhấp vào nút "**Plus**" rồi xác định tên, giá và mã định danh cho mục này.
...
Trong cùng phần này, bạn có thể xác định thời hạn hiệu lực của hóa đơn Lightning. Từ giờ trở đi, đối với tất cả hóa đơn, khách hàng của bạn có `N` giây để thanh toán, nếu không, bạn sẽ phải tạo lại một Lightning Invoice mới.
