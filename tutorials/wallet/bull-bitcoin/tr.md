...
- Otomatik Takas Ayarları**: Otomatik Takas_ işlevi, BTC'nizin **Anında Ödemeler Wallet'ten (Liquid)** **Bitcoin On-Chain** Wallet'inize aktarımını, miktar işlem ücretini haklı çıkarmak için yeterince yüksek olduğunu düşündüğünüz bir eşiğe ulaşır ulaşmaz otomatikleştirmenize olanak tanır.
