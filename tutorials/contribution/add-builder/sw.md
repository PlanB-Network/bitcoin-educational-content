...
- Nenda kwenye [hakuna ya GitHub ya PlanB iliyowekwa kwa data](https://github.com/Plan ₿ Academy/Bitcoin-educational-content/tree/dev/resources/projects) katika sehemu ya `rasilimali/mjenzi/`:
