...
- Kies een sterk wachtwoord en klik op de Green `Doorgaan` knop:

![github](assets/12.webp)


- Kies vervolgens je gebruikersnaam. Je kunt je echte identiteit onthullen of een pseudoniem gebruiken. Klik dan op de Green `Doorgaan` knop:
...
- Kies het gratis plan door op de knop `Gratis verder` te klikken:

![github](assets/7.webp)


- Je wordt dan doorverwezen naar je dashboard.
- Als je wilt, kun je je account aanpassen door op je profielfoto rechtsboven in het scherm te klikken en vervolgens naar het menu `Instellingen` te gaan:
...
- Ik raad ook aan om naar het menu `Wachtwoord en verificatie` te gaan om op zijn minst tweefactorauthenticatie in te stellen:
