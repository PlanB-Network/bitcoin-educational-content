...
- Po drugie, filozofia jest normatywna, w przeciwieństwie do historii, która jest jedynie opisowa. Tym samym filozofia polityczna różni się od nauk politycznych. Filozofia polityczna jest normatywna, co oznacza, że określa wartości i ocenia ludzkie działania według kryterium sprawiedliwości. Z drugiej strony, nauki polityczne zadowalają się opisywaniem reżimów, tworzeniem historii instytucji, bez dokonywania osądów wartościujących.
...
- Filozofia wolności opiera się na naturalnym prawie własności i twierdzi, że jedynym celem prawa jest ochrona własności prywatnej i umów. Każdy powinien móc robić, co chce z tym, co do niego należy, pod warunkiem, że nikogo nie krzywdzi. Jest to filozofia, która broni równej wolności dla wszystkich do dysponowania sobą i swoją własnością pod warunkiem odpowiedzialności. Jest to filozofia wolnego rynku.
- Filozofia władzy uzasadnia władzę pewnych podmiotów zbiorowych, takich jak państwo lub społeczeństwo, do decydowania o ograniczeniach, jakie należy nałożyć na rynek i własność, a tym samym na wolność. W tych ramach to prawo organizuje gospodarkę, zdrowie, mieszkalnictwo, kulturę, edukację... Ta konstruktywistyczna filozofia zawsze miała swoich obrońców, w imię zbiorowego interesu, równości, ochrony i dobrobytu.
...
> (Lord Acton)
> Innymi słowy, wolność to prawo jednostek do podążania za własnym sumieniem, a rolą państwa nie jest dyktowanie postępowania danej osoby w kwestiach filozoficznych, moralnych i religijnych.
> Friedrich Hayek początkowo rozważał nazwanie Mont Pelerin Society "Acton-Tocqueville Society", w hołdzie dwóm myślicielom, których głęboko podziwiał: Lordowi Actonowi i Alexisowi de Tocqueville'owi. Ostatecznie wybrano nazwę miejsca, w którym odbyło się pierwsze spotkanie Towarzystwa, Mont Pelerin w Szwajcarii.
...
> Jeśli chodzi o historiografię marksistowską, możemy również odnieść się do Friedricha Hayeka w _Capitalism and the Historians_ (University of Chicago Press, 1954) i jego rozdziału zatytułowanego "History and Politics". Według Hayeka to nie industrializacja uczyniła robotników nieszczęśliwymi, jak głosi mroczna legenda kapitalizmu propagowana przez marksizm. Zauważa on:
> Prawdziwa historia związku między kapitalizmem a powstaniem proletariatu jest niemalże przeciwieństwem tego, co sugerują teorie wywłaszczenia mas.
...
- Pokojowa współpraca i produkcja, które reprezentują dobrowolne Exchange i tworzenie bogactwa poprzez pracę i innowacje.
- Przymusowy wyzysk i drapieżnictwo, ucieleśnione przez dominację państwa, które siłą przywłaszcza sobie owoce pracy jednostek.
...
- Władza społeczna: wyłania się ze współpracy i pomysłowości wolnych jednostek, prowadząc do postępu gospodarczego i dobrobytu. Jest to władza nad naturą, twórcza zdolność człowieka do przekształcania natury w zasoby i wiedzę dla zbiorowego dobra społeczeństwa.
- Władza państwowa: jest narzucana za pomocą przymusu i przemocy, dążąc do kontrolowania i wykorzystywania społeczeństwa dla własnych korzyści. Jest to władza sprawowana nad człowiekiem. Polega na "drenowaniu owoców społeczeństwa na rzecz nieproduktywnych (w rzeczywistości antyproduktywnych) przywódców"
...
- Okresy wolności: gdy władza społeczna kwitnie, wzrasta wolność, pokój i dobrobyt.
- Okresy dominacji państwa: kiedy państwo zyskuje przewagę, co prowadzi do ucisku, wojny i regresji.
...
- _Phusis_ to prawo natury (od którego pochodzi słowo "fizyka" w języku francuskim).
- _Nomos_ to ludzkie prawo (termin ten można znaleźć w słowie "autonomia", które oznacza "przestrzeganie własnego prawa").
...
Cyceron, słynny rzymski orator i filozof z I wieku p.n.e., podjął tę ideę: "Jesteśmy niewolnikami praw, abyśmy byli wolni" (_De Republica_, Księga III, rozdział 13). W tym fragmencie Cyceron rozwija argument na rzecz republiki rządzonej przez prawa, a nie przez jednego człowieka lub małą grupę ludzi.
...
Według Karla Poppera, filozofom starożytnej Grecji, zwłaszcza presokratykom, zawdzięczamy wynalezienie krytycznego racjonalizmu, czyli zachodniej tradycji krytycznej dyskusji, źródła myśli naukowej i pluralizmu. Wyjaśnia to w rozdziale _Conjectures and Refutations_ zatytułowanym "Return to the Pre-Socratics":
...
- Na zachodzie rozciągał się od Wielkiej Brytanii (dzisiejsza Anglia) do Hiszpanii, przechodząc przez Galię (dzisiejsza Francja) i północ Afryki.
- Na północy sięgała do Renu i Dunaju, obejmując część Niemiec, Holandii, Szwajcarii, Austrii, Węgier, Rumunii i Bułgarii.
- Na południu graniczył z Morzem Śródziemnym, w tym z Włochami, Grecją, Bałkanami, Azją Mniejszą (dzisiejsza Turcja), Syrią, Libanem, Palestyną, Egiptem i Cyrenajką (część dzisiejszej Libii).
...
- Definiuje różne rodzaje własności (ziemia, ruchomości itp.)
- Dzieli własność na usus (prawo użytkowania), fructus (prawo do otrzymywania owoców) i abusus (prawo do alienacji)
- Określa warunki nabywania, przekazywania i ochrony tych towarów.
...
Dlatego, według niego, istnieje uniwersalna sprawiedliwość, wpisana w rozum i naturę. Cyceron pisze w _De Republica_:
...
Tak więc święty Tomasz pisze (_Summa contra Gentiles_, III, 69 i 122):
...
> Dzięki znajomości prawa naturalnego człowiek ma bezpośredni dostęp do wspólnego porządku rozumu, przed i ponad porządkiem politycznym, do którego należy jako obywatel określonego społeczeństwa.
> Dlatego istnieje prawo poprzedzające utworzenie państwa, zbiór ogólnych zasad, które rozum może wyartykułować, badając naturę człowieka taką, jaką stworzył go Bóg. Prawo to narzuca się monarsze, władzy, która musi je respektować. Prawa stanowione przez władzę polityczną są wiążące tylko w takim stopniu, w jakim są zgodne z prawem naturalnym.
...
- Z jednej strony **rozum**, który zaczyna się od natury, od rozsądnego doświadczenia, który rozwija idee i osiąga racjonalne pewniki poprzez swoje rozumowanie.
- Z drugiej strony, **wiara**, która zaczyna się od Objawienia, czyli świętego tekstu natchnionego przez Boga. Podejście jest odwrotne, to nie rzeczywistość lub ludzka cecha (myśl) prowadzi do pewności, ale prawdy dane z góry przez Boga, które wyjaśnią rzeczywistość.
...
Kwestia relacji między polityką a religią nabrała kształtu wraz z dziełem świętego Augustyna _Civitas Dei_ (_Miasto Boga_). Wyjaśnia on w nim, że współistnieją ze sobą dwie sfery:
...
- Duchowa władza pochodząca od Boga jest uosabiana przez papieża i jest sprawowana nad całym chrześcijaństwem (jest to Miasto Boże).
- Miasto ludzi, które jest ziemskie i składa się z lokalnej i doczesnej władzy. Wywodzi się z grzechu pierworodnego, ze zła.
...
Dla Woltera to przede wszystkim omylność człowieka stanowi fundament doktryny tolerancji i wolności politycznej. Pisze on w swoim _Słowniku filozoficznym_ (1764):
...
W _Sixth Letter_, _"On the Presbyterians"_, Voltaire podaje przykład londyńskiej giełdy Exchange. Na tym szczycie międzynarodowego handlu "Żyd, muzułmanin i chrześcijanin" prowadzą interesy razem, "jakby byli wyznawcami tej samej religii". Zastrzegają sobie "miano niewiernych tylko dla tych, którzy bankrutują".
...
Następnie Turgot starał się, aby Ludwik XVI usunął frazę: "Przysięgam stłumić herezję" z przysięgi składanej w dniu koronacji. W _Memoir to the King on Tolerance_ (1775) pisze:
...
- Pomysły powinny być wymieniane, tak jak towary
...
> Ekonomia polityczna, podsumowuje Dupont de Nemours, jest nauką o prawie naturalnym stosowanym w cywilizowanych społeczeństwach. (_Korespondencja z J.-B. Say_).
...
- Z jednej strony są tacy, którzy wierzą, że ta harmonia społeczna musi być osiągnięta sztucznie i poprzez przymus państwa; są to teorie Contract.
- Z drugiej strony są tacy, którzy wierzą, że zarządzanie można osiągnąć poprzez interesy, co oznacza umożliwienie indywidualnym interesom harmonizowania się w ramach reguł gry, które są znane i akceptowane przez wszystkich: są to teorie rynkowe.
...
Odnosząc się do prawa naturalnego (termin pochodzi od _phusis_, natura i _cratos_, władza lub reguła), fizjokraci wierzyli, że istnieją prawa ekonomiczne, które nie zależą od władzy politycznej lub religijnej, ale od samej natury człowieka i społeczeństw. Porządek ekonomiczny jest naturalnym porządkiem społeczeństw. Władza polityczna musi się mu podporządkować.
...
- Społeczeństwo obywatelskie istnieje przed rządem
- Monarchia jest przestarzałym i despotycznym systemem politycznym.
- Ameryka cierpi pod brytyjską dominacją.
- Rewolucja amerykańska to uniwersalna sprawa, która broni wartości wolności, równości i odpowiedzialności.
- Ameryka musi oddzielić się od Anglii i ustanowić republikę, która będzie ucieleśnieniem tych wartości.
...
Rzeczywiście, w swoich _Principles of Politics_ Benjamin Constant twierdzi:
...
Autor _Democracy in America_ ostrzega nas:
...
> Według Hayeka socjalizm i nazizm mają wiele fundamentalnych cech wspólnych, w szczególności odrzucenie indywidualizmu i spontanicznego porządku rynkowego. Obie ideologie przedkładają dobrobyt grupy nad prawa i wolności jednostek i dążą do stworzenia homogenicznego społeczeństwa zjednoczonego wspólnymi wartościami i celami. Ani socjaliści, ani naziści nie wahają się użyć siły i przymusu, by osiągnąć swoje cele. Są gotowi ograniczyć indywidualne wolności i stłumić sprzeciw w imię większego dobra społeczeństwa.
> W rozdziale zatytułowanym "Socjalistyczne korzenie nazizmu" Hayek wskazuje, że nazizm domagał się socjalistycznego planowania (stąd jego nazwa - narodowy socjalizm) gospodarki jako sposobu na ustanowienie całkowitej kontroli nad ludnością.
...
W 1947 roku, pięć lat po francuskim tłumaczeniu _The General Theory_, opublikował artykuł zatytułowany: _The Errors of the General Theory of Lord Keynes_. Zawarł w nim następujące ostrzeżenia:
...
To dlatego w _Human Action_ Ludwig von Mises pisze:


> Standard złota był światowym standardem ery kapitalistycznej, rosnącego dobrobytu, wolności i demokracji \[...\] Był to międzynarodowy standard, którego potrzebował handel międzynarodowy i światowe rynki kapitałowe \[...\] Przeniósł przemysł, kapitał i zachodnią cywilizację do najbardziej odległych zakątków planety, tworząc nieznane wcześniej bogactwo.
> Standard złota ogranicza jednak rządy do finansowania swoich wydatków poprzez podatki, a nie inflację, co tłumaczy pewną wrogość elit politycznych i gospodarczych wobec tego systemu. Ponieważ powiązanie waluty z metalem szlachetnym ogranicza zdolność banków centralnych do finansowania wzrostu państwa opiekuńczego poprzez podatek pośredni, jakim jest inflacja.
> Dlatego już w 1923 r. Keynes oświadczył:

> W rzeczywistości standard złota jest już barbarzyńskim przeżytkiem. (...) Obrońcy starego standardu nie zauważają, jak bardzo odbiega on od ducha i potrzeb nowych czasów. (J.M. Keynes, _Monetary Reform_).
