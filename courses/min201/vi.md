...
### Giới hạn của Chứng minh Cổ phần
...
Bitcoin tự động điều chỉnh độ khó khai thác và thưởng cho những người tham gia. Tuy nhiên, sự tập trung của hashrate có thể đặt ra rủi ro cho tính trung lập của mạng. Sử dụng sức mạnh tính toán của Bitcoin cho giải pháp sưởi ấm trực tiếp mang lại lợi ích cho chính mạng lưới bằng cách tăng cường phân phối sức mạnh tính toán.
...
> "Ban đầu, hầu hết người dùng sẽ chạy các nút mạng, nhưng khi mạng phát triển vượt qua một điểm nhất định, nó sẽ càng ngày càng được giao cho các chuyên gia với các trang trại máy chủ của phần cứng chuyên dụng. Một trang trại máy chủ chỉ cần có một nút trên mạng và phần còn lại của LAN kết nối với nút đó."
>
...
![hình ảnh](assets/guide-achat/8.webp)
...
Quạt nguồn cũng khá ồn và cần được thay thế. Chúng tôi khuyên dùng Noctua NF-A6x25 PWM. Lưu ý rằng các đầu nối của quạt Noctua không giống như quạt gốc, vì vậy bạn sẽ cần một bộ chuyển đổi đầu nối để kết nối chúng. Hai cái là đủ. Một lần nữa, hãy chắc chắn chọn phiên bản 12V của quạt.
...
Cuối cùng, nhấn vào khởi động lại để khởi động lại cầu nối. Việc này sẽ mất vài phút để khởi động lại.
...
Nếu việc cài đặt không thành công, có thể cần thực hiện việc đặt lại và thử lại (xem phần trước).![image](assets/software/8.webp)
...
- Bên dưới, tốc độ quạt dưới dạng phần trăm của tốc độ tối đa và số vòng quay mỗi phút.

![image](assets/software/15.webp)

- Phía dưới, bạn sẽ tìm thấy một cái nhìn chi tiết về từng hashboard. Nhiệt độ trung bình của bảng và các chip nó chứa, cũng như điện áp và tần số.
- Chi tiết về các hồ bơi khai thác hoạt động trong Pools.
- Trạng thái của autotuning trong Tuner Status.
...
> CẢNH BÁO: Trước hết, trước khi bắt đầu, hãy chắc chắn rằng bạn đã rút phích cắm của máy đào để tránh mọi rủi ro điện giật.

![image](assets/hardware/1.webp)

Đầu tiên, tháo 6 ốc vít ở bên cạnh vỏ giữ nó đóng lại. Sau khi các ốc vít được tháo ra, cẩn thận mở vỏ để lấy bỏ phần bảo vệ nhựa che các linh kiện.

![image](assets/hardware/2.webp)
![image](assets/hardware/3.webp)

Tiếp theo, đã đến lúc tháo quạt gốc, cố gắng không làm hỏng các linh kiện khác. Để làm điều này, tháo các ốc vít giữ nó cố định và nhẹ nhàng gỡ bỏ keo trắng xung quanh đầu nối. Quan trọng là phải tiến hành cẩn thận để tránh làm hỏng dây hoặc đầu nối.

![image](assets/hardware/4.webp)
Sau khi tháo quạt gốc, bạn sẽ nhận thấy rằng các đầu nối của quạt Noctua mới không khớp với quạt gốc. Thực tế, quạt mới có 3 dây, bao gồm một dây màu vàng cho phép điều khiển tốc độ. Tuy nhiên, dây này sẽ không được sử dụng trong trường hợp cụ thể này. Do đó, để kết nối quạt mới, nên sử dụng một loại bộ chuyển đổi đặc biệt. Tuy nhiên, quan trọng là phải lưu ý rằng bộ chuyển đổi này đôi khi có thể khó tìm.

![image](assets/hardware/5.webp)

Nếu bạn không có bộ chuyển đổi này, bạn vẫn có thể tiếp tục kết nối quạt mới bằng cách sử dụng đầu nối điện của thợ điện. Để làm điều này, bạn cần cắt các dây của quạt cũ và mới.
...
Sau đó, kéo vỏ chính xuống dưới, cắt vỏ của dây đỏ và đen theo cách tương tự như trước. Và cắt dây vàng ngang bằng.

![image](assets/hardware/9.webp)

Trên quạt cũ, việc cắt vỏ chính mà không làm hỏng vỏ của dây đỏ và đen là khó khăn hơn. Để làm điều này, chúng tôi đã sử dụng một cây kim mà chúng tôi luồn giữa vỏ chính và dây đỏ và đen.

![image](assets/hardware/10.webp)
![image](assets/hardware/11.webp)

Một khi dây đỏ và đen được lộ ra, cắt vỏ một cách cẩn thận để tránh làm hỏng dây điện.
...
Một khi kết nối được thực hiện, đã đến lúc lắp đặt quạt Noctua mới với lưới và các ốc vít cũ. Các ốc vít mới trong hộp sẽ được sử dụng lại sau. Đảm bảo đặt nó theo hướng đúng. Bạn sẽ nhận thấy một mũi tên trên một bên của quạt, chỉ hướng luồng khí. Quan trọng là phải định vị quạt sao cho mũi tên này hướng vào bên trong của thùng máy. Sau đó kết nối lại quạt.

![image](assets/hardware/15.webp)
![image](assets/hardware/16.webp)

> Tùy chọn: Nếu bạn am hiểu về điện, bạn có thể trực tiếp thêm một đầu nối jack nữ 5.5mm vào nguồn điện 12V, sẽ trực tiếp cung cấp điện cho cầu nối Wi-Fi Vonet. Tuy nhiên, nếu bạn không chắc về kỹ năng điện của mình, tốt nhất là sử dụng đầu nối USB với một bộ sạc kiểu điện thoại thông minh để tránh bất kỳ rủi ro nào về mạch ngắn hoặc hỏng hóc điện.
...
> CẢNH BÁO: Trước hết, trước khi bắt đầu, hãy chắc chắn ngắt kết nối máy đào của bạn để tránh mọi rủi ro bị điện giật.

1. Đầu tiên, ngắt kết nối quạt và tháo chúng ra.

![hình ảnh](assets/hardware/19.webp)

2. Các đầu nối của quạt Noctua mới không khớp với đầu nối gốc, nhưng đừng lo lắng! Lấy dao cắt của bạn và cẩn thận cắt bỏ các thanh nhựa nhỏ để các đầu nối vừa khít với máy đào của bạn.

![hình ảnh](assets/hardware/20.webp)
![hình ảnh](assets/hardware/21.webp)
3. Đã đến lúc lắp đặt các bộ phận 3D!
Gắn chúng vào cả hai bên của máy đào sử dụng các ốc vít bạn đã tháo ra từ quạt. Vặn chúng cho đến khi đầu ốc vít bằng phẳng với bộ phận 3D và nó được cố định chắc chắn. Hãy cẩn thận không vặn quá chặt, vì bạn có thể làm biến dạng bộ phận và một trong các ốc vít có thể chạm vào tụ điện!
...
5. Bước cuối cùng: kết nối quạt và gắn lưới bảo vệ lên trên với các ốc vít không sử dụng trong hộp quạt nguồn. Bạn chỉ có 4 cái, nhưng 2 cái cho mỗi lưới ở các góc đối diện sẽ đủ. Bạn cũng có thể tìm các ốc vít tương tự tại cửa hàng phần cứng nếu cần.
...
Tuy nhiên, vì mọi thứ trong Bitcoin đều dựa trên xác suất, đôi khi các thợ mỏ đơn lẻ được thưởng cho việc chấp nhận rủi ro này: Thợ Đào Bitcoin Đơn Lẻ Giải Quyết Khối Với Tốc Độ Hash Chỉ 10 TH/s, Vượt Qua Tỷ Lệ Cược Cực Kỳ Không Chắc Chắn – Decrypt

Nếu bạn thích cờ bạc, bạn có thể thử, nhưng hướng dẫn của chúng tôi sẽ không tập trung vào hướng đó. Thay vào đó, chúng tôi sẽ tập trung vào nhóm đào phù hợp nhất với nhu cầu của chúng tôi trong việc tạo ra một hệ thống sưởi.

Các yếu tố cần xem xét khi chọn một nhóm đào bao gồm hoạt động của hệ thống thưởng của nhóm, có thể thay đổi, cũng như số lượng tối thiểu trước khi có thể rút thưởng về một địa chỉ. Ví dụ, Braiins, cung cấp phần mềm mà chúng tôi đang thảo luận ở đây, cũng cung cấp một nhóm đào. Nhóm này có một hệ thống thưởng gọi là "Score" khuyến khích thợ mỏ đào trong thời gian dài. Sự tham gia bao gồm một yếu tố thời gian hoạt động được biểu thị dưới dạng "hashrate tính điểm". Trong trường hợp của chúng tôi, khi chúng tôi muốn một hệ thống sưởi có thể bật chỉ trong vài phút, đây không phải là hệ thống thưởng lý tưởng. Chúng tôi ưu tiên một hệ thống thưởng cho chúng tôi một phần thưởng bằng nhau cho mỗi lần tham gia. Ngoài ra, số lượng rút tối thiểu cho Braiins Pool là 100,000 sats và On-Chain. Vì vậy, chúng tôi mất một số sats trong phí giao dịch và một phần thưởng của chúng tôi có thể bị khóa nếu chúng tôi không đào đủ trong mùa đông.

Mô hình thưởng quan tâm đến chúng tôi là PPS, có nghĩa là "trả tiền theo mỗi phần". Điều này có nghĩa là thợ mỏ sẽ nhận được thưởng cho mỗi phần hợp lệ. Cũng có một biến thể của hệ thống này, FPPS (Full Pay Per Share), không chỉ chia sẻ phần thưởng coinbase, mà còn cả phí giao dịch bao gồm trong khối. Các nhóm đào chúng tôi khuyến nghị để kết nối hệ thống đào/sưởi của bạn là Linecoin Pool (FPPS) và Nicehash (PPS).
...
- Linecoin: Lợi ích của Linecoin là số lượng tính năng được cung cấp, như bảng điều khiển chi tiết, khả năng thực hiện rút tiền với Paynym (BIP 47) để bảo vệ quyền riêng tư tốt hơn, và tích hợp bot Telegram cũng như tự động cấu hình trực tiếp trong ứng dụng di động. Nhóm này chỉ đào khối Bitcoin, nhưng số lượng tối thiểu để rút tiền vẫn cao là 100,000 sats. Chúng tôi sẽ xem xét giao diện của một trong những nhóm này chi tiết hơn trong một bài viết tương lai.
Để cấu hình một pool trong Braiins OS+, bạn cần tạo một tài khoản trong một trong những pool mà bạn chọn. Ở đây chúng ta sẽ lấy ví dụ về Linecoin:
...
Tăng tốc độ là một điều chỉnh đơn giản bao gồm việc tăng tần số trên các bảng băm để tăng tốc độ băm của máy. Ngược lại, giảm tốc độ bao gồm việc giảm tần số đồng hồ của một mạch tích hợp dưới tần số danh nghĩa của nó. Bằng cách giảm tần số đồng hồ của một ASIC thông qua việc giảm tốc độ, nhiệt độ sinh ra bởi phần cứng cũng được giảm. Điều này cho phép giảm tốc độ của quạt cần thiết để làm mát ASIC, vì chúng không cần phải làm việc quá sức để duy trì nhiệt độ phù hợp. Bằng cách giảm tốc độ quạt, tiếng ồn phát ra bởi ASIC cũng được giảm. Điều này có thể đặc biệt hữu ích cho những người dùng ASIC tại nhà và muốn giảm thiểu sự quấy rầy do tiếng ồn từ thiết bị đào.

Braiins OS+ hỗ trợ tăng tốc độ, giảm tốc độ của ASICs, và tự động điều chỉnh. Nó cho phép người dùng điều chỉnh linh hoạt tần số đồng hồ của phần cứng của họ để tối đa hóa hiệu suất hoặc tiết kiệm năng lượng theo sở thích của họ.

### Tối ưu hóa hiệu suất của Antminer S9 của bạn với tự động điều chỉnh

Trước năm 2018, thợ đào có hai cách để có lợi thế trong hoạt động của mình: tìm điện với giá cả phải chăng và mua phần cứng hiệu quả hơn. Tuy nhiên, vào năm 2018, một tiến bộ mới được phát hiện trong lĩnh vực phần mềm và firmware đào, được gọi là AsicBoost. Kỹ thuật này cho phép thợ đào giảm chi phí khoảng 13% bằng cách chỉnh sửa firmware chạy trên thiết bị của họ.

Ngày nay, có một tiến bộ mới trong lĩnh vực phần mềm và firmware đào gọi là tự động điều chỉnh, mang lại lợi ích lớn hơn so với AsicBoost. ASIC được cấu thành từ nhiều chip máy tính nhỏ thực hiện băm. Những chip này được làm từ silicon, cùng một nguyên tố được sử dụng rộng rãi trong bán dẫn và các thành phần vi điện tử khác. Điều quan trọng cần hiểu ở đây là không phải tất cả các chip silicon đều giống nhau, mỗi chip có thể có sự khác biệt nhỏ về tính chất điện. Các nhà sản xuất phần cứng biết điều này và công bố thông số hiệu suất của máy đào của họ dựa trên giới hạn thấp nhất của sự chịu đựng của chúng. Nói cách khác, các nhà sản xuất biết tần số hoạt động tốt nhất cho các chip trung bình và họ sử dụng tần số này một cách đồng nhất cho tất cả các chip trong máy.

Điều này đặt ra giới hạn trên cho tốc độ băm mà một máy có thể có. Tự động điều chỉnh là quá trình mà các thuật toán đánh giá các tần số tối ưu cho việc băm từng chip, thay vì xử lý toàn bộ máy như một đơn vị duy nhất. Điều này có nghĩa là một chip chất lượng cao hơn có thể thực hiện nhiều băm mỗi giây sẽ nhận được tần số cao hơn, và một chip chất lượng thấp hơn có thể thực hiện tương đối ít băm hơn sẽ nhận được tần số thấp hơn. Tự động điều chỉnh cấp chip cơ bản là một cách để tối ưu hóa hiệu suất của một ASIC thông qua phần mềm và firmware chạy trên nó.
...
![Điều khiển Antminer S9 với smartphone của bạn](https://www.youtube.com/watch?v=OsKmdB2iw88&t=60s)