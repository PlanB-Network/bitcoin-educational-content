...
![image](assets/th/003.webp)

ในใจกลางของวิวัฒนาการทางเทคโนโลยีในช่วงทศวรรษ 1980 และ 1990 กลุ่มคนกลุ่มหนึ่งเริ่มตั้งคำถามอย่างลึกซึ้งเกี่ยวกับบทบาทของความเป็นส่วนตัวและเสรีภาพในยุคดิจิทัล บุคคลเหล่านี้ซึ่งต่อมาจะเป็นที่รู้จักในนาม "[cypherpunks](https://planb.academy/resources/glossary/cypherpunks)" เชื่อมั่นอย่างแน่วแน่ว่า[การเข้ารหัส](https://planb.academy/resources/glossary/cryptography)สามารถทำหน้าที่เป็นเครื่องมือในการปกป้องสิทธิส่วนบุคคลจากการแทรกแซงของรัฐบาลและบรรษัทขนาดใหญ่
...
ก่อนการเกิดขึ้นของ Bitcoin มีความพยายามหลายครั้งในการสร้างสกุลเงินดิจิทัล ยกตัวอย่างเช่น David Chaum ได้แนะนำแนวคิดของ "เงินอิเล็กทรอนิกส์แบบไม่ระบุตัวตน" กับโครงการ "[DigiCash](https://planb.academy/resources/glossary/ecash-david-chaum)" ของเขาในทศวรรษที่ 1980 น่าเสียดายที่เนื่องจากข้อจำกัดต่าง ๆ DigiCash ไม่เคยเติบโตอย่างที่คาดหวัง


อีกหนึ่งบรรพบุรุษที่สำคัญคือ "[B-money](https://planb.academy/resources/glossary/bmoney)" ของ Wei Dai แม้ว่ามันจะไม่เคยถูกนำมาใช้จริง แต่มันได้นำเสนอแนวคิดของสกุลเงินดิจิทัลที่ไม่ระบุตัวตนซึ่งการตรวจจับการฉ้อโกงถูกดำเนินการโดยชุมชนของผู้ประเมินแทนที่จะเป็นหน่วยงานกลาง


ภาพด้านล่างแสดงให้เห็นถึงการพัฒนาของการเคลื่อนไหวผ่านนวัตกรรมทางเทคโนโลยีมากมายอย่างชัดเจน


![image](assets/th/005.webp)


ในสภาพแวดล้อมที่อุดมสมบูรณ์นี้เองที่ [Satoshi Nakamoto](https://planb.academy/resources/glossary/nakamoto-satoshi) ผู้ลึกลับได้ตีพิมพ์[เอกสารไวท์เปเปอร์](https://planb.academy/resources/glossary/white-paper) Bitcoin ในปี 2008 ในเอกสารนี้ เขาได้รวมแนวคิดหลายอย่างจากขบวนการไซเฟอร์พังค์ เช่น [proof of work](https://planb.academy/resources/glossary/proof-of-work) และ[การประทับเวลา](https://planb.academy/resources/glossary/timestamp)คริปโตกราฟี เพื่อสร้างสกุลเงินดิจิทัลที่[กระจายอำนาจ](https://planb.academy/resources/glossary/distributed)และต้านทานการเซ็นเซอร์
...
หน้าที่ของมันในโลกของเรานั้นยากที่จะจำลองขึ้นมาได้อย่างเทียม ในความเป็นจริง ไม่มีบุคคลหรือกลุ่มใดสามารถสร้างเงินได้ เพราะมันเป็นปรากฏการณ์ธรรมชาติที่ต้องเกิดขึ้นจากตลาดและ[ความเห็นพ้องต้องกันโดยสมัครใจ](https://planb.academy/resources/glossary/consensus) ในแง่นี้ ราคาทำหน้าที่เป็นสัญญาณและชิ้นส่วนของข้อมูลที่นำทางสังคมในการจัดสรรทรัพยากร
...
![image](assets/th/008.webp)

![image](assets/th/009.webp)

![image](assets/th/010.webp)
...
ในทางตรงกันข้าม สกุลเงินที่รัฐเป็นผู้ดูแล ([fiat](https://planb.academy/resources/glossary/fiat)) สามารถใช้งานได้ง่าย แต่ถูกลดค่าอย่างต่อเนื่องโดยหน่วยงานที่ควบคุมมัน (กษัตริย์ ธนาคารกลาง จักรพรรดิ์ เผด็จการ)


เพื่ออธิบายแนวคิดนี้ให้ดียิ่งขึ้น เราจะสำรวจลักษณะของสกุลเงินที่มีประสิทธิภาพ:


![image](assets/th/011.webp)



- [ความสามารถในการทดแทน](https://planb.academy/resources/glossary/fungibility)**, หมายถึงการที่สามารถแลกเปลี่ยนกับหน่วยอื่นที่มีลักษณะเดียวกันได้โดยไม่สูญเสียมูลค่า;
...
![image](assets/th/016.webp)


### เฟสของภาวะเงินเฟ้อสูงมีอะไรบ้าง?


![image](assets/th/017.webp)
...
การสร้างบิตคอยน์ใหม่เป็นผลมาจากกระบวนการ [mining](https://planb.academy/resources/glossary/mining) โดยสรุปแล้ว นักขุดใช้คอมพิวเตอร์ที่มีประสิทธิภาพสูงในการแก้ปัญหาทางคณิตศาสตร์ที่ซับซ้อน ([แฮช](https://planb.academy/resources/glossary/hash-function)) ซึ่งจะตรวจสอบและรักษาความปลอดภัยของธุรกรรม เมื่อปัญหาถูกแก้ไข (หรือพบแฮชที่ถูกต้อง) นักขุดจะเพิ่ม[บล็อก](https://planb.academy/resources/glossary/block)ธุรกรรมใหม่ลงในบล็อกเชน ซึ่งเป็นบัญชีแยกประเภทที่กระจายและกระจายศูนย์ที่บันทึกธุรกรรมทั้งหมดที่เกิดขึ้นในเครือข่าย บล็อกเชนช่วยให้มั่นใจในความโปร่งใสและความปลอดภัย เนื่องจากแต่ละบล็อกเชื่อมโยงกับบล็อกก่อนหน้า ทำให้แทบจะเป็นไปไม่ได้ที่จะเปลี่ยนแปลงข้อมูลในอดีตโดยไม่ได้รับความเห็นชอบจากเครือข่าย


![image](assets/th/022.webp)


หลังจากทำภารกิจนี้สำเร็จ นักขุดจะได้รับรางวัลเป็นการออกบิตคอยน์ใหม่ทุก ๆ สิบนาที รางวัลนี้ถูกตั้งโปรแกรมให้ลดลงครึ่งหนึ่งทุก ๆ 210,000 บล็อก ซึ่งประมาณทุก ๆ สี่ปี (เหตุการณ์ที่เรียกว่า "halving"), ทำให้เส้นโค้งการออกเงินมีลักษณะคล้ายบันได เนื่องจากกลไกนี้ สามารถคาดการณ์ทางคณิตศาสตร์ได้ว่าการสร้างบิตคอยน์ใหม่จะหยุดลงประมาณปี 2140 เมื่อจำนวนทั้งหมดถึงขีดจำกัดที่ 21 ล้าน
...
![image](assets/th/023.webp)


ในทางกลับกัน หากมีคนขุดน้อยลงและบล็อกใช้เวลานานขึ้น ความยากของ mining จะลดลง ทำให้เวลาเฉลี่ยของบล็อกกลับมาเร็วขึ้น


คุณรู้หรือไม่ว่า นักขุดได้รับแรงจูงใจในการขุดบล็อกเพื่อรับบิตคอยน์ใหม่ผ่าน[การอุดหนุนบล็อก](https://planb.academy/resources/glossary/block-subsidy) รวมถึง[ค่าธรรมเนียมการทำธุรกรรม](https://planb.academy/resources/glossary/transaction-fees)จากธุรกรรมที่พวกเขารวมไว้ในบล็อกนั้น?
...
ในความเป็นจริง ใครๆ ก็สามารถทำสิ่งนี้ได้ผ่าน Bitcoin node (เช่น ตัวตรวจสอบธุรกรรม) โดยเพียงแค่ป้อนคำสั่งต่อไปนี้: `bitcoin-cli gettxoutsetinfo` ความโปร่งใสนี้ช่วยเสริมสร้างความเชื่อมั่นในระบบ Bitcoin ซึ่งไม่ได้ขึ้นอยู่กับสถาบันหรือบุคคลกลาง แต่ขึ้นอยู่กับการรับประกันทางคณิตศาสตร์และการเข้ารหัสที่มีอยู่ในโปรโตคอลของมัน (คุณจะได้เรียนรู้วิธีทำสิ่งนี้ได้อย่างง่ายดายใน LNP201)
...
ในส่วนที่ 2 เราจะสำรวจการจัดเก็บและความปลอดภัยของ Bitcoin ผ่านการใช้[กระเป๋าเงิน](https://planb.academy/resources/glossary/wallet) เพื่อทำความเข้าใจว่า bitcoins ที่มีชื่อเสียงเหล่านี้อยู่ที่ไหนและวิธีการโต้ตอบกับพวกมัน!
...
![image](assets/th/025.webp)


### Bitcoin wallet ทำงานอย่างไร?


ไม่ว่าจะเป็น Bitcoin "banker" ของคุณหรือของตัวคุณเอง กระเป๋าเงิน Bitcoin ส่วนใหญ่ทำงานด้วยเทคโนโลยีที่คล้ายกันซึ่งอิงตามการเข้ารหัสแบบอสมมาตร ซึ่งเกี่ยวข้องกับระบบคู่คีย์: [คีย์ส่วนตัว](https://planb.academy/resources/glossary/private-key)สำหรับการใช้จ่ายและ[คีย์สาธารณะ](https://planb.academy/resources/glossary/public-key)สำหรับการรับ
...
เมื่อเริ่มต้นใช้งาน wallet จะมีการสร้าง[วลีการกู้คืนลับ](https://planb.academy/resources/glossary/recovery-phrase) หรือที่รู้จักกันในชื่อวลีช่วยจำ (กุญแจส่วนตัว) และจะแสดงให้คุณในรูปแบบของคำ 12 หรือ 24 คำ


คีย์ส่วนตัว มีความสำคัญพื้นฐานเพราะมันเป็นตัวแทนของการครอบครองบิตคอยน์และสิทธิ์ในการใช้หรือส่งบิตคอยน์ ดังนั้นผู้ถือคีย์ส่วนตัวจึงเป็นเจ้าของที่แท้จริงของบิตคอยน์ ตามที่คำกล่าวที่เป็นที่นิยมว่า "ไม่ใช่คีย์ของคุณ ก็ไม่ใช่เหรียญของคุณ"
...
คีย์สาธารณะถูกสร้างขึ้นจากคีย์ส่วนตัวและมีการเชื่อมโยงกัน การแชร์คีย์สาธารณะมีความเสี่ยงต่อความเป็นส่วนตัว (เพราะผู้ใช้อื่นสามารถเห็นยอดเงินของคุณ) แต่ไม่เสี่ยงต่อความปลอดภัย (เพราะพวกเขาไม่สามารถใช้จ่ายเงินของคุณได้หากไม่มีคีย์ส่วนตัว) ในทางกลับกัน คีย์สาธารณะถูกใช้เพื่อสร้าง[ที่อยู่ Bitcoin](https://planb.academy/resources/glossary/receiving-address) และดังนั้นจึงสามารถรับเงินได้
...
- ระดับ 0** คุณใช้สิ่งที่เรียกว่า "[บริการรับฝาก](https://planb.academy/resources/glossary/custody)" ซึ่งคุณไม่ได้เป็นผู้ถือครองบิตคอยน์เพียงผู้เดียว โปรดทราบว่าบุคคลที่สามที่คุณไว้วางใจนี้สามารถจำกัดการเข้าถึงเงินของคุณได้ตลอดเวลา ในกรณีนี้ ระดับอธิปไตยทางการเงินของคุณจะคล้ายกับระบบธนาคารแบบดั้งเดิมที่มีบัญชีธนาคาร


![image](assets/th/030.webp)
...
- ระดับ 2** คุณใช้ wallet แบบกายภาพ และคุณได้รักษารายการคำ 12/24 ของคุณไว้แล้ว มักเรียกว่า "[wallet แบบเย็น](https://planb.academy/resources/glossary/cold-wallet)" เพราะกุญแจของคุณถูกเก็บไว้ในอุปกรณ์ที่ไม่ได้เชื่อมต่อกับอินเทอร์เน็ต ในกรณีนี้ คุณจะต้องเซ็นชื่อทุกธุรกรรมด้วยอุปกรณ์ของคุณเสมอ ซึ่งทำให้เงินของคุณเข้าถึงได้น้อยลงในแต่ละวัน
...
![image](assets/th/032.webp)



- ระดับ 4** คุณใช้ชุดกระเป๋าเงินเพื่อสร้าง "[multisig](https://planb.academy/resources/glossary/multisig)" wallet ซึ่งหมายความว่าต้องใช้ลายเซ็นหลายรายการในการดำเนินการธุรกรรม ในกรณีนี้ โปรดทราบว่าควรจัดเก็บแต่ละส่วนของ multisig ในสถานที่ต่างๆ วิธีการนี้มักถือว่าเป็นการใช้งานขั้นสูงของ Bitcoin โดยหลักแล้วสำหรับการจัดการจำนวนเงินมากและเพื่อวัตถุประสงค์ขององค์กร


![image](assets/th/033.webp)
...
![image](assets/th/039.webp)


เมื่อวันที่ 3 มกราคม 2009 Satoshi ได้เปิดตัวเครือข่าย Bitcoin อย่างเป็นทางการโดยการสร้างบล็อกแรก ซึ่งรู้จักกันในชื่อ "[บล็อก Genesis](https://planb.academy/resources/glossary/genesis-block)" ซึ่งเป็นการเปิดตัวบล็อกเชน Bitcoin บล็อกนี้มีข้อความเปิดเผยที่สะท้อนถึงภารกิจของ Bitcoin: "03/jan/2009 Chancellor on brink of second bailout for banks."


![image](assets/th/040.webp)


> "เราสามารถชนะการต่อสู้ครั้งใหญ่ในสงครามอาวุธและได้รับ"
> ดินแดนใหม่แห่งเสรีภาพเป็นเวลาหลายปี” - Satoshi Nakamoto

![image](assets/th/041.webp)
...
ในการทำธุรกรรมให้เสร็จสมบูรณ์ Bob ต้องลงนามด้วยกุญแจส่วนตัวของเขาเพื่อยืนยันว่าเขาเป็นเจ้าของบิตคอยน์ที่เขาต้องการโอน ขั้นตอนนี้มักจะเป็นอัตโนมัติบนกระเป๋าเงินมือถือ หรืออาจอยู่ในรูปแบบของ[การยืนยัน](https://planb.academy/resources/glossary/confirmation)บน wallet ของคุณ: "คุณแน่ใจหรือไม่ว่าต้องการส่ง X ไปยัง Y? ใช่หรือไม่"


![image](assets/th/045.webp)
...
![image](assets/th/046.webp)


ณ จุดนี้ แม้ว่าธุรกรรมนี้จะเป็นที่รู้จักของทุกคน (ผ่านเครื่องมือที่เรียกว่า [Mempool](https://planb.academy/resources/glossary/mempool)) แต่ก็ไม่สามารถถือว่ายืนยันได้จนกว่าจะถูกแทรกในบล็อกโดยนักขุด ซึ่งเป็นผู้เดียวที่ยืนยันธุรกรรมโดยการรวมไว้ในบล็อกเชน
...
**นักขุดทำหน้าที่รักษาความปลอดภัยของเครือข่ายและเพิ่มธุรกรรมลงในบล็อก พวกเขาใช้ไฟฟ้าผ่านเครื่อง ASIC เพื่อแก้ไข Bitcoin proof of work.**


![image](assets/th/054.webp)
...
เพื่อเพิ่มประสิทธิภาพจำนวนครั้งของการพยายาม พวกเขาจะใช้เครื่องจักรเฉพาะที่เรียกว่า ASICs ซึ่งมีบทบาทเฉพาะในการคำนวณความเป็นไปได้หลายพันล้านครั้งต่อวินาที (จำนวนรวมของการพยายามเรียกว่า "[HashRate](https://planb.academy/resources/glossary/hashrate)") ในการใช้งานเครื่องจักรเหล่านี้ จำเป็นต้องใช้ไฟฟ้าจำนวนมาก ดังนั้น POW จึงเปลี่ยนพลังงานให้เป็นสกุลเงิน เชื่อมต่อโลกจริงและโลกดิจิทัลเพื่อสร้างสกุลเงินแรกที่ใช้พลังงานเป็นฐาน
...
**[coinbase transaction](https://planb.academy/resources/glossary/coinbase-transaction)** เป็นธุรกรรมแรกที่รวมอยู่ในบล็อกเสมอ: มันประกอบด้วยรางวัลของนักขุดสำหรับการดำเนินการ proof-of-work จากนั้นจะเป็นธุรกรรมที่ได้รับการตรวจสอบแล้ว นักขุดจะเลือกแทรกธุรกรรมที่ให้ผลกำไรสูงสุดแก่พวกเขา ซึ่งได้แก่ ธุรกรรมขนาดเล็กที่มีค่าธรรมเนียมสูงสุด
...
![image](assets/th/059.webp)


เพื่อสร้างเสถียรภาพให้กับรูปแบบธุรกิจของพวกเขา ซึ่งอาศัยรางวัลที่ได้รับสำหรับแต่ละบล็อกที่ถูกต้อง นักขุดมักจะสร้างกลุ่มผ่าน "[mining pools](https://planb.academy/resources/glossary/pool-mining)" ซึ่งพวกเขารวมทรัพยากรการคำนวณของพวกเขาเข้าด้วยกัน
...
หากคุณต้องการศึกษาในเชิงลึกเกี่ยวกับหัวข้อเฉพาะของการขุดบิตคอยน์ คุณสามารถดูหลักสูตร MIN 101 ของเราได้ ในนั้นคุณจะพบคำอธิบายเชิงทฤษฎีอย่างละเอียดเกี่ยวกับหลักการของ proof of work และการทำงานของมัน ตลอดจนแนวคิดทั้งหมดที่เกี่ยวข้อง

https://planb.academy/courses/d1ce86d9-c983-49bc-92b3-e3c5269f239e

ขอแนะนำให้คุณค้นพบหลักสูตรภาคปฏิบัติขั้นสูงนี้ด้วย ซึ่งเราอธิบายวิธีเปลี่ยน ASIC ให้เป็นระบบทำความร้อนภายในบ้านแบบ DIY เพื่อใช้ประโยชน์จากความร้อนที่เกิดจากการขุดและรับซาโตชิแรกของคุณ!
...
![image](assets/th/062.webp)

![image](assets/th/063.webp)

![image](assets/th/064.webp)
...
จากวัฏจักรที่ผ่านมา ดูเหมือนว่าความถี่ของวัฏจักรเศรษฐกิจของ Bitcoin จะเท่ากับระยะเวลาระหว่าง[การลดลงครึ่งหนึ่ง](https://planb.academy/resources/glossary/halving)สองครั้ง อาจเป็นเพราะเหตุการณ์การลดลงครึ่งหนึ่งทำหน้าที่เป็นตัวกระตุ้นโดยการลดการปล่อยบิตคอยน์ใหม่ลงครึ่งหนึ่ง
...
- [ค่าเฉลี่ยต้นทุนดอลลาร์](https://planb.academy/resources/glossary/dollar-cost-averaging-dca)
...
มีหลายวิธีในการรับบิตคอยน์ แต่ละวิธีมีข้อบังคับของตัวเองที่อาจแตกต่างกันไปตามเขตอำนาจศาล บางแพลตฟอร์มต้องการการยืนยันตัวตน ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)) ในขณะที่บางแพลตฟอร์มไม่ต้องการ ดังนั้นจึงเป็นสิ่งสำคัญที่จะต้องเข้าใจข้อบังคับที่เกี่ยวข้องกับแต่ละแพลตฟอร์ม
...
![image](assets/th/080.webp)


### ช่องทางการชำระเงินที่ยึดกับ Bitcoin


Lightning อาศัย[ช่องทางการชำระเงิน](https://planb.academy/resources/glossary/payment-channel)สองทิศทาง ช่องทางคือความสัมพันธ์ทางเทคนิคระหว่างผู้เข้าร่วมสองคนที่ช่วยให้พวกเขาสามารถแลกเปลี่ยน [sats](https://planb.academy/resources/glossary/satoshi-sat) นอกเชน ซึ่งหมายถึงการไม่บันทึกการชำระเงินทุกครั้งบนบล็อกเชน


จากมุมมองของ Bitcoin ([onchain](https://planb.academy/resources/glossary/onchain)) การเปิดช่องทางหมายถึงการล็อคเงินทุนในธุรกรรมพิเศษ ซึ่งสามารถมองได้ว่าเป็นการฝากเงินแบบเอสโครว์: เงินทุนถูกล็อคในลักษณะที่เฉพาะการปิดช่องทางที่ถูกต้องเท่านั้นที่สามารถแจกจ่ายเงินเหล่านั้นได้
...
Lightning ได้รับการออกแบบมาเพื่อให้สามารถชำระเงินผ่านตัวกลางโดยไม่ต้องเชื่อใจพวกเขา เพื่อให้บรรลุเป้าหมายนี้ โปรโตคอลใช้สัญญาอัจฉริยะที่เรียกว่า [HTLCs](https://planb.academy/resources/glossary/htlc) (*Hashed Time-Locked Contracts*) โดยไม่ต้องลงลึกในรายละเอียดทั้งหมด กลไกทั่วไปมีดังนี้:
...
ในบทนี้ เราจะแนะนำโปรโตคอลสำคัญสี่ตัวที่แต่ละตัวนำเสนอความเป็นไปได้ใหม่ๆ บน Bitcoin: [sidechains](https://planb.academy/resources/glossary/sidechain) (รวมถึง Liquid), Ark, RGB, และ Taproot Assets.
