...
Для начала этого курса не требуется никаких предварительных знаний. BTC 101 разработан так, чтобы быть доступным для всех, независимо от уровня опыта.
...
Прежде чем термин "биткойн" стал синонимом цифровой валюты и финансовой трансформации, основу для его создания заложил целый ряд идей, инноваций и общественных движений. Среди них ключевым элементом предыстории биткойна является движение [киберпанк](https://planb.academy/resources/glossary/cypherpunks).

### Киберпанки: провидцы цифрового мира

![image](assets/ru/003.webp)

В самом сердце технологической эволюции 1980-х и 1990-х годов группа людей начала глубоко сомневаться в роли приватности и свободы в цифровую эпоху. Эти люди, которых впоследствии стали называть "криперпанки", твердо верили, что [криптография](https://planb.academy/resources/glossary/cryptography) может служить инструментом защиты индивидуальных прав от вмешательства правительств и крупных корпораций.
...
До появления биткойна было несколько попыток создать цифровую валюту. Например, Дэвид Чаум представил концепцию "анонимных электронных денег" со своим проектом "[DigiCash](https://planb.academy/resources/glossary/ecash-david-chaum)" в 1980-х годах. К сожалению, из-за различных трудностей DigiCash так и не смог процветать.

Еще одним важным предшественником является проект Вэя Дая "[B-money](https://planb.academy/resources/glossary/bmoney)". Хотя она так и не была реализована, в ней была представлена идея анонимной цифровой валюты, в которой обнаружение мошенничества осуществлялось бы сообществом оценщиков, а не центральным органом.
...
Именно в этой благодатной среде таинственный [Сатоши Накамото](https://planb.academy/resources/glossary/nakamoto-satoshi) в 2008 году опубликовал документ о биткоине. В этом документе он объединил несколько идей из движения киберпанка, таких как [доказательство работы](https://planb.academy/resources/glossary/proof-of-work) и криптографические [метки времени](https://planb.academy/resources/glossary/timestamp), чтобы создать [децентрализованную](https://planb.academy/resources/glossary/distributed) и устойчивую к цензуре цифровую валюту.
...
Напротив, государственные фидуциарные валюты ([фиаты](https://planb.academy/resources/glossary/fiat)) легко использовать, но они постоянно обесцениваются теми, кто их контролирует (короли, центральные банки, императоры, диктаторы).
...
- [Блокчейн](https://planb.academy/resources/glossary/blockchain) -> [Lightning Network](https://planb.academy/resources/glossary/lightning-network)

Валюты развиваются и по сей день, приспосабливая свои формы к различным условиям использования. Как мы уже говорили, хотя золото является отличным хранилищем стоимости, оно больше не подходит для современной глобализованной экономики. Аналогичным образом, фидуциарные валюты, такие как доллар и евро, очень ликвидны и легко транспортируемы, поскольку теперь они в основном цифровые, но их стоимость постоянно снижается из-за монетарной [инфляции](https://planb.academy/resources/glossary/inflation).

С другой стороны, биткойн открывает новые перспективы. Его свойства, в частности строго ограниченное предложение, делают его отличным средством сохранения стоимости. Кроме того, как нейтральная интернет-валюта, он представляет собой жизнеспособное **средство обмена**, способное преодолевать границы. Тем не менее, несмотря на продолжающееся принятие (что иллюстрирует [карта BTCmap](https://btcmap.org/map)), сегодня он ещё не получил широкого распространения в торговле.
...
Фактически, биткойн представляет собой ответ на эти системные проблемы, предлагая децентрализованное решение и новую параллельную денежную систему. Исторически сложилось так, что если золото предпочитали использовать в качестве валюты из-за его устойчивости к подделкам, то биткойн точно так же невозможно подделать. Более того, его количество ограничено [21 миллионом единиц](https://planb.academy/resources/glossary/limite-demission) благодаря децентрализованной и криптографической природе. Биткойн - это валюта, которая опирается на прозрачность и нейтральность, предлагая привлекательную альтернативу нынешней централизованной денежной системе.
...
Создание новых биткоинов - это результат процесса [майнинга](https://planb.academy/resources/glossary/mining). В двух словах, майнеры используют мощные компьютеры, решающие сложные математические задачи, которые подтверждают и защищают транзакции. Как только задача решена, майнер добавляет новый [блок](https://planb.academy/resources/glossary/block) транзакций в блокчейн - децентрализованную и распределенную бухгалтерскую книгу, в которой фиксируются все транзакции, совершенные в сети. Блокчейн обеспечивает прозрачность и безопасность, поскольку каждый блок связан с предыдущим, что делает практически невозможным изменение прошлых данных без консенсуса сети.
...
Более подробно мы рассмотрим концепцию майнинга в главе [miner](https://planb.academy/courses/2b7dc507-81e3-4b70-88e6-41ed44239966/dbb8264a-7434-57e4-9d1b-fbd1bae37fdf).
...
- [Регулировка сложности майнинга](https://planb.academy/resources/glossary/difficulty-adjustment) - это процесс, который происходит каждые 2016 блоков, или около двух недель, чтобы гарантировать, что новый блок добавляется в блокчейн в среднем каждые десять минут. Такая частота создания блоков и общее количество биткоинов являются фиксированными аспектами протокола биткоина и не могут быть изменены без общего консенсуса, в отличие от произвольных решений, принимаемых в традиционных денежных системах.

Сложность поиска достоверного [хэша](https://planb.academy/resources/glossary/hash-function) происходит по циклу: если количество майнеров увеличивается, значит, увеличивается и количество блоков, которые они находят, что приводит к уменьшению среднего времени поиска блока. Из-за этого сложность повышается. Как следствие, количество блоков, которые находят майнеры, снижается, а это значит, что механизм возвращается к среднему значению в 10 минут на блок. Для наглядности смотрите изображение ниже.

![image](assets/ru/023.webp)

Знаете ли вы, что у майнеров есть стимул добывать блок, чтобы заработать новые биткоины за счет [субсидии на блок](https://planb.academy/resources/glossary/block-subsidy), а также [платы за транзакции](https://planb.academy/resources/glossary/transaction-fees), которые они включают в этот блок?
...
В разделе 2 мы изучим хранение и безопасность Bitcoin с помощью [кошельков](https://planb.academy/resources/glossary/wallet), чтобы понять, где находятся эти знаменитые биткоины и как с ними взаимодействовать!
...
Будь то ваш "банкир" или вы сами, подавляющее большинство биткойн-кошельков работают по схожей технологии, основанной на асимметричной криптографии, которая подразумевает систему пар ключей: [закрытый ключ](https://planb.academy/resources/glossary/private-key) для расходования и [открытый ключ](https://planb.academy/resources/glossary/public-key) для получения.

- Личный ключ

При инициализации кошелька генерируется [секретная фраза восстановления](https://planb.academy/resources/glossary/recovery-phrase) (приватный ключ), которая представляется вам в виде 12 или 24 слов.
...
Хотя ваши ключи хранятся в кошельке, сами биткоины на самом деле "хранятся" в блокчейне Bitcoin, который является публичной распределенной книгой в [одноранговой](https://planb.academy/resources/glossary/peertopeer-p2p) сети Bitcoin (мы подробно рассмотрим ее в разделе 3). Это означает, что потеря устройства, на котором находится ваш кошелек, не обязательно приведет к потере ваших биткоинов. То, что позволяет вам воссоздать кошелек и потратить биткойны, на самом деле является приватным ключом, поэтому всегда помните о его надлежащей защите!
...
Не забудьте выбрать кошелек, подходящий для ваших нужд и использования: подробные руководства по управлению и защите различных кошельков доступны в разделе [учебники нашего университета](https://planb.academy/tutorials/wallet).
...
- Уровень 0\*\*, вы пользуетесь так называемым "[кастодиальным сервисом](https://planb.academy/resources/glossary/custody)", где вы не являетесь единственным владельцем своих биткоинов. Имейте в виду, что эта доверенная третья сторона может в любой момент ограничить ваш доступ к своим средствам. В этом случае уровень вашего финансового суверенитета аналогичен традиционной банковской системе с банковским счетом.
...
- Уровень 2\*\*, вы используете физический кошелек и защитили свой список из 12/24 слов. Его часто называют "[холодным кошельком](https://planb.academy/resources/glossary/cold-wallet)", поскольку ваши ключи хранятся на устройстве, не подключенном к интернету. В этом случае вам придется подписывать каждую транзакцию с помощью своего устройства, что делает ваши средства менее доступными на ежедневной основе.
...
Существуют различные решения: некоторые из них недорогие, такие как "Блокмит", в то время как другие могут потребовать более специализированного оборудования. Вы можете подробнее изучить эту тему в разделе [tutorials](https://planb.academy/en/tutorials/wallet) нашей академии.
...
Если вы хотите глубже изучить тему плана наследования ваших биткоинов, мы рекомендуем прочитать книгу Памелы Морган [Cryptoasset Inheritance Plan](https://planb.academy/resources/books/28) или записаться на курс BTC102, где мы дадим рекомендации по созданию плана.
...
3 января 2009 года Сатоши официально открыл сеть Bitcoin, создав первый блок, также известный как "[блок Genesis](https://planb.academy/resources/glossary/genesis-block)", который ознаменовал запуск блокчейна Bitcoin. Этот блок содержит откровенное сообщение, отражающее миссию биткойна: "03/jan/2009 Канцлер на грани второго спасения банков"
...
Чтобы глубже изучить труды Сатоши Накамото, рекомендую прочитать [*The Book of Satoshi*](https://planb.academy/resources/books/the-book-of-satoshi-61dea136-f12b-4a19-bdb4-0272bca2ab30) Фила Шампейна, в которой собраны и контекстуализированы его основные тексты, а также документальный фильм ARTE [*Le mystère Satoshi*](https://planb.academy/resources/movies/f48841f0-b9ab-4d44-96e7-84fd5b70e91c), предлагающий доступное и хорошо задокументированное расследование его личности и наследия.
...
На данный момент, несмотря на то что эта транзакция известна всем (с помощью инструмента [Mempool](https://planb.academy/resources/glossary/mempool)), она не может считаться подтвержденной, пока ее не вставит в блок майнер, который является единственным, кто подтверждает транзакции, включая их в блокчейн.
...
**Примечание:** Даже если Алиса получила уведомление о том, что она получила биткойны на один из своих адресов, целесообразно считать транзакцию неизменяемой только после того, как она получила **шесть** [подтверждений](https://planb.academy/resources/glossary/confirmation). Это означает, что поверх блока, содержащего транзакцию Боба, должно быть добыто еще шесть блоков. Другими словами, чем старше транзакция в блокчейне, тем более неизменяемой она становится.
...
Первой в блок всегда включается транзакция **[coinbase](https://planb.academy/resources/glossary/coinbase-transaction)**: она содержит вознаграждение майнера за выполнение работы валидатора. Затем следуют подтвержденные транзакции. Майнеры выбирают для вставки те транзакции, которые приносят им наибольшую прибыль, а именно небольшие транзакции с максимальной комиссией.
...
Чтобы стабилизировать свою бизнес-модель, которая зависит от вознаграждения, получаемого за каждый действительный блок, майнеры часто создают группы в виде "[майнинговых пулов](https://planb.academy/resources/glossary/pool-mining)", где объединяют свои вычислительные ресурсы.
...
Если вы хотите углубить знания по конкретной теме майнинга Биткоина, вы можете обратиться к нашему курсу MIN 101. В нём вы найдёте подробное теоретическое объяснение принципа доказательства работы и его функционирования, а также все связанные с ним концепции.

https://planb.academy/courses/d1ce86d9-c983-49bc-92b3-e3c5269f239e

Я также рекомендую вам ознакомиться с этим более продвинутым практическим курсом, в котором мы объясняем, как превратить ASIC в систему домашнего отопления DIY, чтобы использовать тепло, производимое майнингом, и заработать свои первые сатоши!
...
Судя по прошлым циклам, периодичность экономических циклов биткойна эквивалентна продолжительности между двумя [халвингами](https://planb.academy/resources/glossary/halving), возможно, потому, что событие халвинга действует как триггер, сокращая эмиссию новых биткойнов вдвое.
...
Экономика биткойна существует и развивается в определенных регионах мира, таких как Сальвадор, где биткойн стал законным платежным средством в 2021 году. К сожалению, в январе 2025 года ассамблея приняла новый закон, который лишил биткойн титула "законное платежное средство", предположительно после давления со стороны Международного валютного фонда. Согласно новому закону, люди больше не обязаны принимать биткойн в своих бизнесах и не могут больше платить налоги с его помощью. Принятие остается добровольным.

Тем не менее, в Сальвадоре и в других частях мира все больше людей, компаний и организаций принимают биткойн в качестве средства платежа за свои продукты или услуги.

![btc-map-video](https://youtu.be/2-fEEC9_YT8)

*Источник : [Wicked Smart Bitcoin](https://wickedsmartbitcoin.com)*
...
**Plan ₿ Academy не предоставляет никаких инвестиционных консультаций, и ничто, изложенное здесь, не должно рассматриваться как таковое**
...
Существует несколько способов приобретения биткоинов, каждый из которых подчиняется собственному набору правил, которые могут различаться в зависимости от юрисдикции. Некоторые платформы требуют идентификации для проверки ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)), а другие - нет. Поэтому очень важно понимать правила, связанные с каждой платформой.

- Платформы DCA

Как мы уже рассказывали выше, распространенным методом накопления биткоинов является метод [Dollar Cost Averaging (DCA)](https://planb.academy/resources/glossary/dollar-cost-averaging-dca), который предполагает регулярную покупку небольших сумм. Несколько платформ предлагают такую услугу, например, те, что перечислены на нашей [специальной странице](https://planb.academy/tutorials/exchange). Помимо простоты настройки DCA, вывод средств на ваш кошелек обычно осуществляется автоматически, а значит, вы всегда будете контролировать свои активы.
...
Кроме того, существует несколько [marketplaces](https://planb.academy/tutorials/exchange), где можно купить и продать биткоины в одноранговом обмене. В целом, вы можете рассмотреть следующие варианты:
...
Если вы хотите углубить свои знания о стратегиях покупки, использования и защиты ваших биткоинов, настоятельно рекомендую пройти курс **BTC 102** после этого. Там вы узнаете, в частности, рекомендации по инструментам, соответствующим вашему профилю, вашим потребностям и личным целям:
...
Если вы хотите расширить свои знания о биткойне, то сейчас самое время: большое количество авторов, мыслителей и эссеистов создали образовательный контент о биткойне. В течение последних нескольких лет мы составляли список и классифицировали эти работы, чтобы предложить [библиотеку ресурсов](https://planb.academy/resources) самым любопытным из вас. В этом разделе вы найдете лучшие подкасты, сайты, статьи, учебники, книги и другие материалы.
...
## Сеть Lightning: быстрые платежи в биткоинах с низкими комиссиями

<chapterId>b403f1e4-f1ff-572b-a242-9b58cb3736d0</chapterId>

Теперь, когда вы знакомы с основами протокола Bitcoin, мы можем представить основную платёжную сеть, построенную поверх Bitcoin: Lightning Network (часто сокращается как "LN"). Её цель проста: обеспечить платежи в BTC с практически мгновенной финальностью, не перегружая блокчейн, и с комиссиями, как правило, очень низкими.

### Блокчейн не может делать всё

Блокчейн Bitcoin спроектирован так, чтобы быть проверяемым максимально широким кругом участников, без разрешений и без доверия. Это требование влечёт за собой структурные ограничения: блокчейн не может обрабатывать неограниченное количество транзакций, поскольку блоки должны оставаться разумными по размеру для загрузки, хранения и проверки независимыми узлами без необходимости инвестировать в слишком дорогое оборудование. Этот компромисс часто описывают через трилемму: децентрализация, безопасность, масштабируемость. Система, основанная на блокчейне, не может максимизировать все три свойства одновременно. Bitcoin отдаёт приоритет децентрализации и безопасности, что естественным образом ограничивает возможную пропускную способность [ончейн](https://planb.academy/resources/glossary/onchain)-транзакций.

![image](assets/ru/081.webp)

В Bitcoin разработчики сознательно сделали выбор в пользу этих принципов. С одной стороны, ограничение размера блока до 1 МБ и средний интервал в 10 минут между блоками позволяют запускать Bitcoin-узел с низкими затратами, что способствует децентрализации сети. С другой стороны, производство блоков с помощью доказательства работы делает любые попытки мошенничества чрезвычайно дорогостоящими, одновременно упрощая проверку для узлов и усиливая общую безопасность протокола.

Однако эти решения накладывают существенное ограничение: количество транзакций, которые могут быть включены в каждый блок, ограничено. Это соответствует лишь нескольким транзакциям в секунду. Эта цифра ничтожна по сравнению с возможностями централизованных платёжных систем, таких как VISA (теоретическая максимальная пропускная способность которой составляет около 65 000 транзакций в секунду), но это ограничение — цена, которую приходится платить за транзакции без цензуры и без доверенных посредников.

На практике это означает две очень важные вещи для повседневного использования Bitcoin:
* когда спрос на место в блоке растёт, ончейн-комиссии могут значительно увеличиваться;
* ончейн-платежи требуют подтверждений, что не всегда подходит для повседневных покупок.

Lightning Network как раз и является ответом на эти проблемы. Идея Lightning вписывается в многоуровневый подход: Bitcoin остаётся базовым уровнем (уровнем расчётов, надёжным и крайне безопасным), тогда как Lightning служит уровнем быстрых платежей поверх него.

![image](assets/ru/080.webp)

### Платёжные каналы, привязанные к Bitcoin

Lightning основан на двусторонних [платёжных каналах](https://planb.academy/resources/glossary/payment-channel). Канал — это техническое взаимодействие между двумя участниками, которое позволяет им обмениваться [сатоши](https://planb.academy/resources/glossary/satoshi-sat) [офчейн](https://planb.academy/resources/glossary/offchain), то есть без записи каждого платежа в блокчейн.

С точки зрения Bitcoin (ончейн), открытие канала означает блокировку средств в специальной транзакции. Это можно рассматривать как эскроу: средства заблокированы таким образом, что только корректное закрытие канала может перераспределить их.

С точки зрения Lightning, тот же механизм становится каналом, внутри которого обе стороны могут обновлять состояние распределения сатоши столько раз, сколько захотят, почти мгновенно и без необходимости записывать каждый платёж в основной блокчейн.

Механизм работает следующим образом:
* открытие и закрытие Lightning-канала являются транзакциями Bitcoin (то есть публикуются ончейн);
* платежи между открытием и закрытием — это офчейн-обновления, которые не видны в основном блокчейне.

![image](assets/ru/083.webp)

Таким образом, два человека, разделяющие Lightning-канал, могут совершить очень большое количество платежей, не создавая ончейн-транзакцию каждый раз. Здесь проявляется логика масштабируемости: блокчейн резервируется для редких и важных операций (открытие и закрытие канала, то есть финальный расчёт), а остальные мелкие промежуточные платежи переносятся на более эффективный уровень.

### Сеть взаимосвязанных каналов

Lightning — это не просто набор изолированных каналов. Это сеть: тысячи узлов соединены друг с другом каналами и образуют граф соединений.

![image](assets/ru/082.webp)

Благодаря этой сети вы можете отправить платёж получателю, даже если у вас нет с ним прямого канала, при условии, что существует путь из каналов, позволяющий доставить платёж. Такой платёж проходит через несколько промежуточных узлов, шаг за шагом.

Здесь появляется важное понятие Lightning — ликвидность. Вместимость канала соответствует общему объёму средств, заблокированных в этом канале, а ликвидность — распределению этих средств между двумя сторонами канала, то есть направлению, в котором могут перемещаться сатоши. Иными словами, канал может иметь большую вместимость, но быть непригодным для использования в определённом направлении, если ликвидность находится «не на той стороне». Успех платежей зависит не только от наличия маршрута, но и от доступной ликвидности на всём его протяжении.

### Маршрутизация платежей без доверия к посредникам

Lightning был разработан для того, чтобы обеспечивать платежи через посредников без необходимости им доверять. Для этого протокол использует смарт-контракты, называемые [HTLC](https://planb.academy/resources/glossary/htlc) (*Hashed Time-Locked Contracts*). Не вдаваясь во все детали, запомните общий принцип:
* платёж обусловлен раскрытием секрета (преобраза);
* если конечный получатель раскрывает этот секрет, он получает средства, а посредники, в свою очередь, получают причитающееся им;
* если платёж неудачен, сроки истекают, и каждый возвращает свои средства.

Этот механизм даёт ключевое свойство: платёж является атомарным. Либо он полностью завершается, либо не происходит вовсе без промежуточных потерь.

Наконец, Lightning включает механизм наказаний: если один из участников пытается мошенничать, публикуя старое состояние канала (которое больше не отражает реальность), другой может его наказать и забрать все средства. Это правило сильно стимулирует честное поведение даже во враждебной среде.

### Узел Lightning, кошелёк Lightning: что это означает

В ончейн-Bitcoin кошелёк — это программное обеспечение, которое управляет ключами и создаёт транзакции. В Lightning ситуация более неоднозначна, поскольку по-настоящему некастодиальное использование опирается на Lightning-узел (даже если он скрыт за простым интерфейсом).

На практике существуют две основные категории приложений для использования Lightning:
* Кастодиальные сервисы: приложение показывает вам баланс, но средства контролируются провайдером. Ваш баланс — это бухгалтерская запись в их системе, как на бирже;
* Некастодиальные решения: вы реально контролируете ключи и возможность восстановления своих средств. Это может быть приложение со встроенным узлом с минимальным управлением, упрощающим пользовательский опыт (например, Phoenix, Zeus...), либо полноценный Lightning-узел, которым вы управляете полностью.

https://planb.academy/tutorials/wallet/mobile/phoenix-0f681345-abff-4bdc-819c-4ae800129cdf

https://planb.academy/tutorials/wallet/mobile/zeus-embedded-c67fa8bb-9ff5-430d-beee-80919cac96b9

Сегодня также существуют self-custody-кошельки, способные косвенно поддерживать платежи Lightning, опираясь на атомарные свопы, инициируемые по требованию для каждого входящего или исходящего платежа (например, Bull Bitcoin Wallet, Aqua…). Эти кошельки обычно используют сайдчейн Liquid как уровень расчётов (в следующей главе мы разберём, что это означает).

https://planb.academy/tutorials/wallet/mobile/bull-bitcoin-2c72127c-a228-4f50-b833-c6183d56aaf6

https://planb.academy/tutorials/wallet/mobile/aqua-8e6d7dd3-8c03-45cc-90dd-fe3899a7d125

### Конкретные сценарии использования: что Lightning делает возможным

Lightning открывает широкий спектр сценариев использования, которые ранее были неудобны или даже невозможны при использовании только ончейн-Bitcoin.

- **Повседневные платежи (онлайн и офлайн)**

Для оплаты на кассе или онлайн-покупок Lightning обеспечивает практически мгновенную финальность и, как правило, низкие комиссии. Это делает биткоин пригодным для небольших сумм, даже когда основной блокчейн перегружен.

- **Микроплатежи и streaming money**

Возможность отправлять очень малые суммы открывает новые экономические модели: оплата по факту использования, поминутная оплата, регулярные пожертвования, чаевые… Это идея "streaming money": платить по мере фактического потребления контента или сервиса, а не по фиксированной подписке.

- **Создатели контента, подкасты и пожертвования**

Lightning часто используется для микродонатов и механизмов вознаграждения. Приложения вроде Fountain или Rumble хорошо иллюстрируют эту логику: платёж становится гранулярной и естественной частью пользовательского опыта, а не редким и тяжеловесным действием. Мы также интегрировали эту логику в Plan ₿ Academy, поскольку вы можете легко отправлять небольшие пожертвования своим любимым преподавателям в знак благодарности.

- **Игры и цифровые экономики**

Видеоигры и цифровые среды естественным образом подходят для микротранзакций: небольшие ставки, награды, виртуальные предметы… Введение небольшого денежного стимула также может повысить стоимость спама и некоторых злоупотреблений (ботов), оставаясь при этом доступным.

![image](assets/ru/085.webp)

### Основные реализации Lightning

Как и в случае с Bitcoin, Lightning — это протокол, а не одно конкретное программное обеспечение. Существует несколько реализаций, которые остаются совместимыми благодаря общим спецификациям (BOLT):
* LND (Lightning Labs);
...
### Lightning в контексте эволюции Bitcoin

Lightning не заменяет блокчейн Bitcoin — он его дополняет. Блокчейн остаётся финальным уровнем расчётов, медленным, но крайне надёжным. Lightning — это уровень быстрых платежей, предназначенный для частых операций и небольших сумм.

В 2025 году Lightning стал более доступным, чем в начале своего развития, благодаря кошелькам и сервисам, скрывающим часть сложности. Однако он по-прежнему предполагает компромиссы: ликвидность, ончейн-стоимость каналов и иногда выбор между простотой, суверенитетом и конфиденциальностью.

Если вы хотите глубоко разобраться в Lightning (каналы, ликвидность, маршрутизация, управление рисками), я рекомендую полный теоретический курс LNP 201 от Fanis Michalakis:

https://planb.academy/courses/34bd43ef-6683-4a5c-b239-7cb1e40a4aeb

А если вы хотите начать приключение по эксплуатации собственного Lightning-узла, у нас также есть практический курс LNP 202, специально посвящённый этой теме:

https://planb.academy/courses/593e483e-1785-4e83-aa7e-32b99056844c


## За пределами Lightning: другие протоколы для развития Bitcoin

<chapterId>684e31f9-ebd1-51b6-91c0-1e6a315f1141</chapterId>

Как мы видели в предыдущих главах, Bitcoin был спроектирован как чрезвычайно надёжный базовый уровень: публичный реестр, простой и безопасный, но естественным образом ограниченный по скорости, программируемости и пропускной способности платежей. Вместо того чтобы заставлять этот уровень делать всё (как, например, в Ethereum), экосистема Bitcoin постепенно приняла многоуровневый подход: блокчейн служит фундаментом (финальные расчёты), тогда как верхние уровни добавляют новые свойства — более быстрые платежи, повышенную конфиденциальность или выпуск активов (стейблкоины, токенизированные ценные бумаги…).

Bitcoin развивается не только за счёт изменений своего базового протокола. Он также развивается за счёт надстроек — решений с различными компромиссами в зависимости от поставленных целей. Одни ориентированы на масштабируемость платежей, другие — на программируемость (в широком смысле) и выпуск активов, третьи пытаются сочетать оба подхода.

В этой главе мы представляем четыре важных протокола, каждый из которых открывает новые возможности для Bitcoin: [сайдчейны](https://planb.academy/resources/glossary/sidechain) (в частности Liquid), Ark, RGB и Taproot Assets.

### Sidechains: параллельные блокчейны, подключённые к Bitcoin

Сайдчейн — это блокчейн, отличный от Bitcoin, спроектированный для параллельной работы со своими собственными правилами и механизмом консенсуса. Он связан с Bitcoin через механизм двусторонней привязки (*2WP*), который на практике позволяет использовать биткоины в сайдчейне в представительной форме (часто это биткоин, заблокированный в Bitcoin и воссозданный в сайдчейне), а затем возвращаться обратно в основную цепь.

Интерес сайдчейнов заключается в предоставлении функций, которые сложно реализовать в самом Bitcoin: более быстрые транзакции, функции активов, повышенная конфиденциальность или большая гибкость разработки. Взамен сайдчейн всегда предполагает компромиссы по сравнению с Bitcoin, в частности в модели доверия или уровне децентрализации.

Наиболее известным сайдчейном в экосистеме Bitcoin является **Liquid**, разработанный Blockstream. Он предназначен, в частности, для ускорения определённых сценариев использования: быстрых переводов между платформами, более частых расчётов и выпуска активов (стейблкоинов, ценных бумаг…) с повышенной конфиденциальностью. В Liquid используемые биткоины называются L-BTC: они привязаны к BTC в соотношении 1 к 1 через механизм двусторонней привязки.

![image](assets/ru/088.webp)

Ключевое отличие от Bitcoin заключается в модели безопасности и децентрализации: Liquid не опирается на доказательство работы Bitcoin, а использует федерацию операторов (идентифицированную группу), которая обеспечивает производство блоков и функционирование мостов между BTC и L-BTC.

https://planb.academy/courses/d3ca6943-b22c-4e50-b62d-9431460525bc

### Ark: совместное использование UTXO для снижения затрат и улучшения опыта

Ark — это семейство предложений и реализаций, направленных на повышение масштабируемости Bitcoin за счёт объединения множества пользовательских операций в ограниченное число Bitcoin-транзакций. Идея довольно проста: вместо создания ончейн-транзакции для каждого пользователя создаётся одна ончейн-транзакция, представляющая пакет, после чего права каждого участника в основном эволюционируют вне цепи до момента окончательного расчёта в Bitcoin.

Эта идея протокола второго уровня была представлена Burak в мае 2023 года. Как и Lightning Network, Ark является системой, развёртываемой поверх основной цепи Bitcoin. Она позволяет осуществлять платежи в биткоинах вне цепи быстро, анонимно и с низкими комиссиями. В отличие от Lightning, Ark не требует входящей ликвидности для приёма платежей, что значительно улучшает пользовательский опыт. Кроме того, он обеспечивает конфиденциальность, близкую к [coinjoin](https://planb.academy/resources/glossary/coinjoin)-транзакциям. Ark также может стать неинтерактивным, если в Bitcoin будут добавлены ковенанты.

Burak часто критикует способность Lightning масштабироваться из-за его зависимости от основной цепи и предполагает, что Ark теоретически может интегрировать всё мировое население в self-custody. Хотя Ark можно рассматривать как конкурирующий протокол по отношению к Lightning Network, на практике они могут сосуществовать и даже дополнять друг друга.

Ark остаётся активной, но ещё молодой областью: цель многообещающая (радикально снизить ончейн-нагрузку на пользователя), однако важно помнить, что это более сложная архитектура с предположениями и рисками, отличными от Bitcoin и Lightning.

### RGB: контракты и активы с клиентской валидацией

RGB — это система смарт-контрактов и активов в Bitcoin, использующая радикально иной подход по сравнению с универсальными блокчейнами. Её ключевая идея — клиентская валидация: вместо публикации полного состояния контракта в глобальном блокчейне участники локально хранят и проверяют интересующие их истории, тогда как блокчейн Bitcoin служит лишь для закрепления криптографических обязательств и предотвращения двойного расходования.

Иными словами:
* блокчейн Bitcoin играет роль минимального арбитра и основы временной фиксации;
* детальные данные (правила контракта, состояния, переходы) циркулируют вне цепи между заинтересованными сторонами;
* проверка осуществляется локально, что улучшает масштабируемость и может повышать конфиденциальность, поскольку не существует глобального реестра всех действий RGB, видимого для всех.

![image](assets/ru/089.webp)

RGB может служить основой для выпуска и управления широким спектром активов: токенов (включая стейблкоины), NFT или цифровых ценных бумаг, а также для построения более сложных контрактных логик — и всё это без утяжеления базового уровня.

Обратная сторона медали — управление данными: если вы осуществляете клиентскую валидацию, вы также должны надёжно хранить и резервировать данные, подтверждающие ваши права.

RGB — это протокол, находящийся в разработке уже много лет. Прогресс идёт постепенно, но сегодня уже существуют конкретные приложения, использующие RGB. Чтобы углубиться в тему, на Plan ₿ Academy мы предлагаем курс экспертного уровня, подробно разбирающий работу этого протокола:

https://planb.academy/courses/3ce1d37c-05ba-4f54-aa15-7586d37b2bb7

### Taproot Assets: выпуск активов в Bitcoin и их перемещение по Lightning

Taproot Assets (ранее "Taro") — это протокол, разрабатываемый Lightning Labs, целью которого является выпуск активов в Bitcoin с возможностью последующей передачи этих активов через сеть Lightning для быстрых и недорогих обменов.

Этот компонент часто упоминается в нарративе о "программируемых деньгах" в Bitcoin: не потому, что Bitcoin становится глобальным компьютером, а потому, что поверх базового слоя Bitcoin можно накладывать финансовые инструменты (активы), а затем эффективно перемещать их через Lightning.

### Bitcoin укрепляется, позволяя верхним уровням инновации

Сегодня наиболее точное представление экосистемы Bitcoin — это не застывший протокол и не «суперблокчейн», делающий всё, как в случае с Ethereum. Скорее, это намеренно консервативный фундамент, окружённый уровнями и протоколами, которые экспериментируют и позволяют инновации с минимальным принятием риска.
