...
O Satodime, um **carte au porteur, pertence a quem o possuir fisicamente**, sem necessidade de registo ou identificação prévia. Responde à necessidade de armazenamento Bitcoin seguro e portátil, permitindo que qualquer pessoa que possua o cartão o utilize ou transfira bitcoins, digitalizando-o através da aplicação móvel para tomar posse ou desbloquear cofres. Ao contrário de uma nota de papel, utiliza um chip seguro para Seal as chaves privadas, que só são reveladas após a abertura, tornando o cartão semelhante ao dinheiro, em que o Ownership é determinado pela posse física. Ideal para oferecer bitcoins como presentes, facilita a transferência segura de bitcoins de mão em mão, enquanto a aplicação móvel explora o NFC para uma interação acessível com o smartphone.
...
- Aviso**: Este passo é irreversível. Consulte [o artigo *Ownership*] (https://satochip.io/satodime-Ownership-explained/).
...
O Satodime suporta até 3 cofres. Crie um para armazenar Bitcoin :
...
- Selecionar Blockchain (Bitcoin).
- Clicar em "*Criar e Seal*".
- Digitalizar o cartão para generate e Seal a chave privada (desconhecida até ser aberta).
...
- Copiar o Address público ou ler o código QR.
- Enviar fundos de outro Wallet.
- Verificar o saldo após a confirmação no Blockchain.
...
Depois de retirar o selo, exportar a chave para utilização noutro Wallet :
...
- Importá-lo para um programa informático Wallet compatível com a gestão de fundos (por exemplo, Sparrow wallet ou Electrum).
...
A reposição do cofre elimina de forma irreversível a chave privada associada. Por outras palavras, se não tiver assegurado uma cópia da sua chave privada ou se não a tiver importado para outro Wallet, a reposição do cofre provocará a perda irreversível dos fundos nele contidos.
...
- Tirar Ownership do cartão,
- Criar um cofre Bitcoin,
- Transferir Satss para lá,
- Transferir cartão Ownership: a pessoa seguinte a digitalizar o cartão torna-se o seu proprietário,
- Entregue o cartão Satodime a uma pessoa à sua escolha e convide-a a descarregar a aplicação e a digitalizar o cartão para obter o Ownership - e assim aceder aos bitcoins "armazenados" no mesmo.
...
- Verificar o estado**: Efetuar sempre a leitura para confirmar o cartão Ownership e o estado selado/não selado dos cofres.
...
- Recuperação**: Se o cartão for perdido mas tiver dono, os fundos estão no Blockchain; utilize a chave privada se não estiver selado.
...
[Plan ₿ Network](https://planb.network/) para tutoriais sobre auto-custódia, chaves privadas, etc.
...
**A Satochip** é uma empresa belga que desenvolve soluções de hardware e software para gerir e armazenar bitcoins e outras criptomoedas. O seu principal produto, o Satochip Hardware Wallet, é um cartão NFC equipado com um secure element com certificação EAL6+. Complementado pelo Seedkeeper, um gestor de frases e segredos Mnemonic, e o Satodime, um cartão ao portador, a Satochip oferece uma gama completa adaptada às necessidades dos utilizadores. Os seus dispositivos, alimentados por software de código aberto, têm como objetivo democratizar a segurança no Bitcoin.