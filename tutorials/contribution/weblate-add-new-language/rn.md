...
Kugira turabe ko ururimi rwawe rusanzwe ruri muvyo turiko turakora.



- Genda kuri [urubuga rwacu rwa Weblate](https://urubuga.planb.urubuga/imigambi/urubuga-rw'urubuga/):

![language](assets/01.webp)


- Mu `Urubuga Elements`, uzosanga urutonde rw'indimi zose ziriko zirakorwa:
...
- Intambwe ya mbere ni ugukora konti kuri Weblate ukanda kuri "Register" iri hejuru iburyo (niba ukeneye imfashanyo iyo ariyo yose, urashobora gusubira ku nyigisho twavuze haruguru gusa).



- Konti yawe imaze kuremwa, genda kuri `Urubuga Elements` maze uhitemwo `Indimi`:

![language](assets/03.webp)


- Fyonda kuri `+` hejuru ibubamfu bw'idirisha:

![language](assets/04.webp)


- Ugurure urutonde ruja hasi maze uhitemwo ururimi wipfuza kwongerako. Niba ururimi uriko urarondera rutari muri list igenda ihinduka, urashobora gushikira [umugwi wa Telegram](https://t.me/PlanBNetwork_ContentBuilder) kugira ngo ikipe yacu ishobore kuruhingura n’amaboko:

![language](assets/05.webp)


- Fyonda kuri `Tangira ubuhinduzi bushasha`:

![language](assets/06.webp)


- Uzoca ushika kuri paji y'ubuhinduzi bw'ururimi rwawe:

![language](assets/07.webp)


- Kugira ngo utangure guhindura Elements y'urubuga, kanda kuri buto `Guhindura`: ![ururimi](assets/08.webp)
