...
Наиболее очевидной особенностью является [повторное использование адреса](https://planb.academy/resources/glossary/address-reuse) приема в одной и той же транзакции.
...
### [Атомный обмен](https://planb.academy/resources/glossary/atomic-swap)
