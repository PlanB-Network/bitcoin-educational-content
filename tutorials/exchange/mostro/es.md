...
¿Cómo adquirir o vender bitcoins sin comprometer su soberanía financiera? Las plataformas centralizadas imponen procedimientos KYC invasivos que exponen tus datos personales, con la posibilidad de congelación arbitraria de cuentas o vigilancia estatal.



**Mostro P2P** ofrece una alternativa descentralizada que combina Lightning Network, el protocolo Nostr y las facturas de retención. Su mayor innovación: un sistema de custodia automatizado en el que sus bitcoins permanecen bajo su control durante todo el intercambio, eliminando el riesgo de robo, quiebra del intercambio o confiscación arbitraria.
...
La **aplicación móvil** en versión alfa permite operar con P2P directamente desde su smartphone. Interface gráfica intuitiva con navegación por pestañas, visualización de órdenes, filtros avanzados y chat integrado para comunicarse con sus contrapartes.
...
**Importante para la sincronización CLI/Móvil**: Para acceder a los mismos pedidos en CLI y en la app móvil, debes utilizar la **misma Mostro Pubkey** y los **mismos relés Nostr** en ambos clientes. Compruebe esta configuración en Ajustes de la aplicación móvil.
...
Compile e instale el programa CLI :
...
Primero instale Rust vía [rustup.rs](https://rustup.rs/), luego use PowerShell :
...
Mostro te pedirá una **factura relámpago** para recibir el BTC. Se indica la cantidad exacta en satoshis (aquí: 4715 sats).
...
### Paso 3: Facilite su factura Lightning



Genere una factura Lightning desde su wallet (Phoenix, Breez, etc.) por el importe exacto y envíela :
...
El sistema confirma el envío y le indica que espere a que el vendedor pague la factura de retención antes de activar la custodia.
...
En cuanto el vendedor confirme la recepción del fiat y libere la plica con el comando `release`, recibirás al instante tus bitcoins en la factura Lightning que le hayas proporcionado.
...
- Rayo Address** (opcional): Para recibir pagos directamente
...
**Instrucción importante**: Ahora debe **pagar la factura de retención** mostrada para bloquear sus bitcoins (aquí 4674 sats por 1-5 EUR) en la custodia. Tienes **15 minutos máximo** de lo contrario el intercambio será cancelado.



Copie la factura de retención y páguela desde su wallet Lightning (Phoenix, Breez, etc.).
...
Una vez que haya **confirmado la recepción** del pago en fiat en su cuenta, pulse el botón verde **RELEASE** y confirme para enviar el satss al comprador.
...
Los Bitcoins se transfieren instantáneamente al comprador a través de su factura Lightning.
...
4. Proporcione su factura Lightning (generada a partir de su wallet)
...
9. Recibe bitcoins al instante en tu factura Lightning
...
**Soberanía financiera**: Tus bitcoins nunca abandonan tu control directo gracias al mecanismo de retención de factura, eliminando el riesgo de quiebra o piratería del intercambio.
...
La P2P de Mostro representa una alternativa prometedora a las bolsas centralizadas, ya que combina la Lightning Network, Nostr y la custodia automatizada para una negociación verdaderamente descentralizada. A pesar de su incipiente desarrollo y su limitada liquidez, la plataforma ya ofrece soberanía financiera, resistencia a la censura y anonimato por defecto.
