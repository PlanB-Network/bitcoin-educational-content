...
![imagem](assets/fr/032.webp)

![imagem](assets/fr/033.webp)
...
Definições comuns de hiperinflação, como a proposta por Cagan, que estabelece uma inflação mensal de 50%, podem às vezes ser confusas ou simplistas. Por exemplo, dois países com taxas de inflação anual de 1.000% e 3.000%, respectivamente, podem ser percebidos de maneira diferente dependendo da distribuição mensal dessa inflação. Se nenhum mês ultrapassar o limite de 50%, de acordo com a definição de Cagan, esses países não estariam em estado de hiperinflação. Essa abordagem pode levar a anomalias na classificação da hiperinflação, especialmente ao comparar inflações acumuladas ao longo do ano.

![image](assets/fr/038.webp)

- O trabalho de Cagan, "Monetary Dynamics of Hyperinflation", que estabelece uma análise fundamental da hiperinflação.
- O livro de Bernholz, que estuda 30 períodos distintos de hiperinflação, ampliando assim o espectro de análise.
- A coleção pessoal de notas de David de 36 períodos de hiperinflação, permitindo uma compreensão tangível e histórica.
- A tabela Hanky Cross (versão 2012, atualizada em 2016 com a Venezuela), listando 57 períodos de hiperinflação com base na definição de Cagan.

É importante observar que alguns períodos históricos de alta inflação não estão presentes nas tabelas clássicas de hiperinflação, muitas vezes devido aos critérios rigorosos de classificação. Por exemplo, durante a Guerra de Independência dos Estados Unidos em novembro de 1779 e durante a Guerra Civil Americana em março de 1864, as taxas de inflação mensal eram de 47,4% e 40%, respectivamente. Essas taxas, embora altas, não ultrapassam o limite de 50% estipulado por Cagan, excluindo assim esses períodos dos casos classificados como hiperinflação. Essa omissão ilustra as limitações das definições rígidas e destaca a necessidade de uma abordagem mais sutil para compreender a hiperinflação em toda a sua complexidade.
...
- Dois livros sobre a hiperinflação no Zimbábue, "Zimbabwe Warm Heart Ugly Face" e "Hard Boiled Egg Index" de Jérôme Gardner e Kudzai Joseph Gou Min-Yu respectivamente, oferecem testemunhos comoventes de um CEO de uma cadeia de lojas de roupas e de um banqueiro agrícola sobre suas experiências durante este período turbulento.

![image](assets/fr/040.webp)

Ao consolidar minhas anotações, percebi uma infinidade de semelhanças entre as experiências de hiperinflação no Zimbábue e na República de Weimar, apesar dos 90 anos que as separam. Identifiquei cerca de 17 semelhanças, das quais 13 ilustravam uma espécie de progressão em direção ao desastre econômico descrito nestes testemunhos. Esses paralelismos fascinantes demonstram a natureza repetitiva e devastadora da hiperinflação ao longo do tempo e das fronteiras. Hoje, examinaremos essas semelhanças e como elas retratam uma trajetória preocupante durante períodos de hiperinflação.

### Análise comparativa: Zimbábue e a República de Weimar

O jogo das 14 diferenças!

#### 1. Escassez de moeda

Quando a moeda se deprecia a uma velocidade vertiginosa, até mesmo as tentativas mais ambiciosas de inundar o mercado com novas cédulas podem se revelar insuficientes. A demanda incessante por moeda tangível pode ultrapassar em muito a capacidade dos bancos centrais de produzir cédulas, criando crises de liquidez sem precedentes.

> Weimar: "Durante este mês, será aumentada para quase 4 bilhões de marcos de papel, um valor com o qual se espera que a escassez de moeda seja definitivamente superada."
...
> Weimar: "A emissão total atual é de 63.000 bilhões. Em poucos dias, poderemos emitir dois terços da circulação total em um único dia."
...
#### 11. Forçados a manter suas lojas abertas
...
#### 2. Propriedade privada em tempos de conflitos
...
![imagem](assets/fr/052.webp)

À direita do slide, há um gráfico da inflação. As setas vermelhas representam os anos de hiperinflação, definidos pelo critério de Cagan como uma inflação de 50% ao mês. Esse critério às vezes pode levar a interpretações ambíguas, com anos apresentando altas taxas de inflação, mas não atendendo à definição estrita de hiperinflação.
...
As conclusões mencionadas são retiradas do livro "Monetary Regime and Inflation" de Bernholz. De acordo com o autor, o único método para acabar com a inflação é realizar uma reforma monetária e impor restrições ao governo. Essas restrições envolvem a criação de uma instituição, como um banco central, que opera de forma independente das decisões políticas do governo. A hiperinflação é frequentemente o resultado do financiamento de déficits orçamentários por meio da criação de moeda. Para controlar a inflação moderada, é essencial reduzir o crescimento da oferta monetária. Bernholz também sugere que esse crescimento monetário seja relativo aos países vizinhos. Um ponto surpreendente é que, durante períodos de alta ou hiperinflação, o valor total da oferta monetária pode realmente diminuir. Um exemplo marcante dessa situação é o do Zimbábue.
...
[Descubra a coleção digitalizada no *Bitcoin Educational Toolkit* (também acessível a partir da seção *Recursos* da plataforma Plan ₿ Network.](https://penpot.planb.network/#/view?page-id=c157057b-fd28-8042-8004-4f081b21defc&file-id=c157057b-fd28-8042-8004-4f081b21defb&section=interactions&index=0&share-id=7154756b-3ebd-8040-8004-6475c2af5889&interactions-mode=show-on-click)

![imagem](assets/fr/072.webp)
