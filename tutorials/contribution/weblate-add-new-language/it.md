...
- Apri il menù a tendina e seleziona la lingua che desideri aggiungere. Se la lingua che stai cercando non è disponibile nell'elenco, puoi scrivere sul [gruppo Telegram](https://t.me/PlanBNetwork_ContentBuilder) in modo che il nostro team possa crearla manualmente:
...
- Per iniziare a tradurre gli elementi statici del sito web, clicca sul pulsante `Translate`:
