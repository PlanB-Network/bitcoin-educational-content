...
definition: Formatos de codificação para endereços SegWit (começando por bc1), que oferecem uma melhor deteção de erros e maior legibilidade em comparação com os endereços Legacy.
---
