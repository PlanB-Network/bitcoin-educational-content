...
[فهرست فروشندگان در این صفحه در دسترس است](https://bitaxe.org/legit.html)
...
در این آموزش، ما از Braiins Mining pool استفاده می‌کنیم، اما شما آزاد هستید که یکی دیگر را انتخاب کنید. می‌توانید آموزش‌های ما در مورد استخرهای Mining را [در وب‌سایت Plan ₿ Academy](https://planb.academy/en/tutorials/mining) پیدا کنید.
