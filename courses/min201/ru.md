...
Далее пора снять оригинальный вентилятор, стараясь не повредить другие компоненты. Для этого снимите винты, которые держат его на месте, и аккуратно отклейте белый клей вокруг разъема. Важно это делать с осторожностью, чтобы избежать повреждения проводов или разъемов.
...
Если у вас нет этого адаптера, вы все равно можете продолжить подключение нового вентилятора, используя клеммную колодку нужного размера. Для этого вам нужно будет разрезать кабели старого и нового вентилятора.

![image](assets/hardware/6.webp)
![image](assets/hardware/7.webp)

На новом вентиляторе при помощи ножа аккуратно разрежьте контуры основной оболочки на 1 см, не повреждая оболочки кабелей под ней.
...
Затем соедините кабели с помощью клеммного зажима, черный провод с черным, а красный провод с красным. Вы также можете добавить изоленту.
