...
- 通过密码或生物识别**进行本地锁定：该应用程序提供密码和/或指纹/人脸识别锁定。因此，即使有人实际访问了您未上锁的手机，他们也无法打开 Proton Authenticator。
...
在 MacOS 上的 Proton Authenticator 中，点击 "创建新代码"。应用程序会为您提供几个选项： **扫描二维码**或手动输入密钥**。
