...
Bitstackの特徴は、自動丸めシステムであり、ユーザーの銀行口座を同期して、日常の支出で引き落とされた金額と次の1ユーロとの間の差額を直接ビットコインに変換します。この方法は、*Dollar Cost Averaging*（DCA）の適用を容易にし、サトシを段階的かつ痛みなく蓄積することを可能にします。この独自の機能に加えて、プラットフォームは自動投資による従来のDCAシステムや、単発の売買も提供しています。
