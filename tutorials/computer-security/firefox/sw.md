---
name: Firefox
description: Jinsi ya kusanidi Firefox kulinda faragha yako?
---
...
Sote tunatumia saa nyingi mtandaoni, mara nyingi bila kutambua kile kivinjari chetu kinafichua kutuhusu. Kila kubofya, kila utafutaji, kila tovuti tunayotembelea hulisha tasnia kubwa ya ukusanyaji wa data ya kibinafsi.
...
*Sehemu ya soko ya kivinjari cha wavuti: Chrome inatawala kwa 65% ya soko, ikifuatiwa na Safari na Edge. Chanzo: [gs.statcounter.com](https://gs.statcounter.com/browser-market-share)*
...
**Upakuaji rasmi:** Nenda kwa [firefox.com/browsers/desktop](https://www.firefox.com/en-US/browsers/desktop/). Kwenye ukurasa huu, chagua mfumo wako wa kufanya kazi (Windows, macOS, Linux) ili kufikia ukurasa unaofaa wa kupakua na maagizo maalum ya usakinishaji.
...
**Kidokezo:** Mara baada ya kusakinishwa, angalia masasisho kupitia Usaidizi → **Kuhusu Firefox** (muhimu kwa viraka vya usalama).
...
*Skrini ya kwanza wakati wa kuzindua Firefox: weka Firefox kuwa kivinjari chako chaguomsingi, kiongeze kwenye njia zako za mkato, kisha ubofye "Hifadhi na uendelee"*
...
*Hatua ya hiari: fungua au ingia kwenye akaunti ya Firefox. Unaweza kuruka hatua hii kwa kubofya "Si sasa" chini kulia*
...
*Skrini ya kwanza ya Firefox mara tu usanidi utakapokamilika. Kumbuka menyu ya ☰ iliyo juu kulia, ambayo inatoa ufikiaji wa Mipangilio na Viendelezi vya kubinafsisha Firefox*



## Ulinzi ambao tayari umeamilishwa kwa chaguo-msingi (ya kuhakikishia)
...
## Kiwango cha 1 - Muhimu (≤ dakika 10)



Kusudi: faida kubwa za faragha bila kuvunja wavuti. Kwa 90% ya watumiaji.
...
*Ukurasa wa mipangilio ya Firefox - kichupo cha "Jumla". Hapa ndipo unaposanidi chaguo zako nyingi za faragha*



**Kinga ya Ufuatiliaji (ETP)**
...
Hapa kuna viwango tofauti vya usalama vya ETP:
...
- Washa **"Futa vidakuzi na data ya tovuti karibu "** ili kuwasha upya kwa usafi kila unapowasha upya.
- Ongeza **Vighairi Vighairi** kwa tovuti 2-3 muhimu ukipenda (barua pepe, benki).


**Ingizo otomatiki la data, mapendekezo na ukurasa wa nyumbani**
...
- Washa **"Modi ya HTTPS katika madirisha yote tu"**.
...
**Udhibiti wa Faragha Duniani (hiari)**




- Washa **GPC** ili kuashiria kukataa kwako kuuza/kushiriki data.
...
- Badili hadi **DuckDuckGo**, **Startpage**, **Qwant** au **Utafutaji kwa Ujasiri** (Mipangilio → Utafutaji).
...
**Urambazaji wa kibinafsi**




- Dirisha za kibinafsi (Ctrl/Cmd+Shift+P) kwa vipindi vya mara moja (zawadi, akaunti za upili...). Epuka hali ya "faragha kila wakati": viendelezi vinaweza kuwa havitumiki na vighairi vya vidakuzi visivyofaa sana.



**Viendelezi muhimu** (sakinisha kutoka kwa katalogi rasmi)
...
## Kiwango cha 2 - Imeimarishwa (Ugawanyaji na Mtandao)



Lengo: kugawanya shughuli na kupunguza uvujaji wa mtandao.
...
**Viendelezi vya hali ya juu** (vitahifadhiwa)
...
## Kiwango cha 3 - Mtaalam (kuhusu:config & Arkenfox)



Lengo: ugumu wa hali ya juu na maelewano yanayokubalika. Imependekezwa kwenye **wasifu tofauti**.



Chagua moja tu kati ya njia mbili zifuatazo:
...
➡️ **Arkenfox tayari inajumuisha YOTE kuhusu:mabadiliko ya usanidi yaliyotajwa hapa chini** + mamia zaidi. Ukichagua Arkenfox, puuza kuhusu:sehemu ya usanidi.



### Mbinu A: Marekebisho ya Mwongozo kupitia kuhusu:config



Andika `kuhusu:config` katika upau wa Address → Kubali hatari.
...
- Upinzani wa uchapaji vidole (iliyorithiwa kutoka kwa Kivinjari cha Tor)
...
Madoido: Saa za eneo la UTC, **boxboxing** (ukubwa wa kawaida wa dirisha), Wakala/sera sanifu, Vizuizi vya Canvas/WebGL/AudioContext. Usawa zaidi, lakini "quirks" chache (wakati wa kukabiliana, wakati mwingine kidogo ya Kiingereza).
...
- Kirejeleo pamoja na patanifu (chaguo-msingi)
...
Chaguo kali (linaweza kuvunja malipo/SSO):
...
- Kuzuia API za mazungumzo na uvumi
...
Kanuni ya dhahabu: ikiwa kitu kitavunjika, rudi kwenye mabadiliko ya mwisho.



### Mbinu B: Arkenfox user.js (Usanidi otomatiki kikamilifu)



Mradi wa **Arkenfox** unatoa faili ya `user.js` inayodumishwa na jumuiya ambayo inatumika kiotomatiki mamia ya mapendeleo ya Firefox yenye ufaragha na usalama. Inapowashwa upya, Firefox inasoma faili hii kutoka kwa wasifu wako na kutumia mipangilio hii.





- Kuna maana gani? Anza kutoka kwa **msingi mgumu thabiti ** bila "kubofya kila mahali"; kupunguza uangalizi; kuokoa muda.
...
2. Pakua `user.js` kutoka `https://github.com/arkenfox/user.js` (ESR/toleo thabiti).


3. Tafuta folda yako ya wasifu kupitia `kuhusu:profiles`:
...
- Fuata matoleo ya Arkenfox (iliyopangwa ESR), badilisha `user.js`, zindua upya Firefox; soma maelezo ya kutolewa.



**Kubinafsisha kupitia Ubatilifu**



Arkenfox inazuia kwa makusudi kwa chaguo-msingi. Ili kurekebisha mipangilio fulani kulingana na mahitaji yako (kutiririsha, kuona, tovuti maalum), unaweza kuunda faili ya `user-overrides.js` katika folda sawa na `user.js`. Faili hii hukuruhusu "kubatilisha" mapendeleo fulani ya Arkenfox bila kurekebisha faili kuu.



Unda `user-overrides.js` na uongeze ubinafsishaji wako:
...
- Mchanganyiko uliopendekezwa: Firefox (Kiwango cha 2) + VPN kwa matumizi ya kila siku; Tor/Mullvad kwa shughuli nyeti; wasifu tofauti kwa ugawaji.
...
**Faragha yako sasa inalindwa vyema zaidi**: vifuatilizi vya matangazo vimezuiwa, vidakuzi vimegawanywa, uvujaji wa IP Address haubadiliki, telemetry imezimwa. Firefox si kivinjari tu, bali ni zana ya upinzani ya kidijitali iliyoundwa kulingana na mahitaji yako.
...
- [Wiki na mwongozo wa usakinishaji](https://github.com/arkenfox/user.js/wiki): Kamilisha hati za mradi wa Arkenfox
- [Amana na matoleo](https://github.com/arkenfox/user.js): Pakua faili ya user.js na ufuatilie masasisho



### Waelekezi na jumuiya
...
- [Funga Nyimbo Zako (EFF)](https://coveryourtracks.eff.org/): Uwekaji alama za vidole dijitali na ufanisi wa kuzuia ufuatiliaji
- [Jaribio la Uvujaji wa DNS](https://www.dnsleaktest.com/): Jaribio la uvujaji wa DNS na ufanisi wa DoH
