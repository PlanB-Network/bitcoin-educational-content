...
Seedkeeper je čipová karta vyvinutá belgickou společností Satochip, která se specializuje na hardwarová řešení pro správu a ochranu digitálních tajemství. Společnost Satochip, známá svou řadou čipových karet pro ekosystém Bitcoin, navrhla Seedkeeper jako alternativu k tradičním metodám ukládání frází Mnemonic.



Konkrétně má Seedkeeper podobu multifunkční čipové karty s certifikací EAL6, zabezpečeným procesorem a pamětí odolnou proti manipulaci (tj. "secure element*"). Jak napovídá její název, jejím úkolem je šifrovaně a chráněně ukládat fráze a hesla Bitcoin Mnemonic. Pomocí nástroje Seedkeeper můžete svá tajemství generate importovat, organizovat a ukládat přímo do zabezpečené součásti karty.
...
- Bitcoin** Úložiště frází Mnemonic: namísto zapisování 12 nebo 24 slov na papír je můžete importovat na čipovou kartu a chránit je kódem PIN.
- Správa hesel**: prostřednictvím aplikace Seedkeeper můžete vytvořit 10 silných hesel a uložit je přímo na čipovou kartu, čímž získáte pohodlného a snadno použitelného offline správce hesel.
...
V porovnání s jednoduchou papírovou zálohou věty Mnemonic má použití nástroje Seedkeeper několik výhod:
...
Ve srovnání s prostou papírovou zálohou seed však existuje řada nevýhod:
...
- Závislost na univerzálním výpočetním zařízení:** Vstup do seed a jeho správa vyžadují počítač nebo chytrý telefon, což znamená, že váš Mnemonic prochází zařízením s mnohem širším povrchem pro útoky než Hardware Wallet. To může představovat riziko, pokud je pracovní stanice napadena. Proto nedoporučuji používat Seedkeeper k ukládání seed z Hardware Wallet (s výjimkou bezstavového použití bez počítače, jako je tomu u SeedSigner). Úkolem Hardware Wallet je právě ukládání seed v minimalistickém, vysoce zabezpečeném prostředí. Ručním zadáním seed do běžného počítače se již neomezuje na Hardware Wallet: ocitá se také na univerzálním počítači, který je vystaven mnoha vektorům útoku. Proto je lepší použít Seedkeeper pro Hot Wallet než pro Cold (s výjimkou SeedSigner / bezstavového Hardware Wallet).





- Riziko ztráty spojené s PIN:** přímá nedostupnost seed na rozdíl od papírové zálohy skutečně poskytuje ochranu proti fyzické krádeži. Jako vždy je však zabezpečení otázkou rovnováhy mezi rizikem krádeže a rizikem ztráty. Pokud vaše záloha vyžaduje PIN, ztráta tohoto kódu znemožní obnovení fráze Mnemonic, a tím i přístup k vašim bitcoinům.



Vzhledem k těmto výhodám a nevýhodám považuji za nejlepší využití Seedkeeperu (kromě jeho funkce správce hesel) jednak ukládání semínek z vašich **softwarových portfolií**, protože se již nacházejí ve vašem telefonu nebo počítači, nebo z vašich hardwarových peněženek bez obrazovky, jako je Satochip, a jednak jeho použití v kombinaci s bezstavovým Hardware Wallet, jako je SeedSigner, kde se skutečně uplatní.
...
Poté kartu přiložte na zadní stranu smartphonu. Aplikace zjistí, že aplikace Seedkeeper ještě nebyla inicializována, a vyzve vás k nastavení kódu PIN čipové karty, který má 4 až 16 znaků. Pro optimální zabezpečení zvolte silné heslo, které bude co nejdelší, náhodné a složené z různých znaků. Tento kód PIN je jedinou překážkou proti fyzickému přístupu k vaší frázi pro obnovení.
...
## 5. Zaregistrujte si seed v nástroji Seedkeeper
...
Vyberte možnost "Importovat tajné*". Volba "*Tajný kód generate*" umožňuje vytvořit novou frázi Mnemonic přímo z aplikace.
...
V našem případě chceme v portfoliu uložit společnost seed. Klikněte na "*Mnemonic*".
...
Poté zadejte frázi pro obnovení do příslušného pole. Pokud si přejete, můžete také přidat kód passphrase BIP39 nebo své *Deskriptory*. Poté klikněte na tlačítko "Importovat*".
...
*Mnemonic zobrazený na tomto obrázku je fiktivní a nikomu nepatří. Jedná se pouze o příklad. Nikdy nikomu neprozrazujte svůj vlastní Mnemonic, jinak vám budou vaše bitcoiny ukradeny
...
Pokud chcete zkontrolovat frázi Mnemonic, vezměte si nástroj Seedkeeper a klikněte na tlačítko "*Click & Scan*".
...
Tím se dostanete na seznam všech vašich registrovaných tajemství. V tomto příkladu chci zobrazit seed v mém portfoliu "*BLOCKSTREAM App*", takže na něj kliknu.
...
Na obrazovce se nyní zobrazí dříve zaznamenaná fráze Mnemonic.
...
Tím se dostanete na domovskou stránku se seznamem vašich tajemství. Klikněte na tři malé tečky v pravém horním rohu okna Interface.
...
To je vše! Nyní již víte, jak použít nástroj Seedkeeper k uložení fráze Mnemonic z Bitcoin Wallet. V některém z příštích tutoriálů se podíváme na to, jak používat Seedkeeper k ukládání hesel. Zvu vás také k objevení jeho kombinovaného použití se SeedSignerem :
