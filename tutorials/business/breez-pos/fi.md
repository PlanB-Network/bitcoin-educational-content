...
COVID-19-pandemian jälkeen kosketuksettomat digitaaliset maksut ovat levinneet laajalti jopa pienimpiin kauppoihin. Tänä aikana monet yritykset ovat havainneet Bitcoin-käteisratkaisujen käytännöllisyyden, sillä niiden avulla ne voivat vastaanottaa maksuja kaikkialta maailmasta. Näitä ratkaisuja on kuitenkin joskus vaikea käyttää tai ne eivät sovellu pienille yrityksille. Tässä opetusohjelmassa tutustumme Breez-maksupäätteeseen, ratkaisuun, joka erottuu edukseen helppokäyttöisyydellään ja antaa sinulle samalla täydellisen hallinnan bitcoinien hallinnasta.
...
Breez POS on Breez Wallet:n tarjoama itsesäilytyspalvelu. Tämän palvelun hyödyllisyys on se, että kauppiaat voivat kerätä maksuja Bitcoin:n kautta ja pysyä samalla yksinkertaisella Interface:lla, joka on hyvin samanlainen kuin erilaiset Lightning-lompakot. Breez POS on saatavilla [Google Play Store](https://play.google.com/store/apps/details?id=com.breez.client) (Android) ja [App Store](https://apps.apple.com/app/breez-lightning-client-pos/id1463604142) (iOS) -latausalustoilla.
...
"*Myyntipiste*"-valikosta löydät Interface:n maksujen keräämistä varten. Se on jaettu kahteen osaan:
...
Ensimmäinen osa on suoraveloitusnäppäimistö. Tämä Interface on kätevä, kun keräät yhden maksun, kun tiedät asiakkaasi kokonaisostokset tai kun et tarvitse yrityksessäsi kiinteää tuoteluetteloa (esim. freelance-palvelut).
...
Jotta voit käyttää Breez POS:ää ensimmäistä kertaa, sinun on kerättävä yli 2500 satoshin (noin 3 euroa Exchange:n nykykurssilla) suuruinen maksu. Tämä summa, joka maksetaan vain ensimmäisellä kotiutuskerralla, vastaa maksukanavan luomisesta aiheutuvia kustannuksia, jotta voit kommunikoida muiden Lightning Network-solmujen kanssa ja lähettää ja vastaanottaa satosheja.
...
Toinen osa on tuoteluettelo. Tämä Interface on ihanteellinen, kun sinulla on tuoteluettelo, jossa on ennalta määritellyt hinnat. Tässä voit määrittää tuotteet valmiiksi ja käyttää niitä sitten generate laskuissa parantaaksesi kassakuittien jäljitettävyyttä.
...
Voit määrittää jokaisen tuotteen manuaalisesti tästä Interface:stä napsauttamalla "**Plus**"-painiketta ja määrittelemällä sitten tuotteen nimen, hinnan ja tunnisteen.
...
Tässä samassa kohdassa voit määrittää Lightning-laskujen voimassaoloajan. Tästä lähtien asiakkaillasi on kaikkien laskujesi osalta `N` sekuntia aikaa suorittaa maksu, muutoin sinun on luotava uusi Lightning Invoice.
...
Johtajana voit vahvistaa bitcoinien turvallisuutta lisäämällä salasanan, joka vaaditaan kaikkiin Wallet:sta lähteviin maksuihin. Tämä ominaisuus on erityisen hyödyllinen, kun et ole ainoa, joka hallinnoi ulostuloa.
