...
В настоящее время наиболее полнофункциональным watch-only приложением является [Sentinel](https://github.com/wanderingking072/sentinel-android), изначально разработанное командами Samourai Wallet и теперь поддерживаемое сообществом. Оно объединяет все основные функции для качественного watch-only кошелька:
...
Начните с установки приложения Sentinel. Вы можете сделать это с помощью [APK, доступного для загрузки в репозитории проекта на github](https://github.com/wanderingking072/sentinel-android/releases).
...
Затем вам нужно будет обязательно подключиться к собственному Dojo, поскольку серверы Samourai Wallet больше не доступны. Если у вас ещё нет собственного Dojo, вы можете воспользоваться Dojo, предоставленным сообществом на сайте [The Dojo Bay](https://dojobay.pw/), или следовать нашему руководству для установки своего собственного :
