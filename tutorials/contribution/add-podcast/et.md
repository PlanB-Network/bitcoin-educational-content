...
- Minge [PlanB andmetele pühendatud GitHubi repositooriumisse](https://github.com/Plan ₿ Academy/bitcoin-educational-content/tree/dev/resources/podcasts) jaotisesse `resources/podcasts/`:
