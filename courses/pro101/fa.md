...
- کیف‌پول‌های غیر حضانتی**: کاربران کلیدهای خصوصی را نگه می‌دارند، ممکن است مدیریت نقدینگی دستی نیاز باشد. نمونه‌ها شامل Breeze و OBW هستند.
...
مفهوم‌سازی شده توسط Breeze Wallet، ارائه‌دهندگان خدمات رعد و برق (LSPs) با هدف بهبود تجربه کاربری از طریق امکان دریافت فوری طراحی شده‌اند. LSPها کانال‌هایی را برای کاربران باز می‌کنند، مشابه نحوه ارائه خدمات اتصال توسط ارائه‌دهندگان خدمات اینترنت. این نوآوری فرآیند ورود کاربران را ساده کرده و تعاملات بی‌وقفه‌ای را در Lightning Network تضمین می‌کند.
