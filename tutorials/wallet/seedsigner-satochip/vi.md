...
Satochip là thiết bị Hardware Wallet dạng thẻ thông minh, được chứng nhận EAL6+, một trong những tiêu chuẩn bảo mật cao nhất. Sản phẩm được thiết kế và sản xuất bởi công ty Bỉ cùng tên: Satochip.



Với mức giá khoảng 25 euro, Satochip nổi bật so với các đối thủ cạnh tranh nhờ giá trị tuyệt vời. Nhờ chip bảo mật, sản phẩm có khả năng chống lại các cuộc tấn công vật lý. Hơn nữa, mã nguồn của applet này hoàn toàn là mã nguồn mở, được cấp phép theo *AGPLv3*.
...
- Satochip có giá khoảng 25 euro, và vì applet này là mã nguồn mở, bạn có thể tự cài đặt nó trên một thẻ thông minh trống. Sau đó, bạn phải cộng thêm chi phí cho các thành phần SeedSigner và phần mở rộng để đọc thẻ thông minh: tùy thuộc vào nơi bạn mua phần cứng này, tổng chi phí sẽ dao động từ 70 đến 100 euro.
...
Chiến lược sao lưu được chọn ở đây tùy thuộc vào sở thích của bạn, nhưng điều bắt buộc là phải có ít nhất một bản sao cụm từ Mnemonic, trên phương tiện vật lý (giấy hoặc kim loại) hoặc, như ở đây, trong Seedkeeper. Bạn cũng có thể nhân số lượng bản sao lưu tùy theo nhu cầu. Để biết thêm thông tin về các chiến lược sao lưu danh mục đầu tư, tôi khuyên bạn nên đọc hướng dẫn này:



https://planb.academy/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270

Để sao lưu seed của bạn trên Seedkeeper, hãy vào trực tiếp menu `Sao lưu seed`.
...
Chọn một `Nhãn` để dễ dàng nhận dạng các bí mật khác nhau của bạn được lưu trữ trên Seedkeeper. Ví dụ: bạn có thể chỉ cần giữ dấu vân tay của Wallet hoặc chỉ rõ `seed`. Lựa chọn tùy thuộc vào sở thích và mức độ rủi ro của bạn.
...
Sau khi danh mục đầu tư của bạn đã được tạo, lưu và kiểm tra, chúng tôi sẽ chuyển nó sang Satochip. Để thực hiện việc này, hãy đảm bảo seed đã được tải vào RAM của SeedSigner. Sau đó, hãy vào `Công cụ > Công cụ Thẻ thông minh > Chức năng Satochip`.
...
Sau đó, bạn có thể đặt mã PIN Satochip, từ 4 đến 16 ký tự. Để tăng cường bảo mật cho Wallet, hãy chọn một mã dài, ngẫu nhiên: đây là biện pháp bảo vệ duy nhất chống lại việc truy cập vật lý vào cụm từ Mnemonic của bạn.



Hãy nhớ lưu mã PIN này ngay sau khi tạo, có thể là trong trình quản lý mật khẩu an toàn hoặc trên phương tiện vật lý, tùy thuộc vào chiến lược cá nhân của bạn. Trong trường hợp sau, hãy đảm bảo không bao giờ lưu phương tiện chứa mã PIN ở cùng nơi với Satochip của bạn, nếu không việc bảo vệ sẽ trở nên vô dụng. Điều quan trọng là phải có bản sao lưu: **nếu không có mã PIN này, bạn sẽ không thể truy cập seed của mình nữa và số bitcoin của bạn sẽ bị mất vĩnh viễn**.
...
Tiếp theo là lựa chọn chuẩn kịch bản. Chọn chuẩn mới nhất: `Native SegWit`.
...
Sau đó, SeedSigner sẽ tạo xpub của bạn dưới dạng mã QR động, chứa tất cả dữ liệu bạn cần để quản lý danh mục đầu tư trong Sparrow wallet. Bạn có thể điều chỉnh độ sáng màn hình bằng cần điều khiển để quét mã QR dễ dàng hơn.
...
Sau đó, SeedSigner sẽ yêu cầu bạn quét ngẫu nhiên mã Address nhận được từ Sparrow wallet của bạn để xác nhận tính hợp lệ của lần nhập.
...
Satochip (thông qua SeedSigner) và Sparrow wallet của bạn hiện đã được kết nối an toàn. Sparrow đóng vai trò là thiết bị quản lý toàn diện Interface, trong khi Satochip vẫn là thiết bị duy nhất có khả năng ký các giao dịch của bạn. Giờ đây, bạn đã sẵn sàng nhận và gửi bitcoin trong cấu hình air-gapped hoàn toàn.
...
Một phiên bản Bitcoin Address mới xuất hiện. Bạn sẽ tìm thấy:




- Address ở định dạng văn bản (bắt đầu bằng `bc1q...` nếu bạn đang sử dụng P2WPKH, như trong ví dụ này);
- Mã QR liên quan;
- Trường `Nhãn` hữu ích để theo dõi các giao dịch của bạn.



Tôi thực sự khuyên bạn nên thêm nhãn vào mỗi biên lai Bitcoin trong Wallet của mình. Điều này sẽ giúp bạn dễ dàng xác định nguồn gốc của mỗi UTXO và quản lý quyền riêng tư tốt hơn. Để tìm hiểu thêm về chủ đề quan trọng này, hãy xem khóa đào tạo chuyên sâu trên Plan ₿ Academy:
...
Trước khi gửi mã Address nhận được cho người thanh toán, điều quan trọng là phải kiểm tra xem mã này có thuộc về mã seed của bạn hay không. Bước này đảm bảo Satochip của bạn có thể ký các giao dịch liên quan đến mã Address này. Nó cũng ngăn chặn các cuộc tấn công tiềm ẩn khi Sparrow hiển thị mã Address giả mạo. Lưu ý rằng Sparrow chạy trên một môi trường không an toàn (máy tính của bạn), nơi có bề mặt tấn công lớn hơn nhiều so với Satochip của bạn, vốn hoàn toàn bị cô lập. Đây là lý do tại sao bạn không bao giờ nên tin tưởng mù quáng vào các địa chỉ được hiển thị trong Sparrow trước khi kiểm tra chúng trên Hardware Wallet.



Trong Sparrow, hãy nhấp vào mã QR của Address để phóng to: sau đó mã sẽ được hiển thị toàn màn hình.
...
Nếu Address được quét trùng khớp với mã seed của bạn, SeedSigner sẽ hiển thị thông báo: `Address Verified`.
...
Khi đó, bạn có thể chắc chắn rằng Address nằm trong danh mục đầu tư của bạn.
...
Giờ đây, bạn có thể gửi Address này dưới dạng văn bản hoặc qua mã QR cho người hoặc dịch vụ cần gửi Satss cho bạn. Sau khi giao dịch được phát trên mạng, nó sẽ xuất hiện trong tab `Giao dịch` của Sparrow wallet.
...
- Trong `Pay to`, hãy dán Address của người nhận hoặc quét mã QR của họ bằng biểu tượng máy ảnh;
...
Bây giờ giao dịch đã được ký và xác thực, việc còn lại là phát nó trên mạng Bitcoin để Miner có thể đưa nó vào BLOCK. Trong Sparrow, nhấp vào `Quét QR`.
...
Trình bày mã QR hiển thị trên SeedSigner (mã chứa giao dịch đã ký) cho webcam. Sparrow sau đó sẽ hiển thị tất cả thông tin chi tiết về giao dịch. Kiểm tra lại lần cuối để đảm bảo tất cả thông tin đều chính xác, sau đó nhấp vào "Phát sóng giao dịch" để phát sóng trên mạng Bitcoin.
...
Giao dịch của bạn hiện đã được truyền đến mạng. Bạn có thể theo dõi xác nhận trong tab `Giao dịch` của Sparrow wallet.
...
- Bằng cách ghi lại cụm từ Mnemonic trên một phương tiện vật lý;
...
- Nhập cụm từ Mnemonic theo cách thủ công vào menu `Seeds > Enter 12-word seed`.
