...
Ważne jest, aby zrozumieć, że Stratum nie jest zintegrowane jako zasada w Bitcoin, ale jest raczej specyficznym oprogramowaniem używanym przez baseny. Chociaż baseny Mining mogą go nie używać, Stratum stał się standardem dla Bitcoin Mining przez ponad dziesięć lat. Jego druga wersja, Stratum V2, jest obecnie w fazie rozwoju. Ma ona na celu udoskonalenie Stratum i zmniejszenie obaw związanych z centralizacją związanych z pulami Mining.