...
- Nella schermata iniziale del Wallet, fare clic sulla scheda "Impostazioni", quindi su "Dettagli Wallet" e copiare la zPub ([chiave pubblica estesa](https://planb.academy/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f):
...
- Apprendimento ed esercitazioni: **[Plan ₿ Academy](https://planb.academy/)**
...
- **Liquid Network** :
- [Glossario](https://planb.academy/fr/resources/glossary/liquid-network)
...
- **Lightning Network**:
- [Glossario](https://planb.academy/fr/resources/glossary/lightning-network)
