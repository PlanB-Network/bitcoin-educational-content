...
- Warning**: This step is irreversible. Please refer to [the *Ownership* article](https://satochip.io/satodime-Ownership-explained/).
...
- Import it into a Wallet software program compatible with fund management (e.g. Sparrow wallet or Electrum).
...
[Plan ₿ Network](https://planb.network/) for tutorials on self-custody, private keys, etc.
