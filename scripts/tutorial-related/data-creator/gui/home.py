...
class HomePage(ctk.CTkFrame):
    def __init__(self, parent, settings):
        ...
        # Row 5: Control board with large buttons for resource creation
        ...
        self.tutorial_button = ctk.CTkButton(
            button_frame, text="New Tutorial", command=self.open_tutorial_page,
        ...
        self.professor_button = ctk.CTkButton(
            button_frame, text="New Professor", command=self.open_professor_page,
            width=250, height=100, font=("Arial", 18)
        )
        self.professor_button.grid(row=0, column=1, padx=20, pady=20)
        
        self.project_button = ctk.CTkButton(
            button_frame, text="New Project", command=self.open_project_page,
            width=250, height=100, font=("Arial", 18)
        )
        self.project_button.grid(row=0, column=2, padx=20, pady=20)
        
        # Row 6: Theme toggle button (only on the home page)
    ...
    def update_settings(self):
        """Update settings with current values from the home page."""
