---
term: Bitcoin QT
definition: Bitcoin-client met een grafische interface gepubliceerd in 2011, in 2014 hernoemd naar Bitcoin Core.
---
...
> ► *De "QT" komt van de naam van de bibliotheek die gebruikt wordt voor de grafische Interface. De naam "QT" wordt soms geïnterpreteerd als een woordspeling op het geluid van de term "schattig". De naam "QT" wordt soms geïnterpreteerd als een woordspeling op de klank van de term "cute".*