...
Изначально доступная только в Канаде, платформа теперь доступна в Европе и многих других странах с совершенно новым оптимизированным интерфейсом. Эта новая версия Bull Bitcoin позволяет легко и быстро покупать и продавать биткоины с использованием Lightning и мгновенных SEPA-переводов. Также интегрирована оплата счетов в биткоинах. В будущем платформа планирует интеграцию опций DCA, автоматических покупок и лимитных ордеров.

Bull Bitcoin гордится тем, что предоставляет прозрачный сервис без скрытых комиссий. Обратите внимание, что, как и большинство бирж, использование Bull Bitcoin требует прохождения процедуры KYC (идентификация клиента).
...
## Запустить автоматическую регулярную покупку (DCA)
