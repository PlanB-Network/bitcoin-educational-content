...
Para mayo de 2024, Braiins Pool cuenta con una potencia de cómputo de 13 EH/s, lo que representa aproximadamente el 1.8% del total del [hashrate](https://planb.academy/resources/glossary/hashrate) de Bitcoin. Ha minado un total de 1,307,188 Bitcoin, lo que es aproximadamente el 6% de los 21 millones máximos de Bitcoin que existirán.
