...
![La preistoria di Bitcoin](assets/posters/en/1._bitcoin_prehistory.png)
...
![La moneta](assets/posters/en/3._money.png)

## Le valute fiduciarie

![Le valute fiduciarie](https://youtu.be/1hOrDrmT27g)
...
![Le monete Fiduciarie](assets/posters/en/4._fiat_currency.png)
...
![Le iperinflazioni](assets/posters/en/5._hyperinflation.png)
...
![21 milioni di bitcoin](assets/posters/en/6._21_millions.png)
...
![spiegazione dei portafogli Bitcoin](assets/posters/en/8._what_is_a_bitcoin_wallet.png)
...
![scegliere la propria sicurezza](assets/posters/en/9._choose_the_right_wallet.png)

## Creazione di un portafoglio

![creare un portafoglio](https://youtu.be/2MRRERHm7ZM)
...
![mettere in place un portafoglio](assets/posters/en/10._set_up_your_wallet.png)

## Resistere alla prova del tempo

![Resistere alla prova del tempo](https://youtu.be/p8eZPt_XnwI)
...
![Resistere alla prova del tempo](assets/posters/en/19._think_long_term.png)
...
![Lancio di Bitcoin](assets/posters/en/7._lancement_bitcoin.png)
...
![Spiegazione di una transazione](assets/posters/en/11._explaination_of_a_transaction.png)
...
![i nodi Bitcoin](assets/posters/en/12._nodes.png)
...
![I minatori](assets/posters/en/13._miners.png)

## Bitcoin e l'ecologia

![Bitcoin e l'ecologia](https://youtu.be/nV2b2xAMfmU)
...
![Bitcoin e l'ecologia](assets/posters/en/14._ecological_debate.png)
...
![Bitcoin non dorme mai](assets/posters/en/15._bitcoinr_never_sleeps.png)
...
![Ottenere Bitcoin lavorando](assets/posters/en/17._earn_your_bitcoin.png)
...
![risparmio in bitcoin](assets/posters/en/16._saving_in_bitcoin.png)
...
![hyper-bitcoinizzazione](assets/posters/en/18._hyperbitcoinization.png)
...
![Lightning Network](assets/posters/en/20._lightning_network.png)

## Casi d'uso di Lightning Network

![Casi d'uso di LN](https://youtu.be/_UV2jmQ8TQM)
...
![Casi d'uso di LN](assets/posters/en/21._ln_use_cases.png)
...
![pillola rossa](assets/posters/en/2._oprange_pill.png)
...
![Ringraziamenti e continuate a scavare la tana del coniglio](https://youtu.be/A2P5GdkgB-M)
