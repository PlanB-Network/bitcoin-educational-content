...
Tämä lähestymistapa kuvaa Moonin ensisijaista tavoitetta: tehdä bitcoinista suuren yleisön saatavilla oleva maksuväline helpottamalla jokapäiväisiä maksuja kaikkialla maailmassa samalla, kun odotetaan, että useammat kauppiaat hyväksyvät tämän maksuvälineen alun perin. Se on eräänlainen silta Bitcoin:n ja perinteisen pankkimaailman välillä. Tässä opetusohjelmassa kutsumme sinut tutustumaan tähän innovatiiviseen palveluun, sen konseptiin ja sen tarjoamiin tärkeimpiin ominaisuuksiin.
...
Moon tuo mukanaan merkittävän innovaation: virtuaalisten pankkikorttien rahoittamiseen voi käyttää bitcoinia ja muita kryptovaluuttoja. Palvelu hyödyntää Visan infrastruktuuria, jotta voit saada uudelleenladattavia bitcoin-kortteja (Lightning) avaamatta pankkitiliä tai antamatta mitään henkilötietoja tiettyihin käyttörajoihin asti.
...
Kuten olet ehkä huomannut, tämän virtuaalikortin hankkiminen ei vaadi mitään henkilötietoja: tarvitset vain sähköpostiosoitteen ja salasanan. KYC vaaditaan vain, jos ylität kuukausittaiset käyttörajat.
...
Moon-kortti ladataan Moon-krediiteillä, joita voit ostaa maksamalla :
...
Vähimmäissumma on 5 USD per lataus, eikä Moon X -kortillesi ole asetettu ylempää latausrajaa. Aseta summa, jonka haluat ladata, ja maksa sitten luotu Lightning-lasku.
...
Korttiasi hyvitetään automaattisesti heti, kun Lightning-laskun maksu on vahvistettu.
...
Tämän virtuaalikortin avulla voit maksaa tuotteista ja palveluista verkossa aivan kuten millä tahansa perinteisellä Visa-kortilla. Voit esimerkiksi ottaa uusimman Bitcoin mining premium-kurssin, joka on saatavilla alustallamme. Vaikka tämä esimerkki on puhtaasti havainnollistava (koska hyväksymme jo nyt maksuja natiivibittikolikoilla), se osoittaa, miten helppoa Moon-kortin käyttö on.
...
Kutsumme sinut myös tutustumaan opetusohjelmaamme Bitrefill, jotta voit käyttää Bitcoin maksaa lahjakortteja suosikki palvelut :
