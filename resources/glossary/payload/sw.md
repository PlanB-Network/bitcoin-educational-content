...
- `bc`: sehemu inayoweza kusomeka na binadamu (HRP);
- `1`: kitenganishi ;
- `q`: Toleo la SegWit. Hili ni toleo la 0;
- `c2eukw7reasfcmrafevp5dhv8635yuqa`: mzigo wa malipo, katika kesi hii, Hash ya ufunguo wa umma;
- `ys50gj`: cheki.