...
Da biste uspešno pokrenuli toranj (osmatračnicu), potrebno je da bitcoind bude pokrenut pre pokretanja tornja sa teosd komandom. Pre pokretanja obe ove komande, potrebno je da podesite vaš Bitcoin.conf fajl. Evo koraka kako to da uradite:-


1. Instalirajte Bitcoin core sa izvora ili ga preuzmite. Nakon preuzimanja, postavite Bitcoin.conf datoteku u korisnički direktorijum Bitcoin core-a. Proverite ovaj link za više informacija o tome gde postaviti datoteku jer to zavisi od operativnog sistema koji koristite.
...
#RPC
server=1
rpcuser=<tvoj_korisnik>
rpcpassword=<tvoja_lozinka>
...
- regtest: Nije obavezno, ali korisno ako želite da razvijate 
...
2. Nakon što ste uspešno instalirali teos na vaš sistem i pokrenete testove, možete preći na poslednji korak, a to je podešavanje teos.toml fajla u teos korisničkom direktorijumu. Fajl treba da bude smešten u folderu nazvanom .teos (obratite pažnju na tačku) u vašem home folderu. To jest, na primer, /home/<vaše-korisničko-ime>/.teos za Linux. Kada pronađete mesto, kreirajte teos.toml fajl i postavite ove opcije koje odgovaraju stvarima koje smo promenili na bitcoind.
...
Obratite pažnju da ovde korisničko ime i lozinka moraju biti napisani u navodnicima, dakle, za isti primer kao ranije:
...
u prevodu: _GREŠKA [teosd] Nema dovoljno blokova za pokretanje tornja (potrebno: 100). Iskopajte još najmanje 100_
...
To je to, uspešno si pokrenuo/la toranj. Čestitamo. 🎉
