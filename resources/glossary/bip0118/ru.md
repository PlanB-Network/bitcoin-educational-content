...
definition: Предложение ANYPREVOUT, вводящее новые флаги SigHash, которые позволяют повторно использовать подписи в разных транзакциях, что полезно для Eltoo.
---
