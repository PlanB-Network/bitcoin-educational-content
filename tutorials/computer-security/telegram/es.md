---
name: Cuenta de Telegram
description: Mensajes y mucho más, en móvil y escritorio
---
...
En la siguiente página encontrarás algunos consejos útiles para descargar el archivo `.apk`; si no los necesitas, haz clic directamente en _Descargar Telegram_.
...
Deja que Telegram se instale


![image](assets/en/06.webp)


luego ábrelo desde tu teléfono y elige _Iniciar mensajería_.


![image](assets/en/07.webp)


Como toda buena app de mensajería VoIP, el funcionamiento de Telegram también se basa en una línea telefónica que funcione. Para empezar, debes introducir tu número de teléfono: Telegram enviará un SMS de verificación con un código OTP.
...
En el menú principal, seleccione _Mi perfil_.


![image](assets/en/33.webp)


En la siguiente pantalla, seleccione el icono del "lápiz" en la parte superior derecha para entrar en el menú de edición del perfil.


![image](assets/en/12.webp)


Verás todos los datos sensibles de tu cuenta, incluido tu número de teléfono y dos campos vacíos: _Bio_ y _Username_.
...
No pueden, gracias a la unicidad del nombre de usuario.
...
Vuelve al menú principal y luego a _Configuración_:
...
Aquí encontrarás toda una serie de parámetros importantes para ajustar según cómo quieras usar tu cuenta de Telegram.
...
- _Número de teléfono_ a "Nadie"
- _Llamadas_ a "Mis contactos"
- _Invita_ a "Nadie"

Son medidas que evitarán que tu número de teléfono quede al descubierto, por lo que no recibirás llamadas no deseadas ni serás añadido sin saberlo a grupos de dudosa procedencia. Después, podrás ajustar el resto de parámetros a tu gusto.
...
A continuación, los contactos aparecerán en la pantalla principal.
...
Si, en cambio, realizas la misma operación en uno de tus mensajes, **descubrirás que puedes editar tus propios mensajes, incluso los ya enviados**.


También puedes adjuntar archivos de gran tamaño, intercambiando medios "pesados" con facilidad, mucho más que el resto de aplicaciones de este tipo.
...
El chat aparece en primer plano, listo para ser utilizado.
...
**(1)** _No utilices la nube de Telegram para información confidencial como contraseñas, pines, mnemónicos y datos de este tipo_.
...
Se abrirá un menú desplegable en el que deberá seleccionar _Cerrar sesión_.


⚠️ **No cerrarás la sesión, no te preocupes: elegimos este menú sólo para acceder a la funcionalidad de la que estamos hablando**.


![image](assets/en/24.webp)


Entre las opciones, elija _Borrar caché_.


![image](assets/en/25.webp)


El dispositivo comienza a cuantificar el espacio de almacenamiento utilizado. Una vez finalizado el cálculo, aparecerá el botón _Borrar caché_.


![image](assets/en/26.webp)


Al hacer clic en él, aparecerá una pantalla de confirmación, en la que deberá volver a elegir _Borrar caché_ para continuar.
...
Abre la aplicación en tu móvil, ve al menú principal (las tres líneas de la parte superior izquierda).


![image](assets/en/31.webp)


Seleccione _Configuración_


![image](assets/en/19.webp)


e inmediatamente después de _Dispositivos_.


![image](assets/en/20.webp)


Ahora seleccione _Enlazar dispositivo de escritorio_


![image](assets/en/32.webp)


La cámara de tu teléfono se activa. En el primer uso, es probable que tu Android te pida permisos: concédelos.


![image](assets/en/21.webp)


Ahora escanea el código QR que ha aparecido antes en la pantalla del ordenador.


![image](assets/en/22.webp)


Una notificación en el teléfono confirma que el nuevo dispositivo se ha añadido correctamente.
