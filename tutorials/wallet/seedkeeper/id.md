...
Seedkeeper adalah smartcard yang dikembangkan oleh Satochip, sebuah perusahaan Belgia yang berspesialisasi dalam solusi perangkat keras untuk mengelola dan melindungi rahasia digital. Terkenal dengan rangkaian kartu pintarnya untuk ekosistem Bitcoin, Satochip mendesain Seedkeeper sebagai alternatif dari metode tradisional untuk menyimpan frasa Mnemonic.



Secara konkret, Seedkeeper berbentuk sebuah kartu pintar bersertifikasi EAL6 yang multifungsi dengan prosesor yang aman dan memori anti perusakan (yaitu "secure element*"). Seperti namanya, perannya adalah untuk menyimpan frasa dan kata sandi Bitcoin Mnemonic secara terenkripsi dan terlindungi. Dengan Seedkeeper, Anda dapat generate, mengimpor, mengatur, dan menyimpan rahasia Anda secara langsung di dalam komponen kartu yang aman.
...
- Bitcoin** Penyimpanan frasa Mnemonic: alih-alih menuliskan 12 atau 24 kata di atas kertas, Anda dapat mengimpornya ke dalam smartcard dan melindunginya dengan kode PIN.
...
Seedkeeper juga sangat menarik jika digabungkan dengan Hardware Wallet tanpa kewarganegaraan seperti SeedSigner atau Specter DIY. Dalam hal ini, tidak perlu menggunakan komputer atau klien seluler Satochip. Seedkeeper menyimpan seed dalam secure element dan dapat digunakan langsung dengan perangkat penandatanganan, sehingga tidak perlu lagi menggunakan kode QR kertas. Saya tidak akan mengembangkan kasus penggunaan khusus ini dalam tutorial ini, karena ini adalah subjek dari tutorial khusus lainnya:
...
Dibandingkan dengan cadangan kertas sederhana dari frasa Mnemonic, menggunakan Seedkeeper memiliki beberapa keuntungan:
...
- Ketergantungan pada perangkat komputasi serba guna:** Memasuki dan mengelola seed memerlukan komputer atau ponsel cerdas, yang berarti Mnemonic Anda melewati mesin dengan permukaan serangan yang jauh lebih luas daripada Hardware Wallet. Hal ini dapat menimbulkan risiko jika stasiun kerja disusupi. Inilah mengapa saya tidak menyarankan penggunaan Seedkeeper untuk menyimpan seed dari Hardware Wallet (kecuali untuk penggunaan tanpa komputer, seperti pada SeedSigner). Peran Hardware Wallet justru untuk menyimpan seed dalam lingkungan yang minimalis dan sangat aman. Dengan memasukkan seed secara manual pada komputer biasa, seed tidak lagi terbatas pada Hardware Wallet: seed juga akan berakhir pada mesin umum, yang terpapar pada banyak vektor serangan. Jadi, lebih baik menggunakan Seedkeeper untuk Hot Wallet daripada Cold (kecuali SeedSigner / Hardware Wallet tanpa kewarganegaraan).





- Risiko kehilangan yang terkait dengan PIN:** Ketidakmampuan mengakses langsung seed, tidak seperti cadangan kertas, memang memberikan perlindungan terhadap pencurian fisik. Namun seperti biasa, keamanan adalah tindakan menyeimbangkan antara risiko pencurian dan risiko kehilangan. Jika cadangan Anda memerlukan PIN, hilangnya kode ini akan membuat Anda tidak dapat memulihkan frasa Mnemonic, dan dengan demikian mengakses bitcoin Anda.



Dengan mempertimbangkan kelebihan dan kekurangan ini, saya menganggap bahwa penggunaan terbaik untuk Seedkeeper (terlepas dari fungsi pengelola kata sandinya) adalah, di satu sisi, menyimpan benih dari **portofolio perangkat lunak** Anda, karena sudah ada di ponsel atau komputer Anda, atau dari Dompet Perangkat Keras tanpa layar Anda seperti Satochip, dan di sisi lain, menggunakannya dalam kombinasi dengan Hardware Wallet yang tidak memiliki kewarganegaraan seperti SeedSigner, di mana ia benar-benar berfungsi dengan baik.
...
Pilih "Impor rahasia*". Opsi "*generate secret*" memungkinkan Anda membuat frasa Mnemonic baru secara langsung dari dalam aplikasi.
...
*Mnemonic yang ditampilkan dalam gambar ini adalah fiktif dan bukan milik siapa pun. Gambar ini hanya sebuah contoh. Jangan pernah mengungkapkan Mnemonic Anda kepada siapa pun, atau bitcoin Anda akan dicuri
...
Jika Anda ingin memeriksa frasa Mnemonic Anda, ambil Seedkeeper Anda dan klik tombol "*Klik & Pindai*".
...
Ini akan membawa Anda ke daftar semua rahasia Anda yang terdaftar. Dalam contoh ini, saya ingin menampilkan seed dalam portofolio saya "*Aplikasi BLOCKSTREAM*", jadi saya mengkliknya.
...
Frasa Mnemonic yang Anda rekam sebelumnya, sekarang ditampilkan di layar.
...
Ini akan membawa Anda ke halaman beranda dengan daftar rahasia Anda. Klik pada tiga titik kecil di kanan atas Interface.
