...
goal: Antminer S9をAttakaiに再利用し、ガイド付きセットアップによる家庭用マイニング向けDIYヒーターにする。
objectives:
  - ビットコインマイニングの基礎を理解する
  - 中古のAntminer S9を安全に入手する
  - Attakai DIYヒーターを構築する
...
MIN 302、Attakaiプロジェクトに関するコースへようこそ。Ajelex、Jim、Rogzyが、ビットコインマイニングの必須要素をご案内し、その後、中古S9から作られたDIY家庭用暖房システムであるAttakaiの構築を段階的にサポートします。コースを楽しんでいただき、ホームマイニングの冒険に乗り出していただければ幸いです!
