...
Dva glavna dela naše platforme su kursevi i tutorijali. Kursevi pružaju teorijske obrazovne resurse, dok tutorijali nude praktičan sadržaj koji pokazuje kako koristiti određeni alat (na primer, Hardware Wallet ili softver) ili određenu praksu (kao što je osiguravanje Mnemonic fraze ili proveravanje autentičnosti softvera).
...
## Kako da predložim novi kurs?


Ako imate ideju za kurs Bitcoin koji još nije prisutan na platformi i želite da ga napišete, možete nas kontaktirati na sledeći Address:


contact@planb.network


U svojoj poruci, molimo vas da se ukratko predstavite i opišete svoju ideju za kurs. Ako već imate ideju za strukturu vašeg kursa, molimo vas da uključite i pojedinačna poglavlja. Javićemo vam se što je pre moguće da objasnimo kako dalje i, ako je potrebno, razgovaramo o strukturi vašeg kursa.
...
Prvenstveno tražimo tutorijale o alatima povezanim sa Bitcoin ili njegovim ekosistemom. Ovaj sadržaj se može podeliti u šest glavnih kategorija:
...
Predstavite se ukratko i navedite specifičan sadržaj koji biste želeli da pišete, kao i jezik na kojem biste želeli da pišete, slanjem poruke u kanalu "General". Član tima će zatim kreirati problem na GitHub-u koji odgovara vašem budućem doprinosu.


Ako nemate Telegram nalog i radije ga ne biste kreirali, možete nas kontaktirati i putem e-pošte na sledeći Address
