---
name: Debifi
description: Hankige Bitcoin poolt garanteeritud mittekaitstav laen.
---
...
Traditsiooniline laenamine on sajandeid võimaldanud rahastada paljusid projekte. Siiski on see endiselt aeglane, kulukas ja mitte väga kaasav, eriti nende jaoks, kellel puudub juurdepääs kindlale pangainfrastruktuurile.



Bitcoin protokolli kasutuselevõtt juhatas sisse uue finantsajastu, mis tõi endaga kaasa mitmeid väljakutseid. Üks neist väljakutsetest oli see, kuidas saada likviidsust, ilma et oleks sunnitud Bitcoin müüma, kaotades seeläbi oma kasvupotentsiaali



Tulemuseks on **Debifi**, platvorm, mis positsioneerib end kaasaegse alternatiivina pankadele. Eesmärk on selge: muuta laenamine võimalikult lihtsaks ja läbipaistvaks, ühendades traditsioonilise finantssüsteemi eelised Bitcoin pakutava vabadusega. Nimi Debifi peegeldab seda visiooni: ***Decentralized Bitcoin Finance***, mis on kokkuvõtte, mis illustreerib detsentraliseeritud finantseerimise ja Bitcoin innovatsiooni kohtumist.
...
- Laenu ja väärtuse (LTV)** suhe määrab, kui palju raha saate laenata Bitcoin tagatiseks. LTV suhe = laenusumma / tagatise summa * 100. Näiteks LTV 50% tähendab, et laenu väärtus on võrdne 50% hoiustatud Bitcoin väärtusest.




BTC Sessions videoõpetus :
...
Debifiga alustamiseks on vaja mõningaid eeldusi.
...
Enne kui saate Debifist laenutada, veenduge, et teil on olemas järgmised esemed:
...
- KYC (*Know Your Customer*): sõltuvalt valitud laenupakkumisest võidakse nõuda isikusamasuse kontrollimist. Debifis on igas pakkumises märgitud, kas KYC on nõutav või mitte. Seega valmistuge vastavalt ette. KYC-i teostavad usaldusväärsed kolmandatest isikutest teenusepakkujad, näiteks Sumsub.
...
- Laenude võtmiseks on vaja Debifi mobiilirakendust (iOS/Android). Te peate rakenduse alla laadima, looma konto ja "siduma" oma seadme (seadme registreerimine oma kontoga). Debifi rakendus toetab kahefaktorilist autentimist (2FA) ja ilma nutitelefonita ei saa te Debifis tehinguid kinnitada.
...
Külastage [Debifi ametlikku veebisaiti](https://debifi.com/app).
...
Paigaldage rakendus vastavalt teie nutitelefoni tüübile ja avage see seejärel.
...
Kui olete rakenduses, klõpsake menüüs **Settings**.
...
Saate e-kirja teel kinnituskoodi. Kopeerige see kood ja kleepige see rakendusse. Seejärel avage Debifi rakendus oma nutitelefonis ja logige sisse.
...
### Oma konto kindlustamine



Turvalisuse tagamiseks palub Debifi teil järgida kolme sammu.
...
- Kõigepealt peate määrama tugeva PIN-koodi, et hiljem oma rakendusele ligi pääseda.
...
- Seejärel seadistage kahefaktoriline autentimine (2FA), et seostada seade oma kontoga 2FA-koodi abil.
...
- Lõpuks salvestage oma isikliku võtme 12 sõna, kirjutades selle üles usaldusväärsele andmekandjale ja hoides seda turvalises kohas. See etapp on oluline teie konto taastamiseks ja raha haldamiseks.
...
- Lisaturvalisuse tagamiseks saate lisada isegi passphrase.
...
Pange tähele, et ainult teie registreeritud nutitelefon saab teie konto avada (täiendav turvameede).



Kui olete need sammud lõpetanud, klõpsake menüüs **Pakkumised**, et näha olemasolevaid laenupakkumisi. Kui klõpsate pakkumisel, suunab see teid edasi Debifi veebisaidile.
...
### Juurdepääs veebisaidile ja laenupakkumiste uurimine



Kui seade on ühendatud, minge [Debifi veebisaidile](https://debifi.com/). Logige sisse, et luua turvaline ühendus Debifi mobiilirakenduse ja veebiplatvormi vahel. See lihtsustab teie suhtlemist olemasolevate laenupakkumistega (selge ülevaade iga pakkumise üksikasjadest) ja oma konto haldamist.
...
Video õpetus, kuidas oma kontoga platvormile sisse logida :
...
Platvormi kaudu saate ühendust institutsionaalse kvaliteediga likviidsusega ja pakub erinevaid võimalusi, mis sobivad teie vajadustele. Sirvi läbi, et teada saada, mis on saadaval. Teil on ka võimalus kohandada laenuparameetreid vastavalt oma individuaalsele riskitaluvusele ja finantsolukorrale.
...
Debifi praegu pakutavaid fiat-valuutasid saab vaadata platvormil.
...
### Selged ja paindlikud lepingutingimused



Debifi tugineb läbipaistvatele ja paindlikele laenutingimustele, et rahuldada mõlema osapoole (laenuandja ja laenuvõtja) vajadusi. Põhiklauslid on järgmised:
...
Bitcoin laenuosasid on tavaliselt kolm (3):
...
Intressimäära määramine sõltub üldiselt teie valitud LTV-st, laenuperioodi pikkusest, tagatise volatiilsusest ja platvormipõhistest riskihinnangutest. Intressimäärad jäävad laenu kehtivusajaks fikseerituks.



#### Laenutähtaeg ja tagasimaksmise paindlikkus
...
#### Likvideerimisõigused (Margin Calls)
...
### Laenuprotsessi käivitamine



Teie vajadustele sobiva laenupakkumise valimiseks klõpsake sellel, et vaadata selle omadusi.
...
1. Laenu andva asutuse nimi ;


2. Laenusumma vahemik;


3. Et sa saad raha USDC Ethereum ;


4. Laenuperiood, intressimäär ja LTV suhe;


5. Selle pakkumise puhul on nõutav KYC;
...
Kui olete pakkumisega rahul ja täitnud vajalikud andmed, klõpsake nuppu "Contract taotlus".
...
Pöörduge tagasi mobiilirakendusse ''**Provide public key**''.
...
### Tagatise deponeerimine ja rahaliste vahendite laekumine
...
Selle teate saate ka oma mobiilirakendusse.
...
Seejärel saate Debifilt teate, milles palutakse teil tasuda laenutasud või komisjonitasud, et teie laenu olekuga saaksite edasi liikuda.
...
Kõik, mida peate tegema, on allkirjastada tehing, mis võimaldab Debifil oma komisjonitasu garantiist maha arvata. Teie laenuandja peab omalt poolt samuti allkirjastama tasu mahaarvamise tehingu, vastasel juhul ei saa Debifi oma komisjonitasu kätte.
...
Tagatise hinna tõusu korral jääb tagatise kapitalikasum laenuvõtjale. Ta võlgneb ainult laenusumma, mis on eelnevalt kindlaks määratud ja ei sõltu Bitcoin hinnast.




## Tagasimaksmine ja tagatise sissenõudmine



Kokkulepitud tähtaja lõpus (või soovi korral varem) peate laenu tagasi maksma.
...
Palju õnne! Te olete protsessi lõpule viinud.
...
Jälgige oma laenu ja tagatise (LTV) suhet. Seadistage võimalusel hoiatused (BTC hind, LTV). Ärge laske oma suhtarvul läheneda 90%-le. Kahtluse korral suurendage tagatist või makske varakult tagasi.
...
Alustage võimaluse korral väikselt. Esimese laenu puhul katsetage tagasihoidlikku summat, et tutvuda protsessiga.



Kasutage Debifi uudistega kursis olemiseks ainult Debifi ametlikku veebisaiti ja vältige tundmatuid või andmepüügilinde.  Uuendage rakendust, kaitske oma nutitelefoni PIN-koodiga ja valige ühilduv Hardware Wallet.



Kui te olete laenuandja, saate selle õppevideo abil tutvuda Debifi platvormi kasutamisega. Alates teie pakkumisest huvitatud laenuvõtjate valimisest kuni avalike võtmete esitamise, lepingute allkirjastamise, stablecoins'i ülekandmise ja muuni.
...
Te teate nüüd, kuidas kasutada Debifi platvormi laenu saamiseks.



Soovitan teil läbida selle kursuse, kus käsitletakse põhjalikult Bitcoin, Stablecoine ja nende panust suveräänsusele.
