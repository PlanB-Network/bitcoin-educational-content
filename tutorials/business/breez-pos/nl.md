---
name: Breez - POS
description: Breez maakt het eenvoudig om Bitcoin betalingen voor je bedrijf te innen.
---
...
In het menu "*Kooppunt*" vind je een Interface voor het verzamelen van betalingen. Deze bestaat uit twee delen:
...
Het eerste deel is het toetsenbord voor automatische afschrijving. Dit Interface is handig voor het innen van een enkele betaling wanneer je de totale aankopen van je klant kent, of wanneer je geen vaste productcatalogus nodig hebt in je bedrijf (bv. freelance diensten).
...
Om de Breez POS voor de eerste keer te gebruiken, moet je een bedrag van ruim 2.500 satoshis (ongeveer 3 euro tegen de huidige Exchange koers) incasseren. Dit bedrag, dat alleen wordt betaald bij je eerste uitbetaling, vertegenwoordigt de kosten voor het aanmaken van een betaalkanaal, zodat je kunt communiceren met andere Lightning Network knooppunten en satoshis kunt verzenden en ontvangen.
...
Het tweede deel is de productcatalogus. Dit Interface is ideaal als je een productcatalogus hebt met vooraf gedefinieerde prijzen. Hier kun je je producten vooraf configureren en ze vervolgens gebruiken op generate facturen om de traceerbaarheid van je kasontvangsten te verbeteren.
...
Je kunt elk item handmatig configureren vanuit deze Interface door op de "**Plus**" knop te klikken en dan de naam, prijs en een identifier voor dit item te definiëren.
...
In ditzelfde gedeelte kun je de geldigheidsperiode van je Lightning-facturen instellen. Vanaf nu hebben je klanten voor al je facturen `N` seconden om te betalen, anders moet je een nieuwe Lightning Invoice genereren.
...
Je hebt nu een volledig inzicht in het verkooppunt dat wordt aangeboden door de Breez-applicatie voor naadloze integratie van Bitcoin in je bedrijf. Als je deze handleiding nuttig vond, raden we je onze handleiding over be-BOP aan, een e-commerce platform waarmee je betalingen in bitcoins kunt accepteren en je bedrijf te gelde kunt maken.
