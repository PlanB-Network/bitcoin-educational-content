...
Поэтому при настройке важно записать отпечаток мастер-ключа, который можно найти в правом нижнем углу экрана. Например, для моей парольной фразы `Plan ₿ Academy` отпечаток мастер-ключа - `3AD1AE65`.
