...
Развитие и эволюция Биткойн во многом связаны с различными группами акторов, которые постепенно интегрировались в его экосистему.

![image](assets/en/chapter14/1.webp)

- Верующие:

Ранние пользователи Биткойн были в основном технофилами, криптоанархистами, либертарианцами и энтузиастами золота. Эти группы были привлечены к Биткойн из-за его способности предлагать решения, такие как бездоверительный электронный наличный расчет, устойчивость к цензуре или прозрачная и неизменяемая денежно-кредитная политика.

- Темный интернет и преступники

Затем использование Биткойн расширилось до рынков темного интернета, таких как Silk Road, из-за его неуправляемой и псевдонимной природы. Этот сайт привлек внимание к неуправляемой и псевдонимной природе Биткойн, что побудило некоторых преступных акторов использовать его. Однако следует отметить, что использование инструмента, а не сам инструмент, определяет его законность или незаконность. Следует отметить, что незаконное использование Биткойн само по себе не делает человека преступником. Это использование, а не инструмент, может быть классифицировано как незаконное. Например, использование Биткойн для покупки определенных наркотиков может быть законным или незаконным в зависимости от регулирования территории, где происходит деятельность.
...
Затем снова в 2020 году рынок пережил другой спекулятивный пузырь, который поднял цену Биткойн до 60 000 долларов. Этот пузырь отличается от предыдущих большей диверсификацией инвесторов, включая финансовые институты и крупные компании. Но снова сильные коррекции происходят, когда эйфория утихает.

### Биткойн и волатильность

Исходя из прошлых циклов, кажется, что периодичность экономических циклов Биткойн эквивалентна продолжительности между двумя халвингами. Возможно, потому что событие халвинга действует как триггер, уменьшая эмиссию новых биткойнов.
...
Сегодня, в 2023 году, Биткойн продолжает выживать и расти, все больше интегрируясь в традиционный рынок. Предстоящее появление ETF на Биткойн, более четкое регулирование и лучшие инструменты приобретения или хранения только способствуют этой тенденции. Биткойн ОПЯТЬ пережил свой спекулятивный пузырь, так что, возможно, это не все пустые разговоры!
...
Кроме того, чтобы облегчить использование биткойна в повседневных транзакциях, был запущен открытый и совместный проект: BTCMap (https://btcmap.org/map#2/21.28937/5.46680). Эта платформа перечисляет всех торговцев, которые принимают биткойн, а также различные сообщества Биткойн по всему миру. Вы можете посетить их веб-сайт, чтобы узнать о экосистеме Биткойн вокруг вас. Таким образом, несмотря на трудности и колебания, существуют инициативы, такие как BTCMap, которые способствуют тому, чтобы экономика Биткойн стала более доступной и удобной для всех.

### Почему принимать Биткойн вместо покупки?

Чтобы получить биткойны, вы можете купить их на платформах, регулируемых организациями, такими как AMF (Autorité des Marchés Financiers) во Франции. Этот метод влечет за собой определенные риски и отслеживаемость ваших транзакций. Другой способ получения биткойнов - принимать их в качестве средства оплаты за продукты или услуги, которые вы предлагаете. Этот метод позволяет вам приобретать биткойны через вашу работу, не постоянно беспокоясь о цене Биткойн.

Кроме того, принятие Биткойн в качестве торговца имеет несколько преимуществ, включая устойчивость к цензуре, сниженные комиссионные сборы, повышенную эффективность, защиту от инфляции, а также финансовую свободу и суверенитет.
...
Теперь, когда мы ознакомились с основами протокола Биткойн, мы представим платежную сеть, которая использует протокол Биткойн для обеспечения молниеносных транзакций. Разумеется, речь идет о Сети Молния (Lightning Network)!

### Вкратце

Сеть Молния - это революционная технология, которая кардинально изменила наше восприятие Биткойн. Это решение, которое решает проблему масштабируемости Биткойн.

Для полного понимания Сети Молния крайне важно понять, как развивается Биткойн. Биткойн развивается слоями инфраструктуры: первый слой - это блокчейн, а второй слой - это Сеть Молния.
...
В заключение, Сеть Молния - это многообещающая попытка развертывания эффективной платежной системы для совершения транзакций в Биткойн. Уже существует множество кошельков Lightning, которые вы можете изучить в нашем разделе учебных пособий или через наше обучение по Сети Молния.
...
В заключение, будущее микро-транзакций с Биткойн выглядит многообещающим благодаря инновациям, таким как Сеть Молния. По мере того как эти технологии продолжают развиваться и совершенствоваться, мы можем ожидать появления новых и захватывающих применений в ближайшем будущем. Возьмем, к примеру, концепцию "потоковых денег". С помощью Сети Молния мы можем совершать микро-транзакции каждую минуту (потенциально без доверенной третьей стороны), что открывает дверь к экспериментам с экономическими моделями, где потребители платят за контент в зависимости от того, что они потребляют.
...
В заключение, Сеть Молний открывает множество захватывающих возможностей использования для пользователей Биткойн. Появляющиеся экономические модели и бизнес-возможности многочисленны и разнообразны. Мы призываем вас испытать это на себе, попробовав приложение для подкастов [Fountain](https://www.fountain.fm/), которое позволяет вам получать награду в несколько сатоши за прослушивание ваших любимых подкастов!
### Краткое изложение на постере!
...
Как сказал Морфеус Нео: "Ты принимаешь синюю таблетку: история заканчивается, ты просыпаешься у себя в кровати и веришь во что хочешь верить. Ты принимаешь красную таблетку: остаешься в Стране чудес, и я покажу тебе, насколько глубока кроличья нора." Готовы ли вы исследовать кроличью нору Биткойн? Будьте осторожны, ведь вы можете заново открыть для себя свою финансовую свободу!
...
В мире 2.4 миллиарда человек без банковского счета, что неизбежно создает географические неравенства. Биткойн позволяет достичь равенства в транзакциях, независимо от вашего социального статуса или политической позиции. Протокол Биткойн аполитичен и не предоставляет специфических привилегий президенту или другим действующим лицам. Лидеры должны иметь те же привилегии, что и обычные люди, чтобы стимулировать развитие вверх, а не оставлять некоторых на вершине, а других внизу. Должны ли все иметь одну и ту же валюту, независимо от их социального статуса? Важно задуматься о мире, который мы хотим оставить нашим детям. Мы хотим оставить открытый мир, где они свободны делать что хотят со своими деньгами.

Биткойн важен и не должен рассматриваться просто как игра на удачу. Крайне важно продолжать задавать вопросы о Биткойн.

### Биткойн: революционный протокол

Как мы видели в предыдущей главе, протокол Биткойн нейтрален по отношению ко всем своим пользователям. Благодаря правилам консенсуса и криптографии мы можем неизменно записывать транзакции в глобальном публичном реестре, гарантируя передачу денежных средств без необходимости доверенной третьей стороны. Инфраструктура второго уровня (и в скором времени третьего уровня, с RGB) позволяет масштабировать сеть и разрабатывать новые функциональные возможности, особенно для решения проблем масштабирования.

Биткойн обладает всеми необходимыми характеристиками для эффективной и здоровой валюты: делимость, мгновенная транспортабельность, невозможность цензуры, незначительная стоимость проверки и монетарная политика, уже установленная на века вперед с этими 21 миллионом единиц. Биткойн псевдонимен и может обмениваться в любой точке мира без какого-либо разрешения от любой сущности, вам просто нужно держать свои собственные приватные ключи - как говорится "Не твои ключи, не твои биткойны".

Биткойн принят различными группами людей, от криптографов до либертарианцев, традиционных бизнесов и даже страны. Однако, Биткойн предназначен для всех, и его число пользователей растет, как и количество узлов Биткойн, которые служат стражами истории транзакций, обеспечивая его децентрализацию.
