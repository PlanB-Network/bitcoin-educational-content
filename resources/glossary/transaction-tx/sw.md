...
Kila ingizo linajumuisha rejeleo la towe lililopo pamoja na hati ya sahihi (`scriptSig`) ambayo inatimiza masharti ya matumizi (`scriptPubKey`) yaliyowekwa na matokeo yanayorejelea. Hii ndio inaruhusu bitcoins kufunguliwa. Matokeo yanafafanua masharti mapya ya matumizi (`scriptPubKey`) kwa bitcoins zilizohamishwa, mara nyingi katika mfumo wa ufunguo wa umma au Address ambayo bitcoins sasa zinahusishwa.