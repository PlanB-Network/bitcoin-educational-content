---
term: Anchor
definition: No protocolo RGB, um conjunto de dados que prova a inclusão de um compromisso em uma transação Bitcoin, sem revelar publicamente seu conteúdo.
---
