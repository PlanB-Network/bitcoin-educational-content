---
name: Bitfinex
description: Bitfinex'i nasıl kullanırım?
---
...
Bugün Bitfinex, hem basit bitcoin alımlarına hem de risk yönetimi araçlarıyla gelişmiş ticaret özelliklerinin kullanımına izin veren eksiksiz bir platformdur. Bir web sürümü mevcuttur ve basit işlemler için kullanımı kolay bir mobil uygulama da mevcuttur.


Bitfinex, Bitcoin gibi teknolojilere yatırım yaparak ve finansal özgürlük için eşler arası çözümleri teşvik ederek Lightning Network'ün gelişimini aktif olarak desteklemektedir.


## 1 - Bitfinex hesabı oluşturma


Bitfinex'in resmi web sitesine] (https://www.bitfinex.com/) gidin. Ana sayfada, hesabınızı oluşturmaya başlamak için "*Kayıt Ol*" seçeneğini bulun ve tıklayın.


![BITFINEX](assets/fr/01.webp)


Gerekli bilgileri tamamlayın: e-posta adresinizi Address ve ikamet ettiğiniz ülkeyi girin. Güvenli bir kullanıcı adı ve şifre seçin, ardından kaydı onaylamak için "*Kaydol*" düğmesine tıklayın.
...
Akıllı telefonunuzdaki uygulamadan yaparsanız :
...
Bitfinex, mevcut düzenlemelere uygun bir doğrulama süreci (KYC) uygulamaktadır. "Temel" modda, para yatırma, çekme veya işlem yapmak imkansızdır, bu da en azından "Temel Plus" doğrulama seviyesini, hatta gerekirse "Orta" veya "Tam" seviyesini elde etmeyi gerekli kılar:
...
Bu pencere görünmezse, Interface'in sağ üst köşesindeki profilinize gidin ve ardından "*Doğrulama*" seçeneğine tıklayın.


![BITFINEX](assets/fr/08.webp)


"*Hesap Türü*" altında "*Bireysel*" seçeneğini seçin. Benim durumumda, "*Basic Plus*"a yükseltme yapıyorum, bu yüzden "*Upgrade to Basic Plus*"ı seçiyorum.


![BITFINEX](assets/fr/09.webp)


İstenen bilgi ve belgeleri sağlayarak adımları tamamlayın. Başvurunuz tamamlandıktan ve gönderildikten sonra, Bitfinex ilgili özelliklerin kilidini açmak için hesabınızı doğrulayacaktır.
...
Bitfinex'in avantajlarından biri de alt hesaplar oluşturabilmesidir. Bu, hesabınız için farklı kullanımları ayırabileceğiniz anlamına gelir:


![bitfinex](https://youtu.be/aOBXgcuJ5fI)


Dilerseniz, ihtiyaç duyduğunuz özellikleri vurgulamak için kontrol panelinizi de özelleştirebilirsiniz:
...
Bitfinex hesabınıza avro yatırmak için, Interface'nın üst kısmındaki "*Wallet*" menüsündeki "*Yatır*" alt menüsüne erişin.
...
Gönderilecek fiat para birimini seçin, örneğin euro. Yalnızca temel "*Ticaret*" işlevlerini kullanıyorsanız, "*Exchange*" üzerine tıklayın. Ayrıca yatırmak istediğiniz tutarı ve bankanızın ülkesini de belirtin.


![BITFINEX](assets/fr/14.webp)


Banka hesabınızdan Bitfinex tarafından belirtilen banka hesabına bir transfer yapın.
...
Gerçekleşen emirlerinizin geçmişini Interface'in alt kısmında görüntüleyebilirsiniz.


![BITFINEX](assets/fr/28.webp)


Ayrıca, satın alma fiyatınızı zaman içinde düzeltmek için uygulamadan yinelenen bir bitcoin satın alma işlemi de ayarlayabilirsiniz (*DCA*).
