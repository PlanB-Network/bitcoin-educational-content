...
В поле "*Имя*" введите описательное имя для ваших учетных данных. Это облегчит поиск и организацию ваших паролей, особенно если у вас их много. Например, если вы хотите сохранить свои учетные данные для сайта Plan ₿ Academy, вы можете назвать этот элемент так, чтобы он был сразу узнаваем при будущих поисках.
...
Вы можете назначить папку для идентификатора при его создании, как мы делали ранее, или изменяя существующий идентификатор. Например, нажав на мой идентификатор для Plan ₿ Academy, я могу затем выбрать его классификацию в папке "*Bitcoin*".
...
Например, если я вернусь на сайт Plan ₿ Academy и попытаюсь войти в свой аккаунт, вы можете видеть, что расширение Bitwarden, интегрированное в браузер, распознает поля для входа и автоматически предлагает мне выбрать идентификатор, который я ранее сохранил.
...
Расширение также предназначено для обнаружения создания новых аккаунтов. Например, при создании нового аккаунта на Plan ₿ Academy, Bitwarden автоматически предлагает сохранить новый идентификатор.
