...
Kuendesha node ya Bitcoin sio tu chaguo kwa wataalam; ni jambo la lazima. Ni zana ya uthabiti ambayo kila mtumiaji anahitaji kuelewa na kutekeleza. Kozi hii ndio hatua yako ya kuanzia kuwa bitcoiner huru!
...
### Sehemu ya 2 - Kuwa bitcoiner huru
...
Sehemu hii, kwa hiyo, inaonyesha njia ya bitcoiner huru: kuelewa kwa nini ni muhimu kuendesha node, kuchagua aina ya node, kulingana na uchaguzi huu, chagua programu, na, kulingana na programu iliyochaguliwa, kuamua vifaa vinavyofaa.
...
### Sehemu ya 5 - Dhana za hali ya juu na mbinu bora
...
Kama ilivyofafanuliwa na muundaji wake, [Satoshi Nakamoto](https://planb.academy/resources/glossary/nakamoto-satoshi), Bitcoin inajionyesha kama mfumo wa pesa taslimu wa kielektroniki kati ya wenzao. Sentensi hii rahisi, ambayo ni kichwa cha [Karatasi Nyeupe](https://planb.academy/resources/glossary/white-paper), ina vidokezo vingi vya asili ya Bitcoin:
...
- Hatimaye, anaonyesha kuwa mfumo huu hautegemei chombo chochote kikuu: ni "[peer-to-peer](https://planb.academy/resources/glossary/peertopeer-p2p)", akimaanisha kuwa ni watumiaji wenyewe wanaoendesha mfumo.



Kwa kuwa Bitcoin ni mfumo, lazima lazima uendeshwe kwenye kompyuta. Na, kwa sababu ya asili yake rika-kwa-rika, ni watumiaji wenyewe ambao huchukua jukumu la kuendesha mashine hizi. Tunachoita "Bitcoin [node](https://planb.academy/resources/glossary/node)" ni kwamba kompyuta ambayo programu inayotekeleza protocol ya Bitcoin (kama [Bitcoin core](https://planb.academy/resources/glossary/bitcoin-core), lakini tutarejea hapo baadaye) inafanya kazi. Hili ndilo linalowezesha Bitcoin kufanya kazi bila mamlaka kuu: uthibitishaji unafanywa kwa njia [iliyosambazwa](https://planb.academy/resources/glossary/distributed), na maelfu ya mashine za kujitegemea zinazomilikiwa na maelfu ya watumiaji.
...
Nakamoto, S. (2008). *Bitcoin: Mfumo wa Pesa wa Kielektroniki wa Peer-to-Rika*. https://Bitcoin.org/Bitcoin.pdf



Ni watumiaji hawa haswa wanaohakikisha usalama wa Bitcoin. Kama Eric Voskuil anavyoeleza katika kitabu chake *Cryptoeconomics*, usalama wa Bitcoin hautegemei [Blockchain](https://planb.academy/resources/glossary/blockchain), wala [nguvu ya haraka](https://planb.academy/resources/glossary/hashrate), wala [uthibitisho](https://planb.academy/resources/glossary/confirmation), ugatuaji, [cryptography](https://planb.academy/resources/glossary/cryptography), [chanzo huria](https://planb.academy/resources/glossary/foss), wala nadharia ya mchezo. Usalama wa Bitcoin unategemea hasa watu ambao wako tayari kujiweka katika hatari ya kibinafsi. Ugatuaji huruhusu hatari hii kuenea kwa idadi kubwa ya watu binafsi, na ni uwezo wao wa kupinga tu ambao unahakikisha uimara wa mfumo.
...
Kwa hivyo tunaweza kutofautisha na kutaja dhana kadhaa ili kufafanua mambo kwa kipindi kizima cha kozi hii:




- Sarafu ya Bitcoin: kitengo cha akaunti kinachotumika kwa [miamala](https://planb.academy/resources/glossary/transaction-tx) ndani ya mfumo huu;
- Mtandao wa Bitcoin: seti ya nodes zote zilizounganishwa;
- Bitcoin nodes: mashine zinazoendesha [utekelezaji wa Bitcoin](https://planb.academy/resources/glossary/bitcoin-implementation);
...
Kazi ya kwanza ya node ni kudumisha nakala ya ndani ya Blockchain. Ili kuzuia [Double-spending](https://planb.academy/resources/glossary/double-spending-attack) kwenye Bitcoin bila kuhusisha mamlaka kuu, kila mtumiaji lazima aangalie kuwa hakuna shughuli yoyote kwenye mfumo. Njia pekee ya kuwa na uhakika wa hili ni kujua shughuli zote zilizofanywa kwenye Bitcoin. Kwa sababu hii, shughuli zote [zimepigwa kwa muda](https://planb.academy/resources/glossary/timestamp) na zimeunganishwa katika [blocks](https://planb.academy/resources/glossary/block), na kila node huhifadhi Blockchain nzima.
...
Node hiyo pia hudumisha rekodi ya ndani ya [UTXO](https://planb.academy/resources/glossary/utxo) zote zilizopo wakati wowote, unaojulikana kama **[UTXO seti](https://planb.academy/resources/glossary/utxo-set)**. Hifadhidata hii ina vipande vyote vya Bitcoin ambavyo havijatumika. Tunarudia somo hili kwa undani katika sehemu ya mwisho ya kozi.



### Thibitisha na usambaze miamala



Jukumu la pili la node ni kuhakikisha uthibitishaji na uenezi wa shughuli. Wakati shughuli mpya inapofikia node (ama kupitia programu ya Wallet au node nyingine), itaangalia ikiwa inazingatia seti ya sheria ([sheria za makubaliano](https://planb.academy/resources/glossary/consensus-rules) na sheria za [relay](https://planb.academy/resources/glossary/relay)). Kwa mfano:




- bitcoins zilizotumiwa lazima ziwepo katika seti yake ya UTXO (database ya [matokeo](https://planb.academy/resources/glossary/output) ambayo hayajatumika);
- [saini](https://planb.academy/resources/glossary/digital-signature) lazima iwe halali, na masharti yote ya matumizi lazima yatimizwe ([hati](https://planb.academy/resources/glossary/script) halali);
- jumla ya kiasi cha matokeo lazima kisichozidi jumla ya kiasi cha [pembejeo](https://planb.academy/resources/glossary/input), ambayo ina maana kwamba [gharama](https://planb.academy/resources/glossary/transaction-fees) haziwezi kuwa mbaya.
...
Baada ya uthibitisho, shughuli hiyo imehifadhiwa kwenye node ya [Mempool](https://planb.academy/resources/glossary/mempool), nafasi ya kumbukumbu ya muda iliyohifadhiwa kwa shughuli zisizothibitishwa, na kisha kupelekwa kwa wenzao wengine wa mtandao ambao umeunganishwa. Utaratibu huu wa [usambazaji](https://planb.academy/resources/glossary/diffusion) na uthibitishaji unaendelea kutoka node hadi node. Kwa njia hii, shughuli hiyo inaenezwa kwenye mtandao wa Bitcoin, na kila node huihifadhi kwenye Mempool hadi ijumuishwe kwenye block halali na Miner, ambaye kisha anafanya uthibitisho wake wa kwanza.
...
## Kuna tofauti gani kati ya upinde na Wallet?
...
- chelezo ya Blockchain,
- uthibitishaji wa shughuli na uwasilishaji,
- kuzuia uthibitisho na relay.
...
Mawazo ya node na Miner mara nyingi huchanganyikiwa. Bado hizi mbili Elements hufanya kazi tofauti kabisa ndani ya mfumo.
...
Miongoni mwa utekelezaji huu, moja inatawala kwa mbali: **Bitcoin core**.
...
### Utekelezaji wa kihistoria ambao umekuwa kigezo
...
### Usambazaji wa sasa wa utekelezaji
...
### Uendeshaji wa ndani wa Bitcoin core
...
Uundaji wa Bitcoin core unafuata mantiki yenye sifa nzuri: wachangiaji wapya wanahimizwa kukagua na kujaribu msimbo kabla ya kupendekeza mabadiliko yoyote wenyewe. Maamuzi yanatokana na makubaliano ya kiufundi, na marekebisho makubwa (hasa katika maeneo ya makubaliano) yanahitaji mijadala ya juu kwenye vituo vya umma, kama vile orodha za wanaotuma barua au vilabu vya ukaguzi wa PR.



### Utekelezaji mwingine wa Bitcoin
...
Miradi hii inachangia utofauti wa mfumo ikolojia, lakini kupitishwa kwake kunasalia kuwa mdogo, na kufanya iwe vigumu kwa Bitcoin core kujiendeleza.



### Nguvu ya watengenezaji wa Core
...
Hii ina maana kwamba ikiwa mabadiliko katika Bitcoin core haifikii makubaliano, inaweza kupuuzwa na nodes, ama kwa kutosasisha Bitcoin core au kwa kubadilisha tu utekelezaji. Kinyume chake, ikiwa kipengele kinachohitajika na watumiaji kimezuiwa katika mchakato wa ukuzaji wa Core, inawezekana kila wakati kubadili hadi utekelezaji mwingine au Fork mradi.
...
### Usambazaji wa siri zaidi wa miamala
...
### Uthibitishaji wa data wa kujitegemea
...
### Usambazaji bora wa usalama wa mfumo
...
Kwa mfano, muamala usio na ada, kwa mujibu wa sheria za makubaliano, ni halali kabisa, lakini utakataliwa kwa chaguo-msingi kulingana na sera ya relay ya Bitcoin core, kwa sababu kigezo cha `minRelayTxFee` kimewekwa kuwa `0.00001` (katika BTC/kB). Hata hivyo, inawezekana, kwa node yako mwenyewe, kupunguza kizingiti hiki ili kurejesha shughuli na ada za chini, au, kinyume chake, kuongeza kikomo, kwa mfano, kwa 2 Sats / vB, ili kuepuka kurejesha shughuli za ada ya chini.
...
Kwa hivyo tunaweza kujaribu haraka kuelewa ni nguvu ngapi unazo juu ya sheria shukrani kwa node yako. Na kiwango cha nguvu hii kitategemea aina ya utawala.
...
Alimradi `p` inasalia chini ya `p_c`, shughuli ya ununuzi itabaki kwenye mifuko iliyotengwa na haifikii Miner. Mara tu kizingiti hiki kinapozidi, huenea karibu mara moja katika mtandao mzima.
...
Wacha tuchukue mfano: hebu tuseme Bitcoin inaugua Hard Fork. Kisha kungekuwa na aina 2 tofauti za sarafu: BTC-1 (toleo la awali, ambalo halijabadilishwa) na BTC-2 (sarafu mpya yenye sheria tofauti za makubaliano). Ikiwa wafanyabiashara wote waliokubali BTC-1 wanaendelea kufanya hivyo, lakini wanakataa BTC-2, basi wa mwisho, kwa nadharia, wana matumizi madogo sana ya fedha. Kama mtumiaji, singependa kutunza na kutumia BTC-2, nikijua kwamba hakuna mfanyabiashara angeitaka katika Exchange kwa bidhaa au huduma. Kinyume chake, ikiwa 50% ya wafanyabiashara wanachagua kukubali BTC-2 pekee na 50% iliyobaki kuchukua BTC-1 tu, basi matumizi ya BTC-1, kwa nadharia, yamepungua kwa nusu. Ninatumia neno "nadharia" kwa sababu matumizi hubakia kuwa ya kibinafsi katika kiwango cha mtu binafsi na hutegemea mambo mengi (kama vile eneo na tabia za utumiaji) ambayo ni ngumu kueleweka kwa kila kesi.
...
## Muhtasari wa suluhisho za programu
...
**Manufaa:** Uthabiti wa juu zaidi, tabia inayotabirika, matumizi ghafi, rahisi kusakinisha na kusanidi.
...
Kuna sababu 2 zinazowezekana za kuchagua Mafundo juu ya Msingi:
...
Ni suluhisho rahisi zaidi kwa kuanzisha na kudhibiti programu nyingi za ziada kila siku. Upande wa chini ni kwamba shida inapotokea (kwa mfano, mzozo wa picha ya Docker, sasisho mbovu, hifadhidata iliyoharibika), utatuzi unaweza kuwa ngumu sana, kwani unategemea ujumuishaji wa usambazaji mwenyewe. Zaidi ya hayo, usaidizi wa jumuiya au rasmi mara nyingi huwa mgumu.
...
Nyingi za suluhisho hizi zinapatikana katika fomati mbili:
...
Kwa kifupi, ikiwa unahitaji tu programu muhimu za Bitcoin, bila kupendezwa hasa na mfumo ikolojia tajiri sana wa Umbrel, na mtumiaji wa Interface sio kipaumbele, basi Start9 ni chaguo bora zaidi. Vinginevyo, Umbrel ni chaguo bora.
...
Ikiwa unamiliki Raspberry Pi, hili ni chaguo bora, kwani mifumo kamili zaidi kama Umbrel inazidi kuwa nzito kwa aina hii ya kompyuta ndogo.
...
Kanuni ni rahisi: ikiwa unatumia Ashigaru Wallet (mrithi wa Fork wa Samurai Wallet, kufuatia kukamatwa kwa wasanidi wake) au ikiwa unataka kufaidika na zana za hali ya juu za faragha, RoninDojo ni kwa ajili yako.
...
Hapo awali mradi ulitoa mashine iliyosanidiwa awali inayoitwa Tanto, lakini hii haipatikani kwa sasa. Inaweza kurudi baadaye. Wakati huo huo, inawezekana kusakinisha RoninDojo kwa urahisi kwenye Rock5B+ au Rockpro64, au hata kwa njia isiyo ya moja kwa moja kwenye Raspberry Pi.
...
## Muhtasari wa suluhisho za vifaa
...
### Je, unahitaji kweli mashine maalum?
...
### Mbinu 3 za kupata: kuchakata tena, mtumba, na mpya



#### Kusafisha tena PC ya zamani
...
Kabla ya kununua vifaa vyovyote, angalia idadi ya nafasi za diski zinazopatikana, aina ya uunganisho (M.2 au SATA), muundo wa RAM (SODIMM au DIMM), na kizazi chake (DDR4, nk). Unapaswa pia kuchukua fursa ya kusafisha mashine, haswa feni, ili kuhakikisha utendaji bora.



Kuwa mwangalifu, hata hivyo, ikiwa unatumia kompyuta ya mkononi: betri inaweza kuwa tatizo baada ya muda (zaidi juu ya hili baadaye katika sura).



#### Imerekebishwa au kutumika
...
Pia inawezekana kupata Kompyuta na kompyuta za mkononi zilizotumika miaka michache iliyopita, zilizo na usanidi wa kuvutia na thamani bora ya pesa.



**Kumbuka:** mashine kutoka kwa mashirika ya kibiashara, kama vile *ThinkCentre Tiny*, mara nyingi huwa na lango la *DisplayPort* (DP) la skrini pekee, bila kutoa HDMI. Kwa hivyo usisahau kuleta adapta au kebo ya DP-to-HDMI ikiwa unahitaji moja.
...
Ikiwa bajeti yako inaruhusu, unaweza pia kuchagua mashine mpya. Hili ni chaguo zuri ikiwa ungependa kuwa na maunzi ya hivi majuzi yenye utendakazi mzuri, hasa ikiwa unapanga kutumia Umbrel au Start9 na programu za ziada nje ya mfumo ikolojia wa Bitcoin kwa upangishaji binafsi.



### Je, ni aina gani ya mashine nipaswa kuchagua?
...
Binafsi, napendelea *Lenovo ThinkCentre Tiny*, ambayo imeenea sana kwenye soko la mitumba (kutoka kwa mashirika ya meli); ni imara na ni rahisi kurekebisha. Kuna, bila shaka, vifaa vingi vinavyolingana na watengenezaji wengine: *Dell OptiPlex Micro*, *HP ProDesk / EliteDesk Mini / Micro*, *Intel NUC*, *Gigabyte BRIX*, *MSI Cubi*..
...
**Mambo muhimu:** alama ndogo, matumizi ya nishati ya wastani, kelele ya chini, uwezo wa kubadilika (kulingana na muundo), na kutegemewa.



**Udhaifu:** ghali kidogo kuliko SBC ya aina ya Raspberry Pi, hakuna skrini iliyojengewa ndani (ufikiaji wa mbali au kupitia kichunguzi cha nje), hakuna betri (kuzima kwa ghafla iwapo nguvu ya umeme itakatika).
...
**Mambo muhimu:** Suluhisho la yote kwa moja, chaji hufanya kazi kama UPS (hakuna kukatika), usakinishaji uliorahisishwa kwa shukrani kwa skrini iliyounganishwa na kibodi, kadi iliyounganishwa ya Wi-Fi, na chaguo pana la masoko yaliyotumika na mapya (ambayo mara nyingi humaanisha kuwa unaweza kujadili bei).



**Udhaifu:** matumizi ya nishati ya juu kidogo kuliko Mini-PC tupu, betri huchakaa taratibu katika operesheni ya 24/7 na kupoteza uwezo wake, hatari adimu lakini halisi ya kuvimba kwa betri au kukimbia kwa joto kutokana na uzee. Ni hasa kipengele hiki kinachonifanya kuzingatia mini-PC chaguo bora kuliko kompyuta ndogo: uharibifu wa taratibu wa betri na hatari zinazohusiana.



Ikiwa unachagua suluhisho hili, napendekeza uangalie kwa karibu hali ya betri ili kuzuia hatari yoyote. Tazama joto jingi, harufu isiyo ya kawaida, kuyumba au ganda lililoharibika. Katika tukio la kengele, zima na uchomoe kompyuta mara moja, kisha utupe betri kwenye kituo maalumu cha kuchakata tena.



**Kidokezo:** Ikiwa BIOS/UEFI au zana ya mtengenezaji inaruhusu, weka kikomo cha upakiaji (k.m., 60% au 80%) ili kuongeza muda wa matumizi ya betri.



#### Raspberry Pi na SBC zingine: wazo lisilo sahihi
...
Raspberry Pi ina idadi ya hasara:




- wasindikaji ambao ni nyembamba sana, na usanifu wa ARM ambao wakati mwingine hauendani na programu fulani au inahitaji utunzaji zaidi;
- RAM iliyouzwa, haiwezekani kuboresha, na usanidi mdogo (mara nyingi upeo wa 8 GB);
- masanduku ya nje ya SSD zilizounganishwa na cable, vyanzo vya mara kwa mara vya mende, zinazohitaji ununuzi wa kadi maalum kwa SSD imara;
- tabia ya joto haraka na ugumu katika kuhakikisha baridi sahihi;
- haja ya kununua vifaa vya ziada (kesi, shabiki, kadi ya SSD, nk);
- muunganisho mdogo sana.



Kihistoria, faida kubwa ya SBC kama vile Raspberry Pi ilikuwa bei yao: kwa euro kadhaa chache, unaweza kupata mashine maalum. Walakini, leo, bei zimeongezeka sana, na mara tu umeongeza vifaa vyote muhimu vya ziada, gharama inakaribia ile ya kompyuta ndogo za x86 zilizotumiwa au zilizoboreshwa, ambazo, kwa maoni yangu, hutoa faida zaidi. Kwa sababu hii, sipendekezi kuchagua SBC.
...
#### Hifadhi ya diski: SSD ya lazima, kiwango cha chini cha 2 TB
...
Kwa upande wa uwezo, 2TB inajiimarisha polepole kama kiwango cha chini kinachofaa. Katika msimu wa joto wa 2025, Blockchain tayari inakaribia GB 700, na ikiwa unaongeza Umbrel, indexer ya Address, na programu chache, SSD 1 TB itajaa haraka. Ukiwa na 2TB, una ukingo mzuri wa miaka ijayo (katika makadirio mapana, kati ya miaka 5 na 15). Unaweza pia kuchagua 4TB ikiwa unapanga kutumia programu nyingi kwenye Umbrel, kuhifadhi faili kubwa katika upangishaji wa kibinafsi, au ikiwa unataka kutarajia nafasi yako ya diski inahitaji kwa kiwango kikubwa.
...
Kuhusu umbizo, hii itategemea bandari zinazopatikana kwenye mashine yako; hata hivyo, ikiwezekana, napendekeza kutumia NVMe M.2 SSD.



#### Kumbukumbu (RAM): 8 hadi 16 GB
...
### Mifano ya usanidi halisi



Hapo chini, ninapendekeza usanidi tatu thabiti, uliochukuliwa kwa bajeti na mahitaji tofauti, na mifano sahihi ya kuunga mkono. Chaguzi hizi zimetolewa kama mifano ili kueleza habari katika sura hii; huna jukumu la kuchagua aina hizi haswa. Ninapochukulia Mini-PC kuwa chaguo bora kwa muda mrefu, nitakuwa nikitegemea umbizo hili kwa usanidi uliopendekezwa.



*Bei zilizoonyeshwa hapa chini ni elekezi pekee na zinaweza kutofautiana kulingana na eneo, muuzaji na muda*



Kwanza kabisa, unahitaji SSD ambayo ni kubwa ya kutosha kubeba Blockchain, huku ukiacha nafasi ya ujanja. SSD zina muda mdogo wa kuishi katika suala la mizunguko ya uandishi na jumla ya kiasi cha data iliyoandikwa. Walakini, node ya Bitcoin inaweka mzigo mkubwa kwenye diski wakati wa kuandika. Ndiyo sababu sipendekezi mifano ya ngazi ya kuingia; badala yake, ninapendekeza NVMe SSD, ambayo inatoa utendaji bora zaidi.



Kama mfano, kwa madhumuni ya kozi hii, nimechagua muundo ufuatao: *Samsung 990 EVO Plus NVMe M.2 SSD 2Tb*, inapatikana kwa takriban €120 kwenye Amazon. Unaweza pia kuchagua chapa zingine zinazojulikana kama vile Crucial, Western Digital, au Kingston.
...
#### Usanidi wa bajeti ya chini



Ni wazi, ikiwa bajeti yako ni ndogo sana (chini ya €200), ningekushauri usiwekeze kwenye mashine maalum, lakini badala yake usakinishe Bitcoin core moja kwa moja kwenye Kompyuta yako ya kila siku (katika hali ya pruned ikiwa huna nafasi ya diski).
...
Kisha ongeza tu SSD kwenye bajeti. Kuanzia na Samsung 2TB kwa €120, tunapata gharama ya jumla ya €216 kwa mashine kamili, inayofanya kazi.



#### Usanidi wa bajeti ya wastani
...
Ukiwa na mashine hii, una usanidi mzuri: IBD ya haraka na uwezo wa kuendesha programu nyingi kwenye Umbrel au Start9 yako bila shida. Huu ndio usanidi ninaotumia kwa kozi hii ya BTC 202.
...
Kwa mfano, *ASUS NUC 14 Pro* inapatikana mpya kutoka Amazon kwa €540. Kwa bei hii, unapata kichakataji cha Intel Core Ultra 5 (ya hivi majuzi na hasa yenye utendakazi wa juu), ikiambatana na GB 16 ya DDR5 RAM. Ukiwa na usanidi kama huu, utaweza kukamilisha IBD katika muda wa rekodi na kusakinisha programu zinazohitajika bila shida.
...
Kulingana na matumizi unayokusudia, unaweza kuchagua SSD ya 2TB, kama ilivyo katika usanidi mwingine, au moja kwa moja kwa SSD ya 4TB kwa €260 ikiwa pia ungependa kuhifadhi faili za kibinafsi na kupanua matumizi yako ya upangishaji binafsi. Kwa SSD ya 2TB, gharama ya jumla ya usanidi ni €660, wakati kwa SSD ya 4TB, inafikia €800.
...
- Ikiwa ungependa kununua vifaa vya mitumba na kulipa kwa bitcoins, njoo kwenye mkutano karibu nawe! Kwa kupiga gumzo na washiriki wengine, una uhakika wa kupata vifaa vinavyofaa kwa bei nzuri, huku ukisaidia kudumisha hali ya uchumi wa mzunguko wa Bitcoin hai. Pia ni fursa ya kufaidika na ushauri mzuri kutoka kwa jamii.





- Kwa muunganisho wa Mtandao, bila shaka utahitaji kebo ya RJ45 Ethernet, angalau kwa usakinishaji wa mfumo.
...
- Daima tumia nguvu ya mtengenezaji asili Supply kwa mashine yako. Hii ni muhimu ili kuzuia uharibifu wa kifaa chako na kuzuia hatari ya kuwasha moto.





- Ikiwa mashine yako haina betri iliyojengewa ndani, ni wazo nzuri kuwekeza kwenye kibadilishaji umeme ili kuzuia kuzimwa kwa ghafla.
...
- Hatimaye, kumbuka kuboresha hali ya kupoeza kwa mashine yako: isafishe mara kwa mara, na uisakinishe katika sehemu yenye ubaridi, yenye uingizaji hewa wa kutosha, isiyo na vitu vingi ili kuepuka joto kupita kiasi, jambo ambalo linaweza kusababisha kubana (kuzuia kwa hiari kasi ya kichakataji chako).
...
Katika Umbrel, kila programu inaendesha kwenye chombo cha Docker (kutengwa, sasisho za atomiki, kuanza / kuacha huru). Interface huweka ufikiaji wa programu hizi zote katikati, kutoa kuingia mara moja (kwa 2FA ya hiari), masasisho ya kubofya mara moja kwa OS na programu, ufuatiliaji wa moja kwa moja wa mashine (CPU, RAM, halijoto, hifadhi), udhibiti wa ruhusa kati ya programu, na muhtasari wa matumizi yao.
...
Umbrel hutoa njia mbili tofauti:
...
- [**umbrelOS**](https://umbrel.com/umbrelos): huu ni mfumo wa uendeshaji unayoweza kujisakinisha kwenye maunzi yako mwenyewe (mini-PC, NUC, tower, kompyuta ndogo iliyojitolea...). Una Interface sawa na App Store sawa na kwenye Umbrel Home.
...
Katika matukio yote mawili, uzoefu wa mtumiaji ni sawa na upande wa programu: utawala wa msingi wa kivinjari, sasisho moja-click, usakinishaji wa maombi ya mahitaji ... Suluhisho la DIY mara nyingi ni la kiuchumi zaidi kuliko kununua Nyumba ya Umbrel (kulingana na mashine inayotumiwa). Hata hivyo, si lazima nikupendekeze kwamba uchague chaguo la DIY kila wakati, kwani **kununua Nyumba ya Umbrel huchangia moja kwa moja kufadhili maendeleo ya mradi**, kwa kuwa mtindo wake wa biashara unategemea uuzaji wa maunzi. Na kusema ukweli, kwa €389 kwa 2TB ya hifadhi, bei inasalia kuwa ya kuridhisha kutokana na ubora wa mashine inayotolewa.
...
Katika sura inayofuata, tutachunguza jinsi ya kusakinisha umbrelOS DIY kwenye mashine yako mwenyewe. Hata hivyo, unaweza kufuata kozi hii ya BTC 202 kwa njia sawa ikiwa umechagua Nyumba ya Umbrel.
...
### Jumuiya na misaada ya pande zote



Mojawapo ya faida kuu za Umbrel juu ya washindani wake ni jumuiya yake kubwa na yenye kazi nyingi ya watumiaji. Unaweza kuwafikia hasa kupitia [Discord yao](https://discord.gg/efNtFzqtdx) na [mijadala yao ya mtandaoni](https://community.umbrel.com/). Hapa, utapata sio tu ushauri wa vitendo lakini, juu ya yote, suluhisho za kutatua shida au kurekebisha mende. Ni mahali pazuri pa kuanzia, kuendeleza, na, hatimaye, kuwasaidia watumiaji wengine, ili usiachwe peke yako na Coin yako.
...
Kwa vitendo, unaweza kufanya kitu chochote unachopenda ukitumia mwamvuli OS, mradi tu ni kwa matumizi ya kibinafsi, yasiyo ya kibiashara: kurekebisha, ugawaji upya kwa madhumuni yasiyo ya faida, kuunda derivatives kwa ajili yako mwenyewe au kwa mashirika yasiyo ya faida, mradi unaheshimu arifa za kisheria.



Hata hivyo, ni marufuku kuuza Umbrel au viasili vyake (kwa mfano, mashine iliyounganishwa awali yenye mwamvuli uliosakinishwa awali), ili kutoa huduma zinazohusiana na Umbrel kibiashara, au kuunganisha msimbo wake katika bidhaa kwa faida.
...
Hata hivyo, kila programu kwenye Duka huhifadhi leseni yake, mara nyingi chanzo huria.




## Kufunga Full node na Umbrel
...
Ikiwa umechagua Raspberry Pi 5 (chaguo ambalo sikupendekeza, kama ilivyotajwa katika sehemu iliyopita), usakinishaji ni tofauti kidogo. Kisha unaweza kufuata mafunzo haya mahususi na kurudi kwenye kozi yangu mara moja kwenye mtandao wa Interface `http://umbrel.local`:
...
Ninapenda sana safu ya ThinkCentre Tiny ya Lenovo, kwa kuwa ni mashine fupi, tulivu, na imara sana. Kompyuta hizi ni maarufu sana kwa biashara na kwa hivyo ziko nyingi kwenye soko la mitumba, ambapo unaweza kupata usanidi wa kuvutia kati ya €70 na €200.



Ikiwa, kama mimi, umechagua Kompyuta bila kifuatiliaji, **utahitaji kuunganisha kifuatiliaji na kibodi** kwa muda wa usakinishaji pekee. Baadaye, utaweza kuipata ukiwa mbali na kompyuta nyingine kwenye mtandao huo huo (au kupitia mbinu zingine tutakazoshughulikia katika sura zijazo). Utahitaji pia kebo ya Ethaneti ya RJ45 ili kuunganisha mashine yako kwenye mtandao wa ndani, na ufunguo wa USB wa angalau GB 4 ili kuhifadhi picha ya usakinishaji.



Kwa muhtasari, hapa kuna mahitaji ya kifaa:




- Kompyuta yenye kichakataji cha x86_64 (kiwango cha chini cha Dual-core, ilipendekeza Quad-core);
- Kumbukumbu ya RAM (kiwango cha chini cha GB 4, GB 8 iliyopendekezwa au zaidi kwa matumizi ya muda mrefu);
- SSD (ilipendekezwa + 2 TB);
- Kitufe cha USB (+ 4 GB) kwa ajili ya ufungaji wa picha ya UmbrelOS;
- Kufuatilia na keyboard (muhimu tu kwa ajili ya ufungaji wa awali ikiwa PC haina vifaa na moja);
- Kebo ya Ethaneti ya RJ45.



### Hatua ya 1 - Kuweka kompyuta



Kulingana na maunzi uliyochagua, hatua ya kwanza ni kukusanya vipengele mbalimbali vya kompyuta yako. Kwa mfano, katika kesi yangu, SSD ya asili ilikuwa na uwezo wa GB 256 tu, kwa hiyo nitaitengeneza kwa matumizi mengine na kuibadilisha na 2 TB SSD. Ikiwa pia unataka kubadilisha moduli za RAM, sasa ni wakati wa kuifanya.



### Hatua ya 2: Tayarisha ufunguo wa USB unaoweza kuwashwa
...
- Anza kwa kupakua toleo jipya zaidi la UmbrelOS katika umbizo la USB:



Nenda kwenye [tovuti rasmi ya Umbrel ili kupakua picha ya ISO](https://download.umbrel.com/release/latest/umbrelos-amd64-usb-installer.iso) kwa usakinishaji kupitia ufunguo wa USB. Hakikisha umechagua toleo linalooana na usanifu wa x86_64 (faili inayoitwa `umbrelos-amd64-usb-installer.iso`). Kupakua kunaweza kuchukua muda, kwani picha ni kubwa sana.
...
Ili kuunda kifimbo cha USB kinachoweza kuwashwa, utatumia zana rahisi ya jukwaa tofauti inayoitwa [Balena Etcher](https://www.balena.io/etcher/). Pakua na usakinishe kwenye kompyuta yako.
...
- Ingiza kitufe tupu cha USB cha angalau GB 4:



Chomeka kitufe cha USB kwenye kompyuta yako (ile ambayo umepakua picha ya UmbrelOS na Balena Etcher). **Tahadhari: data yote kwenye ufunguo itafutwa**. Hakikisha kuwa haina faili zozote muhimu.





- Choma picha ya ISO kwenye fimbo ya USB na Balena Etcher:



Zindua Balena Etcher na uchague faili ya ISO ya `umbrelos-amd64-usb-installer.iso` ambayo umepakua kwa kubofya kitufe cha "*Flash kutoka kwenye faili*". Kisha, teua ufunguo wa USB kama kifaa lengwa na ubofye "*Mweko!*" ili kuanza kuandika.
...
Operesheni ikishakamilika, utakuwa na kitufe cha USB kinachoweza kuwashwa kilicho na UmbrelOS, tayari kuwasha na kusakinisha Umbrel kwenye mashine yako.
...
### Hatua ya 3: Kuanzisha kompyuta kutoka kwa ufunguo wa USB
...
Kama ilivyoelezwa mwanzoni mwa sura hii, ili kukamilisha usakinishaji, utahitaji kifaa cha kuonyesha na kifaa cha kuingiza data. Unganisha onyesho kupitia HDMI (au mlango mwingine, kulingana na Kompyuta yako) na uunganishe kibodi kupitia USB kwenye mashine yako. Vifaa hivi vinahitajika tu kwa ajili ya ufungaji; hutazihitaji baadaye, kwani Umbrel itafikiwa kwa mbali kutoka kwa kompyuta nyingine. Unganisha vifaa hivi viwili kwenye PC yako.



**Kidokezo:** Ikiwa huna skrini ya pembeni nyumbani, unaweza kutumia TV yako. Kwa pembejeo yake ya HDMI (au nyingine), inaweza kutumika kama skrini ya muda unaposakinisha mfumo wa uendeshaji.
...
Washa mashine yako. Katika hali nyingi, inapaswa kutambua kiotomati ufunguo wa USB na kuwasha kutoka kwake. Kisha utaona skrini ya usakinishaji ya UmbrelOS Interface ikitokea.



Ikiwa kifaa kinaanza kwenye mfumo mwingine au kinaonyesha ujumbe wa hitilafu, hii labda inamaanisha kuwa haifungui kiotomatiki kutoka kwa ufunguo wa USB. Katika kesi hii, fungua upya na uweke mipangilio ya BIOS/UEFI (kawaida hupatikana kwa kubonyeza `DEL`, `F2`, `F12`, au `ESC`, kulingana na mtengenezaji wa kompyuta). Kisha, badilisha mpangilio wa boot ili kutoa kipaumbele kwa ufunguo wa USB. Kisha anzisha upya kifaa ili kuzindua UmbrelOS.



### Hatua ya 4: Sakinisha UmbrelOS kwenye kompyuta yako



Mara tu kifaa kitakapojifungua kutoka kwa fimbo ya USB, utasalimiwa na usakinishaji wa Interface UmbrelOS. Hatua hii inahusisha kusakinisha mfumo moja kwa moja kwenye diski ya ndani ya Hard ya mashine yako.



Skrini inayoonekana huorodhesha vifaa vyote vya hifadhi ya ndani vilivyogunduliwa na kompyuta. Kila diski inaambatana na nambari, jina na uwezo wa kuhifadhi. Pata diski ambayo ungependa kusakinisha Umbrel. **Tahadhari: faili zote kwenye diski hii zitafutwa kabisa.**
...
Mara baada ya kutambua disk sahihi (kawaida moja yenye uwezo mkubwa zaidi, kuweka Blockchain), kumbuka nambari iliyopewa. Kwa mfano, ikiwa diski uliyochagua inaonekana chini ya nambari `2`, ingiza tu `2`, kisha bonyeza kitufe cha `Ingiza` kwenye kibodi.
...
Programu itaunda diski iliyochaguliwa, kusakinisha UmbrelOS, na kusanidi kiotomatiki mfumo. Hii inaweza kuchukua dakika chache. Acha mchakato uendeshe bila usumbufu.
...
Usakinishaji utakapokamilika, utaulizwa kuzima kifaa. Bonyeza kitufe chochote ili kuzima kompyuta.
...
Kabla ya kuanzisha upya kifaa, angalia pointi mbili zifuatazo:
...
Bonyeza kitufe cha nguvu. Boti za mfumo kiotomatiki kutoka kwa diski ya ndani ambapo UmbrelOS iliwekwa. Kiwasho cha kwanza kinaweza kuchukua takriban **dakika 5**. Wakati huu, Umbrel huanzisha huduma zake na Interface.



Kutoka kwa kompyuta nyingine (Kompyuta yako ya kila siku) iliyounganishwa kwa **mtandao sawa wa ndani**, fungua kivinjari (Firefox, Chrome...) na uende kwa:
...
Address hii inatumika kufikia mtumiaji wa picha wa Umbrel Interface Interface kwa mbali na kuanza kusanidi.



Ikiwa Address `http://umbrel.local` haifanyi kazi kwenye kivinjari chako baada ya kusubiri angalau dakika 5, jaribu tu:
...
Ikiwa hii bado haifanyi kazi, ingiza IP ya ndani ya Umbrel Address moja kwa moja kwenye kivinjari. Kwa mfano (badilisha `42` na nambari ya mashine yako ya kukaribisha Umbrel kwenye mtandao wa ndani):
...
Ili kutambua IP ya Umbrel Address yako, kuna njia kadhaa, kutoka rahisi hadi ya juu zaidi:





- Fikia usimamizi wa kipanga njia chako Interface na upate IP Address ya kifaa cha Umbrel kwenye mtandao wa ndani.





- Tumia programu ya kuchanganua mtandao kama vile Kichunguzi cha Hasira cha IP ili kugundua vifaa vilivyounganishwa na kupata IP ya Umbrel Address yako.
...
Sasa uko tayari kutumia Umbrel!



### Hatua ya 5: Kuanza na Umbrel
...
Chagua nenosiri thabiti na uhakikishe kuwa unahifadhi angalau nakala moja (kidhibiti cha nenosiri kinapendekezwa).
...
Usanidi wako wa Umbrel sasa umekamilika.
...
Interface ya Umbrel ni angavu kabisa:





- Kwenye ukurasa wa nyumbani, unaweza kuona programu na wijeti zako zilizosakinishwa.
...
- "*Duka la Programu*" hukuwezesha kusakinisha programu mpya,
...
- Menyu ya "*Mipangilio*" hukuruhusu kurekebisha mipangilio ya Umbrel yako na kufikia maelezo yake, ikijumuisha:
    - Sasisha, anzisha upya, au simamisha mashine yako;
    - Angalia nafasi inayopatikana ya kuhifadhi, matumizi ya RAM, na halijoto ya kichakataji;
    - Badilisha Ukuta;
    - Dhibiti ufikiaji wa mbali kupitia Tor, washa Wi-Fi au 2FA.
...
#### Mipangilio ya usalama na uunganisho
...
Ukiwezesha chaguo hili, hakikisha kuwa umewasha uthibitishaji wa vipengele viwili (2FA), nenosiri dhabiti, na usiwahi kufichua muunganisho wako wa Tor Address.



Ingiza tu Tor Address hii kwenye kivinjari chako cha Tor ili kufikia Umbrel's Interface kutoka kwa mtandao wowote.
...
Kwa Kompyuta ya usanidi wa kawaida (kichakata kinachofaa, RAM ya GB 8 hadi 16, na SSD), inaruhusu kwa takriban siku 2 hadi 7.
...
Kwa chaguo-msingi, thamani ya kigezo cha `dbcache` katika Bitcoin core imewekwa kuwa 450 MiB, au karibu 472 MB. Kwa kuongeza thamani hii, unaweza kuongeza kasi ya IBD kidogo. Walakini, nisingependekeza kwa lazima kusukuma kigezo hiki juu sana: hata kuiweka 4 GiB kutafanya tu upatanishi wa karibu 10% haraka, na kunaweza kusababisha upoteze muda katika tukio la kukatizwa wakati wa IBD.
...
Ili kujua zaidi kuhusu athari ya kigezo cha `dbcache` kwenye ulandanishaji wa awali, ninapendekeza uchanganuzi huu wa Jameson Lopp: [*Athari za Ukubwa wa DBcache kwenye Kasi ya Usawazishaji wa Njia ya Bitcoin*](https://blog.lopp.net/effects-dbcache-size-Bitcoin-node-sync-speed/speed
...
## Vielelezo: jukumu, operesheni, na suluhisho
...
Kwa maneno ya watu wa kawaida, ni kanuni sawa na faharasa katika kitabu: ikiwa unatafuta habari maalum, badala ya kusoma tena kitabu kizima, angalia faharisi ili kupata ukurasa ambao habari unayotafuta inaonekana.
...
### Je, Bitcoin core ina kiashiria?



Bila hitaji la programu ya ziada, Bitcoin core haitoi indexer kamili ya Address inayolingana na zile zinazopatikana katika programu kama vile Electrs au Fulcrum. Hata hivyo, inajumuisha njia kadhaa za ndani za kuorodhesha, pamoja na chaguo za hiari za kupanua uwezo wake wa kuuliza. Ili kuelewa hali hiyo kikamilifu, tunahitaji kuchukua mkondo kwenye historia ya mradi.
...
Hata hivyo, mbinu hii ilikuwa na mapungufu yake: ilikuwa ya polepole, ya gharama kubwa katika suala la kuhifadhi, na isiyohitajika katika suala la habari. Ili kurekebisha hili, toleo la 0.8.0 linatanguliza urekebishaji wa modeli ya uthibitishaji inayoitwa ***Ultraprune***. Badala ya kuhifadhi kila kitu katika mfumo wa faharasa za miamala, Bitcoin core ina hifadhidata rahisi inayotolewa kwa UTXO pekee, inayoitwa `chainstate` (katika lugha ya kila siku, hii inajulikana kama "UTXO set"), na kusasisha orodha yake kadri matokeo yanavyotumiwa na kuundwa.
...
Kinyume na imani maarufu, Bitcoin core haitoi faharasa kulingana na Address kama Electrs au Fulcrum. Kuna sababu kadhaa za uchaguzi huu:





- Jukumu la Bitcoin core si kuwa Block explorer kamili, wala kutoa API iliyoundwa kwa kila matumizi. Kuunganisha faharasa yenye msingi wa Address kunaweza kumaanisha matengenezo ya muda mrefu ya Commitment ambayo yanapita zaidi ya upeo wa awali wa programu.





- Kesi nyingi za utumiaji tayari zinaweza kufunikwa kwa njia zingine. Kwa mfano, ili kukadiria salio la Address, unaweza kutumia amri ya `scantxoutset`, ambayo inaulizia moja kwa moja seti ya UTXO bila kuhitaji faharasa kamili.





- Kila programu ya programu ina mahitaji mahususi kuhusu umbizo au aina ya data itakayoorodheshwa (Address, hati ya Hash, lebo ya umiliki, n.k.). Ni rahisi na yenye mantiki zaidi kuruhusu programu hizi zitengeneze faharasa zao zilizobinafsishwa kuliko kurekebisha suluhisho la jumla katika Bitcoin core.



Bitcoin core haina kielezo cha hiari cha muamala (`txindex`), mabaki ya utendakazi wake wa kihistoria, lakini haitoi faharasa ya Address, wala Interface ya moja kwa moja kwa utafutaji changamano. Katika baadhi ya matukio, kwa hiyo, inaweza kuwa muhimu kuongeza indexer ya nje.
...
Kuongeza faharasa ya Address, kama vile Electrs au Fulcrum, si lazima; inategemea na mahitaji yako maalum.
...
Kwa upande mwingine, kutumia programu ya hali ya juu zaidi, kama vile kuendesha Mempool. Ndani ya nchi, usakinishaji wa kiashiria cha Address unakuwa wa lazima kwa nafasi ya Block explorer.



Kielezo kinahitaji kiasi fulani cha muda wa maingiliano (chini ya IBD) na kitachukua nafasi ya ziada ya diski. Ikiwa SSD yako bado ina nafasi ya kutosha ya bure baada ya kupakua Blockchain, unaweza kuongeza indexer kwa urahisi.



### Kielelezo kipi cha kuchagua?
...
Kuweka tu, Electrs ni kompakt kabisa: inaashiria Blockchain haraka na inachukua nafasi ndogo ya diski, lakini hufanya vizuri kidogo kuliko Fulcrum kwenye maswali. Kinyume chake, Fulcrum hutumia nafasi zaidi ya diski na inachukua muda mrefu kuashiria, lakini inatoa utendakazi bora wa hoja.
...
Kwa maneno madhubuti, mnamo Agosti 2025, Electrs itahitaji takriban GB 56 za hifadhi, ikilinganishwa na takriban GB 178 kwa Fulcrum. Chaguo lako la indexer, kwa hivyo, inategemea pia uwezo wako wa kuhifadhi:




- Ikiwa nafasi yako ya diski ni ndogo sana, itabidi ufanye na Bitcoin core bila indexer ya nje ya Address.
- Ikiwa ungependa kutumia kiashiria, lakini bado unabanwa na uwezo, chagua Electrs.
- Ikiwa unayo nafasi nzuri ya diski, Fulcrum inaweza kuwa kile unachotafuta.
...
### Ninawezaje kusakinisha indexer kwenye Umbrel?



Ili kufunga Electrs (au Fulcrum) kwenye Umbrel yako, utaratibu ni wa moja kwa moja: nenda kwenye Hifadhi ya Programu, tafuta programu inayofaa (iko kwenye kichupo cha Bitcoin), na kisha bofya kitufe cha "* Sakinisha *".
...
Baada ya usakinishaji kukamilika, Electrs itaendelea na awamu ya ulandanishi (indexing), ambayo inaweza kuchukua saa kadhaa.
...
Kama ilivyoelezwa hapo juu, kuna miingiliano miwili kuu ya unganisho:
...
Kwenye Sparrow, fungua kichupo cha "*Faili*" na uende kwenye menyu ya "Mipangilio".
...
### Muunganisho wa Bitcoin core RPC
...
Kichupo cha "*RPC Details*" kinaonyesha taarifa zote muhimu za kuunganisha. Chagua kuunganisha kupitia Tor Address (katika `.onion`).
...
Ingiza data hizi kwenye sehemu zinazolingana kwenye Sparrow wallet, kisha ubofye kitufe cha "*Test Connection*".
...
Ikiwa uunganisho umefanikiwa, tiki ya Green na ujumbe wa uthibitisho utaonekana.
...
Jibu chini ya kulia ya Interface Sparrow wallet sasa itakuwa Green (kuonyesha uhusiano wa moja kwa moja na Bitcoin core).
...
Kwenye Sparrow, nenda kwenye kichupo cha "*Electrum ya Kibinafsi*".
...
Kisha utahitaji kuingiza vipande kadhaa vya habari ili kuanzisha muunganisho na indexer yako. Utapata data hii katika programu ya "*Electrs*" (au, inapohitajika, "*Fulcrum*") kwenye Umbrel.



Teua kichupo cha "*Tor*" ili kupata muunganisho wa `.onion` Address. Ikiwa ungependa kuunganisha programu ya simu ya Wallet, unaweza pia kuchanganua msimbo wa QR moja kwa moja.
...
Ikiwa uunganisho umefanikiwa, alama ya hundi na ujumbe wa uthibitisho utaonyeshwa.
...
**Kumbuka:** Ili muunganisho ufanye kazi, kielezo chako lazima kisawazishwe 100%. Ikiwa sivyo, subiri hadi mchakato wa kuorodhesha ukamilike.
...
## Muhtasari wa programu zinazopatikana
...
Umbrel hutoa duka kubwa la maombi. Kama utaona, kuna zana nyingi zinazohusiana na Bitcoin, lakini pia aina mbalimbali za programu katika nyanja tofauti sana: ufumbuzi wa kujitegemea wa huduma na faili, programu za tija, zana za jumla za kifedha, usimamizi wa vyombo vya habari, usalama wa mtandao na utawala, maendeleo, akili ya bandia, mitandao ya kijamii, na hata otomatiki nyumbani.



Katika kozi hii ya BTC 202, tutakuwa tukiangazia programu zinazohusiana na Bitcoin pekee. Hata hivyo, jisikie huru kuchunguza katalogi iliyosalia ya zana ambazo zinaweza kuwa muhimu kwako.



Bila shaka, haitawezekana kuorodhesha maombi yote ya Bitcoin hapa. Katika sura hii, ningependa kukujulisha kuhusu zana muhimu zitakazokuwezesha na kuboresha matumizi yako ya kila siku ya Bitcoin.
...
Katika matumizi ya kila siku ya Bitcoin, ikiwa kuna zana moja ambayo ni muhimu sana, ni Block explorer. Iwe inapatikana mtandaoni au kusakinishwa ndani ya nchi, inabadilisha data ghafi ya Blockchain kuwa umbizo lililoundwa, wazi, na rahisi kusoma. Pia ina injini ya utafutaji ambayo inaruhusu watumiaji kupata kwa haraka eneo maalum la kuzuia, muamala au Address.
...
Umbrel hutoa wachunguzi kadhaa wa block:
...
Mara tu programu imesakinishwa, ifungue tu ili kufikia kichunguzi chako mwenyewe.
...
Ili kujifunza zaidi kuhusu kutumia Mempool.Space Explorer, ninapendekeza mafunzo haya ya kina:
...
Hatimaye, ninapendekeza programu ya *Lightning Network+*, inayokuruhusu kupata marafiki ambao utafungua nao chaneli, kuwezesha miamala ya pesa inayotoka na inayoingia.
...
Kwa maneno madhubuti, Tailscale inakupa faida kadhaa unapotumia Umbrel yako:
...
Ili kujua jinsi ya kutumia programu hizi zote, ninapendekeza uangalie mafunzo haya kamili:
...
- Kozi ya BIZ 101 ya kutumia Bitcoin katika biashara yako:
...
### Kuweka vifaa vyenye afya



Node ya kuaminika huanza na vifaa imara. Hakikisha mashine inayoweka kifundo chako ina hewa ya kutosha, isiyo na Dust, na imewekwa katika mazingira kavu, mbali na vyanzo vyovyote vya joto na unyevunyevu. Epuka kuibana kwenye nafasi ndogo na uchague eneo lenye uingizaji hewa mzuri.
...
Hakikisha unatumia nguvu ya hali ya juu ya Supply, kwani voltage isiyo imara inaweza kusababisha uharibifu wa mfumo na hata kusababisha hatari ya moto. Kwa kweli, unapaswa kutumia nguvu asili ya Supply iliyotolewa na mtengenezaji wa mashine yako. Jihadharini, pia, kutokana na kuongezeka kwa joto kwa sababu ya athari ya Joule kwenye vipande vya nguvu: daima heshimu upeo unaoruhusiwa na usiunganishe vipande kadhaa vya nguvu katika kuteleza.
...
- Ili kusasisha mfumo: Fungua menyu ya mipangilio, kisha ubofye kitufe cha "*Angalia Usasishaji*" karibu na kigezo cha "*UmbrelOS*".
...
- Ili kusasisha programu: Nenda kwenye Duka la Programu. Ikiwa programu yako yoyote inahitaji kusasishwa, kitufe chenye kiputo chekundu kitaonekana kwenye kona ya juu kulia ya Interface. Bonyeza tu juu yake, kisha usasishe kila programu.



Fanya operesheni hii mara kwa mara ili kusasisha mfumo wako wa uendeshaji na programu.
...
Tutarejea vipengele hivi kwa undani katika kozi inayofuata ya LNP202.



### Usalama wa uendeshaji wa kila siku
...
Usiwahi kuonyesha dashibodi kwenye Mtandao bila kutumia lango salama (kama vile VPN, Tor, au ufikiaji wa ndani pekee). Weka kikomo idadi ya programu unazosakinisha, na ufute mara kwa mara zile ambazo huhitaji tena, ili kupunguza eneo la mashambulizi.



Ili kuongeza ujuzi wako wa usalama wa kompyuta kwa ujumla, ninapendekeza sana uangalie kozi hii nyingine ya bure:
...
Tatizo likiendelea, ninapendekeza kwamba [ujiunge na jumuiya ya watumiaji wa Umbrel kwenye Discord yao](https://discord.gg/efNtFzqtdx). Anza kwa kufanya utafutaji ili kubaini ikiwa kuna mtu yeyote tayari amekumbana na ugumu sawa na kupata suluhu. Ikiwa sivyo, unaweza kuchapisha ujumbe katika kituo cha `msaada wa jumla`. Unaweza pia kutumia [kongamano la Umbrel](https://community.umbrel.com/).



Maeneo haya yatakuwezesha sio tu kufuata matangazo na masasisho ya usalama, lakini pia kuuliza maswali na, hatimaye, kuwasaidia watumiaji wengine. Mara nyingi ni katika mabadilishano haya ambapo mbinu bora hugunduliwa.
...
## Kuelewa IBD na mchakato wa ugunduzi wa rika
...
Usawazishaji huanza na _**vijajuu-kwanza**_ hatua. Node yako inaomba mlolongo wa vichwa vya kuzuia kutoka kwa wenzao kadhaa na, kwa kila mmoja wao, inathibitisha Proof of Work, kurekebisha ugumu, syntax, pamoja na Timestamp na sheria za nambari za toleo. Kwa kifupi, inahakikisha kwamba kila kichwa kilichopokelewa kinazingatia sheria za makubaliano.
...
Unaweza kulazimisha uthibitishaji kamili wa hati zote kwa kuzima utaratibu huu, kwa gharama ya IBD ndefu zaidi, kwa kutumia kigezo cha `assumevalid=0` katika faili `Bitcoin.conf`.
...
`assumeutxo` ni kigezo kingine kilichopo, lakini tofauti na `assumevalid`, haijaamilishwa kwa chaguomsingi. Utaratibu huu huwezesha programu kupakia muhtasari wa seti ya UTXO, pamoja na metadata yake, na kuizingatia kwa muda kama hali ya marejeleo, baada ya kuthibitisha kwamba vichwa kweli vinaongoza kwa Blockchain yenye kazi nyingi zaidi.
...
- Luke Dashjr: `dnsseed.Bitcoin.dashjr-orodha-ya-P2P-nodes.us.`
...
Mara tu inapofungwa, meneja wa ndani wa Address hubadilisha vyanzo (mitandao tofauti inayojitegemea, clearnet, na Tor, pamoja na maeneo mbalimbali ya kijiografia) ili kupunguza hatari ya kutengwa kwa kijiografia. Node huanzisha viunganisho hivi vinavyotoka (viunganisho huchagua yenyewe, na kwa hiyo ni salama zaidi).
...
#### Blk*.dat faili (data ghafi ya kuzuia)
...
#### Rev*.dat faili (data ya kughairiwa)
...
#### Faharasa za hiari (faharasa/)



Faharisi zingine ni za hiari na zimezimwa kwa chaguo-msingi, kwani zinaongeza alama ya diski:
...
### Seti ya UTXO (chainstate)



Muundo wa UTXO (*Pato la Muamala Usiotumika*) ni uwakilishi wa kihasibu wa Bitcoin: kila pato ambalo halijatumika ni "Coin" inayopatikana ambayo inaweza kutumika kama ingizo kwa muamala wa siku zijazo.
...
Kinadharia, tunaweza kuthibitisha muamala kwa kuchanganua upya historia ya kuzuia ili kuangalia kuwa pato halijawahi kutumika. Kwa mazoezi, hata hivyo, hii inaweza kuchukua muda mwingi, kwani Blockchain nzima italazimika kuchanganuliwa kwa kila shughuli mpya. Seti ya UTXO, kwa hiyo, inatoa mtazamo wa chini unaohitajika ili kuthibitisha ndani ya nchi na kwa muda wa kutosha kutokuwepo kwa Double-spending.



Kumbuka kuwa seti ya UTXO mara nyingi ndiyo kiini cha wasiwasi kuhusu ugatuaji wa Bitcoin, kwani ukubwa wake kawaida huongezeka haraka. Hii ni kwa sababu ya kupanda kwa bei ya Bitcoin, ambayo inahimiza kugawanyika kwa sehemu, na kwa sehemu kwa kupitishwa kwa mfumo: watumiaji wengi wapo, ndivyo mahitaji ya UTXO yanavyoongezeka.
...
#### Sera ya kumbukumbu na usimamizi
...
#### Mempool kuendelea kwenye diski
...
### Faili za msaidizi na hifadhidata



Faili zingine kadhaa katika kiwango sawa na `blocks/`, `chainstate/`, na `indexes/` zinashiriki katika utendakazi sahihi wa:
...
- `.cookie` ina uthibitishaji wa muda mfupi wa RPC token (iliyoundwa wakati wa kuanza, ilifutwa wakati wa kuzimwa) wakati uthibitishaji wa vidakuzi unatumika. Hii inaweza kutumika, kwa mfano, kuunganisha programu ya Wallet.
- `.lock` ni kufuli ya saraka ya data, ambayo huzuia hali nyingi kuandika kwa datadir sawa kwa wakati mmoja.
- `guisettings.ini.bak` ni uhifadhi wa kiotomatiki wa mipangilio ya GUI (*Bitcoin Qt*) wakati chaguo la `-resetguisettings` linapotumika.
...
Kwa muhtasari, hapa kuna muundo wa faili wa Bitcoin core:
...
### Mahali na kipaumbele



Kwa chaguo-msingi, `Bitcoin.conf` inakaa katika orodha ya data ya Bitcoin core. Hii ndio saraka maarufu tuliyotaja katika sura iliyotangulia. Hata hivyo, faili hii haijaundwa kiotomatiki na Bitcoin core, isipokuwa katika mazingira fulani, kama vile Umbrel. Ikiwa haipo tayari, itabidi uifanye generate mwenyewe kwa kuunda faili inayoitwa `Bitcoin.conf`, kisha uifungue kwenye kihariri cha maandishi ili kufanya marekebisho yako.



Vigezo vilivyofafanuliwa katika `Bitcoin.conf` vinaweza kubatilishwa na tabaka 2:




- `settings.json` (iliyoandikwa kwa nguvu na michoro ya Interface au baadhi ya RPC),
- na chaguzi zilizobadilishwa kupitia mistari ya amri.
...
Umbizo la `Bitcoin.conf` kwa hiyo ni rahisi sana: mstari mmoja kwa kila chaguo, katika muundo `chaguo=value`. Nafasi zisizohitajika na mistari tupu hupuuzwa, na maoni ya msimbo huanza na `#`.



Takriban chaguo zote za Boolean zinaweza kuzimwa kwa kiambishi awali cha `hapana`. Kwa mfano, `sikiliza=0` na `nolisten=1` ni sawa kulingana na toleo.



Ili kupanga usanidi kwa mtandao, unaweza kutumia sehemu: `[kuu]`, `[test]` (testnet3), `[testnet4]`, `[alamisho]`, `[regtest]`. Vinginevyo, unaweza kuweka kiambishi awali cha chaguo kwa `regtest.maxmempool=100`.



### Nini Bitcoin.conf inaweza na haiwezi kufanya



Kama ilivyoelezwa hapo juu, sheria za maafikiano ni wazi haziwezi kusanidiwa katika `Bitcoin.conf`, kwani hii inaweza kuunda Hard Fork. Kwa upande mwingine, vipengele vingine vingi vinaweza kusanidiwa. Kuna madarasa 3 muhimu ya kukumbuka:
...
Ikiwa hupendi kufungua mlango kwenye kipanga njia chako, lakini bado unakubali miunganisho inayoingia, unaweza kuwezesha kigezo cha `kusikiliza = 1`. Hii itafikia matokeo sawa, lakini tu kupitia mtandao wa Tor badala ya clearnet.



Katika kiwango cha mtandao, pia tunayo:
...
Ili kuwasha Tor kikamilifu, unahitaji kulazimisha Bitcoin core kutumia mtandao huu tu na kuunda huduma iliyofichwa kwa miunganisho inayoingia (ikiwa unataka kuwawezesha). Katika `Bitcoin.conf`, unahitaji kuongeza usanidi huu:




- `neti=kitunguu`,
- `wakala=127.0.0.1:9050`,
- `sikiliza=1`,
...
Ni wazi, ikiwa wewe ni mwanzilishi, ningekushauri uache mipangilio hii yote ya mtandao peke yako kwa wakati huu. Usanidi chaguo-msingi mara nyingi hutosha.



### Mempool na sera ya relay
...
Hivi ndivyo vigezo vya msingi unavyoweza kurekebisha kwenye `Bitcoin.conf` yako kuhusu usimamizi wa Mempool yako na utumaji upya wa miamala ambayo haijathibitishwa:
...
- `mempoolexpiry=<n>`: Muda wa juu zaidi wa kubaki kwa miamala ambayo haijathibitishwa katika Mempool (kwa saa, chaguomsingi: `336`). Baada ya muda huu, miamala huondolewa hata kama nafasi itabaki kupatikana.





- `persistmempool=1`: Huhifadhi muhtasari wa Mempool ikiwa imesimama na kupakia upya inapowashwa upya (chaguo-msingi: `1`). Hii inaharakisha ahueni baada ya kuwasha upya, kuepuka haja ya kujifunza upya hali kupitia mtandao.





- `maxorphantx=<n>`: Idadi ya juu zaidi ya miamala ya watoto yatima iliyobaki (vipengee tegemezi kutoka kwa UTXO bado hazijaonekana katika seti ya UTXO, chaguomsingi: `100`). Zaidi ya kizingiti hiki, miamala ya zamani zaidi inafutwa ili kuzuia ukuaji usiodhibitiwa wa kache.
...
- `mempoolfullrbf=1`: Kubali miamala ya RBF hata bila ishara dhahiri ya RBF katika ununuzi uliobadilishwa. Kwa sera hii ya "*full-RBF*", shughuli inayotoa ada ya juu zaidi inaweza kuchukua nafasi ya nyingine katika Mempool ikiwa masharti mengine ya uingizwaji yatatimizwa.
...
#### Mipangilio ya hali ya juu na maalum



Hapa kuna mipangilio ya kina ya Mempool na sera ya relay. Ikiwa wewe ni mwanzilishi, hupaswi kuhitaji kurekebisha mipangilio hii:
...
- `bytespersigop=<n>`: Kigezo ambacho hubadilisha miamala ya sahihi kuwa baiti sawa kwa tathmini ya kikomo cha upeanaji (chaguo-msingi: `20`). Hii itaathiri kukubalika kwa shughuli tajiri za `sigops` kulingana na sheria za sera za ndani.
...
- `whitebind=<[permissions@]addr>` / `whitelist=<[permissions@]CIDR>`: Hufunga masafa ya Interface au Address na hupeana ruhusa zenye ubora mzuri kwa wenzao sambamba: `relay`, `forcerelay`, `Mempool` (Mempool), `kupakua`, `ombi`, `ombi`, `ombi`, `````, ``````````````````````````````````````````````````````````````` `bloomfilter`. Hii inaweza kuwa muhimu kwa kutoa matibabu ya upendeleo kwa wenzao wanaoaminika (kama vile lango, LAN na huduma za ndani).
...
- `changetype=<legacy|P2SH-SegWit|bech32|bech32m>`: Lazimisha umbizo la Exchange Address (salio la ingizo kwenye malipo moja).
...
- `walletrbf=1`: Huwasha RBF kuchagua kuingia ili kuashiria RBF kwenye shughuli zote za malipo (chaguo-msingi: `1`). Hukuruhusu kuongeza ada baadaye katika tukio la shughuli iliyozuiwa.
...
- `paytxfee=<amt>`: Kiwango cha ada kisichobadilika (BTC/kvB) kinatumika kwa miamala ya Wallet. Epuka kwa ujumla: tumia ukadiriaji unaobadilika kupitia `txconfirmtarget`.
...
- `mintxfee=<amt>`: Kiwango cha chini zaidi (BTC/kvB) kwa Wallet ili kuunda miamala (chaguo-msingi: `0.00001`). Wallet itakataa kujenga shughuli chini ya kizingiti hiki.





- `maxtxfee=<amt>`: Kiwango kamili cha ada ya jumla ya malipo ya Wallet (chaguo-msingi: `0.10` BTC). Inalinda dhidi ya ada ya juu isiyo ya kawaida ambayo inaweza kuharibu bitcoins bila lazima.





- `avoidpartialspends=1`: Huchagua UTXO kwa makundi ya Address ili kuepuka matumizi kiasi.





- `spendzeroconfchange=1`: Inaruhusu UTXO Exchange ambayo haijathibitishwa kutumika tena kama ingizo la muamala mpya (chaguo-msingi: `1`).





- `consolidatefeerate=<amt>`: Kiwango cha juu zaidi (BTC/kvB) ambacho Wallet huepuka kuongeza pembejeo zaidi kuliko inavyohitajika ili kuunganishwa. Hii inaruhusu ujumuishaji nyemelezi kwa bei ya chini na kupunguza gharama wakati gharama ni kubwa.





- `maxapsfee=<n>`: Bajeti ya gharama za ziada (BTC, thamani kamili) ambayo Wallet inakubali kulipa ili kuwezesha chaguo la "*epuka matumizi kiasi*".





- `discardfee=<amt>`: Kadiria (BTC/kvB) inayoonyesha uvumilivu wako kutupa Exchange kwa kuiongeza kwenye ada. Matokeo ambayo yangegharimu zaidi ya theluthi moja ya thamani yake kwa kiwango hiki hupunguzwa.





- `keypool=<n>`: Ukubwa wa bwawa la maji la Address lililotolewa awali (chaguo-msingi: `1000`). Thamani ambazo ni ndogo sana huongeza hatari ya urejeshaji usio kamili.
...
### Uhifadhi, indexing, na utendaji



Faili ya usanidi pia hukuruhusu kurekebisha vigezo vinavyohusiana na mashine yako. Hii inaweza kuwa muhimu sana ikiwa una rasilimali ndogo, au, kinyume chake, idadi kubwa ya uwezo unaopatikana:





- `datadir=<dir>`: Inaweka saraka kuu ya data ya Bitcoin core.
...
- `dbcache=<n>`: Hutenga `<n>` MiB kwa akiba ya hifadhidata (*LevelDB*) inayotumiwa na faharasa ya kuzuia na `chainstate` (chaguo-msingi: `450`). Thamani ya juu, kasi ya IBD na uthibitishaji wa sasa, kwa gharama ya matumizi ya juu ya RAM.
...
- `reindex=1`: Huunda upya faharasa za kuzuia na hali (`chainstate`) kutoka kwa faili za `blk*.dat` kwenye diski. Pia huunda upya faharasa zinazotumika kwa hiari. Huu ni operesheni inayotumia muda mrefu kukarabati hifadhidata iliyoharibika au kuwasha/kuzima faharasa nzito.





- `reindex-chainstate=1`: Hujenga upya `chainstate` pekee kutoka faharasa ya sasa ya block. Inapendekezwa wakati faili za kuzuia ni nzuri.





- `blockfilterindex=<aina>`: Hudumisha faharasa za vichujio vya kuzuia vichungi (k.m., `basic`) vinavyotumiwa na wateja wembamba (BIP157/158) na baadhi ya RPC. Imezimwa kwa chaguo-msingi (`0`). Hutumia nafasi ya ziada ya diski na wakati wa kuorodhesha.





- `coinstatsindex=1`: Hudumisha faharasa ya takwimu za UTXO inayoendeshwa na simu ya `getxoutsetinfo`. Inafaa kwa ukaguzi na vipimo, ikiondoa hitaji la kukokotoa tena kwa gharama kubwa. Imezimwa kwa chaguomsingi.
...
- `par=<n>`: Huweka idadi ya minyororo ya uthibitishaji hati (kutoka `-10` hadi `15`, `0` = otomatiki, `<0` = huacha nambari hii ya viini bila malipo). Inakuruhusu kurekebisha usawa wa CPU wakati wa uthibitishaji. Hali ya kiotomatiki inafaa katika hali nyingi.





- `debuglogfile=<file>`: Hubainisha eneo la kumbukumbu ya `debug.log`.





- `shrinkdebugfile=1`: Hupunguza ukubwa wa `debug.log` mwanzoni (chaguo-msingi: `1` wakati `-debug` haitumiki).





- `mipangilio=<faili>`: Njia ya faili ya mipangilio inayobadilika `settings.json`.



### Ufikiaji wa RPC na usalama wa kufanya kazi
...
- `rpcport=<port>`: bandari ya RPC (chaguo-msingi: `8332` kwenye Mainnet, `18332` kwenye Testnet, `38332` kwenye alamisho, `18443` kwenye regtest).





- `rpcallowip=<ip|cidr>`: Huruhusu wateja wa RPC kutoka kwa IP au subnet iliyotolewa (inaweza kurudiwa). Tumia kwa kushirikiana na `rpcbind` kufichua API kwa sehemu inayoaminika pekee (LAN/VPN).





- `rpcauth=<USERNAME>:<SALT>$<Hash>`: Mbinu ya uthibitishaji ya RPC inayopendekezwa (nenosiri la haraka). Huruhusu maingizo mengi na huepuka kuhifadhi siri katika maandishi wazi.





- `rpccookiefile=<njia>`: Njia ya kuki ya uthibitishaji (chaguo-msingi: faili ya `.cookie` chini ya `datadir/`). Hii inatumika kwa ufikiaji wa ndani na mtumiaji sawa bila kudhibiti manenosiri yanayoendelea. Kwa mfano, unaweza kuitumia kuunganisha Liana Wallet kwa Bitcoin core yako kwenye mashine sawa.





- `rpcuser=<user>` / `rpcpassword=<pw>`: Uthibitishaji wa Kawaida wa RPC na nenosiri la maandishi. Epuka kutumia hii kwa kupendelea `rpcauth` au kidakuzi.





- `rpctreads=<n>`: Idadi ya nyuzi za kutumia simu za RPC (chaguo-msingi: `4`). Iongeze ikiwa una vilele vya juu vya simu kwenye upande wa ufuatiliaji/wa nje wa zana.





- `rpcwhitelist=<USERNAME>:<rpc1>,<rpc2>,...`: Orodha iliyoidhinishwa ya API. Hupunguza eneo la mashambulizi kwa kuzuia njia zinazoweza kufikiwa.





- `rpcwhitelistdefault=1|0`: Tabia chaguo-msingi ya orodha iliyoidhinishwa: ikiwashwa na orodha iliyoidhinishwa ikitumiwa, simu ambazo hazijaorodheshwa hukataliwa. Hii inaweza pia kulazimisha seti chaguo-msingi tupu (hakuna simu zinazoruhusiwa) mradi hakuna chochote kilichoorodheshwa wazi.





- `rest=1`: Washa API ya REST ya umma (imezimwa kwa chaguomsingi). Ili kufichuliwa tu kwenye mtandao unaoaminika (tahadhari sawa na kwa JSON-RPC).





- `conf=<file>`: Inabainisha, kwenye mstari wa amri pekee, faili ya usanidi ya kusoma tu. Inafaa kwa kufungia wasifu wa utekelezaji (haibadiliki) kwenye upande wa ops.





- `includeconf=<file>`: Hupakia faili ya ziada ya usanidi (njia inayohusiana na `datadir/`). Huruhusu utenganisho wa majukumu: msingi wa kawaida + upakiaji nyeti wa ndani.





- `daemon=1` / `daemonwait=1`: Huanzisha `bitcoind` chinichini na, ikiwa na `daemonwait`, husubiri uanzishaji umalizike kabla ya kukabidhi. Hii inawezesha ushirikiano na wasimamizi (systemd, runit).





- `pid=<file>`: Eneo la faili ya PID.





- `sandbox=<log-and-abort|abort>`: Huwasha syscalls sandboxing ya majaribio: siskali zinazotarajiwa pekee ndizo zinazoruhusiwa.





- `startupnotify=<cmd>` / `shutdownnotify=<cmd>`: Hutekeleza amri wakati wa kuanzisha au kuzima.





- `alertnotify=<cmd>`: Huanzisha amri inapopokea arifa.
...
- `debug=<category>|1` / `debugexclude=<category>`: Huwasha/huzima kategoria za kumbukumbu za kina (k.m. `net`, `Mempool`, `RPC`, `uthibitishaji`...).
...
- `logsourcelocations=1` / `logthreadnames=1` / `logtimestamps=1`: Huongeza maeneo ya chanzo, majina ya mazungumzo, na mihuri ya muda sahihi kwenye kumbukumbu, mtawalia.





- `printtoconsole=1`: Hutuma ufuatiliaji/utatuzi kwa kiweko (*stdout*).





- `msaada-utatuzi=1`: Huonyesha usaidizi wa chaguo la utatuzi na kuacha.





- `uacomment=<cmt>`: Huongeza maoni kwa Wakala wa Mtumiaji P2P.
...
Sasa unaweza kuendelea hadi sehemu ya mwisho ya kozi, ambapo utaweza kutathmini BTC 202, kisha uchukue diploma yako ili uangalie ikiwa umefahamu dhana zote zinazoshughulikiwa.
