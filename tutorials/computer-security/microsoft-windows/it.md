...
La prima cosa di cui hai bisogno è un file di installazione. Il luogo più sicuro e affidabile per scaricarlo è direttamente il sito ufficiale di Microsoft.
...
Una volta arrivato alla pagina di download, scorri verso il basso fino alla sezione per scaricare il file ISO.
...
Dopo aver selezionato Windows 11, fai clic sul pulsante "Conferma".
...
Una volta elaborata la richiesta, verrà visualizzata una pagina con il link per il download del file .iso. Fai clic sul pulsante Download 64-bit per avviare il download.
...
Come indicato all'inizio della pagina, questo metodo può essere usato per l'installazione di Windows 10 e 11. Nella prima fase seleziona la lingua di Windows. Se desideri aggiungere una seconda o addirittura una terza lingua all'elenco delle lingue del display e della tastiera di Windows, è possibile utilizzare la casella sottostante:

![Image](assets/en/07.webp)

Nella fase successiva, seleziona la posizione desiderata.
