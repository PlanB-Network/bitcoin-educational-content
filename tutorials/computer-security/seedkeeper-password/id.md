...
- Bitcoin** Penyimpanan frasa Mnemonic: alih-alih menuliskan 12 atau 24 kata di atas kertas, Anda dapat mengimpornya ke dalam kartu pintar dan melindunginya dengan kode PIN.
- Manajemen kata sandi**: Anda dapat generate kata sandi yang kuat melalui aplikasi Seedkeeper dan menyimpannya langsung di dalam smartcard, memberikan Anda pengelola kata sandi offline yang nyaman dan mudah digunakan.
...
Dalam tutorial ini, kita hanya akan membahas penggunaan SeedKeeper untuk kata sandi tradisional, seperti halnya pengelola kata sandi. Jika Anda ingin menggunakan SeedKeeper untuk menyimpan frasa Bitcoin Wallet Mnemonic, silakan lihat tutorial lainnya:
...
Pilih "Rahasia generate*". Opsi "*Import a secret*" memungkinkan Anda untuk menyimpan rahasia yang sudah ada (misalnya, kata sandi yang pernah Anda buat sebelumnya).
...
Tetapkan "*Label*" pada rahasia ini agar dapat dengan mudah diidentifikasi jika Anda menyimpan beberapa informasi di Seedkeeper. Anda juga dapat menambahkan nama pengguna yang terkait dengan kata sandi dan URL situs.
...
Ini akan membawa Anda ke daftar semua rahasia Anda yang terdaftar. Dalam contoh ini, saya ingin menampilkan kata sandi untuk akun Plan ₿ Network saya, jadi saya klik.
