...
Zaidi ya hayo, tunapothamini muundo wa *Value4Value*, tutatuza michango ya ukaguzi. Zawadi itatokana na urefu wa maudhui, usahihi wa kiisimu wa tafsiri yetu ya kiotomatiki na ugumu wa maudhui.
...
- Fungua akaunti kwenye [GitHub](https://github.com/) ili kuanza kuchangia. Ikiwa unataka mwongozo wa kuunda akaunti yako ya GitHub, nenda kwenye mafunzo yaliyotajwa hapo juu.
...
> 29182ddfc9 (Kusasisha_mafunzo_ya_ya_kusahihisha (#1642))

- Utahitaji pia akaunti kwenye programu ya kutuma ujumbe [Telegram](https://telegram.org/).


## 2. Jiunge na kikundi cha Telegram
...
- Kwa ufupi jitambulishe na ubainishe maudhui unayotaka kuchangia na lugha katika ujumbe kwa kituo cha "Jumla".
- Mwanachama wa timu ataunda suala kwenye GitHub kwa mchango wako wa siku zijazo. Utapata taarifa zote zinazohitajika ili kuanza ukaguzi wako hapo.


![REVIEW](assets/fr/02.webp)


## 3. Kagua na uhariri maudhui kupitia Interface ya GitHub
...
- Sasa unaweza kutazama GitHub Interface ya faili ili kukagua.
- Paneli ya kushoto inakuruhusu kuvinjari kupitia tawi lako (cf. \**A\**) na faili (cf. \**B\**).
- Bofya aikoni ya penseli ili kuanza kukagua (cf. \**C\**).
...
- Ikiwa huu ni mchango wako wa kwanza, GitHub itakuelekeza kwenye hazina ya chanzo cha Fork. Bonyeza tu kifungo.
...
- Kisha utafika kwenye Kihariri Interface (cf. \**A\**), ambapo unaweza kuona njia ya faili na tawi linalolingana (cf. \**B\**) na ubadilishe kati ya hali za kuhariri na onyesho la kukagua (cf. \**C\**).
...
- Unaweza kuanza kukagua na kusahihisha maudhui inavyohitajika.
- Unapotaka kusitisha kipindi chako, unaweza kutekeleza mabadiliko yako, hata kama ukaguzi haujakamilika. Ni kama kuhifadhi maendeleo yako kwenye GitHub.
...
- Ongeza ujumbe wa maelezo kwa mabadiliko yako (cf. \**A\**).
- Ongeza muktadha zaidi katika maelezo ikiwa ni lazima (cf. \**B\**).
- Bofya kitufe cha "Pendekeza mabadiliko" (cf. \**C\**).
...
- Ikiwa huu sio mchango wako wa kwanza, GitHub itakuhimiza kuunda tawi jipya. Haupaswi kamwe kujitolea moja kwa moja kwa tawi kuu la `dev`. Ikiwa tayari umefanya ahadi kwenye tawi linalofanya kazi, chagua tawi hilo. Vinginevyo, chagua chaguo la "Unda tawi jipya" ili kuunda jipya.
...
- Kisha utafikia ukurasa unaofupisha mabadiliko yako yote. Kwa kuipitia, unaweza kuona marekebisho sahihi: vitu vilivyofutwa vinaonekana kwa rangi nyekundu, wakati vitu vilivyoongezwa vinaonekana kwenye Green.
...
- Chagua tawi lililo na maendeleo yako (cf. \**A\**), tafuta faili yako ya maudhui (cf. \**B\**), kisha ubofye aikoni ya penseli ili kuendelea na ukaguzi.
...
## 5. Unda PR na tawi lililojitolea



- Ikiwa kila kitu kinaonekana vizuri na umekamilisha mabadiliko yako, bofya kitufe cha Green "Unda Ombi la Kuvuta".
...
- Kisha utafika kwenye ukurasa wa PR. Ombi la Kuvuta ni ombi la kuwasilisha mabadiliko yaliyofanywa kwenye tawi la hazina ya mbali kwa ukaguzi na uwezekano wa kuunganishwa kwenye tawi kuu.
- Ongeza kichwa na maelezo mafupi kwa PR yako. Kichwa kinapaswa kuendana na suala unaloshughulikia. Kwa mfano, ikiwa mada ya toleo ni `[TRANSLATION] Kozi CYP201 - FR`, tumia kichwa sawa na PR yako (cf. \**A\**). Katika maelezo, taja suala linalohusiana kwa kutumia nambari yake, iliyotanguliwa na "Inafungwa". Hii itafunga suala kiotomatiki mara tu PR itakapounganishwa (cf. \**B\**).
- Ikiwa kila kitu kinaonekana vizuri, bofya kitufe cha Green "Unda Ombi la Kuvuta" (cf. \**C\**).
...
- Ikiwa una maoni, maswali au maoni yoyote kuhusu mradi huu, jisikie huru kutuma DM [kwa kikundi cha wachangiaji cha Telegram](https://t.me/PlanBNetwork_ContentBuilder).
