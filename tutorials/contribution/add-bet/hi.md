...
- [डेटा के लिए समर्पित PlanB के GitHub रिपॉजिटरी](https://github.com/Plan ₿ Academy/Bitcoin-educational-content/tree/dev/resources/bet) पर जाएं, `resources/bet/` अनुभाग में:
