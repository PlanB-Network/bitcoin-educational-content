---
term: NEDLADDNING AV INITIALT BLOCK (IBD)
---
...
> ► *På franska är det allmänt accepterat att direkt hänvisa till en IBD. Den översättning som ibland används är "synchronisation initiale", eller "téléchargement initial des blocs".*