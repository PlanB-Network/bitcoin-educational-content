...
Sélectionnez la date de commencement et la fréquence de votre DCA, avec des options allant de l'achat horaire à mensuel. Confirmez en cliquant sur "Programmer".
...
Si vous ne connaissez pas le fonctionnement d'un portefeuille en self-custody, nous proposons des tutoriels sur la plupart des solutions disponibles [sur Plan ₿ Network dans la section "Wallet"](https://planb.network/fr/tutorials/wallet).
