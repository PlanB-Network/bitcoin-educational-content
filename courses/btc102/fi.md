...
Ponzi-huijaukset voivat ilmetä monin eri tavoin. Joskus ne naamioituvat uusiksi token-tarjouksiksi tai alkuperäisiksi kolikkoantitarjouksiksi (ICO), älykkäiden sopimusten yhdistelmiin, yrityksiin monopolisoida fiat-valuutta tai jopa markkinointiohjelmiin ilman todellista tuotetta. Kuitenkin perusteellinen tutkimus ja huolellinen due diligence paljastavat, että nämä järjestelmät eivät luo todellista arvoa. Ne vain uudelleenjakavat rahaa uusilta tulokkailta maksamaan vanhoille osallistujille.
...
Bitcoin-yhteisö usein mobilisoituu tuomitsemaan nämä teot, mutta oikeusjärjestelmän voi kestää jonkin aikaa toimia näitä yksilöitä vastaan.
...
![tiivistettynä](assets/section2/8.webp)
...
Lompakot ovat olennainen osa Bitcoinia ja tutkimme niitä yksityiskohtaisesti tässä yliopistossa.
...
Rakkaat Liz & Maia,
Rakastan teitä syvästi ja tiedän, että te olette vahvoja.
Kirjoitan tätä kirjettä ilmoittaakseni, että omistan krypto-omaisuuksia, joilla voi olla arvoa.
Lue tämä kirje huolellisesti ja kokonaisuudessaan ennen toimintaan ryhtymistä. Nämä varat eroavat muista varoista, sillä kerran siirrettyinä, niitä ei voi palauttaa."

Seuraavaksi sisällytämme "neuvonantajien osion". Tämä osa voi olla hämmentävä perillisillesi, erityisesti jos mainitset henkilöitä tai organisaatioita, joita he eivät tunne. Ole tarkka:

- Miten heihin otetaan yhteyttä
- Miten heidät tunnistetaan
- Mikä on heidän asiantuntemusalueensa
- Miten he voivat perehtyä aiheeseen

"Alla on luettelo ihmisistä, joihin luotan vastaamaan kysymyksiisi ja auttamaan sinua prosessissa löytää ja siirtää nämä varat. Ota yhteyttä listatuille henkilöille, mutta älä luota yksittäiseen henkilöön hallitsemaan prosessia. Ole valppaana kaikkien neuvonantajien kanssa, myös tässä listassa olevien kanssa. Jokainen voi tehdä virheitä, joten varmista, että ymmärrät heidän tekemisensä parhaasi mukaan, äläkä pelkää esittää kysymyksiä ja varmistaa vastaukset itse.
...
Vaikuttaa ehkä oudolta, mutta ota yhteyttä kaikkiin heihin. Lisäksi voit sivistää itseäsi kuuntelemalla Andreas Antonopoulosia YouTubessa ja ostamalla Pamela Morganin kirjan "Cryptoasset Inheritance Planning".

Ja nyt lisäämme Inventointi-osion. Aloita listaamalla laitteesi ja paikat, joissa pidät bitcoineja.

- Puhelin: mobiililompakko
- Pöytäkone: vaihtoalustat, sovellukset, pelit, verkkosivustot
- Siirry fyysisiin lompakkoihin
- Salalause (passphrase)
- Multisig

Kun mainitset varmuuskopion säilytyspaikan, käytä yleistä sijaintia, älä tarkkaa osoitetta. Jos omistat jotain muuta kuin bitcoineja, kerro siitä meille.

"Alla on luettelo laitteista, ohjelmistoista ja lompakoista, joita käytän näiden varojen käyttämiseen. Säilytä kaikki nämä laitteet turvallisessa paikassa ja pidä ne kunnes varat siirretään perillisilleni. Älä salli kenenkään päästä niihin käsiksi valvomatta.

(Lisää tähän krypto-omaisuutesi inventaario)

- "Olen käyttänyt puhelintani (Samsung Galaxy S8) päästäkseni käsiksi Samourai-lompakkooni. Lompakkoa suojaava yksityinen avain on säilytetty pankin holvissa ja toinen kopio on setä Bobin luona. Puhelimeni ja lompakon lukituksen avaava PIN-koodi on säilytetty kotona ja isoäitini luona.
- Käytän 2018 Dell-tietokonettani päästäkseni käsiksi online-vaihtoalustaan nimeltä Bitstamp. Minulla saattaa edelleen olla Bitcoineja tai dollareita tällä alustalla. Päästäksesi käsiksi tililleni, sinun täytyy ottaa yhteyttä heihin suoraan tai kirjautua tililleni (ole varovainen, tämä saattaa olla laitonta - tarkista paikallinen lainsäädäntösi).
...
- Apu: Varmista, että olet antanut nimet, yhteystiedot ja mahdollisuuksien mukaan valokuvat.
- Laitteet: Varmista, että olet listannut puhelimesi, tietokoneesi, fyysiset lompakot ja paperilompakot.
...
- Bitcoin-solmu ja Lightning Network: Lightning Network, kuten olemme jo useita kertoja nähneet, tuo aivan uuden näkemyksen siitä, mikä Bitcoin on. Tämän toisen kerroksen kautta mahdollisuuksia on lukuisia, ja sen päälle rakentuu kokonainen teollisuudenala. Saattaaksesi sinut löytöretkelle, kutsun sinut osallistumaan LN 201 -teoriakurssille tai LN 202 -käytännön kurssille. Molemmat kurssit ovat kaikkien saavutettavissa tässä oppimisen vaiheessa ja voivat auttaa sinua ymmärtämään paremmin tämän uuden Bitcoinin näkökulman.

- Itävaltalainen taloustiede: Jos talous ja rahoitus ovat aiheita, jotka kiinnostavat sinua, ECON 201 -kurssi on todennäköisesti oikea valinta syvemmän itävaltalaisen taloustieteen näkökulmien tutkimiseen. Siellä löydät tämän talouskoulukunnan, joka vastustaa perinteisempää Keynesiläisyyttä. Se on hyvä lähtökohta kyseenalaistaa järjestelmämme ja ymmärtää, miten tähän on tultu inflaation ja rahamanipulaation näkökulmasta.

- Kauppiaan ratkaisu: Lopuksi, jos olet enemmän kiinnostunut Bitcoinin todellisesta käytöstä, voit siirtyä opetusosioomme ja tutkia monia kauppiaiden ratkaisuja. Tämä voi tarjota sinulle mahdollisuuksia alallamme, mutta myös auttaa yritystäsi tai ystäviäsi hyväksymään Bitcoinin kaupassaan ja siten luoda paikallisen talouden perustuen Bitcoiniin kaupungissasi!
