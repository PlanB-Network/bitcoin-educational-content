...
- Gå till [GitHub-arkivet för PlanB som är dedikerat till data] (https://github.com/PlanB-Network/Bitcoin-educational-content/tree/dev/resources/builders) i avsnittet `resources/project/`:
