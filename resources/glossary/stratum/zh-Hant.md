...
必須瞭解的是，Stratum 並非 Bitcoin 內的整合規則，而是水池使用的特定軟體。雖然 Mining 水池可以自由不使用它，但 Stratum 已經在十多年前將自己確立為 Bitcoin Mining 的標準。其第二版 Stratum V2 目前正在開發中。其目的是完善 Stratum，並減少後者產生的與 Mining 池相關的集中化問題。