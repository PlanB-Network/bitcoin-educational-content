---
name: Kaart ₿ Academie - Peren App
description: Hoe installeer en gebruik ik de applicatie Plan ₿ Academy op Pears?
---
...
Zoals je waarschijnlijk weet, is Plan ₿ Academy de grootste educatieve database gewijd aan Bitcoin, die cursussen, tutorials en duizenden bronnen samenbrengt die onder een open licentie zijn gepubliceerd. Oorspronkelijk was Plan ₿ Academy een website. Maar wat zou er gebeuren als je er niet langer normaal toegang toe zou hebben, bijvoorbeeld in het geval van censuur?



In deze tutorial leren we hoe we het **Plan ₿ Academy** platform op een echt onmeetbare manier kunnen uitvoeren dankzij **Pears**, een peer-to-peer (P2P) technologie ontwikkeld door **Holepunch** en ondersteund door **Tether**.
...
Het doel van Pears is eenvoudig: het mogelijk maken om webapplicaties te distribueren en te gebruiken zonder afhankelijk te zijn van een gecentraliseerde infrastructuur (geen servers, geen hosts, geen tussenpersonen). Met andere woorden, zelfs als een cloudprovider sluit of een land een domein blokkeert, leeft de toepassing voort onder de peers van het netwerk. Het is deze aanpak die ervoor zorgt dat ons onderwijsplatform Plan ₿ Academy overal ter wereld toegankelijk blijft, zonder dat er één enkel storingspunt is.
...
- Voer de volgende opdracht uit om de toepassing Plan ₿ Academy te starten:
...
### 1.2 - Hoe installeer ik Pears op Linux (Debian)?



Het installeren van Pears op een Debian systeem is relatief eenvoudig, maar vereist wel een paar vereisten, die we in deze sectie in detail zullen uitleggen.



#### 1.2.1. Het systeem bijwerken
...
#### 1.2.2 Afhankelijkheden installeren



Pears vertrouwt op een aantal systeembibliotheken, waaronder `libatomic1`, gebruikt door de Bare JavaScript runtime. Installeer deze met het volgende commando:
...
#### 1.2.3 Node.js en npm installeren via NVM
...
#### 1.2.4 Pears installeren met npm
...
### 1.3 - Hoe installeer ik Pears op Windows?
...
*Als je Linux gebruikt en Pears al hebt geïnstalleerd, kun je direct doorgaan naar stap 2



#### 1.3.1. Open PowerShell in beheerdersmodus
...
#### 1.3.4. Installaties controleren
...
#### 1.3.5. Pears installeren met npm
...
#### 1.3.6. Peren controleren en initialiseren
...
### 1.4. Hoe installeer je Pears op macOS?
...
*Als je Linux of Windows gebruikt en Pears al hebt geïnstalleerd, kun je direct doorgaan naar stap 2



#### 1.4.1. Systeemvereisten controleren
...
#### 1.4.3 Node.js en npm installeren
...
#### 1.4.4 Pears installeren met npm
...
## 2. Hoe gebruik ik Plan ₿ Academy op peren?



Zodra Pears geïnstalleerd en actief is, kun je het **Plan ₿ Academy** platform direct starten via het P2P netwerk. Voer gewoon het volgende commando uit in je terminal (het is hetzelfde commando voor Linux, Windows en macOS):
...
Na het uploaden opent Plan ₿ Academy in uw Pears-omgeving, klaar voor gebruik zoals op de oorspronkelijke website, maar zonder afhankelijkheid van een centrale server.
