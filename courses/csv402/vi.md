...
| Lược đồ cam kết xác định                          | Tiêu chuẩn     | Chi phí trên chuỗi                                                                                                  | Kích thước bằng chứng phía khách hàng                                                                           |
| ------------------------------------------------ | -------------- | ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- |
| Keytweak (P2C xác định)                          | LNPBP-1, 2     | 0 byte                                                                                                            | 33 byte (khóa chưa tinh chỉnh)                                                                                   |
| Sigtweak (S2C xác định)                          | WIP (LNPBP-39) | 0 byte                                                                                                            | 0 byte                                                                                                          |
| Opret (OP_RETURN)                                | -              | 36 (v)byte (TxOut bổ sung)                                                                                        | 0 byte                                                                                                          |
| Thuật toán Tapret: nút trên bên trái             | LNPBP-6        | 32 byte trong witness (8 vbyte) cho bất kỳ multisig n-of-m nào và chi tiêu thông qua đường dẫn script             | 0 byte trên scriptless scripts taproot ~270 byte trong trường hợp một script duy nhất, ~128 byte nếu nhiều script |
| Thuật toán Tapret #4: bất kỳ nút nào + bằng chứng duy nhất | LNPBP-6        | 32 byte trong witness (8 vbyte) đối với các trường hợp script duy nhất, 0 byte trong witness trong hầu hết các trường hợp khác | 0 byte trên scriptless scripts taproot, 65 byte cho đến khi Taptree có một tá script                            |

| Lớp                            | Chi phí on-chain (bytes/vbytes) | Chi phí on-chain (bytes/vbytes) | Chi phí on-chain (bytes/vbytes) | Chi phí on-chain (bytes/vbytes) | Chi phí on-chain (bytes/vbytes) | Chi phí phía khách hàng (bytes) | Chi phí phía khách hàng (bytes) | Chi phí phía khách hàng (bytes) | Chi phí phía khách hàng (bytes) | Chi phí phía khách hàng (bytes) |
| ------------------------------ | ---------------------------- | ---------------------------- | ---------------------------- | ---------------------------- | ---------------------------- | ------------------------ | ------------------------ | ------------------------ | ------------------------ | ------------------------ |
