...
definition: Introdução das carteiras HD (hierárquicas determinísticas) permitindo que todas as chaves de uma carteira sejam geradas a partir de uma única semente.
---
