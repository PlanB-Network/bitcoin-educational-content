...
처음 몇 줄에서, 총 649TH/s를 위해 1323개의 **Bitaxe**가 연결된 **Bitaxe**를 볼 수 있습니다. **Bitaxe**는 **오픈 소스** 프로젝트로, **오픈 소스** 전자 보드에서 **Antminer S19**와 같은 **[ASIC](https://planb.academy/resources/glossary/asic)**의 칩을 간단히 재사용하여 15W의 0.5TH/s의 초소형 Miner을 만들 수 있게 해줍니다. 이 튜토리얼에서 예제로 사용할 Miner입니다.
...
네트워크 [난이도](https://planb.academy/resources/glossary/difficulty)**는 블록을 검증하기 위해 도달해야 하는 난이도를 나타냅니다.
