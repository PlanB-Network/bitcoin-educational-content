...
Acheter des bitcoins sur Flash passe par trois étapes.

Cliquez sur l'option Acheter dans la section d'échanges de bitcoins, sélectionnez votre pays et le réseau mobile à partir duquel vous souhaitez faire votre achat.
...
![process-sell](assets/fr/06.webp)
 ...
 Renseignez vos données et effectuez le paiement de la facture pour valider votre demande. 
...
Dans la section d'accès au service du quotidien, sélectionnez l'option **Achat unité**.
Sélectionnez ensuite le pays, le réseau mobile et le type de service numérique que vous souhaitez payer.

![flashpayment](assets/fr/09.webp)

Renseignez vos informations puis procédez au paiement de la facture générée.
