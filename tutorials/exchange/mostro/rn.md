---
name: Mostro
description: KYC-utagira Bitcoin P2P Exchange urubuga biciye ku Muravyo na Nostr
---
...
**Mostro P2P** itanga uburyo bundi bwo gufatanya Lightning Network, umurongo wa Nostr n’amafagitire yo gufata. Igishasha cayo gikomeye: uburyo bwo gushiramwo amafaranga yawe aho amafaranga yawe aguma ari munsi y’ububasha bwawe mu kiringo cose ca Exchange, bikakuraho ingorane zo kwiba, Exchange gusenyuka canke gufatwa ku bushake.
...
- daemon Mostrod**: ihuza ubuhana hagati y'abakoresha na Lightning Network
...
**Ibanga kubera umugambi**: Uburyo bubiri buraboneka kugira ngo bujane n’ivyo ukeneye. Uburyo bw’Izina** buhuza izina ryawe n’urufunguzo rwawe rwa Nostr kugira ngo wubake ukwizigira kuramba. Uburyo bwihariye bushitse** bukunda kutamenyekana n'imfunguruzo zikoreshwa rimwe gusa.
...
**Uguhindura uko wishura**: Gushigikira amafaranga menshi y’amahera biciye ku nzira y’igiciro ca yadio.io Exchange. Yemera amafaranga yoherezwa na SEPA, PayPal, Revolut, amafaranga, n’uburyo bwose bwemejwe hagati y’ababiri.
...
**Mostro CLI** ni umukiriya akuze kandi akora cane. Yanditswe muri Rust, itanga urutonde rwose rw’ibintu vya Mostro biciye ku murongo w’amabwirizwa wa Interface. Ihuye na macOS, Linux na Windows.
...
- `rekura`: Rekura escrow maze uheze Exchange
- `getdm`: Reba ubutumwa butaziguye
- `rate` : Suzuma umugenzi wawe inyuma y'igikorwa ca Exchange
...
Interface porogaramu y'urubuga rwa JavaScript iteye imbere iriko irategurwa. Igenewe gutanga ubumenyi bushitse bw’abakoresha n’ubudandaji bwinshi n’imikorere yo gucunga ibiharuro. Ushobora gushikako biciye ku mucukumbuzi ata gushiramwo bisabwa.
...
- Ihitamwo ariko ni ngirakamaro**: VPN canke Tor guhuza kugira ngo upfuke IP yawe Address
...
**Intambwe ya 1: Igenzura rya Rust**
...
Gukoranya bifata iminota 1-2. Ivyo `mostro-CLI` bizoshirwa mu `~/.imitwaro/ibitoro/`.
...
Mbere ushiremwo Rust biciye kuri [rustup.rs](https/rustup.rs/), hanyuma ukoreshe PowerShell :
...
**Intambwe ya 1**: Genda kuri [paji y’ibisohoka vya GitHub] (https://github.com/MostroP2P/mobile/ibisohoka) maze ushiremwo dosiye **app-release.apk** (nk’ibilometero 65).
...
### Ubuhinga bwo gucungera umutekano
...
- Amahera make**: Tangura n’amahera ari munsi ya Sats 10.000 kugira ngo utangure
- Ivyuma vyinshi**: Gutegura ivyuma 3-5 bitandukanye mu karere
- Uburinzi bw'urubuga**: Gukoresha VPN canke Tor kugira ngo uhishe IP yawe Address
- Wallet itekanye**: Gukoresha urufunguzo rwikora kuri Wallet yawe umuravyo
...
Iki gice kirerekana ugugura amafaranga y’ama bitcoins biciye kuri Mostro CLI hakurikijwe ikibazo c’ikoreshwa ry’ubuzima nyakuri.
...
Mostro azogusaba gutanga **Umuco Invoice** kugira ngo ubone BTC. Igitigiri nyaco kiri mu masatoshi kizokwerekanwa (aha: 4715 Sats).
...
### Intambwe ya 3: Tanga umuravyo wawe Invoice



generate umuravyo Invoice uva kuri Wallet yawe (Phoenix, Breez, n'ibindi) ku rugero nyarwo, hanyuma uwurungike :
...
Uwo murongo wemeza ko ivyo bintu woherejwe maze ukakumenyesha ko utegerezwa kurindira ko uwugurisha ariha Invoice hold imbere y’uko ukoresha escrow.
...
Igihe escrow imaze gukoreshwa, koresha `dmtouser` kugira usabe amakuru y'ukwishura ku mugurisha:
...
Igihe umaze kwishura, menyesha Mostro :
...
Uwugurisha akimara kwemeza ko yakiriye fiat maze akarekura escrow n’itegeko rya `release`, ubwo nyene uraronka bitcoins zawe ku Lightning Invoice watanze.
...
- Igitabo c'amategeko**: Suzuma amategeko ariho yo kugura (GUGURA BTC) no kugurisha (GURISHA BTC)
...
Kanda buto ya Green **"+"** iri hasi iburyo, hanyuma uhitemwo **GURISHA** (buto itukura).
...
**Ivyigwa bihambaye**: Ubu utegerezwa **kwishura Invoice hold** yerekanwa kugira ngo ufunge amafaranga yawe (aha 4674 Sats ku 1-5 EUR) mu giciro c’amahera. Ufise **iminota 15 n'iyirengeye** ahandi ho Exchange izokurwaho.



Kopa igiharuro ca Invoice maze ukihe ukoresheje umuravyo wawe wa Wallet (Phoenix, Breez, n’ibindi).
...
Uwuguze (aha "anonymous-gloriaZhao") azoguhamagara kugira ngo akusabe amakuru y'ukwishura kwawe. Ndagusavye wishure n'amakuru yawe (Revtag, IBAN, n'ibindi).
...
Uhejeje **kwemeza ko wakiriye** amahera ya fiat kuri konti yawe, kanda buto ya Green **RELEASE** maze wemeze ko wohereje Satss ku muguzi.
...
Bitcoins zica zirungikwa ku muguzi biciye ku muravyo wiwe Invoice.
...
4. Tanga umuravyo wawe Invoice (wavuye muri Wallet yawe)


5. Rindira ko uwugurisha akoresha escrow


6. Baza uwugurisha uciye kuri **CONTACT** kugira ngo umenye ingene wokwishura
...
9. Uronke ama bitcoins ubwo nyene ku muravyo wawe Invoice
...
**Ubusegaba bw’ivy’amahera**: Ama bitcoins yawe ntazokwigera ava mu bubasha bwawe butaziguye kubera uburyo bwo gufata Invoice, bikuraho ingorane zo gusenyuka canke ubusuma bwa Exchange.



**Censor-resistant**: Nta butegetsi bushobora gufunga urubuga canke gucengera amategeko yawe. Ubuhinga burakora igihe cose amarelay ya Nostr ariko arakora.



**Ukumenyekana kwa mbere**: Urufunguzo rwa Nostr rw’izina ry’uruyeri ni rwo rwonyene rukumenya, ata KYC canke amakuru y’ibanga. Ivy’itumanaho bipfutse kuva ku mpera kugeza ku mpera.
...
**Ibisabwa mu vy'ubuhinga**: Gutahura ivy'ishimikiro ku bijanye n'umuravyo na Nostr birakenewe.
