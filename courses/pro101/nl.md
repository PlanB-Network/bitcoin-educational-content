...
Het doel van de cursus is om deelnemers uit te rusten met een diepgaand begrip van de onderliggende principes van Bitcoin, praktische ontwikkelingsvaardigheden en het vermogen om effectief te navigeren en bij te dragen aan het Bitcoin ecosysteem. Door een mix van theoretische kennis en praktische oefeningen zullen studenten de essentie van Bitcoin beveiliging, de fijne kneepjes van de softwarestack en de mechanismen van het bestuur onder de knie krijgen.


### Voorwaarde


Van deelnemers wordt verwacht dat ze nieuwsgierig zijn, graag willen leren op professioneel niveau en enige basiskennis hebben van ontwikkeling. Hoewel een gedetailleerde achtergrond in Bitcoin niet vereist is, zijn een basiskennis van coderingsprincipes en een open houding tegenover complexe technische concepten essentieel om het meeste uit de versneller te halen.


#### Gereedschap


Tijdens de cursus zullen deelnemers gebruik maken van belangrijke hulpmiddelen die hun begrip en leerervaring zullen verbeteren. Het gebruik van Linux, de Interface commandoregel, GitHub en Docker zullen integraal zijn in het bieden van een hands-on benadering van Bitcoin ontwikkeling. Deze tools zullen het werken met de Bitcoin software stack, het beheren van ontwikkelomgevingen en het samenwerken aan projecten in een real-world omgeving vergemakkelijken.
...
De beslissing van El Salvador om Bitcoin als wettig betaalmiddel in te voeren, toont het transformatieve potentieel ervan aan. Door Bitcoin te gebruiken wil het land buitenlandse investeringen aantrekken en financiële stabiliteit bevorderen. Projecten zoals **Bitcoin Beach** laten zien hoe lokale economieën kunnen groeien door Bitcoin te gebruiken als een middel voor Exchange.


De wereldwijde invoering van Bitcoin stuit echter op obstakels zoals onwetendheid, weerstand tegen nieuwe technologieën en uitdagingen op het gebied van infrastructuur. De weg naar een meer inclusief financieel systeem - waarbij Bitcoin kan helpen om ontwikkelingslanden te verheffen - is lang maar veelbelovend. De gedecentraliseerde en open-source aard van Bitcoin biedt hoop op een toekomst waarin financiële eerlijkheid voor iedereen beschikbaar is.


#### Conclusie


Samengevat houdt Bitcoin een immense belofte in voor financiële empowerment en inclusie, maar er liggen belangrijke uitdagingen in het verschiet. Betrokken blijven bij de Bitcoin gemeenschap, leren en vragen stellen zal de sleutel zijn tot het realiseren van een gedecentraliseerde financiële toekomst. Door samenwerking en belangenbehartiging kan de visie van een eerlijker financieel systeem voor iedereen werkelijkheid worden.


### Cypherpunk beweging en Oostenrijkse economie
...
De fundamenten van Bitcoin in de **Cypherpunk beweging** en **Oostenrijkse Economie** maken het een unieke en revolutionaire vorm van geld. Inzicht in deze principes helpt te begrijpen waarom Bitcoin werd gecreëerd en hoe het vandaag de dag werkt. Voor verdere lectuur, overweeg **De Bitcoin Standaard** door **Saifedean Ammous**.


Bedankt voor je betrokkenheid bij dit materiaal!
...
De structuur en voortdurende evolutie van Bitcoin tonen de innovatie en het aanpassingsvermogen van haar technologie. Van **Hashcash** naar een gedecentraliseerd Blockchain, en van **SegWit** naar **Taproot**, Bitcoin blijft Address uitdagingen aangaan met betrekking tot schaalbaarheid, privacy en veiligheid. De voortdurende inspanningen van de gemeenschap zorgen ervoor dat Bitcoin veerkrachtig en gedecentraliseerd blijft, terwijl het evolueert om aan de eisen van de toekomst te voldoen.
...
Bitcoin wordt vaak bekritiseerd omdat het gebruikt wordt voor criminele activiteiten. Analyse van Blockchain laat echter zien dat slechts een klein percentage van de Bitcoin transacties verband houdt met criminaliteit. In werkelijkheid worden traditionele financiële systemen veel meer gebruikt voor criminele activiteiten dan Bitcoin.
...
FUD rond Bitcoin overdrijft vaak zorgen over de impact op het milieu, crimineel gebruik en veiligheid. Hoewel de markt zal fluctueren, biedt de gedecentraliseerde en solide technologie van Bitcoin een solide basis voor stabiliteit en financiële vrijheid op de lange termijn, vooral in beperkende omgevingen zoals Venezuela.


#### Conclusie


Inzicht in de realiteit van Bitcoin's energieverbruik, privacykenmerken en rol in misdaadpreventie helpt de mythes eromheen te verdrijven. Door door de FUD heen te prikken, kunnen we het potentieel van Bitcoin waarderen als een revolutionaire vorm van gezond geld dat privacy, veiligheid en decentralisatie bevordert.
...
Dit zijn enkele van de basiscommando's bij het configureren van je node:
...
**Installeer de binary en configureer auto-start met systemd**

Installeer vervolgens de binary en stel deze in om automatisch te starten met systemd.
...
**C-Lightning overzicht**


C-Lightning, ook bekend als Core-Lightning, is een Layer 2 protocol dat snellere en goedkopere transacties mogelijk maakt door gebruik te maken van off-chain kanalen. Het onderscheidt zich door zijn modulaire en ontwikkelaarvriendelijke architectuur, die uitgebreide aanpassingen door middel van plugins mogelijk maakt.


**Belang van modulariteit en uitbreidbaarheid met plugins**

Het modulaire ontwerp van C-Lightning betekent dat u naar behoefte functies kunt toevoegen of verwijderen, zodat u het systeem kunt aanpassen aan specifieke gebruikssituaties. Voorbeelden van toepassingen zijn:
...
Laten we verder gaan met het installeren van C-Lightning.


**Gebruik de laatste stabiele release**

Voor deze lezing gebruiken we de laatste stabiele release, bijvoorbeeld 22.11.1.
...
**Verifieer integriteit met GPG-sleutels**

Controleer altijd de integriteit van het gedownloade bestand met GPG-sleutels.
...
**Afhankelijkheden installeren en compileren vanaf broncode**

Installeer de benodigde afhankelijkheden en compileer C-Lightning vanaf de broncode.
...
**Configureer de systemd service voor automatisch starten**

Maak een systemd servicebestand voor C-Lightning:
...
**Maak de benodigde mappen en configuratiebestanden**

Creëer mappen en configuratiebestanden die nodig zijn voor C-Lightning.
...
**Zorg voor compatibiliteit en synchronisatie**

Start de services en zorg ervoor dat ze compatibel en gesynchroniseerd zijn.
...
Voeg het volgende toe voor Tor-integratie:
...
**Back-up HSM-geheim voor fondsherstel**

Maak een back-up van het HSM-geheim voor fondsherstel.
...
**Test verbindingen en valideer de operationele status van het knooppunt**

Valideer ten slotte de operationele status van je knooppunt door verbindingen te testen en ervoor te zorgen dat alles werkt zoals verwacht.
...
Welkom bij onze lezing over beveiliging en apparaatinstelling voor Bitcoin. Vandaag ligt de nadruk op het begrijpen van het gebruik van beveiligingstools, in het bijzonder de Specter desktop Wallet en Ledger Hardware Wallet, en hoe deze effectief te configureren voor verbeterde Bitcoin beveiliging.
...
**Downloaden en instellen van Specter**
...
Na het instellen van de Wallet is het ontvangen van transacties net zo eenvoudig als het delen van uw Wallet Address. Specter biedt realtime monitoring van binnenkomende transacties, zodat u altijd op de hoogte bent van de status van uw Wallet.
...
Om de privacy te versterken, wordt het sterk aangeraden om Specter te configureren om Tor te gebruiken. Tor anonimiseert je netwerkverkeer en beschermt je IP Address tegen mogelijke bewaking. Dit is vooral belangrijk voor gebruikers die zich zorgen maken over privacy en veiligheid.


**Veilig verbinding maken met externe knooppunten**


Wanneer je verbinding maakt met externe knooppunten, zorg er dan voor dat de verbinding beveiligd is. Dit omvat het gebruik van SSL/TLS certificaten en het verifiëren van de authenticiteit van het knooppunt. Veilige verbindingen voorkomen man-in-the-middle aanvallen en garanderen de integriteit van gegevens.
...
De volgende stappen zijn de integratie van Specter met de Lightning Network. Dit maakt het mogelijk om geld van Specter naar een Lightning-node te sturen, wat snellere en goedkopere transacties mogelijk maakt. Toekomstige lessen zullen deze integratie in detail behandelen, en uw Bitcoin transactiemogelijkheden uitbreiden.
...
Het installeren van nodes, lokaal of op afstand, profiteert van het gebruik van Tor voor verbeterde beveiliging. Het draaien van je eigen node zorgt voor persoonlijke transactie validatie, wat de veiligheid en privacy verbetert.


**Filosofie: zelfredzaamheid in leren**


Omarm een filosofie van zelfredzaamheid. Praktische vaardigheden en zelfstudie staan voorop en overtreffen vaak de voordelen van formeel onderwijs. Doe mee aan praktijkoefeningen om uw begrip van Bitcoin beveiliging te verdiepen.
...
Het beveiligen van Bitcoin activa is een complexe taak, vol uitdagingen. Hot wallets, die vaak gebruikt worden voor alledaagse transacties, vormen aanzienlijke veiligheidsrisico's, vooral voor degenen die Lightning nodes beheren. Daarnaast blijft het plannen van de erfenis van Bitcoin activa een ingewikkeld en vaak onveilig proces. De complexiteit van deze veiligheidsmaatregelen kan potentiële gebruikers afschrikken en een wijdverspreide adoptie bemoeilijken.
...
### Inleiding tot beveiligingsdenken


Beveiligingsdenken is gebaseerd op principes die ontworpen zijn om systemen te beschermen tegen opzettelijke aanvallen. Het gaat om het identificeren van potentiële bedreigingen en het implementeren van maatregelen om deze te beperken. Betrouwbaarheid daarentegen richt zich op het garanderen dat systemen correct functioneren onder gespecificeerde omstandigheden, waarbij rekening wordt gehouden met probabilistische storingen in plaats van opzettelijke pogingen om de beveiliging te doorbreken.


#### Relatie tussen veiligheid en betrouwbaarheid


Hoewel zowel beveiliging als betrouwbaarheid tot doel hebben om de integriteit van een systeem te behouden, verschillen hun benaderingen aanzienlijk. Betrouwbaarheidstechniek houdt zich bezig met de waarschijnlijkheid van systeemstoringen als gevolg van willekeurige gebeurtenissen en maakt vaak gebruik van statistische methoden om deze storingen te voorspellen en te beperken. Aan de andere kant moet beveiliging rekening houden met de opzettelijke en intelligente aard van aanvallen, waarvoor een meerlaagse verdedigingsstrategie nodig is die bekend staat als "verdediging in de diepte"


#### Veiligheid versus betrouwbaarheid
...
Overweeg het proces van het aanmaken en opslaan van Bitcoin sleutels met behulp van papieren portemonnees. Hoewel papieren portemonnees veilig kunnen zijn, zijn ze gevoelig voor fysieke schade en manipulatie. Om de integriteit van zulke portemonnees te waarborgen zijn manipulatiebeveiligde methoden en robuuste verificatieprotocollen nodig.


Stel je in een ander scenario een pick-up op een vliegveld voor waarbij de chauffeur een geheime code gebruikt om de passagier te verifiëren. Deze eenvoudige maar effectieve beveiligingsmaatregel voorkomt dat bedriegers beide partijen misleiden.
...
Bedreigingsmodellering is het proces van het identificeren van potentiële beveiligingsbedreigingen en het creëren van strategieën om deze te beperken. Dit omvat het begrijpen van de systeemomgeving, het identificeren van mogelijke aanvallers en het ontwikkelen van veilige protocollen op basis van aannames en probabilistische analyse.


#### Veilige protocollen maken


Om verkiezingen veilig te stellen, kan bijvoorbeeld onpartijdig toezicht of partijoverschrijdend toezicht worden geïmplementeerd om transparantie en integriteit te waarborgen. Cryptografische methoden, zoals tijdstempeling en kruiselingse verificatie, helpen bij het handhaven van de authenticiteit van gegevens en het voorkomen van geknoei.
...
Vertrouwen opbouwen gaat niet onmiddellijk; het vereist het koppelen van meerdere vertrouwenspaden en zorgen voor redundantie. Het gebruik van HTTPS en Blockchain-ondersteunde certificaattransparantie, bijvoorbeeld, verzekert de authenticiteit van webbronnen, waardoor het voor aanvallers moeilijk wordt om het vertrouwen te schenden.
...
Strategieën voor het beveiligen van Bitcoin wallets omvatten multi-handtekening setups en gediversifieerde opslag. Deze methodes zorgen ervoor dat zelfs als één component gecompromitteerd wordt, de algehele beveiliging intact blijft.


#### Belang van validatie


Tot slot is gebruikersvalidatie van cruciaal belang voor het behoud van een veilig netwerk. De rol van elke gebruiker bij het valideren van transacties en het verifiëren van software- en hardwarecomponenten helpt de integriteit van het netwerk te behouden en potentiële bedreigingen te verijdelen.


Concluderend kunnen we stellen dat het begrijpen en integreren van beveiligings- en betrouwbaarheidsprincipes essentieel is bij het ontwerpen van robuuste systemen. Door te leren van historische voorbeelden, strategieën uit de echte wereld toe te passen en vertrouwen voortdurend te valideren, kunnen we systemen bouwen die zowel veilig als betrouwbaar zijn.
...
### Aard en belang van software


Software is in essentie een verzameling code en gegevens die computers instrueert hoe ze specifieke taken moeten uitvoeren. In tegenstelling tot hardware, waarvoor fysieke materialen en productieprocessen nodig zijn om te repliceren, kan software eenvoudig worden gekopieerd en gedistribueerd tegen vrijwel geen kosten. Dit fundamentele verschil speelt een cruciale rol in de verspreiding en ontwikkeling van software.


Een van de belangrijkste verschillen tussen software en hardware is het concept van open-source. Hoewel open-source hardware bestaat, is het niet zo wijdverbreid vanwege de complexiteit van het dupliceren van fysieke objecten. Daarentegen gedijt open-source software goed vanwege het gemak van replicatie en distributie. Met openbronsoftware kan iedereen de code bekijken, wijzigen en verspreiden, wat een samenwerkingsomgeving bevordert die innovatie en probleemoplossing versnelt.


Het wettelijke kader voor software draait voornamelijk rond auteursrechtwetten. Deze wetten verlenen de maker van de software exclusieve rechten om zijn werk te gebruiken, aan te passen en te verspreiden. Open source licenties bieden echter een mechanisme om deze rechten te delen met het publiek, onder specifieke voorwaarden. Deze juridische structuur is essentieel om de dynamiek van softwaredistributie en -aanpassing te begrijpen.


Samengevat onderstreept de aard van software als gemakkelijk repliceerbare code en gegevens, in combinatie met de juridische mechanismen van open source licenties, het cruciale belang ervan in het moderne digitale landschap. Dit kader stimuleert niet alleen innovatie, maar zorgt er ook voor dat software vrijelijk kan worden gedeeld en verbeterd door de wereldwijde gemeenschap.


### Geschiedenis van de Vrije Softwarebeweging


De Free Software Movement vindt zijn oorsprong in het begin van de jaren 1980, voornamelijk gedreven door Richard Stallmans visie op softwarevrijheid. Gefrustreerd door de beperkende aard van propriëtaire software begon Stallman aan een missie om software te maken die gebruikers vrij konden gebruiken, wijzigen en delen. Dit leidde tot de oprichting van de Free Software Foundation (FSF) in 1985.
...
**Elliptische krommen in cryptografie**: Key tweaking en veiligheid zijn belangrijke onderwerpen, zoals het aanpassen van een publieke sleutel met behulp van een extra private sleutel terwijl de veiligheid gewaarborgd blijft. De specifieke elliptische curve van Bitcoin, SECP256K1, en zijn parameters (P en N) zijn fundamenteel voor de implementatie.
...
Verschillende voorbeelden uit de praktijk illustreren het bestuur van Bitcoin in actie. De overflow bug fix in 2010 was een Soft Fork die een kritieke fout aanpakte. Het probleem van het jaar 2106 vereist waarschijnlijk een Hard Fork om de implicaties ervan Address te maken. De overgang van de langste keten naar de keten met het meeste werk weerspiegelt een belangrijke bestuursbeslissing die invloed had op de manier waarop consensus wordt bereikt.


Het bestuur van Bitcoin richt zich ook op echte veranderingen in het gebruik van het protocol. De introductie van ordinalen en inscripties illustreert bijvoorbeeld hoe protocolwijzigingen kunnen falen om transacties te censureren. Op dezelfde manier veranderde de implementatie van Volledig RBF (Replace-by-fee) de transactievervangingsprocedures zonder de consensusregels te veranderen.
...
De spreker richt zich op het zakelijke aspect van Bitcoin Mining en onderzoekt strategieën om winstgevend te blijven in een concurrerende markt. De discussie omvat een analyse van operationele kosten, efficiëntiemaatregelen en de economische drijfveren van de Mining industrie.
...
3. **Privacy en controle**: Het runnen van je eigen node zorgt ervoor dat je niet afhankelijk bent van externe nodes, die je privacy in gevaar kunnen brengen door je transacties en Wallet balans te volgen.


### Wat doet een Bitcoin knooppunt?
...
De munten worden niet opgeslagen in adressen; ze bevinden zich in UTXO's, die alle uitgangen van transacties vertegenwoordigen die niet zijn uitgegeven. Je kunt deze informatie opvragen met de opdracht:
...
#### Voor elke UTXO heeft Chainstate:



- txid.
- Uitvoerindex.
- In welk blok de UTXO zit.
- Of het nu een coinbase UTXO is.
...
Het is een lijst van onbevestigde transacties in elk knooppunt, die kandidaat-transacties worden genoemd. Het wordt opgeslagen in RAM voor snelle toegang en maakt geen deel uit van de consensus.
...
Vertrouwen op één enkele bron voor Blockchain gegevens, zoals het downloaden van alle blokken van een centrale server, brengt aanzienlijke risico's met zich mee. Om het gedecentraliseerde karakter van Bitcoin te behouden, moeten knooppunten verbinding maken met meerdere peers en de gegevens die ze ontvangen valideren.


#### Isolatieaanvallen voorkomen


Isolatieaanvallen treden op wanneer een knooppunt wordt misleid om verbinding te maken met een beperkte verzameling van peers, waardoor een aanvaller het onjuiste gegevens kan geven. Door verbinding te maken met een diverse verzameling van peers en de ontvangen gegevens te verifiëren, kunnen knooppunten zichzelf tegen deze aanvallen beschermen.


#### Peer-verbindingen beheren


Knooppunten moeten hun peerverbindingen zorgvuldig beheren om er zeker van te zijn dat ze geen verbinding maken met kwaadwillende actoren. Dit omvat het bijhouden van een lijst met geblokkeerde peers die verdacht gedrag hebben vertoond en het regelmatig bijwerken van de peer-lijst om te voorkomen dat je afhankelijk bent van een kleine groep nodes.


#### Belang van de UTXO set


De UTXO set geeft de huidige status van Bitcoin weer, met alle niet uitgegeven transactie-uitgangen. Deze set is cruciaal voor het valideren van transacties en om ervoor te zorgen dat munten niet meer dan één keer worden uitgegeven. Het is belangrijk om deze set klein en gemakkelijk toegankelijk te houden om de efficiëntie van het netwerk te behouden.
...
### Bitcoin-blokken en transacties in Rust parseren


#### Componenten om te ontleden


Om een Bitcoin blok te ontleden, moet je je richten op de volgende onderdelen:


1. **Blokkop**

2. **Transacties binnen het blok**

3. **Transactie-ingangen en -uitgangen**


#### Structuur blokkop


De block header is de hoeksteen van een Bitcoin blok en bevat de volgende velden:
...
Om ons voorbeeld beheersbaar te houden:
...
Elke transactie in een Bitcoin blok bevat het volgende:
...
In Rust kunnen we verschillende technieken gebruiken om deze structuren te ontleden:



- Gebruik `from_le_bytes` voor het lezen van Little Endian gegevens.
- Implementeer een aangepaste `parse` eigenschap om de parsinglogica voor verschillende structuren af te handelen.
...
- Generiek parsen implementeren voor lijsten en specifieke typen zoals `VarInt`, `U32`, `U64`, etc.
...
Om ervoor te zorgen dat onze parser correct werkt:



- Vergelijk de geparseerde gegevens met bekende blokgegevens (bijvoorbeeld van Mempool.space).
- Valideer dat de geparseerde transactietellingen en blokgegevens overeenkomen met de verwachte waarden.


### Omgaan met speciale gevallen en script parsing


#### Implementatie van de functie 'parse


We zullen de `parse` functie implementeren om het volledige blok te verwerken, inclusief de koptekst van het blok en de transacties. Dit houdt in het lezen van de blokgegevens en het extraheren van de relevante velden.
...
#### Modificatie van de blokkop


We moeten onze parseringlogica aanpassen om de transactietelling uit de blokkopstructuur te verwijderen en het als een aparte entiteit te behandelen.
...
Definieer een nieuwe structuur `Blok` die zowel de koptekst van het blok als een lijst met transacties bevat.
...
Asserties toevoegen om te controleren dat er geen bytes onverteerd achterblijven na het verwerken van een volledig blok. Dit verzekert de integriteit van ons parseerproces.
...
#### Script parsing strategie


Om het script in transacties te parsen, zullen we ons richten op veelvoorkomende opcodes zoals `OP_CHECKSIG`, `OP_HASH160` en `OP_PUSH`. Het parsen van deze scripts is cruciaal voor het valideren van transacties en het afhandelen van fouten.
...
Script-parsing kan uitdagingen opleveren, vooral met coinbase-transacties. Het is belangrijk om rekening te houden met edge cases en deze correct af te handelen om een nauwkeurige parsing te garanderen.
...
#### Efficiëntie in Mining


Mining lege blokken kunnen efficiënter zijn voor mijnwerkers:



- Mijnwerkers beginnen Mining met lege blokken om tijd te besparen.
- Lege blokken kunnen snel worden gedolven voordat wordt overgeschakeld naar een volledig blok zodra het vorige blok is bevestigd.
...
Hoewel kwaadwillende Mining van lege blokken mogelijk is, is dit niet waargenomen. De primaire reden voor lege blokken is de timingbeperking en niet kwaadwillende opzet.
...
- De codebase compileren om een uitvoerbare versie te maken. [Bitcoin github](https://github.com/Bitcoin/Bitcoin) toegang tot doc/build-\*.md voor instructies.
...
- Testen om er zeker van te zijn dat alles goed werkt. Instructies kunnen [hier] worden gevonden (https://github.com/Bitcoin/Bitcoin/blob/master/test/README.md)
...
#### Basisfuncties van een Bitcoin Wallet
...
Aangezien alle Bitcoin wallets vergelijkbare functies delen, is het herhaaldelijk herschrijven van Wallet logica inefficiënt. Dit is waar de Bitcoin Development Kit (BDK) om de hoek komt kijken.


### Bitcoin Ontwikkelingskit (BDK) en technische concepten


De Bitcoin Development Kit (BDK) is een bibliotheek die is ontworpen om het maken en beheren van Bitcoin wallets te vereenvoudigen.


#### Overzicht van BDK


BDK vereenvoudigt het maken van Wallet door functionaliteit op een hoger niveau te bieden, gebouwd bovenop Rust Bitcoin. Het ondersteunt meerdere programmeertalen via bindingen, waaronder Kotlin, Swift en Python.


#### Andere Bitcoin-bibliotheken


Talrijke Bitcoin bibliotheken zijn geschikt voor verschillende programmeertalen, zoals Python, JavaScript, Java, Go en C. Deze bibliotheken bieden diverse hulpmiddelen voor Bitcoin ontwikkeling.
...
#### Transacties aanmaken en beheren


BDK stroomlijnt het proces van het opbouwen, ondertekenen en uitzenden van transacties:


1. **Bouw transacties**: Geef ontvangers, bedragen en kosten op.

2. **Teken transacties**: Gebruik PSBT om handtekeningen te verzamelen.

3. **Transacties verzenden**: Verzend afgeronde transacties naar het netwerk.


#### Voorbeeld workflow in BDK
...
Bij het ontwikkelen van Bitcoin projecten wordt vaak de voorkeur gegeven aan Rust vanwege de veiligheid en efficiëntie. De taalkeuze kan echter variëren op basis van specifieke projecteisen en expertise van de ontwikkelaar.
...
Welkom bij onze lezing over moderne betaaloplossingen binnen de Blockchain technologie. Vandaag verkennen we de historische context en de belangrijkste ontwikkelingen van multi-hop sloten (MHL's) en de Lightning Network.


#### Overzicht en historische context


Multi-hop locks (MHL's) en de Lightning Network zijn geavanceerde concepten in de Blockchain technologie die efficiënte en veilige microbetalingen over het netwerk mogelijk maken. Historisch gezien is de behoefte aan deze innovaties ontstaan door de inefficiënties en beperkingen die werden waargenomen bij de eerste toepassing van Blockchain technologieën, in het bijzonder Bitcoin. Naarmate we dieper ingaan, zult u begrijpen hoe onderwerp-gebaseerde structuren en gelaagde benaderingen een revolutie teweeg hebben gebracht in Blockchain transacties.


### Op thema gebaseerde structuur


De introductie van MHL's en de Lightning Network betekent een paradigmaverschuiving van traditionele, lineaire Blockchain transacties naar meer geavanceerde, gelaagde systemen. Door transacties onder te verdelen in specifieke onderwerpen of segmenten, maken deze innovaties een meer schaalbare en veilige betalingsinfrastructuur mogelijk die veel van de inherente problemen in vroege Blockchain implementaties aanpakt.
...
Concluderend: inzicht in de historische context en uitdagingen van Bitcoin, en de innovatieve oplossingen die worden voorgesteld via MHL's, Lightning Network en betalingskanalen, geeft een uitgebreid beeld van het huidige landschap en het toekomstig potentieel van de Blockchain technologie.
...
Om Address te maken van deze beperkingen, stelde Manny Rosenfeld in 2012 het concept van gecentraliseerde hops voor. Dit model introduceerde gecentraliseerde betalingsverwerkers, zoals TrustPay, om betalingen tussen gebruikers te routeren. Hoewel deze methode de noodzaak voor meerdere directe kanalen kan verminderen, introduceert het belangrijke nadelen. Gecentraliseerde hops hebben te kampen met veiligheidsproblemen, vertrouwensproblemen, privacyschendingen, de mogelijkheid van oplichting, censuur en betrouwbaarheidsproblemen. Gebruikers moeten deze gecentraliseerde entiteiten vertrouwen om hun transacties te faciliteren, wat in strijd is met het decentralisatie-ethos.
...
In een praktisch scenario houdt de betalingsstroom van Alice in dat Eric betaald wordt via meerdere tussenpersonen, zoals Bob, Carol en Diana. Elke deelnemer in deze keten is verantwoordelijk voor het opnemen van geld van de voorgaande deelnemer.
...
Tussenpersonen zoals Diana en Carol worden gestimuleerd om correct te handelen binnen het netwerk. Als ze dat niet doen, hebben de gevolgen meestal alleen gevolgen voor de tussenpersoon zelf, waardoor verantwoordelijk gedrag wordt gestimuleerd.


### Praktische overwegingen


Meer hops in de betalingsroute kunnen echter de latentie, de kosten en de potentiële onbetrouwbaarheid verhogen. Het openen van meerdere kanalen kan helpen om het aantal hops dat nodig is voor de routering te verminderen, waardoor de algehele efficiëntie toeneemt.


#### Kanaalgrafiek en liquiditeit


Knooppunten binnen het netwerk kunnen ofwel deel uitmaken van een publiek aangekondigde kanaalgrafiek of onaangekondigd blijven. De liquiditeit van deze kanalen speelt een cruciale rol in effectieve routering, omdat knooppunten voldoende saldo nodig hebben om betalingen succesvol door te sturen.


#### Bronroutering en privacy
...
Samengevat zorgt een goede werking van de knooppunten voor atomaire betalingen, en de Lightning Network probeert Address veel problemen op te lossen waar traditionele betalingssystemen zoals Ripple mee te maken hebben. Door gebruik te maken van HTLC's en strategische routering biedt de Lightning Network een meer schaalbare, efficiënte en veilige oplossing voor gedecentraliseerde betalingen.
...
HTLC's spelen een centrale rol in de betalingsroutering van het netwerk en maken veilige transacties zonder vertrouwen mogelijk. Commitment- en intrekkingsberichten zorgen voor wederzijdse overeenstemming over de toestand van het kanaal en voorkomen fraude.
...
Kanalen kunnen worden gesloten door wederzijdse overeenstemming, eenzijdige actie of straf als valsspelen wordt ontdekt. Een juiste sluiting rondt transacties veilig af.


#### Swaps voor liquiditeitsbeheer


Swaps maken On-Chain opnames en efficiënt liquiditeitsbeheer mogelijk zonder kanalen te sluiten. Toekomstige oplossingen zoals splicing worden ontwikkeld om dit proces te verbeteren.


#### Veiligheidsmaatregelen


Commitment transacties bevatten mechanismen zoals nLockTime, OPCheckSequenceVerify en revocation keys om fondsen te beveiligen en diefstal te voorkomen.
...
Handshake-procedures en versleuteling (Chacha20) met authenticatie (Poly1305) zorgen voor berichtintegriteit en privacy in Lightning-transacties.
...
De belangrijkste Bolt 7 berichten zijn:
...
Het proces begint met lokale peers die identiteits- en kanaalgegevens uitwisselen. Na het verifiëren van handtekeningen en het financieren van transacties, kondigen ze het kanaal aan bij hun netwerkgenoten, zodat het hele netwerk op de hoogte blijft van de meest recente topologieveranderingen.
...
Knooppunten kunnen hun ondersteunde functies uitzenden, waardoor achterwaartse compatibiliteit wordt gegarandeerd terwijl optionele uitbreidingen mogelijk zijn. Deze flexibiliteit zorgt ervoor dat alle nodes vlot kunnen samenwerken, zelfs als het protocol evolueert.


#### Bolt11 facturen afhandelen


Het netwerk zorgt voor de uniciteit van Bolt 11 facturen om meerdere betalingen voor dezelfde Invoice te voorkomen. Als een Invoice wordt hergebruikt, onderscheppen netwerkknooppunten dubbele betalingen en voorkomen ze deze, waardoor de transactie-integriteit behouden blijft.


#### Spraak Gegevensoverdracht


Hoewel het mogelijk is, wordt het verzenden van spraakgegevens via de Lightning Network zwaar gecomprimeerd en beperkt door de grootte van het bericht. Een voorbeeldtoepassing is Sphinx, dat het innovatieve gebruik van Lightning voor datatransmissie onderzoekt.
...
- Dit is de hoeveelheid Bitcoin die een gebruiker kan versturen vanuit zijn Lightning-kanalen. Het is cruciaal voor het initiëren van betalingen en om ervoor te zorgen dat transacties kunnen worden gerouteerd naar de ontvanger.


#### Externe (inkomende) liquiditeit:



- Dit is de hoeveelheid Bitcoin die een gebruiker kan ontvangen via zijn kanalen. Het is net zo belangrijk, omdat het ervoor zorgt dat anderen betalingen naar de gebruiker kunnen sturen.
...
#### Uitdagingen in de Lightning Network:
...
### Verschillende portemonnees en hun functies


Er zijn verschillende Lightning wallets beschikbaar, die elk voldoen aan verschillende gebruikersbehoeften en -voorkeuren. Hier zijn enkele voorbeelden:
...
Portemonnees kunnen worden ingedeeld op basis van wie de privésleutels bezit en wie de liquiditeit beheert. Deze matrix helpt gebruikers bij het kiezen van wallets die aansluiten bij hun voorkeuren voor veiligheid en gemak:
...
Ondanks hun voordelen hebben Lightning wallets te maken met verschillende punten van kritiek en gebieden die voor verbetering vatbaar zijn:
...
#### Algoritme uitdagingen:


De huidige algoritmen voor het vinden van het optimale pad binnen de Lightning Network zijn vaak suboptimaal, met vallen en opstaan. Er zijn verbeteringen nodig om de efficiëntie van de routering te verbeteren.


#### Meerpartijenbetalingen:


Het opsplitsen van grotere betalingen in kleinere transacties kan liquiditeits- en padvindproblemen verlichten, waardoor transacties soepeler verlopen.


#### Inkomsten uit routing:


De inkomsten uit routeringsvergoedingen zijn meestal minimaal, waardoor het voor individuele gebruikers minder aantrekkelijk is om routeringsknooppunten met winst te beheren.


#### Diverse Wallet voorbeelden:
...
Verschillende portemonnees dienen verschillende doelen, van gebruiksgemak voor beginners tot geavanceerde functies voor power users. Er is niet één "beste" Wallet; de keuze hangt af van individuele behoeften en voorkeuren.


#### Open source bijdrage:


Feedback van gebruikers en bijdragen aan open-source projecten zijn van onschatbare waarde voor ontwikkeling en persoonlijke vaardigheidsgroei en bevorderen een collaboratieve en innovatieve omgeving.


Concluderend, het begrijpen van de verschillende aspecten van Lightning Network klanten, hun verschillen met traditionele Bitcoin wallets en het belang van effectief liquiditeitsbeheer is cruciaal voor het benutten van het volledige potentieel van de Lightning Network. Door de juiste Wallet te kiezen en actief deel te nemen aan het ecosysteem, kunnen gebruikers hun Bitcoin transactie-ervaring aanzienlijk verbeteren.
...
In deze sessie gaat Asi0 in op de praktische uitdagingen bij het werken met de Lightning Network (LN). Ondanks de revolutionaire benadering van het schalen van Bitcoin transacties, biedt de Lightning Network verschillende praktische uitdagingen waar zowel gebruikers als ontwikkelaars doorheen moeten navigeren. We zullen in het bijzonder vier belangrijke uitdagingen onderzoeken: **liquiditeitsbeheer**, **Layer 1/Layer 2 abstractie**, **offline betalingen ontvangen**, en **back-up beheer**.


Elk van deze uitdagingen wordt bekeken vanuit twee perspectieven: de **gebruiker** en de **ontwikkelaar**, omdat de uitdagingen en oplossingen verschillen afhankelijk van de rol die je speelt in het ecosysteem.


---

### Uitdaging 1: liquiditeitsbeheer


#### **Vanuit het perspectief van de gebruiker:**


In de Lightning Network verwijst **liquiditeit** naar de beschikbaarheid van fondsen in betalingskanalen die nodig zijn om betalingen te doen of te ontvangen. Gebruikers moeten ervoor zorgen dat ze voldoende inkomende en uitgaande liquiditeit hebben voor succesvolle transacties. Als je bijvoorbeeld betalingen wilt ontvangen, moet je inkomende liquiditeit beschikbaar hebben, wat betekent dat een ander knooppunt een deel van zijn saldo moet toewijzen aan jouw kanaal. Op dezelfde manier, als je betalingen wilt versturen, heb je uitgaande liquiditeit in je kanaal nodig.
...
Ontwikkelaars staan voor de uitdaging om naadloos liquiditeitsbeheer te implementeren in applicaties. Ze moeten tools ontwikkelen die rebalancing automatiseren en wrijving voor gebruikers verminderen, terwijl ze tegelijkertijd de vergoedingen optimaliseren en liquiditeitsknelpunten vermijden.
...
Het is de taak van ontwikkelaars om de complexiteit van L1 en L2 voor gebruikers te abstraheren en soepele en intuïtieve interfaces te creëren die transacties efficiënt afhandelen. De uitdaging is om de gebruikerservaring te optimaliseren met behoud van de integriteit en veiligheid van het Lightning-protocol.
...
### Uitdaging 3: offline betalingen ontvangen


#### **Vanuit het perspectief van de gebruiker:**


Een van de uitdagingen in de Lightning Network is **betalingen ontvangen wanneer de gebruiker offline is**. In tegenstelling tot de Bitcoin's basis Layer, waar transacties op elk moment ontvangen kunnen worden, vereist Lightning dat zowel de betaler als de begunstigde online zijn om een transactie te voltooien. Dit is een belangrijke beperking voor veel gebruikers die Lightning-betalingen in alledaagse situaties willen gebruiken.
...
Ontwikkelaars onderzoeken manieren om gebruikers in staat te stellen Lightning-betalingen te ontvangen, zelfs als hun nodes offline zijn. Dit vereist creatieve oplossingen om het gedecentraliseerde karakter van Lightning te behouden en tegelijkertijd het praktische probleem van het constant verbonden zijn aan te pakken.
...
Ontwikkelaars moeten back-upoplossingen implementeren waarmee gebruikers hun fondsen veilig en betrouwbaar kunnen herstellen, zelfs na catastrofale storingen. De uitdaging is om ervoor te zorgen dat deze oplossingen veilig en gebruiksvriendelijk zijn en tegelijkertijd de integriteit van het Lightning-protocol behouden.
...
Taproot is een belangrijke upgrade die de complexiteit van transacties consolideert en de privacy verbetert. In combinatie met MuSig (een protocol voor transacties met meerdere handtekeningen) en Schnorr-handtekeningen verbetert Taproot de efficiëntie van transacties. Dankzij deze verbeteringen lijken Lightning-transacties op gewone Bitcoin-transacties, wat het proces vereenvoudigt en de privacy versterkt.


**PTLC-routering**

Point Time Locked Contracts (PTLC's) zijn een verbetering ten opzichte van de bestaande Hash Time Lock Contracts (HTLC's). PTLC's gebruiken Schnorr-handtekeningen en verbeteren de privacy door gedeelde geheimen te vervangen door openbare sleutels, waardoor de kans op correlatie en misbruik van betalingen afneemt.
...
Naar oBedrijfsmodellen en geavanceerde protocollen

om de beperkingen van traditionele facturen te overwinnen, zijn er verschillende protocollen ontwikkeld om Lightning-betalingen uit te breiden en te verbeteren.
...
Een ander protocol, **RGB**, breidt de functionaliteit van Lightning verder uit door **asset transfers** over de Lightning Network mogelijk te maken. RGB maakt de overdracht van verschillende activa mogelijk, waaronder tokens, via Lightning-kanalen, waardoor het bereik van wat kan worden verhandeld wordt vergroot.
...
De vooruitgang in Lightning-betalingen heeft de weg vrijgemaakt voor nieuwe bedrijfsmodellen, met name voor **Lightning Service Providers (LSP's)**. LSP's verbeteren de gebruikerservaring door kanalen alleen te openen wanneer er betalingen worden gedetecteerd, waardoor het vooraf instellen minder complex wordt.


Een voorbeeld van een bedrijfsmodel dat wordt gefaciliteerd door Lightning is het **veilingmodel**. Hierbij houdt een server het hoogste bod vast en wijst lagere biedingen af, waardoor betalingen uitblijven totdat de veiling is afgelopen. Dit voorkomt de noodzaak voor terugbetalingen en stroomlijnt het veilingproces.
