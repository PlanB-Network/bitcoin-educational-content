...
- l'icona con un pennino, in basso a destra, che ti permetterà di aprire la dashboard da cui gestire i nuovi messaggi.
...
- mandare un regalo (di solito _Telegram Premium_);
- iniziare una chat segreta, che è una delle caratteristiche più carine di Telegram: **una chat segreta è uno spazio da cui, ad esempio, non è possibile estrarre screenshot, è una chat molto riservata ed è attiva solo da cellulare**;
...
⚠️ **Non farai logout, non temere: scegliamo questo menu solo per accedere alla funzionalità di cui stiamo parlando**.
...
Ti verrà mostrato sullo schermo un QR Code, da inquadrare con il tuo dispositivo mobile, quello su cui è già attivo Telegram: è così che potrai usare quell'account via desktop.
...
Nell'immagine seguente puoi vedere come far partire una call di gruppo usando Telegram desktop: vai nella chat dello stesso e nella parte superiore destra della schermata è presente l'icona di uno schermo. Cliccando su quella potrai decidere se far partire la chiamata immediatamente, oppure schedularla per un orario prestabilito.
