...
| **नकद**                       | नहीं                              | तुरंत (भौतिक Exchange)             | तुरंत (कोई निपटान विलंब नहीं)                | उच्च (एक बार भुगतान होने के बाद वापसी नहीं)            | कोई नहीं                           | कोई नहीं                               |
...
| विदेशी Exchange (FX) शुल्क       | एक सार्वभौमिक लेखा इकाई की कमी के कारण सीमा पार लेनदेन के लिए महंगी मुद्रा रूपांतरण की आवश्यकता होती है।                                                                                                                              | अंतर्राष्ट्रीय व्यापार के लिए अतिरिक्त लागत जोड़ता है, जिससे वैश्विक लेनदेन कम सस्ती हो जाती है।             |
...
बिटकॉइन एक **पीयर-टू-पीयर डिजिटल करेंसी Exchange सिस्टम** (इलेक्ट्रॉनिक कैश) है। "बिटकॉइन" शब्द निम्नलिखित घटकों को संदर्भित करता है:
...
बिटकॉइन अपनी वैल्यू को बरकरार रखता है क्योंकि इसका Ledger छेड़छाड से सुरक्षित है। इसकी कीमत Supply की दुर्लभ और सीमित संख्या के कारण बढ़ती है, साथ ही Exchange के मौकों में वृद्धि हो रही है जो यूजर्स की बढ़ती संख्या से प्रेरित है।
...
लाइटनिंग नेटवर्क, Exchange को लाइट की स्पीड से इंस्टेंट वैल्यू देता है। यह पेमेंट्स पर लागू एक ईमेल प्रोटोकॉल जैसा है: एक नेक्स्ट-जेनरेशन पेमेंट नेटवर्क। यह "पैसे" के ट्रांसफर के तरीके को पूरी तरह बदल देता है, इसे इंटरनेट पर डेटा ट्रांसमिशन की तरह फ्री और फास्ट बना देता है।
...
**बिटकॉइन की Exchange क्षमताओं को बढ़ाना:**

बिजली बिटकॉइन की भूमिका को "Exchange का माध्यम" और बढ़ा देती है। लेन-देन की आवृत्ति और स्वतंत्रता को बढ़ाकर, यह पैसे के मुख्य कार्य को मजबूत करती है: सभी भागीदारों के लिए आर्थिक लेन-देन और मूल्य सृजन को सुगम बनाना।
...
चूंकि बिटकॉइन, Exchange के माध्यम के रूप में काम करता है, इसलिए एक चक्रीय अर्थव्यवस्था की कल्पना करना संभव है। हालांकि यह आज भी असामान्य है, लेकिन अधिक से अधिक व्यवसाय बिटकॉइन भुगतान स्वीकार करने लगे हैं—आपका क्यों नहीं? (हमारा अगला अध्याय देखें)
...
अगर आप असली बिटकॉइन खरीदने का फैसला करते हैं, तो आपके पास मार्केटप्लेस (Exchange) या ब्रोकर के जरिए कई मुख्य विकल्प होते हैं:
...
- व्यापार **नहीं** करता है वास्तविक लाभ या हानि की गणना। इसके बजाय, लेन-देन को इस तरह दर्ज किया जाता है:
    ...
    - बिटकॉइन का बचा हुआ बैलेंस: 0.5 BTC, जिसकी कीमत अभी $20,000 है (Exchange की मौजूदा दर पर अपडेट किया गया)।
...
रिटेलर्स को हर लेन-देन के लिए बिटकॉइन से फिएट करेंसी (Exchange) की दर रिकॉर्ड करनी होगी। मिसाल के तौर पर, कई देशों में बिजनेस VAT कैलकुलेट करने के लिए सेल के समय की Exchange दर का इस्तेमाल करते हैं।
...
हालांकि, ज्यादातर छोटे व्यवसायों के लिए लेन-देन का इतिहास वाली एक साधारण `.csv` फाइल ही काफी होती है। मकसद यह है कि हर भुगतान की तारीख, रकम, यूरो/डॉलर में उसकी समतुल्य वैल्यू, और संबंधित बिटकॉइन पतों को दर्ज किया जाए। अधिकांश बिटकॉइन भुगतान समाधान (जैसे BTC Pay Server, Swiss बिटकॉइन Pay, वगैरह) या Exchange प्लेटफॉर्म (जैसे Bitfinex, Kraken, Coinbase, वगैरह) पहले से ही लेन-देन का इतिहास एक्सपोर्ट करने का विकल्प देते हैं। अकाउंटेंट को यह फाइल देकर डेटा एंट्री को आसान बनाया जा सकता है और बिटकॉइन से जुड़े आने-जाने वाले लेन-देन को साफ तौर पर अलग किया जा सकता है।
