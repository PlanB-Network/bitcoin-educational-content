...
**Satodime**, yang dikembangkan oleh **[Satochip](https://satochip.io/fr/)**, adalah sebuah kartu pembawa yang aman untuk menyimpan Bitcoin dengan cara yang sederhana dan nyata. Kartu ini bertindak sebagai Hardware Wallet kustodian mandiri, di mana Anda memiliki kontrol penuh atas kunci pribadi Anda tanpa bergantung pada pihak ketiga. Bersifat open-source dan bersertifikasi EAL6+, kartu ini mendukung hingga tiga brankas independen.
...
- Media yang aman**: Tempat yang aman untuk menyimpan kunci pribadi setelah dibuka segelnya (kertas, logam; tidak pernah dalam bentuk digital).
...
- Peringatan**: Langkah ini tidak dapat diubah. Silakan merujuk ke [artikel *Ownership*] (https://satochip.io/satodime-Ownership-explained/).
...
- Klik "*Buat & Seal*".
- Pindai kartu ke generate dan Seal untuk mendapatkan kunci privat (tidak diketahui sampai segel dibuka).
...
- Pilih brankas.
- Klik "*Tambah dana*".
- Salin Address publik atau pindai kode QR.
- Kirim dana dari Wallet lain.
- Periksa saldo setelah konfirmasi pada Blockchain.
...
Setelah membuka segel, ekspor kunci untuk digunakan pada Wallet yang lain:
...
- Impor ke dalam program perangkat lunak Wallet yang kompatibel dengan pengelolaan dana (misalnya Sparrow wallet atau Electrum).
...
Mengatur ulang brankas akan menghapus kunci pribadi yang terkait secara permanen. Dengan kata lain, jika Anda belum mengamankan salinan kunci pribadi Anda, atau mengimpornya ke Wallet yang lain, mengatur ulang brankas akan menyebabkan hilangnya dana yang ada di dalamnya secara permanen.
...
- Ambil kartu Ownership dari kartu tersebut,
- Buat brankas Bitcoin,
- Pindahkan Satss ke sana,
- Kartu transfer Ownership: orang berikutnya yang memindai kartu akan menjadi pemiliknya,
- Berikan kartu Satodime kepada orang yang Anda pilih, dan undang mereka untuk mengunduh aplikasi dan kemudian memindai kartu tersebut untuk mengambil Ownership dari kartu tersebut - dan dengan demikian mengakses bitcoin yang 'tersimpan' di dalamnya.
...
- Periksa status**: Selalu pindai untuk mengonfirmasi kartu Ownership dan status brankas yang tersegel/tidak tersegel.
...
- Pemulihan**: Jika kartu hilang tetapi dimiliki, dana ada di Blockchain; gunakan kunci privat jika tidak tersegel.
...
[Plan ₿ Network] (https://planb.network/) untuk tutorial mengenai penyimpanan mandiri, kunci pribadi, dll.
...
**Satochip** adalah perusahaan Belgia yang mengembangkan solusi perangkat keras dan perangkat lunak untuk mengelola dan menyimpan bitcoin dan mata uang kripto lainnya. Produk andalannya, Satochip Hardware Wallet, adalah kartu NFC yang dilengkapi dengan secure element bersertifikasi EAL6+. Dilengkapi dengan Seedkeeper, sebuah pengelola frasa dan rahasia Mnemonic, dan Satodime, sebuah kartu pembawa, Satochip menawarkan rangkaian lengkap yang disesuaikan dengan kebutuhan pengguna. Perangkatnya, yang didukung oleh perangkat lunak sumber terbuka, bertujuan untuk mendemokratisasi keamanan pada Bitcoin.