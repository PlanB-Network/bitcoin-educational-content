...
**セクション 1: BTCPay Server の紹介**  
ログイン画面、ユーザーアカウント管理、新しいストアの作成を含む BTCPay Server の一般的な紹介から始めます。このイントロダクションにより、BTCPay Server のインターフェースを理解し、このツールを使用するために必要な基本的な機能を把握することができます。

**セクション 2: ビットコイン鍵の保護についての紹介**  
ビットコインの資金の安全性は非常に重要です。このセクションでは、暗号鍵の生成、ハードウェアウォレットを使用した鍵の保護、および BTCPay Server を通じて鍵と対話する方法を探ります。また、トランザクションを最適化するために BTCPay Server Lightning ウォレットを設定する方法も学びます。

**セクション 3: BTCPay Server のインターフェース**  
このパートでは、BTCPay Server のユーザーインターフェースを案内します。ダッシュボードの操作方法、ストアとサーバーの設定の構成方法、支払いの管理、および統合プラグインの活用方法を学びます。目的は、インストールをニーズに合わせてカスタマイズするために必要なツールに慣れることです。

**セクション 4: BTCPay Server の設定**  
最後に、さまざまな環境で BTCPay Server を実際にインストールする方法に焦点を当てます。LunaNode、Voltage、または Umbrel ノードを使用する場合でも、それぞれの環境の特性を考慮しながら BTCPay Server をデプロイおよび構成するために必要な基本的な手順を学びます。

BTCPay Server をマスターしてビジネスを発展させる準備はできましたか？始めましょう！
