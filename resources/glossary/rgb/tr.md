...
RGB'te, Double-spending'e karşı direnç, Bitcoin'deki UTXO'ların yalnızca bir kez kullanılabileceği gerçeğinden yararlanan bir kriptografik mekanizma olan Single-Use Seal'un kullanılmasıyla sağlanır. token özgünlüğüne gelince, bu, Contract'un oluşturulmasından en son durumuna kadar durum geçmişinin istemci tarafında doğrulanmasıyla garanti edilir.