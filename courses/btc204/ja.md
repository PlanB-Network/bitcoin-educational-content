...
第5章では、[coinjoin](https://planb.academy/resources/glossary/coinjoin)とは別に、ビットコイン上でプライバシーを保護するために利用可能な他のテクニックをすべて見ていきます。何年もの間、開発者はプライバシーに特化したツールの設計において驚くべき創造性を発揮してきました。ここでは、[payjoin](https://planb.academy/resources/glossary/payjoin)、協調取引、コインスワップ、アトミックスワップなど、これらの方法をすべて取り上げ、その仕組み、目的、弱点について詳しく説明します。
