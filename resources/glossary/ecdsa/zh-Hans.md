...
在比特币世界中，ECDSA 用于从私钥中提取公钥。它还用于签署交易，以满足脚本解锁比特币和花费比特币的要求。比特币 ECDSA 中使用的椭圆曲线是 `secp256k1`，由方程 $y^2 = x^3 + 7$ 表示。这种算法自 2009 年比特币诞生以来就一直在使用。如今，它与 2021 年与 Taproot 一起推出的另一种数字签名算法，即 Schnorr 协议共享其地位。
