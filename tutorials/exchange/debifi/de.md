---
name: Debifi
description: Holen Sie sich einen von der Bitcoin garantierten Kredit ohne Vormundschaft.
---
...
Seit Jahrhunderten ermöglicht das traditionelle Kreditwesen die Finanzierung zahlreicher Projekte. Sie sind jedoch nach wie vor langsam, kostspielig und wenig integrativ, insbesondere für diejenigen, die keinen Zugang zu einer soliden Bankinfrastruktur haben.



Der Aufstieg des Bitcoin-Protokolls läutete eine neue finanzielle Ära ein und brachte eine Reihe von Herausforderungen mit sich. Eine dieser Herausforderungen war die Beschaffung von Liquidität, ohne gezwungen zu sein, Bitcoin zu verkaufen und damit sein Wachstumspotenzial zu verlieren



Das Ergebnis ist **Debifi**, eine Plattform, die sich als moderne Alternative zu Banken positioniert. Das Ziel ist klar: Kredite so einfach und transparent wie möglich zu machen, indem die Vorteile des traditionellen Finanzsystems mit der Freiheit von Bitcoin kombiniert werden. Der Name Debifi spiegelt diese Vision wider: ***Dezentralisierte Bitcoin-Finanzierung***, eine Abkürzung, die das Zusammentreffen von dezentraler Finanzierung und Bitcoin-Innovation verdeutlicht.
...
- Das Verhältnis von Kredit zu Wert (LTV)** eines Kredits bestimmt, wie viel Geld Sie als Sicherheit für Ihren Bitcoin aufnehmen können. Beleihungsquote = Darlehensbetrag / Sicherheitenbetrag * 100. Ein Beleihungsausmaß von 50 % bedeutet zum Beispiel, dass der Wert des Kredits 50 % des Wertes des hinterlegten Bitcoin entspricht.
...
## Erste Schritte mit Debifi



Um mit Debifi zu beginnen, benötigen Sie einige Voraussetzungen.
...
Bevor Sie Debifi ausleihen können, vergewissern Sie sich bitte, dass Sie die folgenden Gegenstände dabei haben:
...
- KYC (*Know Your Customer*): Je nach gewähltem Kreditangebot kann eine Identitätsprüfung erforderlich sein. Auf Debifi ist bei jedem Angebot angegeben, ob KYC erforderlich ist oder nicht. Bereiten Sie sich also entsprechend vor. Die KYC wird von zuverlässigen Drittanbietern wie Sumsub durchgeführt.
...
- Die Debifi Mobile App (iOS/Android) ist für die Kreditaufnahme erforderlich. Sie müssen die App herunterladen, ein Konto erstellen und Ihr Gerät "verlinken" (das Gerät bei Ihrem Konto registrieren). Die Debifi-App unterstützt die Zwei-Faktor-Authentifizierung (2FA). Ohne Smartphone können Sie keine Transaktionen auf Debifi bestätigen.
...
Besuchen Sie [die offizielle Website von Debifi](https://debifi.com/app).
...
Installieren Sie Ihre Anwendung je nach Smartphone-Typ und öffnen Sie sie dann.
...
Wenn Sie in der Anwendung sind, klicken Sie auf das Menü **Einstellungen**.
...
Sie erhalten per E-Mail einen Verifizierungscode. Kopieren Sie diesen Code und fügen Sie ihn in die Anwendung ein. Öffnen Sie dann die Debifi-Anwendung auf Ihrem Smartphone und melden Sie sich an.
...
Zur Sicherheit bittet Debifi Sie, drei Schritte zu befolgen.
...
- Zunächst müssen Sie einen sicheren PIN-Code festlegen, um später auf Ihre Anwendung zugreifen zu können.
...
- Richten Sie als Nächstes die Zwei-Faktor-Authentifizierung (2FA) ein, um Ihr Gerät mithilfe des 2FA-Codes mit Ihrem Konto zu verknüpfen.
...
- Speichern Sie schließlich die 12 Wörter Ihres privaten Schlüssels, indem Sie sie auf einem zuverlässigen Medium notieren und an einem sicheren Ort aufbewahren. Diese Phase ist für die Wiederherstellung Ihres Kontos und die Verwaltung Ihrer Mittel unerlässlich.
...
Bitte beachten Sie, dass nur Ihr registriertes Smartphone in der Lage ist, Ihr Konto zu eröffnen (eine zusätzliche Sicherheitsmaßnahme).



Sobald Sie diese Schritte abgeschlossen haben, klicken Sie auf das Menü **Angebote**, um die verfügbaren Kreditangebote zu sehen. Wenn Sie auf ein Angebot klicken, werden Sie auf die Debifi-Website weitergeleitet.
...
Sobald Ihr Gerät verbunden ist, rufen Sie die [Debifi-Website](https://debifi.com/) auf. Melden Sie sich an, um eine sichere Verbindung zwischen der mobilen Anwendung von Debifi und der Webplattform herzustellen. Dies erleichtert Ihnen die Interaktion mit den verfügbaren Kreditangeboten (übersichtliche Darstellung der Details zu jedem Angebot) und die Verwaltung Ihres Kontos.
...
Video-Tutorial, wie Sie sich mit Ihrem Konto auf der Plattform anmelden:
...
Die Plattform bringt Sie mit Liquidität in institutioneller Qualität in Kontakt und bietet eine Reihe von Optionen, die Ihren Bedürfnissen entsprechen. Informieren Sie sich über die verfügbaren Angebote. Sie haben auch die Möglichkeit, die Kreditparameter entsprechend Ihrer individuellen Risikotoleranz und finanziellen Situation anzupassen.
...
Die derzeit von Debifi angebotenen Fiat-Währungen können auf der Plattform eingesehen werden.
...
### Klare, flexible Vertragsklauseln



Debifi setzt auf transparente und flexible Kreditbedingungen, die den Bedürfnissen beider Seiten (Kreditgeber und Kreditnehmer) gerecht werden. Die wichtigsten Klauseln sind:
...
Die Zinsfestsetzung hängt im Allgemeinen von dem von Ihnen gewählten Beleihungssatz, der Länge der Kreditlaufzeit, der Volatilität der Sicherheiten und der plattformspezifischen Risikobewertung ab. Die Zinssätze bleiben für die gesamte Laufzeit des Kredits fest.



#### Flexibilität bei Laufzeit und Rückzahlung des Darlehens
...
#### Liquidationsrechte (Margin Calls)
...
### Einleitung des Kreditverfahrens



Um ein für Sie passendes Kreditangebot auszuwählen, klicken Sie es an, um seine Merkmale anzuzeigen.
...
1. Name des kreditgebenden Instituts ;


2. Die Kredithöhe ist variabel;


3. Dass Sie das Geld in USDC Ethereum erhalten werden;


4. Darlehenslaufzeit, Zinssatz und Beleihungsquote;


5. KYC ist für dieses Angebot erforderlich;
...
Kehren Sie zur mobilen Anwendung für ''**Öffentlichen Schlüssel bereitstellen**'' zurück.
...
### Hinterlegung der Bürgschaft und Erhalt Ihres Geldes
...
Sie erhalten diese Benachrichtigung auch in Ihrer mobilen Anwendung.
...
Sie erhalten dann eine Benachrichtigung von Debifi, in der Sie aufgefordert werden, die Kreditgebühren oder Provisionen zu zahlen, um den Status Ihres Kredits voranzutreiben.
...
Sie müssen lediglich eine Transaktion unterzeichnen, die es Debifi ermöglicht, seine Provision von der Bürgschaft abzuziehen. Ihr Kreditgeber muss seinerseits ebenfalls die Transaktion für den Gebührenabzug unterzeichnen, da Debifi sonst seine Provision nicht erhalten kann.
...
## Rückzahlung und Verwertung von Sicherheiten



Am Ende der vereinbarten Laufzeit (oder auf Wunsch auch früher) müssen Sie das Darlehen zurückzahlen.
...
Herzlichen Glückwunsch! Sie haben den Prozess abgeschlossen.
...
Fangen Sie nach Möglichkeit klein an. Testen Sie bei Ihrem ersten Kredit einen bescheidenen Betrag, um sich mit dem Verfahren vertraut zu machen.



Verwenden Sie nur die offizielle Debifi-Website, um sich über die Neuigkeiten von Debifi auf dem Laufenden zu halten, und vermeiden Sie unbekannte oder Phishing-Links.  Aktualisieren Sie die Anwendung, schützen Sie Ihr Smartphone mit einem PIN-Code, und wählen Sie ein kompatibles Hardware Wallet.



Wenn Sie ein Kreditgeber sind, führt Sie dieses Tutorial-Video durch die Nutzung der Debifi-Plattform. Von der Auswahl von Kreditnehmern, die an Ihrem Angebot interessiert sind, über die Bereitstellung öffentlicher Schlüssel, die Unterzeichnung von Verträgen, die Übertragung von Stablecoins und mehr.
...
Sie wissen nun, wie Sie die Debifi-Plattform nutzen können, um einen Kredit zu erhalten.



Ich empfehle Ihnen diesen Kurs, der sich eingehend mit Bitcoin, Stablecoins und ihrem Beitrag zur Souveränität befasst.
