---
name: Debifi
description: Bitcoin tarafından garanti edilen velayetsiz bir kredi alın.
---
...
Geleneksel kredilendirme yüzyıllardır birçok projenin finanse edilmesini mümkün kılmıştır. Ancak, özellikle sağlam bir bankacılık altyapısına erişimi olmayanlar için yavaş, maliyetli ve çok kapsayıcı değildir.



Bitcoin protokolünün yükselişi yeni bir finansal dönemi başlatmış ve beraberinde bir dizi zorluğu da getirmiştir. Bu zorluklardan biri, Bitcoin'i satmaya zorlanmadan likiditenin nasıl sağlanacağı ve böylece büyüme potansiyelinden nasıl mahrum kalınacağıydı



Sonuç, kendisini bankalara modern bir alternatif olarak konumlandıran bir platform olan **Debifi**. Amaç açık: geleneksel finans sisteminin avantajlarını Bitcoin'nin sunduğu özgürlükle birleştirerek krediyi mümkün olduğunca basit ve şeffaf hale getirmek. Debifi ismi bu vizyonu yansıtmaktadır: *merkezi olmayan finans ve Bitcoin inovasyonunun buluşmasını gösteren bir kısaltma olan **Decentralized Bitcoin Finance***.
...
## Debifi ile çalışmaya başlama



Debifi'ye başlamak için birkaç önkoşula ihtiyacınız olacak.
...
Debifi'den ödünç almadan önce lütfen aşağıdaki eşyalara sahip olduğunuzdan emin olun:
...
- KYC (*Müşterinizi Tanıyın*): seçilen kredi teklifine bağlı olarak, bir kimlik doğrulama süreci gerekebilir. Debifi'de her teklif KYC'nin gerekli olup olmadığını belirtir. Bu yüzden buna göre hazırlanın. KYC, Sumsub gibi güvenilir üçüncü taraf hizmet sağlayıcıları tarafından gerçekleştirilir.
...
- Kredi almak için Debifi mobil uygulaması (iOS/Android) gereklidir. Uygulamayı indirmeniz, bir hesap oluşturmanız ve cihazınızı "bağlamanız" (cihazı hesabınıza kaydetmeniz) gerekmektedir. Debifi uygulaması iki faktörlü kimlik doğrulamayı (2FA) destekler ve akıllı telefonunuz olmadan Debifi'deki işlemleri onaylayamazsınız.
...
Debifi'nin resmi web sitesini] (https://debifi.com/app) ziyaret edin.
...
Sahip olduğunuz akıllı telefon türüne göre uygulamanızı yükleyin, ardından açın.
...
Uygulamaya girdikten sonra **Ayarlar** menüsüne tıklayın.
...
Güvenlik için Debifi sizden üç adımı takip etmenizi isteyecektir.
...
- Öncelikle, uygulamanıza daha sonra erişmek için güçlü bir PIN kodu belirlemeniz gerekir.
...
- Ardından, 2FA kodunu kullanarak cihazınızı hesabınızla ilişkilendirmek için iki faktörlü kimlik doğrulamayı (2FA) ayarlayın.
...
- Son olarak, özel anahtarınızın 12 kelimesini güvenilir bir ortama yazarak ve güvenli bir yerde saklayarak kaydedin. Bu aşama, hesabınızı kurtarmak ve fonlarınızı yönetmek için çok önemlidir.
...
- Daha fazla güvenlik için bir passphrase bile ekleyebilirsiniz.
...
Hesabınızı yalnızca kayıtlı akıllı telefonunuzun açabileceğini lütfen unutmayın (ek bir güvenlik önlemi).



Bu adımları tamamladıktan sonra, mevcut kredi tekliflerini görmek için **Teklifler** menüsüne tıklayın. Bir teklife tıkladığınızda, sizi Debifi web sitesine yönlendirir.
...
### Web sitesine erişin ve kredi tekliflerini keşfedin
...
Platformdaki hesabınızla nasıl giriş yapacağınıza dair video eğitimi:
...
Platform sizi kurumsal kalitede likidite ile temasa geçirir ve ihtiyaçlarınıza uygun bir dizi seçenek sunar. Nelerin mevcut olduğunu öğrenmek için göz atın. Ayrıca kredi parametrelerini bireysel risk toleransınıza ve finansal durumunuza göre ayarlama esnekliğine de sahipsiniz.
...
Debifi'nin şu anda sunduğu fiat para birimleri platformda görüntülenebilir.
...
### Açık, esnek sözleşme maddeleri



Debifi, her bir tarafın (borç veren ve borç alan) ihtiyaçlarını karşılamak için şeffaf ve esnek kredi koşullarına dayanır. Temel hükümler şunları içerir :
...
Bitcoin kredi dilimleri genellikle üç (3) adettir:
...
Oran belirleme genellikle seçtiğiniz LTV'ye, kredi vadesinin uzunluğuna, teminat oynaklığına ve platforma özgü risk değerlendirmelerine bağlıdır. Oranlar kredi süresi boyunca sabit kalır.



#### Kredi vadesi ve geri ödeme esnekliği
...
#### Tasfiye hakları (Teminat çağrıları)
...
### Kredi sürecinin başlatılması



İhtiyaçlarınıza uygun bir kredi teklifi seçmek için üzerine tıklayarak özelliklerini görüntüleyin.
...
1. Kredi veren kurumun adı ;


2. Kredi tutarı aralığı;


3. Parayı USDC Ethereum cinsinden alacağınızı;


4. Kredi süresi, faiz oranı ve LTV oranı;


5. Bu teklif için KYC gereklidir;
...
Tekliften memnun kaldığınızda ve gerekli bilgileri doldurduğunuzda, "Contract talebi" üzerine tıklayın.
...
''**Provide public key**'' için mobil uygulamaya geri dönün.
...
### Teminatın yatırılması ve paranızın alınması
...
Bu bildirimi mobil uygulamanızda da alacaksınız.
...
Daha sonra Debifi'den, kredinizin durumunu ilerletmek için kredi ücretlerini veya komisyonlarını ödemenizi isteyen bir bildirim alacaksınız.
...
Teminatın fiyatında bir artış olması durumunda, borçlu teminat üzerindeki herhangi bir sermaye kazancını elinde tutar. Yalnızca önceden belirlenmiş ve Bitcoin fiyatından bağımsız olan kredi tutarını borçlanır.




## Teminatın geri ödenmesi ve geri alınması



Kararlaştırılan vadenin sonunda (veya isterseniz daha erken) krediyi geri ödemeniz gerekir.
...
Kredi/teminat (LTV) oranınızı izleyin. Mümkünse uyarılar (BTC fiyatı, LTV) ayarlayın. Oranınızın %90'a yaklaşmasına izin vermeyin. Şüpheniz varsa, teminatı artırın veya erken geri ödeme yapın.
...
Mümkünse küçük başlayın. İlk krediniz için, kendinizi sürece alıştırmak amacıyla mütevazı bir miktarı test edin.



Debifi haberlerini takip etmek için yalnızca resmi Debifi web sitesini kullanın ve bilinmeyen veya kimlik avı bağlantılarından kaçının.  Uygulamayı güncelleyin, akıllı telefonunuzu bir PIN kodu ile koruyun ve uyumlu bir Hardware Wallet seçin.



Alternatif olarak, eğer bir borç veren iseniz, bu eğitim videosu Debifi platformunu kullanırken size rehberlik edecektir. Teklifinizle ilgilenen borçluları seçmekten, açık anahtarlar sağlamaya, anlaşmalar imzalamaya, sabit coinleri aktarmaya ve daha fazlasına kadar.
...
Artık kredi almak için Debifi platformunu nasıl kullanacağınızı biliyorsunuz.



Bitcoin, Stablecoinler ve bunların egemenliğe katkılarını derinlemesine inceleyen bu dersi almanızı tavsiye ederim.
