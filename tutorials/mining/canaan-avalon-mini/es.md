...
En este tutorial, veremos cómo configurar el Canaan Avalon Mini 3, para facilitar el uso doméstico de Miner.
...
Tenga en cuenta que la diferencia de precio con los calentadores tradicionales de potencia equivalente no le permite, en la inmensa mayoría de los casos, obtener un beneficio financiero. Los satoshis generados por la actividad de Mining nunca compensarán esta diferencia de precio, a menos que tenga acceso a electricidad gratuita (excedente) o muy barata.
...
Debajo del bloque de espuma está el aparato y, una vez sacado de la caja, la unidad de alimentación Supply.
...
Una vez desembalado, coloca tu Avalon Mini 3 en una zona relativamente abierta, si es posible, para permitir que el calor circule correctamente. A continuación, empieza por insertar el pequeño módulo receptor WIFI en el puerto USB de la parte inferior del dispositivo, enchufa el Supply de alimentación y asegúrate de que el botón de encendido está en la posición "1".
...
Una vez completados estos pasos, la pantalla LED del dispositivo se ilumina y muestra el símbolo "Bluetooth", indicando que está listo para conectarse a su red local a través de la aplicación Avalon Family.
...
En la aplicación Avalon Family, seleccione el dispositivo como se muestra a continuación. A continuación, se le pedirá automáticamente que cambie la contraseña de administrador de la máquina. Pulse en "Aceptar" si lo desea, o en cancelar para dejar la contraseña de acceso por defecto "admin".
...
Los pools #2 y #3 actuarán como backups en el caso de que uno de ellos falle, para que tu Miner no funcione en vano. Por defecto, Hashrate apuntará al pool #1
...
Si desea más información sobre cómo conectarse a una Mining pool, consulte estos tutoriales :
...
En el menú principal de la aplicación de la familia Avalon, pulsa sobre el icono correspondiente al Avalon Mini 3. Accederás directamente al menú de gestión de los modos de funcionamiento.
...
Por último, en el modo "Noche", su Mini 3 funciona a la velocidad más baja posible con el mínimo ruido. 400 W, 20 Th/s y aproximadamente 33 dB.



Aquí también puede establecer una temperatura objetivo por encima de la cual la unidad pasa al modo inactivo y deja de Miner. Si la temperatura desciende, la unidad se reiniciará y reanudará el calentamiento y la Miner. En este modo, los LED de la pantalla están apagados por defecto, pero puede optar por encenderlos si es necesario para iluminar la habitación en la oscuridad, como una luz nocturna (véase la foto de abajo).
...
Al igual que en el Avalon Nano 3S, el menú "Ajustes" permite cambiar la contraseña del administrador, los ajustes de la piscina, comprobar la obstrucción del filtro (situado en la parte inferior del dispositivo), ponerse en contacto con el servicio de asistencia o ver los registros del dispositivo.
...
Hemos llegado al final de este tutorial, que nos ha enseñado cómo conectar nuestro Avalon Mini 3 a nuestra red local, cómo apuntar nuestro Hashrate a las piscinas Mining, y cómo navegar por las opciones y configuraciones utilizando la aplicación Avalon Family.
