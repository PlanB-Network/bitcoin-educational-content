...
**Satodime**, ontwikkeld door **[Satochip](https://satochip.io/fr/)**, is een veilige draagkaart voor het opslaan van Bitcoin op een tastbare en eenvoudige manier. Het fungeert als een self-custodial Hardware Wallet, waarbij je volledige controle hebt over je private keys zonder afhankelijk te zijn van een derde partij. Het is open-source en EAL6+ gecertificeerd en ondersteunt tot drie onafhankelijke kluizen.
...
Satodime, een **carte au porteur, behoort toe aan degene die het fysiek bezit**, zonder noodzaak voor voorafgaande registratie of identificatie. Het voorziet in de behoefte aan veilige, draagbare Bitcoin opslag, waardoor iedereen die de kaart bezit deze kan gebruiken of bitcoins kan overdragen door de kaart te scannen via de mobiele app om bezit te nemen of kluizen te ontzegelen. In tegenstelling tot een papieren biljet maakt de kaart gebruik van een beveiligde chip voor Seal de privésleutels, die pas worden onthuld na het ontzegelen, waardoor de kaart vergelijkbaar is met contant geld waarbij Ownership wordt bepaald door fysiek bezit. Ideaal voor het geven van bitcoins als cadeau, het vergemakkelijkt de veilige overdracht van bitcoins van hand tot hand, terwijl de mobiele applicatie gebruik maakt van NFC voor toegankelijke smartphone interactie.
...
- Waarschuwing**: Deze stap is onomkeerbaar. Raadpleeg [het *Ownership* artikel] (https://satochip.io/satodime-Ownership-explained/).
...
Satodime ondersteunt tot 3 kluizen. Maak er een om Bitcoin op te slaan:
...
- Kies Blockchain (Bitcoin).
- Klik op "*Creëer & Seal*".
- Scan de kaart naar generate en Seal de privésleutel (onbekend tot ontzegeling).
...
- Kopieer de openbare Address of scan de QR-code.
...
- Importeer het in een Wallet softwareprogramma dat compatibel is met fondsbeheer (bijv. Sparrow wallet of Electrum).
...
Het resetten van de kluis wist onherroepelijk de bijbehorende privésleutel. Met andere woorden, als je geen kopie van je privésleutel hebt veiliggesteld of deze in een andere Wallet hebt geïmporteerd, zal het resetten van de kluis leiden tot het onomkeerbare verlies van het geld dat erin zit.
...
- Neem Ownership van de kaart,
- Maak een Bitcoin kluis,
- Breng Satss daarheen,
- Kaart overdragen Ownership: de volgende persoon die de kaart scant, wordt de eigenaar,
- Geef de Satodime-kaart aan de persoon van je keuze en nodig hem uit om de applicatie te downloaden en vervolgens de kaart te scannen om er Ownership van te maken - en zo toegang te krijgen tot de bitcoins die erop 'opgeslagen' zijn.
...
- Controleer status**: Scan altijd om de Ownership-kaart en de verzegelde/onverzegelde status van kluizen te bevestigen.
...
- Herstel**: Als de kaart verloren maar in bezit is, staat het geld op de Blockchain; gebruik de privésleutel als deze niet verzegeld is.
...
[Plan ₿ Network](https://planb.network/) voor tutorials over zelfbehoud, privésleutels, enz.
