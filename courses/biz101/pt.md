...
Ao longo do curso, ser-lhe-ão apresentados os princípios fundamentais que tornam a Bitcoin e a Lightning Network nitidamente transformadoras. Aprenderá como estas tecnologias oferecem um espetro de casos de utilização, desde o armazenamento de capital digital a pagamentos rápidos, económicos e escaláveis, e como proporcionam melhorias críticas em relação à moeda tradicional e aos sistemas de pagamento. O curso BIZ101 liga a teoria económica a aplicações do mundo real, esclarecendo como a descentralização pode reduzir as dependências de intermediários e ultrapassar as limitações inerentes aos sistemas antigos.
...
Atualmente, o princípio da senhoriagem está a ser posto em causa pela [criptomoeda](https://planb.academy/resources/glossary/cryptocurrency) Bitcoin, que funciona sem controlo centralizado. O Bitcoin é um sistema "sem permissão", em que qualquer pessoa pode participar na utilização da moeda sem pedir autorização e, através da [extração mineira](https://planb.academy/resources/glossary/mining), na sua criação. Esta descentralização retira aos governos o monopólio da emissão, levantando questões sobre um potencial regresso a sistemas monetários competitivos de mercado livre.
...
- **[Fungível](https://planb.academy/resources/glossary/fungibility)**: Todas as unidades de uma moeda devem ser permutáveis e de igual valor. Por exemplo, uma nota de dólar deve ser equivalente a qualquer outra nota de dólar. Esta uniformidade assegura a equidade e a simplicidade das transacções.
...
Atualmente, o aparecimento da moeda descentralizada Bitcoin representa o próximo salto nas redes monetárias. A moeda eletrónica tradicional depende de autoridades centralizadas, como bancos ou governos, para gerir e verificar as transacções. Embora eficazes, esses sistemas são vulneráveis a ineficiências, censura e [pontos únicos de falha](https://planb.academy/resources/glossary/spof). As moedas descentralizadas melhoram estas propriedades da rede, **[distribuindo](https://planb.academy/resources/glossary/distributed) a confiança e removendo os intermediários**. Significa também que o dinheiro pode circular muito **mais depressa** e **mais barato**, porque não há passos de autorização. Finalmente, nenhum ser humano pode ser tentado a mudar o [cronograma de fornecimento](https://planb.academy/resources/glossary/limite-demission) da moeda Bitcoin, é imposto pelo software.

Nos sistemas descentralizados, as transacções são verificadas por uma rede global de participantes que utilizam a tecnologia [blockchain](https://planb.academy/resources/glossary/blockchain), garantindo segurança, transparência e resiliência. Esta estrutura minimiza o risco de fraude, reduz a dependência das autoridades centrais e permite que os indivíduos tenham um maior controlo sobre as suas finanças. Ao eliminar barreiras geográficas e institucionais, as moedas descentralizadas oferecem um sistema monetário verdadeiramente global e inclusivo.
...
### Tipos comuns de métodos de pagamento
...
| Método de Pagamento               | Necessidade de Autorização?       | Tempo de Aprovação da Transação (Visão do Comerciante) | Velocidade de Liquidação (Fundos Totalmente Liquidados) | Finalidade (Facilidade de Reversão)           | Número de Intermediários       | Taxas Típicas (para o Beneficiário) |
| --------------------------------- | --------------------------------- | ----------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------- | ------------------------------ | ---------------------------------- |
| **Dinheiro (Cash)**                | Não                               | Imediato (Troca Física)                                | Imediato (Sem Atraso na Liquidação)                    | Alta (Irreversível após o pagamento)         | Nenhum                        | Nenhum                             |
| **Cheques (Checks)**               | Sim (Compensação Bancária)        | Aceitação no Depósito (Não Garantido)                  | Vários Dias (Processo de Compensação de Cheques)       | Médio (Pode ser Recusado/Parado Antes da Compensação) | Banco                         | **Baixa a Média** (Taxas Bancárias) |
| **Transferências Bancárias (Wire Transfers)** | Sim (Banco/Rede)                | Confirmação em Horas                                    | Mesmo Dia ou Próximo Dia (Doméstico)                  | Alta (Geralmente Irreversível após o Envio)  | Bancos, Redes de Pagamento     | **Média** (Fixa/Porcentagem)        |
| **Cartões de Pagamento (Payment Cards)** | Sim (Autorização do Emissor do Cartão) | Segundos a Minutos (Código de Autorização)           | Alguns Dias (Liquidação Interbancária)                | Médio (Possíveis Estornos)                   | Emissor, Adquirente, Rede de Cartões | **Variável (1-3% da Transação)** |
| **Carteiras Digitais/Pagamento Móvel (Digital Wallets/Mobile Pay)** | Sim (Provedor da Carteira/Banco) | Segundos (Confirmação Instantânea)                   | Normalmente 1-2 Dias (Depende da Fonte de Financiamento) | Médio (Possíveis Reembolsos/Disputas)       | Bancos, Operadores de Carteiras | **Baixa a Média (Varia)**          |


### Limitações das Soluções Existentes

A indústria de pagamentos tradicionais representa uma economia anual de aproximadamente 2,2 trilhões de dólares, aproximadamente um décimo do PIB dos Estados Unidos ou equivalente ao PIB da França. Como as moedas funcionam como redes permissivas, há uma competição limitada, fazendo com que esse "serviço" se assemelhe mais a um imposto imposto à economia produtiva. Além dos encargos de custo que cria, existem várias outras limitações, conforme descrito abaixo.

| Limitação                         | Explicação                                                                                                                                                                                                                  | Impacto                                                                                                    |
| -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Altas Taxas de Cartão             | As taxas de intercâmbio (~0,3%), taxas de rede (fixas ou 0,3%-1%), assinaturas de terminais/PSP e margens bancárias (0,5%-1,7%) somam um custo substancial — como um "imposto" global sobre setores produtivos, totalizando trilhões de dólares. | Aumenta os custos para comerciantes, reduzindo margens e potencialmente elevando os preços para consumidores. |
| Liquidação Final Muito Lenta      | A liquidação dos fundos pode levar até 5 dias, desacelerando o fluxo de dinheiro e a atividade econômica geral.                                                                                                              | Atrasos na liquidez para comerciantes e redução da velocidade da circulação econômica.                    |
| Fraude                            | Canais de e-commerce são fortemente visados por fraudes, contribuindo para perdas significativas (ex.: 28 bilhões de dólares). Os estornos podem alcançar cerca de 174 bilhões de dólares globalmente até 2024. Gerenciar essas disputas consome tempo e causa estresse mental. | Aumenta os custos operacionais, exige medidas complexas de prevenção de fraudes e diminui a confiança do cliente. |
| Abandono de Carrinho              | Etapas adicionais de segurança (códigos de uso único, autenticação de dois fatores sob PSD2) introduzem fricção no checkout.                                                                                                | Maior complexidade no checkout leva ao aumento do abandono de carrinho e perda de vendas.                  |
| Altos Valores Mínimos de Transação | Os limites mínimos de gasto nos cartões podem forçar comerciantes e consumidores a condições inconvenientes de preços ou compras, desencorajando transações de baixo valor.                                                | Reduz a satisfação e a flexibilidade do cliente, potencialmente limitando compras por impulso ou de baixo valor. |
| Pré-Autorização Lenta             | Os sistemas atuais não conseguem lidar com transações em velocidades de milissegundos ou suportar fluxos contínuos de pagamentos em tempo real.                                                                             | Limita os casos de uso que exigem pagamentos instantâneos ou contínuos, restringindo a inovação e escalabilidade. |
| Necessidade de Conta Bancária/Cartão | O acesso a esses métodos de pagamento requer uma conta bancária ou cartão vinculado, excluindo automaticamente aqueles que não possuem tais contas.                                                                       | Limita a inclusão financeira, reduzindo o acesso para populações não bancarizadas ou com pouca bancarização. |
| Criação Repetida de Contas Online  | Os usuários muitas vezes precisam criar várias contas online, levando a fadiga, conveniência reduzida e maior exposição de dados pessoais.                                                                                 | Deteriora a experiência do usuário, aumenta as preocupações com privacidade e aumenta o risco de violações de dados. |
| Taxas de Câmbio (FX)              | A falta de uma unidade de conta universal força conversões de moeda caras para transações transfronteiriças.                                                                                                               | Adiciona custos extras para o comércio internacional, tornando as transações globais menos acessíveis.     |
...
Bitcoin é um sistema de troca de moeda digital **[peer-to-peer](https://planb.academy/resources/glossary/peertopeer-p2p)** (dinheiro eletrónico). O termo "Bitcoin" refere-se aos seguintes componentes:


- Um protocolo informático **que facilita a troca de valores na Internet sem intermediários, sem necessidade de autorização e de forma pseudónima. Utiliza princípios [criptográficos](https://planb.academy/resources/glossary/cryptography) avançados.**
- Uma rede física de máquinas ligadas à Internet ([nós](https://planb.academy/resources/glossary/node), [mineiros](https://planb.academy/resources/glossary/miner), etc.) operadas por indivíduos e empresas, formando um sistema descentralizado (sem autoridade central ou ponto único de controlo).
- A **unidade de conta** dentro do sistema. Nunca existirão mais de 21 milhões de bitcoins. Cada bitcoin é divisível em 100 milhões de unidades chamadas "[satoshis](https://planb.academy/resources/glossary/satoshi-sat)", nome dado em honra do seu criador anónimo.

Em conjunto, fazem da Bitcoin um **ativo portador** e uma moeda digital **sem emissor**. A propriedade é garantida apenas pela posse da **[chave criptográfica privada](https://planb.academy/resources/glossary/private-key)**, garantindo o controlo total **sem intermediários ou terceiros de confiança**. Quando transferida, a **finalidade** da propriedade é imediata: o novo detentor possui-a na totalidade sem depender de uma autoridade central para proteção ou convertibilidade. As [transacções](https://planb.academy/resources/glossary/transaction-tx) são **imutáveis** - uma vez registadas na cadeia de blocos, não podem ser alteradas ou apagadas.
...
![BIZ101](assets/pt/004.webp)

A Bitcoin preserva efetivamente o valor porque o seu [livro-razão](https://planb.academy/resources/glossary/ledger) é inviolável. O seu valor aumenta devido à oferta rara e limitada combinada com o número crescente de oportunidades de troca, impulsionado pelo número crescente de utilizadores.
...
- **[Capitalização bolsista](https://planb.academy/resources/glossary/market-cap-capitalization):** 1,8 biliões de dólares (> Meta, Visa, Prata; < Apple, Google, Ouro)
...
- Totalmente **[open-source](https://planb.academy/resources/glossary/foss)**
...
- **Modelo económico inovador:** A criação de blocos é [subsidiada](https://planb.academy/resources/glossary/block-subsidy) por [taxas de transação](https://planb.academy/resources/glossary/transaction-fees) (com base em leilões)
...
A [Lightning Network](https://planb.academy/resources/glossary/lightning-network) é **um protocolo e uma rede** que facilita as transacções Bitcoin com uma interação mínima com a blockchain principal da Bitcoin. Veja como ela funciona:


- **Configuração inicial:** Os fundos são bloqueados (escrowed) na blockchain principal para estabelecer um [canal de pagamento](https://planb.academy/resources/glossary/payment-channel) entre 2 partes.
...
- **Transacções [fora da cadeia](https://planb.academy/resources/glossary/offchain):** As transacções ocorrem entre as partes mas não são **publicadas imediatamente** na cadeia de blocos principal da Bitcoin (**"fora da cadeia"**).
- **Liquidações [on-chain](https://planb.academy/resources/glossary/onchain):** Apenas o **saldo final** das transacções de um canal é publicado na blockchain principal da Bitcoin (**"on-chain"**), permitindo que numerosas transacções ocorram entretanto. Este agrupamento de vários pagamentos reduz o congestionamento e, portanto, reduz as taxas em comparação com a realização de muitas transacções on-chain.
...
![BIZ101](assets/pt/005.webp)

Esta abordagem evita a lentidão e a complexidade de realizar todas as transacções diretamente na cadeia de blocos principal da Bitcoin, registando apenas os saldos finais e mantendo a sua segurança. A Lightning Network é uma [camada](https://planb.academy/resources/glossary/layer) "no topo" do Bitcoin, mas permanece ancorada a ele.
...
Felizmente, a Bitcoin obriga-nos a repensar tudo e a pôr em causa estas noções preconcebidas. Existe uma escola de pensamento - a [Escola Austríaca de Economia](https://planb.academy/resources/glossary/austrian-school) - que pode esclarecer estas questões e ajudar-nos a reconsiderar a verdadeira natureza do capital.
...
**Inflação oculta**: Num sistema monetário de [reservas fraccionadas](https://planb.academy/resources/glossary/fractional-reserves) baseado na dívida e apoiado por bancos centrais, a **oferta monetária global cresce em média cerca de 7% por ano** (por exemplo, M1 na Zona Euro ou nos EUA). Isto significa que a sua "parte do bolo" é cortada para metade em apenas alguns anos - a menos que tenha acesso privilegiado à torneira financeira e possa continuar a crescer alavancando e comprando activos rapidamente a "preços antigos" antes que o dinheiro recém-criado os faça subir. Este é o efeito Cantillon, que explica em parte a transferência de riqueza para os mais ricos, enquanto o "capital" é erradamente apontado como o culpado (ver a nossa introdução sobre o capital acima).
...
Em resumo, para o caso de utilização mais comum - investir o excesso de tesouraria durante, pelo menos, um período de quatro anos - a Bitcoin enquadra-se perfeitamente. Vale a pena combiná-la com uma [estratégia de entrada gradual](https://planb.academy/resources/glossary/dollar-cost-averaging-dca): investir montantes fixos em intervalos regulares para suavizar o ponto de entrada ou de saída.
...
Este é, de longe, o método mais comum, efectuado através de trocas peer-to-peer ou, mais tipicamente, em plataformas de negociação especializadas. No entanto, ao adquirir Bitcoin como um ativo de tesouraria empresarial, as empresas têm de cumprir normas regulamentares robustas e procedimentos "Know-Your-Customer" ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)). Quando a compram em plataformas de negociação especializadas, as empresas são normalmente obrigadas a fornecer informações detalhadas sobre a empresa, incluindo documentos de identificação, extractos financeiros e comprovativo de morada, para satisfazer os requisitos KYC e de combate ao branqueamento de capitais (AML).
...
- **[Auto-Custódia](https://planb.academy/resources/glossary/selfcustody):**
...
- **Características de contabilidade:** No mínimo, a capacidade de exportar o histórico de transacções em formato .CSV.
...
| Atributo                      | O Iniciante                                                                                                                           |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Estado Mental**             | "experimentando meu primeiro pagamento físico", "recebendo gorjetas pelo meu conteúdo online", "visando uma receita muito pequena" |
| **Frequência de Transações**   | "primeira transação para aprender", "recebendo pagamento de vez em quando"                                                          |
| **Exemplos de Tipos de Negócio** | Economia criativa (criadores de conteúdo, blogs, artigos, etc.), gorjetas ocasionais, vendas presenciais únicas, associações, eventos únicos |
| **Tipo de Pagamento**          | Geralmente alguns centavos a alguns euros/dólares; menos de ~300 euros/dólares por item                                            |
| **Complexidade de Configuração** | Nenhuma                                                                                                                           |
| **Exemplo de Solução Recomendada** | Uma carteira custodial Lightning como Wallet of Satoshi ou uma carteira não-custodial como Phoenix                               |
| **Interface do Comerciante**   | Carteira Bitcoin Lightning simples: um aplicativo em um celular                                                                    |
| **Interface do Cliente**       | Código QR Bitcoin, escaneado através da carteira pessoal do cliente                                                                |
| **Taxas**                      | O cliente paga taxas do Bitcoin Lightning e quaisquer taxas aplicáveis do aplicativo                                              |
| **Dispositivo de Ponto de Venda** | Aplicativo gratuito para smartphone ou uma opção de terminal físico (ex.: Bitcoinize)                                           |
| **Gestão e Funções**           | Gestão de aplicativo único; diferenciação mínima de funções                                                                        |
| **Exportações Contábeis**      | Listas básicas de histórico de transações                                                                                         |
| **API**                        | Não                                                                                                                                |
...
| Atributo                      | O Essencial                                                                                                                       |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **Estado Mental**             | "Aceito Bitcoin no meu negócio, mas não espero um volume significativo"                                                          |
| **Frequência de Transações**   | Poucas transações por mês                                                                                                        |
| **Exemplos de Tipos de Negócio** | Bares, restaurantes, vendas semirregulares de produtos frescos ou adquiridos diretamente, várias lojas sob um único proprietário, economia criativa para artistas |
| **Tipo de Pagamento**          | Geralmente variando de alguns euros/dólares a algumas centenas por item; menos de ~300 por item e menos de ~3.000 por mês       |
| **Complexidade de Configuração** | Mínima (aplicativo móvel)                                                                                                      |
| **Exemplo de Solução Recomendada** | Swiss Bitcoin Pay                                                                                                            |
| **Interface do Comerciante**   | Carteira Bitcoin Lightning simples: um aplicativo em um celular; faturamento simples com detalhes mínimos                      |
| **Interface do Cliente**       | Código QR Bitcoin, escaneado através da carteira pessoal do cliente                                                            |
| **Taxas**                      | Normalmente <1% para envio para um endereço Bitcoin, e <1,5% para conversão em moeda fiduciária                                |
| **Dispositivo de Ponto de Venda** | Aplicativo gratuito para smartphone ou uma opção de terminal físico (ex.: Bitcoinize)                                        |
| **Gestão e Funções**           | Opção de função apenas para vendas para funcionários; painel online para administração                                        |
| **Exportações Contábeis**      | Exportação CSV com detalhes completos das transações                                                                            |
| **API**                        | Sim                                                                                                                            |
...
| Atributo                      | O Profissional                                                                                                                          |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **Estado Mental**             | - Um método de pagamento como qualquer outro para o meu e-commerce - Ou gestão conjunta para um grupo de negócios prontos para maiores volumes |
| **Frequência de Transações**   | Múltiplas transações por dia                                                                                                            |
| **Exemplos de Tipos de Negócio** | Sites de e-commerce com volume moderado, pequenos marketplaces, grupos de lojas físicas (ex.: Click & Collect), operações de PMEs     |
| **Tipo de Pagamento**          | Geralmente variando de alguns euros/dólares a algumas centenas; sem limite definido de tamanho de pagamento; menos de 250.000 por ano |
| **Complexidade de Configuração** | De leve a totalmente funcional (hospedagem local ou em nuvem), frequentemente requer uma loja de e-commerce                            |
| **Exemplo de Solução Recomendada** | BTC Pay Server para e-commerce e/ou ambientes físicos; ZapRite, Musqet ou PayWithFlash para checkout, Be-BOP para uma e-store integrada |
| **Interface do Comerciante**   | Site (móvel e desktop) com edição de faturas, opções de carrinho de compras e criação de botões de pagamento; faturamento automatizado com integração de e-commerce |
| **Interface do Cliente**       | Código QR Bitcoin, escaneado através da carteira pessoal do cliente                                                                  |
| **Taxas**                      | Combinação de backend gratuito e open-source com hospedagem Lightning paga; taxas front-end incluem taxas Bitcoin Lightning e <1,5% de taxas de conversão |
| **Dispositivo de Ponto de Venda** | Loja online, exibição física opcional (ex.: iPad mostrando o site ou terminal Bitcoin)                                              |
| **Gestão e Funções**           | Loja totalmente funcional com múltiplos papéis administrativos; funcionários e clientes interagem com o sistema                       |
| **Exportações Contábeis**      | Exportação CSV com detalhes completos das transações                                                                                 |
| **API**                        | Sim                                                                                                                                |
...
| Atributo                      | A Empresa                                                                                                                          |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Estado Mental**             | - Um método de pagamento estratégico para a empresa - Com algum desenvolvimento para integrar na plataforma de serviços conforme especificações específicas |
| **Frequência de Transações**   | Ilimitado, transações de alta frequência                                                                                          |
| **Exemplos de Tipos de Negócio** | Empresas de médio porte, empresas de serviços de TI, grandes corporações, grandes marketplaces                                    |
| **Tipo de Pagamento**          | Qualquer tamanho ou volume                                                                                                       |
| **Complexidade de Configuração** | Média a alta, dependendo da escolha da arquitetura                                                                               |
| **Exemplo de Solução Recomendada** | Arquitetura personalizada ou orquestração de soluções hospedadas em SaaS, potencialmente usando serviços de terceiros LSP (*Lightning Service Provider*) |
| **Interface do Comerciante**   | Interfaces frontend e backend totalmente personalizadas e integradas aos fluxos de trabalho e processos da empresa              |
| **Interface do Cliente**       | Variando de um código QR Bitcoin a uma interface de usuário totalmente personalizada e/ou integração de API                    |
| **Taxas**                      | Combinação de desenvolvimento interno e taxas de terceiros; o cliente paga taxas do Bitcoin Lightning e quaisquer taxas de transação dos provedores de serviço |
| **Dispositivo de Ponto de Venda** | Soluções personalizadas projetadas para o ambiente empresarial                                                                  |
| **Gestão e Funções**           | Funções totalmente personalizadas em vendas, administração, devops, contabilidade e finanças                                   |
| **Exportações Contábeis**      | Exportações contábeis totalmente personalizadas                                                                                 |
| **API**                        | Sim                                                                                                                            |
...
O perfil Starter é projetado para empresas, criadores e indivíduos que desejam explorar os pagamentos com Bitcoin sem comprometer recursos substanciais ou experiência. Estes são tipicamente aqueles que lidam com um volume muito pequeno de transacções (talvez algumas gorjetas, doações ou vendas ocasionais) e procuram uma introdução simples e leve ao ecossistema Bitcoin e Lightning Network. O principal valor da abordagem Starter reside na sua configuração mínima: na maioria dos casos, tudo o que é necessário é um smartphone ou tablet equipado com uma [carteira](https://planb.academy/resources/glossary/wallet) básica compatível com Lightning.

![BIZ101-profiles](assets/pt/017.webp)
...
![BIZ101-profiles](assets/pt/019.webp)
...
![BIZ101-profiles](assets/pt/020.webp)
...
![BIZ101-profiles](assets/pt/021.webp)
...
![BIZ101-profiles](assets/pt/022.webp)
...
![BIZ101-profiles](assets/pt/023.webp)
...
![BIZ101-profiles](assets/pt/024.webp)
...
![BIZ101-profiles](assets/pt/025.webp)
...
![BIZ101-profiles](assets/pt/026.webp)
...
![BIZ101-profiles](assets/pt/027.webp)

A implementação destas tecnologias num ambiente profissional significa prestar muita atenção à **complexidade operacional**. Fluxos de trabalho de faturação automatizados, visualizações em várias moedas e sincronização com sistemas de inventário existentes são todas caraterísticas de uma plataforma bem integrada. A capacidade de exportar dados de transação com precisão (seja como ficheiros CSV, chamadas diretas à API ou formatos personalizados) ajuda as empresas a reconciliar as vendas de bitcoin com outros fluxos de receitas de forma eficiente.

A segurança e a gestão de funções constituem outra consideração fundamental para os utilizadores profissionais. À medida que as transacções diárias de Bitcoin se acumulam, o controlo do acesso às funções administrativas torna-se uma medida essencial de mitigação de riscos. Em muitas soluções, os administradores podem atribuir vários níveis de permissão (talvez restringindo alguns funcionários à visualização de históricos de transacções e à geração de facturas, enquanto concedem a outros autoridade para gerir o inventário ou configurar as definições de todo o sistema...). Esta estrutura hierárquica não só protege os dados sensíveis, como também simplifica as operações, esclarecendo quais os membros do pessoal responsáveis por cada segmento da infraestrutura de pagamento.

No que diz respeito a exemplos do mundo real, considere uma loja de comércio eletrónico de média dimensão especializada em acessórios tecnológicos. A empresa poderia integrar o BTC Pay Server na sua montra online existente, gerando automaticamente endereços de pagamento Bitcoin durante o checkout. Os clientes concluem as suas compras digitalizando um endereço Lightning ou on-chain, e a plataforma da loja confirma instantaneamente o pagamento. Ao mesmo tempo, um sistema interno actualiza o estado das encomendas e acciona notificações de envio. Graças às funcionalidades avançadas de criação de relatórios, a equipa financeira pode analisar facilmente as vendas diárias de Bitcoin, exportar um livro-razão consolidado para auditoria e acompanhar o valor de quaisquer participações em BTC que a empresa decida manter.

![BIZ101-profiles](assets/pt/028.webp)

*[Crédito: Loja Bitcoin Bazar em Paris, França](https://bitcoinbazar.fr/)*

Para se aprofundar nas especificidades da implementação e explorar as configurações práticas do BTC Pay Server, consulte o seguinte curso:
...
O perfil Enterprise está no ápice das implementações de pagamento Bitcoin, adaptado especificamente para corporações de grande porte, grandes mercados e empresas estabelecidas que exigem soluções totalmente personalizadas. Ao contrário das implementações de pequena ou média escala, as operações de nível empresarial integram os pagamentos Bitcoin numa ampla rede de fluxos de trabalho e sistemas, desde dispositivos de ponto de venda no local a montras de comércio eletrónico, plataformas de contabilidade de back-office e estruturas ERP sofisticadas.

A esta escala, o objetivo global não é simplesmente aceitar Bitcoin, mas fazê-lo de uma forma que esteja completamente **alinhada com os processos principais da organização**. Este alinhamento pode exigir o desenvolvimento de software especializado, quer a solução seja totalmente personalizada ou orquestrada através de uma infraestrutura baseada em SaaS apoiada por terceiros *Lightning Service Providers* (LSPs). Estes LSP podem lidar com elevados volumes de transacções e configurações de rede complexas que excedem a capacidade das ferramentas mais convencionais e prontas a utilizar. A arquitetura resultante incorpora, portanto, uma vasta gama de considerações técnicas e comerciais, desde integrações orientadas por API a capacidades avançadas de gestão de tesouraria.

No contexto de uma empresa, a complexidade operacional torna-se especialmente acentuada. Uma grande empresa pode precisar de acomodar vários departamentos (vendas, marketing, desenvolvimento, finanças e contabilidade), cada um com responsabilidades e requisitos de dados distintos. Neste cenário, uma plataforma de pagamento Bitcoin deve oferecer uma gestão de funções altamente granular, permitindo que cada departamento aceda precisamente às funções relevantes para as suas tarefas, preservando simultaneamente um controlo rigoroso da segurança e da integridade dos dados. Igualmente essencial é a capacidade de personalizar os fluxos de trabalho: por exemplo, os pagamentos recebidos podem desencadear actualizações nos sistemas de inventário, enviar notificações automáticas aos gestores de vendas e atualizar as entradas do livro-razão para a equipa financeira, tudo em tempo real. Os próprios dispositivos de ponto de venda são normalmente adaptados ao ambiente empresarial, com interfaces de software personalizadas que correspondem à marca e às necessidades operacionais da empresa.

**A segurança** é fundamental para as empresas de escala empresarial. Elevados volumes de transacções e somas potencialmente elevadas de Bitcoin requerem uma infraestrutura robusta capaz de defender contra ataques maliciosos ou ameaças internas. As melhores práticas incluem frequentemente configurações de tesouraria com várias assinaturas e [timelocks](https://planb.academy/resources/glossary/timelock), bases de código cuidadosamente auditadas e uma adesão rigorosa aos quadros regulamentares relevantes. Além disso, a conformidade com os regulamentos financeiros locais e internacionais pode ser essencial para preservar a reputação da empresa e a licença para operar.

O **desenvolvimento personalizado** envolvido na criação ou integração de uma solução de pagamento Bitcoin de nível empresarial vai para além da codificação de algumas funcionalidades da aplicação. Normalmente, requer um design arquitetónico, protocolos de teste minuciosos e uma implementação estruturada que pode abranger várias fases (programas piloto iniciais, testes de mercado limitados e eventual implementação global).

Na frente da contabilidade, as transacções de alta frequência exigem **exportações totalmente personalizadas** e, por vezes, sincronização em tempo real com software financeiro empresarial. As grandes empresas podem depender de soluções de planeamento de recursos empresariais (ERP), como SAP ou Oracle, que, por sua vez, devem interagir perfeitamente com os dados de pagamento Bitcoin. Para facilitar isto, as APIs da plataforma escolhida devem ser sofisticadas e flexíveis, dando às equipas de TI a liberdade de criar painéis de relatórios personalizados, implementar processos de reconciliação automatizados e gerar resumos financeiros diários ou mesmo de hora a hora.

Um cenário empresarial típico pode envolver um grande mercado de comércio eletrónico que recebe milhares de transacções por dia. Além de simplesmente listar o Bitcoin como uma opção de pagamento, este mercado pode adaptar todos os aspectos da experiência do utilizador, desde a forma como o fluxo de pagamento Bitcoin aparece no site virado para o cliente até à forma como os reembolsos, estornos ou resoluções de litígios são geridos no back end. Uma equipa de desenvolvimento dedicada, em colaboração com os departamentos financeiro e jurídico, supervisionaria a manutenção contínua, os patches de segurança e as actualizações de conformidade. Caso a empresa opte por reter uma parte das suas receitas em Bitcoin, um sistema de tesouraria interno registaria as participações em Bitcoin da empresa juntamente com as reservas de moeda tradicionais.

Para garantir uma implementação tranquila e segura a nível empresarial, a maioria das organizações envolve fornecedores de serviços especializados ou equipas de desenvolvimento internas com experiência em integrações Bitcoin e Lightning Network. O processo começa normalmente com uma avaliação aprofundada das necessidades (abrangendo a infraestrutura técnica, os requisitos de conformidade e o percurso desejado do cliente), seguida da conceção de uma arquitetura capaz de lidar com um elevado volume de produção. Dependendo do âmbito do projeto, pode recorrer a uma equipa multidisciplinar composta por controladores financeiros, analistas de segurança e engenheiros de software. Em alternativa, um número crescente de empresas de consultoria especializadas pode orientá-lo desde a concetualização inicial até à implementação final, ajudando-o em tarefas como a avaliação de soluções alojadas em SaaS, a configuração de *Provedores de Serviços Lightning* e a personalização de interfaces front-end. Ao estabelecer parcerias com especialistas no domínio, as empresas podem reduzir os riscos associados à implementação de pagamentos em grande escala e obter uma solução que não só é robusta e compatível, mas também suficientemente flexível para acomodar o crescimento futuro.

## Soluções de pagamento Bitcoin: Opções e tendências

<chapterId>59ff43a1-98e2-4a81-af3e-9654bdd60952</chapterId>

Existem sempre soluções de compromisso para cada categoria de solução. Por exemplo, na "fase de teste" inicial, as carteiras sugeridas são concebidas para serem tão simples quanto possível em termos de interface de utilizador, mas são alojadas (**custodial**). Isto significa que os fundos são controlados pelo fornecedor da aplicação. No entanto, o ethos da Bitcoin encoraja a evolução para a propriedade total dos fundos pelo utilizador (**autocustodial**). Neste caso, recomenda-se a atualização para a categoria seguinte assim que as primeiras vendas forem efectuadas - essencialmente, assim que for confirmado que tem clientes dispostos a pagar em Bitcoin.

Uma das principais vantagens da Bitcoin é a capacidade de movimentar fundos à vontade, tornando **muito fácil mudar de fornecedor** ou de componentes da sua solução. Além disso, todas as aplicações e soluções estão a evoluir rapidamente. Por exemplo, considere a Bitcoinize, que agora fornece um terminal físico de ponto de venda (POS) que se integra com muitas aplicações no mercado, uma solução que não existia há apenas alguns meses.

### Procura uma solução para criar uma loja e aceitar pagamentos tradicionais e em Bitcoin?

Se está a começar do zero - sem loja, sem software de gestão de produtos e sem sistema de ponto de venda (POS) - tem algumas opções:


- **Subcontratação:** Pode subcontratar a criação de um sítio Web com opções de compras e, em seguida, adicionar capacidades de pagamento Bitcoin juntamente com soluções tradicionais na loja.
- **Soluções simples:** Em alternativa, pode utilizar plataformas como Accessing.app para o fazer você mesmo. Os principais benefícios incluem:
    - Criação rápida e económica de uma loja online ou física.
    - Adequado para negócios sazonais, eventos, restaurantes ou lojas de retalho.
    - Definição e gestão de produtos para venda física e online.
    - Processamento de pagamentos Fiat (por exemplo, euros, dólares) através da sua própria conta Stripe.
    - Processamento de pagamentos em Bitcoin através da sua própria conta SwissBitcoinPay.

### Como está a progredir a adoção do Pagamento Relâmpago?

Embora a Lightning Network ofereça uma eficiência superior e taxas mais baixas, a sua adoção ainda está numa fase inicial. Em vez de se concentrar nas limitações actuais, vale a pena recordar como se desenrolaram as transformações históricas das infra-estruturas:


- Quando os automóveis surgiram, não havia carros suficientes para justificar a construção de estradas, nem estradas suficientes para justificar a posse de automóveis.
- Quando a eletricidade foi introduzida, não havia clientes suficientes para justificar a construção de redes eléctricas, nem redes suficientes para atrair clientes.

As novas infra-estruturas têm sucesso porque são mais eficientes e os primeiros utilizadores aderem porque colhem benefícios tangíveis. Eis algumas observações sobre a Lightning Network em 2024:


- **Transacções ultra-rápidas:** As transacções são muitas vezes quase instantâneas (<500ms) e têm uma taxa de falhas extremamente baixa.
- **Profissionalização da rede:** Os maiores intervenientes estão a assegurar a liquidez em toda a rede, enquanto os indivíduos deixaram de encaminhar pagamentos e agora gerem sobretudo "nós de extremidade"
- **Melhoria da experiência do utilizador:** As aplicações móveis para utilizadores individuais melhoraram significativamente. Funcionalidades como splicing, facturas Bolt12 estáticas e pagamentos de confirmação zero (0-conf) estão amplamente disponíveis, tornando as interações perfeitas. Os problemas de interoperabilidade (por exemplo, force-closes) já não são uma grande preocupação.
- Gestão melhorada de nós e canais: As soluções individuais e profissionais avançaram. Por exemplo, o BTC Pay Server suporta agora numerosos plugins para ligação a outros fornecedores (PSPs, rampas on/off, etc.). Novos fornecedores de infra-estruturas, como a LightSpark e a Alby Hub, estão também a entrar em produção.
- **Crescimento da adoção por parte dos comerciantes:** Comerciantes como a BitRefill estão a registar um aumento dos pagamentos em Bitcoin entre os seus utilizadores activos, com uma clara mudança para a Bitcoin em detrimento da Lightning. Além disso, as taxas ultrabaixas do Lightning fazem dele a escolha preferida para pequenos pagamentos (média de 32 euros por transação).

![BIZ101-profiles](assets/pt/029.webp)

*[Fonte: BTC Map](https://btcmap.org/)*


- **Métricas da rede:** O número total de canais e Bitcoin bloqueados no Lightning permanece estável, com aproximadamente 20.000 nós, 5.200 BTC e 60.000 canais. No entanto, isto reflecte apenas uma parte da rede e indica uma rotação entre os participantes, com menos indivíduos e mais profissionais a participar.
- **Lightning como uma ponte entre redes:** A eficiência e a disponibilidade da Lightning Network já a posicionaram como uma ponte para outras redes interconectadas (por exemplo, FediMint, Liquid, etc.).

**O regresso da carteira**

A Bitcoin e a Lightning Network estão a completar a **revolução das carteiras digitais**. Novos serviços web permitem agora **transacções sem a necessidade de criar uma conta** - a sua carteira torna-se a sua identidade! Com protocolos como o **Nostr Wallet Connect (NWC)** e o **LN-URL-AUTH**, as carteiras podem autenticar utilizadores sem problemas e permitir transacções sem contas tradicionais. Já se foram os dias de cansaço com contas para simples compras ou assinaturas. Acabou-se a necessidade de fornecer informações pessoais ou de pagamento que podem acabar por ser pirateadas e vendidas na dark web, como nos recordam com demasiada frequência os acontecimentos recentes.

![BIZ101](assets/pt/030.webp)

Os comerciantes de amanhã vão adotar esta inovação, oferecendo aos clientes uma experiência mais segura e sem descontinuidades (um clique) que também respeita a sua privacidade.

# Contabilidade da Bitcoin

<partId>d49d7595-a189-4e2b-bd60-c19e8e717aa2</partId>

## Princípios essenciais para o bitcoin contabilístico nas empresas

<chapterId>84063061-ffdb-4b1f-b20b-588ffb146877</chapterId>

O conteúdo que se segue destina-se apenas a fins educativos e não deve ser considerado como aconselhamento financeiro ou contabilístico. Recomenda-se vivamente às empresas e aos particulares que consultem um contabilista qualificado ou um perito jurídico familiarizado com os regulamentos relativos às criptomoedas na sua jurisdição específica antes de tomarem qualquer medida.

### Conceitos-chave da contabilidade Bitcoin

**Qualquer transação de Bitcoin deve ser registada e pode dar origem a um evento tributável**

A nível mundial, a Bitcoin é frequentemente classificada não como uma moeda, mas como um ativo digital. Esta distinção tem um impacto significativo na forma como a Bitcoin é contabilizada nas empresas, influenciando as obrigações fiscais, os relatórios financeiros e os requisitos de conformidade. As empresas que aceitam a Bitcoin como método de pagamento ou a utilizam como ferramenta de tesouraria devem compreender estas nuances regulamentares.

A **consequência mais importante** a ter em conta é que, na maioria das jurisdições, ganhar, vender, negociar ou utilizar Bitcoin para efetuar compras, cria normalmente **um evento tributável** e os ganhos estão sujeitos ao imposto sobre as mais-valias.

Outro aspeto da contabilidade Bitcoin é a diferenciação entre dois tipos de mais-valias:


- **Ganhos/perdas latentes:** Ganhos ou perdas não realizados com base no valor da Bitcoin detida no final de um período contabilístico.
- **Ganhos/Perdas efectivos:** Ganhos ou perdas realizados quando o Bitcoin é vendido ou trocado durante o ano fiscal.

Estes cálculos dependem em grande medida do facto de a Bitcoin ser detida para investimento a longo prazo ou para utilização operacional a curto prazo. Além disso, as empresas devem alinhar as suas práticas contabilísticas com as estruturas fiscais locais, uma vez que os regulamentos variam significativamente de país para país.

A contabilidade para empresas que possuem Bitcoin é um pouco complicada porque cada transação deve ser meticulosamente rastreada para calcular lucros ou perdas realizados ou não realizados. Para cada venda que se faz aceitando Bitcoin como forma de pagamento, ou cada vez que se compra ou vende Bitcoin, é necessário registar:


- a hora específica
- o preço de venda (em moeda fiduciária)
- o preço de custo do Bitcoin (o preço a que o Bitcoin foi inicialmente adquirido).

Isto permitir-lhe-á, mais tarde, calcular a diferença para determinar o lucro ou a perda.

**Exemplo:** Uma empresa compra 1 BTC por $30.000. Mais tarde, vende 0,5 BTC por $20.000. Para calcular o lucro ou a perda, a empresa deve:


- Registou a hora, o preço de custo fiduciário e a quantidade de Bitcoin adquirida
- Registou a hora, o preço de venda fiduciário e a quantidade de Bitcoin vendida
- Determinar o custo do Bitcoin vendido: 0,5 BTC: $30.000 ÷ 2 = $15.000.
- Compare o preço de venda com o preço de custo: $20.000 (preço de venda) - $15.000 (preço de custo) = $5.000 de lucro.
- Atualizar as participações em Bitcoin com o novo preço de custo

Este processo tem de ser repetido para cada transação, e a natureza flutuante do preço da Bitcoin torna a manutenção de registos ainda mais complicada.

**Como funcionaria se a Bitcoin fosse uma moeda?**

Se o Bitcoin fosse tratado como uma moeda, as empresas iriam geri-lo como qualquer outra moeda no seu sistema de contabilidade. Em vez de acompanhar a base de custos e os lucros realizados/não realizados para cada transação, as participações em Bitcoin seriam simplesmente registadas numa conta de moeda. No final de cada período de reporte, o valor de todas as participações em moeda, incluindo a Bitcoin, seria convertido para a moeda contabilística (por exemplo, USD ou EUR) utilizando a taxa de câmbio atual.

**Exemplo atualizado se a Bitcoin fosse reconhecida como moeda:**


- Uma empresa detém 1 BTC quando a Bitcoin vale $30.000. Mais tarde, a empresa utiliza 0,5 BTC para um pagamento quando a Bitcoin vale $40.000.
- A empresa **não** calcula os lucros ou perdas realizados. Em vez disso, a transação é registada como:
    - Pagamento: $20.000 (0,5 BTC × $40.000).
    - Saldo restante de Bitcoin: 0.5 BTC, agora no valor de $20.000 (atualizado à taxa de câmbio atual).

**Vantagem chave se a Bitcoin fosse reconhecida como moeda:**


- A empresa só precisa de ajustar o equivalente fiduciário das suas participações em Bitcoin periodicamente (por exemplo, para relatórios mensais ou anuais), tal como para euros, ienes ou outras moedas que detenha.
- Isto elimina a necessidade de rastreio da base de custos ao nível da transação e simplifica a contabilidade, especialmente para empresas com transacções frequentes de Bitcoin.

Esta abordagem tornaria a contabilidade da Bitcoin muito mais simples, reduziria os encargos administrativos e alinharia com o tratamento de outras moedas, assumindo que a Bitcoin seria totalmente reconhecida como tal em termos legais e regulamentares. Ainda não chegámos a esse ponto.

### Distinções entre a contabilidade do Bitcoin individual e empresarial

O tratamento jurídico e contabilístico da Bitcoin difere significativamente entre pessoas singulares e colectivas. Para as pessoas singulares, os ganhos das transacções de Bitcoin podem estar sujeitos a imposto sobre o rendimento, muitas vezes a uma taxa mais elevada. Em contraste, as empresas podem beneficiar de taxas de imposto sobre as sociedades potencialmente mais baixas, mas devem aderir a normas contabilísticas mais rigorosas.

Para as empresas, a Bitcoin pode ser classificada em várias contas, dependendo da sua utilização prevista:


- **Activos fixos:** Para a Bitcoin detida a longo prazo como um investimento estratégico.
- **Acções:** Para a Bitcoin utilizada nos processos de produção (um caso de utilização raro, por exemplo, é o caso dos comerciantes profissionais).
- **Contas de Caixa ou Tesouraria:** Para Bitcoin detido como ativo líquido, principalmente para transacções operacionais ou gestão de tesouraria a curto prazo.

A escolha da classificação depende da atividade e da estratégia da empresa, com implicações para a informação financeira e as obrigações fiscais. Verifique sempre a regulamentação local, uma vez que estas classificações podem diferir consoante o país.

### Quadro jurídico

O reconhecimento legal e o tratamento da Bitcoin variam consoante a jurisdição. Alguns países, como El Salvador, reconheceram a Bitcoin como moeda com curso legal, simplificando a sua utilização em transacções, mas complicando os relatórios financeiros internacionais. Outros tratam a Bitcoin como um ativo digital sujeito a regras fiscais e contabilísticas específicas.

Na maioria dos países, a Bitcoin é classificada como um ativo digital e o seu tratamento é regido por normas contabilísticas gerais. As empresas devem contabilizar as transacções de Bitcoin da seguinte forma:


- **Registo de ganhos/perdas de capital:** As empresas devem contabilizar os ganhos ou perdas realizados nos seus resultados financeiros.
- **Avaliação de ganhos/perdas latentes:** Os ganhos ou perdas não realizados devem ser frequentemente comunicados, mas podem não ter impacto direto no rendimento tributável.
- **Conformidade com as normas contabilísticas:** As empresas devem integrar as transacções Bitcoin nas práticas contabilísticas normais, garantindo transparência e precisão.

A abordagem da contabilidade da Bitcoin varia consoante a geografia:


- **Estados Unidos:** O IRS classifica a Bitcoin como **propriedade, semelhante a acções, obrigações ou bens imóveis**. Esta classificação significa que qualquer transação que envolva criptomoeda, como ganhar, vender, negociar ou mesmo utilizá-la para fazer compras, pode criar um evento tributável e os ganhos estão sujeitos ao imposto sobre mais-valias.
- **União Europeia:** Os Estados-Membros tratam geralmente a Bitcoin como um ativo especulativo e não como uma moeda funcional. Por conseguinte, os ganhos estão frequentemente sujeitos ao imposto sobre as mais-valias.
- **Ásia:** Países como Singapura e Japão adoptaram quadros regulamentares progressivos, tratando favoravelmente as transacções de Bitcoin em contextos específicos. Mas a Bitcoin é geralmente contabilizada como **activos intangíveis** e é medida pelo justo valor à data do relatório, sendo as alterações reconhecidas nos lucros ou perdas.

É essencial compreender a regulamentação do seu país de atividade e adaptar as suas práticas contabilísticas em conformidade.

### Desafios na evolução da regulamentação

O ritmo acelerado da inovação em matéria de criptomoeda ultrapassa frequentemente os quadros regulamentares. Desde o reconhecimento da Bitcoin como um ativo digital, as regulamentações globais têm sofrido actualizações incrementais, mas continuam a existir lacunas:


- **Falta de jurisprudência:** Poucos casos jurídicos esclareceram práticas contabilísticas específicas, deixando margem para interpretação.
- **Debates em curso:** Questões como o tratamento fiscal das perdas latentes continuam por resolver em muitas jurisdições.
- **Complexidade transfronteiriça:** As empresas que operam a nível internacional enfrentam desafios para conciliar as diferentes normas contabilísticas nacionais.

Apesar destes desafios, as posições proactivas de muitos países fornecem uma base sólida para as empresas incorporarem a Bitcoin nas suas operações. As actualizações contínuas e a harmonização internacional serão essenciais para abordar as complexidades emergentes na contabilidade da criptomoeda.

### Classificação da Bitcoin nas Demonstrações Financeiras

A classificação da Bitcoin nas demonstrações financeiras varia consoante a jurisdição e depende da sua utilização prevista numa empresa. Em termos gerais, a Bitcoin é tratada como um ativo digital, semelhante a um inventário, investimento ou moeda, mas com caraterísticas únicas que influenciam o seu tratamento contabilístico.


- **Ativo digital ou ativo intangível**: Muitas jurisdições, incluindo a França e a União Europeia, classificam a Bitcoin como um ativo digital ou intangível e não como moeda legal. Esta classificação exige que as empresas contabilizem a Bitcoin de forma diferente das moedas fiduciárias.
- **Inventário**: Se a atividade principal de uma empresa envolve a negociação de Bitcoin, como trocas ou corretores de criptomoeda, o Bitcoin é classificado como inventário. Neste caso, a avaliação segue as normas de contabilidade de inventário.
- **Investimento financeiro**: As empresas que detêm a Bitcoin como um ativo a longo prazo podem classificá-la como um investimento financeiro. Por exemplo, nos Estados Unidos, as empresas poderiam contabilizar a Bitcoin de acordo com as diretrizes do Financial Accounting Standards Board (FASB), reconhecendo imparidades quando os valores de mercado diminuem.

**Implicações da classificação :**


- As participações a longo prazo requerem frequentemente testes de imparidade e amortização.
- As actividades activas de negociação ou relacionadas com pagamentos exigem um acompanhamento constante dos ganhos e perdas realizados e não realizados.

### Métodos de avaliação

Os métodos de avaliação são técnicas contabilísticas utilizadas para determinar a base de custos da Bitcoin, que é essencial para calcular com precisão os ganhos ou perdas durante as transacções. Em geral, é melhor **manter um valor sempre atualizado dos custos actuais das participações em Bitcoin** no sistema de contabilidade. Isto garante a transparência, o cumprimento dos regulamentos fiscais e evita atrasos quando é necessário efetuar cálculos.


- **Primeiro a entrar, primeiro a sair (FIFO)**: Comum em jurisdições como a Austrália e a Índia, este método valoriza a Bitcoin com base no custo de aquisição mais antigo. Isto pode tornar-se bastante **complexo**, uma vez que pode exigir o acompanhamento de cada fração de uma bitcoin separadamente quando ocorre uma venda.
- **Custo médio ponderado (CMP)**: Frequentemente preferido para transacções de grande volume devido à sua **simplicidade**, como se vê em países como os Estados Unidos.

É altamente recomendável manter um livro de trabalho detalhado que acompanhe os custos da Bitcoin **desde o momento em que uma empresa começa a comprar Bitcoin ou a aceitá-la como pagamento** para garantir uma manutenção de registos precisa e organizada. Esta consideração deve ser a principal preocupação ao escolher uma solução de software para aceitar pagamentos em bitcoin ou para comprar bitcoin.

### Contabilidade das transacções no comércio retalhista e eletrónico

Os retalhistas devem registar, para cada transação, a taxa de câmbio da Bitcoin para a Fiat. Por exemplo, em muitos países, as empresas utilizam a taxa de câmbio no momento da venda para calcular o IVA.

As empresas devem certificar-se de que as ferramentas de **pagamento** que estão a utilizar permitem:


- gerar uma fatura com o montante fiduciário local (euros, dólares, libras), o IVA ou outros impostos locais, o equivalente em bitcoin, a data e a hora, a taxa de câmbio do bitcoin e a fonte de câmbio, etc
- exportar todos os recibos de pagamento, no mínimo em formato .csv, com todas as informações acima referidas, de modo a que o contabilista os possa processar facilmente
- idealmente, manter um registo do valor atualizado da base de custos para o Bitcoin corrente detido em tesouraria

### Desafios


- **Volatilidade**: O preço do Bitcoin flutua significativamente, criando dificuldades na avaliação das participações e na previsão de resultados financeiros futuros.
- **Controlo regulamentar**: Em países como a China, o estatuto restrito da Bitcoin limita a sua utilização como ativo de tesouraria.
- **Incerteza regulamentar**: O cenário regulatório em evolução do Bitcoin muitas vezes deixa as empresas no limbo. Por exemplo, as alterações nas políticas fiscais, como as da Índia ou dos Estados Unidos, podem afetar as práticas contabilísticas de um dia para o outro.
- **Riscos de má gestão**: A classificação inadequada ou a incapacidade de monitorizar as transacções de Bitcoin pode levar a problemas de conformidade, penalizações ou danos à reputação.
- **Riscos de requalificação**: A manutenção de uma parte significativa da tesouraria de uma empresa em Bitcoin expõe a empresa a potenciais perdas decorrentes de quedas de preços. Isto pode ter consequências graves, particularmente se essas quedas ocorrerem quando os pagamentos a fornecedores, empregados ou impostos são devidos. Além disso, o proprietário da empresa pode ser responsabilizado, o que pode resultar em multas ou outras questões legais, como acusações de uso indevido de activos da empresa.

## Ferramentas e software de contabilidade

<chapterId>e7b31be5-1176-4835-944e-3cba1b7040fa</chapterId>

Quando uma empresa decide integrar o Bitcoin na sua contabilidade, várias ferramentas e software especializado simplificam a recolha e o processamento de dados. Entre as soluções mais conhecidas estão [CoinTracker](https://www.cointracker.io/), [Waltio](https://www.waltio.com/), [Cryptio](https://cryptio.co/), [Koinly](https://koinly.io/), [TokenTax](https://tokentax.co/), e [ZenLedger](https://zenledger.io/). Estas plataformas centram-se essencialmente em quatro aspectos:


- recolha automática de dados;
- conversão destes dados em formatos compatíveis com os programas de contabilidade mais gerais (QuickBooks, Xero, ERP);
- cálculo das obrigações fiscais;
- categorização de transacções.

São frequentemente um complemento inteligente para grandes organizações com várias carteiras e activos em várias plataformas ou bolsas.

![BIZ101](assets/pt/031.webp)

No entanto, um simples ficheiro `.csv` contendo o histórico de transacções é muitas vezes suficiente para a maioria das pequenas empresas. O objetivo é documentar, para cada pagamento, a data, o montante, o valor equivalente em euros/dólares e os endereços Bitcoin relevantes. A grande maioria das soluções de pagamento Bitcoin (BTC Pay Server, Swiss Bitcoin Pay, etc.) ou das plataformas de câmbio (Bitfinex, Kraken, Coinbase, etc.) já oferecem um mecanismo de exportação do histórico das transacções. Ao fornecer este ficheiro a um contabilista, torna-se possível simplificar a introdução de dados e distinguir claramente os fluxos de entrada e de saída relacionados com a Bitcoin.

Para aqueles que fazem a autocustódia da sua Bitcoin, a gestão de UTXOs (*Unspent Transaction Outputs*) é um passo importante. A rotulagem adequada de UTXO ajuda a rastrear a origem de cada fragmento de BTC, a diferenciar as transacções relacionadas com a atividade profissional das que se destinam a despesas pessoais e a facilitar a rastreabilidade para fins legais ou fiscais. A maioria dos bons softwares de carteira Bitcoin permite-lhe importar a sua carteira usando o seu ficheiro de backup (ou o seu xpub, dependendo da sua configuração) e etiquetar UTXOs com base na sua origem ou destino. Para o ajudar, aqui está um tutorial completo dedicado a esta prática:

https://planb.academy/tutorials/privacy/on-chain/utxo-labelling-d997f80f-8a96-45b5-8a4e-a3e1b7788c52

Finalmente, quer se trate de um pequeno comerciante ou de uma empresa mais estabelecida, é possível **liquidar uma fatura em Bitcoin**. A chave é documentar corretamente a transação. Se pagar a partir de uma carteira com custódia própria, o ideal é gerar uma transação anotando o número da fatura e a finalidade do pagamento nas suas etiquetas. Se preferir liquidar a fatura através de uma bolsa, terá também a opção de exportar um recibo ou histórico de transacções para incluir nos seus registos contabilísticos. Esta transparência simplificará o acompanhamento e a elaboração de relatórios de todas as suas operações BTC.

## Exemplos práticos de contabilidade Bitcoin

<chapterId>763f6f20-9181-495a-bf7d-b405899e65ec</chapterId>

### Caso de utilização 1: Loja de retalho que converte pagamentos em Bitcoin para euros

**Cenário**: Uma pequena padaria aceita Bitcoin como método de pagamento, mas converte imediatamente todas as Bitcoin recebidas em euros para evitar a exposição à volatilidade das criptomoedas.

**Exemplo**:


- **Taxa de conversão de Bitcoin**: 1 Bitcoin = €40.000.
- **Transação 1**: O cliente compra vários produtos de pastelaria por 20 euros.
    - Equivalente em Bitcoin: (20 / 40.000) = 0,0005 Bitcoin = 50.000 Satoshis.
    - Taxa de conversão: 1,5% (20 euros × 0,015) = 0,30 euros.
    - Líquido recebido: 20 euros - 0,30 euros = 19,70 euros.
- **Transação 2**: O cliente compra café por 5 euros.
    - Equivalente em Bitcoin: (5 / 40.000) = 0,000125 Bitcoin = 12.500 Satoshis.
    - Taxa de conversão: 1,5% (5 euros × 0,015) = 0,075 euros.
    - Líquido recebido: 5 euros - 0,075 euros = 4,93 euros.

**Resumo das transacções**:


- **Vendas totais**: 25 euros.
- **Total das taxas**: 0,375 euros.
- **Euros líquidos recebidos**: 24,625 euros.

**Implicações contabilísticas**:


- Registar as vendas totais (25 euros) como receitas.
- Deduzir as taxas de conversão (0,375 euros) como uma despesa.
- Não aparecem no balanço quaisquer participações em Bitcoin, uma vez que todos os montantes foram imediatamente convertidos.

### Caso de utilização 2: Loja de retalho que retém 50% dos pagamentos em Bitcoin

**Cenário**: A mesma padaria opta por reter 50% dos pagamentos em Bitcoin como um ativo de tesouraria, enquanto converte os outros 50% em euros.

**Exemplo**:


- **Taxa de conversão de Bitcoin**: 1 Bitcoin = €40.000.
- **Transação do cliente**: O cliente compra produtos de pastelaria por 50 euros.
    - Equivalente em Bitcoin: (50 / 40.000) = 0,00125 Bitcoin = 125.000 Satoshis.
    - Conversão (50%): 25 euros de Bitcoin = 0,000625 Bitcoin = 62 500 Satoshis.
        - Taxa de conversão: 1,5% (25 euros × 0,015) = 0,375 euros.
        - Líquido recebido em euros: 25 euros - 0,375 euros = 24,625 euros.
    - Retido em Bitcoin (50%): 62.500 Satoshis = 0,000625 Bitcoin.

**Resumo**:


- **Vendas totais**: 50 euros.
- **Taxas**: 0,375 euros.
- **Euros líquidos recebidos**: 24,625 euros.
- **Bitcoin retido**: 62.500 Satoshis.

**Implicações contabilísticas**:


- Registar as vendas totais (50 euros) como receitas.
- Deduzir as taxas de conversão (0,375 euros) como uma despesa.
- A Bitcoin retida (62.500 Satoshis) aparece no balanço como um ativo digital.
- Ganho não realizado: se a avaliação do bitcoin no final do ano fiscal for maior ou menor, haverá um ganho ou perda não realizado que será divulgado nas notas financeiras, mas não realizado como receita

### Caso de utilização 3: Serviço profissional que retém Bitcoin para investimento a longo prazo

**Cenário**: Um designer gráfico freelancer aceita Bitcoin como pagamento e retém todas as Bitcoin recebidas como um investimento a longo prazo.

**Exemplo**:


- **Taxa de conversão de Bitcoin no momento do pagamento**: 1 Bitcoin = €30.000.
- **Transação do cliente**: O cliente paga por serviços no valor de 3.000 euros.
    - Equivalente em Bitcoin: (3.000 / 30.000) = 0,1 Bitcoin = 10.000.000 Satoshis.
- **Avaliação de fim de ano**:
    - Taxa de conversão do Bitcoin no final do ano: 1 Bitcoin = 35 000 euros.
    - Avaliação da participação na Bitcoin: 0.1 Bitcoin × 35 000 euros = 3 500 euros.
    - Ganho não realizado: 3.500 euros - 3.000 euros = 500 euros.

**Resumo**:


- **Total das receitas reconhecidas**: 3.000 euros.
- **Detenção de Bitcoin**: 0.1 Bitcoin avaliado em 3.500 euros no balanço.
- **Ganho não realizado**: 500 euros divulgados em notas financeiras mas não realizados como rendimento.

**Implicações contabilísticas**:


- Registar a receita (3 000 euros) no momento da prestação do serviço.
- A Bitcoin reteve (0,1) no valor de 3 500 euros no balanço.
- Os ganhos não realizados são registados mas não incluídos nas demonstrações de resultados.

### Caso de uso 4: Proprietário de empresa vende 50% do Bitcoin após aumento de preço

**Cenário**: O proprietário de uma empresa faz três compras de Bitcoin durante o ano, mantém o Bitcoin como um ativo e vende 50% após um aumento significativo do preço.

**Exemplo**:


- **Compras de Bitcoin de clientes**:
...
- **Total de Bitcoins detidos**: 0.3867 Bitcoin = 38.670.000 Satoshis.
- **Avaliação de fim de ano**:
    - Preço da Bitcoin no final do ano: 40 000 euros/BTC.
    - Valor total: 0,3867 Bitcoin × 40 000 euros = 15 468 euros.
    - Ganho não realizado: €15.468 - €10.000 (custo total) = €5.468.
- **Venda de 50% do Bitcoin**:
    - Bitcoin Vendido: 0.19335 Bitcoin.
    - Receitas da venda: 0.19335 Bitcoin × €40.000 = €7.734.
    - Base de custos (média ponderada):
        - Custo total: 2.000 euros + 3.000 euros + 5.000 euros = 10.000 euros.
        - Preço médio ponderado: 10.000 euros / 0,3867 Bitcoin = 25.850 euros/BTC.
        - Custo do Bitcoin vendido: 0,19335 Bitcoin × 25 850 euros = 4 999 euros.
    - Ganho realizado: 7.734 euros - 4.999 euros = 2.735 euros.

**Resumo**:


- **Bitcoin restante**: 0.19335 Bitcoin avaliadas em €7.734 (a €40.000/BTC).
- **Ganho realizado**: €2.735 incluído na demonstração de resultados.
- **Ganhos não realizados**: €5.468 divulgados em notas financeiras (incluindo o valor não realizado do Bitcoin remanescente).

**Implicações contabilísticas**:


- Registar o produto da venda (7.734 euros) como rendimento.
- Deduzir o custo da Bitcoin vendida (€4.999) para calcular o ganho realizado.
