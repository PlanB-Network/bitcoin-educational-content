...
![cartão de expansão de armazenamento RPI4](assets/fr/1.png)
...
![vamos começar](assets/fr/25.png)
...
![confirmar senha root](assets/fr/27.png)
...
![credenciais do usuário](assets/fr/28.png)
...
![Emparelhamento](assets/fr/31.png)
![Electrs](assets/fr/32.png)
Você então precisará inserir o endereço `Hostname` terminando em `.onion` no seu software de carteira, acompanhado pela porta `50001`. ![hostname](assets/fr/33.png)
...
![Conexão Samourai Wallet](assets/fr/36.png)
...
Vamos tomar um exemplo adicional com uma transação mais convencional, apresentando uma entrada e duas saídas: [1b1b0c3f0883a99f1161c64da19471841ed12a1f78e77fab128c69a5f578ccce](https://mempool.space/fr/tx/1b1b0c3f0883a99f1161c64da19471841ed12a1f78e77fab128c69a5f578ccce)
...
![página inicial boltzmann](assets/fr/51.png)
...
![ferramenta xpub](assets/fr/54.png)
