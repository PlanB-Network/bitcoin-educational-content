...
Коротко кажучи, інновація Біткоїну полягає в пропозиції рішення проблеми подвійної трати за допомогою використання блокчейну на основі доказу роботи (Proof of Work) з плаваючою складністю. У цифровому світі концепція власності відрізняється від тієї, що існує у фізичному світі. Дійсно, у цифровому світі все можна скопіювати та вставити, що створює проблеми з подвійною тратою для цифрових активів, які мають цінність. Довірені посередники, такі як банки, були створені для вирішення цієї технологічної проблеми та забезпечення того, що коли актив передається, він більше не належить відправнику. Але як це можна зробити без довіреного посередника? Ця проблема є аналогічною "Задачі візантійських генералів" (Byzantine Generals' Problem), проблемі координації інформації в системі, де різним учасникам не можна довіряти.
![зображення](assets/en/chapter12/13.webp)

Отже, Біткоїн є своєрідним рішенням для вирішення цієї проблеми, або принаймні для її обходу. "Генерали" Біткоїну, або майнери, виробляють блоки (інформації), а вузли Біткоїну перевіряють фінансові транзакції, використовуючи правила консенсусу, щоб забезпечити автентичність інформації. Асиметрія в енергетичних витратах між виробництвом інформації та її перевіркою забезпечує надійність інформації без довіреної третьої сторони.
