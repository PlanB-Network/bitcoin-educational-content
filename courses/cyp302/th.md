...
มาเริ่มการสอบถามของเราในด้าน[การเข้ารหัส](https://planb.academy/resources/glossary/cryptography)ด้วยหนึ่งในตอนที่มีเสน่ห์และสนุกสนานที่สุดในประวัติศาสตร์ของมัน: นั่นคือรหัสบีล [1]
...
ที่สำคัญคือ วิทยาการเข้ารหัสลับสมัยใหม่ไม่ได้เป็นเพียงการศึกษาระบบการเข้ารหัสด้วยกุญแจสมมาตรและอสมมาตรเท่านั้น (แม้ว่าจะครอบคลุมส่วนใหญ่ของสาขานี้) ตัวอย่างเช่น วิทยาการเข้ารหัสลับยังเกี่ยวข้องกับ[ฟังก์ชันแฮช](https://planb.academy/resources/glossary/hash-function)และตัวสร้างตัวเลขสุ่มเทียม และคุณสามารถสร้างแอปพลิเคชันบนพื้นฐานเหล่านี้ที่ไม่เกี่ยวข้องกับการเข้ารหัสด้วยกุญแจสมมาตรหรืออสมมาตร
...
วิธีแก้ปัญหาแรกที่พวกเขาเสนอคือ *โปรโตคอลการแลกเปลี่ยนกุญแจระยะไกล* ซึ่งเป็นชุดของกฎสำหรับการแลกเปลี่ยนกุญแจสมมาตรหนึ่งหรือมากกว่าผ่านช่องทางการสื่อสารที่ไม่ปลอดภัย โปรโตคอลนี้ปัจจุบันรู้จักกันในชื่อ *การแลกเปลี่ยนกุญแจ [Diffie-Helmann](https://planb.academy/resources/glossary/diffiehellman)* หรือ *การแลกเปลี่ยนกุญแจ Diffie-Helmann-Merkle* [2]
...
โครงร่างที่ใช้ลอการิทึมแบบไม่ต่อเนื่องพึ่งพากลุ่มไซคลิกสองประเภทหลัก: กลุ่มการคูณของจำนวนเต็มและกลุ่มที่รวมถึงจุดบน[เส้นโค้งวงรี](https://planb.academy/resources/glossary/elliptic-curve) การแลกเปลี่ยนกุญแจ Diffie Helmann ดั้งเดิมตามที่นำเสนอใน “New Directions in Cryptography” ทำงานร่วมกับกลุ่มการคูณไซคลิกของจำนวนเต็ม อัลกอริทึม[ลายเซ็นดิจิทัล](https://planb.academy/resources/glossary/digital-signature)ของ Bitcoin และโครงร่างลายเซ็น [Schnorr](https://planb.academy/resources/glossary/schnorr-protocol) ที่เพิ่งเปิดตัว (2021) ทั้งสองอิงตามปัญหาลอการิทึมแบบไม่ต่อเนื่องสำหรับกลุ่มไซคลิกเส้นโค้งวงรีเฉพาะ
...
ตัวอย่างหนึ่งของฟังก์ชันแฮชที่ได้รับความนิยมคือ **[SHA-256](https://planb.academy/resources/glossary/sha256)** (secure hash algorithm 256) ไม่ว่าจะมีขนาดของข้อมูลนำเข้าเท่าใด (เช่น 15 บิต, 100 บิต, หรือ 10,000 บิต) ฟังก์ชันนี้จะให้ค่าแฮชที่มีขนาด 256 บิต ด้านล่างนี้คุณสามารถดูตัวอย่างผลลัพธ์บางส่วนของฟังก์ชัน SHA-256 ได้
