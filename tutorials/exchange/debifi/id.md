---
name: Debifi
description: Dapatkan pinjaman tanpa jaminan yang dijamin oleh Bitcoin.
---
...
Selama berabad-abad, pinjaman tradisional telah memungkinkan untuk membiayai banyak proyek. Namun, cara ini masih lambat, mahal, dan tidak terlalu inklusif, terutama bagi mereka yang tidak memiliki akses ke infrastruktur perbankan yang solid.



Munculnya protokol Bitcoin mengantarkan era keuangan baru, yang membawa sejumlah tantangan. Salah satu tantangan ini adalah bagaimana mendapatkan likuiditas tanpa dipaksa untuk menjual Bitcoin, sehingga kehilangan eksposur terhadap potensi pertumbuhannya



Hasilnya adalah **Debifi**, sebuah platform yang memposisikan dirinya sebagai alternatif modern untuk bank. Tujuannya jelas: membuat kredit sesederhana dan setransparan mungkin, dengan menggabungkan keunggulan sistem keuangan tradisional dengan kebebasan yang ditawarkan oleh Bitcoin. Nama Debifi mencerminkan visi ini: ***Keuangan Bitcoin Terdesentralisasi***, sebuah kontraksi yang menggambarkan pertemuan antara keuangan terdesentralisasi dan inovasi Bitcoin.
...
- Rasio Loan-to-Value (LTV)** pinjaman menentukan berapa banyak uang tunai yang dapat Anda pinjam sebagai jaminan untuk Bitcoin Anda. Rasio LTV = Jumlah pinjaman / Jumlah agunan * 100. Sebagai contoh, LTV 50% berarti nilai pinjaman sama dengan 50% dari nilai Bitcoin yang disimpan.




Tutorial video Sesi BTC :
...
## Memulai dengan Debifi



Untuk memulai menggunakan Debifi, Anda memerlukan beberapa prasyarat.
...
Sebelum Anda dapat meminjam dari Debifi, pastikan Anda memiliki hal-hal berikut ini:
...
- KYC (*Know Your Customer*): tergantung pada penawaran pinjaman yang dipilih, proses verifikasi identitas mungkin diperlukan. Di Debifi, setiap penawaran menunjukkan apakah KYC diperlukan atau tidak. Jadi persiapkanlah dengan baik. KYC dilakukan oleh penyedia layanan pihak ketiga yang dapat diandalkan seperti Sumsub.
...
- Aplikasi seluler Debifi (iOS/Android) diperlukan untuk mengambil pinjaman. Anda harus mengunduh aplikasi, membuat akun, dan "menautkan" perangkat Anda (mendaftarkan perangkat ke akun Anda). Aplikasi Debifi mendukung otentikasi dua faktor (2FA) dan tanpa smartphone, Anda tidak dapat mengonfirmasi transaksi di Debifi.
...
Kunjungi [situs web resmi Debifi](https://debifi.com/app).
...
Instal aplikasi Anda sesuai dengan jenis ponsel cerdas yang Anda miliki, lalu buka aplikasi tersebut.
...
Setelah berada dalam aplikasi, klik menu **Settings**.
...
Anda akan menerima kode verifikasi melalui email. Salin dan tempel kode ini ke dalam aplikasi. Kemudian buka aplikasi Debifi di ponsel cerdas Anda dan masuk.
...
Untuk keamanan, Debifi akan meminta Anda untuk mengikuti tiga langkah.
...
- Pertama, Anda harus mengatur kode PIN yang kuat untuk mengakses aplikasi Anda nanti.
...
- Selanjutnya, siapkan autentikasi dua faktor (2FA) untuk mengaitkan perangkat Anda dengan akun menggunakan kode 2FA.
...
- Terakhir, simpan 12 kata dari kunci pribadi Anda dengan menuliskannya di media yang dapat diandalkan dan simpan di tempat yang aman. Fase ini sangat penting untuk memulihkan akun Anda dan mengelola dana Anda.
...
- Untuk keamanan tambahan, Anda bahkan dapat menambahkan passphrase.
...
Setelah Anda menyelesaikan langkah-langkah ini, klik menu **Penawaran** untuk melihat penawaran pinjaman yang tersedia. Ketika Anda mengklik salah satu penawaran, Anda akan diarahkan ke situs web Debifi.
...
### Akses situs web dan jelajahi penawaran pinjaman



Setelah perangkat Anda terhubung, buka [situs web Debifi](https://debifi.com/). Masuk untuk membuat koneksi yang aman antara aplikasi mobile Debifi dan platform web. Hal ini memudahkan Anda untuk berinteraksi dengan penawaran pinjaman yang tersedia (tampilan yang jelas tentang detail setiap penawaran) dan mengelola akun Anda.
...
Video tutorial tentang cara masuk dengan akun Anda di platform :
...
Platform ini menghubungkan Anda dengan likuiditas berkualitas institusional dan menawarkan berbagai opsi yang sesuai dengan kebutuhan Anda. Jelajahi untuk mengetahui apa saja yang tersedia. Anda juga memiliki fleksibilitas untuk menyesuaikan parameter pinjaman sesuai dengan toleransi risiko dan situasi keuangan Anda.
...
Mata uang fiat yang ditawarkan Debifi saat ini dapat dilihat di platform.
...
### Klausul kontrak yang jelas dan fleksibel



Debifi mengandalkan persyaratan pinjaman yang transparan dan fleksibel untuk memenuhi kebutuhan masing-masing pihak (pemberi pinjaman dan peminjam). Klausul-klausul utama meliputi :
...
Tahap pinjaman Bitcoin umumnya terdiri dari tiga (3) tahap:
...
Penetapan suku bunga umumnya bergantung pada LTV yang Anda pilih, jangka waktu pinjaman, volatilitas agunan, dan penilaian risiko spesifik platform. Suku bunga tetap selama jangka waktu pinjaman.



#### Fleksibilitas jangka waktu pinjaman dan pembayaran kembali
...
### Meluncurkan proses pinjaman



Untuk memilih penawaran pinjaman yang sesuai dengan kebutuhan Anda, klik untuk melihat fitur-fiturnya.
...
1. Nama lembaga pemberi pinjaman ;


2. Kisaran jumlah pinjaman;


3. Bahwa Anda akan menerima dana dalam USDC Ethereum;


4. Jangka waktu pinjaman, suku bunga dan rasio LTV;
...
Setelah Anda setuju dengan penawaran tersebut dan telah mengisi informasi yang diperlukan, klik "Permintaan Contract".
...
Kembali ke aplikasi seluler untuk ''**Sediakan kunci publik**''.
...
### Penyetoran jaminan dan penerimaan dana Anda
...
Anda juga akan menerima notifikasi ini di aplikasi seluler Anda.
...
Anda kemudian akan menerima notifikasi dari Debifi yang meminta Anda untuk membayar biaya pinjaman atau komisi agar status pinjaman Anda dapat berkembang.
...
Anda hanya perlu menandatangani transaksi yang memungkinkan Debifi untuk memotong komisi dari jaminan. Sementara itu, pemberi pinjaman Anda juga harus menandatangani transaksi pemotongan biaya, jika tidak, Debifi tidak akan dapat menerima komisinya.
...
## Pelunasan dan pemulihan agunan



Pada akhir jangka waktu yang disepakati (atau lebih awal, jika Anda menginginkannya), Anda harus melunasi pinjaman.
...
Selamat! Anda telah menyelesaikan prosesnya.
...
Pantau rasio pinjaman terhadap agunan (LTV) Anda. Siapkan peringatan (harga BTC, LTV) jika memungkinkan. Jangan biarkan rasio Anda mendekati 90%. Jika ragu, tingkatkan agunan atau lunasi lebih awal.
...
Mulailah dari jumlah yang kecil jika memungkinkan. Untuk pinjaman pertama Anda, cobalah dengan jumlah yang tidak terlalu besar untuk membiasakan diri Anda dengan prosesnya.



Gunakan hanya situs web resmi Debifi untuk mendapatkan informasi terbaru tentang Debifi, dan hindari tautan yang tidak dikenal atau phishing.  Perbarui aplikasi, lindungi ponsel cerdas Anda dengan kode PIN, dan pilih Hardware Wallet yang kompatibel.



Atau, jika Anda seorang pemberi pinjaman, video tutorial ini akan memandu Anda dalam menggunakan platform Debifi. Mulai dari memilih peminjam yang tertarik dengan penawaran Anda, hingga memberikan kunci publik, menandatangani perjanjian, mentransfer stablecoin, dan banyak lagi.
...
Sekarang Anda sudah tahu bagaimana cara menggunakan platform Debifi untuk mendapatkan pinjaman.
