...
Andate sul sito ufficiale del sistema operativo [elementare](https://elementary.io/) e scegliete un importo per sostenere il progetto. Questo passo è facoltativo.


Se si desidera scaricare gratuitamente l'immagine ISO, inserire 0 nel campo **"Altro "** e avviare il download dell'immagine ISO del sistema.
...
Scaricare un software come [Balena Etcher](https://etcher.balena.io/) o uno strumento simile, quindi avviare il software.


Selezionare l'immagine ISO di **Elementary OS** scaricata in precedenza e impostare la chiave USB come destinazione.



Fare clic sul pulsante **flash** per avviare il processo e attendere il completamento del processo prima di rimuovere la chiave USB.
...
Spegnere il computer su cui si desidera installare Elementary OS, quindi inserire la chiave USB.


All'avvio del computer, accedere al BIOS (`ESC`, `F9` o `F11` a seconda della marca) e selezionare la chiave USB come dispositivo di avvio, quindi premere `Invio` per avviare il processo di avvio.



## Installazione del sistema operativo elementare
...
Selezionare la lingua in cui si desidera installare il sistema. È possibile scegliere anche una variante regionale.
...
Selezionare il layout corrispondente alla propria tastiera. È previsto un campo per verificare che i tasti producano i caratteri corretti.
...
La modalità Elementary OS consente di testare il sistema prima di installarlo. Questa modalità consente di esplorare il Interface senza modificare nulla del disco Hard.
...
- Fare clic su **"Cancella disco e installa "** per installare direttamente sull'intero disco.
- Fare clic su **"Installazione personalizzata "** se si desidera gestire manualmente le partizioni.
...
Selezionare il disco su cui installare Elementary OS, quindi fare clic sul pulsante Continua.
...
- Fare clic su "Cancella e installa" per avviare l'installazione.
...
Al termine, fare clic sul pulsante **enter** per riavviare, quindi rimuovere la chiave USB al momento opportuno per evitare di riavviare l'installazione.
...
Confermare o modificare la lingua del sistema al momento del login.
...
Assicurarsi che il layout della tastiera sia quello desiderato.
...
Associare un account utente al sistema operativo definendo un nome utente e proteggendo l'accesso ai dati con una password alfanumerica di almeno 20 caratteri e simboli.
...
### Opzione 1: Aggiornamento tramite grafica Interface



Accedere all'**AppCenter** e fare clic sull'icona degli aggiornamenti nell'angolo in alto a destra. Attendere l'elenco degli aggiornamenti, quindi fare clic su **"Aggiorna tutto "** per avviare l'installazione.
...
È anche possibile eseguire l'aggiornamento dalla riga di comando tramite il terminale: un'opzione consigliata per la sua precisione.
...
Per i primi aggiornamenti, il sistema operativo richiede la password utente e la conferma per aggiornare i pacchetti software, anche nel kernel elementare.
