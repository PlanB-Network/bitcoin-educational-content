---
term: Пересчет сложности

definition: Периодический процесс пересчета цели сложности каждые 2016 блоков для поддержания среднего времени выпуска блока в 10 минут.
---
