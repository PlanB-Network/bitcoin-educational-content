...
definition: Đặc tính của một hệ thống nơi các thành phần được trộn đều, được sử dụng để đánh giá chất lượng của các coinjoin.
---
