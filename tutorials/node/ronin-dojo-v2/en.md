...
![storage expansion card RPI4](assets/en/1.png)
...
![user credentials](assets/en/28.png)
...
![Pairing](assets/en/31.png)
![Electrs](assets/en/32.png)
You will then need to enter the `Hostname` address ending in `.onion` in your wallet software, accompanied by port `50001`. ![hostname](assets/en/33.png)
For example, on Sparrow Wallet, simply go to the tab:
`File > Preferences > Server > Private Electrum`

![Sparrow](assets/en/34.png)
...
![Samourai Toolkit](assets/en/43.png)

Then select `Whirlpool Stat Tool`:

![WST](assets/en/44.png)
