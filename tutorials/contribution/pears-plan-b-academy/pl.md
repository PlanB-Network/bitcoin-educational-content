---
name: Plan ₿ Akademia - aplikacja Pears
...
- Linux (Debian)** → Sekcja **1.2**
- Windows** → Sekcja **1.3**
- macOS** → Sekcja **1.4**


### 1.2. Jak zainstalować Pears na Linux (Debian)?
...
#### 1.2.4. Zainstaluj Pears za pomocą npm
...
*Jeśli korzystasz z Linuksa i zainstalowałeś już Pears, możesz przejść bezpośrednio do **Kroku 2**


#### 1.3.1. Otwórz PowerShell jako administrator
...
#### 1.3.5. Zainstaluj Pears za pomocą npm
...
#### 1.3.6. Weryfikacja i inicjalizacja gruszek
...
*Jeśli korzystasz z systemu Linux lub Windows i zainstalowałeś już Pears, możesz przejść bezpośrednio do **Kroku 2**


#### 1.4.1. Sprawdź wymagania wstępne systemu
...
#### 1.4.3. Zainstaluj Node.js i npm
...
#### 1.4.4. Zainstaluj Pears za pomocą npm
...
## 3. Jak zaplanować seed ₿ Akademia na gruszkach


W sieci Pears *seed* aplikacji oznacza jej redystrybucję do innych użytkowników z własnego komputera. W praktyce, gdy seed Plan ₿ Academy, komputer staje się źródłem danych, które umożliwia innym użytkownikom pobieranie aplikacji bez polegania na centralnym serwerze.
