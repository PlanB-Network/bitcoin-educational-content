...
### Introduktion till Bittr


Bittr är ett enkelt verktyg för alla som vill få sina besparingar att växa i Bitcoin - utan en komplicerad app, identitetskontroller eller tredjepartsförvaring. Det är utformat för människor som föredrar enkelhet, integritet och full kontroll över sina pengar.


Skicka bara en vanlig banköverföring från ditt konto, så får du Bitcoin direkt till din egen Wallet. Oavsett om du vill spara varje vecka, månad eller när det passar dig, är Bittr utformat för att passa in i din rutin utan att vara i vägen.


Låt oss gå igenom hur enkelt det är att börja stapla Sats med Bittr.
...
Bittr fungerar med alla typer av Wallet inklusive app-plånböcker, mjukvaruplånböcker eller hårdvaruplånböcker.


Vi börjar med BlueWallet för nybörjare, och senare i handledningen ställer vi in den med BitBox.


## Köp Bitcoin direkt till BlueWallet
...
Wuhuu, det är det! 🤩 Så snart pengarna kommer in på Bittrs bankkonto kommer Bittr att köpa din Bitcoin, skicka Bitcoin direkt till din Wallet och mejla dig transaktionsuppgifterna (inklusive Exchange-kursen vid tidpunkten för konverteringen).
