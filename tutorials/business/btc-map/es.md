...
Empecemos. El pequeño icono de la luna o el sol en la parte superior derecha alterna entre los temas claro y oscuro.
...
Las distintas pestañas de la parte superior del sitio, de izquierda a derecha:
...
- "Mantener": participar en la actualización y enriquecimiento de los mapas
- " Wiki: el GitHub del proyecto
- "Apóyanos": las donaciones y el patrocinio son la única fuente de ingresos del proyecto



Por cierto, estas pestañas formarán el índice de este tutorial.
...
El sitio ofrece dos fichas con objetivos diferentes. Pero empecemos por describir las herramientas que aparecen en el borde izquierdo de cada una:
...
*nota: Los establecimientos potenciados son aquellos que han recibido una propina de un visitante o usuario satisfecho, lo que les otorga una visibilidad mejorada durante un tiempo*
...
El Mapa de Comerciantes enumera los establecimientos de todo el mundo que aceptan el pago en BTC. Puedes ver diferentes tipos de iconos, que son una primera pista de la naturaleza del establecimiento (una pinta para un bar, un diamante para una joyería...). Cogeré uno al azar.
...
Enseguida verás las zonas de color naranja. Como puedes ver, son las distintas comunidades de Bitcoin que aparecen en BTC Map. Si haces clic con el botón izquierdo del ratón en cualquiera de ellas, aparecerá un pequeño recuadro con todos los enlaces proporcionados, como el sitio web y las cuentas de redes sociales. Quién sabe, puede que te encuentres en medio de una comunidad activa de Bitcoin, ¡a sólo unos clics de unirte a ella si te apetece!



## Otras pestañas del sitio
...
- Cuadro de mandos: estadísticas sobre la alimentación de la base de datos, como el número de localidades incluidas o el número de verificaciones recientes realizadas
- Tagger Leaderboard: tabla de usuarios clasificados por volumen de contribución (¡únete a ellos!)
...
**Wiki**: Este enlace lleva a la página GitHub del proyecto.
...
BTC Map te permite [añadir tu propia comunidad](https://btcmap.org/communities/add/), veámoslo paso a paso:
...
Y esto es todo, hemos repasado juntos las principales características del sitio. Ahora ya sabes dónde gastar tus bitcoins gracias a BTC map
