...
# Bygg din första DIY Bitcoin-värmare
...
Den här kursen är uppbyggd kring Attakai, ett praktiskt DIY-projekt som förvandlar en begagnad S9-miner till en Bitcoin-värmare för hemmet.

Du börjar med en kortfattad översikt av Bitcoin-mining och verkligheterna inom gruvindustrin, för att sedan gå direkt till bygget: skaffa rätt hårdvara, flasha och konfigurera BraiinsOS+, ställa in nätverk, byta fläktar, gå med i en mining-pool och optimera prestanda för värme, buller och effektivitet.

Steg-för-steg-guider leder dig genom hela processen så att du kan bygga Attakai hemma och bryta dina första sats medan du värmer upp ditt utrymme.
...
Mining centralisering tas upp som en stor utmaning. Stora aktörer, såsom Foundry, dominerar marknaden, vilket potentiellt kan leda till transaktionscensur. Denna centralisering kan också göra nätverket sårbart för attacker, inklusive [51%-attacken](https://planb.academy/resources/glossary/51-percent-attack), där en aktör eller grupp kontrollerar mer än 50% av nätverkets hashingkraft, vilket gör att de kan kontrollera och manipulera nätverket.
...
Blockstorlekskrigen avslöjade den osäkerhet och spänning som finns i hanteringen av Bitcoin-nätverket. Även om [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core) för närvarande är den dominerande kedjan fortsätter debatten om styrning och nätverkshantering.
...
Kopiera sedan [Stratum](https://planb.academy/resources/glossary/stratum) Address och ditt användarnamn:
