...
Katika somo hili, utajifunza CoinJoin ni nini na jinsi ya kutekeleza moja kwa kutumia programu ya Samourai Wallet na utekelezaji wa Whirlpool, ukitumia Dojo yako mwenyewe. Kwa maoni yangu, njia hii kwa sasa ni bora kwa kuchanganya bitcoins zako.
...
- Kasi ya mizunguko ya kuchanganya ili kukuza ongezeko kubwa la anonsets.

Masharti haya yaliongoza chaguo za wasanidi wa Samourai Wallet katika muundo wa Whirlpool, na kuwafanya kuweka kikomo cha idadi ya washiriki kwa kila mzunguko. Washiriki wachache sana wangehatarisha ufanisi wa CoinJoin, na kupunguza kwa kiasi kikubwa utatuzi unaotokana na kila mzunguko, ilhali washiriki wengi sana wangeleta matatizo ya usimamizi kwenye programu za simu na ingezuia mtiririko wa mizunguko.
...
Akaunti hizi zote zimeunganishwa na seed moja, ambayo inaruhusu mtumiaji kurejesha upatikanaji wa bitcoins zao zote kwa kutumia maneno yao ya kurejesha na, ikiwa ni lazima, passphrase yao. Hata hivyo, ni muhimu kutaja kwa programu, wakati wa operesheni hii ya kurejesha, indexes tofauti za akaunti ambazo zilitumiwa.
...
Baada ya kuangazia nadharia, hebu tuzame kwenye mazoezi kwa mafunzo ya kutumia Whirlpool kupitia programu ya Android ya Samourai Wallet, iliyosawazishwa na Whirlpool CLI na GUI kwenye Dojo yako mwenyewe!

## Mafunzo: CoinJoin Whirlpool na Dojo Yako Mwenyewe
...
Ili kuanza, utahitaji kusakinisha Dojo na kupata msimbo wa QR au kiungo kitakachokuruhusu kuunganishwa nacho ukiwa mbali. Kiungo hiki ni Tor Address inayoishia kwa `.onion`. Ikiwa unatumia RoninDojo, nenda kwa menyu ya `Kuoanisha` ili kufikia maelezo haya.

![coinjoin](assets/notext/10.webp)


Chini ya `Samourai Dojo`, bofya kitufe cha `Oanisha sasa`.


![coinjoin](assets/notext/11.webp)


Msimbo wako wa QR wa muunganisho na kiungo sambamba vitaonyeshwa.


![coinjoin](assets/notext/12.webp)


Ikiwa uko kwenye Umbrel, nenda kwenye Duka la Programu na utafute programu ya `Samourai Server`. Iko kwenye kichupo cha `Bitcoin`.
...
Baada ya kufungua programu, utakuwa na idhini ya kufikia msimbo wa QR wa kuunganisha kwenye Dojo yako.
...
### Inatayarisha Samourai Wallet yako

Baada ya kurejesha maelezo ya muunganisho kwenye Dojo yako, sasa ni wakati wa kusanidi Wallet yako kwa viungio vya sarafu. Kuna matukio mawili: ikiwa bado huna Samourai Wallet kwenye smartphone yako, mchakato ni rahisi, tu kuunda mpya.


Kwa upande mwingine, ikiwa tayari una Samourai Wallet, utahitaji kusakinisha upya programu ili kuihusisha na Dojo mpya. Hatua hii ni muhimu kwa sababu muunganisho kwenye Dojo unaweza tu kuanzishwa wakati wa uzinduzi wa kwanza wa programu. Hata hivyo, kutokana na faili ya chelezo iliyosimbwa kiotomatiki na Samourai kwenye simu yako, utaratibu huu ni rahisi na wa haraka.


*Ikiwa hujawahi kutumia Samourai, unaweza kuruka hatua hizi za awali na kuendelea moja kwa moja kwenye usakinishaji wa programu.*


Kwanza kabisa, hakikisha kwamba programu yako ya Samourai Wallet imesasishwa. Ili kufanya hivyo, angalia Duka la Google Play au ulinganishe toleo la programu yako katika `Mipangilio > Nyingine` na toleo linalopatikana kwenye tovuti ya Samourai.


![coinjoin](assets/notext/17.webp)


Hakikisha kuwa una kifungu chako cha maneno cha urejeshi cha Samourai Wallet na kwamba kinasomeka. Kisha, fanya jaribio la BIP39 passphrase yako kwa kuenda kwenye `Mipangilio > Tatua matatizo > passphrase/Jaribio la Hifadhi nakala` ili kuthibitisha usahihi wake.


![coinjoin](assets/notext/18.webp)

Weka passphrase yako, kisha uthibitishe kuwa Samourai inathibitisha uhalali wake.

![coinjoin](assets/notext/19.webp)


Ikiwa passphrase yako ni batili, au kama huna kishazi chako cha kurejesha, ni muhimu kusitisha utaratibu mara moja! **Una hatari ya kupoteza bitcoins zako wakati wa operesheni hii.** Katika kesi hii, inashauriwa kuhamisha pesa zako hadi Wallet nyingine na kuanza na Samourai Wallet mpya isiyo na kitu. Hatua zifuatazo zinapaswa kufuatwa tu ikiwa una uhakika una taarifa zote muhimu za chelezo na kwamba passphrase yako ni halali.


Kisha uendelee na kuunda chelezo iliyosimbwa kwa njia fiche ya Wallet yako na uinakili kwenye ubao wako wa kunakili. Ili kutekeleza operesheni hii, bofya kwenye vitone vitatu vidogo vilivyo kwenye sehemu ya juu ya kulia ya skrini, kisha uchague `Hamisha nakala rudufu ya Wallet`.


![coinjoin](assets/notext/20.webp)


**Kuanzia hatua hii na kuendelea, usiinakili kitu kingine chochote kwenye ubao wako wa kunakili!** Ni muhimu kabisa kuweka nakala yako ya nakala.


Ikiwa umetekeleza hatua za awali kwa usahihi, sasa unaweza kufuta Samourai Wallet yako kwa usalama. Ili kufanya hivyo, nenda kwa: `Mipangilio > Wallet > Futa salama Wallet`.
...
*Ikiwa hujawahi kutumia Samourai na unasakinisha programu kutoka mwanzo, unaweza kuendelea na mafunzo kwa hatua hii.*


Programu yako ya Samourai sasa imewekwa upya. Fungua programu na uendelee na hatua za usanidi kana kwamba ulikuwa unaitumia kwa mara ya kwanza.


![coinjoin](assets/notext/23.webp)


Katika hatua inayofuata, utafikia ukurasa uliowekwa maalum kusanidi Dojo yako. Teua chaguo la `Dojo`, kisha uweke maelezo ya kuingia ya Dojo yako. Ili kufanya hivyo, una chaguo la kuchanganua habari kwa kubonyeza `Scan QR`.
...
Kwa kawaida, unapaswa kuwa na faili yako ya urejeshi kila wakati kwenye ubao wako wa kunakili. Kisha ubofye kwenye `PASTE` ili kuingiza faili yako kwenye eneo lililowekwa. Ili kuiondoa, itakuwa muhimu pia kuingiza BIP39 passphrase ya Wallet yako kwenye uwanja unaofanana, ulio chini kidogo. Kumaliza, bofya `MALIZA`.

![coinjoin](assets/notext/26.webp)


Kisha utaelekezwa kwenye Samourai Wallet yako ambayo, wakati huu, itaunganishwa kwenye Dojo yako mwenyewe.
...
Nenda kwenye kompyuta yako ya kibinafsi na upakue programu ya Whirlpool kutoka kwa tovuti rasmi ya Samourai Wallet, ukichagua toleo linalolingana na mfumo wako wa uendeshaji.


![coinjoin](assets/notext/29.webp)


Kabla ya kuzindua Whirlpool GUI, ni muhimu kusakinisha JAVA 8 au toleo la juu zaidi kwenye mashine yako. Kwa hili, [unaweza kusakinisha OpenJDK](https://adoptium.net/).

![coinjoin](assets/notext/30.webp)

Ni muhimu pia kuwa na Tor daemon au Tor Browser inayofanya kazi chinichini kwenye kompyuta yako. Hakikisha kuwa umeanzisha Tor kabla ya kila kipindi cha matumizi cha Whirlpool GUI. Ikiwa Tor bado haijasakinishwa kwenye mashine yako, [unaweza kuipakua na kuisakinisha kutoka kwa tovuti rasmi ya mradi](https://www.torproject.org/download/), kisha uhakikishe kuizindua chinichini.


![coinjoin](assets/notext/31.webp)


Mara tu JDK inaposakinishwa kwenye mfumo wako na Tor ikizinduliwa chinichini, unaweza kuanzisha Whirlpool GUI.


![coinjoin](assets/notext/32.webp)


Kutoka Whirlpool GUI, bofya kwenye `Advanced: Remote CLI` ili kuunganisha Whirlpool CLI yako ambayo iko kwenye Dojo yako. Utahitaji Tor Address ya Whirlpool CLI yako.
...
Katika Whirlpool GUI, weka Tor Address uliyopata awali katika sehemu ya `CLI Address`. Weka kiambishi awali cha `http://`, lakini usiongeze mlango wa `:8899` mwishoni. Bandika Address pekee kama ulivyopewa.

![coinjoin](assets/notext/35.webp)


Katika sehemu ya Wakala wa Tor, weka `soksi5://127.0.0.1:9050` ikiwa unatumia Tor daemon, au `soksi5://127.0.0.1:9150` ikiwa ni Kivinjari cha Tor. Unapounganisha kwa mara ya kwanza kwa Whirlpool CLI kupitia Whirlpool GUI, inawezekana kuacha sehemu ya ufunguo wa API ikiwa tupu. Ikiwa huu sio muunganisho wako wa kwanza, tafadhali weka ufunguo wako wa API katika nafasi maalum. Kitufe hiki kinaweza kupatikana kwenye ukurasa sawa na Tor Address yako.


![coinjoin](assets/notext/36.webp)


Mara tu unapojaza kila kitu, bofya kitufe cha `Unganisha`. Tafadhali subiri, muunganisho unaweza kuchukua dakika chache.


![coinjoin](assets/notext/37.webp)


### Inaoanisha Samourai yako ya Wallet na Whirlpool GUI

*Kwa watumiaji wa RoninDojo, unaweza kuendelea na mafunzo hapa.*


Sasa tutaoanisha Samourai Wallet tuliyosanidi awali na programu ya Whirlpool GUI, au moja kwa moja na RoninDojo kwa wale wanaotumia programu hii. Iwe unatumia Whirlpool GUI au RoninDojo, utaombwa kubandika au kuchanganua maelezo ya kuoanisha ya Samourai Wallet yako.


![coinjoin](assets/notext/38.webp)


Ili kupata maelezo haya, nenda kwenye mipangilio ya Wallet yako.


![coinjoin](assets/notext/39.webp)


Bofya kwenye `Shughuli`, kisha kwenye `Oanisha na Whirlpool GUI`.


![coinjoin](assets/notext/40.webp)


Kisha Samourai itakupa taarifa muhimu ili kuanzisha muunganisho. Kuwa mwangalifu, data hii ni nyeti! Unaweza kuihamisha hadi kwa Kompyuta yako kwa kuinakili moja kwa moja au kwa kuchanganua msimbo wa QR unaoonyeshwa, kwa kutumia kamera ya wavuti ya kompyuta yako baada ya kubofya alama ya msimbo wa QR.


![coinjoin](assets/notext/41.webp)


Baada ya kufanya operesheni hii, katika Whirlpool GUI, chagua `Anzisha GUI`. Tafadhali subiri, kwani hatua hii inaweza kuchukua muda.


![coinjoin](assets/notext/42.webp)


Iwe unatumia Whirlpool GUI au RoninDojo, utaombwa uweke passphrase ya Samourai Wallet yako. Ingiza katika sehemu maalum, kisha ubonyeze kitufe cha `Ingia` ili kuendelea.


![coinjoin](assets/notext/43.webp)


Kisha utawasili kwenye ukurasa wa nyumbani wa Whirlpool CLI


![coinjoin](assets/notext/44.webp)


### Kuanzisha coinjoins kutoka Whirlpool GUI

*Kwa watumiaji wa RoninDojo, mchakato wa kufuata ni sawa. Programu ya Whirlpool Interface iliyojumuishwa katika RoninDojo inatoa chaguo na utendaji sawa na programu ya Whirlpool GUI kwenye eneo-kazi. Kwa hiyo, unaweza kufuata maagizo haya kwa njia sawa.*

Sasa kwa kuwa kila kitu kimewekwa, uko tayari kuanza kuchanganya bitcoins zako. Ili kufanya hivyo, hamisha bitcoins unazotaka kuchanganya hadi kwa **Amana** akaunti ya Samourai Wallet yako. Operesheni hii inaweza kufanywa moja kwa moja kupitia programu ya Samourai Wallet au kwenye Whirlpool GUI. Kutoka kwa ukurasa kuu, bofya kitufe cha `+ Amana` kilicho juu kushoto.
...
Baada ya amana kuthibitishwa, utaweza kuiona ikionekana katika akaunti ya **Amana** kwenye Whirlpool GUI.
...
Mara tu `TX0` inapoundwa, utaweza kuona UTXO zako zilizosawazishwa katika akaunti ya **Premix**, ukisubiri uthibitisho. Ili kuruhusu sarafu zako kuchanganywa kiotomatiki saa 24 kwa siku, siku 7 kwa wiki, ninapendekeza kuwezesha chaguo la `Changanya kiotomatiki premix & postmix`. Utapata kipengele hiki kwenye kichupo cha `Usanidi`, kilicho upande wa kushoto wa dirisha lako la Whirlpool GUI.
...
UTXO zako zilizochanganywa zinaonekana kutoka kwa akaunti ya **Postmix** kwenye Whirlpool GUI. Zaidi ya hayo, una chaguo la kuzitazama na kuzitumia moja kwa moja kupitia Whirlpool Interface kwenye Samourai Wallet yako. Ili kufikia menyu hii, bofya kwenye bluu `+` chini ya skrini yako, kisha uchague `Whirlpool`.


![coinjoin](assets/notext/52.webp)


Akaunti za Whirlpool zinaweza kutambulika kwa urahisi kwenye Samourai Wallet kwa rangi yao ya buluu. Hii hukuruhusu kutumia UTXO zako zilizochanganywa kutoka mahali popote na wakati wowote, moja kwa moja kutoka kwa simu yako mahiri.
