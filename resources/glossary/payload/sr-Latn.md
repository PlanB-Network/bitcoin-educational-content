...
- `bc`: ljudski čitljiv deo (HRP) ;
- `1`: separator ;
- `q`: SegWit verzija. Ovo je verzija 0;
- `c2eukw7reasfcmrafevp5dhv8635yuqa`: teret, u ovom slučaju, Hash javnog ključa ;
- `ys50gj`: kontrolni zbir.