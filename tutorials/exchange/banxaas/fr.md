...
Aujourd'hui, l'accessibilité au Bitcoin est un challenge innovant dans les pays sous-développés ou émergents pour compenser une certaine défaillance du système financier local.
...
La première action à mener sur [banxaas](https://banxaas.com) est de définir le sens de votre échange :

- Vous avez du franc CFA et vous souhaitez échanger en bitcoin (satoshis).

![sens1](assets/fr/01.webp)

- Vous avez des bitcoins (satoshis) que vous souhaitez convertir en franc CFA.
...
- **Du franc CFA vers des satoshis** :

Banxaas couvre l'ensemble du territoire sénégalais avec deux opérateurs mobiles majeurs. À l'aide de leur intégrateur de paiement (DexchangePay), la plateforme supporte principalement :
- Orange Money
- Wave
- Wizall Money

Lorsque vous initiez une conversion de franc CFA vers bitcoin, vous ajouterez dans le champ de destination votre adresse Lightning ou une facture sans montant créée depuis votre portefeuille Lightning.
