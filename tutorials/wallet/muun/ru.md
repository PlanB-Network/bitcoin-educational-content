...
[Muun](https://muun.com/) — это самокастодиальный кошелек для биткоина и лайтнинга.
...
Полное руководство пользователя (со скриншотами) для приложения Muun; удобный мобильный кошелек для биткоина, позволяющий совершать транзакции в сети Lightning.
...
- Найдите свой код восстановления
