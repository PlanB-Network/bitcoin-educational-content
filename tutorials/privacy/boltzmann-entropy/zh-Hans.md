...
## 如何使用 Boltzmann 计算器？
使用 Boltzmann 计算器有两种选择。第一种是直接在您的机器上安装 Python 工具。或者，您可以选择 KYCP.org（_了解您的币隐私_）网站，该网站提供了一个简化的使用平台。对于 [RoninDojo](https://planb.academy/tutorials/node/bitcoin/ronin-dojo-v2-0ddb3854-6f38-4466-b4e2-f66c028e0dd8) 用户，请注意，此工具已集成到您的节点中。
