...
### Introduction à Bittr


Bittr est un outil simple pour tous ceux qui veulent faire fructifier leur épargne en Bitcoin - sans application compliquée, sans contrôle d'identité, ni garde par un tiers. Il est conçu pour les personnes qui préfèrent la simplicité, la confidentialité et le contrôle total de leur argent.


Il vous suffit d'effectuer un virement bancaire régulier à partir de votre compte, et vous recevrez Bitcoin directement dans votre propre Wallet. Que vous souhaitiez épargner chaque semaine, chaque mois ou quand cela vous convient, Bittr est conçu pour s'intégrer à votre routine sans vous gêner.


Voyons comment il est facile de commencer à empiler des Sats avec Bittr.
...
Bittr fonctionne avec n'importe quel type de Wallet, y compris les portefeuilles d'applications, les portefeuilles logiciels ou les portefeuilles matériels.


Nous commencerons par BlueWallet pour les débutants, et plus tard dans le tutoriel, nous le configurerons avec la BitBox.


## Acheter Bitcoin directement dans BlueWallet
...
Wuhuu, c'est ça ! 🤩 Dès que l'argent arrive sur le compte bancaire de Bittr, Bittr achète votre Bitcoin, envoie le Bitcoin directement à votre Wallet et vous envoie par courriel les détails de la transaction (y compris le taux du Exchange au moment de la conversion).
