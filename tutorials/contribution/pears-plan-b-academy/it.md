...
- Hyperbee**: un indice costruito in cima a Hypercore che consente di organizzare e interrogare i dati in modo efficiente.
...
*Questa guida all'installazione di Pears è suddivisa in più sezioni a seconda del sistema operativo in uso. Passate direttamente a quella corrispondente al vostro ambiente per seguire le istruzioni appropriate:*



- Linux (Debian)** → Sezione **1.2**
- Windows** → Sezione **1.3**
- macOS** → Sezione **1.4**


### 1.2. Come installare Pears su Linux (Debian)?
...
#### 1.2.2. Installare le dipendenze
...
#### 1.2.3. Installare Node.js e npm tramite NVM
...
Verificare che *NVM* sia installato correttamente:
...
### 1.3. Come installare Pears su Windows


L'installazione di Pears su Windows è altrettanto semplice che su Linux, ma richiede alcuni strumenti specifici.


*Se si utilizza Linux e si è già installato Pears, si può passare direttamente al **fase 2**


#### 1.3.1. Aprire PowerShell come amministratore
...
#### 1.3.6. Verifica e inizializzazione di Pears
...
*Se si utilizza Linux o Windows e si è già installato Pears, si può passare direttamente al **Passo 2**.*


#### 1.4.1. Verifica dei prerequisiti del sistema
...
#### 1.4.3. Installare Node.js e npm
...
#### 1.4.4. Installare Pears con npm
...
## 2. Come utilizzare l'Accademia Plan ₿ sulle pere
...
## 3. Come seed Plan ₿ Academy sulle pere


Nella rete Pears, *seed* un'applicazione significa ridistribuirla ad altri peer dal proprio computer. In pratica, quando si seed Plan ₿ Academy, il proprio computer diventa una fonte di dati che consente agli altri utenti di scaricare l'applicazione senza fare affidamento su un server centrale.
