...
시드서명자 확장 키트는 [사토칩 공식 스토어](https://satochip.io/product/seedsigner-extension-kit/)에서 구매할 수 있습니다.
...
## 시드키퍼 애플릿으로 DIY 스마트카드를 플래시하는 방법은 무엇인가요?
...
## DIY 스마트카드에서 애플릿을 삭제하려면 어떻게 하나요?
