...
description: BTCPay 서버 설정 및 관리 가이드
---

![cover](assets/cover.webp)


BTCpay 서버(https://btcpayserver.org/)는 #Bitcoin을 수락하는 가장 좋은 방법입니다. 수수료도, 중개자도 없습니다. 자주적인 개인과 기업을 위한 무료 오픈 소스 및 자체 호스팅 Bitcoin 결제 프로세서입니다.


![video](https://youtu.be/-GJr4XjRCPo?si=UIZNonwJqa9r7Lpj)

BTCpay 서버 - BTC세션으로 몇 분 안에 Bitcoin 결제 수락
