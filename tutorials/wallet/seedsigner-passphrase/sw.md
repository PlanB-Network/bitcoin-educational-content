...
## Masharti kabla ya kuongeza Nenosiri
...
## Je, ninawezaje kuongeza passphrase kwa SeedSigner?
...
Ili kuweka passphrase kwa SeedSigner yako, washa kifaa na uchanganue SeedQR yako kama kawaida. Kisha SeedSigner itaonyesha alama ya vidole ya wallet yako ya sasa, inayolingana na ile **bila passphrase**. wallet yenye passphrase itakuwa na alama ya vidole tofauti.



Bofya kitufe cha `BIP-39 Nenosiri`.
...
*Katika mfano huu, nilitumia passphrase `pba`. Walakini, kwa upande wako, hakikisha umechagua passphrase thabiti. Ili kujua jinsi ya kufafanua passphrase bora zaidi, tafadhali soma makala haya mengine:*



https://planb.academy/tutorials/wallet/backup/passphrase-a26a0220-806c-44b4-af14-bafdeb1adce7

SeedSigner kisha inaonyesha alama ya vidole mpya ya passphrase wallet yako. Tengeneza nakala kadhaa za alama hii ya vidole: ni muhimu unapotumia wallet yenye passphrase, kwani inakuwezesha kuangalia, kila wakati unapoingia kwenye passphrase, kwamba hujafanya makosa yoyote ya kuandika na kwamba unafikia wallet sahihi.
...
Mara tu unapohifadhi alama ya kidole chako, bofya `Nimemaliza`.
...
Kisha unaweza kufikia utendaji wa kwingineko yako yote, kama vile kwenye SeedSigner ya kawaida.
...
Sasa unaweza kuleta duka la vitufe kwenye Sparrow Wallet na utumie wallet yako kama kawaida. Kila wakati unapowasha upya, utahitaji kuchanganua SeedQR yako na uingize tena passphrase yako kwa kutumia kibodi, kama tulivyofanya hapa.
