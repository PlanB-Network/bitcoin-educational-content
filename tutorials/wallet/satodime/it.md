...
Satodime, una **carte au porteur, appartiene a chiunque la possieda fisicamente**, senza necessità di registrazione o identificazione preventiva. Risponde all'esigenza di un deposito Bitcoin sicuro e portatile, consentendo a chiunque sia in possesso della carta di utilizzarla o di trasferire bitcoin scansionandola tramite l'app mobile per prenderne possesso o aprire casseforti. A differenza di una banconota cartacea, utilizza un chip sicuro per Seal le chiavi private, che vengono rivelate solo dopo l'apertura, rendendo la carta simile ai contanti, dove il Ownership è determinato dal possesso fisico. Ideale per regalare bitcoin, facilita il trasferimento sicuro di bitcoin da una mano all'altra, mentre l'applicazione mobile sfrutta l'NFC per un'interazione accessibile con lo smartphone.
...
- Attenzione**: Questo passaggio è irreversibile. Consultare [l'articolo *Ownership*] (https://satochip.io/satodime-Ownership-explained/).
...
Satodime supporta fino a 3 casseforti. Createne una per memorizzare il Bitcoin :
...
- Scegliere Blockchain (Bitcoin).
- Cliccare su "*Crea & Seal*".
- Eseguire la scansione della scheda su generate e Seal la chiave privata (sconosciuta fino a quando non viene sigillata).
...
- Copiare il Address pubblico o scansionare il codice QR.
- Inviare fondi da un altro Wallet.
- Controllare il bilanciamento dopo la conferma sul Blockchain.
...
- Attenzione**: Una volta tolti i sigilli, la chiave privata è accessibile. Se qualcuno entra in possesso del vostro smartphone, può accedere a questa chiave e quindi recuperare i fondi contenuti nella vostra cassaforte (in modo irreversibile).
...
- Importarlo in un programma software Wallet compatibile con la gestione dei fondi (ad esempio, Sparrow wallet o Electrum).
...
Il reset della cassaforte cancella irreversibilmente la chiave privata associata. In altre parole, se non avete protetto una copia della vostra chiave privata o non l'avete importata in un altro Wallet, il reset della cassaforte causerà la perdita irreversibile dei fondi in essa contenuti.
...
- Prendere il Ownership della carta,
- Creare una cassaforte Bitcoin,
- Trasferire Satss lì,
- Trasferimento della carta Ownership: la persona successiva che scansiona la carta ne diventa proprietaria,
- Consegnate la carta Satodime a una persona di vostra scelta, invitandola a scaricare l'applicazione e a scansionare la carta per prenderne il Ownership e accedere così ai bitcoin "memorizzati" su di essa.
...
- Controllare lo stato**: Eseguire sempre una scansione per confermare la scheda Ownership e lo stato sigillato/non sigillato delle casseforti.
...
- Recupero**: Se la carta viene smarrita ma è di proprietà, i fondi sono sul Blockchain; utilizzare la chiave privata se non è sigillata.
...
[Plan ₿ Network](https://planb.network/) per esercitazioni su autocustodia, chiavi private, ecc.
...
**Satochip** è un'azienda belga che sviluppa soluzioni hardware e software per la gestione e l'archiviazione di bitcoin e altre criptovalute. Il suo prodotto di punta, Satochip Hardware Wallet, è una carta NFC dotata di un secure element con certificazione EAL6+. Completato dal Seedkeeper, un gestore di frasi e segreti Mnemonic, e dal Satodime, una carta al portatore, Satochip offre una gamma completa e adatta alle esigenze degli utenti. I suoi dispositivi, alimentati da software open source, mirano a democratizzare la sicurezza su Bitcoin.