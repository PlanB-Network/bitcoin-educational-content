...
Bitcoin प्रोटोकॉल [UTXO](https://planb.academy/resources/glossary/utxo) मॉडल पर आधारित है, जो "Unspent Transaction Output" (अनस्पेंट ट्रांजैक्शन आउटपुट) के लिए खड़ा है।
...
**याद दिलाना:** जीडब्ल्यू-44, जिसे अक्सर 'सैट' (sat) के नाम से छोटा किया जाता है, जीडब्ल्यू-43 की सबसे छोटी इकाई है, जो [फिएट](https://planb.academy/resources/glossary/fiat) करेंसी में सेंटाइम (centime) के बराबर है।

```plaintext
1 BTC = 100 000 000 SATS
```

थ्योरेटिकली, एक UTXO बिटकॉइन में किसी भी वैल्यू को रिप्रेजेंट कर सकता है, एक [सतोशी](https://planb.academy/resources/glossary/satoshi-sat) से लेकर थ्योरेटिकली करीब 21 मिलियन BTC तक। हालांकि, लॉजिकली 21 मिलियन बिटकॉइन का मालिक होना नामुमकिन है, और एक लोअर इकोनॉमिक थ्रेशोल्ड होता है जिसे "[Dust](https://planb.academy/resources/glossary/dust)" कहते हैं, जिसके नीचे एक UTXO को खर्च करना इकोनॉमिकली फायदेमंद नहीं माना जाता।

**क्या आप जानते हैं?** Bitcoin पर बनाया गया अब तक का सबसे बड़ा UTXO, जिसकी कीमत `500,000 BTC` थी, MtGox प्लेटफॉर्म द्वारा नवंबर 2011 में एक [समेकन](https://planb.academy/resources/glossary/consolidation) ऑपरेशन के दौरान बनाया गया था: [29a3efd3ef04f9153d47a990bd7b048a4b2d213daaa5fb8ed670fb85f13bdbcf](https://Mempool.space/fr/tx/29a3efd3ef04f9153d47a990bd7b048a4b2d213daaa5fb8ed670fb85f13bdbcf)
...
![BTC204](assets/hi/007.webp)

सभी UTXO [स्क्रिप्ट्स](https://planb.academy/resources/glossary/script) द्वारा सुरक्षित होते हैं जो यह तय करते हैं कि उन्हें किन शर्तों पर खर्च किया जा सकता है। UTXO को खर्च करने के लिए, एक उपयोगकर्ता को नेटवर्क को यह साबित करना होगा कि वह उस स्क्रिप्ट द्वारा निर्धारित शर्तों को पूरा करता है जो उस UTXO को सुरक्षित करती है। आमतौर पर, UTXO एक [पब्लिक की](https://planb.academy/resources/glossary/public-key) (या एक [प्राप्त करने वाला Address](https://planb.academy/resources/glossary/receiving-address) जो इस पब्लिक की को दर्शाता है) द्वारा सुरक्षित होते हैं। इस पब्लिक की से जुड़े UTXO को खर्च करने के लिए, उपयोगकर्ता को यह साबित करना होगा कि उसके पास संबंधित [प्राइवेट की](https://planb.academy/resources/glossary/private-key) है, और इस की से बने [डिजिटल सिग्नेचर](https://planb.academy/resources/glossary/digital-signature) को प्रदान करना होगा। इसीलिए हम कहते हैं कि आपका [Bitcoin Wallet](https://planb.academy/resources/glossary/wallet) वास्तव में बिटकॉइन्स नहीं रखता, बल्कि आपकी प्राइवेट कीज़ को स्टोर करता है, जो आपको आपके UTXO तक पहुंच देती हैं और इस तरह, उन बिटकॉइन्स तक भी जिन्हें वे दर्शाते हैं।

![BTC204](assets/hi/008.webp)
...
Bitcoin ट्रांजेक्शन एक ऑपरेशन है जो [Blockchain](https://planb.academy/resources/glossary/blockchain) पर रिकॉर्ड किया जाता है और Ownership बिटकॉइन एक व्यक्ति से दूसरे को ट्रांसफर करता है। असल में, क्योंकि हम UTXO मॉडल पर हैं और कोई अकाउंट्स नहीं हैं, यह ट्रांजेक्शन खर्च करने की शर्तों को पूरा करता है जो एक या ज्यादा UTXOs को सुरक्षित करती हैं, उन्हें खर्च करता है और बराबर में नए UTXOs बनाता है जिनकी नई खर्च करने की शर्तें होती हैं। संक्षेप में, एक ट्रांजेक्शन बिटकॉइन को एक पूरी हुई स्क्रिप्ट से एक नई स्क्रिप्ट में ले जाता है जो उन्हें सुरक्षित करने के लिए डिज़ाइन की गई होती है।

![BTC204](assets/hi/010.webp)

हर Bitcoin ट्रांजैक्शन में एक या ज़्यादा [इनपुट](https://planb.academy/resources/glossary/input) और एक या ज़्यादा [आउटपुट](https://planb.academy/resources/glossary/output) होते हैं। इनपुट वो UTXO होते हैं जो इस ट्रांजैक्शन में खर्च किए जाते हैं और generate आउटपुट में बदल जाते हैं। आउटपुट नए UTXO होते हैं जिन्हें आगे की ट्रांजैक्शन्स के इनपुट के तौर पर इस्तेमाल किया जा सकता है।

![BTC204](assets/hi/011.webp)

**क्या आप जानते हैं?** सिद्धांत रूप में, एक Bitcoin लेनदेन में इनपुट और आउटपुट की संख्या अनंत हो सकती है। एकमात्र सीमा अधिकतम [ब्लॉक](https://planb.academy/resources/glossary/block) आकार है।
...
```plaintext
लेन-देन शुल्क = total inputs - total outputs
```

चलो Alice का उदाहरण लेते हैं, जिसके पास `10,000 Sats` का UTXO है और वह `4,000 Sats` में एक बैगूएट खरीदना चाहती है। Alice अपने `10,000 Sats` के UTXO को इनपुट के रूप में लेकर एक ट्रांजैक्शन बनाती है। फिर वह बैकर को बैगूएट के भुगतान के लिए `4,000 Sats` का आउटपुट जनरेट करती है। [माइनर्स](https://planb.academy/resources/glossary/miner) को प्रोत्साहित करने के लिए कि वे उसकी ट्रांजैक्शन को ब्लॉक में शामिल करें, Alice `200 Sats` का फीस आवंटित करती है। इसके बाद वह एक दूसरा आउटपुट, Exchange, बनाती है, जो उसे वापस मिलेगा, जिसकी राशि `5,800 Sats` होगी।

![BTC204](assets/hi/015.webp)

फीस फॉर्मूला लगाने पर, हम देखते हैं कि नाबालिगों के लिए वास्तव में `200 Sats` बचा है:

```plaintext
लेन-देन शुल्क = total inputs - total outputs
लेन-देन शुल्क = 10 000 - (4 000 + 5 800)
लेन-देन शुल्क = 10 000 - 9 800
लेन-देन शुल्क = 200
```

जब एक Miner ब्लॉक को वैलिडेट करने में सफल होता है, तो उसे अपने ब्लॉक में शामिल सभी ट्रांजैक्शन के लिए फीस इकट्ठा करने का अधिकार मिलता है, जो "[कॉइनबेस](https://planb.academy/resources/glossary/coinbase-transaction)" ट्रांजैक्शन के जरिए होता है।
...
कोइनबेस एक खास तरह का Bitcoin ट्रांजैक्शन है, जो हर ब्लॉक के लिए यूनिक होता है और हमेशा इनमें सबसे पहले आता है। यह Miner (जिसने वैलिड [Proof of Work](https://planb.academy/resources/glossary/proof-of-work) ढूंढ़ा है) को अपना Block reward पाने की अनुमति देता है। यह रिवॉर्ड दो Elements से मिलकर बना होता है: **[ब्लॉक ग्रांट](https://planb.academy/resources/glossary/block-subsidy)** और **ट्रांजैक्शन फी**, जिसकी चर्चा पिछले सेक्शन में की गई है।
...
वहीं दूसरी तरफ, अपने स्वभाव के कारण, फिजिकल करेंसी में [डबल स्पेंडिंग](https://planb.academy/resources/glossary/double-spending-attack) की समस्या नहीं होती। अगर मैं तुम्हें 10 यूरो का नोट दे देता हूँ, तो वह मेरे कब्ज़े से निकलकर सीधे तुम्हारे पास चला जाता है - इससे उस पैसे को दोबारा खर्च करने का कोई चांस ही नहीं रह जाता। सीधे शब्दों में कहें तो, मैं इस 10 यूरो के नोट को दोबारा खर्च नहीं कर पाऊँगा।

![BTC204](assets/hi/019.webp)
...
![BTC204](assets/hi/027.webp)

पिछले अध्याय के बारे में सोचो। मैंने समझाया था कि Bitcoin का प्राइवेसी मॉडल मूल रूप से यूजर आइडेंटिटी को ट्रांजैक्शन्स से अलग रखने पर आधारित क्यों था। इसलिए यह सोचना आसान होगा कि Blockchain का एनालिसिस बेकार है, क्योंकि अगर हम [ऑनचेन](https://planb.academy/resources/glossary/onchain) एक्टिविटीज को जोड़ भी लें, तो भी हम उन्हें किसी असली आइडेंटिटी से नहीं जोड़ सकते।
...
![BTC204](assets/hi/030.webp)

Blockchain के विश्लेषण का मुकाबला करने का इससे बेहतर तरीका क्या हो सकता है कि आप इसमें इस्तेमाल होने वाले तरीकों के बारे में जानें? अगर आप Bitcoin पर अपनी प्राइवेसी को बेहतर बनाने के तरीके जानना चाहते हैं, तो आपको इन तरीकों को समझना होगा। इससे आपको [CoinJoin](https://planb.academy/resources/glossary/coinjoin) या [PayJoin](https://planb.academy/resources/glossary/payjoin) जैसी तकनीकों (जिन्हें हम कोर्स के आखिरी हिस्सों में देखेंगे) की बेहतर समझ मिलेगी, और आपसे होने वाली गलतियाँ कम होंगी।

https://planb.academy/tutorials/privacy/on-chain/ashigaru-whirlpool-e566803d-ab3f-4d98-9136-5462009262ef
https://planb.academy/tutorials/privacy/on-chain/payjoin-848b6a23-deb2-4c5f-a27e-93e2f842140f
इसमें, हम [क्रिप्टोग्राफी](https://planb.academy/resources/glossary/cryptography) और क्रिप्टएनालिसिस के साथ एक समानता बना सकते हैं। एक अच्छा क्रिप्टोग्राफर सबसे पहले एक अच्छा क्रिप्टएनालिस्ट होता है। एक नया एन्क्रिप्शन एल्गोरिदम बनाने के लिए, आपको यह जानना होगा कि इस पर किस तरह के हमले होंगे, और पुराने एल्गोरिदम कैसे तोड़े गए थे यह भी पढ़ना होगा। यही सिद्धांत Bitcoin प्राइवेसी पर भी लागू होता है। Blockchain एनालिसिस मेथड्स को समझना ही उनसे बचाव की कुंजी है। इसीलिए मैंने इस ट्रेनिंग कोर्स में on chain एनालिसिस का एक पूरा सेक्शन शामिल किया है।
...
- [cIOH](https://planb.academy/resources/glossary/cioh) (*कॉमन इनपुट Ownership ह्यूरिस्टिक*);
- और जीडब्ल्यू-151 का दोबारा इस्तेमाल।

![BTC204](assets/hi/031.webp)
...
उदाहरण के लिए, यहाँ एक Bitcoin लेन-देन है जो [स्वीप](https://planb.academy/resources/glossary/sweep-transaction) पैटर्न को अपनाता है:

```plaintext
35f1072a0fda5ae106efb4fda871ab40e1f8023c6c47f396441ad4b995ea693d
```

![BTC204](assets/hi/036.webp)
...
![BTC204](assets/hi/040.webp)

इस मॉडल की व्याख्या यह है कि हम [समूहित खर्च](https://planb.academy/resources/glossary/batched-spending) के सामने हैं। यह एक ऐसी प्रथा है जो संभवतः एक बहुत बड़ी आर्थिक गतिविधि को दर्शाती है, जैसे कि Exchange प्लेटफॉर्म। समूहित खर्च इन संस्थाओं को अपने खर्चों को एक ही लेन-देन में जोड़कर लागत बचाने में सक्षम बनाता है।
...
![BTC204](assets/hi/047.webp)

इस डायग्राम पर, हम देख सकते हैं कि इनपुट नंबर 0 एक [P2WPKH](https://planb.academy/resources/glossary/p2wpkh) स्क्रिप्ट (SegWit V0 जो `bc1q` से शुरू होता है) को अनलॉक करता है। आउटपुट नंबर 0 भी उसी तरह की स्क्रिप्ट का इस्तेमाल करता है। वहीं दूसरी तरफ, आउटपुट नंबर 1 एक [P2TR](https://planb.academy/resources/glossary/p2tr) स्क्रिप्ट (SegWit V1 जो `bc1p` से शुरू होता है) का इस्तेमाल करता है। इस फीचर की व्याख्या यह है कि संभावना है कि Address जिसका वर्जनिंग इनपुट के समान है, वह Exchange Address है। इसलिए यह हमेशा एक ही यूजर का होगा।
...
इस पर हम देख सकते हैं कि इनपुट नंबर 0 और आउटपुट नंबर 1 P2WPKH स्क्रिप्ट्स (SegWit V0) का उपयोग करते हैं, जबकि आउटपुट नंबर 0 एक अलग [P2PKH](https://planb.academy/resources/glossary/p2pkh) स्क्रिप्ट (लेगेसी) का उपयोग करता है।
...
सबसे पहले, एक विश्लेषक स्क्रिप्ट के इस्तेमाल में समानताएं ढूंढ सकता है। उदाहरण के लिए, [Multisig](https://planb.academy/resources/glossary/multisig) जैसी कुछ अल्पसंख्यक स्क्रिप्ट्स को SegWit V0 स्क्रिप्ट्स की तुलना में पहचानना आसान हो सकता है। जितने बड़े समूह में हम छिपे होते हैं, उतना ही हमें पकड़ना मुश्किल होता है। यही एक वजह है कि अच्छे CoinJoin प्रोटोकॉल्स पर सभी प्रतिभागी बिल्कुल एक जैसी स्क्रिप्ट का इस्तेमाल करते हैं।
...
चैनल विश्लेषण में [OSINT](https://planb.academy/resources/glossary/osint) (*ओपन सोर्स इंटेलिजेंस*) का थोड़ा और व्यापक हिस्सा भी शामिल होता है, जिसमें इंटरनेट सर्च शामिल हैं। इसी वजह से हम सलाह देते हैं कि सोशल नेटवर्क्स या वेबसाइट पर सीधे पते ना डालें, चाहे वो छद्म नाम से हों या नहीं।

![BTC204](assets/hi/063.webp)
...
इस परिकल्पना को कई कारण मजबूत करते हैं। पहला, UTXO इनपुट को सुरक्षित करने के लिए इस्तेमाल किया गया स्क्रिप्ट [P2SH](https://planb.academy/resources/glossary/p2sh) 2/3 Multisig स्क्रिप्ट है, जो Exchange प्लेटफॉर्म्स की तरह उन्नत स्तर की सुरक्षा दिखाता है:
...
उदाहरण के लिए, यहाँ एक [Taproot](https://planb.academy/resources/glossary/taproot) रिसेप्शन Address है:
...
एक और एडवांस्ड तरीका है *Knapsack Solver* का। यह [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core) Wallet में वर्जन 0.17 तक इस्तेमाल किया जाता था। इसमें Wallet से UTXOs को बारी-बारी और रैंडमली चुनकर उन्हें सबसेट में जोड़ा जाता है, और जो सॉल्यूशन ट्रांजैक्शन वेट को यूजर के लिए कॉस्ट कम करने के लिए जितना हो सके कम कर दे, उसे रखा जाता है।
...
*इस अध्याय को लिखने के लिए, मैंने [@pivi___](https://x.com/pivi___) द्वारा दिए गए BTC205 ट्रेनिंग कोर्स का इस्तेमाल किया, जो Plan ₿ Academy पर उपलब्ध है (फिलहाल सिर्फ फ्रेंच में ही मौजूद है)*
...
![BTC204](assets/hi/105.webp)

जब आप अपना खुद का Bitcoin नोड इस्तेमाल नहीं कर रहे होते हैं, तो सबसे बड़ा खतरा यह है कि तीसरे पक्ष के नोड का ऑपरेटर आपकी Blockchain पर की गई गतिविधियों को देख सकता है, यहाँ तक कि इस जानकारी को दूसरे संस्थाओं के साथ भी साझा कर सकता है। इस खतरे को कम करने के लिए, एक बीच का हल है Wallet सॉफ्टवेयर का इस्तेमाल करना जो [Tor](https://planb.academy/resources/glossary/tor) के जरिए आपके कनेक्शन को छुपाता है। इससे आपके डेटा का एक्सपोजर कम हो सकता है। हालाँकि, सबसे बेहतर हल यह है कि आप अपना खुद का Bitcoin नोड रखें और उसका इस्तेमाल करके अपने लेन-देन को प्रसारित करें। बेशक, आपको यह भी ध्यान रखना होगा कि अपने नोड के जरिए कोई जानकारी लीक न हो, लेकिन यह एक अलग विषय है जिसे हम आगे के सेक्शन में देखेंगे।
...
![BTC204](assets/hi/118.webp)

पहले उदाहरण में, हमने देखा कि coinjoin किसी कॉइन की गोपनीयता को उसके अतीत के संदर्भ में कैसे सुरक्षित कर सकता है, और दूसरे उदाहरण में, यह उसके भविष्य के संदर्भ में किसी कॉइन के इतिहास को कैसे सुरक्षित कर सकता है। इसी कारण मैंने उल्लेख किया कि coinjoin को एक एकमुश्त घटना के रूप में देखा जाना चाहिए, जो कॉइन के इतिहास को दोनों दिशाओं में विभाजित करती है:

![BTC204](assets/hi/119.webp)
...
![BTC204](assets/hi/132.webp)

जैसा कि नाम से पता चलता है, [Zerolink](https://planb.academy/resources/glossary/zerolink) का सिद्धांत CoinJoin लेन-देन बनाना है जो यह सुनिश्चित करते हैं कि इनपुट और आउटपुट के बीच के लिंक्स का पता नहीं लगाया जा सकता। यह सभी आउटपुट्स में बिल्कुल समान रकम सुनिश्चित करके हासिल किया जाता है।

![BTC204](assets/hi/133.webp)
...
- जीडब्ल्यू-६८३;
- वाबी-साबी;
इन तीन ऐतिहासिक इम्प्लीमेंटेशनों के अतिरिक्त, हाल ही में एक नया उभरा है: Joinstr. मैं इसे इस अध्याय में नहीं लूँगा, लेकिन आप इससे संबंधित सभी जानकारी इस समर्पित ट्यूटोरियल में पा सकते हैं:
...
![BTC204](assets/hi/139.webp)

Wabisabi के साथ, संस्करण 2.0 ने coinjoin के प्रति अपने दृष्टिकोण को Whirlpool के मॉडल के और निकट लाने के लिए अनुकूलित किया है। यद्यपि coinjoin लेनदेन अभी भी बहुत बड़े आकार के होते हैं, अब Whirlpool मॉडल का अनुसरण करते हुए कई क्रमिक चक्रों को एक के बाद एक चलाना संभव है। चेंज प्रबंधन पर भी विशेष ध्यान दिया गया है: Wasabi 1.0 के विपरीत, जहाँ चेंज सीधे उपयोगकर्ताओं के इनपुट से जुड़ा होता था, Wabisabi चेंज को कई छोटी राशियों में विभाजित करने का प्रयास करता है, जिन्हें सभी प्रतिभागियों के बीच समान मूल्यवर्ग में वितरित किया जाता है।
...
![BTC204](assets/hi/143.webp)


- 6 इनपुट और 6 आउटपुट ;

![BTC204](assets/hi/144.webp)


- 7 इनपुट और 7 आउटपुट ;

![BTC204](assets/hi/145.webp)


- 8 इनपुट और 8 आउटपुट।

![BTC204](assets/hi/146.webp)
...
![BTC204](assets/hi/153.webp)

### रिमिक्स

प्रारंभिक मिक्स करने के बाद, UTXO को **postmix** खाते में स्थानांतरित कर दिया जाता है। यह खाता पहले से मिक्स किए गए UTXO और रीमिक्स की प्रतीक्षा कर रहे UTXO दोनों को एकत्र करता है। जब Whirlpool क्लाइंट सक्रिय होता है, तो **postmix** खाते में स्थित UTXO स्वचालित रूप से रीमिक्स के लिए उपलब्ध होते हैं और इन नए चक्रों में भाग लेने के लिए उन्हें यादृच्छिक रूप से चुना जाएगा।
...
सबसे सरल और सबसे सुरक्षित समाधान यह है कि अपने मिश्रित UTXO को उनके **postmix** खाते में आराम करने दें, उन्हें पुनः मिश्रित होने दें और केवल खर्च करते समय ही छुएँ। Samourai (और अब Ashigaru) तथा Sparrow वॉलेट श्रृंखला विश्लेषण से जुड़े इन सभी जोखिमों के विरुद्ध अतिरिक्त सुरक्षा प्रदान करते हैं। ये सुरक्षाएँ आपको गलतियाँ करने से बचाती हैं.
...
- **Monero के माध्यम से उनका समेकन:** Samourai Wallet पहले BTC और XMR के बीच एटॉमिक स्वैप सेवा प्रदान करता था, जो उनकी गिरफ्तारी के बाद अब उपलब्ध नहीं है। यह तरीका विषाक्त UTXO को Monero पर समेकित करके बिना CIOH के माध्यम से आपकी गोपनीयता के साथ समझौता किए उनका प्रबंधन करने की अनुमति देता था, और फिर उन्हें Bitcoin पर वापस भेजा जाता था। यदि इसी तरह की सेवा फिर से उपलब्ध होती है, तो यह एक रोचक विकल्प हो सकता है। ध्यान रखें कि यह तरीका महंगा हो सकता है—खनन शुल्क और बिटकॉइन में पुनः परिवर्तन के दौरान तरलता संबंधी सीमाओं के कारण लगने वाले प्रीमियम दोनों की वजह से।
...
Samourai Wallet के संस्थापकों की गिरफ़्तारी और 24 अप्रैल 2024 को उनके सर्वरों की जब्ती के बाद, Whirlpool उपकरण अब Samourai Wallet और Sparrow Wallet पर उपलब्ध नहीं है.

![BTC204](assets/hi/155.webp)
...
Whirlpool के कार्य करने का मूल सिद्धांत अपरिवर्तित रहता है, लेकिन Samourai पर इसके उपयोग की तुलना में कुछ अंतर मौजूद हैं: 2025 में, Ashigaru पर केवल दो पूल उपलब्ध हैं, `0.25 BTC` और `0.025 BTC` के, जिनके प्रवेश शुल्क क्रमशः `0.0125 BTC` और `0.00125 BTC` हैं।
...
![BTC204](assets/hi/165.webp)

इसके विपरीत, Whirlpool 5x5 मॉडल के अनुसार संरचित एक coinjoin में $1\,496$ संभावित संयोजन होते हैं:

![BTC204](assets/hi/166.webp)

एक Whirlpool सर्ज साइकिल 8x8 CoinJoin के $9\,934\,563$ संभावित व्याख्याएँ हैं:

![BTC204](assets/hi/167.webp)
...
![BTC204](assets/hi/177.webp)


payjoin का सबसे उन्नत इम्प्लीमेंटेशन निस्संदेह Stowaway है, जिसे Samourai Wallet के डेवलपर्स ने बनाया था। सॉफ़्टवेयर के संस्थापकों की गिरफ़्तारी के बाद से यह उपकरण Samourai पर केवल आंशिक रूप से काम करता है। लेकिन इसे Ashigaru एप्लिकेशन पर फिर से शुरू किया गया है।

Stowaway का लाभ यह है कि यह एक पूर्ण और अत्यंत उपयोग में आसान प्रोटोकॉल है, जो payjoin प्राप्त करने और भेजने दोनों का समर्थन करता है। आंशिक रूप से हस्ताक्षरित लेनदेन को कई QR कोड स्कैन करके मैन्युअल रूप से या Tor के माध्यम से Soroban द्वारा स्वचालित रूप से विनिमय किया जा सकता है.

![BTC204](assets/hi/178.webp)
...
- अगर तुम्हें [Stonewall](https://planb.academy/resources/glossary/stonewall) x2 ट्रांजैक्शन के लिए कोई नहीं मिल रहा, तो तुम सिर्फ़ Stonewall ट्रांजैक्शन भी कर सकते हो - यह Stonewall x2 जैसा ही काम करेगा।
...
![BTC204](assets/hi/190.webp)

इससे बचने के लिए हमें एक ऐसे टूल की जरूरत है जो Bitcoin सिक्के के पुराने ट्रैक को धुंधला कर सके, ताकि कुछ हद तक उसकी [विनिमेयता](https://planb.academy/resources/glossary/fungibility) (fungibility) बहाल हो सके। यही रिकोशे (ricochet) का मकसद है।

![BTC204](assets/hi/191.webp)
...
रिकोशे विधि का विचार मूल रूप से Samourai Wallet की टीमों से आया था, जिन्होंने इसके कार्य को स्वचालित करने के लिए इसे अपने अनुप्रयोग में एकीकृत किया था। Samourai पर यह सेवा सशुल्क थी, क्योंकि एक रिकोशे से सेवा शुल्क के लिए 100,000 सैट की निश्चित लागत आती थी, जिसमें माइनिंग शुल्क भी जोड़ दिए जाते थे। आज Ashigaru पर भी यही स्थिति है। इसलिए इसका उपयोग मुख्यतः बड़े धनराशि वाले लेनदेन के लिए अनुशंसित है.
...
- "Bounce" या "Rebound" से थोड़ा अलग है ([Ricochet](https://planb.academy/resources/glossary/ricochet) में ज़ोर और अनियंत्रित उछाल का भाव होता है)।  
...
![BTC204](assets/hi/196.webp)

Ashigaru एप्लिकेशन दो रिकोशे संस्करण प्रदान करता है (वही जो पहले Samourai पर उपलब्ध थे):


- सुदृढ़ रिकोशे, या "चरणबद्ध वितरण", का लाभ यह है कि यह Ashigaru सेवा शुल्क को लगातार पाँच लेनदेन में विभाजित कर देता है। यह विकल्प यह भी सुनिश्चित करता है कि प्रत्येक लेनदेन अलग समय पर प्रसारित हो और एक अलग ब्लॉक में दर्ज हो, जिससे स्वामित्व परिवर्तन के व्यवहार की अधिकतम संभव नकल हो सके। यद्यपि यह धीमा है, यह विधि उनके लिए बेहतर है जिन्हें जल्दी नहीं है, क्योंकि यह श्रृंखला विश्लेषण के विरुद्ध इसकी प्रतिरोधक क्षमता को बढ़ाकर रिकोशे की प्रभावशीलता को अधिकतम करती है;

![BTC204](assets/hi/197.webp)
...
![BTC204](assets/hi/201.webp)

इसके अलावा, इस बात की कोई गारंटी नहीं है कि एलिस, बॉब की निजी कुंजी $B$ प्राप्त करने के बाद, बदले में अपनी निजी कुंजी $A$ प्रसारित करेगी। इसलिए यह विनिमय पक्षों के बीच भारी विश्वास पर निर्भर करता है और सुरक्षित तरीके से स्वामित्व के गुप्त हस्तांतरण को सुनिश्चित करने के लिए अप्रभावी साबित होता है।

![BTC204](assets/hi/202.webp)
...
![BTC204](assets/hi/211.webp)

इसके बाद लेन-देन को "Fluff" चरण के दौरान पूरे नेटवर्क में प्रसारित किया जाता है।

![BTC204](assets/hi/212.webp)

तना और "Fluff" नेटवर्क में लेन-देन के प्रसार के व्यवहार को दर्शाते हैं, जो एक डंडेलियन ("[Dandelion](https://planb.academy/resources/glossary/dandelion)") के आकार और विकास के समान होता है।
...
लेन-देन करने के लिए, दोनों पक्षों के पास BIP47 लागू करने वाला एक बिटकॉइन वॉलेट होना चाहिए, जैसे Ashigaru पर PayNym या Sparrow Wallet. उनके भुगतान कोडों का संयुक्त उपयोग उनके बीच एक गुप्त चैनल बनाता है। इस चैनल को प्रभावी रूप से स्थापित करने के लिए प्रेषक को बिटकॉइन ब्लॉकचेन पर एक विशिष्ट लेन-देन करना आवश्यक है, जिसे “सूचना लेन-देन” कहा जाता है (इसके विवरण मैं आपको बाद में दूँगा)।
...
PayNym Bots के संबंध में — वे रोबोट जो कभी-कभी X (Twitter) पर दिखाई देते हैं — ये भुगतान कोड के दृश्य रूप हैं, जिन्हें Samourai Wallet द्वारा बनाया गया है। अब Ashigaru के साथ ये थोड़े भिन्न दिखाई देते हैं, परंतु सिद्धांत वही है। इन्हें हैश फ़ंक्शन के माध्यम से उत्पन्न किया जाता है, जो इन्हें लगभग अद्वितीय बनाता है। ये `+` से शुरू होने वाली एक छोटी वर्णमाला श्रृंखला के रूप में दिखाई देते हैं:
...
![BTC204](assets/hi/224.webp)

### Diffie-Hellman की गुप्त कुंजी Exchange अण्डाकार वक्रों पर (ECDH)

BIP47 के केंद्र में मौजूद क्रिप्टोग्राफिक प्रोटोकॉल को [ECDH](https://planb.academy/resources/glossary/ecdh) के नाम से जाना जाता है, जो *Elliptic-Curve Diffie-Hellman* का संक्षिप्त रूप है। यह तरीका मूल Diffie-Hellman की Exchange का एक प्रकार है।
