...
definition: Процесс, посредством которого сообщество Bitcoin решает активировать софт-форк, ища консенсус между майнерами и пользователями, чтобы избежать раскола блокчейна.
---
