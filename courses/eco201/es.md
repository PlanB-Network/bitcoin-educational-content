...
Para lograr este objetivo, explicaremos los principios fundamentales de la "[Economía Austriaca](https://planb.academy/resources/glossary/austrian-school)", una corriente de pensamiento económico con una tradición metodológica que se remonta al siglo XVI, que proporciona ideas sobre la acción humana bajo restricciones económicas. Con esta introducción, ahora comprendes los conceptos básicos de la creación de dinero y el estado actual de nuestro sistema financiero y monetario.
