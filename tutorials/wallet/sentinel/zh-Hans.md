...
## 应该使用哪个仅观察钱包？
目前，最完整的 watch-only 应用是 [Sentinel](https://github.com/wanderingking072/sentinel-android)，最初由 Samourai Wallet 团队开发，如今由社区维护。它汇集了优秀 watch-only 钱包所需的所有核心功能：
- 支持扩展密钥、公钥和地址；
- 能够将多个账户或钱包组织成集合；
...
## 如何使用Sentinel仅观察钱包？
### 安装和设置
首先安装 Sentinel 应用程序。您可以使用[项目 github 仓库中提供下载的 APK](https://github.com/wanderingking072/sentinel-android/releases) 来完成此操作。
