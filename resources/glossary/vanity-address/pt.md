---
term: Endereço personalizado

definition: Endereço de receção personalizado contendo uma sequência de caracteres escolhida, gerado por força bruta (brute force).
---
