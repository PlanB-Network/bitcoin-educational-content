...
| Aplikacija           | E2EE 1:1       | E2EE grupe   | Anonimna registracija | Open-source klijentska licenca | Open-source serverska licenca | Decentralizovani server | Godina osnivanja |
| -------------------- | -------------- | -------------- | --------------------- | ------------------------------ | ------------------------------ | ---------------------- | ---------------- |
| WhatsApp             | ✅              | ✅              | ❌                     | ❌                              | ❌                              | ❌                      | 2009            |
| WeChat               | ❌              | ❌              | ❌                     | ❌                              | ❌                              | ❌                      | 2011            |
