---
name: Blockstream App - Endast för bevakning
...
- generate en mottagande Address**: Klicka på "Transact" och sedan på "Receive" för att skapa en ny Address i kedjan. Dela den via QR-kod eller kopia för att ta emot pengar:
