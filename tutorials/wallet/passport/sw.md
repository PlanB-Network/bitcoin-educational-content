...
- Kadi ya MicroSD;
- Adapta mbili za MicroSD hadi Umeme au USB-C;
- Vibandiko.


Kwenye kifaa utapata:
...
- Kitufe cha kufuta (3);
- Kitufe cha kurudi (4);
- Kitufe cha uthibitisho (5);
- Pedi ya mwelekeo (6);
- Kitufe cha kuwasha/kuzima (7);
- Kiashiria cha hali (8);
- Bandari ya MicroSD (9);
- Kitufe cha kubadilisha hali aA1 (10);
- Kamera ya nyuma.
...
Bonyeza kitufe cha uthibitishaji ili kufikia menyu inayofuata.
...
Kisha ukubali masharti ya matumizi.
...
Nenda kwa [tovuti rasmi ya uthibitishaji](https://validate.foundationdevices.com/) na uchague "*Pasipoti*".
...
Kisha kifaa chako kitaonyesha maneno 4.
...
Ikiwa ujumbe "*Imepitishwa*" inaonekana, Hardware Wallet yako ni halisi. Sasa unaweza kuitumia kupata Bitcoin Wallet.
...
Tumia vitufe kuweka nambari zako za PIN. Unapomaliza, bofya kitufe cha uthibitishaji.


![Image](assets/fr/16.webp)


Thibitisha PIN yako mara ya pili.
...
Kisha thibitisha usakinishaji wa firmware.
...
Baada ya kusasisha kukamilika, weka PIN yako ili kufungua kifaa na uendelee kusanidi.


![Image](assets/fr/26.webp)


## Unda Bitcoin Wallet mpya


Sasa ni wakati wa kuunda Bitcoin Wallet mpya. Bonyeza kitufe cha uthibitisho.


![Image](assets/fr/27.webp)


Ili kuunda Wallet mpya, bofya "*Unda seed* Mpya".


![Image](assets/fr/28.webp)


Unaweza kuchagua kati ya maneno 12- au 24 ya Mnemonic. Usalama unaotolewa na chaguo zote mbili ni sawa, kwa hivyo unaweza kuchagua ile ambayo ni rahisi kuhifadhi, yaani maneno 12.
...
Ingiza "*Nambari ya Hifadhi nakala*" ili kuthibitisha kuwa umeihifadhi kwa usahihi.


![Image](assets/fr/32.webp)


Ikiwa MicroSD imeingizwa, chelezo iliyosimbwa kwa njia fiche ya Wallet yako imehifadhiwa hapo.
...
Bofya kwenye kitufe cha uthibitishaji ili kuona maneno yako ya Mnemonic.
...
Katika menyu ndogo ya "*Dhibiti Akaunti*", unaweza kuunganisha Bitcoin Wallet yako kwenye programu ya usimamizi ya Wallet (ambayo tutashughulikia katika hatua zinazofuata za mafunzo haya), au kutazama na kubadilisha jina la akaunti yako.
...
Unaweza pia kuingiza BIP39 passphrase (tazama sehemu inayofuata) au utumie seed ya muda.
...
Menyu ndogo ya "*Kifaa*" hukupa chaguo za kubinafsisha mwangaza wa skrini, kuweka ucheleweshaji kabla ya kujifunga kiotomatiki, kubadilisha msimbo wa PIN, au kubadilisha jina la kifaa.


![Image](assets/fr/43.webp)


Menyu ndogo ya "*Chelezo*" hukuwezesha kuhamisha nakala yako ya Wallet iliyosimbwa kwa njia fiche, kuangalia uhalali wa chelezo iliyopo, au utafute "*Nambari ya Hifadhi nakala*" yako tena.
...
Menyu ndogo ya "*Bitcoin*" inakuwezesha kubadilisha kitengo kinachoonyeshwa (BTC au satoshis), kudhibiti uwezekano wa Multisig Wallet, au ubadili hadi modi ya "*Testnet*".
...
Ingiza passphrase yako ukitumia vitufe vya aA1, na uhakikishe kuwa umeihifadhi mara moja au zaidi kwenye maudhui halisi (karatasi au chuma). Kwa mfano, ninatumia passphrase dhaifu sana, lakini unapaswa kuchagua passphrase yenye nguvu, isiyo ya kawaida, ikiwa ni pamoja na aina zote za wahusika na muda mrefu wa kutosha (kama nenosiri kali).
...
Katika somo hili, nitakuonyesha matumizi ya hali ya juu ya Pasipoti na Sparrow Wallet. Walakini, Hardware Wallet hii pia inaendana na Mjumbe (maombi ya Foundation), Keeper, BlueWallet, Nunchuk, Specter, na wengine wengi...
...
Taja Wallet yako, kisha ubofye kwenye "*Unda Wallet*".


![Image](assets/fr/56.webp)


Chagua "*Airgapped Hardware Wallet*".


![Image](assets/fr/57.webp)


Bofya kwenye "*Scan...*" karibu na chaguo la "*Pasipoti*". Hii itafungua webcam yako.


![Image](assets/fr/58.webp)


Kwenye Hardware Wallet yako, nenda kwenye menyu ya "*Akaunti*", chagua menyu ndogo ya "*Dhibiti Akaunti*", na ubofye "*Unganisha Wallet*".


![Image](assets/fr/59.webp)


Katika orodha kunjuzi inayoonekana, chagua "*Sparrow*".


![Image](assets/fr/60.webp)


Kisha chagua "*Single-sig*" kwa usanidi wa kawaida, bila Multisig.


![Image](assets/fr/61.webp)


Chagua chaguo la "* Msimbo wa QR*".
...
Weka nenosiri thabiti ili kupata ufikiaji salama wa Sparrow Wallet yako. Nenosiri hili litalinda funguo zako za umma, anwani, lebo na historia ya muamala dhidi ya ufikiaji ambao haujaidhinishwa. Ni vyema kuhifadhi nenosiri hili kwenye kidhibiti nenosiri, ili usilisahau.
...
Katika Sparrow, nenda kwenye kichupo cha "*Pokea*" na uchanganue msimbo wa QR wa Address ya kwanza.
...
Hii inathibitisha kuwa uletaji ulifanikiwa.
...
Sparrow itaonyesha risiti ya kwanza tupu Address katika Wallet yako. Unaweza kuongeza lebo.
...
Bofya kwenye "*Thibitisha Address*", kisha uchanganue msimbo wa QR unaoonyeshwa kwenye Sparrow Wallet.
...
Sasa unaweza kuitumia kupokea bitcoins. Shughuli inapotangazwa kwenye mtandao, itaonekana kwenye Sparrow. Subiri hadi upate uthibitisho wa kutosha ili kuzingatia muamala kuwa suluhu.
...
Kwa kuwa sasa una Sats chache kwenye Wallet yako, unaweza pia kutuma baadhi. Ili kufanya hivyo, bofya kwenye menyu ya "*UTXOs*".


![Image](assets/fr/76.webp)


Chagua UTXO unazotaka kutumia kama pembejeo za muamala huu, kisha ubofye "*Tuma Zilizochaguliwa*".


![Image](assets/fr/77.webp)


Weka Address ya mpokeaji, lebo ya kukukumbusha madhumuni ya muamala na kiasi ambacho ungependa kutuma kwa Address hii.


![Image](assets/fr/78.webp)


Rekebisha kiwango cha ada kulingana na hali ya sasa ya soko, kisha ubofye "*Unda Muamala*".


![Image](assets/fr/79.webp)


Hakikisha kuwa vigezo vyote vya muamala ni sahihi, kisha ubofye "*Maliza Muamala kwa Kutia Sahihi*".
...
Changanua PSBT (*Partially Signed Bitcoin Transaction*) inayoonyeshwa kwenye Sparrow Wallet.


![Image](assets/fr/83.webp)


Thibitisha kuwa Address inayopokea na kiasi kilichotumwa ni sahihi, kisha bonyeza kitufe cha uthibitishaji.


![Image](assets/fr/84.webp)


Angalia Exchange Address. Katika mfano wangu, hakuna, kwani shughuli hiyo inajumuisha pato moja.


![Image](assets/fr/85.webp)


Hakikisha ada ni ile uliyochagua.


![Image](assets/fr/86.webp)


Ikiwa maelezo yote ni sahihi, bofya kwenye kitufe cha uthibitisho ili kutia sahihi muamala.
...
Muamala wako uliotiwa saini sasa uko tayari kutangazwa kwenye mtandao wa Bitcoin na kujumuishwa kwenye kizuizi na Miner. Ikiwa kila kitu kiko sawa, bofya kwenye "*Muamala wa Tangaza*".


![Image](assets/fr/89.webp)


Muamala wako umetangazwa na unasubiri uthibitisho.
