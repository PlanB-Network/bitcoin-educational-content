...
> **⚠️ 緊急セキュリティ開示（2026年7月）— Coldcardウォレットが現在進行形で資金流出の被害に遭っています。** Coldcardデバイスのシード生成におけるファームウェアのバグにより、攻撃者はあなたが何もしなくてもシードフレーズを特定できます。**すべてのColdcardモデルが影響を受けます：Mk3、Mk4、Mk5、Q。** 2026年7月30日、約500のウォレットから約594 BTCが盗まれ、攻撃は今も続いています。安全と見なされるのは、ダイスロール方式で生成されたウォレットのみで、それも少なくとも50回サイコロを振った場合に限られます。シードがどのように生成されたか分からない、覚えていない、または確信が持てない場合は、侵害されたものとして扱い、Coldcard以外で生成されたシードのウォレットへ**直ちに資金を移動してください**。Coinkiteの公式発表に従ってください。専用の移行チュートリアルはこちら：
