...
definition: Инструмент Bitcoin Core, который диверсифицирует соединения между узлами в соответствии с автономными системами (ASN) для предотвращения атак Eclipse.
---
