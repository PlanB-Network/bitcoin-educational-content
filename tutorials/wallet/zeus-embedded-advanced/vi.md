...
Hiện tại, ZEUS dành cho những người đang vận hành các nút mạng gia đình/doanh nghiệp [Lightning Network Daemon (LND)](https://lightning.engineering/) hoặc [Core Lightning (CLN)](https://blockstream.com/lightning/) của riêng họ và quản lý chúng thông qua Zeus từ xa.
...
- Bộ lọc khối Neutrino** - đồng bộ khối được thực hiện bằng [bộ lọc khối và giao thức Neutrino](https://bitcoinops.org/en/topics/compact-block-filters/) (không có thông tin về quỹ On-Chain của người dùng). Nhắc nhở: đối với kết nối internet chậm/độ trễ cao, đồng bộ khối dựa trên neutrino này đôi khi có thể không thành công. Thử chuyển sang máy chủ gần neutrino có thể giúp khôi phục đồng bộ. Nếu không có đồng bộ này, nút LND của bạn không thể khởi động!
...
- Hãy kiên nhẫn trong quá trình đồng bộ ban đầu, có thể mất vài phút. Hãy thử kết nối với kết nối internet băng thông rộng có độ trễ tốt. Nếu bạn chạy nút Bitcoin của riêng mình, [bạn có thể kích hoạt dịch vụ neutrino](https://docs.lightning.engineering/lightning-network-tools/LND/enable-neutrino-mode-in-Bitcoin-core) và kết nối Zeus của bạn với nút của riêng bạn, thậm chí sử dụng mạng LAN nội bộ, do đó bạn sẽ có tốc độ tối đa.
