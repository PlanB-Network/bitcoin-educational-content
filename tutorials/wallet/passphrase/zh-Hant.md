...
根據 [Trezor 於 2019 年進行的一項研究](https://blog.trezor.io/is-your-passphrase-strong-enough-d687f44c63af)，若攻擊者取得你的種子，並在 AWS 上租用高階 GPU（如 NVIDIA Tesla V100），他可以僅用 1 美元測試近 6.2 億個密碼片語。作為參考，以 2019 年的效能來看，破解一組由 12 個隨機小寫字母組成的密碼片語平均需花費 **7700 萬美元**。

不過，我不建議你僅使用 12 個字元。應以目前強密碼的標準為目標：到了 2025 年，至少使用 13 個隨機字元，包含數字、大小寫字母與符號；如果只使用大小寫字母，則至少 14 個字元。當然，我建議更進一步，例如使用包含符號的 20 字元密碼短語，以預見未來的發展並考量這些研究未涵蓋的人為風險。
