...
> **⚠️ 緊急セキュリティ告知（2026年7月）— Coldcardウォレットが現在進行形で資金流出の被害に遭っています。** Coldcardデバイスのシード生成におけるファームウェアのバグにより、攻撃者はあなたが何も操作しなくてもシードフレーズを割り出すことができます。**すべてのColdcardモデルが影響を受けます：Mk3、Mk4、Mk5、Q。** 2026年7月30日、約500のウォレットからおよそ594 BTCが盗まれ、攻撃は現在も続いています。安全とみなされるのは、サイコロ振り（ダイスロール）方式で生成されたウォレットのみで、それも少なくとも50回サイコロを振った場合に限られます。シードがどのように生成されたか分からない、覚えていない、または確信が持てない場合は、侵害されたものとみなし、Coldcard上で生成されていないシードのウォレットへ**直ちに資金を移動してください**。Coinkiteの公式発表に従ってください。専用の移行チュートリアルをご覧ください：
