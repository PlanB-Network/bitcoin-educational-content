...
گزینه دوم استفاده از یک قطعه سخت افزار اختصاصی برای این منظور است، مانند Raspberry Pi 4 با یک SSD به اندازه کافی بزرگ (حدودا ~1TB). این گزینه در صورتی که باید سخت افزار را بخرید، گران تر است، اما کمتر از 10,00 یورو در سال از لحاظ مصرف برق مصرف میکند. از دیدگاه پهنای باند، با در نظر گرفتن 1 بلوک به حجم  1MB هر 10 دقیقه، تقریباً به 5GB در ماه می‌رسد.
