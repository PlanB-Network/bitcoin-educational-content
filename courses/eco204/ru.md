...
[Инфляция](https://planb.academy/resources/glossary/inflation) - это концепция, которая часто неправильно понимается из-за множества связанных с ней определений. Восприятие инфляции различается среди разных групп, таких как сторонники Биткойна и традиционные экономисты. Давайте сначала проясним определения, прежде чем обсуждать гиперинфляцию:
