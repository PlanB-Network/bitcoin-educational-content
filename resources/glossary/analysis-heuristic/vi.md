---
term: Phân tích kinh nghiệm

definition: Một phương pháp thực nghiệm được sử dụng để theo dõi dòng chảy Bitcoin trên blockchain dựa trên các đặc điểm có thể quan sát được trong các giao dịch.
---
