...
definition: Các định dạng mã hóa địa chỉ SegWit (bắt đầu bằng bc1), cung cấp khả năng phát hiện lỗi tốt hơn và khả năng đọc được cải thiện so với địa chỉ Legacy.
---
