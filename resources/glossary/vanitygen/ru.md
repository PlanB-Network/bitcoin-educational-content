...
definition: Программное обеспечение с открытым исходным кодом для командной строки, позволяющее создавать персонализированные адреса получения (vanity address).
---
