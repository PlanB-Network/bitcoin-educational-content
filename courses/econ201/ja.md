---
name: オーストリア学派の経済学入門
goal: オーストリア学派の経済思想を知る。社会とマクロ／ミクロ経済の現実に対する彼らの見解について学ぶ。
objectives:
  - ケインズ主義への代替案
  - ハード通貨の重要性
  - 景気循環はなぜ、どのようにして生まれるのか？
  - 中央銀行はなぜ狂ってしまったのか？
---
...
実際、経済学は非常に社会的で複雑な分野であり、相互に関連する無数の小さな行為者が一緒になって一貫した全体を形成しています。数学の方程式からではなく、人間の論理と社会学の観点からこの学問を理解する必要があります。この講座では、オーストリア学派経済学の基本的な概念を探求します。講師であるThéomo Jeunetは、オーストリア学派経済学の情熱的で有能な教授です。
