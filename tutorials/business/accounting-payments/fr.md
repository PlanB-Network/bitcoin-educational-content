---
name: Suivre Bitcoin en tant qu'entreprise

description: Apprenez à comptabiliser facilement et rapidement les paiements Bitcoin au sein d'une petite entreprise.
---
...
L'objectif de ce tutoriel est de permettre au propriétaire d'un petit commerce, idéalement un magasin, un vendeur ambulant ou toute autre activité commerciale, d'accepter le Bitcoin comme moyen de paiement et de s'en accommoder de manière simple. Le public cible est le propriétaire de l'entreprise, qui gère l'activité commerciale de manière autonome et s'appuie sur quelques employés.
...
Une configuration légèrement plus avancée consiste à utiliser Wallet de la fonction Point de vente de Satoshi, accessible à partir de l'application en cliquant sur le menu hamburger dans le coin supérieur droit :
...
- la fonctionnalité de réception unique, idéale pour laisser les employés collecter les paiements des clients sans qu'ils puissent dépenser ces fonds ;
- permet de créer une liste de prix et de produits pour votre magasin, afin que vous puissiez créer des factures Lightning en sélectionnant les produits achetés ;
- télécharge les rapports de vente au format CSV.


Pour plus d'informations, voir le tutoriel dédié sur Wallet de Satoshi - Point de vente :
...
Quelle que soit la réglementation en vigueur dans votre pays, l'action la plus simple pour un propriétaire de petite entreprise est de convertir les bitcoins reçus en monnaie locale immédiatement après les avoir reçus. Vous éviterez ainsi les complications liées à l'acceptation, à la déclaration et à la comptabilisation du Bitcoin dans le cadre de votre activité commerciale.


**Remarque** : Dans certains types d'entreprises, il se peut qu'il n'y ait pas de documents papier liés à la transaction entre le client et le vendeur, de sorte que pour le propriétaire de l'entreprise, c'est encore plus facile et plus immédiat !


Examinons les avantages et les inconvénients de cette solution :
