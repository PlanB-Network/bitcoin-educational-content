---
name: Debifi
description: Hanki Bitcoin:n takaama laina ilman huoltajaa.
---
...
Perinteinen luotonanto on vuosisatojen ajan mahdollistanut monien hankkeiden rahoittamisen. Se on kuitenkin edelleen hidasta, kallista ja vähän osallistavaa, erityisesti niille, joilla ei ole käytettävissään vankkaa pankki-infrastruktuuria.



Bitcoin-protokollan käyttöönotto aloitti uuden taloudellisen aikakauden ja toi mukanaan useita haasteita. Yksi näistä haasteista oli se, miten saada likviditeettiä ilman, että Bitcoin:n joutuisi myymään ja menettäisi siten alttiuden sen kasvupotentiaalille



Tuloksena on **Debifi**, joka on nykyaikainen vaihtoehto pankeille. Tavoite on selkeä: tehdä luotonannosta mahdollisimman yksinkertaista ja avointa yhdistämällä perinteisen rahoitusjärjestelmän edut ja Bitcoin:n tarjoama vapaus. Nimi Debifi kuvastaa tätä visiota: ***Decentralized Bitcoin Finance***, joka on lyhenne, joka kuvaa hajautetun rahoituksen ja Bitcoin-innovaation kohtaamista.
...
## Debifin käytön aloittaminen



Debifin käytön aloittaminen edellyttää muutamia ennakkoedellytyksiä.
...
Ennen kuin voit lainata Debifistä, varmista, että sinulla on seuraavat tavarat:
...
- KYC (*Know Your Customer*): valitusta lainatarjonnasta riippuen henkilöllisyyden todentaminen voi olla tarpeen. Debifissä kussakin tarjouksessa ilmoitetaan, vaaditaanko KYC-tietoa vai ei. Valmistaudu siis sen mukaisesti. KYC:n suorittavat luotettavat kolmannen osapuolen palveluntarjoajat, kuten Sumsub.
...
- Lainojen ottaminen edellyttää Debifi-mobiilisovellusta (iOS/Android). Sinun on ladattava sovellus, luotava tili ja "linkitettävä" laitteesi (laite rekisteröidään tilillesi). Debifi-sovellus tukee kaksitekijätodennusta (2FA), ja ilman älypuhelinta et voi vahvistaa tapahtumia Debifissä.
...
Vieraile [Debifin virallisilla verkkosivuilla](https://debifi.com/app).
...
Asenna sovellus älypuhelimesi tyypin mukaan ja avaa se sitten.
...
Kun olet sovelluksessa, napsauta **Asetukset**-valikkoa.
...
Saat vahvistuskoodin sähköpostitse. Kopioi koodi ja liitä se hakemukseen. Avaa sitten Debifi-sovellus älypuhelimellasi ja kirjaudu sisään.
...
Turvallisuuden vuoksi Debifi pyytää sinua noudattamaan kolmea vaihetta.
...
- Ensin sinun on asetettava vahva PIN-koodi, jotta voit käyttää sovellusta myöhemmin.
...
- Määritä seuraavaksi kaksitekijätodennus (2FA), jotta laite voidaan yhdistää tiliisi 2FA-koodin avulla.
...
- Tallenna lopuksi yksityisen avaimesi 12 sanaa kirjoittamalla se luotettavalle välineelle ja säilyttämällä se turvallisessa paikassa. Tämä vaihe on olennaisen tärkeä tilisi palauttamiseksi ja varojen hallinnoimiseksi.
...
- Lisäturvallisuuden lisäämiseksi voit jopa lisätä passphrase:n.
...
Huomaa, että vain rekisteröity älypuhelin voi avata tilisi (lisäturvatoimenpide).



Kun olet suorittanut nämä vaiheet, napsauta **Tarjoukset**-valikkoa nähdäksesi käytettävissä olevat lainatarjoukset. Kun napsautat tarjousta, se ohjaa sinut Debifi-verkkosivustolle.
...
### Käy verkkosivustolla ja tutustu lainatarjouksiin



Kun laite on yhdistetty, siirry [Debifi-verkkosivustolle](https://debifi.com/). Kirjaudu sisään luodaksesi suojatun yhteyden Debifi-mobiilisovelluksen ja verkkoalustan välille. Tämä helpottaa vuorovaikutusta käytettävissä olevien lainatarjousten kanssa (selkeä näkymä kunkin tarjouksen yksityiskohdista) ja tilinhallintaa.
...
Video-opastus siitä, miten kirjaudut tilillesi alustalla :
...
Alustan avulla saat yhteyden institutionaalisen tason likviditeettiin ja voit valita erilaisia vaihtoehtoja tarpeidesi mukaan. Tutustu saatavilla oleviin vaihtoehtoihin selaamalla. Voit myös joustavasti mukauttaa lainaparametrejä yksilöllisen riskinsietokykysi ja taloudellisen tilanteesi mukaan.
...
Debifin tällä hetkellä tarjoamat fiat-valuutat ovat nähtävissä alustalla.
...
### Selkeät ja joustavat sopimuslausekkeet



Debifi luottaa avoimiin ja joustaviin lainaehtoihin, jotka vastaavat kummankin osapuolen (lainanantajan ja lainanottajan) tarpeita. Keskeisiä lausekkeita ovat mm:
...
Bitcoin-lainaeriä on yleensä kolme (3):
...
Korkojen määrittäminen riippuu yleensä valitsemastasi LTV:stä, laina-ajan pituudesta, vakuuksien volatiliteetista ja alustakohtaisista riskinarvioinneista. Korot pysyvät kiinteinä lainan keston ajan.
...
#### Likvidaatio-oikeudet (marginaalipyynnöt)
...
### Lainaprosessin käynnistäminen



Valitse tarpeisiisi sopiva lainatarjous klikkaamalla sitä nähdäksesi sen ominaisuudet.
...
1. Lainan myöntävän laitoksen nimi ;


2. Lainan määrä vaihtelee;


3. Että saat varat USDC Ethereum ;


4. Laina-aika, korko ja LTV-suhde;


5. KYC vaaditaan tätä tarjousta varten;
...
Kun olet tyytyväinen tarjoukseen ja täyttänyt tarvittavat tiedot, napsauta "Contract-pyyntö".
...
Palaa mobiilisovelluksen kohtaan ''**Provide public key**''.
...
### Vakuuden tallettaminen ja varojen vastaanottaminen
...
Saat tämän ilmoituksen myös mobiilisovellukseesi.
...
Tämän jälkeen saat Debifiltä ilmoituksen, jossa sinua pyydetään maksamaan lainamaksut tai palkkiot, jotta lainasi tila etenisi.
...
Sinun tarvitsee vain allekirjoittaa maksutapahtuma, jonka perusteella Debifi voi vähentää palkkionsa takuusta. Lainanantajasi on puolestaan myös allekirjoitettava palkkiovähennystapahtuma, muuten Debifi ei voi saada palkkiotaan.
...
Jos vakuuden hinta nousee, lainanottaja saa vakuudesta mahdollisesti saamansa myyntivoiton. Hän on velkaa vain lainan määrän, joka on ennalta määrätty ja riippumaton Bitcoin-hinnasta.




## Takaisinmaksu ja vakuuden takaisinperintä



Sovitun laina-ajan päättyessä (tai halutessasi aikaisemmin) sinun on maksettava laina takaisin.
...
Onnittelut! Olet saattanut prosessin päätökseen.
...
Aloita pienestä, jos mahdollista. Testaa ensimmäistä lainaa varten vaatimaton summa, jotta voit tutustua prosessiin.



Käytä vain virallisia Debifi-verkkosivuja pysyäksesi ajan tasalla Debifi-uutisista ja vältä tuntemattomia tai phishing-linkkejä.  Päivitä sovellus, suojaa älypuhelimesi PIN-koodilla ja valitse yhteensopiva Hardware Wallet.



Vaihtoehtoisesti, jos olet lainanantaja, tämä opetusvideo opastaa sinua Debifi-alustan käytössä. Tarjouksestasi kiinnostuneiden lainanottajien valinnasta julkisten avainten antamiseen, sopimusten allekirjoittamiseen, stablecoinien siirtämiseen ja muuhun.
...
Tiedät nyt, miten Debifi-alustaa käytetään lainan hankkimiseen.
