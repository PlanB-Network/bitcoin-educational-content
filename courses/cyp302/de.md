...
Dieser Bildungsinhalt ist eine Adaption des Buches und repo [JWBurgers](https://github.com/JWBurgers/An_Introduction_to_Cryptography). Während der Autor die pädagogische Nutzung freundlicherweise gestattet hat, verbleiben alle geistigen Eigentumsrechte beim ursprünglichen Ersteller.
...
Beginnen wir unsere Untersuchung auf dem Gebiet der [Kryptographie](https://planb.academy/resources/glossary/cryptography) mit einer der charmantesten und unterhaltsamsten Episoden ihrer Geschichte: der Beale-Chiffre. [1]
...
Zweitens beinhalten klassische Verschlüsselungssysteme wie die Beale-Chiffren immer einen Schlüssel, der von allen beteiligten Parteien gemeinsam genutzt wird. Viele moderne kryptografische Verfahren verwenden jedoch nicht nur einen, sondern zwei Schlüssel: einen **privaten** und einen **[öffentlichen Schlüssel](https://planb.academy/resources/glossary/public-key)**. Während der erste in allen Anwendungen privat bleiben sollte, ist der zweite in der Regel öffentlich bekannt (daher auch die jeweiligen Namen). Im Bereich der Verschlüsselung kann der öffentliche Schlüssel zur Verschlüsselung der Nachricht verwendet werden, während der [private Schlüssel](https://planb.academy/resources/glossary/private-key) für die Entschlüsselung verwendet werden kann.
...
Die erste Lösung, die sie anboten, war ein entferntes *Schlüsselaustauschprotokoll*, d. h. eine Reihe von Regeln für den Austausch eines oder mehrerer symmetrischer Schlüssel über einen unsicheren Kommunikationskanal. Dieses Protokoll ist heute als *[Diffie-Helmann](https://planb.academy/resources/glossary/diffiehellman)-Schlüsselaustausch* oder *Diffie-Helmann-Merkle-Schlüsselaustausch* bekannt. [2]
...
Auf dem diskreten Logarithmus basierende Verfahren stützen sich im Wesentlichen auf zwei Arten von zyklischen Gruppen: multiplikative Gruppen von ganzen Zahlen und Gruppen, die die Punkte auf [elliptischen Kurven](https://planb.academy/resources/glossary/elliptic-curve) enthalten. Der ursprüngliche Diffie-Helmann-Schlüsselaustausch, der in "New Directions in Cryptography" vorgestellt wurde, arbeitet mit einer zyklischen multiplikativen Gruppe von ganzen Zahlen. Der [digitale Signaturalgorithmus](https://planb.academy/resources/glossary/digital-signature) von Bitcoin und das kürzlich eingeführte [Schnorr-Signaturverfahren](https://planb.academy/resources/glossary/schnorr-protocol) (2021) basieren beide auf dem Problem des diskreten Logarithmus für eine bestimmte zyklische Gruppe elliptischer Kurven.
...
Ein Beispiel für eine beliebte Hash-Funktion ist **[SHA-256](https://planb.academy/resources/glossary/sha256)** (Secure Hash Algorithm 256). Unabhängig von der Größe der Eingabe (z. B. 15 Bit, 100 Bit oder 10.000 Bit) ergibt diese Funktion einen 256-Bit-Hash-Wert. Nachfolgend sehen Sie einige Beispielausgaben der SHA-256-Funktion.
