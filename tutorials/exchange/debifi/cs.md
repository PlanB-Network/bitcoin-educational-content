---
name: Debifi
description: Získejte půjčku bez ručení garantovanou společností Bitcoin.
---
...
Tradiční úvěry umožňovaly po staletí financovat mnoho projektů. Je však stále pomalý, nákladný a nepříliš inkluzivní, zejména pro ty, kteří nemají přístup k solidní bankovní infrastruktuře.



S nástupem protokolu Bitcoin nastala nová finanční éra, která s sebou přinesla řadu výzev. Jednou z těchto výzev bylo, jak získat likviditu, aniž bychom byli nuceni Bitcoin prodat, a tím ztratit expozici vůči jeho růstovému potenciálu



Výsledkem je **Debifi**, platforma, která se prezentuje jako moderní alternativa k bankám. Její cíl je jasný: co nejvíce zjednodušit a zprůhlednit úvěrování tím, že spojí výhody tradičního finančního systému se svobodou, kterou nabízí Bitcoin. Název Debifi odráží tuto vizi: ***Decentralizované finance Bitcoin***, což je zkratka, která ilustruje setkání decentralizovaných financí a inovací Bitcoin.
...
- Poměr výše úvěru k hodnotě nemovitosti (LTV)** určuje, kolik peněz si můžete půjčit jako zástavu za úvěr Bitcoin. Poměr LTV = výše úvěru / výše zajištění * 100. Například LTV 50 % znamená, že hodnota úvěru se rovná 50 % hodnoty vloženého Bitcoin.




Video tutoriál BTC Sessions :
...
## Začínáme s aplikací Debifi



Abyste mohli začít pracovat na Debifi, potřebujete několik předpokladů.
...
Než si budete moci od společnosti Debifi půjčit, ujistěte se, že máte následující položky:
...
- KYC (*Know Your Customer*): v závislosti na zvolené nabídce úvěru může být vyžadován proces ověření totožnosti. Na stránkách Debifi je u každé nabídky uvedeno, zda je KYC vyžadováno, či nikoli. Připravte se tedy podle toho. KYC provádějí spolehliví poskytovatelé služeb třetích stran, například Sumsub.
...
- K čerpání půjček je nutná mobilní aplikace Debifi (iOS/Android). Aplikaci si musíte stáhnout, vytvořit si účet a "propojit" své zařízení (zaregistrovat zařízení se svým účtem). Aplikace Debifi podporuje dvoufaktorovou autentizaci (2FA) a bez chytrého telefonu nelze transakce na Debifi potvrdit.
...
Navštivte [oficiální webové stránky společnosti Debifi](https://debifi.com/app).
...
Nainstalujte aplikaci podle typu chytrého telefonu, který máte, a otevřete ji.
...
Po vstupu do aplikace klikněte na nabídku **Nastavení**.
...
Ověřovací kód obdržíte e-mailem. Tento kód zkopírujte a vložte do aplikace. Poté otevřete aplikaci Debifi ve svém chytrém telefonu a přihlaste se.
...
V zájmu bezpečnosti vás společnost Debifi požádá o provedení tří kroků.
...
- Nejprve je třeba nastavit silný kód PIN pro pozdější přístup k aplikaci.
...
- Poté nastavte dvoufaktorové ověřování (2FA) a pomocí kódu 2FA spojte zařízení s účtem.
...
- Nakonec si uložte 12 slov svého soukromého klíče tak, že si je zapíšete na spolehlivé médium a uložíte na bezpečném místě. Tato fáze je nezbytná pro obnovení účtu a správu finančních prostředků.
...
- Pro zvýšení bezpečnosti můžete přidat i passphrase.
...
Po dokončení těchto kroků klikněte na nabídku **Nabídky** a zobrazte si dostupné nabídky půjček. Po kliknutí na nabídku budete přesměrováni na webové stránky společnosti Debifi.
...
### Vstupte na webové stránky a prozkoumejte nabídky půjček



Po připojení zařízení přejděte na webovou stránku [Debifi](https://debifi.com/). Přihlaste se a vytvořte zabezpečené spojení mezi mobilní aplikací Debifi a webovou platformou. To vám usnadní interakci s dostupnými nabídkami půjček (přehledné zobrazení detailů každé nabídky) a správu vašeho účtu.
...
Video návod, jak se přihlásit pomocí účtu na platformě :
...
Platforma vám zprostředkuje kontakt s likviditou institucionální kvality a nabízí řadu možností, které vyhovují vašim potřebám. Projděte si nabídku a zjistěte, co je k dispozici. Máte také možnost flexibilně upravit parametry půjčky podle své individuální tolerance k riziku a finanční situace.
...
Fiat měny, které Debifi v současné době nabízí, si můžete prohlédnout na platformě.
...
### Jasné a flexibilní smluvní doložky



Společnost Debifi si zakládá na transparentních a flexibilních podmínkách půjček, aby vyhověla potřebám každé strany (věřitele i dlužníka). Klíčová ustanovení zahrnují :
...
Úvěrové tranše Bitcoin jsou zpravidla tři (3):
...
Stanovení sazby obecně závisí na zvoleném LTV, délce trvání úvěru, volatilitě zajištění a posouzení rizik specifických pro danou platformu. Sazby zůstávají fixní po celou dobu trvání úvěru.



#### Doba splatnosti a flexibilita splácení úvěru
...
### Zahájení úvěrového procesu



Chcete-li si vybrat nabídku půjčky, která vyhovuje vašim potřebám, klikněte na ni a zobrazte její vlastnosti.
...
1. Název úvěrové instituce ;


2. Výše půjčky se pohybuje v rozmezí;


3. Že obdržíte prostředky v USDC Ethereum ;


4. Doba trvání úvěru, úroková sazba a poměr LTV;


5. Pro tuto nabídku je vyžadováno KYC;
...
Jakmile jste s nabídkou spokojeni a vyplnili jste potřebné údaje, klikněte na "Contract request".
...
Vraťte se do mobilní aplikace pro ''**Provide public key**''.
...
### Složení záruky a přijetí vašich finančních prostředků
...
Toto oznámení se zobrazí také v mobilní aplikaci.
...
Poté obdržíte od společnosti Debifi oznámení s výzvou k úhradě poplatků nebo provizí za půjčku, abyste mohli postoupit ve stavu vaší půjčky.
...
Stačí, když podepíšete transakci, která umožní společnosti Debifi odečíst provizi ze záruky. Váš věřitel bude muset ze své strany také podepsat transakci odečtení poplatku, jinak společnost Debifi nebude moci získat svou provizi.
...
V případě zvýšení ceny kolaterálu si dlužník ponechá veškeré kapitálové zisky z kolaterálu. Dluží pouze částku úvěru, která je předem stanovena a nezávislá na ceně Bitcoin.




## Splácení a vymáhání zajištění



Na konci sjednané doby splatnosti (nebo dříve, pokud si to přejete) musíte půjčku splatit.
...
Gratulujeme! Proces jste dokončili.
...
Sledujte poměr úvěru k zajištění (LTV). Pokud je to možné, nastavte si upozornění (cena BTC, LTV). Nedovolte, aby se váš poměr přiblížil 90 %. V případě pochybností zvyšte zajištění nebo předčasně splaťte.
...
Začněte pokud možno v malém. Při první půjčce si vyzkoušejte skromnou částku, abyste se seznámili s procesem.
...
Pokud jste věřitelem, můžete si prohlédnout toto výukové video, které vás provede používáním platformy Debifi. Od výběru dlužníků, kteří mají zájem o vaši nabídku, přes poskytnutí veřejných klíčů, podepsání smluv, převod stablecoinů a další.
...
Nyní víte, jak využít platformu Debifi k získání půjčky.



Doporučuji vám absolvovat tento kurz, který se podrobně zabývá Bitcoin, stabilními mincemi a jejich přínosem pro suverenitu.
