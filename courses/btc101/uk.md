...
> Мілтон Фрідман, відомий економіст, передбачив у 1999 році: «Я думаю, що Інтернет стане однією з основних сил у зменшенні ролі уряду. Єдине, чого не вистачає, але скоро буде розроблено, це надійна електронна готівка — метод, за допомогою якого ви зможете підсумокати кошти через Інтернет від А до Б, при цьому А не знатиме Б, а Б не знатиме А".
...
Протокол, заснований на блокчейні, може задовольнити лише два з цих 3 аспектів. У протоколі Біткоїн було зроблено вибір на користь децентралізації/безпеки. З одного боку, розмір блоку в 1 МБ і час між двома блоками (в середньому 10 хвилин) дозволяють запустити Біткоїн-вузол за нижчу вартість, сприяючи децентралізації. З іншого боку, виробництво блоків за допомогою Proof-of-Work робить шахрайство в межах протоколу надзвичайно дорогим, одночасно полегшуючи верифікацію мережевими вузлами, таким чином сприяючи безпеці. Однак, ці вибори накладають обмеження на середню кількість транзакцій у блоку, що приблизно відповідає кільком транзакціям в секунду. Ця кількість є смішною порівняно з оброблювальною потужністю платіжних процесорів, таких як VISA, яка становить 1700/с. Проте це обмеження є необхідним для того, щоб здійснювати транзакції з Біткоїном без цензури та без довіри до третіх сторін. Однак розробники Біткоїну задумувалися над цією проблемою ще з самого початку.

### Мережа Lightning як рівень зверху

Після років роздумів і численних спроб з'являється протокол Lightning. Використовуючи певну кількість специфікацій, цей протокол дозволяє побудувати однорангову платіжну мережу, використовуючи безпеку та програмованість протоколу транзакцій Біткоїна. Lightning Network діє як мережа платіжних каналів, що дозволяє здійснювати миттєві транзакції з низькими комісіями для відправника. Ця мережа платіжних каналів навіть дозволяє здійснювати транзакції між особами, які не мають прямого підключення до каналу.

![зображення](assets/en/chapter18/4.webp)

Традиційні сервіси грошових підсумоків, такі як Western Union, центральні банки, Visa та Mastercard, можуть зникнути, якщо не впровадять технологію Lightning Network. Lightning Network є більш ефективною та економічною порівняно з існуючими платіжними системами. Дійсно, Lightning Network дозволяє здійснювати майже необмежену кількість транзакцій між двома учасниками, які діляться каналом, без додаткових енергетичних витрат на базовому блокчейні, окрім транзакції для оголошення створення каналу.

![зображення](assets/en/chapter18/7.webp)

Транзакції захищені за допомогою криптографії та опосередковано через енергію, споживану майнерами Біткоїна. Транзакції можуть здійснюватися миттєво, без географічних обмежень, а комісії є надзвичайно низькими, часто менше 0,5%.

Таким чином, мережа Lightning Network є багатообіцяючою спробою розгорнути ефективну платіжну систему для здійснення транзакцій в біткоїнах. Вже існує безліч гаманців Lightning, з якими ви можете ознайомитися в нашому навчальному розділі або на нашому тренінгу по Lightning Network.
...
Як ми щойно побачили, протокол Біткоїна, хоча й є революційним, стикається з серйозними проблемами масштабованості для обробки всіх наших щоденних транзакцій. Щоб вирішити ці проблеми, у 2016 році було запропоновано рішення другого рівня, відоме як мережа Lightning Network, яка наразі має кілька різних реалізацій, всі з яких є сумісними:

- Core-lightning від Blockstream
- Eclair від Acinq
- LND від Lightning strike

Ця пірингова (peer-to-peer) мережа має на меті полегшити мікротранзакції, тобто транзакції з дуже низькою вартістю, які в іншому випадку були б недоцільними через високі комісії та тривалий час підтвердження в блокчейні Біткоїна.

### Які випадки використання мережі?

Ця технологія відкриває двері до широкого спектру потенційних застосувань для Біткоїна, які раніше були недосяжні через обмеження, необхідні для забезпечення безпеки та децентралізації Біткоїна. Серед таких застосувань у повсякденному житті можна згадати миттєве виставлення рахунків у торгівлі (як фізичній, так і онлайн), потокові грошові перекази для платежів у реальному часі, а також мікродонати за контент. Розгортання мережі майже миттєвих, безпечних і дешевих транзакцій (в середньому менше 0,5%) дозволяє реалізувати багато раніше немислимих бізнес-моделей. Це стало можливим завдяки тому, що Lightning Network використовує сатоші (десяткові частини Біткоїна) для своєї роботи.

![зображення](assets/en/chapter19/9.webp)

Індустрія відеоігор пропонує особливо цікавий приклад того, як Мережа Lightning Network може бути використана для трансформації існуючих бізнес-моделей. Концепція "шкіри в грі" є ідеєю, яка нещодавно набула популярності в цьому контексті. Вона, по суті, передбачає наявність фінансових інтересів у результаті гри. Мережа Lightning Network дозволяє гравцям ставити дуже малі суми грошей під час ігор, наприклад, кілька сатоші (приблизно частина євроцента). Це дозволяє встановити ставку, яка стимулює конкуренцію, одночасно значно підвищуючи витрати на використання ботів.

![зображення](assets/en/chapter19/2.webp)

Підсумовуючи, майбутнє мікротранзакцій з біткоїном виглядає багатообіцяючим завдяки таким інноваціям, як Lightning Network. Оскільки ці технології продовжують розвиватися і вдосконалюватися, ми можемо очікувати, що в найближчому майбутньому з'являться нові і захоплюючі додатки. Візьмемо, наприклад, концепцію «грошових потоків». Завдяки Lightning Network ми можемо здійснювати мікротранзакції щохвилини (потенційно без довіреної третьої сторони), що відкриває двері для експериментів з економічними моделями, в яких споживачі платять за контент на основі того, що вони споживають.

![зображення](assets/en/chapter19/8.webp)

У такій системі гроші автоматично розподіляються на основі заздалегідь визначеного відсотка між різними учасниками надання послуги або продукту. Це може докорінно змінити наше уявлення про моделі оплати. Наприклад, замість того, щоб платити щомісячну підписку за послугу, користувачі могли б платити за хвилину, або навіть за секунду, часу, проведеного у використанні цієї послуги. Така економічна модель могла б мати глибокі наслідки для творців контенту, які були б зацікавлені у створенні якісного контенту, щоб утримувати увагу користувачів. Користувачі, у свою чергу, платитимуть лише за той контент, який вони споживають, таким чином усуваючи авансові платежі за підписку. Можна навіть уявити собі використання цієї системи для оренди товарів.

![зображення](assets/en/chapter19/3.webp)
На завершення, мережа Lightning Network відкриває безліч цікавих варіантів використання для користувачів Біткоїна. Економічні моделі та бізнес-можливості, що з'являються в результаті, численні та різноманітні. Ми запрошуємо вас спробувати це самостійно, протестувавши застосунок для подкастів [Fountain](https://www.fountain.fm/), який дозволяє отримувати винагороду у вигляді кількох сатоші за прослуховування ваших улюблених подкастів!
...
Як сказав Морфеус Нео: "Ти вибираєш синю пігулку, історія закінчується, ти прокидаєшся у своєму ліжку і віриш у те, що хочеш вірити. Ти вибираєш червону пігулку, залишаєшся в Країні Чудес, і я покажу тобі, наскільки глибокою є кроляча нора." Готові дослідити кролячу нору Біткоїна? Будьте обережні, адже ви можете знову знайти свою фінансову свободу!

![червона пігулка](assets/posters/fr/2_pilluleorange.webp)

### Технологічне майбутнє та його наслідки

Технології розвиваються в геометричній прогресії, і ніхто не може з упевненістю передбачити їхній подальший розвиток. Звʼязок зі світом і штучний інтелект продовжують прогресувати. Знання, які людина може отримати через інтернет, з часом стають усе більш безмежними.

Візьмімо як приклад штучний інтелект. Ці технології вже перевершили або наближаються до рівня людської продуктивності в дедалі більшій кількості сфер, таких як відеоігри, створення зображень і текстів, а також аналіз даних. Одним із можливих наслідків є те, що понад 80% робочих місць можуть зникнути через розвиток штучного інтелекту та автоматизації. У нас є кілька варіантів: обмежити технологічний прогрес або використовувати збільшений капітал, отриманий від підвищення продуктивності завдяки штучному інтелекту.

Основні питання, які варто поставити:

- Як керувати суспільством, де 80% робочих місць зникнуть?
- Як відродити населення?
- Чи потрібна така кількість вчителів?
- Геополітичні, політичні та соціальні наслідки автоматизації обговорюються недостатньо. 
  Комп'ютерні технології, інтернет, стрімінг і віртуальна реальність змінять освіту. Можна уявити універсальний курс для всіх учнів, керований державою, де вчителі не читають лекції, а безпосередньо супроводжують студентів. Діти можуть занурюватися у віртуальний світ і вивчати історію в інтерактивному середовищі.

- Де межа між вчителем та ШІ?
- Як ми можемо гарантувати суспільству процвітання?

Ці фундаментальні питання для нашого майбутнього мають бути обговорені та колективно вирішені. Але який зв'язок з Біткоїном? Як інтернет для способів комунікації, Біткоїн є технологічною революцією для нових способів масштабної організації, надаючи нам можливість обмінюватися цінностями без будь-якої довіреної третьої сторони. Чи хочемо ми перешкоджати технологічному розвитку грошової системи або збирати збільшення капіталу через десятикратний приріст продуктивності від використання протоколів Біткоїн і Lightning?

### Яке майбутнє фінансів?

Ці роздуми також піднімають питання про те, хто повинен володіти, санкціонувати та відстежувати гроші, які ми використовуємо. Мета полягає в тому, щоб зробити вибір між закритою системою з невиборними лідерами та відкритою системою без довірених третіх сторін, де переважає нейтралітет.
...
Прийняття нових технологій може призвести до значних економій на масштабах по всьому світу. Чи варто дозволити вільний рух капіталу? Міжнародні блокади мають економічні та політичні наслідки. Чи етично використовувати фінансових посередників, таких як Western Union, які іноді стягують до 25% комісії? Ми вважаємо, що в усе більш цифровому світі, гроші мають бути демократизовані та вважатися загальним добром, що належить людям, а не державі чи непрозорим фінансовим інституціям.
...
У світі є 2,4 мільярда людей без банківського рахунку, що, безумовно, створює географічні нерівності. Біткоїн дозволяє забезпечити рівність у транзакціях, незалежно від вашого соціального статусу чи політичної позиції. Протокол Біткоїна аполітичний і не надає особливих привілеїв ні президенту, ні іншим учасникам. Лідери повинні мати ті ж самі привілеї, що й звичайні люди, щоб сприяти розвитку зверху, а не залишати одних на вершині, а інших — на дні. Чи повинні всі користуватися однією валютою, незалежно від свого соціального статусу? Важливо задуматися про те, який світ ми хочемо залишити нашим дітям. Ми хочемо залишити відкритий світ, де вони вільні розпоряджатися своїми грошима, як вважатимуть за потрібне.

Біткоїн є важливим і не повинен сприйматися лише як гра на удачу. Важливо продовжувати ставити питання про Біткоїн.

### Біткоїн: революційний протокол

Як ми бачили в попередньому розділі, протокол Біткоїна є нейтральним до всіх своїх користувачів. Завдяки правилам консенсусу та криптографії, ми можемо записувати транзакції незмінно в глобальному публічному реєстрі, гарантуючи передачу грошової вартості без будь-якої довіреної третьої сторони. Інфраструктура другого рівня (і незабаром третього рівня, з RGB) дозволяє масштабувати мережу та розвивати нові функціональні можливості, особливо для вирішення проблем масштабування.

Біткоїн має всі необхідні характеристики, щоб бути ефективною та здоровою валютою: ділимий, миттєво транспортабельний, непіддатливий цензурі, незначна вартість перевірки, і з вже встановленою монетарною політикою на століття вперед з цими 21 мільйоном одиниць. Біткоїн є псевдонімним і може бути обміняний будь-де у світі без будь-якого дозволу від будь-якої сутності, вам просто потрібно тримати власні приватні ключі - як кажуть "Не твої ключі, не твої біткоїни".

Біткоїн приймають різні групи людей — від криптографів і лібертаріанців до традиційних бізнесів і навіть цілої країни. Однак Біткоїн для всіх, і кількість його користувачів постійно зростає, як і кількість вузлів Біткоїну, що виступають охоронцями історії транзакцій, забезпечуючи децентралізацію.
Біткоїн більше не можна зупинити чи цензурувати. Це мирна революція, спрямована на зміну монетарної системи та забезпечення фінансової інклюзивності. Користувачі можуть отримати біткоїни, приймаючи їх як оплату за товари або послуги, або купуючи через регульовані чи нерегульовані платформи. Біткоїни можна зберігати в гаманцях, мобільних додатках або фізичних пристроях. У Біткоїні не існує довірених посередників, адже він пропагує прозорість, свободу та особисту відповідальність — як кажуть, "Не довіряй, перевіряй".

Зміна фінансової системи передбачає зміну валюти. Сатоші створив Біткоїн у 2008 році, щоб запропонувати спробу такої зміни. Доступ до "легких" і "чарівних" грошей розбещує. Тому Біткоїн є альтернативою для побудови нової нейтральної монетарної системи. Біткоїн дає змогу звільнитися від банківської системи. Це соціальне явище, яке спонукає нас брати участь у мирній революції. Ви готові приєднатися?

## Подяка та продовження копати кролячу нору
