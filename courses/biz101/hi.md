...
| **व्यापारी Interface**           | साधारण Bitcoin बिजली Wallet: एक मोबाइल फोन पर ऐप                                                                                  |

| **ग्राहक Interface**           | Bitcoin QR भुगतान कोड, ग्राहक के निजी Wallet द्वारा स्कैन किया गया                                                                        |

| **फीस**                         | ग्राहक Bitcoin लाइटनिंग फीस और कोई भी लागू ऐप फीस का भुगतान करता है                                                                          |

| **पॉइंट ऑफ सेल डिवाइस**         | फ्री स्मार्टफोन ऐप या फिर एक फिजिकल टर्मिनल का विकल्प (जैसे कि Bitcoinize)                                                                 |
...
| **मन की स्थिति**                | "मैं अपने व्यवसाय में Bitcoin को स्वीकार करता हूँ, लेकिन मुझे इससे कोई खास मात्रा की उम्मीद नहीं है"                                                                    |
...
| **उदाहरण अनुशंसित समाधान** | स्विस Bitcoin पे                                                                                                                          |

| **व्यापारी Interface**           | सरल Bitcoin बिजली Wallet: मोबाइल फोन पर एक ऐप; न्यूनतम विवरण के साथ सरल चालान

| **ग्राहक Interface**           | Bitcoin QR भुगतान कोड, ग्राहक के निजी Wallet के माध्यम से स्कैन किया गया                                                                        |

| **फीस**                         | आमतौर पर Bitcoin Address को भेजने के लिए <1%, और फिएट करेंसी में बदलने के लिए <1.5%                                                           |

| **पॉइंट ऑफ सेल डिवाइस**         | फ्री स्मार्टफोन ऐप या फिजिकल टर्मिनल का विकल्प (जैसे Bitcoinize)                                                                 |
...
| **ग्राहक Interface**           | Bitcoin QR पेमेंट कोड, ग्राहक के निजी Wallet के माध्यम से स्कैन किया गया                                                                                    |

| **फीस**                         | मुफ्त ओपन-सोर्स बैकएंड और पेड लाइटनिंग होस्टिंग/सर्विस फीस का मिश्रण; फ्रंट-एंड फीस में Bitcoin लाइटनिंग फीस और <1.5% कन्वर्जन फीस शामिल हैं       |
...
| **ग्राहक Interface**           | Bitcoin क्यूआर पेमेंट कोड से लेकर पूरी तरह से कस्टम यूआई और/या एपीआई इंटीग्रेशन तक                                                              |

| **फीस**                         | आंतरिक विकास और तीसरे पक्ष की फीस का संयोजन; ग्राहक Bitcoin लाइटनिंग फीस प्लस सेवा प्रदाताओं से किसी भी लेन-देन शुल्क का भुगतान करता है |
