...
正如 LaurentMT 在 Space Kek #19（法语播客）中所说，随着时间的推移，钱包足迹在链分析中的作用会显著增加。事实上，随着脚本类型的不断增加，以及钱包软件对这些新功能的逐步应用，这些差异就更加明显了。我们甚至可以准确识别被追踪实体所使用的软件。因此，重要的是要理解，研究钱包的足迹对近期交易尤其重要，比 2010 年代初启动的交易更有意义。
