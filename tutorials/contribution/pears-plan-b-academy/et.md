...
#### 1.2.3. Node.js ja npm paigaldamine NVM-i kaudu
...
#### 1.2.4. Paigaldage Pears koos npmiga
...
#### 1.2.6. Katsepirnid koos Keetiga
...
See käsk laeb Keet-rakenduse otse Pearsi võrgust, ilma keskserverit kasutamata. Kui Keet käivitub õigesti, tähendab see, et teie Pearsi paigaldus on täielikult toimiv.
...
### 1.3. Kuidas paigaldada pirnid Windowsis


Pearsi paigaldamine Windowsis on sama lihtne kui Linuxis, kuid nõuab mõningaid spetsiifilisi tööriistu.


*Kui kasutate Linuxi ja olete juba paigaldanud Pearsi, võite otse edasi minna **Sammu 2**.*


#### 1.3.1. Avage PowerShell administraatorina
...
#### 1.3.4. Paigaldiste kontrollimine
...
#### 1.3.5. Paigaldage Pears koos npmiga
...
#### 1.3.7. Katsepirnid koos Keetiga
...
### 1.4. Kuidas paigaldada pirnid macOS-i
...
*Kui kasutate Linuxi või Windowsi ja olete juba paigaldanud Pearsi, võite otse edasi minna **Sammu 2**.*


#### 1.4.1. Kontrollige süsteemi eeldusi
...
#### 1.4.3. Installige Node.js ja npm
...
#### 1.4.4. Paigaldage Pears koos npm-iga
...
#### 1.4.6. Katsepirnid koos Keetiga
...
## 2. Kuidas kasutada Plan ₿ Academy't pirnide puhul
...
## 3. Kuidas seed kava ₿ Akadeemia pirni kohta ₿ Kuidas seed kava ₿ Akadeemia pirni kohta


Pearsi võrgus tähendab *seed* rakenduse ümberjaotamine teistele eakaaslastele oma masinast. Praktikas, kui te seed Plan ₿ Academy, muutub teie arvuti andmeallikaks, mis võimaldab teistel kasutajatel rakenduse alla laadida, ilma et nad peaksid toetuma keskserverile.


See mehhanism tugevdab meie rakenduse vastupidavust ja tsensuurikindlust Pearsi võrgus. Mida rohkem seed eakaaslasi on rakenduses, seda kättesaadavamaks ja detsentraliseeritumaks see muutub, isegi kui mõni algne sõlmpunkt läheb offline.
