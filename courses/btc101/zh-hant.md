...
Lightning Network 於 2017 年正式實施，目的是解決比特幣的可擴展性問題，因為它可以實現即時、低成本的比特幣交易。
...
比特幣不能被阻止，也不能再被審查。它是一場和平的革命，改變了貨幣體系，實現了金融包容性。用戶可以通過接受比特幣進行交易或通過受監管或不受監管的平台購買比特幣來獲得比特幣。他們可以將資金存放在自己的錢包，行動應用程式或實體設備中，而不需要可信賴的中介。比特幣提倡透明、自由和個人責任：正如俗語所說 「Don't Trust, Verify.」(不要信任，要驗證)。
