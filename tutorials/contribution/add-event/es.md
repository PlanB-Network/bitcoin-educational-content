...
- Crea una carpeta para tu evento. Para hacerlo, en el cuadro `Name your file...`, escribe el nombre de tu evento en minúsculas con guiones en lugar de espacios. Por ejemplo, si tu evento se llama "Paris Bitcoin Conference", deberías anotar `paris-bitcoin-conference`. También agrega el año de tu conferencia, por ejemplo: `paris-bitcoin-conference-2024`:
...
- Regresa a la carpeta `resources/conference/` y selecciona la carpeta de tu evento que acabas de crear en el commit anterior:
  
![evento](assets/18.webp)

- En la carpeta de tu evento, haz clic en el botón `Add file`, luego en `Create new file`:
...
- Verifica que sigues en la misma rama de trabajo, luego haz clic en el botón `Commit changes`:
