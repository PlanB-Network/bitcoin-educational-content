...
Si vous êtes à distance, comparez les codes sur une autre messagerie sécurisée. Ou bien encore mieux, si vous pouvez vous voir en présentiel, scannez le QR code de votre interlocuteur en cliquant sur "Scan code".
