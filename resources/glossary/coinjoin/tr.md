...
> ► *"CoinJoin" teriminin Fransızca çevirisi bulunmamaktadır. Bazı bitcoin kullanıcıları CoinJoin işlemine atıfta bulunmak için "mix", "mixing" veya "mixage" terimlerini de kullanmaktadır. Karıştırma daha ziyade CoinJoin'nin merkezinde kullanılan bir işlemdir. Ayrıca, coinjoins yoluyla karıştırmayı, işlem sırasında bitcoinleri ele geçiren merkezi bir aktör yoluyla karıştırma ile karıştırmamak önemlidir. Bunun, kullanıcının işlem sırasında bitcoinlerinin kontrolünü kaybetmediği CoinJoin ile hiçbir ilgisi yoktur.*