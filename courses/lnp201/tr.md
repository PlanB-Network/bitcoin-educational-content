...
$$ f*{\text{Carol-Bob}} = \text{baz ücret} + \left(\frac{\text{ppm} \times \text{amount}}{10^6}\right) $$
...
$$ f*{\text{Suzie-Carol}} = \text{temel ücret} + \left(\frac{\text{ppm} \times \text{amount}}{10^6}\right) $$
