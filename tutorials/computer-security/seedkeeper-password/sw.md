...
The Seedkeeper ni kadi mahiri iliyotengenezwa na Satochip, kampuni ya Ubelgiji inayobobea katika suluhu za maunzi kwa ajili ya kusimamia na kulinda siri za kidijitali. Satochip inayojulikana kwa anuwai ya kadi mahiri za mfumo ikolojia wa Bitcoin, ilipendekeza Mlinzi wa Mbegu kama njia mbadala ya mbinu za jadi za kuhifadhi misemo ya Mnemonic na siri zingine za kidijitali.



Kwa maneno madhubuti, Mtunza Mbegu huchukua umbo la kadi mahiri iliyoidhinishwa na multifunctional, iliyoidhinishwa na EAL6 na kichakataji salama na kumbukumbu isiyoweza kuchezewa (yaani "*secure element*"). Kama jina lake linavyopendekeza, jukumu lake ni kuhifadhi kumbukumbu na manenosiri ya kwingineko ya Bitcoin kwa njia iliyosimbwa na kulindwa. Ukiwa na Mlinzi wa mbegu, unaweza generate, kuagiza, kupanga na kuhifadhi siri zako moja kwa moja katika sehemu salama ya kadi.
...
- Bitcoin** Hifadhi ya vifungu vya Mnemonic: badala ya kuandika maneno yako 12 au 24 kwenye karatasi, unaweza kuyaingiza kwenye kadi mahiri na kuyalinda kwa msimbo wa PIN.
...
Kitaalamu, Mtunza mbegu ana uwezo wa baiti 8192, na kuiwezesha kuhifadhi angalau siri 50 tofauti (nambari kamili itategemea saizi yao na metadata inayohusiana na kila moja). Mtunza mbegu anaweza kufikiwa ama [kupitia kisoma kadi mahiri kilichounganishwa](https://satochip.io/accessories/) kwenye kompyuta, au kupitia programu ya simu yenye muunganisho wa NFC. Mfumo mzima hufanya kazi katika hali ya nje ya mtandao, bila muunganisho wa Mtandao, unaohakikisha eneo dogo la mashambulizi.
...
Katika somo hili, tutashughulikia tu matumizi ya SeedKeeper kwa manenosiri ya kitamaduni, kwa namna ya kidhibiti nenosiri. Ikiwa ungependa kutumia SeedKeeper kuhifadhi vifungu vya maneno ya Bitcoin Wallet Mnemonic, tafadhali tazama mafunzo haya mengine:
...
Zindua programu na ubofye kitufe cha "*Bofya & Changanua*".
...
Thibitisha msimbo wako wa PIN kwa mara ya pili.
...
Sasa utapelekwa kwenye ukurasa wako wa usimamizi wa kadi mahiri.
...
## 4. Hifadhi nywila kwenye Mtunza mbegu
...
Chagua "generate siri *". Chaguo la "*Leta siri*" hukuruhusu kuhifadhi siri iliyopo (kwa mfano, nenosiri ulilounda hapo awali).
...
Kwa upande wetu, tunataka kuhifadhi nenosiri. Bonyeza "*Nenosiri*".
...
Weka "*Lebo*" kwa siri hii ili iweze kutambulika kwa urahisi ikiwa utahifadhi taarifa kadhaa kwenye Mtunza mbegu wako. Unaweza pia kuongeza jina la mtumiaji linalohusishwa na nenosiri na URL ya tovuti.
...
Chagua urefu na vigezo vya nenosiri lako, kisha ubofye "*generate*", kisha "*Leta*".
...
## 5. Fikia nenosiri lako la Seedkeeper



Ikiwa ungependa kuangalia nenosiri lako, chukua Mtunza mbegu wako na ubofye kitufe cha "*Bofya na Uchanganue*".
...
Ingiza msimbo wako wa PIN, kisha ubonyeze "*Next*".
...
Hii inakupeleka kwenye orodha ya siri zako zote zilizosajiliwa. Katika mfano huu, nataka kuonyesha nenosiri kwa akaunti yangu ya Plan ₿ Network, kwa hiyo mimi bonyeza juu yake.
...
Nenosiri lako lililohifadhiwa awali sasa linaonekana kwenye skrini. Unaweza kuinakili na kuitumia kwenye tovuti husika.
...
Fungua programu, bofya "*Bofya & Uchanganue*", weka PIN ya Seedkeeper n°1 (chanzo), kisha uchanganue.
...
Hii inakupeleka kwenye ukurasa wa nyumbani, na orodha ya siri zako. Bofya kwenye vitone vitatu kwenye sehemu ya juu ya kulia ya Interface.
...
Chagua "* Fanya chelezo *", kisha ubonyeze "* Anza*".
...
Weka PIN ya kadi yako ya chelezo (Seedkeeper n°2).
...
Fanya vivyo hivyo na kadi kuu (Seedkeeper n°1), kisha ubofye "*Fanya nakala rudufu*".
...
Unaweza kuchanganua Seedkeeper n°2 yako ili kuangalia kama siri zimenakiliwa.
...
Hayo ndiyo yote yaliyopo kwake! Sasa unajua jinsi ya kutumia Seedkeeper kuhifadhi nywila zako. Katika mafunzo yajayo, tutaangalia jinsi ya kutumia Seedkeeper kucheleza kwingineko ya Bitcoin. Pia ninakualika ugundue matumizi yake kwa pamoja na SeedSigner :
