---
name: Tracking Bitcoin as a Business

description: Learn to easily and quickly account for Bitcoin payments within a small business.
---
...
This is one of two ways to access the Point of Sale feature. The other method is through the dedicated [Wallet of Satoshi PoS app](https://www.walletofsatoshi.com/pos.)
...
**Attention**: filling in the `Note` field when creating the LN invoice for the customer will make updating the Bitcoin accounting much easier. The same goes for making an LN payment to suppliers. Ideally, each transaction is associated with a payment note.
