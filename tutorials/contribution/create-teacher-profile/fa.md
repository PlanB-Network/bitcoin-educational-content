---
name: پروفسور Plan ₿ Network
description: چگونه می‌توانم پروفایل معلم خود را در Plan ₿ Network اضافه یا ویرایش کنم؟
---
![cover](assets/cover.webp)


اگر قصد دارید با نوشتن یک آموزش یا دوره جدید به Plan ₿ Network کمک کنید، به یک پروفایل معلم نیاز خواهید داشت. این پروفایل به شما امکان می‌دهد تا اعتبار مناسب برای محتوایی که به پلتفرم ارائه می‌دهید را دریافت کنید.


برای کسانی که قبلاً در ایجاد محتوای آموزشی در Plan ₿ Network مشارکت داشته‌اند، احتمالاً پروفایل معلم دارید. می‌توانید آن را در پوشه `/professors` [در مخزن GitHub ما](https://github.com/PlanB-Network/Bitcoin-educational-content/tree/dev/professors) پیدا کنید. اگر پروفایل شما قبلاً وجود دارد، ورود خود را در فایل `professor.yml` پیدا کنید.
...
آسان‌ترین راه برای ایجاد پروفایل معلم خود در Plan ₿ Network استفاده از ابزار پایتون یکپارچه ما است. در اینجا نحوه کار آن آمده است.
...
به [مخزن GitHub Plan ₿ Network اختصاص داده شده به داده‌ها](https://github.com/PlanB-Network/Bitcoin-educational-content/graphs/contributors) بروید.
...
اگر هنوز یک Fork از مخزن Plan ₿ Network ندارید، GitHub پیشنهاد می‌کند که یکی ایجاد کنید. روی "*Fork این مخزن*" کلیک کنید.
...
در این صورت، درخواست کشش شما در زبانه "*Pull Request*" مخزن اصلی Plan ₿ Network قابل مشاهده خواهد بود. اکنون تنها کاری که باید انجام دهید این است که منتظر بمانید تا یک مدیر تغییرات شما را ادغام کند.
