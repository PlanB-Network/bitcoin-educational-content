---
name: Wengi
description: Jukwaa lisilo la KYC la Bitcoin P2P Exchange kupitia Umeme na Nostr
---
...
Je, unapata au kuuza vipi bitcoins bila kuathiri uhuru wako wa kifedha? Mifumo ya kati huweka taratibu za KYC zinazofichua data yako ya kibinafsi, pamoja na uwezekano wa kufungia akaunti kiholela au ufuatiliaji wa serikali.



**Mostro P2P** inatoa mbadala uliogatuliwa unaochanganya Lightning Network, itifaki ya Nostr na kushikilia ankara. Ubunifu wake mkuu: mfumo wa otomatiki wa escrow ambapo bitcoins zako zinasalia chini ya udhibiti wako katika Exchange, kuondoa hatari ya wizi, kufilisika kwa Exchange au kutaifishwa kiholela.
...
Mostro P2P ni itifaki ya chanzo huria ya Bitcoin Exchange iliyoundwa na **grunch**, msanidi wa bot maarufu ya Telegram **lnp2pbot** iliyozinduliwa mwaka wa 2021. Ingawa lnp2pbot tayari imewasha ubadilishanaji wa P2P bila KYC kupitia Umeme, iliwasilisha udhaifu mkubwa wa kuathiriwa kwa**Telegramu isiyoweza kufikiwa. na serikali.
...
- Wateja wengi**: miingiliano ya watumiaji (CLI, Simu ya Mkononi, Wavuti)
...
**Ubadilikaji wa malipo**: Usaidizi wa sarafu nyingi za fiat kupitia yadio.io huduma ya viwango vya Exchange. Inakubali uhamishaji wa SEPA, PayPal, Revolut, pesa taslimu na njia yoyote iliyokubaliwa kati ya wahusika.
...
### Mostro CLI - Amri Line Mteja



**Mostro CLI** ndiye mteja aliyekomaa na amilifu zaidi. Imeandikwa katika Rust, inatoa anuwai kamili ya vipengele vya Mostro kupitia mstari wa amri wa Interface. Inapatana na macOS, Linux na Windows.
...
- `kutolewa`: Achilia escrow na ukamilishe Exchange
- `getdm`: Tazama ujumbe wa moja kwa moja
- `rate` : Tathmini mshirika wako baada ya Exchange
...
**programu ya simu ya mkononi** katika toleo la alpha huwezesha biashara ya P2P moja kwa moja kutoka kwa simu yako mahiri. Mchoro angavu wa Interface yenye urambazaji ulio na vichupo, utazamaji wa mpangilio, vichujio vya hali ya juu na gumzo iliyojumuishwa ili kuwasiliana na wenzako.



Inapatikana kwa **Android** (kupitia APK kwenye GitHub), ni chaguo mojawapo kwa watumiaji wanaopendelea urahisi na biashara ya mara kwa mara ya rununu.
...
Programu ya wavuti ya hali ya juu ya Interface ya JavaScript chini ya usanidi amilifu. Imeundwa ili kutoa uzoefu kamili wa mtumiaji na utendaji wa kina wa biashara na usimamizi wa kwingineko. Fikia kupitia kivinjari bila usakinishaji unaohitajika.
...
- Hiari lakini inapendekezwa**: Muunganisho wa VPN au Tor ili kuficha IP yako Address
...
**Hatua ya 1: Uthibitishaji wa Rust**
...
- Ulinzi wa mtandao**: Washa VPN au Tor ili kuficha IP yako Address
- Wallet salama**: Washa kufuli kiotomatiki kwenye Umeme wa Wallet yako
...
Mostro itakuomba utoe **Umeme Invoice** ili kupokea BTC. Kiasi halisi katika satoshi kitaonyeshwa (hapa: 4715 Sats).
...
### Hatua ya 3: Toa Umeme wako Invoice



generate a Lightning Invoice kutoka kwa Wallet yako (Phoenix, Breez, n.k.) kwa kiasi kamili, kisha utume :
...
Mfumo unathibitisha usafirishaji na kukuarifu umngoje muuzaji alipe muda wa Invoice kabla ya kuwezesha escrow.
...
Angalia ujumbe wa moja kwa moja ili kuona jibu la muuzaji:
...
Mara tu muuzaji atakapothibitisha kupokea fiat na kuachilia escrow kwa amri ya `kutolewa`, utapokea bitcoins zako papo hapo kwenye Lightning Invoice uliyotoa.
...
**Ghairi agizo** (kabla haijachukuliwa) :
...
Bonyeza kitufe cha Green **"+"** chini kulia, kisha uchague **UZA** (kitufe chekundu).
...
**Maagizo muhimu**: Ni lazima sasa **ulipie kiwango cha Invoice** kilichoonyeshwa ili kufunga bitcoins zako (hapa 4674 Sats kwa EUR 1-5) kwenye escrow. Una **muda wa juu zaidi wa dakika 15** vinginevyo Exchange itaghairiwa.



Nakili mshiko wa Invoice na ulipe kutoka kwa Umeme wa Wallet (Phoenix, Breez, n.k.).
...
Mara baada ya **kuidhinisha risiti** ya malipo ya fiat kwenye akaunti yako, bonyeza kitufe cha Green **RELEASE** na uthibitishe kutuma Satss kwa mnunuzi.
...
Bitcoins huhamishwa mara moja kwa mnunuzi kupitia Umeme wake Invoice.
...
4. Toa Umeme wako Invoice (iliyotolewa kutoka kwa Wallet yako)
...
9. Pokea bitcoins papo hapo kwenye Umeme Invoice yako
...
**Uhuru wa kifedha**: Bitcoin zako haziachi kamwe udhibiti wako wa moja kwa moja kwa utaratibu wa kushikilia Invoice, kuondoa hatari ya kufilisika au uharamia wa Exchange.
...
Mostro P2P inawakilisha njia mbadala ya kuahidi kwa ubadilishanaji wa serikali kuu, ikichanganya Lightning Network, Nostr na escrow otomatiki kwa biashara iliyogatuliwa kweli. Licha ya maendeleo yake ya mapema na ukwasi mdogo, jukwaa tayari linatoa uhuru wa kifedha, upinzani wa udhibiti na kutokujulikana kwa chaguomsingi.



Kwa bitcoiners ambao wanapendelea uhuru na usiri, Mostro ni chaguo linalofaa linalostahili uchunguzi unaoendelea. Usanifu wake uliogatuliwa hudhamini jamii badala ya mageuzi ya kibiashara, na hivyo kutengeneza njia kwa mustakabali wa ubadilishanaji wa bure wa Bitcoin.
