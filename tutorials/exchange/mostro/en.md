...
How do you acquire or sell bitcoins without compromising your financial sovereignty? Centralized platforms impose invasive KYC procedures exposing your personal data, with the possibility of arbitrary account freezing or state surveillance.
...
The **Mostro CLI** is the most mature and functional client. Written in Rust, it offers the full range of Mostro features via a Interface command line. Compatible with macOS, Linux and Windows.
...
- Wallet secure**: Activate the automatic lock on your Wallet Lightning
...
Mostro will ask you to provide a **Lightning Invoice** to receive the BTC. The exact amount in satoshis will be indicated (here: 4715 Sats).
...
The system confirms the shipment and informs you to wait for the seller to pay the Invoice hold before activating the escrow.
...
As soon as the seller confirms receipt of the fiat and releases the escrow with the `release` command, you instantly receive your bitcoins on the Lightning Invoice you supplied.
...
**Important instruction**: You must now **pay the Invoice hold** displayed to lock your bitcoins (here 4674 Sats for 1-5 EUR) in the escrow. You have **15 minutes maximum** otherwise the exchange will be cancelled.


Copy the Invoice hold and pay it from your Wallet Lightning (Phoenix, Breez, etc.).
...
**Financial sovereignty**: Your bitcoins never leave your direct control thanks to the Invoice hold mechanism, eliminating the risk of Exchange bankruptcy or piracy.
