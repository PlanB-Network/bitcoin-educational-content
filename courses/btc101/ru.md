...
**Майнеры обеспечивают безопасность сети и добавляют транзакции в блоки. Они используют электроэнергию через [ASIC](https://planb.academy/resources/glossary/asic)-машины для решения проблемы доказательства работы Биткойна**

![image](assets/ru/054.webp)

### Объяснение доказательства работы

Доказательство работы" ([proof of work](https://planb.academy/resources/glossary/proof-of-work), POW) - это механизм консенсуса безопасности протокола Bitcoin. Он является основой всего и играет важнейшую роль в теории игр Биткойна.
...
Одним словом, инновация биткойна заключается в том, что он предлагает решение проблемы двойных расходов с помощью блокчейна, основанного на принципе [proof of work](https://planb.academy/resources/glossary/proof-of-work) с плавающей сложностью. В цифровом мире концепция собственности отличается от физической. Фактически, в цифровом мире все можно скопировать и вставить, что создает риск использования цифровых активов, имеющих ценность, большее количество раз. Доверенные посредники, такие как банки, были созданы для решения этой технологической проблемы и обеспечения того, чтобы при передаче актива он больше не принадлежал отправителю.
...
Lightning основан на двусторонних платёжных каналах. Канал — это техническое взаимодействие между двумя участниками, которое позволяет им обмениваться сатоши офчейн, то есть без записи каждого платежа в блокчейн.
...
Lightning был разработан для того, чтобы обеспечивать платежи через посредников без необходимости им доверять. Для этого протокол использует смарт-контракты, называемые HTLC (*Hashed Time-Locked Contracts*). Не вдаваясь во все детали, запомните общий принцип:
...
В этой главе мы представляем четыре важных протокола, каждый из которых открывает новые возможности для Bitcoin: сайдчейны (в частности Liquid), Ark, RGB и Taproot Assets.
