...
_**of course, you must never share these words on the Internet, as I'm doing in this tutorial. This example wallet will be used only on the Testnet and will be deleted at the end of the tutorial.**_
...
Congratulations, you're now up to speed on the use of Single-share and Multi-share Backups on Trezor hardware wallets. If you'd like to take your wallet security one step further, take a look at this tutorial on BIP39 passphrases:
