...
در بیت کوین، آنچه ما واقعاً مبادله می کنیم بیت کوین ها به طور مستقیم نیستند، بلکه **[UTXO](https://planb.academy/resources/glossary/utxo)s** (Unspent Transaction Outputs )، به معنی "خروجی های تراکنش های خرج نشده" هستند.
