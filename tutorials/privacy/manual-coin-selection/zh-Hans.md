...
_本教程导入自[Bitcoin 讲习班的课程_](https://officinebitcoin.it/lezioni/coinco/)_
...
Bitcoin 协议的稳健性由简单的基石概念来保证。其中最重要的是透明度：所有 Bitcoin 交易都是公开的，任何人都可以轻松验证。虽然这一特性是协议的基石，因为它可以防止欺诈并确保资金的真实性，但它也可能对保密性构成挑战。 **您是否想过，如此高的透明度是否会影响您的隐私？
...
我们可能会问自己这样一个问题：** 为什么要这样做？ **为什么要这样做？** 我们不使用 "UTXO1 "有几个原因，或者说可能有几个原因**，这些原因都说明了为什么在支出阶段启用 Coin 控制手册是最好的做法之一**。
...
**Kyc 资金将不可避免地导致追查付款人的身份。如果这是你的 Wallet，你会希望外部观察者能够如此绝对肯定地追查到你的身份吗？
