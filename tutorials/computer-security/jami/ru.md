...
| Приложение | E2EE 1:1 | Группы E2EE | Анонимная регистрация | Open-source лицензия клиента | Open-source лицензия сервера | Децентрализованный сервер | Год создания |
| -------------------- | -------------- | -------------- | ------------------- | -------------------------- | --------------------------- | -------------------- | ----------------- |
| WhatsApp | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | 2009 |
| WeChat | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | 2011 |
