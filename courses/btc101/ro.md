...
- **Nivelul 3**, folosiți un portofel de nivel 1 sau 2 dar cu o frază de acces suplimentară. Fiți conștienți că acum trebuie să faceți backup atât listei de 12 sau 24 de cuvinte **cât și** frazei dumneavoastră de acces. Ideal, aceste două informații sunt stocate în două locuri diferite.
...
### Astfel, nodurile sunt nucleul central al Bitcoin.
...
- Nebunia ICO și sosirea publicului larg.
...
Vă invităm să reflectați asupra acestei noi revoluții monetare. Există atât de multe de explorat cu Bitcoinul încât este complicat să asimilezi totul dintr-o dată. Luați-vă timp, Bitcoinul nu va dispărea. Dimpotrivă, revoluția abia a început. Împreună, credem că suntem capabili să creăm lumea pe care dorim să o încredințăm copiilor noștri. O lume în care suveranitatea umană este un drept, unde intimitatea este respectată implicit și unde banii nu sunt manipulați. Sperăm că împreună vom realiza acest lucru.

![image](assets/en/chapter17/3.webp)

Dacă doriți să vă extindeți cunoștințele despre Bitcoin, un număr mare de autori, gânditori și eseisti au contribuit la stratul educațional al Bitcoinului. În ultimii ani, am listat și categorisit aceste lucrări pentru a oferi o [bibliotecă de resurse](https://planb.network/resources) celor mai curioși dintre voi. Veți găsi cele mai bune podcasturi, site-uri web, articole, tutoriale, cărți și alte conținuturi.

> Milton Friedman, un economist renumit, a prezis în 1999: "Cred că Internetul va fi una dintre forțele majore pentru reducerea rolului guvernului. Singurul lucru care lipsește, dar care va fi dezvoltat în curând, este un e-cash de încredere - o metodă prin care pe Internet poți transfera fonduri de la A la B fără ca A să cunoască B sau B să cunoască A."

### Rezumat rapid într-un poster!

![Alt text](assets/posters/en/18._hyperbitcoinization.webp)

# Viitorul Bitcoinului: Rețeaua Lightning
<partId>899fd35e-39e6-5a25-a73e-6fed6e725094</partId>

## O Scurtă Introducere în Rețeaua Lightning
<chapterId>b403f1e4-f1ff-572b-a242-9b58cb3736d0</chapterId>
Acum că avem bazele protocolului Bitcoin, vom introduce o rețea de plăți care utilizează protocolul Bitcoin pentru a permite tranzacții fulgerătoare. Vorbim, evident, despre Lightning Network!

### Pe scurt

Lightning Network este o tehnologie revoluționară care a schimbat profund percepția noastră despre Bitcoin. Este o soluție care abordează problema de scalabilitate a Bitcoin.

Pentru a înțelege pe deplin Lightning Network, este crucial să înțelegem cum evoluează Bitcoin. Bitcoin se dezvoltă în straturi de infrastructură: primul strat este blockchain-ul, iar al doilea strat este Lightning Network.

![image](assets/en/chapter18/6.webp)

Recunoscut ca un strat al Bitcoin, Lightning Network a fost validat și implementat în 2017. Permite tranzacții Bitcoin instantanee, cu costuri reduse, rezolvând astfel problema de scalabilitate a Bitcoin. Dar care este această problemă de scalabilitate cu care se confruntă Bitcoin?

### Un Blockchain Nu Poate Crește La Infinit

Problema de scalabilitate se referă la provocarea implementării unui sistem monetar capabil să ofere un număr tot mai mare de tranzacții pe secundă pe măsură ce este adoptat. Aceasta se raportează la trilema blockchain-ului. Imaginați-vă un triunghi cu descentralizarea, securitatea și scalabilitatea ca vârfuri ale sale.

![image](assets/en/chapter18/5.webp)

Un protocol bazat pe un blockchain poate satisface doar două dintre aceste 3 aspecte. În cadrul protocolului Bitcoin, au fost făcute alegeri pentru a favoriza descentralizarea/securitatea. Pe de o parte, dimensiunea blocului de 1MB și timpul dintre două blocuri (în medie 10 minute) permit rularea unui nod Bitcoin la un cost mai mic, favorizând descentralizarea. Pe de altă parte, producția de blocuri prin Proof-of-Work face frauda în cadrul protocolului extrem de costisitoare, facilitând în același timp verificarea de către nodurile rețelei, favorizând astfel securitatea. Cu toate acestea, aceste alegeri impun o limită asupra numărului mediu de tranzacții într-un bloc, corespunzând aproximativ la câteva tranzacții pe secundă. Acest număr este ridicol comparativ cu capacitatea de procesare a procesatorilor de plăți precum VISA, care este de 1700/s. Totuși, această limită este necesară pentru a tranzacționa cu Bitcoin într-un mod rezistent la cenzură și fără încredere. Cu toate acestea, cei care dezvoltă pe Bitcoin s-au gândit la această problemă încă de la început.

### Lightning ca un Strat Suplimentar

După ani de reflecție și multiple încercări, emerge protocolul Lightning. Folosind un anumit număr de specificații, acest protocol permite construirea unei rețele de plăți peer-to-peer prin valorificarea securității și programabilității protocolului de tranzacție Bitcoin. Lightning Network acționează ca o rețea de canale de plată, permițând tranzacții instantanee cu taxe reduse pentru expeditor. Această rețea de canale de plată face chiar posibilă tranzacționarea între indivizi care nu au o conexiune directă de canal.

![image](assets/en/chapter18/4.webp)

Serviciile tradiționale de transfer de bani, cum ar fi Western Union, băncile centrale, Visa și Mastercard, ar putea dispărea dacă nu adoptă tehnologia Lightning Network. Lightning Network este mai eficient și mai rentabil decât sistemele de plată actuale. Într-adevăr, Lightning Network permite tranzacții aproape nelimitate între doi colegi care împart un canal, fără cheltuieli energetice pe blockchain-ul de bază în afara tranzacției pentru anunțarea creării canalului.

![image](assets/en/chapter18/7.webp)

Tranzacțiile sunt securizate prin criptografie și indirect prin energia consumată de mineri pe Bitcoin. Tranzacțiile pot fi efectuate instantaneu, fără limitări geografice, iar taxele sunt extrem de scăzute, adesea mai puțin de 0,5%.

În rezumat, Lightning Network este o încercare promițătoare de a desfășura un sistem de plată eficient pentru tranzacționarea în Bitcoin. Există deja numeroase portofele Lightning disponibile, pe care le puteți descoperi în secțiunea noastră de tutoriale sau prin formarea noastră despre Lightning Network.

### Recapitulare rapidă într-un poster!

![Alt text](assets/posters/en/20._lightning_network.webp)
## Cazuri de Utilizare ale Rețelei Lightning<chapterId>684e31f9-ebd1-51b6-91c0-1e6a315f1141</chapterId>

Așa cum tocmai am văzut, protocolul Bitcoin, deși revoluționar, se confruntă cu provocări semnificative în ceea ce privește scalabilitatea pentru a gestiona toate tranzacțiile noastre zilnice. Pentru a rezolva aceste probleme, o soluție de al doilea strat cunoscută sub numele de Rețeaua Lightning a fost propusă în 2016 și acum are mai multe implementări diferite, toate interoperabile:

- Core-lightning de la Blockstream
- Eclair de la Acinq
- LND de la Lightning strike

Această rețea peer-to-peer își propune să faciliteze micro-tranzacțiile, care sunt tranzacții de valoare foarte scăzută care altfel ar fi impracticabile din cauza taxelor mari și a timpilor lungi de confirmare pe blockchain-ul Bitcoin.

### Care sunt cazurile de utilizare ale rețelei?

Această tehnologie deschide ușa către o gamă largă de aplicații potențiale pentru Bitcoin care anterior erau inaccesibile din cauza constrângerilor necesare pentru a asigura securitatea și descentralizarea Bitcoin. Printre aceste aplicații în viața de zi cu zi, putem menționa facturarea instantanee în comerț (atât fizic cât și online), streaming de bani pentru plăți în timp real și micro-donații pentru conținut. Prin desfășurarea unei rețele de tranzacții aproape instantanee, sigure și cu costuri scăzute (în medie mai puțin de 0,5%), multe modele de afaceri anterior de neimaginat pot fi implementate. Acest lucru este posibil deoarece Rețeaua Lightning utilizează sats (zecimala bitcoinului) pentru a funcționa.

![imagine](assets/en/chapter19/9.webp)

Industria jocurilor video oferă un exemplu deosebit de interesant despre cum Rețeaua Lightning poate fi utilizată pentru a transforma modelele de afaceri existente. Conceptul de "skin in the game" este o idee care a câștigat recent popularitate în acest context. În esență, implică având un pariu financiar în rezultatul unui joc.
Rețeaua Lightning permite jucătorilor să parieze sume foarte mici de bani când joacă jocuri, cum ar fi câțiva satoshi (aproximativ o fracțiune de cent euro). Acest lucru permite stabilirea unui pariu care stimulează competiția, crescând în același timp semnificativ costul desfășurării botilor.

![imagine](assets/en/chapter19/2.webp)

În rezumat, viitorul micro-tranzacțiilor cu Bitcoin arată promițător datorită inovațiilor precum Rețeaua Lightning. Pe măsură ce aceste tehnologii continuă să se dezvolte și să se maturizeze, ne putem aștepta să vedem apariția unor noi și interesante aplicații în viitorul apropiat. Luați, de exemplu, conceptul de "streaming de bani." Cu Rețeaua Lightning, putem face micro-tranzacții în fiecare minut (potențial fără o terță parte de încredere), ceea ce deschide ușa experimentării cu modele economice unde consumatorii plătesc pentru conținut bazat pe ceea ce consumă.

![imagine](assets/en/chapter19/8.webp)

Într-un astfel de sistem, banii sunt împărțiți automat, pe baza unui procentaj prestabilit, între diferiții contribuitori la un serviciu sau produs. Acest lucru ar putea revoluționa modul în care ne gândim la modelele de plată. De exemplu, în loc să plătești un abonament lunar pentru un serviciu, utilizatorii ar putea fi taxați pe minut, sau chiar pe secundă, pentru timpul petrecut folosind serviciul. Un astfel de model economic ar putea avea implicații profunde pentru creatorii de conținut, care ar fi motivați să producă conținut de calitate pentru a reține atenția utilizatorilor. Utilizatorii, la rândul lor, ar plăti doar pentru conținutul pe care îl consumă, eliminând astfel taxele de abonament plătite în avans. Este chiar concepabil să folosim acest sistem pentru închirierea bunurilor.

![imagine](assets/en/chapter19/3.webp)
În concluzie, Lightning Network deschide o multitudine de cazuri de utilizare interesante pentru utilizatorii Bitcoin. Modelele economice rezultate și oportunitățile de afaceri sunt numeroase și variate. Vă încurajăm să îl testați pe cont propriu încercând aplicația de podcasturi [Fountain](https://www.fountain.fm/), care vă permite să fiți recompensat cu câțiva sats pentru ascultarea podcasturilor preferate!
### Recapitulare rapidă într-un poster!
...
Așa cum Morpheus i-a spus lui Neo: "Iei pastila albastră, povestea se termină, te trezești în patul tău și crezi orice vrei să crezi. Iei pastila roșie, rămâi în Țara Minunilor și îți arăt cât de adâncă este gaura de iepure." Ești gata să explorezi gaura de iepure a Bitcoinului? Fii atent, deoarece s-ar putea să redescoperi libertatea ta financiară!

![pastila roșie](assets/posters/fr/2_pilluleorange.webp)

### Viitorul tehnologic și implicațiile sale

Tehnologia evoluează exponențial și nimeni nu poate prezice cu certitudine dezvoltările viitoare ale acesteia. Conectivitatea lumii și inteligența artificială continuă să avanseze. Cunoștințele pe care un individ le poate dobândi prin intermediul internetului devin din ce în ce mai imensurabile în timp.

Să luăm IA ca exemplu. Aceste tehnologii au depășit deja sau se apropie de performanța la nivel uman într-un număr tot mai mare de domenii, cum ar fi jocurile video, producția de imagini și texte și analiza datelor. O posibilă implicație este că peste 80% din locuri de muncă vor dispărea din cauza IA și a automatizării. Avem la dispoziție mai multe opțiuni, cum ar fi restrângerea progresului tehnologic sau valorificarea capitalului crescut din câștigurile de productivitate create de IA.

Întrebările esențiale de pus sunt:

- Cum gestionăm o societate în care 80% din locuri de muncă vor dispărea?
- Cum revitalizăm o populație?
- Este nevoie de atât de mulți profesori?
- Consecințele geopolitice, politice și umane ale automatizării nu sunt discutate suficient.
  Calculatoarele, internetul, streamingul și VR vor schimba educația. Am putea avea un curs universal pentru toți elevii francezi gestionat de guvern și profesori care nu mai țin prelegeri, ci însoțesc direct elevii. Copiii ar putea intra într-o lume virtuală și să fie însoțiți în învățarea istoriei.

- Unde este granița între un profesor și o IA?
- Cum putem garanta o societate care trăiește în prosperitate?

Aceste întrebări fundamentale pentru viitorul nostru trebuie dezbătute și decise colectiv. Dar care este legătura cu Bitcoin? La fel ca internetul pentru modurile de comunicare, Bitcoin este o revoluție tehnologică pentru noi moduri de organizare la scară largă, aducându-ne posibilitatea de a schimba valoare fără niciun terț de încredere. Vrem să împiedicăm evoluția tehnologică a sistemului monetar sau să recoltăm creșterea capitalului prin câștigul de productivitate de zece ori mai mare folosind protocoalele Bitcoin și Lightning?

### Care este viitorul finanțelor?

Aceste reflecții ridică de asemenea întrebări despre cine ar trebui să dețină, să autorizeze și să urmărească banii pe care îi folosim. Scopul este să decidem între un sistem închis cu lideri nealeși sau un sistem deschis fără părți de încredere, unde neutralitatea prevalează.

- Este moneda o formă de proprietate privată?
- Pot fi blocate conturile protestatarilor fără un ordin al Curții Supreme?
- Cine garantează sistemul financiar?
- Cum poate fi un individ suveran asupra banilor săi și să se bazeze pe o terță parte de încredere?
- Se pot trimite bani în cealaltă parte a lumii fără taxe sau intermediari?
Acceptarea acestor noi tehnologii ar putea genera economii de scară masive la nivel mondial. Ar trebui să permitem libera circulație a fluxurilor de capital? Blocadele internaționale au consecințe economice și politice. Este etic să folosim intermediari financiari precum Western Union, care uneori percep taxe de până la 25%? Credem că într-o lume din ce în ce mai digitalizată, banii ar trebui democratizați și considerați un bun comun aparținând oamenilor, mai degrabă decât statului sau instituțiilor financiare opace.
Întrebarea despre cine ar trebui să controleze sistemul bancar este crucială deoarece regulile jocului bancar nu sunt transparente și înțelese de toți, permițând unei caste de politicieni și reglementatori să își mențină controlul asupra sistemului. Este important să ne întrebăm dacă piața liberă sau un grup de intelectuali ar trebui să controleze sistemul bancar.

### Libertățile noastre sunt în joc.

Cenzura trebuie, de asemenea, pusă sub semnul întrebării deoarece cine are cunoștințele necesare pentru a decide ce ar trebui cenzurat sau nu? Media și-a schimbat poziția față de anumite informații și persoanele care au fost cenzurate înainte nu mai sunt cenzurate astăzi.

- Cine decide ce este cenzura sau propaganda?
- Cine are mâna divină asupra sistemului nostru?

Tolerarea cenzurii poate distruge libertatea de exprimare și dreptul la adunare. Implementarea cenzurii este tehnic dificilă fără a crea o distopie completă. Ce entitate ar trebui să aibă puterea de cenzură? Întrebarea cenzurii este complicată și este dificil de știut cine ar trebui cenzurat sau nu. Cenzura poate avea un impact negativ asupra inovației și libertății de a întreprinde.

Există 2,4 miliarde de persoane în lume fără un cont bancar, ceea ce creează în mod necesar inegalități geografice. Bitcoin permite egalitatea în tranzacții, indiferent de statutul social sau poziția politică. Protocolul Bitcoin este apolitic și nu oferă privilegii specifice președintelui sau altor actori. Liderii ar trebui să aibă aceleași privilegii ca oamenii obișnuiți pentru a împinge dezvoltarea în sus, în loc să lase pe unii în vârf și pe alții la bază. Ar trebui ca toată lumea să aibă aceeași monedă, indiferent de statutul social? Este important să ne gândim la lumea pe care dorim să o lăsăm copiilor noștri. Dorim să lăsăm o lume deschisă unde ei sunt liberi să facă ce vor cu banii lor.

Bitcoin este important și nu ar trebui considerat doar un joc de noroc. Este crucial să continuăm să punem întrebări despre Bitcoin.

### Bitcoin: un protocol revoluționar

Așa cum am văzut în capitolul anterior, protocolul Bitcoin este neutru față de toți utilizatorii săi. Mulțumită regulilor de consens și criptografiei, putem înregistra tranzacții imutabil într-un registru public global, garantând transferuri de valoare monetară fără nicio parte terță de încredere. Infrastructura de al doilea strat (și în curând al treilea strat, cu RGB) permite scalabilitatea rețelei și dezvoltarea de noi funcționalități, în special pentru a aborda problemele de scalare.

Bitcoin are toate caracteristicile necesare pentru a fi o monedă eficientă și sănătoasă: divizibilă, instantaneu transportabilă, necenzurabilă, cost neglijabil pentru verificare și cu o politică monetară deja stabilită pentru secolele următoare cu aceste 21 de milioane de unități. Bitcoin este pseudonim și poate fi schimbat oriunde în lume fără nicio autorizație din partea vreunei entități, trebuie doar să deții propriile chei private - după cum spune zicala "Nu sunt cheile tale, nu sunt bitcoinii tăi".

Bitcoin este adoptat de grupuri diverse de oameni, de la criptografi la libertarieni până la afaceri tradiționale și chiar o țară. Cu toate acestea, Bitcoin este pentru toată lumea, iar numărul utilizatorilor săi crește, la fel și numărul nodurilor Bitcoin care servesc ca gardieni ai istoriei tranzacțiilor, asigurând descentralizarea sa.
Bitcoin nu mai poate fi oprit și nu mai poate fi cenzurat. Este o revoluție pașnică pentru a schimba sistemul monetar și pentru a permite incluziunea financiară. Utilizatorii pot obține bitcoin acceptându-i pentru comerțul lor sau cumpărându-i prin platforme reglementate sau nereglementate. Bitcoinii pot fi stocați în portofele, aplicații mobile sau dispozitive fizice. În Bitcoin, nu există intermediar de încredere, susținătorii Bitcoin promovează transparența, libertatea și responsabilitatea individuală - după cum spune zicala "Nu avea încredere, verifică".

Schimbarea sistemului financiar necesită schimbarea monedei. Satoshi a creat Bitcoin în 2008 pentru a propune o încercare în acest sens. Accesul la bani ușori și "magici" corupe. Prin urmare, Bitcoin este o alternativă pentru a construi un nou sistem monetar neutru. Bitcoin permite emanciparea din sistemul bancar. Este un fenomen social care ne conduce să participăm la o revoluție pașnică. Ești gata să te alături?

## Recunoștințe și continuă să sapi mai adânc în gaura iepurelui
<chapterId>c153facd-fe77-5954-b18b-d0e2243e787a</chapterId>

### Mergi mai departe

Felicitări pentru finalizarea acestui curs BTC 101! Sper sincer că ți-a plăcut și că ți-a deschis uși. Descoperirea bitcoinului este doar la început, și te invit să explorezi toate celelalte cursuri disponibile la universitate.

- [BTC 102](https://planb.network/courses/btc101) te va ajuta să îți stabilești planul bitcoin
- [LNP 201](https://planb.network/courses/lnp201) îți va permite să descoperi Lightning Network, o rețea de plăți de nivel secundar
- [ECO 201](https://planb.network/courses/eco201) va acoperi economia austriacă
- [SCU 101](https://planb.network/courses/scu101) îți va permite să îți actualizezi securitatea digitală
- [MIN 201](https://planb.network/courses/min201) pentru a afla mai multe despre minerit
- și multe altele...

## Susține-ne
<chapterId>3e6e756b-b6c4-5d41-bece-767922348067</chapterId>

Acest curs, precum și tot conținutul acestei universități, ți-au fost oferite gratuit de comunitatea noastră. Pentru a ne susține, poți împărtăși cursul cu alții, poți deveni membru al universității și chiar poți contribui la dezvoltarea sa prin intermediul [GitHub-ului nostru](https://github.com/PlanB-Network/bitcoin-educational-content). În numele întregii echipe, îți mulțumim!

## Notează formarea
<chapterId>44d01865-5c89-55a5-a397-a014960eec0f</chapterId>

Un sistem de notare pentru formare va fi în curând integrat în această nouă platformă de E-learning! Între timp, îți mulțumim foarte mult pentru participarea la curs și, dacă ți-a plăcut, te rugăm să iei în considerare să-l împărtășești cu alții.

Un mare mulțumesc susținătorilor noștri de pe Patreon, membrilor și donatorilor pentru sprijinul financiar, mulțumesc persoanelor care împărtășesc și mulțumesc celor care au făcut posibilă această formare: Rachel, Muriel, echipa StackinSat, JohnOnChain, Fanis, Guillaume, Lounes, corectorii și recenzenții.
