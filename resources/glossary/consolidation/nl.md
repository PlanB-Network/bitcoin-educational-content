...
Transacties met veel inputs zijn immers zwaarder en dus duurder. Naast de besparingen op transactiekosten, is consolidatie ook een vorm van langetermijnplanning. Als je Wallet erg kleine UTXO's bevat, kunnen deze onbruikbaar worden als het Bitcoin netwerk een langdurige periode van hoge kosten ingaat. Als je bijvoorbeeld een UTXO van 10.000 Sats moet uitgeven, maar de minimum Mining vergoedingen bedragen 15.000 Sats, dan zouden de kosten hoger zijn dan de waarde van de UTXO zelf. Deze kleine UTXO's worden dan economisch irrationeel om te gebruiken en blijven onbruikbaar zolang de vergoedingen niet dalen. Deze UTXO's worden gewoonlijk "Dust" genoemd Door je kleine UTXO's regelmatig te consolideren, verminder je dit risico dat gepaard gaat met tariefstijgingen.
