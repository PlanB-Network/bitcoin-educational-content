...
本視訊教學將引導您設定並使用 Bitcoin Keeper Wallet 與 Tapsigners 來建立繼承計劃。我們將介紹傳送/接收交易、金鑰管理、備份等功能。


![video](https://youtu.be/tCld_-n2d30)


若要查看 Bitcoin Keeper Wallet 的完整教學，請參閱此處的教學：
...
- Bitcoin Keeper App 下載 [這裡](bitcoinkeeper.app)
