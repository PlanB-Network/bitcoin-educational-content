...
definition: Encoding formats for SegWit addresses (starting with bc1), offering better error detection and improved readability compared to Legacy addresses.
---
