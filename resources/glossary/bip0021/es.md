...
definition: Estándar que define el formato de las URI de Bitcoin (enlaces que comienzan con bitcoin) para facilitar los pagos mediante enlaces o códigos QR.
---
