...
Antes do surgimento do Bitcoin, várias tentativas foram feitas para criar uma moeda digital. David Chaum, por exemplo, introduziu o conceito de "moeda eletrônica anónima" com o seu projeto "DigiCash" na década de 1980. Infelizmente, devido a várias restrições, o DigiCash nunca se concretizou.
...
A segurança dos teus Bitcoins é de extrema importância e um simples erro pode ter consequências caras. É por isso que agora vamos ver as melhores práticas ao criar uma nova carteira Bitcoin.
...
- Criar um plano de herança: para garantir que os teus entes queridos possam acessar o dinheiro em caso de problemas.
...
> Segue um dos lemas do Bitcoin: Não confiex, verifica por ti mesmo!
...
### Por quê aceitar Bitcoin em vez de comprá-lo?
...
Se o assunto ainda não estiver claro, o curso BTC102 acompanhar-te-á na segurança e aquisição dos teus primeiros bitcoins. Aqui, vamos apenas dar-te uma visão geral do assunto.
...
Num sistema como esse, o dinheiro é automaticamente dividido, com base enuma porcentagem pré-definida, entre os diferentes contribuidores de um serviço ou produto. Isso poderia revolucionar a forma como pensamos nos modelos de pagamento. Por exemplo, em vez de pagar uma assinatura mensal por um serviço, os usuários poderiam ser cobrados por minuto, ou até mesmo por segundo, pelo tempo que passam usando o serviço. Esse modelo económico poderia ter implicações profundas para os criadores de conteúdo, que seriam incentivados a produzir conteúdo de qualidade para reter a atenção dos usuários. Os usuários, por sua vez, pagariam apenas pelo conteúdo que consomem, eliminando assim as taxas de assinatura antecipadas. É até mesmo possível usar esse sistema para aluguer de bens.

![image](assets/Concept/chapitre18/3.png)

Em conclusão, a Lightning Network abre uma infinidade de casos de uso empolgantes para os usuários de Bitcoin. Os modelos económicos e as oportunidades comerciais resultantes são numerosos e variados. Encorajamos-te a testar por ti mesmo(a) usando o aplicativo de podcast [Fountain](https://www.fountain.fm/), que permite-te seres remunerado(a) com alguns sats para ouvires os teus podcasts favoritos!

## Pílula azul ou pílula vermelha?

![pílula vermelha](https://youtu.be/nCRVIoyyyck)

Como Morpheus disse a Neo: "Se tomares a pílula azul, a história acaba, acordas na tua cama e acreditas no que quiseres. Se tomares a pílula vermelha, ficas no País das Maravilhas e eu mostro-te até onde vai a toca do coelho." Estás pronto para explorar a toca do coelho do Bitcoin? Tem cuidado, pois podes encontrar a tua liberdade financeira!

![pílula vermelha](assets/posters/fr/2_pilluleorange.png)

### O futuro tecnológico e as suas implicações

A tecnologia está a evoluir de forma exponencial e ninguém pode prever com certeza as suas evoluções. A conectividade do mundo e a inteligência artificial continuam a desenvolver-se. O conhecimento que um indivíduo pode adquirir através da internet está a tornar-se cada vez mais incontável.

Vamos tomar a IA como exemplo, essas tecnologias já ultrapassaram ou estão a aproximar-se do nível humano num número crescente de áreas, como jogos de vídeo, produção de imagens e textos, análise de dados. Uma das implicações potenciais é que mais de 80% dos empregos desaparecerão devido à IA e automação. Temos várias opções, como restringir o avanço tecnológico ou colher o aumento de capital gerado pela produtividade das IAs.
...
- As consequências geopolíticas, políticas e humanas da automação não são discutidas o suficiente.
  A computação, a internet, o streaming, a realidade virtual vão mudar a educação. Poderíamos ter um curso universal para todos os estudantes portugueses gerenciado pelo governo e professores(as) que não dão mais a aula, mas que acompanham diretamente os alunos. As crianças poderiam entrar num mundo virtual e serem acompanhadas para aprender história.

- Onde está a linha entre um(a) professor(a) e uma IA?
- Como garantir uma sociedade próspera?

Essas questões fundamentais para o nosso futuro devem ser debatidas e decididas coletivamente. Mas qual é a relação com o Bitcoin? Assim como a internet para os meios de comunicação, o Bitcoin é uma revolução tecnológica para novos modos de organização de grande escala, proporcionando-nos a possibilidade de trocar valor sem qualquer intermediário de confiança. Desejamos restringir a evolução tecnológica do sistema monetário ou colher o aumento de capital através do ganho de produtividade multiplicado pelo uso dos protocolos Bitcoin e Lightning?

### Qual é o futuro da finança?
...
- Como um indivíduo pode ser soberano sobre o seu dinheiro e depender de um intermediário de confiança?
- É possível enviar dinheiro para o outro lado do mundo sem taxas ou intermediários?

Aceitar estas novas tecnologias poderia gerar economias de escala massivas por todo o planeta. Devemos permitir a livre circulação de fluxos de capital? Os bloqueios internacionais têm consequências económicas e políticas. É ético usar intermediários financeiros como a Western Union, que às vezes cobra até 25% de taxas? Acreditamos que num mundo cada vez mais digital, o dinheiro deve ser democratizado e considerado um bem comum pertencente às pessoas, em vez de pertencer ao Estado ou a instituições financeiras opacas.

A questão de quem deve controlar o sistema bancário é crucial, pois as regras do jogo bancário não são transparentes e compreensíveis para todos e todas, o que permite que uma casta de políticos e reguladores mantenha o seu domínio sobre o sistema. É importante questionar se o mercado livre ou um grupo de intelectuais deve controlar o sistema bancário.

### As nossas liberdades estão em jogo.

A censura também deve ser questionada, pois quem possui o conhecimento para decidir o que deve ser censurado ou não? Os meios de comunicação mudaram a sua posição sobre algumas informações e as pessoas que foram censuradas antes não o são mais hoje.

- Quem decide o que é censura ou propaganda?
- Quem tem o controlo divino sobre o nosso sistema?

Tolerar a censura pode destruir a liberdade de expressão e o direito de reunião. A implementação da censura é tecnicamente difícil sem se criar uma distopia completa. Qual é a instância que deve ter o poder de censura? A questão da censura é complicada e é difícil saber quem deve ser censurado ou não. A censura pode ter um impacto negativo na inovação e na liberdade de empreender.

Existem 2,4 biliões de pessoas no mundo sem conta bancária, o que inevitavelmente cria desigualdades geográficas. O Bitcoin permite igualdade em transações, independentemente do seu status social ou posição política. O protocolo Bitcoin é apolítico e não concede privilégios específicos ao presidente ou a outros atores. Os líderes devem ter os mesmos privilégios que as pessoas comuns para impulsionar o desenvolvimento para cima, em vez de deixar alguns no topo e outros na base. Todos e todas devem ter a mesma moeda, independentemente do seu status social? É importante pensar no mundo que queremos deixar para os nossos(as) filhos(as). Desejamos deixar um mundo aberto onde eles e elas sejam livres para fazer o que quiserem com o seu dinheiro.

O Bitcoin é importante e não deve ser considerado apenas um jogo de sorte ou azar. É crucial continuar a fazer perguntas sobre o Bitcoin.

### Bitcoin: um protocolo revolucionário

![Conclusão](https://youtu.be/BoZL_D7uLAg)

Como vimos no capítulo anterior, o protocolo Bitcoin é neutro em relação a todos os seus utilizadores. Através das regras de consenso e criptografia, podemos registar transações de forma imutável num registo público global, garantindo transferências de valor monetário sem a necessidade de terceiros confiáveis. As camadas de infraestrutura de nível 2 (e em breve nível 3, com RGB) permitem que a rede evolua e desenvolva novas funcionalidades, especialmente para resolver problemas de escalabilidade.
O Bitcoin tem todas as características necessárias para ser uma moeda eficiente e saudável: divisível, transportável instantaneamente, não censurável, com verificação de custo negligenciável e com uma política monetária já estabelecida para os séculos futuros com essas 21 milhões de unidades. O Bitcoin é pseudo-anónimo e pode ser negociado em qualquer lugar do mundo sem a necessidade de autorização de qualquer entidade, apenas é necessário possuir as suas próprias chaves privadas - como diz o ditado "Not your keys, not your bitcoins" ("não são as suas chaves, não são os seus bitcoins").
Bitcoin é adotado por diversos grupos de pessoas, desde criptógrafos, libertários até empresas tradicionais e até mesmo um país. No entanto, o Bitcoin é para todos e todas e o número de usuários está crescendo, assim como o número de nós Bitcoin que atuam como guardiões do histórico de transações, garantindo assim a sua descentralização.

O Bitcoin não pode mais ser interrompido e não pode mais ser censurado. É uma revolução pacífica para mudar o sistema monetário e permitir a inclusão financeira. Os usuários podem obter Bitcoins aceitando-os nas suas transações comerciais ou comprando-os por meio de plataformas regulamentadas ou não. Os Bitcoins podem ser armazenados em carteiras, aplicativos móveis ou dispositivos físicos. Não há intermediário de confiança no Bitcoin, o Bitcoin defende a transparência, a liberdade e a responsabilidade individual - como diz o ditado "Don't Trust, Verify" ("Não confies, verifica por ti mesmo/a").

Mudar o sistema financeiro requer mudar a moeda. Satoshi criou o Bitcoin em 2008 como uma tentativa de efetuar essa mudança. Ter acesso a dinheiro fácil e "mágico" corrompe. Portanto, o Bitcoin é uma alternativa para construir um novo sistema monetário neutro. O Bitcoin permite a emancipação do sistema bancário. É um fenómeno social que nos leva a participar de uma revolução pacífica. Estás pronto(a) para te juntares a ela?
...
Parabéns por concluires este curso BTC 101! Espero sinceramente que tenhas gostado e que o curso tenha aberto portas para ti. A tua descoberta do bitcoin está apenas a começar e convidamos-te a explorar todos os outros cursos disponíveis na universidade.

- [BTC 102](https://sovereignuniversity.org/course/btc102/fr) irá ajudar-te a criar o teu plano bitcoin
- [LN 201](https://sovereignuniversity.org/course/ln201/fr) e [LN 202](https://sovereignuniversity.org/course/ln202/fr) permitirão que descubras a Lightning Network, uma rede de pagamento de segunda camada
- [ECON 201](https://sovereignuniversity.org/course/econ201/fr) abordará a economia austríaca
- [SECU 101](https://sovereignuniversity.org/course/secu101/fr) permitirá que atualizes a tua segurança digital
- [MINAGE 201](https://sovereignuniversity.org/course/min201/fr) para saber mais sobre mineração
- e muitos outros...

## Apoia-nos

Este curso, assim como todo o conteúdo presente nesta universidade, foi oferecido gratuitamente pela nossa comunidade. Para nos apoiar, podes compartilhá-lo com outras pessoas, tornar-te membro da universidade e até mesmo contribuir para o seu desenvolvimento através do [nosso GitHub](https://github.com/DecouvreBitcoin/sovereign-university-data). Em nome de toda a equipa, muito obrigado(a)!

## Avalia o curso

Um sistema de avaliação para o curso será em breve integrado a esta nova plataforma de E-learning! Enquanto isso, muito obrigado(a) por teres acompanhado o curso e se gostaste, pensa em compartilhá-lo com outras pessoas.

Um enorme agradecimento aos nossos Patreon, membros e doadores pelo seu apoio financeiro, gratidão às pessoas que compartilham e àqueles e àquelas que tornaram este curso possível: Rachel, Muriel, a equipa do StackinSat, JohnOnChain, Fanis, Guillaume, Lounes, aos corretores e revisores.
