...
Bu eğitim videosu, bir miras planı oluşturmak için Tapsigners ile Bitcoin Keeper Wallet'ü kurma ve kullanma konusunda size yol gösterir. Gönderme/alma işlemleri, anahtar yönetimi, yedeklemeler ve daha fazlasını ele alıyoruz.


![video](https://youtu.be/tCld_-n2d30)


Bitcoin Keeper Wallet eğitiminin tamamını görmek için buradaki eğitime bakın:

https://planb.network/tutorials/wallet/mobile/bitcoin-keeper-7f2a160b-10b6-4cc5-8820-514ee2eb1599

İlgili diğer bağlantılara buradan göz atın:


- Bitcoin Keeper Uygulamasını indirin [buradan](bitcoinkeeper.app)
