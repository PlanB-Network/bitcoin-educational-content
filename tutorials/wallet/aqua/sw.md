...
## Sakinisha programu ya Aqua


Hatua ya kwanza ni, bila shaka, kupakua programu ya Aqua. Nenda kwenye duka lako la maombi:



- [Kwa Android](https://play.google.com/store/apps/details?id=io.aquawallet.android);
- [Kwa Apple](https://apps.apple.com/us/app/Aqua-Wallet/id6468594241).

![AQUA](assets/fr/04.webp)


Kwa watumiaji wa Android, pia una chaguo la kusakinisha programu kupitia faili ya `.apk` [inapatikana kwenye GitHub](https://github.com/AquaWallet/Aqua-Wallet/releases).


![AQUA](assets/fr/05.webp)


Fungua programu, kisha uteue kisanduku cha "*Nimesoma na kukubaliana na Sheria na Masharti na Sera ya Faragha*".


![AQUA](assets/fr/06.webp)


## Unda Wallet yako kwenye Aqua


Bonyeza kitufe cha "* Unda Wallet *".


![AQUA](assets/fr/07.webp)


Na voilà, Wallet yako tayari imeundwa!


![AQUA](assets/fr/08.webp)


Lakini kwanza kabisa, kwa kuwa hii ni Wallet ya kujilinda, ni muhimu kufanya nakala rudufu ya Mnemonic yako. **Mnemonic hii inakupa ufikiaji kamili, usio na kikomo kwa bitcoins zako zote**. Mtu yeyote aliye na Mnemonic hii anaweza kuiba pesa zako, hata bila idhini ya kufikia simu yako.


Inakuruhusu kurejesha ufikiaji wa bitcoins zako katika tukio la upotezaji, wizi au kuvunjika kwa simu yako. Kwa hivyo ni muhimu sana kuihifadhi kwa uangalifu kwenye hali ya kawaida (sio ya dijiti) na kuihifadhi mahali salama. Unaweza kuiandika kwenye kipande cha karatasi, au kwa usalama ulioongezwa, ikiwa hii ni Wallet kubwa, ningependekeza kuichora kwenye usaidizi wa chuma cha pua ili kuilinda kutokana na hatari ya moto, mafuriko au kuanguka (kwa Hot Wallet iliyopangwa ili kupata kiasi kidogo cha bitcoins, nakala rahisi ya karatasi ni pengine ya kutosha).


Ili kufanya hivyo, bofya kwenye menyu ya Mipangilio.


![AQUA](assets/fr/09.webp)


Kisha bofya kwenye "*Tazama Neno la seed*". Tengeneza nakala halisi ya kifungu hiki cha maneno 12.


![AQUA](assets/fr/10.webp)


Katika menyu ya mipangilio sawa, unaweza pia kubadilisha lugha ya programu na sarafu ya fiat inayotumiwa.
...
## Pokea bitcoins kwenye Aqua


Sasa kwa kuwa Wallet yako imesanidiwa, uko tayari kupokea Sats yako ya kwanza! Bofya tu kitufe cha "*Pokea*" kwenye menyu ya "*Wallet*".
...
Kwa miamala ya onchain, Aqua itakuwa generate mahususi kupokea Address ambapo unaweza kupokea Sats yako.


![AQUA](assets/fr/14.webp)


Vile vile, kwa kuchagua Liquid, Aqua itakupa Liquid Address.


![AQUA](assets/fr/15.webp)


Ikiwa ungependa kupokea pesa kupitia Umeme, utahitaji kwanza kutaja kiasi unachotaka.


![AQUA](assets/fr/16.webp)


Kisha bonyeza "*generate Invoice*".
...
Hapa unaweza kuona muamala wako na salio lako la L-BTC.
...
Katika kisanduku cha "*Hamisha kutoka*", chagua kipengee unachotaka kuuza. Hivi sasa, ninamiliki L-BTC pekee, kwa hivyo ndivyo ninachagua.


![AQUA](assets/fr/24.webp)


Katika kisanduku cha "*Hamisha hadi*", chagua kipengee lengwa cha kubadilisha kwako. Kwa upande wangu, nilichagua USDT kwenye Liquid Network.


![AQUA](assets/fr/25.webp)


Weka kiasi unachotaka kubadilisha.
...
Hakikisha kuwa umefurahishwa na mipangilio ya kubadilishana, kisha uthibitishe kwa kuburuta kitufe cha "*Swap*" chini ya skrini.
...
Tukiangalia nyuma kwenye Wallet yetu, tunaweza kuona kwamba sasa tuna USDT kwenye Liquid.


![AQUA](assets/fr/30.webp)


## Tuma bitcoins na Aqua


Sasa kwa kuwa una bitcoins kwenye Aqua Wallet yako, unaweza kuzituma. Bonyeza kitufe cha "* Tuma *".


![AQUA](assets/fr/31.webp)


Chagua kipengee unachotaka kutuma au chagua mtandao ili kutekeleza muamala. Kwa upande wangu, nitatuma bitcoins kupitia Umeme.
...
Bofya "*Endelea*" tena ikiwa maelezo yote yanaonekana kuwa sawa.


![AQUA](assets/fr/34.webp)


Aqua kisha inakuletea muhtasari wa muamala. Hakikisha kuwa maelezo yote ni sahihi, ikijumuisha unakoenda Address, gharama na kiasi. Ili kuthibitisha muamala, telezesha kitufe cha "*Slaidi ili kutuma*" kilicho chini ya skrini.


![AQUA](assets/fr/35.webp)


Kisha utapokea uthibitisho wa usafirishaji.


![AQUA](assets/fr/36.webp)


Kwa hivyo sasa unajua jinsi ya kutumia programu ya Aqua kupokea na kutumia pesa kwenye Bitcoin, Lightning na Liquid, zote kutoka kwa Interface moja.
