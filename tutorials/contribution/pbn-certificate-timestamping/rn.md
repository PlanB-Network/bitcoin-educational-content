...
2. Gushirako ikidodo c’igihe c’iyo dosiye nyene yashizweko umukono biciye ku [ibimenyetso vy’igihe co gufungura](https://ibimenyetso vy’igihe co gufungura.org/).


Igikorwa ya mbere kigufasha kwemeza uwaguhaye icemeza (canke icemeza), mu gihe igikorwa ca kabiri kigufasha kugenzura itariki catanzweko.

Twemera ko ubwo buryo bworoshe bwo gutanga ibimenyamenya buduha ubushobozi bwo gutanga ivyemezo n’amadiplome bifise ibimenyamenya bidashobora guhakanwa umuntu wese ashobora kuvyisuzuma yigenga.
...
OpenTimestamps itanga iyi serivisi ku buntu ikoresheje uburyo bwiza cane bwo kubika ibimenyamenya muri Bitcoin Blockchain. Ikoresha ubuhinga bwa SHA-256 Hash kugira ngo ikore ikimenyetso kidasanzwe ca dosiye yawe, kandi yubake Merkle Tree ikoresheje ama hashes y’amadosiye yashikirijwe n’abandi bakoresha. Hash yonyene y’imiterere ya Merkle Tree ni yo ishizwe mu bikorwa vya OP_RETURN, bikaba bituma haba uburyo butekanye kandi bukomeye bwo kugenzura ko dosiye iriho.
...
Genda kuri "Credentials" ukanda ku ruhande rw'ibubamfu, uhitemwo igihe c'ikibazo cawe canke Diplome yawe.


![image](./assets/credential.webp)


Gukuraho dosiye ya zip.


![image](./assets/download.webp)


Kura ibirimwo ukanda iburyo kuri dosiye `.zip` ugahitamwo "Kura". Uzosanga amadosiye atatu atandukanye:



- Dosiye y'inyandiko yashizweko umukono (nk'icete.txt)
- Gufungura Timestamp (OTS) dosiye (nk'icete.txt.ots)
...
Ushobora kubona ubutumwa nk'ubu bukurikira nimba warashoboye kwinjiza urufunguzo rwa PGP
...
ICIBUKIRO: iyo ubonye ko urufunguzo 1 rwatunganijwe kandi urufunguzo 0 rwazanywe, birashoboka ko bisigura ko waramaze kwinjiza urufunguzo rumwe mbere, ivyo bikaba ari vyiza cane.


2. Suzuma umukono w’icete canke w’impapuro z’umutsindo ukoresheje itegeko rikurikira:
...
Iri tegeko rikwiye kukwereka ido n'ido ry'umukono, harimwo:
...
Aka ni akarorero k'ivyavuyemwo:
...
2. Fyonda ku rubuga rwa "Stamp & Verify".

3. Kurura dosiye ya OTS (nk'akarorero `icete.txt.ots`) mu kibanza categekanijwe.

4. Kurura dosiye ifise ikidodo c'igihe (nk'akarorero `certificate.txt`) mu kibanza cagenewe.

5. Urubuga ruzoca rugenzura ubwarwo Timestamp yuguruye maze rugaragaze igisubizo.


Niwabona ubutumwa nk'ubu bukurikira, Timestamp irafise akamaro:
...
1. Shiraho umukiriya wa OpenTimestamps avuye mu [bubiko] buzwi (https://github.com/ibimenyetso vy'igihe/umukiriya w'igihe-gufungura) ukoresheje itegeko rikurikira:
...
2. Ja ku bubiko burimwo amadosiye y’icete yakuwemwo.


3. Gukoresha itegeko rikurikira kugira ngo ugenzure Timestamp yuguruye:
...
- Suzuma Timestamp n'iya Bitcoin Blockchain
- Erekane neza igihe dosiye yashizweko ikidodo c'igihe
