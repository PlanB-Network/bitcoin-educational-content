...
Blockstream Explorer adalah proyek yang memudahkan eksplorasi transaksi dan status global protokol Bitcoin, serta [*sidechain*] (https://planb.academy/en/resources/glossary/sidechain) Liquid yang dikembangkan oleh perusahaan Blockstream.
...
Transaksi pertama dalam blok disebut **transaction coinbase**. Transaksi ini digunakan untuk mengalokasikan upah mining penambang, yaitu semua biaya dari transaksi yang masuk ke dalam blok serta hadiah blok. Bitcoin yang dihasilkan dari transaksi ini hanya bisa digunakan setelah 100 blok berturut-turut ditambang. Dengan kata lain, untuk dapat menggunakannya, penambang harus menunggu produksi blok **919430**. Hal ini dikenal sebagai [*"periode jatuh tempo"] (https://planb.academy/fr/resources/glossary/maturity-period).
