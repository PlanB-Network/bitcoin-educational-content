...
class LanguageConfig:
    ...
    def get_translator_info(self, lang_code: str) -> Dict:
        lang = next((l for l in self.config['languages'] if l['code'] == lang_code), None)
        if not lang:
...
def translate_content(input_path: Union[str, Path], 
    ...
    output_path = input_path.parent / f"{target_lang}.md"
