...
| Aplicación | E2EE 1:1 | E2EE grupos | Registro anónimo | Licencia de cliente open-source | Licencia de servidor open-source | Servidor descentralizado | Año de creación |
| -------------------- | -------------- | -------------- | ------------------- | -------------------------- | --------------------------- | -------------------- | ----------------- |
| WhatsApp | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | 2009 |
| WeChat | ❌ | ❌ | ❌ | ❌ | ❌ | 2011 |
