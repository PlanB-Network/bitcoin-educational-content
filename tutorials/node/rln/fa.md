...
اکنون می‌توانیم یک دارایی RGB ایجاد کنیم. فرمان بستگی به نوع دارایی که می‌خواهید ایجاد کنید و پارامترهای آن دارد. در اینجا من یک NIA (*دارایی غیرقابل تورم*) token به نام "Plan ₿ Academy" با یک Supply به مقدار 1000 واحد ایجاد می‌کنم. `precision` به شما اجازه می‌دهد تا قابلیت تقسیم‌پذیری واحدها را تعریف کنید.
...
سپس، کانال را با مشخص کردن دارایی مربوطه (`Plan ₿ Academy`) باز خواهیم کرد. فرمان `/openchannel` به شما اجازه می‌دهد اندازه کانال را به ساتوشی تعریف کنید و انتخاب کنید که دارایی RGB را شامل شود. این بستگی به آنچه که می‌خواهید ایجاد کنید دارد، اما در مورد من، فرمان این است:
...
کانال Lightning اکنون باز است و همچنین حاوی 500 توکن `Plan ₿ Academy` در سمت نود شماره 1 است. اگر نود شماره 2 بخواهد توکن‌های `Plan ₿ Academy` دریافت کند، باید generate و Invoice را انجام دهد. در اینجا نحوه انجام آن آمده است:
...
ما اکنون این Invoice را از اولین نود پرداخت خواهیم کرد، که پول لازم را با `Plan ₿ Academy` token نگه می‌دارد:
