...
È interessante dare subito un'occhiata anche al menu _/advanced_
...
Anche se il wallet è stato appena creato, scegliere ad esempio _/transactions_
...
Pagando l'invoice il wallet mostra il saldo. Se per qualche motivo il totale non è aggiornato, scrivere _/balance_ + invio.
...
Cliccando su _Pay_ l'invoice viene pagata.
...
Si sa che la funzione più comoda per pagare con il mobile è inquadrare un QR code, ma questo wallet ne è sprovvisto per design, visto che non è un'app a sé stante ma è contenuto in un social.
...
Cliccando su _/OK_ compare l'invoice che si può mostrare al cliente sottoforma di QR code, oppure inviare con la messaggeria istantanea, per essere pagata
