---
name: BTC Map
description: Find places to spend your Sats
---
...
Go to [btcmap.org](https://btcmap.org/):
...
- [F-Droid](https://f-droid.org/en/packages/org.btcmap/) the android open-source app catalog
- by downloading the [apk android](https://github.com/teambtcmap/btcmap-android/releases/latest) directly from the project's github
...
BTC Map allows you to [add your own community](https://btcmap.org/communities/add/), let's take a look at it step by step:
...
[This page](https://btcmap.org/add-location/) shows you how to add a Bitcoin-compliant property listing yourself, using Open Street Map. If you're having trouble, there's a form for you to fill in, so that someone else can create the listing for you (this can take several weeks). Let's have a look:
