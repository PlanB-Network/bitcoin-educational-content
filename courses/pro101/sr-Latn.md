...
Kurs ima za cilj da opremi učesnike dubokim razumevanjem osnovnih principa Bitcoin, praktičnim razvojnim veštinama i sposobnošću da efikasno navigiraju i doprinesu ekosistemu Bitcoin. Kroz kombinaciju teorijskog znanja i praktičnih vežbi, studenti će savladati osnove bezbednosti Bitcoin, složenosti njegovog softverskog steka i mehanizme njegovog upravljanja.


### Preduslov


Od učesnika se očekuje da donesu snažan osećaj radoznalosti, želju za učenjem na profesionalnom nivou i osnovno znanje iz razvoja. Iako detaljno poznavanje Bitcoin nije potrebno, osnovno razumevanje principa kodiranja i otvorenost za angažovanje sa složenim tehničkim konceptima su ključni za maksimalno iskorišćavanje akceleratora.
...
Ukratko, Bitcoin ima ogroman potencijal za finansijsko osnaživanje i inkluziju, ali značajni izazovi su pred nama. Održavanje angažmana sa zajednicom Bitcoin, učenje i postavljanje pitanja biće ključni za ostvarenje decentralizovane finansijske budućnosti. Kroz saradnju i zagovaranje, vizija pravednijeg finansijskog sistema za sve može postati stvarnost.


### Pokret Cypherpunk i austrijska ekonomija
...
- Oškudica:** Fiksirani Bitcoin od strane Supply osigurava njegovu vrednost tokom vremena.
- Vremenska preferencija:** Podstiče štednju za budućnost umesto trenutne potrošnje.
...
- Konfiskacija**: Otpornost Bitcoin na konfiskaciju pruža Salvadorcima kontrolu nad njihovom imovinom, štiteći njihovo bogatstvo od spoljašnjeg oduzimanja i unapređujući finansijski suverenitet.


Prihvatanje Bitcoin u El Salvadoru promoviše inkluzivniji, konkurentniji i sigurniji finansijski sistem, izazivajući ograničenja tradicionalnih finansija.
...
Struktura i stalna evolucija Bitcoin prikazuju inovaciju i prilagodljivost njegove tehnologije. Od **Hashcash** do decentralizovanog Blockchain, i od **SegWit** do **Taproot**, Bitcoin nastavlja da Address izazove vezane za skalabilnost, privatnost i sigurnost. Kontinuirani napori zajednice osiguravaju da Bitcoin ostane otporan i decentralizovan dok se razvija kako bi zadovoljio zahteve budućnosti.
...
- Potvrdite sopstvene transakcije i blokove**: Osiguravanje da se pravila Bitcoin mreže poštuju bez oslanjanja na treće strane.
...
- Obreži Blockchain da uštediš prostor na disku tako što ćeš zadržati samo najnovije blokove:**:
...
- Proverite stanje vašeg Bitcoin Wallet:**:
...
**Kreiraj datoteku usluge za systemd:**
...
Hajde da pređemo na instalaciju C-Lightning.


**Koristi najnovije stabilno izdanje**

Za ovo predavanje koristićemo najnovije stabilno izdanje, npr., 22.11.1.
...
**Instaliraj zavisnosti i kompajliraj iz izvornog koda**

Instalirajte potrebne zavisnosti i kompajlirajte C-Lightning iz izvornog koda.
...
**Osigurajte kompatibilnost i sinhronizaciju**

Pokrenite usluge i osigurajte da su kompatibilne i sinhronizovane.
...
Dodajte sledeće za integraciju sa Tor-om:
...
**Razlika između uređaja Ledger i kontroverze kompanije**
...
### Otvoreni problemi u ekosistemu Bitcoin
...
Osiguranje Bitcoin sredstava je složen zadatak, prepun izazova. Hot novčanici, koji se često koriste za svakodnevne transakcije, predstavljaju značajne sigurnosne rizike, posebno za one koji upravljaju Lightning čvorovima. Pored toga, planiranje nasleđivanja Bitcoin sredstava ostaje zamršen i često nesiguran proces. Složenost ovih sigurnosnih mera može odvratiti potencijalne korisnike i zakomplikovati širu primenu.


#### Otvoreni problemi u privatnosti


Privatnost je još jedno ključno pitanje unutar ekosistema Bitcoin. Iako je privatnost ključna za sigurnost, trenutni okvir Bitcoin nudi ograničene funkcije privatnosti. Transakcije On-Chain su lako pratljive, što predstavlja rizik za anonimnost korisnika. Iako Lightning Network ima potencijal da poboljša privatnost, još uvek zahteva značajna poboljšanja. Ravnoteža između transparentnosti i privatnosti je delikatna i zahteva inovativna rešenja kako bi se osigurala sigurnost i privatnost korisnika.
...
Izmena konsenzusnog mehanizma Bitcoin je retko i izazovno poduhvat zbog decentralizovane prirode mreže. Predlozi kao što su ChISA (agregacija potpisa sa unakrsnim unosom) i zaveti imaju za cilj uvođenje složenijih pravila transakcija, ali njihova implementacija je puna poteškoća. Promene konsenzusa zahtevaju širok dogovor unutar zajednice, a potrebna koordinacija može dovesti do značajne frustracije i iscrpljenosti ako predložene promene nisu prihvaćene. Ovo naglašava potrebu za pažljivim i saradničkim naporima u razvoju protokola.


### Inovacije i standardi u razvoju Bitcoin
...
Razvoj boljih alata i hardvera je od vitalnog značaja za poboljšanje upotrebljivosti i sigurnosti Bitcoin. Inovacije poput hardverskih novčanika (npr. Ledger i Trezor) nude robusna sigurnosna rešenja, ali moraju nastaviti da se razvijaju kako bi Address odgovorio na nove pretnje. Poboljšani alati mogu učiniti Bitcoin pristupačnijim i sigurnijim za širu publiku.


Ublažavanje rizika povezanih sa distribucijom Hardware Wallet i osiguranje njihovog integriteta je ključno. Napadi na Supply lanac predstavljaju značajne pretnje bezbednosti ovih uređaja. Implementacija rigoroznih bezbednosnih mera i osiguranje transparentnosti u procesu proizvodnje i distribucije može pomoći u ublažavanju ovih rizika.
...
## Razmišljanje o bezbednosti u Bitcoin
...
#### Kreiranje sigurnih protokola


Da bi se zaštitili izbori, na primer, može se sprovesti nepristrasni nadzor ili monitoring od strane više stranaka kako bi se osigurala transparentnost i integritet. Kriptografske metode, kao što su vremensko označavanje i međusobna verifikacija, pomažu u održavanju autentičnosti podataka i sprečavanju manipulacije.
...
Razumevanje uloge podsticaja je ključno za održavanje bezbednosti. Na primer, bezbednosni model Bitcoin oslanja se na podsticaje rudara i validaciju učesnika mreže, ističući važnost ekonomskih podsticaja u zaštiti digitalnih ekosistema.


#### Osiguravanje Bitcoin novčanika
...
Pravni okvir koji reguliše softver prvenstveno se vrti oko zakona o autorskim pravima. Ovi zakoni daju stvaraocu softvera ekskluzivna prava da koristi, modifikuje i distribuira svoje delo. Međutim, open-source licence pružaju mehanizam za deljenje ovih prava sa javnošću, pod određenim uslovima. Ova pravna struktura je ključna za razumevanje dinamike distribucije i modifikacije softvera.


Ukratko, priroda softvera kao lako replikabilnog koda i podataka, u kombinaciji sa pravnim mehanizmima koje pružaju open-source licence, naglašava njegovu ključnu važnost u savremenom digitalnom okruženju. Ovaj okvir ne samo da podstiče inovacije već i osigurava da softver može biti slobodno deljen i unapređivan od strane globalne zajednice.
...
#### Motivacije za promenu i konsenzus
...
#### Upravljanje vezama sa vršnjacima


Čvorovi moraju pažljivo upravljati svojim vezama sa vršnjacima kako bi osigurali da se ne povezuju sa zlonamernim akterima. Ovo uključuje održavanje liste zabranjenih vršnjaka koji su pokazali sumnjivo ponašanje i redovno ažuriranje liste vršnjaka kako bi se izbeglo oslanjanje na malu grupu čvorova.
...
### Parsiranje Bitcoin blokova i transakcija u Rust
...
Da naš primer ostane upravljiv:
...
- Ulazi**: Lista ulaza.
  ...
  - Skripta potpisa**: Skripta za potvrdu autorizacije transakcije.
  - Sekvenca**: Verzija transakcije kako je definisao pošiljalac.
- Broj izlaza**: Broj izlaza transakcije.
...
U Rust, možemo koristiti različite tehnike za parsiranje ovih struktura:



- Koristite `from_le_bytes` za čitanje podataka u Little Endian formatu.
- Implementirajte prilagođeni `parse` trait za obradu logike parsiranja za različite strukture.
...
- Implementirajte parsiranje generički za liste i specifične tipove kao što su `VarInt`, `U32`, `U64`, itd.
...
Da bismo osigurali da naš parser radi ispravno:
...
Implementiraćemo funkciju `parse` da obradi ceo blok, uključujući zaglavlje bloka i transakcije. Ovo podrazumeva čitanje podataka bloka i izdvajanje relevantnih polja.
...
Parsiranje skripti može predstavljati izazove, posebno sa coinbase transakcijama. Važno je uzeti u obzir rubne slučajeve i pravilno ih obraditi kako bi se osiguralo tačno parsiranje.
...
#### Korišćenje postojećih biblioteka
...
Mining prazni blokovi mogu biti efikasniji za rudare:
...
Iako je zlonamerni Mining praznih blokova moguć, nije primećen. Primarni razlog za prazne blokove je vremensko ograničenje, a ne zlonamerna namera.


#### Implikacije praznih blokova
...
Zaključno, parsiranje Bitcoin blokova i transakcija u Rust uključuje razumevanje složenih struktura i implementaciju efikasnih tehnika parsiranja. Rukovanje posebnim slučajevima i parsiranje skripti zahteva pažljivo razmatranje, a fokusiranje na efikasnost i sigurnost osigurava robusnost Bitcoin mreže.


## Pregled softvera Bitcoin i implementacije čvorova
...
- Kompajliranje baze koda za kreiranje izvršne verzije. [Bitcoin github](https://github.com/Bitcoin/Bitcoin) pristup doc/build-\*.md za uputstva.
...
- Pokretanje testova kako bi se osiguralo da sve funkcioniše ispravno. Uputstva se mogu pronaći [ovde](https://github.com/Bitcoin/Bitcoin/blob/master/test/README.md)
...
#### Novčanici samo za gledanje


Novčanici samo za gledanje sadrže samo javne ključeve, omogućavajući korisnicima da primaju Bitcoin i prate svoj saldo bez mogućnosti trošenja. Ova funkcija dodaje dodatni Layer sigurnosti za one koji trebaju pažljivo pratiti svoja sredstva.


#### Osnovne funkcije Bitcoin Wallet


Bez obzira na tip, svaki Bitcoin Wallet obavlja tri osnovne funkcije:


1. **Primite Bitcoin**: generate adrese i pratite dolazne transakcije.
...
1. **Deskriptori**: Deskriptori opisuju kako izvesti Bitcoin skripte i adrese iz ključeva, omogućavajući fleksibilnije i snažnije Wallet funkcionalnosti.
...
Razumevanjem ovih komponenti, od Bitcoin čvorova i novčanika do Bitcoin Razvojnog Kita (BDK), možete se kretati kroz Bitcoin ekosistem sa većim poverenjem i kompetencijom. Ovo znanje vas osnažuje da razvijate robusne i sigurne Bitcoin aplikacije, doprinoseći stalnoj evoluciji ove revolucionarne tehnologije.
...
Dobrodošli na naše predavanje o modernim rešenjima za plaćanje unutar Blockchain tehnologije. Danas ćemo istražiti istorijski kontekst i ključne razvoje multi-hop brave (MHLs) i Lightning Network.
...
Uvođenje MHL-ova i Lightning Network označava promenu paradigme sa tradicionalnih, linearnih Blockchain transakcija ka sofisticiranijim, višeslojnim sistemima. Podelom transakcija na specifične teme ili segmente, ove inovacije omogućavaju skalabilniju i sigurniju platnu infrastrukturu koja rešava mnoge od inherentnih problema u ranim implementacijama Blockchain.
...
U praktičnom scenariju, tok plaćanja Alice uključuje plaćanje Ericu preko više posrednika, kao što su Bob, Carol i Diana. Svaki učesnik u ovom lancu je odgovoran za povlačenje sredstava od prethodnog učesnika.
...
Ukratko, pravilno funkcionisanje čvora osigurava atomska plaćanja, a Lightning Network ima za cilj da Address mnoge probleme sa kojima se suočavaju tradicionalni platni sistemi poput Ripple-a. Korišćenjem HTLC-ova i strateškog rutiranja, Lightning Network pruža skalabilnije, efikasnije i sigurnije rešenje za decentralizovana plaćanja.
...
Čvorovi mogu emitovati svoje podržane funkcije, osiguravajući unazadnu kompatibilnost dok omogućavaju opcionalna poboljšanja. Ova fleksibilnost osigurava da svi čvorovi mogu glatko komunicirati, čak i dok se protokol razvija.


#### Rukovanje Bolt11 fakturama


Mreža osigurava jedinstvenost Bolt 11 faktura kako bi se izbegla višestruka plaćanja za isti Invoice. Ako se Invoice ponovo koristi, mrežni čvorovi presreću i sprečavaju dvostruka plaćanja, održavajući integritet transakcije.
...
U zaključku, razumevanje Druge Layer Važnosti, Lightning Network Specifikacija i mehanizama Otkrivanja Mreže je ključno za svakoga ko želi da se upusti u složenosti Lightning Network. To je složeno, ali veoma nagrađujuće polje koje obećava transformaciju budućnosti digitalnih transakcija.
...
- Ovo predstavlja količinu Bitcoin koju korisnik može primiti putem svojih kanala. To je jednako važno, jer osigurava da drugi mogu slati uplate korisniku.
...
- Funkcije**: Ekstenzija za pregledač, otvorenog koda, podržava i kustodijalne i nekustodijalne modele, poboljšavajući svestranost.
...
- Funkcije**: Lagan čvor na telefonu, otvorenog koda, kombinuje samostalno čuvanje sa upravljanom likvidnošću, pružajući ravnotežu kontrole i pogodnosti.
...
Uprkos njihovim prednostima, Lightning novčanici se suočavaju sa nekoliko kritika i oblasti za poboljšanje:
...
### Dodatni uvidi i slučajevi upotrebe
...
U Lightning Network, **likvidnost** se odnosi na dostupnost sredstava u platnim kanalima koja su neophodna za izvršenje ili primanje uplata. Korisnici moraju osigurati da imaju dovoljno dolazne i odlazne likvidnosti za uspešne transakcije. Na primer, ako želite da primate uplate, morate imati dostupnu dolaznu likvidnost, što znači da drugi čvor mora dodeliti deo svog salda vašem kanalu. Slično tome, ako želite da šaljete uplate, potrebna vam je odlazna likvidnost u vašem kanalu.
...
Programeri se suočavaju sa izazovom implementacije besprekornog upravljanja likvidnošću unutar aplikacija. Potrebno je da kreiraju alate koji automatizuju rebalansiranje i smanjuju trenje za korisnike, dok optimizuju naknade i izbegavaju uska grla u likvidnosti.
...
- Praktično pitanje**: Osigurati da je korisnik zaštićen od tehničkih složenosti upravljanja kanalima i On-Chain transakcijama, uz održavanje transparentnosti kada je to potrebno.
...
Programeri istražuju načine kako omogućiti korisnicima da primaju Lightning uplate čak i kada su njihovi čvorovi van mreže. Ovo zahteva kreativna rešenja kako bi se očuvala decentralizovana priroda Lightning-a, dok se rešava praktično pitanje stalne povezanosti.



- Praktično pitanje**: Razvijanje protokola ili sistema koji omogućava korisnicima da primaju uplate offline bez ugrožavanja sigurnosti ili decentralizacije predstavlja značajan tehnički izazov.
...
Pravljenje rezervnih kopija Lightning kanala je ključno za korisnike kako bi povratili svoja sredstva u slučaju da njihov čvor prestane sa radom ili se podaci izgube. Međutim, proces pravljenja rezervnih kopija za Lightning kanale je složeniji nego za Bitcoin jer su kanali sa stanjem, što znači da se menjaju sa svakom transakcijom.
...
- Praktično pitanje**: Projektovanje rezervnih sistema koji su bezbedni, decentralizovani i jednostavni za korišćenje predstavlja značajan izazov, jer rezervne kopije moraju biti ažurirane sa svakom promenom stanja u kanalu.
...
Da biste bili u toku sa najnovijim tehničkim inovacijama u Bitcoin i Lightning Network, neophodno je iskoristiti vredne resurse. Bitcoin OpTec bilten, lightning dev mailing lista i materijali od stručnjaka iz industrije kao što je Jason Lopp pružaju uvide i ažuriranja o tekućim napretcima i istraživanjima u ovoj brzo razvijajućoj oblasti.


Razumevanjem i uvažavanjem ovih razvoja, možemo prepoznati višestruki napredak i potencijal koji i Bitcoin i Lightning Network imaju za budućnost digitalnih transakcija.


## Protokoli na vrhu LN
...
- Jednokratna upotreba**: Fakture se obično koriste samo za jednu transakciju, što može biti nezgodno.
