...
* à l'appréciation de son prix au cours du temps, l'amenant à devenir une réserve de valeur et un investissement à long terme en raison de son émission monétaire ;
* au développement successif du marché spéculatif des cryptomonnaies, en particulier en 2017/2018 et en 2020/2021 ;
...
D'autre part, comment pourrions-nous amener les nouvelles personnes arrivant par appât du gain dans "l'écosystème des cryptomonnaies" à ne pas perdre leur argent dans le dernier memecoin à la mode, mais à **s'éduquer sur les fondamentaux de Bitcoin** ?
...
En parallèle, un meet-up est un événement organisé par (et pour) cette communauté, dans un objectif précis. Il se fait donc habituellement après la création d'une communauté.
...
D'une part, elle peut permettre à ses membres d'échanger et de partager des informations entre eux. L'entraide est alors un pilier central de son développement, permettant à chacun d'accélérer son apprentissage.
...
L'organisation de ces meet-ups peut en ce sens permettre des rencontres bien plus conviviales que des rencontres audios ou par visioconférence. Ces événements peuvent alors s'effectuer **autour d'un verre ou d'un repas**, permettant ainsi d'échanger de manière précise et directe avec un plus grand nombre de personnes.
...
C'est la raison pour laquelle **la géolocalisation de votre communauté (et donc, de vos futurs meet-ups) a un impact considérable sur son développement**.

Voici donc quelques réflexions pouvant vous orienter :

1. **Créez et développez votre communauté dans une moyenne ou une grande ville**.
    ...
    * d'**accentuer le sentiment d'implication et d'appartenance** d'un plus grand nombre de personnes envers votre communauté et vos événements ;
...
3. **Choisissez un nom pour votre communauté / meet-up en référence à sa ville**, permettant ainsi aux gens de s'y identifier facilement. Par exemple : "Bitcoin Paris", "Einundzwanzig Berlin", "Satoshi Spritz Milano", etc.
...
Il est alors possible qu'après quelques recherches, vous découvriez qu'un meet-up ou qu'une communauté existe dans la même ville que la vôtre. Or, comme Bitcoin est décentralisé, chaque individu est libre de faire ce qu'il veut.
Cependant, il est évident qu'**il est plus pertinent d'unir ses forces plutôt que de multiplier les communautés proches ; et donc, de diminuer la capacité d'impact de chacune**. En ce sens, créer une nouvelle communauté dans une ville qui en possède déjà une, peut créer une forme de concurrence, même involontaire.
...
Cela peut alors être décidé au lancement de votre communauté / meet-up, ou lorsque plusieurs membres vous auront rejoint et que votre communauté sera réellement active.

Pour vous aider en ce sens, voici ci-dessous quelques réflexions pouvant être utiles :

1 - **Pourquoi, en tant que bitcoiner, ai-je créé cette communauté ?** Est-ce pour partager mes connaissances ? Pour éduquer ? Pour apprendre des autres ? Pour rencontrer d'autres personnes partageant une même vision ? Pour m'impliquer dans l'écosystème ? Pour rencontrer des professionnels ? Pour simplement boire des bières et se faire de nouveaux amis ?
...
En ce sens, **se fixer des objectifs et des projets concrets semble nécessaire**.
...
Toutefois, comme nous le verrons plus tard dans la section "[Des exemples de projets et d'initiatives](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/05880102-07ac-413a-8433-8a6ab8fac2ab)", **un meet-up peut être construit de différentes manières, avec des objectifs divers**.
...
**Vous pourriez alors choisir de vous focaliser à court terme sur le développement des réseaux sociaux et des canaux de communication de sa communauté. À moyen terme, sur le développement de ressources pédagogiques (articles, flyers, etc.). Et à long terme, sur le lancement d'un meet-up physique**.

Quelques mois plus tard, **lorsque vos meet-ups seront réguliers, vous pourriez alors réfléchir à la mise en place à court terme de présentations ou d'ateliers sur des thèmes spécifiques ; à moyen terme, à la réalisation d'une campagne de sensibilisation / d'éducation à Bitcoin ; et à long terme, à la création d'une association ou à la recherche d'un bar acceptant Bitcoin comme moyen de paiement**.
...
C'est la raison pour laquelle nous nous efforcerons, dans cette partie 2/8, de vous proposer des tutoriels et des solutions logicielles vous permettant de concevoir l'identité visuelle de votre communauté ; et cela, sans pour autant avoir les compétences d'un designer.
...
Cela passe tout d'abord par le choix du nom. En effet, suivant les pays, différentes initiatives et communautés nationales existent.
...
Ainsi, bien qu'il vous soit parfaitement possible de créer une nouvelle communauté française avec le nom que vous souhaitez, **il semble plus pertinent dans notre pays de l'appeler "Bitcoin [VILLE]" ou "[VILLE] Bitcoin"**.

En parallèle, **l'identité visuelle de votre communauté et de votre meet-up joue un rôle essentiel sur son développement**, car c'est entre autres grâce à elle que l'on se rappellera de votre initiative.
...
Pour créer son identité visuelle, le mieux est donc de partir d'un élément ou d'un lieu marquant de votre ville. Cela peut être, par exemple, à Paris la tour Eiffel, à Lille le Beffroi ou la Citadelle, à New York la statue de la Liberté, à Londres Big Ben, etc.
...
- À Saint-Malo, l'hermine — emblème de la ville — est mise en valeur :

![image](assets/fr/009.webp)

À vous désormais de **trouver un élément ou un lieu marquant de votre ville et de l'utiliser pour construire le visuel de votre communauté Bitcoin**.
...
Lors de la **création de votre logo**, il vous est alors possible d'effectuer sur la page d'accueil une recherche des différents logos déjà préconstruits, de dupliquer celui ou ceux qui vous intéressent ; puis de les modifier à votre guise.
...
Dans le cas de la **création d'une bannière ou d'une affiche**, il vous suffit d'effectuer de nouveau une recherche sur la page d'accueil du site afin d'obtenir une affiche préconçue. Par la suite, après l'avoir dupliquée, il est possible de la modifier en changeant les textes et polices, en ajoutant le logo de votre communauté et en important des photos pour les glisser dans un cadre (que vous obtiendrez en cherchant "cadre" dans le menu de gauche "Éléments").
Le menu de gauche "Designs" permet par ailleurs de rechercher d'autres modèles correspondant à votre demande.

Enfin, il est également possible de rechercher sur la page d'accueil une **miniature ou une bannière YouTube préconçue**, de la dupliquer puis de la modifier à votre guise.
...
Les possibilités étant infinies, vos choix s'aligneront sur vos besoins. **N'hésitez donc pas à concevoir vous-même de nouveaux modèles, puis prenez quelques minutes pour les partager autour de vous afin que cela puisse faire gagner du temps aux autres communautés de votre pays**.
...
Pour ce faire, de nombreuses IA existent. On compte notamment :
...
- [ ] *Rends le 4ᵉ beaucoup plus réaliste* - [Lien](https://copilot.microsoft.com/images/create/un-logo-bitcoin-futuriste-avec-en-arric3a8re-plan-le-/1-6612ba64b72d4cea9830ab7eb844f785?FORM=SYDBIC)

![image](assets/fr/015.webp)

Le dernier rendu est d'ailleurs plutôt sympa !

Cependant, si l'on souhaite un logo plus épuré, pour un sticker par exemple, on peut alors entrer sur "copilot" :
...
Pour ce faire, jeter un coup d'œil à la carte [btcmap.org](https://btcmap.org/communities/map#0/0/0/) vous donnera un avis déjà bien précis des canaux de communication les plus utilisés autour de vous.
...
Passez donc directement à la section suivante, intitulée "[Créer un groupe Telegram](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/7b87c24a-4820-4652-a3de-dc29cafea4d0)".
...
- poster des **sondages** (très pratique pour choisir la date du prochain meet-up lorsque cela n'est pas encore régulier, c'est-à-dire que la communauté est encore peu développée) ;
...
- **ajouter une "photo de profil"** au groupe Telegram (c'est-à-dire le logo de votre communauté), **et modifier son nom**.
...
Le point négatif d'un groupe Telegram est que, lorsqu'il commence à y avoir plusieurs centaines de membres, les discussions dans ce même canal de communication commencent à devenir fouillis. Cela entraîne alors un effet indésirable : certains membres ne suivent plus quotidiennement le groupe Telegram, les amenant parfois à rater des informations importantes ; comme la date du prochain meet-up.

Pour remédier à cela, plusieurs solutions existent :
1. **épinglez en tant qu'administrateur les messages importants**, pour que tout le monde en soit notifié (appuyez pour cela 1 fois avec votre doigt sur le message en question, puis sélectionnez "Épingler") ;
...
C'est tout simplement **un groupe Telegram dans lequel on intègre plusieurs "sujets"**. Un sujet **"Informations importantes"** peut alors être créé, dans lequel on n'y postera que les informations essentielles associées aux prochains événements / meet-ups.
...
Maintenant que vous avez créé votre groupe (ou super-groupe) Telegram, le moment est venu de **réfléchir aux permissions de ce dernier ainsi qu'à sa modération**. Évidemment, chaque communauté est libre de faire comme elle le souhaite.
...
Enfin, dans la partie "Administrateurs", il est possible d'ajouter un "Antispam agressif" qui supprime automatiquement les messages considérés comme tels. Cela n'est toutefois pas forcément nécessaire.

##  Insérer un bot multifonction dans un canal Telegram
<chapterId>80108eb0-6648-4fe9-b41f-586f03466805</chapterId>

**Une autre possibilité pour paramétrer et sécuriser son groupe ou super-groupe Telegram est d'ajouter un bot multifonction**. Cela permet en effet d'aller beaucoup plus loin dans sa configuration.
...
- configurer un **mécanisme antispam** ;
...
- configurer le **mécanisme antiflood** ;
...
Tutoriel pour ajouter un bot multifonction à un groupe ou super-groupe Telegram :

:::video id=cdbf82d6-3530-45c4-90de-593f100863bb:::

Petite remarque : comme dit précédemment, toute cette procédure peut désormais être  réalisée sur téléphone. Il n'y a en effet plus besoin de l'application Telegram+.
...
Dans l'optique de vous faire de nouveau gagner du temps, voici un tutoriel expliquant comment ajouter ce bot multifonction à un groupe ou super-groupe Telegram :
...
Tout simplement parce qu'à l'image du réseau social NOSTR, ces dernières sont décentralisées et chiffrées. En plus du **gain de confidentialité** pour votre communauté, cela permet également de **se prémunir d'une fermeture (voire d'une censure) de votre groupe ou super-groupe Telegram**.
...
C'est la raison pour laquelle un **profil NOSTR spécifique à votre communauté** peut également être créé, en particulier si vous avez en tête d'anticiper de potentielles restrictions et/ou censures sur Twitter. Après tout : il vaut mieux prévenir que guérir.
...
Néanmoins, il est à rappeler que **plus il y a de canaux de communication et de réseaux sociaux à gérer et à alimenter, plus cela prend du temps. Il vaut donc peut-être mieux se concentrer sur les plus pertinents, Twitter et NOSTR semblent être de bons candidats**.
...
2. **le logo et la bannière** que vous aurez créés pour votre communauté ou votre meet-up (voir section "[Créer un logo, une affiche et une bannière](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/8b85ccb1-5474-474e-ae1b-c8cb69f060ad)") ;
...
Bien que cela puisse paraître inutile aux yeux de certain(e)s, **suivre les comptes des communautés et des initiatives locales / de son pays peut amener indirectement à la réalisation de projets communs**, voire de "partenariats". C'est ainsi que les communautés Bitcoin Liège et Bitcoin Lille sont venues à prendre contact (c'est le cas aussi de Bitcoin Aix et Bitcoin Marseille) ; les amenant désormais à effectuer au moins une fois par an un meet-up commun.
...
En parallèle, il est évidemment possible de **proposer aux organisateurs de meet-ups et aux bitcoiners ayant créé une communauté de se réunir deux ou trois fois dans l'année par visioconférence afin de faire un point sur l'évolution des projets nationaux et des communautés associées. Cela peut également se faire lors des événements physiques**, l'objectif étant simple : écouter le ressenti de chacun, discuter de l'évolution des communautés présentes, mais aussi partager des idées et des projets qui ont aboutis, de proposer des solutions lorsque cela est nécessaire, etc. Un bilan écrit de cette réunion peut même être partagé après cette "réunion" aux organisateurs(rices) des communautés de votre pays qui n'étaient pas présent(e)s.
...
* **[Btcmap.org](https://btcmap.org/)**, site internet qui regroupe deux cartes mises à jour quotidiennement : **[la carte mondiale des commerces acceptant Bitcoin](https://btcmap.org/map)** et **[la carte des communautés mondiales](https://btcmap.org/communities/map)**. De nombreux bitcoiners, lors de leurs vacances ou même dans leur quotidien, scrutent régulièrement ces cartes afin de pouvoir faire de nouvelles rencontres ou de nouveaux achats. **Btcmap est clairement la référence mondiale. Et pour votre visibilité, votre communauté se doit d'y être référencée.**
...
Maintenant que les réseaux sociaux et les canaux de communication de votre communauté ont été lancés, il n'y a plus qu'à faire acte de présence sur ces plateformes. Les nouveaux membres devraient par la suite se présenter d'eux-mêmes, engageant petit à petit la discussion.
Cela vous permettra donc de vous libérer du temps, qui pourrait par exemple vous permettre de réfléchir à la création d'une rencontre de type "meet-up" ; quel qu'en soit son format. Cela s'accentuera d'ailleurs lorsque vous commencerez à sentir une certaine ferveur au sein de votre communauté.
...
- l'apport d'un livre ;
- l'apport d'un **Nerdminer**, Bitaxe, FPGA voire ASIC ;
...
À noter toutefois : lorsque le meet-up n'est qu'à ses débuts, il n'est pas forcément pertinent de réaliser un exposé didactique. Lorsque vous êtes peu, il semble en effet préférable de réaliser cela sous la forme de discussion, de manière plus ouverte et plus conviviale.
...
*voire* **un second événement dans le mois**.
...
Dans le second cas, un deuxième événement dans le mois peut par exemple permettre d'**aborder un thème spécifique, comme la mise en place de sessions "débutants" et/ou d'ateliers** (minage, Lightning, installation de nœud, etc.).

![image](assets/fr/031.webp)

Gardez toutefois en tête que **cela demande une organisation plus importante ; et vous prendra donc plus de temps**. Mais heureusement, dans la [partie 6/8 de ce cours](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/05880102-07ac-413a-8433-8a6ab8fac2ab), vous seront proposées de nombreuses ressources open source réutilisables.
...
4) le lieu dispose-t-il d'un **vidéoprojecteur et d'un espace calme pour réaliser vos présentations ?**
...
Lorsque votre groupe comptera davantage de membres, vous pourrez consacrer une fin d’après-midi à visiter plusieurs commerces et bars. L’objectif sera de vérifier s’ils disposent d’un espace adapté pour accueillir vos événements mensuels.
...
2. **annoncer sur les réseaux sociaux et canaux de communication votre événement, en explicitant clairement la date, l'heure, le lieu** et en ajoutant le lien d'inscription si nécessaire. Pour cette communication, un visuel spécifique peut être créé (affiche Canva par exemple, voir partie 2/8 "[Concevoir une identité propre à sa communauté Bitcoin](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/4475004b-19e7-4c0f-a799-fd2cb0baefad)"). De plus, pour qu'un maximum de personnes puisse voir cette annonce, celle-ci peut être **épinglée sur Telegram et Twitter**, et peut aussi contenir un **"@everyone" sur Discord**. Il semble également plus que pertinent de **poster ces annonces 1 semaine à dix jours avant la date de l'événement**, permettant ainsi à tout à chacun de pouvoir anticiper sa venue ;

![image](assets/fr/033.webp)

3. **deux à trois jours avant l'événement, ces annonces peuvent être retweetées et repartagées**, amenant plus de visibilité ;
...
3) en plus de l'agencement de la salle, d'autres petites "customisations" peuvent être entreprises :
    ...
    - installation sur une ou plusieurs tables de **stickers, flyers, voire du matériel pouvant amener à la discussion** (Nerdminer, portefeuille matériel, ordinateur allumé avec la mempool, ASIC, plaque en métal pour sécuriser sa clé privée, etc.).
...
- envoyant un message sur vos canaux de communication afin de **remercier les personnes présentes**, et/ou en partageant les liens ou sites dont vous avez parlé ;
...
Une longue période de quelques semaines se présentera alors à vous ; parfaite pour développer d'autres designs et/ou projets pour votre prochain meet-up.
...
- pourquoi certains participants ne sont-ils finalement pas venus ?
...
En France, au cours de l'été 2023, les organisateurs de meet-ups ont ainsi travaillé sur **une progression annuelle**. En plus d'avoir une **dimension éducative forte, cela permet également aux meet-ups de pouvoir s'échanger des documents et des présentations PowerPoint opensource** ; permettant ainsi de disposer d'une base de données de ressources de plus en plus conséquentes.
...
| Février     | Chapitre 5 : Monter un nœud Bitcoin et Lightning     | [Lien youtube](https://www.youtube.com/watch?v=RRYK-usg-OY)     | [PowerPoint modifiable](https://www.canva.com/design/DAF55FU6HI0/sQ0lacRJblqrhn_9Xk1yDg/edit) |
...
- voire, d'**un meet-up commun avec les meet-ups limitrophes**.

![image](assets/fr/037.webp)

Pensez toutefois à faire attention à **ne pas trop réaliser d'événements dans le mois, car plus il y en a, plus cela demande du temps** pour les organisateurs comme pour les participants ; et cela peut amener certains d'entre eux à ne plus venir à chaque fois.
...
- si vous souhaitez que ces stickers puissent être collés dans la rue, il vous faut des **stickers résistants à l'eau** ("waterproof" ou imperméables) ;
...
Enfin, toujours dans l'idée de développer les lectures autour de Bitcoin, une dernière action d'envergure peut être de **se rendre dans les bibliothèques municipales de la ville et de vérifier si elles disposent de différents ouvrages sur Bitcoin**.
Si oui, peut être demandé aux bibliothécaires si des **tables rondes** sur ce sujet peuvent être réalisées dans les prochains mois, quitte à leur donner le contact du meet-up de la ville.
Sinon, **peut être proposé l'achat de plusieurs ouvrages que vous aurez sélectionnés en amont**. Le site de [l'éditeur Konsensus Network](https://konsensus.network/) peut alors être source d'inspiration.

## Créer des flyers personnalisés et les distribuer
<chapterId>50949d74-897a-4097-8bad-65245e5bb5e1</chapterId>

La création et l'écriture de flyers prennent beaucoup de temps. Néanmoins, cela permet de **disposer d'un support papier lors des discussions autour de Bitcoin**, ce qui est tout à fait appréciable.
...
Tout bitcoiner a certainement déjà vu la très intéressante minisérie "Le mystère Satoshi, aux origines du Bitcoin" de [Rémi Forte](https://twitter.com/forteremi).
...
Petit bémol toutefois : bien qu'ARTE France ait confirmé que cette diffusion était possible, il sera nécessaire pour être dans la légalité de s'acquitter des **droits de projection**, dont le montant s'élevait à près de 250€ par projection en 2023 (avec une réduction envisageable de 120€ par projection si 5 meet-ups effectuaient une projection dans l'année).
...
Dans plusieurs pays d'Europe (Allemagne, Espagne, France, etc.), **des bitcoiners ont pris l'initiative de coller des affiches dans leur ville**. Certaines d'entre elles reprennent alors les œuvres de Banksy en y intégrant le logo Bitcoin.
...
D'autres CMS ou plateformes permettent également de créer des sites internet. Bien que certaines soient plus simples en raison de leur interface agréable, les sites internet qui en sortent sont également bien moins personnalisables. **WordPress semble donc être le plus pertinent pour se lancer**.
...
Parmi les membres de votre communauté, certains seront peut-être intéressés pour **créer du contenu multimédia** ; comme la réalisation de vidéos tutoriels.
En parallèle, vous réaliserez probablement un jour des présentations lors de vos meet-ups, voire dans des universités.
...
Quant au **montage vidéo** (si tant est qu'il y en a), il vous sera nécessaire de disposer d'un logiciel adéquat.
Bien qu'il soit payant (45€ par an), [Wondershare Filmora](https://filmora.wondershare.fr/) est particulièrement efficace et très simple d'utilisation ; vous permettant de réaliser des montages de qualité en quelques minutes.
...
En parallèle, dans un registre tout à fait différent, il est également possible **à chaque événement de demander aux participants d'écrire leurs prénoms ou pseudonymes sur un badge**. La raison de leur présence peut aussi être demandée. 
...
De plus, **avoir un état d’esprit ouvert, prêt à vulgariser au besoin**, est essentiel dans ce type d'exercice ; en particulier lors de la phase de questions / réponses en fin de conférence, ou dans le cas d'une table ronde. Cela ne signifie pas "faire une croix sur ses principes", mais simplement accepter qu'autrui puisse avoir un autre point de vue, quitte à répondre plus tard ou à laisser couler afin que le dialogue puisse avancer. De toute façon, si **votre discours et vos réponses se basent sur des arguments pertinents et sourcés**, le public ne sera pas dupe.
...
Dans un premier temps, il faut parvenir à **obtenir un contact**. Cela peut être obtenu **par le biais d’une connaissance, par le biais des BDE ("Bureaux Des Étudiants") ; voire même des associations d’élèves**, qui organisent généralement des cycles de conférences et de rencontres tout au long de l'année. Vos **anciens professeurs d'école d'ingénieurs ou de faculté** peuvent également servir de relais.

Dans le cas d’une école post-bac, il est également possible de **contacter directement la personne responsable de la formation** afin de présenter votre initiative ou association. Cela peut alors amener à une première rencontre puis – dans le meilleur des mondes, quelques semaines plus tard — à une présentation de ce qu’est Bitcoin et de comment il fonctionne, devant les étudiants.

Malheureusement, dans notre monde actuel, Bitcoin est encore bien trop volontairement diabolisé par les médias et les politiques ; amenant de nombreux néophytes à penser qu’il est à bannir des salles de classe et des amphithéâtres. **La probabilité est donc assez élevée pour que vous essuyiez de nombreux refus**, notamment dans la sphère universitaire où la preuve de travail et la consommation énergétique de Bitcoin semblent être tabou.

Rien ne vous empêche toutefois d’essayer, notamment auprès des BDE et des associations d’élèves.**Même après un premier refus catégorique, il est possible que l’on vous recontacte ultérieurement via l’adresse mail de votre communauté. Cela peut survenir, par exemple, lors d’un bull-run, pour organiser une conférence devant environ 280 étudiants!**  
...
3 - une fois que cette personne se sera décidée à accepter Bitcoin, **prendre rendez-vous avec elle afin de lui montrer la solution logicielle que vous proposez, semble pertinent**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** se présente alors comme une excellente solution car :
...
4 - **lorsque ce commerce acceptera Bitcoin**, il vous sera alors envisageable :
    ...
    - mais aussi, de **potentiellement réaliser des événements dans ce commerce**, comme des meet-ups ou des ateliers.

![image](assets/fr/056.webp)

5 - une fois que plusieurs commerces de votre ville auront été onboardés et qu’ils auront compris ce que leur apporte Bitcoin, vous pourrez alors leur **proposer de créer un groupe Telegram spécial commerçants** ; l'objectif étant alors de **leur permettre de s’entraider** et d’aller plus loin dans l’orange-pilling des autres commerces de la ville. En parallèle, ce groupe pourra également **jouer le rôle d'aide technique**, dans le cas où un problème survient avec un client.

Bien évidemment, **ce démarchage est un travail de longue haleine. Il demande beaucoup de temps, une motivation accrue, mais aussi une once de stratégie**.
...
Bien que cette stratégie peut-être spécifique à certaines dynamiques locales, il peut être intéressant de prendre contact avec les éditeurs régionaux. Voici d'ailleurs une liste des principaux titres de presse française :
...
À l’image de celle d’internet, cette révolution va nécessairement **prendre du temps**, et tant mieux. Cela va en effet permettre à tout un chacun de **s’éduquer sur les fondamentaux de Bitcoin et d’apprendre à l’utiliser**. Mais également, aux développeurs et aux entreprises de développer des protocoles et des applications qui permettront d’explorer le plein potentiel de cette technologie.

Bien qu’il soit impossible de prévoir le futur, **une augmentation très significative du nombre d’utilisateurs de Bitcoin est à anticiper** afin d’**être préparée à toutes les éventualités possibles**. Y compris les plus catastrophiques, comme une potentielle implosion du système financier traditionnel ; voire: une interdiction de Bitcoin.
...
Face à des situations complexes comme celles-ci, le plus simple est de prendre l’initiative d’expliquer "gentiment" à ces personnes que le meet-up n’est pas l’endroit où elles y parviendront, en avançant des arguments x ou y (par exemple, informer d'une potentielle présence policière en civil).
Si malheureusement ces personnes refusent de s’en aller ou de se plier aux règles de décence (c’est déjà arrivé), une intervention orale lors du meet-up informant qu’une (ou des) personne(s) cherche à réaliser tel ou tel acte malveillant peut être réalisée.
**Heureusement, ces situations sont cocasses et ne se produisent que très rarement. Mais, il vaut mieux y être préparé.**
...
S'il vous plait, **pensez en amont à la passation des rênes de la gestion de votre communauté en** :
...
2) **partageant à  une personne de confiance de votre communauté les noms de compte au moins, mots de passe et mails des comptes et des réseaux sociaux** que vous aviez créés pour lui donner de la visibilité.
...
Repartir de zéro en créant des réseaux et des canaux de communication "forkés" prend en effet tellement de temps et tellement d’énergie…
...
Dans l'objectif de décentraliser encore plus, **utiliser des [logiciels libres tels que la suite framasoft](https://framasoft.org/fr/)** peut également constituer un premier "rempart" face à un État-fiction qui censurerait ou interdirait Bitcoin. Utiliser des outils de communication chiffrés — voire anonymes — en est évidemment un second.

## Et si Bitcoin devenait l'ennemi public n°1 ?
<chapterId>30ca4745-f8b5-48a0-b902-8c270e2062ed</chapterId>

Le 5 avril 1933, Franklin Roosevelt, alors 32ᵉ président des États-Unis d'Amérique, signa le décret 6102 interdisant à tout particulier de posséder pièces d’or, lingots d’or et certificats sur tout le territoire.
...
Heureusement, cette dystopie orwellienne n'empêchera personne de réellement posséder ses propres BTC, car il est impossible d'empêcher qui que ce soit d'apprendre une suite de mots.
...
Satoshi Nakamoto a créé un outil révolutionnaire qui est déjà en train de changer le monde que nous connaissons. Cependant, **c’est à nous, bitcoiners, de choisir la trajectoire que nous souhaitons prendre pour construire l'avenir**.
...
Mais comme nous ne sommes qu'humains, nous ne disposons que d’une quantité de temps fini au cours de notre vie. **C’est donc en restant humble et en apprenant des autres** que chacun d'entre nous parviendra à atteindre son niveau de compréhension souhaité de Bitcoin.
...
Comme vous l’aurez compris dans ce cours, **créer une communauté et un meet-up Bitcoin** demande de l’organisation et de la motivation. Bien évidemment, en fonction des envies et du temps que vous aurez à y consacrer, vous pourrez aller plus ou moins loin dans les projets. 
...
Une fois que les canaux de communication de votre communauté seront assez développés :
  ...
  10) faites référencer votre événement sur des plateformes et des sites adéquats ;
...
Mais aussi, à **réfléchir au monde de demain, à celui que nous souhaitons construire et aux communautés qui sont en train de le bâtir**.
...
**Proposez également aux personnes qui vous suivront dans cette aventure de vous aider, quitte à déléguer certaines tâches** et à ce que ces dernières prennent plus de temps. Sur le long terme, votre communauté en sortira souder et plus mature.
...
Pour ce faire, nous partirons de l'expérience de plusieurs communautés ayant elles-mêmes déjà réalisé leurs propres événements et présentations.
