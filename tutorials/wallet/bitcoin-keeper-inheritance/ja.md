...
description: BitcoinキーパーWalletをタップシグナーで設定・使用し、相続プランを作成する。
---
...
このビデオチュートリアルでは、Bitcoin Keeper WalletとTapsignersのセットアップと使用方法について説明します。トランザクションの送受信、鍵の管理、バックアップなどについて説明します。
...
- Bitcoin Keeperアプリのダウンロードは[こちら](bitcoinkeeper.app)
