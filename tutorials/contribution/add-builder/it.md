...
Vuoi aggiungere una nuova attività Bitcoin su Plan ₿ Network e dare visibilità alla tua azienda o software, ma non sai come fare? Questo tutorial è per te!
...
- Vai al [repository GitHub Plan ₿ Network dedicato ai dati](https://github.com/PlanB-Network/bitcoin-educational-content/tree/dev/resources/builders) nella sezione `resources/builder/`:
...
- Aggiungi un titolo e una descrizione al tuo commit:
...
- Attenzione, la tua immagine deve essere quadrata, deve essere nominata `logo`, e deve essere in formato `.webp`. Il nome completo del file dovrebbe quindi essere:
...
Congratulazioni! La tua PR è stata creata con successo. Un amministratore la esaminerà ora e, se tutto è in ordine, la integrerà nel repository principale di Plan ₿ Network. Dovresti vedere apparire il profilo della tua attività sul sito web qualche giorno dopo.
