...
description: Kuelewa na kutumia miamala ya Stonewall kwenye Ashigaru
---
...
Kwa kuchanganua muamala huu, tunaweza kuona kwamba mwokaji amepokea `4,000 sats` kama malipo ya baguette. Alice ilitumia 2 UTXO kama pembejeo: moja ya `10,000 sats` na moja ya `15,000 sats`. Kwa upande wa matokeo, imepata 3 UTXO: moja ya `4,000 sats`, moja ya `6,000 sats` na moja ya `11,000 sats`. Kwa hivyo Alice ina salio halisi la `- 4,000 sats` kwenye shughuli hii, ambayo inalingana vyema na bei ya baguette.
...
Muamala wa Stonewall unafanya kazi sawa na muamala wa StonewallX2, isipokuwa kwamba wa mwisho unahitaji ushirikiano, tofauti na shughuli ya kawaida ya Stonewall, kwa hivyo jina "x2". Hii ni kwa sababu shughuli ya Stonewall inatekelezwa bila kuhitaji ushirikiano wa nje: mtumaji anaweza kuitekeleza bila usaidizi wa mtu mwingine. Kinyume chake, kwa shughuli ya Stonewall x2, mshiriki wa ziada, anayejulikana kama "mshiriki", anajiunga na mchakato. Yeye huchangia bitcoins zake mwenyewe kwenye shughuli, pamoja na zile za mtumaji, na huchukua kiasi chote mwishoni (modulo ya gharama za mining).



Wacha turudi kwenye mfano wetu na Alice kwenye duka la mkate. Ikiwa angetaka kufanya muamala wa Stonewall x2, Alice ingemlazimu kushirikiana na Bob (watu wengine) wakati wa kusanidi muamala. Kila mmoja angeleta UTXO. Bob basi ingepokea mchango wake wote. Mwokaji angepokea malipo ya baguette yake kwa njia sawa na katika shughuli ya Stonewall, huku Alice ingerejesha salio lake la awali, chini ya gharama ya baguette.
...
[**-> Pata maelezo zaidi kuhusu shughuli za Stonewall x2**](https://planb.academy/tutorials/privacy/on-chain/stonewall-x2-05120280-f6f9-4e14-9fb8-c9e603f73e5b)



## Ni nini lengo la muamala wa Stonewall?
...
## Je, ninawezaje kufanya muamala wa Stonewall kwenye Ashigaru?



Iliyoundwa awali na timu ya Samourai Wallet, miamala ya Stonewall imechukuliwa na programu ya Ashigaru, fork ya wallet asili iliyoundwa kufuatia kukamatwa kwa wasanidi wa Samourai. Utahitaji kusakinisha Ashigaru na kuunda wallet:
...
Bofya kwenye kitufe cha `+` chini kulia mwa skrini, kisha uchague `Tuma`.
...
Chagua akaunti ambayo ungependa kufanya matumizi.
...
Mara baada ya kukagua maelezo yote, buruta kishale kijani chini ya skrini ili kutia sahihi na uachilie muamala.
