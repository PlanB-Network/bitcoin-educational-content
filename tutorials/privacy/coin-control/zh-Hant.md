...
Bitcoin 協定的穩健性由簡單的基石概念所保證。其中最重要的是透明度：所有 Bitcoin 交易都是公開的，任何人都可以輕易驗證。雖然這項功能是協定的基石，因為它可以防止欺詐並確保資金的真實性，但它也可能對保密性造成挑戰。 **您有沒有想過如此高的透明度是否會影響您的隱私？
...
我們可能會問自己以下的問題： **為什麼要這麼做？** 我們不使用 `UTXO1` 的原因有幾個，或可能有幾個，**這些原因都解釋了為什麼在支出階段，啟用 Coin 控制手冊是最好的做法之一**。
...
**Kyc 資金將不可避免地導致追蹤付款人的身份。如果是您的 Wallet，您會希望外部觀察者能如此絕對肯定地追蹤您的身份嗎？
