...
objectives:
- مفاهیم اصلی و فناوری‌های زیربنایی Bitcoin را درک کنید.
...
گروه Lightning Walker راه‌حل خود برای خدمات حواله را با استفاده از MySQL، JavaScript و API شرکت ZDB ارائه می‌دهد.
