...
goal: Edenda oma Lightning arendusoskusi vahepealse Rusti ja SDK koolitusega.
objectives:
  - Harjuda Rusti keelega
  - Mõista, miks kasutada Rusti Bitcoin'i arendamiseks
  - Omandada SDK alusteadmised
---

# Oma LN arendusoskuste edendamine

Tere tulemast oma LN teekonnale SDK-ga.

Selles kursuses õpid Rusti raamatu põhitõdesid, seejärel jätkad mõningate LN programmeerimisega, kasutades SDK-sid, ja lõpetad mõningate praktiliste harjutustega. Meie erineva taustaga õpetajad juhendavad teid praktiliste oskuste poole ja selgitavad erinevaid väljakutseid, millega tänased LN insenerid sageli silmitsi seisavad.
...
Tere tulemast sellele edasijõudnute programmeerimiskursusele SDK-dega. Sellel koolitusel õpid Rusti põhitõdesid, seejärel keskendud BTC-le & Rustile ja lõpetad mõningate praktiliste harjutustega, kasutades SDK-sid.
...
- Andrei: "Lightning ekspert LIPA juures"
...
Täname, et võtsite osa sellest kursusest! Loodame, et see meeldis teile.

Kui soovite sellest seminarist edasi õppida, julgustame teid osalema RGB kursustel, mis on sellel platvormil saadaval.
