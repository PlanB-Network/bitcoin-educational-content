...
- Перейдите на [самостоятельный хостинг Weblate of Plan ₿ Academy](https://weblate.planb.network/):
...
- Теперь вы можете вернуться к панели Plan ₿ Academy:
...
- Когда вы найдете в строке "Plan ₿ Academy", убедитесь, что вы НЕ переводите слово "сеть" (считайте Plan ₿ Academy торговой маркой). Кроме того, всегда используйте ₿ биткоина!
...
Заранее благодарим вас за вклад в перевод Plan ₿ Academy! Если у вас есть какие-то конкретные вопросы или комментарии к нам, не стесняйтесь обращаться к нам через [группу Telegram](https://t.me/PlanBNetwork_ContentBuilder).
