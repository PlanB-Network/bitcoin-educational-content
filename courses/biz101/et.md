...
Veel üks valuuta oluline eelis on selle võime **sallida edasilükatud vahetust**. Vahetustehingute puhul on tehingud kohesed; üks kaup vahetatakse teise vastu reaalajas. Valuuta võimaldab aga **säästmist - üksikisikud saavad väärtust säilitada tulevikuks kasutamiseks**. See kujutab endast tohutut hüpet majanduse planeerimisel, investeerimisel ja jõukuse kogumisel, mis kõik parandavad võrgustikus osalejate elu.
...
"Kapitali" kujutatakse sageli ekspluateerimise vahendina ja see vaatenurk on sügavalt mõjutanud erinevaid liikumisi, mis näevad kapitali olemuslikult vastandatuna töötajate huvidele. Kuid kas see on tõsi? Või võib see arusaam olla moonutatud:
...
Üks lihtne kasutusjuhtum illustreerib, kuidas kõik need elemendid kokku tulevad. Kujutage ette kohalikku käsitöölist, kes müüb laupäevasel taluturul omatehtud moosi. Kui klient palub maksta Bitcoinis, sisestab kaupmees kiiresti vastava fiat-summa ja rakendus arvutab automaatselt tasumisele kuuluvad satsid. Saadud QR-kood skaneeritakse kliendi rahakotiga, makse arveldatakse sekunditega ja käsitööline teab kohe, et tehing õnnestus. Päeva lõpus saab kõik tehingu üksikasjad eksportida arvestuse pidamiseks ning päeva saldo saab täielikult või osaliselt saata vahetusplatvormile fiat-valuutaks konverteerimiseks.

Tasakaalustades kasutajasõbralikke vahendeid, minimaalseid riistvaranõudeid ja lihtsat arvestuse pidamist, pakuvad Starter-lahendused põhitõdesid, ilma et need oleksid üle jõu käivad uutele ettevõtjatele. Kui tehingumahud suurenevad ja ettevõtte tegevusnõuded arenevad, on järgmises peatükis kirjeldatud edasijõudnute kategooriatesse üleminek loomulikuks sammuks.

Soovitatavate rahakottide ja põhiliste seadistuste üksikasjalikud õpetused leiate järgmistest juhenditest:
...
Essential-profiil sobib väikestele ja keskmise suurusega ettevõtetele, kus on potentsiaalselt töötajaid, kes soovivad bitcoin'e lihtsalt ja kiiresti vastu võtta, ilma et nad vajaksid arenenud tehnilisi teadmisi, omades samas terviklikumat ja professionaalsemat süsteemi kui lihtne rahakott. See kategooria kehtib kõige sagedamini restoranide, kohvikute, baaride või väikeste jaemüügipoodide kohta, mis näevad iga kuu vaid käputäis Bitcoin-makseid, kuid soovivad kasutajaliidest, mis on nii lihtne kui ka piisavalt töökindel, et igapäevaseid toiminguid katkestusteta teha.

Erinevalt Starter-profiilist peavad Essential-ettevõtted Bitcoini makseid tavaliselt pigem oma tuluvoo jätkuvaks osaks kui pelgalt eksperimendiks. Nad tegutsevad endiselt suhteliselt väikeste tehingumahtudega, kuid nende tehingute sagedus on piisav, et omanikud ja töötajad saaksid kasu struktureeritumast ja usaldusväärsemast süsteemist. Samal ajal on Essential-profiil jätkuvalt keskendunud lihtsusele; kuigi see võimaldab käepäraseid armatuurlaudu ja piiratud rollihaldust, ei vaja see spetsiaalseid IT-ressursse ega keerulisi integratsioone.
...
Professional-profiil on suunatud ettevõtetele, kes on ületanud juhuslikud või väikesemahulised Bitcoin-maksed ja otsivad nüüd tugevat infrastruktuuri, et hallata mitmeid igapäevaseid tehinguid. Need ettevõtted tegutsevad sageli mitmes kanalis (võib-olla jaemüügikoht, spetsiaalne e-kaubanduse veebisait ja isegi mobiilimüük) ning vajavad seetõttu makselahendusi, mida saab sujuvalt integreerida nende olemasolevatesse töövoogudesse. Paljudel juhtudel haldavad selle tasandi ettevõtted juba müügipunktisüsteeme, veebipõhiseid tellimuste haldamise platvorme ja back-office-toiminguid, mis nõuavad usaldusväärset ja skaleeritavat lähenemisviisi.
...
Turvalisuse ja rollide haldamine on Professional-kasutajate jaoks veel üks oluline aspekt. Kuna igapäevased Bitcoini tehingud kuhjuvad, muutub haldustoimingutele juurdepääsu kontrollimine oluliseks riskide vähendamise meetmeks. Paljudes lahendustes saavad administraatorid määrata erineva tasemega õigusi (ehk piirata mõnele töötajale tehinguloo vaatamist ja arvete koostamist, kuid anda teistele volitused varude haldamiseks või kogu süsteemi hõlmavate seadete konfigureerimiseks...). Selline hierarhiline struktuur mitte ainult ei kaitse tundlikke andmeid, vaid ka lihtsustab toiminguid, sest see selgitab, millised töötajad vastutavad makseinfrastruktuuri iga segmendi eest.
...
Enterprise-profiil on Bitcoin-maksete rakendamise tipp, mis on kohandatud spetsiaalselt suurtele ettevõtetele, suurtele turuplatsidele ja väljakujunenud ettevõtetele, mis nõuavad täielikult kohandatud lahendusi. Erinevalt väiksema või keskmise tasandi rakendustest integreerivad Enterprise-tasandi operatsioonid Bitcoin-maksed laiaulatuslikku töövoogude ja süsteemide võrgustikku, alates kohapealsetest müügipunktide seadmetest kuni e-kaubanduse kaupluste, raamatupidamisplatvormide ja keerukate ERP-raamistikeni.

Sellises mastaabis ei ole üldeesmärk mitte lihtsalt Bitcoini vastuvõtmine, vaid see peab toimuma viisil, mis on põhjalikult **sidus organisatsiooni põhiprotsessidega**. Selline vastavusse viimine võib nõuda spetsiaalse tarkvara arendamist, olenemata sellest, kas lahendus on täielikult individuaalne või korraldatud SaaS-põhise infrastruktuuri kaudu, mida toetavad kolmandatest isikutest *valgustusteenuse pakkujad* (LSP). Sellised LSPd saavad hakkama suurte tehingumahtude ja keeruliste võrgukonfiguratsioonidega, mis ületavad tavapäraste valmis tööriistade võimekuse. Sellest tulenev arhitektuur hõlmab seega laia valikut tehnilisi ja ärilisi kaalutlusi, alates API-põhistest integratsioonidest kuni täiustatud riigikassa haldamise võimekusteni.
...
Raamatupidamise valdkonnas nõuavad kõrgsageduslikud tehingud **täielikult kohandatud eksporti** ja mõnikord reaalajas sünkroniseerimist ettevõtte finantstarkvaraga. Suured ettevõtted võivad toetuda ettevõtte ressursside planeerimise (ERP) lahendustele, nagu SAP või Oracle, mis omakorda peavad sujuvalt liidestuma Bitcoini makseandmetega. Selle hõlbustamiseks peavad valitud platvormi APId olema keerukad ja paindlikud, andes IT-meeskondadele vabaduse luua kohandatud aruandluse armatuurlauad, rakendada automatiseeritud kooskõlastusprotsesse ja luua igapäevaseid või isegi tunnipõhiseid finantsülevaateid.

Tüüpiline ettevõtte stsenaarium võib hõlmata suurt e-kaubanduse turuplatsi, mis võtab iga päev vastu tuhandeid tehinguid. Lisaks Bitcoini kui maksevõimaluse loetellu lisamisele saab see turuplats kohandada kõiki kasutajakogemuse aspekte, alates sellest, kuidas Bitcoini maksevoog kliendile suunatud veebisaidil kuvatakse, kuni selleni, kuidas tagastamist, tagasimaksete tegemist või vaidluste lahendamist hallatakse tagapool. Spetsiaalne arendusmeeskond koostöös finants- ja õigusosakondadega jälgiks pidevat hooldust, turvaparandusi ja nõuetele vastavuse uuendusi. Kui ettevõte otsustab säilitada osa oma Bitcoini tuludest, jälgiks sisemine kassasüsteem ettevõtte bitcoini varusid koos traditsiooniliste valuutareservidega.

Et tagada sujuv ja turvaline kasutuselevõtt ettevõtte tasandil, kaasab enamik organisatsioone spetsialiseerunud teenusepakkujaid või ettevõttesiseseid arendusmeeskondi, kellel on kogemusi Bitcoini ja Lightning Networki integreerimisega. Protsess algab tavaliselt põhjaliku vajaduste hindamisega (mis hõlmab tehnilist infrastruktuuri, nõuetele vastavuse nõudeid ja soovitud kliendi teekonda), millele järgneb suure mahuga läbilaskevõimet võimaldava arhitektuuri kavandamine. Sõltuvalt projekti ulatusest võite toetuda multidistsiplinaarsele meeskonnale, mis koosneb finantskontrolöridest, turvaanalüütikutest ja tarkvarainseneridest. Teise võimalusena saab üha suurem hulk spetsialiseerunud konsultatsioonifirmasid juhendada teid algsest kontseptsioonist kuni lõpliku kasutuselevõtuni, aidates teid näiteks SaaS-hostingulahenduste hindamisel, *valgustusteenuse pakkujate* konfigureerimisel ja eesmise liidese kohandamisel. Koostöös valdkondlike ekspertidega saavad ettevõtted vähendada suuremahulise maksete rakendamisega seotud riske ning saavutada lahenduse, mis ei ole mitte ainult töökindel ja nõuetele vastav, vaid ka piisavalt paindlik, et võimaldada tulevast kasvu.

## Bitcoini makselahendused: Valikud ja suundumused

<chapterId>59ff43a1-98e2-4a81-af3e-9654bdd60952</chapterId>

Iga lahenduskategooria puhul on alati kompromissid. Näiteks esialgses "prooviperioodis" on soovitatud rahakotid kavandatud võimalikult lihtsaks kasutajaliidese poolest, kuid need on hostitud (**custodial**). See tähendab, et vahendeid kontrollib rakenduse pakkuja. Bitcoini eetos julgustab aga liikuma kasutaja täieliku omandiõiguse suunas (**sõltumatu**). Sellisel juhul on soovitatav uuendada järgmisesse kategooriasse niipea, kui esimesed müügitehingud on tehtud - sisuliselt siis, kui on kinnitust leidnud, et teil on kliente, kes soovivad maksta Bitcoinis.

Üks Bitcoini peamisi eeliseid on võime liigutada vahendeid soovi korral, mis muudab **suurimat sorti teenusepakkujate** või lahenduse komponentide vahetamise väga lihtsaks. Lisaks arenevad kõik rakendused ja lahendused ise kiiresti. Võtame näiteks Bitcoinize'i, mis pakub nüüd füüsilist müügipunkti (POS) terminali, mis integreerub paljude turul olevate rakendustega - lahendus, mida veel mõni kuu tagasi ei olnud olemas.

### Otsid lahendust poe loomiseks ja nii traditsiooniliste kui ka Bitcoini maksete vastuvõtmiseks?

Kui alustate nullist - teil ei ole kauplust, tootehaldustarkvara ega müügipunktisüsteemi (POS) - on teil mitu võimalust:


- Allhanke korras:** Saate ostuvõimalustega veebisaidi loomise sisse osta ja seejärel lisada Bitcoini maksevõimalused koos traditsiooniliste kauplusesiseste lahendustega.
- Lihtsad lahendused:** Alternatiivina võite kasutada selliseid platvorme nagu Accessing.app, et seda ise teha. Peamised eelised on järgmised:
    - Kiire ja taskukohane veebipoe või füüsilise poe loomine.
    - Sobib hooajaliste ettevõtete, ürituste, restoranide või jaemüügipoodide jaoks.
    - Toodete määratlemine ja haldamine nii füüsilise kui ka online-müügi jaoks.
    - Fiatmaksete töötlemine (nt eurod, dollarid) teie enda Stripe'i konto kaudu.
    - Bitcoini maksete töötlemine oma SwissBitcoinPay konto kaudu.

### Kuidas edeneb välkmaksete kasutuselevõtt?

Kuigi Lightning Network pakub suuremat tõhusust ja madalamaid tasusid, on selle kasutuselevõtt alles algusjärgus. Selle asemel, et keskenduda praegustele piirangutele, tasub meenutada, kuidas ajaloolised infrastruktuuri ümberkujundamised on toimunud:


- Kui autod esmakordselt tekkisid, ei olnud piisavalt autosid, et õigustada teede ehitamist, ja ei olnud piisavalt teid, et õigustada autode omamist.
- Kui elektrienergia kasutusele võeti, ei olnud piisavalt kliente, et õigustada elektrivõrkude ehitamist, ja ei olnud piisavalt võrke, et kliente ligi meelitada.

Uued infrastruktuurid on edukad, sest nad on tõhusamad, ja varajased kasutuselevõtjad liituvad, sest nad saavad sellest käegakatsutavat kasu. Siin on tähelepanekud Lightning Networki kohta aastal 2024:


- Ülikiired tehingud:** Tehingud on sageli peaaegu kohesed (<500 ms) ja neil on äärmiselt väike veamäär.
- Võrgustiku professionaliseerumine:** Suuremad mängijad tagavad likviidsuse kogu võrgus, samal ajal kui üksikisikud on suures osas lõpetanud maksete suunamise ja juhivad nüüd enamasti "servasõlmi"
- Parem kasutajakogemus:** Mobiilirakendused üksikkasutajate jaoks on oluliselt paranenud. Sellised funktsioonid nagu liitmine, staatilised Bolt12-arved ja nullkinnitusmaksed (0-conf) on laialdaselt kättesaadavad, muutes suhtluse sujuvaks. Koostalitlusvõime probleemid (nt sunniviisiline sulgemine) ei ole enam suur probleem.
...
- Võrgumõõdikud:** Lightning'ile lukustatud kanalite ja bitcoinide koguarv on endiselt stabiilne: ligikaudu 20 000 sõlme, 5 200 BTC ja 60 000 kanalit. See kajastab siiski ainult osa võrgustikust ja näitab osalejate rotatsiooni, kus osaleb vähem eraisikuid ja rohkem professionaale.
- Lightning kui sild võrkude vahel:** Lightning-võrgustiku tõhusus ja kättesaadavus on juba praegu sillaks teiste omavahel ühendatud võrkudega (nt FediMint, Liquid jne).

**Pangakoti tagasitulek**
...
# Bitcoini raamatupidamine

<partId>d49d7595-a189-4e2b-bd60-c19e8e717aa2</partId>

## Raamatupidamise olulised põhimõtted Bitcoini raamatupidamises

<chapterId>84063061-ffdb-4b1f-b20b-588ffb146877</chapterId>

Järgnev sisu on mõeldud ainult hariduslikel eesmärkidel ja seda ei tohiks pidada finants- või raamatupidamisalaseks nõustamiseks. Ettevõtetel ja eraisikutel soovitatakse enne mis tahes meetmete võtmist tungivalt konsulteerida kvalifitseeritud raamatupidaja või juriidilise eksperdiga, kes on kursis krüptoraha regulatsioonidega oma konkreetses jurisdiktsioonis.

### Bitcoini raamatupidamise põhimõisted

**Kõik Bitcoini tehingud tuleb registreerida ja need võivad põhjustada maksustatava sündmuse**

Maailmas liigitatakse Bitcoini sageli mitte valuutaks, vaid digitaalseks varaks. See eristamine mõjutab oluliselt Bitcoini arvestust ettevõtetes, mõjutades maksukohustusi, finantsaruandlust ja nõuetele vastavust. Ettevõtted, kes aktsepteerivad Bitcoini makseviisina või kasutavad seda kassavahendina, peavad neid regulatiivseid nüansse mõistma.

Kõige olulisem tagajärg**, mida tuleb meeles pidada, on see, et enamikus jurisdiktsioonides tekitab Bitcoini teenimine, müümine, kauplemine või kasutamine ostude tegemiseks tavaliselt **maksustatava sündmuse** ja kasumi suhtes kohaldatakse kapitalitulu maksu.

Bitcoini arvestuse teine aspekt on kahte liiki kapitalikasumi eristamine:


- Latentsed kasumid/kahjumid:** Realiseerimata kasumid või kahjumid, mis põhinevad raamatupidamisperioodi lõpus hoitava Bitcoini väärtusel.
- Tegelik kasum/kahjum:** Realiseeritud kasum või kahjum, kui Bitcoin müüakse või vahetatakse eelarveaasta jooksul.

Need arvutused sõltuvad suuresti sellest, kas Bitcoini hoitakse pikaajalisteks investeeringuteks või lühiajaliseks operatiivseks kasutamiseks. Lisaks peavad ettevõtted viima oma raamatupidamistavad vastavusse kohalike maksustruktuuridega, kuna eeskirjad on riigiti väga erinevad.

Bitcoini omavate ettevõtete raamatupidamine on mõnevõrra tülikas, sest iga tehingut tuleb hoolikalt jälgida, et arvutada realiseeritud või realiseerimata kasumit või kahjumit. Iga müügi puhul, mille teete, võttes Bitcoini maksevahendina vastu, või iga kord, kui ostate või müüte Bitcoini, peate registreerima:


- konkreetne aeg
- müügihind (fiat-valuutas)
- bitcoini omahind (hind, millega Bitcoin algselt omandati).

See võimaldab teil hiljem kasumi või kahjumi määramiseks vahe välja arvutada.

**Näide:** Ettevõte ostab 1 BTC 30 000 dollari eest. Hiljem müüb ta 0,5 BTC 20 000 dollari eest. Kasumi või kahjumi arvutamiseks peab ettevõte:


- On salvestatud aeg, fiat omahind ja kogus Bitcoin omandatud
- On salvestatud aeg, fiat müügihind ja kogus Bitcoin müüdud
- Määrake müüdud Bitcoini maksumus : 0,5 BTC: 30 000 $ ÷ 2 = 15 000 $.
- Võrrelge müügihinda ja omahinda: 20 000 dollarit (müügihind) - 15 000 dollarit (omahind) = 5000 dollarit kasumit.
- Bitcoini positsioonide ajakohastamine uue omahinnaga

Seda protsessi tuleb korrata iga tehingu puhul ning Bitcoini hinna kõikumine muudab arvestuse pidamise veelgi tülikamaks.

**Kuidas see töötaks, kui Bitcoin oleks valuuta? **

Kui Bitcoini käsitletaks valuutana, haldaksid ettevõtted seda oma raamatupidamissüsteemis nagu mis tahes muud valuutat. Selle asemel, et jälgida iga tehingu kulubaasi ja realiseeritud/realiseerimata kasumit, kirjendataks Bitcoini osalused lihtsalt valuutakontole. Iga aruandeperioodi lõpus konverteeritaks kõigi valuutavarude, sealhulgas Bitcoini väärtus raamatupidamisvaluutaks (nt USA dollar või euro), kasutades kehtivat vahetuskurssi.

**Päevandatud näide, kui Bitcoin oleks tunnustatud valuutana:**


- Äriühingul on 1 BTC, kui Bitcoin on väärt 30 000 dollarit. Hiljem kasutab ettevõte maksmiseks 0,5 BTC-d, kui Bitcoini väärtus on 40 000 dollarit.
- Äriühing **ei** arvuta realiseeritud kasumit või kahjumit. Selle asemel kirjendatakse tehing järgmiselt:
    - Makse: 20 000 $ (0,5 BTC × 40 000 $).
    - Ülejäänud Bitcoini saldo: 0.5 BTC, mis on praegu väärt 20 000 dollarit (praeguse vahetuskursi järgi ajakohastatud).

**Key Advantage kui Bitcoin oli tunnustatud valuuta:**


- Ettevõte peab ainult perioodiliselt (nt kuu- või aastaaruannete jaoks) kohandama oma Bitcoini varude fiat-ekvivalenti, nagu ka eurode, jeenide või muude valuutade puhul.
- See kõrvaldab vajaduse tehingu tasandil kulupõhise jälgimise järele ja lihtsustab raamatupidamist, eriti ettevõtete puhul, kus on sagedased Bitcoini tehingud.

Selline lähenemisviis muudaks Bitcoini raamatupidamisarvestuse palju lihtsamaks, vähendaks halduskoormust ja ühtlustaks seda teiste valuutade käsitlemise viisiga, eeldusel, et Bitcoini tunnustatakse õiguslikult ja regulatiivselt täielikult. Me ei ole veel jõudnud selleni.

### Erinevused üksikisiku ja ettevõtte Bitcoini raamatupidamisarvestuse vahel

Bitcoini õiguslik ja raamatupidamislik käsitlus erineb märkimisväärselt eraisikute ja ettevõtete vahel. Eraisikute puhul võib Bitcoini tehingutest saadav tulu olla tulumaksuga maksustatav, sageli kõrgema maksumääraga. Seevastu ettevõtted võivad saada kasu potentsiaalselt madalamatest ettevõtte tulumaksumääradest, kuid peavad järgima rangemaid raamatupidamisstandardeid.

Ettevõtete jaoks võib Bitcoini liigitada erinevate kontode alla sõltuvalt selle kasutusotstarbest:


- Põhivara:** Bitcoini puhul, mida hoitakse pikaajaliselt strateegilise investeeringuna.
- Varud:** Tootmisprotsessides kasutatava Bitcoini puhul (harvaesinev kasutusjuhtum, näiteks on see nii professionaalsete kauplejate puhul).
- Sularaha või riigikassa kontod:** Bitcoini jaoks, mida hoitakse likviidsete varadena, peamiselt operatiivsete tehingute või lühiajalise riigikassa haldamise jaoks.

Klassifitseerimise valik sõltub ettevõtte tegevusest ja strateegiast, mis mõjutab finantsaruandlust ja maksukohustusi. Kontrollige alati kohalikke eeskirju, sest need liigitused võivad riigiti erineda.

### Õiguslik raamistik

Bitcoini õiguslik tunnustamine ja käsitlemine on jurisdiktsiooniti erinev. Mõned riigid, näiteks El Salvador, on tunnustanud Bitcoini seadusliku maksevahendina, mis lihtsustab selle kasutamist tehingutes, kuid muudab rahvusvahelise finantsaruandluse keerulisemaks. Teised riigid käsitlevad Bitcoini kui digitaalset vara, mille suhtes kohaldatakse konkreetseid maksu- ja raamatupidamiseeskirju.

Enamikus riikides liigitatakse Bitcoin digitaalseks varaks ja selle käsitlemist reguleerivad üldised raamatupidamisstandardid. Ettevõtted peavad Bitcoini tehingute üle arvestust pidama järgmiselt:


- Kapitalikasumi/kahjumi kajastamine:** Ettevõtjad peavad oma finantstulemustes kajastama realiseeritud kasumit või kahjumit.
- Latentse kasumi/kahjumi hindamine:** Realiseerimata kasum või kahjum tuleb sageli teatada, kuid see ei pruugi otseselt mõjutada maksustatavat tulu.
- Vastavus raamatupidamisstandarditele:** Ettevõtted peavad integreerima Bitcoini tehingud standardsetesse raamatupidamistavadesse, tagades läbipaistvuse ja täpsuse.

Bitcoini raamatupidamisarvestuse käsitlusviis on geograafiliselt erinev:


- Ameerika Ühendriigid:** IRS liigitab Bitcoini **varana, mis on sarnane aktsiate, võlakirjade või kinnisvara**. See klassifikatsioon tähendab, et mis tahes tehing, mis on seotud krüptoraha, näiteks selle teenimine, müümine, kauplemine või isegi selle kasutamine ostude tegemiseks, võib tekitada maksustatava sündmuse ja kasumi suhtes kohaldatakse kapitalitulu maksu.
- Euroopa Liit:** Liikmesriigid käsitlevad Bitcoini üldiselt pigem spekulatiivse varana kui funktsionaalse valuutana. Seetõttu maksustatakse kasum sageli kapitalitulu maksuga.
- Aasia:** Sellised riigid nagu Singapur ja Jaapan on võtnud vastu progressiivsed õigusraamistikud, mis käsitlevad Bitcoini tehinguid teatud kontekstis soodsalt. Kuid üldiselt käsitletakse bitcoinit **aineliste varadena** ja seda mõõdetakse õiglases väärtuses aruandekuupäeval, kusjuures muutused kajastatakse kasumiaruandes.

Oluline on mõista oma tegevusriigi eeskirju ja kohandada oma raamatupidamistavasid vastavalt sellele.

### Regulatiivse arengu väljakutsed

Krüptoraha innovatsiooni kiire tempo on sageli kiirem kui regulatiivsed raamistikud. Alates Bitcoini tunnustamisest digitaalseks varaks on ülemaailmsete eeskirjade ajakohastamine toimunud järk-järgult, kuid lüngad on endiselt olemas:


- Kohtupraktika puudumine:** Konkreetseid raamatupidamispraktikaid on selgitatud vähe, mistõttu on jäänud ruumi tõlgendamiseks.
- Käimasolevad arutelud:** Paljudes jurisdiktsioonides on endiselt lahendamata sellised küsimused nagu varjatud kahjumi maksustamine.
- Piiriülene keerukus:** Rahvusvaheliselt tegutsevad ettevõtted seisavad silmitsi erinevate riiklike raamatupidamisstandardite ühitamisega.

Vaatamata nendele väljakutsetele pakuvad paljude riikide proaktiivsed seisukohad ettevõtetele kindlat alust Bitcoini kaasamiseks oma tegevusse. Krüptoraha raamatupidamisarvestuse uute keerukuste lahendamiseks on oluline jätkata ajakohastamist ja rahvusvahelist ühtlustamist.

### Bitcoini liigitamine finantsaruannetes

Bitcoini liigitus finantsaruannetes on jurisdiktsiooniti erinev ja sõltub selle eesmärgipärasest kasutamisest ettevõttes. Laias laastus käsitletakse Bitcoini kui digitaalset vara, mis on sarnane varude, investeeringute või valuutaga, kuid millel on unikaalsed omadused, mis mõjutavad selle raamatupidamiskäsitlust.


- Digitaalne vara või immateriaalne vara**: Paljud jurisdiktsioonid, sealhulgas Prantsusmaa ja Euroopa Liit, liigitavad Bitcoini pigem digitaalseks või immateriaalseks varaks kui seaduslikuks maksevahendiks. See liigitus nõuab, et ettevõtted peavad Bitcoini raamatupidamisarvestust erinevalt fiatvaluutadest.
- Inventuur**: Kui ettevõtte põhitegevus hõlmab Bitcoiniga kauplemist, näiteks krüptovaluutavahetus või -maaklerid, liigitatakse Bitcoin varudeks. Sellisel juhul järgitakse hindamisel varude raamatupidamisstandardeid.
- Finantsinvesteering**: Ettevõtted, kes hoiavad Bitcoini pikaajalise varana, võivad liigitada selle finantsinvesteeringuks. Näiteks Ameerika Ühendriikides võiksid ettevõtted Bitcoini raamatupidamisarvestust pidada finantsaruandlusstandardite nõukogu (FASB) suuniste kohaselt, kajastades turuväärtuse languse korral väärtuse langust.

**Klassifikatsiooni tagajärjed :**


- Pikaajalised osalused nõuavad sageli väärtuse languse kontrollimist ja amortiseerimist.
- Aktiivne kauplemine või maksetega seotud tegevus nõuab realiseeritud ja realiseerimata kasumite ja kahjumite pidevat jälgimist.

### Hindamismeetodid

Hindamismeetodid on raamatupidamismeetodid, mida kasutatakse Bitcoini soetusmaksumuse määramiseks, mis on oluline tehingute käigus tekkiva kasumi või kahjumi täpseks arvutamiseks. Üldiselt on kõige parem **säilitada raamatupidamissüsteemis alati ajakohastatud väärtust jooksvate Bitcoini positsioonide kulude** kohta. See tagab läbipaistvuse, maksueeskirjade järgimise ja hoiab ära mahajäämuse, kui on vaja teha arvutusi.


- Esimesena sisse, esimesena välja (FIFO)**: See meetod, mis on levinud sellistes jurisdiktsioonides nagu Austraalia ja India, hindab Bitcoini varaseima soetusmaksumuse alusel. See võib muutuda üsna **kompleksseks**, sest see võib nõuda iga bitcoini osa eraldi jälgimist müügi korral.
- Kaalutud keskmine maksumus (WAC)**: Sageli eelistatakse suure mahuga tehingute puhul selle **ühtsuse** tõttu, nagu näiteks Ameerika Ühendriikides.

Väga soovitatav on pidada üksikasjalikku töövihikut Bitcoini kulude jälgimise kohta **sellest hetkest, kui ettevõte hakkab Bitcoini ostma või seda maksetena vastu võtma**, et tagada täpne ja organiseeritud arvestus. Ainuüksi see kaalutlus peaks olema peamine, kui valitakse tarkvaralahendust Bitcoini makse vastuvõtmiseks või Bitcoini ostmiseks.

### Jaekaubanduse ja e-kaubanduse tehingute raamatupidamisarvestus

Jaemüüjad peavad iga tehingu puhul registreerima Bitcoini ja fiat'i vahetuskursi. Näiteks paljudes riikides kasutavad ettevõtted käibemaksu arvutamiseks müügihetkel kehtivat vahetuskurssi.

Ettevõtted peavad tagama, et mis iganes **Maksevahendid**, mida nad kasutavad, võimaldavad:


- genereerida arve kohaliku fiat-summa (euro, dollar, nael), et käibemaksu või muude kohalike maksude, Bitcoin vääringustatud vaste, kuupäev ja kellaaeg, Bitcoin vahetuskurss ja vahetuse allikas jne
- eksportida kõik maksekviitungid vähemalt .csv-vormingus koos kõigi eespool nimetatud andmetega, nii et raamatupidaja saaks neid hõlpsasti töödelda
- ideaaljuhul on kirjendamist pidamine ajakohastatud väärtuse kulubaasi praeguse Bitcoin hoitakse riigikassas

### Väljakutsed


- Volatiilsus**: Bitcoini hind kõigub märkimisväärselt, mis tekitab raskusi osaluste hindamisel ja tulevaste finantstulemuste prognoosimisel.
- Regulatiivne kontroll**: Bitcoini piiratud staatus piirab selle kasutamist riigikassa varana.
- Regulatiivne ebakindlus** : Bitcoini arenev regulatiivne maastik jätab ettevõtted sageli ebaselgeks. Näiteks võivad muutused maksupoliitikas, näiteks Indias või Ameerika Ühendriikides, mõjutada raamatupidamispraktikaid üleöö.
- Valesti juhtimise riskid** : Ebakorrektne klassifitseerimine või Bitcoini tehingute kontrollimata jätmine võib põhjustada nõuetele vastavuse probleeme, karistusi või mainekahjustusi.
- Ümberkvalifitseerimise riskid**: Kui ettevõte hoiab märkimisväärse osa oma varadest Bitcoinis, võib ettevõte saada hinnalangusest tulenevaid võimalikke kahjusid. Sellel võivad olla tõsised tagajärjed, eriti kui sellised langused toimuvad siis, kui tuleb teha makseid tarnijatele, töötajatele või makse. Lisaks võidakse ettevõtte omanikku võtta vastutusele, mis võib kaasa tuua trahve või muid õiguslikke probleeme, näiteks süüdistusi ettevõtte vara väärkasutamises.

## Raamatupidamisvahendid ja tarkvara

<chapterId>e7b31be5-1176-4835-944e-3cba1b7040fa</chapterId>

Kui ettevõte otsustab integreerida Bitcoini oma raamatupidamises, lihtsustavad mitmesugused tööriistad ja spetsiaalne tarkvara andmete kogumist ja töötlemist. Tuntuimad lahendused on [CoinTracker](https://www.cointracker.io/), [Waltio](https://www.waltio.com/), [Cryptio](https://cryptio.co/), [Koinly](https://koinly.io/), [TokenTax](https://tokentax.co/) ja [ZenLedger](https://zenledger.io/). Need platvormid keskenduvad peamiselt neljale aspektile:


- automaatne andmete kogumine;
- nende andmete konverteerimine üldisema raamatupidamistarkvaraga (QuickBooks, Xero, ERP) ühilduvatesse vormingutesse;
- maksukohustuste arvutamine;
- tehingu liigitamine.
...
### Kasutusjuhtum 1: Bitcoini maksete konverteerimine eurodeks jaekaubanduses

**Stsenaarium**: Väike pagaritöökoda aktsepteerib makseviisina Bitcoini, kuid konverteerib kõik saadud Bitcoinid kohe eurodeks, et vältida krüptovaluuta volatiilsust.

**näide**:


- Bitcoini konverteerimiskurss**: 1 Bitcoin = 40 000 eurot.
- Tehing 1**: Klient ostab mitu küpsetist 20 euro eest.
    - Bitcoini ekvivalent: (20 / 40,000) = 0,0005 Bitcoin = 50,000 Satoshis.
    - Ümberarvestustasu: 1,5% (20 eurot × 0,015 eurot) = 0,30 eurot.
    - Saadud neto: 20 eurot - 0,30 eurot = 19,70 eurot.
- Tehing 2**: Klient ostab kohvi 5 euro eest.
    - Bitcoini ekvivalent: (5 / 40,000) = 0.000125 Bitcoin = 12,500 Satoshis.
    - Ümberarvestustasu: 1,5% (5 € × 0,015 €) = 0,075 €.
    - Saadud neto: 5 eurot - 0,075 eurot = 4,93 eurot.

**Tehingute kokkuvõte**:


- Müük kokku**: 25 eurot.
- Tasud kokku**: 0,375 eurot.
- Saadud netoeurod**: 24 625 eurot.

**Bilansimõju**:


- Registreerige müügi kogumaht (25 eurot) tuluna.
- Maha arvata konverteerimistasud (0,375 eurot) kuluna.
- Bilansis ei kajastu ühtegi Bitcoini osalust, kuna kõik summad konverteeriti kohe.

### Kasutusjuhtum 2: jaekauplus, mis säilitab 50% Bitcoini maksetest

**Stsenaarium**: Sama pagaritöökoda otsustab jätta 50% Bitcoin-maksetest varana alles, kuid konverteerib ülejäänud 50% eurodeks.

**näide**:


- Bitcoini konverteerimiskurss**: 1 Bitcoin = 40 000 eurot.
- Kliendi tehing**: Klient ostab küpsetisi 50 euro eest.
    - Bitcoini ekvivalent: (50 / 40,000) = 0.00125 Bitcoin = 125,000 Satoshis.
    - Ümberarvestus (50%): 25 € väärtuses Bitcoin = 0,000625 Bitcoin = 62,500 Satoshis.
        - Ümberarvestustasu: 1,5% (25 € × 0,015) = 0,375 €.
        - Saadud neto eurodes: 25 eurot - 0,375 eurot = 24,625 eurot.
    - Säilitatud Bitcoinis (50%): 62,500 Satoshis = 0,000625 Bitcoin.
...
- Tasud**: 0,375 eurot.
- Saadud netoeurod**: 24 625 eurot.
- Bitcoin säilitatud**: 62,500 Satoshis.

**Bilansimõju**:


- Müügi kogumaht (50 eurot) kirjendatakse tuluna.
- Maha arvata konverteerimistasud (0,375 eurot) kuluna.
- Säilinud Bitcoin (62,500 Satoshis) ilmub bilansis digitaalse varana.
- Realiseerimata kasum: kui bitcoini hindamine eelarveaasta lõpus on kõrgem või madalam, tekib realiseerimata kasum või kahjum, mis avalikustatakse finantsmärkustes, kuid ei realiseeru tuluna

### Kasutusjuhtum 3: Professionaalne teenus, mis säilitab Bitcoini pikaajalise investeeringu jaoks

**Stsenaarium**: Vabakutseline graafiline disainer aktsepteerib maksetena Bitcoini ja säilitab kõik saadud Bitcoinid pikaajalise investeeringuna.

**näide**:


- Bitcoini konverteerimiskurss maksmisel**: 1 Bitcoin = 30 000 eurot.
- Kliendi tehing**: Klient maksab teenuste eest 3000 euro väärtuses.
    - Bitcoini ekvivalent: (3,000 / 30,000) = 0,1 Bitcoin = 10,000,000 Satoshis.
- Aasta lõpu hindamine**:
    - Bitcoini ümberarvestuskurss aasta lõpus: 1 Bitcoin = 35 000 eurot.
    - Bitcoini osaluse hindamine: 0.1 Bitcoin × 35 000 eurot = 3500 eurot.
    - Realiseerimata kasum: 3500 eurot - 3000 eurot = 500 eurot.

**Kokkuvõte**:


- Kokku kajastatud tulu**: 3000 eurot.
- Bitcoin Holding**: 0.1 Bitcoin väärtusega 3500 eurot bilansis.
- Realiseerimata kasum**: 500 eurot, mis on avaldatud finantsmärkustes, kuid ei ole realiseeritud tuluna.

**Bilansimõju**:


- Rekordtulu (3000 eurot) teenuse osutamise ajal.
- Bitcoin säilitas (0,1) väärtusega 3500 eurot bilansis.
- Realiseerimata kasumit jälgitakse, kuid see ei kajastu kasumiaruannetes.

### Kasutusjuhtum 4: Ettevõtte omanik müüb 50% Bitcoinist pärast hinnatõusu

**Stsenaarium**: Ettevõtja teeb aasta jooksul kolm Bitcoini ostu, hoiab Bitcoini varana ja müüb 50% pärast märkimisväärset hinnatõusu.

**näide**:


- Bitcoini ostud klientidelt**:
    - Ostu 1: 2000 eurot hinnaga 20 000 €/BTC = 0,1 Bitcoin = 10 000 000 Satoshis.
    - Ostu 2: 3000 € 25 000 €/BTC = 0,12 Bitcoin = 12 000 000 Satoshis.
    - Ostu 3: 5000 € 30 000 €/BTC = 0,1667 Bitcoin = 16 670 000 Satoshis.
    - Haldatud bitcoinid kokku**: 0.3867 Bitcoin = 38,670,000 Satoshis.
- Aasta lõpu hindamine**:
    - Bitcoini hind aasta lõpus: 40,000 €/BTC.
    - Koguväärtus: 0,3867 Bitcoin × 40 000 eurot = 15 468 eurot.
    - Realiseerimata kasum: 15 468 eurot - 10 000 eurot (kogumaksumus) = 5 468 eurot.
- Müük 50% Bitcoinist**:
    - Bitcoin Müüdud: 0.19335 Bitcoin.
    - Müügitulu: 0.734 eurot.
    - Kulubaas (kaalutud keskmine):
        - Kogumaksumus: 2000 eurot + 3000 eurot + 5000 eurot = 10 000 eurot.
        - Kaalutud keskmine hind: €10,000 / 0.3867 Bitcoin = €25,850/BTC.
        - Müüdud Bitcoini maksumus: 0,19335 Bitcoin × 25,850 € = 4,999 €.
    - Realiseeritud kasum: 7 734 eurot - 4 999 eurot = 2 735 eurot.

**Kokkuvõte**:


- Bitcoini jääk**: 0.(40 000 €/BTC).
- Realiseeritud kasum**: 2 735 eurot, mis on kajastatud kasumiaruandes.
- Realiseerimata kasum**: 5 468 eurot, mis on avaldatud finantsmärkustes (sh ülejäänud Bitcoini realiseerimata väärtus).

**Bilansimõju**:


- Kirjendage müügitulu (7 734 eurot) tuluna.
- Müüdud Bitcoini maksumus (4 999 eurot) lahutatakse realiseeritud kasumi arvutamiseks.
