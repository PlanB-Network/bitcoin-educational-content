...
Việc cài đặt Pears trên hệ thống Debian khá đơn giản, nhưng cần một số điều kiện tiên quyết mà chúng tôi sẽ giải thích chi tiết trong phần này.
...
Trước khi cài đặt, vui lòng đảm bảo *Xcode Command Line Tools* đã có trên hệ thống của bạn. Gói này cung cấp các công cụ biên dịch cần thiết cho _Node.js_ và các phần phụ thuộc của nó.
