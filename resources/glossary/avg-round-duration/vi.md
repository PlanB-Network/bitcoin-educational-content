...
definition: Một chỉ số ước tính thời gian trung bình cần thiết để một nhóm khai thác tìm thấy một khối, dựa trên sức mạnh tính toán và độ khó mạng của nó.
---
