...
Nếu tất cả các thuật ngữ này có vẻ hơi quá kỹ thuật, tôi khuyên bạn nên [tham khảo bảng thuật ngữ của chúng tôi](https://planb.network/resources/glossary), trong đó có định nghĩa về tất cả các thuật ngữ kỹ thuật liên quan đến Bitcoin và hệ sinh thái của nó.
