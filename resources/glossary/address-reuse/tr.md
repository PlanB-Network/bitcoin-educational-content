...
> "*Ek bir güvenlik duvarı olarak, her işlem için yeni bir anahtar çifti kullanılarak işlemlerin ortak bir sahiple ilişkilendirilmesi engellenebilir.*" - Nakamoto, S. (2008). "Bitcoin: Eşler Arası Elektronik Nakit Sistemi". Https://Bitcoin.org/Bitcoin.pdf adresinden alınmıştır.
...
> ► *İngilizcede "Address Reuse" olarak adlandırılmaktadır.*