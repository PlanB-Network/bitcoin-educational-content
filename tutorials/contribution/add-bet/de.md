...
- Gehen Sie zu [dem GitHub-Repository von PlanB, das den Daten gewidmet ist](https://github.com/Plan ₿ Academy/bitcoin-educational-content/tree/dev/resources/bet) im Abschnitt `resources/bet/`:
