...
闪电钱包与所有移动钱包一样，都被视为 "热" 钱包，因为它们都与互联网相连。因此，它们主要用于管理日常消费的小额资金。如果金额较大，最好使用硬件钱包等更安全的存储解决方案。
...
- [苹果版](https://apps.apple.com/app/lipa-bitcoin-lightning/id1602180066)
...
- **通过电话号码发送比特币**：无需复杂的地址--只需选择联系人，输入金额，即可直接向其电话号码发送比特币。
...
要备份您的钱包，请前往 “Settings” 选项卡并选择 “Recovery phrase”。Lipa 使用助记词，务必将其仔细记录在纸质或金属等物理介质上。如果您的手机丢失或被盗，此短语是找回资金的唯一途径。为了验证您的备份，应用程序会要求您确认短语中的 3 个随机单词。

![Backup](assets/fr/04.webp)

关于如何正确备份和管理恢复短语的更多信息，我强烈建议您参考以下教程，尤其如果您是新手：

https://planb.academy/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270

## 接收比特币

为了接收比特币，您有两个选项。要访问这些选项，请返回主屏幕并下拉屏幕。然后您可以选择 ：

- 选择 "Transfer BTC"，通过链上交易接收比特币。然后只需用另一个钱包扫描二维码，即可完成交易。
- 选择 "Request" 以通过闪电网络接收，并输入您希望接收的金额。
...
如果您想要发送比特币，请进入主屏幕，下拉屏幕并选择 "Pay"。然后只需：
...
您可以在 Lipa 应用程序中购买比特币，手续费为 1.5%。如果您想购买，请进入主屏幕，向下拉显示选单。然后选择 "Buy BTC"。三个介绍性屏幕将引导您完成购买流程。
...
Lipa 是入门闪电网络的绝佳选择，尤其适合寻求简单日常支付解决方案的用户。其易用性和简洁的界面使其成为初学者的理想钱包，同时提供日常闪电网络使用所需的基本功能。

## 资源

- [Lipa 官方网站](https://lipa.swiss/)
- [Lipa 支持](https://getlipa.atlassian.net/servicedesk/customer/portal/1)
