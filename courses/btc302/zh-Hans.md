...
####
此外，这些活动还可以促进比特币相关项目的宣布、设备或书籍的借用、纪录片的预映；但也包括举办关于特定主题的会议或工作坊。我们将在本课程的第6/8部分，题为“[项目和倡议的例子](LINK)”中更详细地讨论这一点。
####
...
为了为您的社区创建各种视觉效果，**可以使用[Canva](https://www.canva.com/)**。
...
| 网络/平台         | Logo      | Banner     | Poster / Image |
| ------------------ | --------- | ---------- | -------------- |
...
- [ ] *创建一个带有伦敦桥和大本钟背景的比特币标志。未来主义* - [链接](https://copilot.microsoft.com/images/create/un-logo-bitcoin-futuriste-avec-en-arric3a8re-plan-le-/1-6612ba1758df4384bc33c4bca00ab45b?FORM=SYDBIC)

![image](assets/fr/chapter5/img14.webp)

如果副驾驶提供的四个提案对你的口味来说不够真实，可以在对话中添加：
- [ ] *让第四个更加真实* - [链接](https://copilot.microsoft.com/images/create/un-logo-bitcoin-futuriste-avec-en-arric3a8re-plan-le-/1-6612ba64b72d4cea9830ab7eb844f785?FORM=SYDBIC)
...
- [ ] *为“伦敦比特币聚会”创建一个具有英式和简洁风格的标志* - [链接](https://copilot.microsoft.com/images/create/logo-for-27londres-bitcoin-meetup27-with-a-british-a/1-6612bb9451924859a6c34b350b3a6ebc?FORM=SYDBIC)
...
根据你的愿望修改这些，例如，类似于阿比让比特币聚会的超级群组。
...
最后，虽然您的用户名“@Bitcoin[CITY]”是唯一的，现在属于您，但预先创建账户“@Bitcoin_[CITY]”、“@[CITY]Bitcoin”或“@[CITY]_Bitcoin”可能是明智的，以**确保没有人试图复制您的身份**。预先防范总是更好的！
...
4) 这个场地是否配备了**视频投影仪和一个安静的空间供你们展示？**
5) 最后，在酒吧（甚至餐厅）的情况下，**菜单是否能让每个人都能吃喝？**
对于这些点，可以补充三个重要的备注：
...
####
当然，如果你想要进行街头张贴，就必须**了解你所在国家的法律**。例如，在法国，只允许**在公共广告牌上张贴海报**。在其他地方，这是被禁止的，可能会导致罚款。
显而易见：**眼不见为净**。所以，在这种情况下，也许要小心不要在这些海报上包含任何可能被追溯到你的元素（聚会的名称、@ Twitter 等）。

如果你计划**使用个人打印机打印这类海报，请注意这通常会导致纸张严重脏污，而且随着时间的推移也会迅速恶化**。在这种意义上，**最好的做法当然是联系专业打印商，使用专为户外使用而设计的特殊自粘纸张生产这些海报**。这样可以确保质量。

![image](assets/fr/chapter29/49.webp)
####
然而，不可否认的是，**这项举措的成本相当高：每张海报超过0.40欧元（即100张海报40欧元）**；而且那还是在你有好联系的情况下。在线上，价格确实可能翻一番到五倍。

如前所述，法国比特币爱好者[@Mill3sim3](https://twitter.com/Mill3sim3)拥有适当的专业设备。因此，你可以在 Twitter 上联系他获取信息。
...
然而，如果你希望订购**超过50张NFC卡，你可以通过其官方网站（或在[Twitter](https://twitter.com/SwissBitcoinPay)上）联系该公司，并提出你为卡片正面设计的自定义设计**。然而，背面则是标准化的。
...
因此，**协会的每位新成员在欢迎包中都会收到一张定制的NFC卡**。

这个想法显然可以根据你的愿望进行采纳和改进。
...
在您的社区成员中，有些人可能对**创建多媒体内容**感兴趣。例如，这可能表现为制作教程视频（使用软件钱包，购买非KYC BTC的教程等）。
...
原则上，这项倡议也可以用来**奖励您社区中最活跃的成员，例如通过组织年度抽奖**，在此期间获得的徽章将对应一张抽奖券。一位全年参加了12次聚会的成员，那么他将拥有12张这种年度抽奖的票。

此外，从完全不同的角度来看，**在每个活动中要求参与者在徽章上写下他们的名字或昵称**也是可能的。此外，还可以添加他们参加的原因。
这种策略虽然有点正式，但可以使一些成员**更容易找到共同点和话题**，同时也使**新来者更容易识别组织者**和可能的协会成员。
...
另一个完全不同的话题是对**您的比特币社区成员去世**的立场。
确实，不幸的一天可能会到来，当时您的一位前成员的家人联系您，宣布这个人已经去世。他们将解释说**这个人留下了指示**，其中之一就是**与您的社区/聚会/协会取得联系**。
这个人可能会解释说他们**需要帮助来回收资金**，因为他们是这位前成员遗产的受益人。
...
此外，提前思考要遵循的程序也确保无论是聚会的成员还是仅仅是客人，都不能以任何方式利用这种情况来谋取自己的利益（和/或窃取资金）。

为了实现这个目标，**提议成立一个“工作组”来讨论在成员去世和家属请求帮助时采取的程序**可能会很有趣。比特币里尔协会实际上正在研究这一点，并将在几个月内以开源方式在[这里](https://docs.google.com/document/d/1TDfLZjuictC5s3PEM2Z7WmkxIDSJ8Q1E4xevm52pVgU/edit?usp=sharing)分享其最终的工作文件。

## 在学校和大学举办会议
<chapterId>65efdb44-e3d4-567c-aedf-972765753d73</chapterId>
之前描述的项目列表显然不是详尽无遗的。一般来说，这些项目是社区/聚会内部的项目，一旦你的社区发展起来，这些项目就可以相当容易地建立起来。因此，现在是时候讨论入职培训的情况了。

首先，你无疑已经意识到，**同时向尽可能多的人介绍比特币的最佳方式之一显然是举办一个会议**（或工作坊）。这可以在**高等学校和大学内**进行；从而引导年轻人（可能还有不那么年轻的人）发现或加深他们对比特币的理解。

除了**知道如何进行公开演讲**的重要性外，在几十甚至数百人面前主持一个会议还需要**知道如何管理压力、措辞和时间**。它还需要**准备一个高质量的演讲或工作坊，这个演讲或工作坊要有来源并且符合你将面对的听众的技能水平**。
此外，**拥有一个开放的心态，必要时准备简化概念**，在这种练习中是至关重要的；特别是在问答阶段和小组讨论的情况下。这并不意味着“放弃你的原则”；但仅仅是接受其他人可能有不同的观点，即使这意味着稍后回应或让步，以便对话能够进展。无论如何，如果**你的演讲和回答基于相关且有来源的论据**，听众不会被愚弄。
所以，如果你觉得自己能够胜任：那就去做吧！我们的世界如此需要对比特币是什么的教育...
然而，不用说，要完成这项任务，**你将需要大量的动力、大量的工作；但也需要正确的联系人**。

![image](assets/fr/chapter33/53bis.webp)
####
的确，**在学校和/或大学组织一个会议或工作坊并非易事**。
首先，需要**获得一个联系人**。这可以通过**一个熟人、通过BDE（"Bureaux Des Étudiants" 或学生办公室）；甚至是学生会**来实现，这些学生会通常每年都会组织一系列的会议和聚会。你的**前工程学院和/或大学教授**也可以作为中介。
在高中毕业后的学校的情况下，也可以**直接联系负责培训项目的人**，目的是解释你的提议。这可能会导致一次初步会议，而在最理想的情况下，几周后，会在学生面前就比特币是什么以及它是如何工作的进行演讲。
####
不幸的是，在我们当前的世界中，比特币仍然经常被媒体和政治家故意妖魔化；导致许多新手认为它应该被禁止在课堂和讲堂中使用。**因此，你很可能会面临许多拒绝**；特别是在学术领域，比特币的工作证明和能源消耗有时似乎是禁忌。
然而，这并不妨碍你尝试，特别是与BDE和学生会。**有一点运气，即使第一次拒绝是坚定的，也不是不可能在下一个牛市期间，你会再次被联系到你社区的电子邮件地址，前去面对近280名学生举行一个会议！**
...
####
因此，在你的城市发展比特币生态系统可能涉及**引导商家加入**。要做到这一点，最简单的方式是**分步骤进行**：

1) 一旦你走进一家商店，**总是询问是否可以用比特币支付**。这通常会导致拒绝和疑惑的眼神，但这个简单的问题将逐渐引导商家看到比特币可以被“普通人”使用，并且作为支付方式在人群中获得兴趣。你甚至可以**在几天内轮换两三个人在同一家商店询问是否可以用比特币支付**。在某个时刻，这将引起商家的注意；

2) 一旦他们变得感兴趣或询问比特币是什么，你可以**简洁并用外行的术语向他们解释**。例如，比特币是一种货币，不受银行控制，没有可信赖的中介，它是不可审查的，不受通货膨胀影响，而且费用低于传统银行系统。然后你可以**给他们一份传单**，例如，“使用比特币的21个理由”和/或“在你的商店接受比特币的10个理由”，然后**给他们你的联系方式或你的聚会联系方式**。这样，当他们对演示感兴趣时，他们可以联系你。

3) 一旦这个人决定接受比特币，**安排与他们会面以展示你提议的软件解决方案似乎是合适的**。**[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** 在这方面呈现为一个极佳的解决方案，因为：
...
4) **当这个商家接受比特币时**，那么对你来说将有可能：
- **定期访问**进行购买；
- 借此机会**询问一切是否顺利**，甚至再次提供你的联系方式，以备不时之需；
- **再次提议参加你的聚会和活动**；
...
2) **一步一个脚印，不要气馁**；3) 最重要的是，**向你的成员和周围的其他社区寻求帮助和支持**。

请记住，**每个社区和聚会都经历过你现在所经历的同样阶段**。所以，不要犹豫，**向他们寻求建议**。
...
在本课程的第八部分和最后一部分中，我们将花时间详细讨论在发展你的社区和聚会时需要考虑的一些点。
####
其中第一个（最容易预见的）显然是**加入你社区的人数增加**。这将以两种方式影响它：

1) **你的沟通渠道（Telegram, Signal, Matrix等...）将会变得拥挤，可能使得对话难以跟进**。然后需要考虑两点。
一方面，如果你们500人在同一个讨论频道交换各种话题，你的大多数成员将逐渐停止跟进对话；其中一个原因是需要阅读的消息数量和相关通知的泛滥。从这个意义上说，可能需要**重新思考你的沟通渠道；比如Telegram超级群组，或者甚至是Discord服务器**，这两者都允许按主题分组对话。
另一方面，交流频道中的人数增多也意味着更多的机器人、更多的诈骗，也意味着**需要进行更多的管理**。因此，你需要做好准备，例如起草一套规则，当你管理消息时可以依赖这套规则。根据经验，这避免了大部分冲突；特别是当规则可以在你的沟通渠道上阅读时。从这个意义上说，比特币里尔协会几年前写了一套**[开源的规则](https://bitcoinlille.fr/reglement/)，适用于其Telegram群组和Discord服务器**，基于简单和普遍原则。其设计也是[可用的](https://www.canva.com/design/DAGHI692AD4/rjT4sqEnhajc5FiPA6GFZQ/edit?utm_content=DAGHI692AD4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)。

![image](assets/fr/chapter36/59-frbis.webp)

2) **你的聚会和活动将显著增加，有大量新面孔想要相互交流**。
...
没有这些权利和标识符，任何人都将无法**轻松接管并继续你花费了大量时间发展的倡议**。从头开始创建“分叉”的网络和频道确实需要很多时间和精力...

**因此，预见你可能会去秘鲁的情况**。如果你在法国没有可信赖的聚会成员，你可以随时联系 Telegram 上的 @ProfEduStream 或 @gabtribe，以便顺利过渡。
####
这引出了社区发展的**一个关键点：去中心化**。
的确，如果你是唯一参与其中的人，拥有所有控制权，如果你消失了会发生什么？答案很简单：你的社区也会消失。

因此，避免这种情况的最佳方式是**去中心化任务并分享权利、角色和访问权限**。因此，如果你的社区或聚会的组织团队成员之一在未来的反乌托邦中因拥有非KYC比特币（或简单地说：因为他们刚刚有了孩子或换了工作而没有时间投入其中）而被逮捕，其他人可以毫无困难地继续他们的任务。
####
...
####
正如你从这门课程中所理解的，**创建一个社区和比特币聚会**需要组织和动力。当然，这取决于你的愿望和你能够投入的时间，你将在项目中走得更远或更近。
尽管如此，目标仍然相同：**在你的城市点燃比特币的火花**。
####
为了总结这门课程的许多章节和小节，这里是**创建你的比特币社区的“行动计划”摘要**：
1) 提前决定你为什么想创建一个比特币社区，目的是什么，地点在哪里等；
2) 通过联系和/或寻求建议，接近你周围已经建立的社区；
3) 为你的社区及其地点创建独特的身份（标志、海报、横幅、传单等）；
...
6) 通过调查提议一种聚会类型的集会；
7) 思考你想从这个实体活动中实现的目标；
8) 寻找一个位置好、环境友好的地方，满足你的目标，并预订一个桌子；
9) 在活动前一周，在你的网络和通讯渠道上宣传它。在关键日期前两到三天重复这一过程；
10) 如果可行，将你的活动列在合适的平台和网站上；
11) 在聚会当天，让事情顺其自然发生，即使有必要也要向他人靠拢，甚至可能需要适时引导对话；

后续跟进：

12) 寻求留住并吸引尽可能多的成员和参与者，以便他们返回；
13) 提出项目想法和简单的倡议，并开始实施对你个人重要的那些。如果有人想要设置不同的东西，不要犹豫，根据任务和期望的目标伸出援手；
最后：

14) 通过考虑更大的聚会场所、通讯渠道的规则、网站等来预见未来；
15) 开始在你城市的商家中推广比特币的接受，例如询问他们是否接受比特币；
16) 在信任的个体之间分散任务，以及你的渠道和网络的权利；
17) 推广你的社区，以便越来越多的人加入，并吸引感兴趣的个体；
18) 进一步推进你喜欢并关心的项目。

以稍微不那么详细的方式，在一段21分钟的视频中，看起来是这样的：
![比特币社区教程](https://www.youtube.com/watch?v=EHLAmHHuZd8)
####
无论如何，**记住你并不孤单，现有的社区在这里帮助你**。
...
####
**在创建社区的这长长的画廊中，你需要展现动力、策略、自我牺牲和时间**。这有时是一项不被感激的任务；在这项努力中，最好是一点一点地取得进展，以免伤害自己。
**所以，思考一下你自己，你的极限**。尽管比特币可能日夜激励着你，**但不要尝试独自做所有事情；否则，你会筋疲力尽**。

相反，**向那些已经走过这条相同画廊、已经探索过相同问题并构建了相同工具的比特币用户寻求帮助**。这将为你节省大量时间。

**还建议跟随你在这次冒险中的人帮助你，即使这意味着委派一些任务**，而这些任务可能需要更长的时间。从长远来看，你的社区将显得更加团结和成熟。

![image](assets/fr/chapter39/63.webp)
独自一人，可以迅速探索比特币兔子洞的众多画廊之一，直到到达尽头。但还有返回的旅程要进行。然后还有所有其他方向要探索。而**通过创建和/或加入一个比特币爱好者社区，定期与他们分享和交流，你将同时探索比特币兔子洞的所有方向**。

那时，你会发现，比起独自一人，你能够更快地说：“我已经理解了比特币”。