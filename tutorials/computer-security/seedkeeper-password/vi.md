...
Trong hướng dẫn này, chúng tôi sẽ chỉ đề cập đến việc sử dụng SeedKeeper cho mật khẩu truyền thống, theo cách của một trình quản lý mật khẩu. Nếu bạn muốn sử dụng SeedKeeper để lưu các cụm từ Bitcoin Wallet Mnemonic, vui lòng xem hướng dẫn khác này:
...
Chọn "Bí mật generate*". Tùy chọn "*Nhập bí mật*" cho phép bạn lưu một bí mật hiện có (ví dụ: mật khẩu bạn đã tạo trước đó).
...
Gán "*Nhãn*" cho bí mật này để có thể dễ dàng nhận dạng nếu bạn lưu trữ nhiều thông tin trong Seedkeeper. Bạn cũng có thể thêm tên người dùng được liên kết với mật khẩu và URL của trang web.
...
Chọn độ dài và thông số của mật khẩu, sau đó nhấp vào "*generate*", rồi "*Nhập*".
...
Thao tác này sẽ đưa bạn đến danh sách tất cả các bí mật đã đăng ký của bạn. Trong ví dụ này, tôi muốn hiển thị mật khẩu cho tài khoản Plan ₿ Network của mình, vì vậy tôi nhấp vào đó.
...
Thao tác này sẽ đưa bạn đến trang chủ, với danh sách các bí mật của bạn. Nhấp vào ba dấu chấm nhỏ ở góc trên bên phải của Interface.
...
Vậy là xong! Giờ bạn đã biết cách sử dụng Seedkeeper để lưu trữ mật khẩu. Trong bài hướng dẫn sau, chúng ta sẽ tìm hiểu cách sử dụng Seedkeeper để sao lưu danh mục đầu tư Bitcoin. Tôi cũng mời bạn khám phá cách sử dụng kết hợp với SeedSigner:
