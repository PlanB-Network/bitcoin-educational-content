...
Pomimo wdrożenia SegWit w sierpniu 2017 r., projekt 2X mający na celu podwojenie rozmiaru nie zdołał osiągnąć konsensusu, zwłaszcza z powodu kampanii opozycyjnej "NO2X", co doprowadziło do jego anulowania na początku listopada. Epizod ten był postrzegany przez wielu użytkowników i deweloperów jako atak na Bitcoin, w kontekście wojny o rozmiar bloków.


> segWit2x jest czasami nazywany również "B2X" lub "S2X". Początkowo jego nazwa brzmiała "SegWit2Mb"