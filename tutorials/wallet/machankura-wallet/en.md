---
name: Machankura
description: Use Bitcoin on any phone, without Internet.
---
...
To be informed of new countries where the service will be available, please consult their [website](https://8333.mobi) regularly.
...
Example: a +2371234567890 number will become `+2371234567890@8333.mobi`

However, you can choose a custom user name to replace the number (e.g. `Satoshi@8333.mobi`).
...
You can watch the [video sending demo](https://www.linkedin.com/posts/activity-7351143606121820162-Ua3T?utm_source=share&utm_medium=member_android&rcm=ACoAAAeTubUB8GuaMia5yNBlBg4WhZpGOeVLY0w) of bitcoins by PIO TARAS (Lead Machankura Afrique Francophone) via Machankura on a basic phone.
