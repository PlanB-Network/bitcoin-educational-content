...
- En el menú `Elementos del sitio web`, encontrarás una lista de todas los idiomas en curso:
...
- Haz clic en el signo `+` de la parte superior izquierda de la ventana:
...
- Haz clic en `Iniciar nueva traducción`:

![language](assets/06.webp)

- Llegarás entonces a la página de gestión de la traducción de tu idioma:

![language](assets/07.webp)

- Para empezar a traducir los elementos estáticos del sitio web, haz clic en el botón `Translate`:
