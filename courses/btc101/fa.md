...
هیچ دانش قبلی برای شروع این دوره مورد نیاز نیست. BTC 101 به گونه‌ای طراحی شده است که برای همه قابل دسترسی باشد، صرف نظر از سطح تجربه شما.
...
آماده‌اید که به دنیای جذاب بیت‌کوین وارد شوید و تمام جزئیات آن را درک کنید؟ بیایید برویم!
...
قبل از اینکه عبارت "بیت کوین" مترادف با ارز دیجیتال و تحول مالی شود، زمینه ایجاد آن توسط مجموعه ای از ایده ها، نوآوری ها و جنبش های اجتماعی فراهم شد. در میان اینها، جنبش [سایفرپانک](https://planb.academy/resources/glossary/cypherpunks) به عنوان یک عنصر کلیدی در پیشینه تاریخ بیت کوین برجسته است.

### سایفرپانک‌ها: رویادیدگان دنیای دیجیتال

![image](assets/fa/003.webp)

در قلب تکامل فناوری دهه‌های 1980 و 1990، گروهی از افراد شروع به پرسش‌های عمیق درباره نقش حریم شخصی و آزادی در عصر دیجیتال کردند. این افراد، که بعدها به عنوان "سایفرپانک‌ها" شناخته می‌شدند، با اعتقاد قاطعی فکر می‌کردند که [رمزنگاری](https://planb.academy/resources/glossary/cryptography) می‌تواند به عنوان ابزاری برای حفاظت از حقوق فردی در برابر دخالت دولت‌ها و شرکت‌های بزرگ عمل کند.
...
قبل از ظهور بیت کوین، چندین تلاش برای ایجاد یک ارز دیجیتال انجام شده بود. برای مثال، دیوید چام مفهوم "پول الکترونیکی ناشناس" را با پروژه "[دیجی کش](https://planb.academy/resources/glossary/ecash-david-chaum)" خود در دهه 1980 معرفی کرد. متاسفانه، به دلیل محدودیت های مختلف، دیجی کش هرگز رونق نیافت.

یک پیشگام مهم دیگر  "[B-money](https://planb.academy/resources/glossary/bmoney)" وی دای است. با اینکه هرگز اجرا نشد، اما ایده ای از یک ارز دیجیتال ناشناس را ارائه داد که تشخیص تقلب توسط یک جامعه از ارزیابان انجام می شد نه توسط یک مرجع مرکزی.

تصویر زیر به طور واضح توسعه حرکت را از طریق نوآوری های فناورانه زیادی که داشته است، نشان می دهد.

![image](assets/fa/005.webp)

این بود که در این محیط بارور، [ساتوشی ناکاموتو](https://planb.academy/resources/glossary/nakamoto-satoshi) (Satoshi Nakamoto) ی مرموز [برگه ی سفید](https://planb.academy/resources/glossary/white-paper) بیت کوین را در سال 2008 منتشر کرد. در این سند، او چندین ایده از جنبش سایفرپانک، مانند [اثبات کار](https://planb.academy/resources/glossary/proof-of-work) و [برچسب زمانی](https://planb.academy/resources/glossary/timestamp) رمزنگاری شده، را ترکیب کرد تا یک ارز دیجیتال [غیرمتمرکز](https://planb.academy/resources/glossary/distributed) و مقاوم در برابر سانسور ایجاد کند.
...
بسیار دشوار است که کارکرد آن در جهان ما به صورت مصنوعی تقلید شود. در واقع، هیچ فرد یا گروهی نمی‌تواند پول ایجاد کند، زیرا این یک پدیده طبیعی است که باید از بازار و [توافق داوطلبانه](https://planb.academy/resources/glossary/consensus) بیرون بیاید. در این معنا، قیمت‌ها به عنوان سیگنال‌ها و اطلاعاتی عمل می‌کنند که جامعه را در تخصیص منابع هدایت می‌کنند.
...
در مقابل، ارزهای امانی دولتی ([فیات](https://planb.academy/resources/glossary/fiat)) به راحتی قابل استفاده هستند، اما به طور مداوم توسط نهادهایی که آنها را کنترل می کنند (پادشاهان، بانک های مرکزی، امپراتوران، دیکتاتورها) ارزش آنها کاهش می یابد.
...
- **[قابلیت تبادل](https://planb.academy/resources/glossary/fungibility)**، به این معنی که بدون از دست دادن ارزش با یک واحد دیگر از همان نوع قابل تعویض است؛
...
- سنگ خام -> سکه
- اسکناس -> کارت بانکی
- [بلاکچین](https://planb.academy/resources/glossary/blockchain) -> [شبکه لایتنیگ](https://planb.academy/resources/glossary/lightning-network)

ارزها هنوز هم در حال تکامل هستند و شکل های خود را برای برآورده کردن نیازهای مختلف تغییر می دهند. همانطور که گفتیم، در حالی که طلا یک ذخیره عالی ارزش است، دیگر برای اقتصاد جهانی فعلی مناسب نیست. به طور مشابه، ارزهای اعتمادی مانند دلار و یورو بسیار نقدی هستند و به راحتی قابل حمل هستند زیرا اکنون بیشتر دیجیتالی هستند، اما ارزش آنها به طور مداوم توسط [تورم نقدی](https://planb.academy/resources/glossary/inflation) کاهش می یابد.

از سوی دیگر، بیت‌کوین افق‌های جدیدی می‌گشاید. ویژگی‌های آن، به‌ویژه عرضه‌ای کاملاً محدود، آن را به ذخیره‌ای عالی برای ارزش تبدیل می‌کند. همچنین، به‌عنوان یک ارز اینترنتی بی‌طرف، یک **وسیله مبادله** قابل اتکا است که می‌تواند از مرزها فراتر رود. با این حال، با وجود پذیرش مداوم (چنان‌که [نقشه BTCmap](https://btcmap.org/map) نشان می‌دهد)، هنوز به‌طور گسترده در تجارت امروزی پذیرفته نشده است.
...
ایجاد بیت کوین های جدید نتیجه فرآیند [استخراج](https://planb.academy/resources/glossary/mining) است. در یک کلام، استخراج کنندگان(ماینر ها) از کامپیوترهای قدرتمندی استفاده می کنند که مسائل ریاضی پیچیده را حل می کنند، که معاملات را تأیید و امن می کند. هنگامی که یک مسئله حل می شود، استخراج کننده یک [بلوک](https://planb.academy/resources/glossary/block) جدید از معاملات را به بلاکچین اضافه می کند، که یک دفتر کل غیر متمرکز و توزیع شده که تمام معاملات انجام شده در شبکه را ثبت می کند است. بلاکچین شفافیت و امنیت را تضمین می کند، زیرا هر بلوک به بلوک قبلی متصل است، که تقریباً امکان تغییر داده های گذشته بدون اجماع از شبکه را ناممکن می کند.
...
محدودیت 21 میلیون واحد، بنیان کمیابی بیت کوین است و توسط دو مکانیزم کلیدی تضمین می‌شود: [تنظیم سختی استخراج](https://planb.academy/resources/glossary/difficulty-adjustment) و نظریه بازی.
...
سختی یافتن یک [هش](https://planb.academy/resources/glossary/hash-function) معتبر،  یک نوع چرخه را دنبال میکند: اگر تعداد ماینرها افزایش یابد، به این معنی است که تعداد بلوک‌هایی که آن‌ها پیدا می‌کنند بیشتر می‌شود، که منجر به کاهش میانگین زمان یافتن یک بلوک می‌شود. به این دلیل ، سختی افزایش می‌یابد. در نتیجه، تعداد بلوک‌هایی که ماینرها پیدا می‌کنند کاهش می‌یابد، که به این معنی است که مکانیزم بر می‌گردد به میانگین 10 دقیقه برای هر بلوک. لطفاً برای درک تصویری، به تصویر زیر مراجعه کنید.

![image](assets/fa/023.webp)

آیا می دانستید که ماینر ها برای کسب بیت کوین های جدید از طریق [حمایت مالی بلوک](https://planb.academy/resources/glossary/block-subsidy)، و همچنین [هزینه های تراکنش](https://planb.academy/resources/glossary/transaction-fees) از تراکنش هایی که در آن بلوک قرار می دهند، تشویق می شوند تا یک بلوک را استخراج کنند؟
...
در بخش 2، ما قصد داریم تا از طریق استفاده از [کیف پول‌ها](https://planb.academy/resources/glossary/wallet)، ذخیره سازی و امنیت بیت کوین را بررسی کنیم، تا بفهمیم این بیت کوین‌های معروف کجا قرار دارند و چگونه با آنها تعامل داشته باشیم!
...
چه "بانکدار" بیت کوین شما باشد یا خود شما، اکثریت عظیم کیف پول های بیت کوین با یک فناوری مشابه بر اساس رمزنگاری نامتقارن کار می کنند، که شامل یک سیستم از جفت کلید است: یک [کلید خصوصی](https://planb.academy/resources/glossary/private-key) برای خرج کردن و یک [کلید عمومی](https://planb.academy/resources/glossary/public-key) برای دریافت.


- کلید خصوصی (Private key)

هنگام راه اندازی کیف پول، یک [عبارت بازیابی مخفی](https://planb.academy/resources/glossary/recovery-phrase) (کلید خصوصی) تولید می شود و به شما به صورت 12 یا 24 کلمه ارائه می شود.
...
اگر کسی به طور تصادفی لیست 12 یا 24 کلمه ما را حدس بزند چه اتفاقی می افتد؟ پاسخ کوتاه این است که به شدت نامحتمل است، با توجه به رمزنگاری استفاده شده برای ایجاد کیف پول. برای قرار دادن آن در یک دیدگاه، کشف تصادفی عبارت همان مونیک شما مشابه یافتن شماره "درست" بین 1 و $2^256$ است، که تقریباً معادل یافتن اتم "درست" در جهان است. با این حال، اگر با این امنیت پیش فرض راضی نیستید، همیشه می توانید آن را با افزودن یک [عبارت عبور](https://planb.academy/resources/glossary/passphrase-bip39) (یک کلمه اضافی) به کیف پول بیت کوین خود افزایش دهید.
...
به یاد داشته باشید که کیف پول مناسب برای نیازها و استفاده خود را انتخاب کنید: آموزش های دقیق در مورد مدیریت و امنیت کیف پول های مختلف در [بخش آموزش دانشگاه ما](https://planb.academy/tutorials/wallet) موجود است.
...
- **سطح 0**، شما از یک "[سرویس نگهداری](https://planb.academy/resources/glossary/custody)" به نام استفاده می کنید که در آن شما،  تنها دارنده بیت کوین های خود نیستید. توجه داشته باشید که این طرف سوم قابل اعتماد می تواند در هر زمانی دسترسی شما به سرمایه هایتان را محدود کند. در این حالت، سطح حاکمیت مالی شما مشابه سیستم بانکی سنتی با یک حساب بانکی است.
...
- **سطح 2**، شما از یک کیف پول فیزیکی استفاده می کنید و لیست 12/24 کلمه خود را امن کرده اید. اغلب به آن "[کیف پول سرد](https://planb.academy/resources/glossary/cold-wallet)" می گویند زیرا کلیدهای شما در یک دستگاه ذخیره شده است که به اینترنت متصل نیست. در این حالت، شما همیشه باید هر معامله را با دستگاه خود امضا کنید، که این باعث می شود دارایی های شما در هر روز کمتر قابل دسترسی باشد.
...
راه حل های مختلفی در دسترس هستند: برخی از آنها هزینه کمی دارند، مانند "بلوکمیت"، در حالی که برخی دیگر ممکن است نیاز به تجهیزات تخصصی تری داشته باشند. شما می توانید این موضوع را بیشتر در بخش [آموزش ها](https://planb.academy/en/tutorials/wallet) آکادمی ما بررسی کنید.
...
اگر شما تمایل دارید که بیشتر در مورد موضوع برنامه ارث برای بیت کوین های خود بررسی کنید، ما توصیه می کنیم که کتاب پاملا مورگان [برنامه ارث دارایی رمزنگاری شده](https://planb.academy/resources/books/28) را بخوانید یا در دوره BTC102 ثبت نام کنید، که در آن ما راهنمایی در مورد ایجاد برنامه شما ارائه می دهیم.
...
برای نهایی کردن معامله، باب باید آن را با کلید خصوصی خود امضا کند تا تایید کند که وی صاحب بیت کوین هایی است که می خواهد منتقل کند. این مرحله معمولاً به صورت خودکار در کیف پول های موبایلی انجام می شود، یا به شکل [تأییدیه](https://planb.academy/resources/glossary/confirmation) در کیف پول فیزیکی شما قرار می گیرد: "آیا مطمئن هستید که می خواهید X را به Y ارسال کنید؟ بله یا خیر".

![image](assets/fa/045.webp)

**چرا ما هزینه می‌پردازیم؟** هزینه‌ها برای ایجاد یک بازار آزاد برای انجام معاملات در بلوک‌ها ضروری هستند. در واقع، یک بلوک اندازه‌ای معادل 1 مگابایت دارد (که پس از به‌روزرسانی [Segwit](https://planb.academy/resources/glossary/segwit) به 4 مگابایت گسترش یافت)، بنابراین تعداد معاملاتی که می‌توان در یک بلوک "درج" کرد، به چند هزار معامله در هر بلوک محدود است. اندازه یک معامله بستگی به پیچیدگی آن دارد. بنابراین، معاملات پیچیده‌تر معمولاً هزینه‌های بیشتری را به همراه دارند.
...
در این نقطه، حتی اگر این تراکنش برای همه (از طریق ابزاری به نام [Mempool](https://planb.academy/resources/glossary/mempool)) شناخته شده باشد، تا زمانی که توسط یک ماینر در یک بلوک قرار نگیرد، نمی توان آن را تأیید شده در نظر گرفت. مایند تنها کسی است که تراکنش ها را با قرار دادن آنها در بلاکچین تأیید می کند.
...
برای بهینه سازی تعداد تلاش ها، آنها از دستگاه های خاصی به نام ASICs استفاده خواهند کرد که تنها نقش آنها محاسبه میلیاردها امکان در هر ثانیه است (مجموع تعداد تلاش ها "[HashRate](https://planb.academy/resources/glossary/hashrate)" نامیده می شود). برای کار کردن این دستگاه ها، باید مقادیر زیادی از برق مصرف شود. بنابراین، POW انرژی را به ارز تبدیل می کند، دنیای واقعی و دنیای دیجیتال را به هم متصل می کند تا اولین ارز مبتنی بر انرژی را ایجاد کند.
...
**تراکنش [کوین‌بیس](https://planb.academy/resources/glossary/coinbase-transaction)** همیشه اولین تراکنشی است که در بلوک قرار می‌گیرد: این تراکنش، پاداش ماینر برای انجام کار اعتبارسنجی را در بر دارد. سپس تراکنش‌های اعتبارسنجی شده می‌آیند. ماینرها تراکنش‌هایی را برای درج انتخاب می‌کنند که بیشترین سود را به آن‌ها می‌دهد، یعنی تراکنش‌های کوچک با حداکثر کارمزد.
...
برای ثابت کردن مدل کسب و کار خود، که بر اساس پاداشی است که آنها برای هر بلوک معتبر دریافت می کنند، ماینر ها اغلب از طریق "[استخرهای استخراج](https://planb.academy/resources/glossary/pool-mining)"(Mining pool) گروه هایی را ایجاد می کنند، جایی که منابع محاسباتی خود را تجمیع می کنند.
...
اگر مایل هستید موضوع خاص استخراج بیت‌کوین را عمیق‌تر بررسی کنید، می‌توانید به دوره MIN 101 ما مراجعه کنید. در آنجا توضیحی نظری و مفصل درباره اصل اثبات کار و نحوه عملکرد آن، به همراه تمامی مفاهیم مرتبط با آن خواهید یافت.

https://planb.academy/courses/d1ce86d9-c983-49bc-92b3-e3c5269f239e

همچنین به شما توصیه می‌کنم این دوره عملی پیشرفته‌تر را کشف کنید که در آن توضیح می‌دهیم چگونه یک ASIC را به یک سیستم گرمایش خانگی DIY تبدیل کنید تا از گرمای تولیدشده توسط استخراج بهره ببرید و اولین ساتوشی‌های خود را به دست آورید!
...
بر اساس چرخه‌های گذشته، به نظر می‌رسد که تناوب چرخه‌های اقتصادی بیت کوین معادل با مدت زمان بین" دو [نیم شدن](https://planb.academy/resources/glossary/halving)" است، شاید زیرا رویداد نیم شدن با نصف کردن انتشار بیت کوین‌های جدید به عنوان یک محرک عمل می‌کند.
...
*منبع : [Wicked Smart Bitcoin](https://wickedsmartbitcoin.com)*
...
یک [UTXO](https://planb.academy/en/resources/glossary/utxo) خروجی یک تراکنش است که هنوز خرج نشده است، به عبارت دیگر، به عنوان ورودی برای یک تراکنش جدید استفاده نشده است. ادغام آن‌ها به معنای ترکیب چند UTXO کوچک به یک UTXO بزرگ‌تر است، به طوری که "وزن" تراکنش کاهش یابد و در نتیجه هزینه‌های کمتری پرداخت شود.
- خرید بی‌برنامه
...
چندین روش برای به دست آوردن بیت کوین وجود دارد، هر کدام موضوع قوانین خاص خود را دارد که می تواند بر اساس حوزه قضایی متفاوت باشد. برخی از پلتفرم ها برای تأیید هویت ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)) نیاز به مدارک شناسایی دارند، در حالی که برخی دیگر ندارند. بنابراین، درک قوانین مرتبط با هر پلتفرم بسیار حیاتی است.


- پلتفرم های DCA

همانطور که در بالا معرفی کردیم، یک روش رایج برای انباشت بیت کوین، [میانگین هزینه دلار (DCA)](https://planb.academy/resources/glossary/dollar-cost-averaging-dca) است که شامل خرید مقادیر کوچک به طور منظم است. چندین سکو این سرویس را ارائه می دهند، مانند آنهایی که در [صفحه اختصاصی ما](https://planb.academy/tutorials/exchange) فهرست شده اند. علاوه بر سادگی راه اندازی یک DCA، برداشت ها به کیف پول شما معمولاً به صورت خودکار است، به این معنی که شما همیشه کنترل بر دارایی های خود دارید.
...
علاوه بر این، چندین [بازار](https://planb.academy/tutorials/exchange) وجود دارد که در آنها می توان بیت کوین ها را در یک مبادله نفر به نفر خرید و فروخت. به طور کلی، شما ممکن است موارد زیر را در نظر بگیرید:
...
اگر مایلید دانش خود را در زمینه راهبردهای خرید، استفاده و ایمن‌سازی بیت‌کوین‌های خود عمیق‌تر کنید، اکیداً توصیه می‌کنم پس از این دوره، دوره **BTC 102** را بگذرانید. در آنجا، در میان سایر موارد، توصیه‌هایی برای ابزارهایی خواهید یافت که با پروفایل، نیازها و اهداف شخصی شما سازگار هستند:
...
## شبکهٔ لایتنینگ: پرداخت سریع با بیت‌کوین و کارمزدهای پایین

<chapterId>b403f1e4-f1ff-572b-a242-9b58cb3736d0</chapterId>

اکنون که با مبانی پروتکل بیت‌کوین آشنا شده‌اید، شبکهٔ پرداخت اصلی‌ای را معرفی می‌کنیم که بر روی بیت‌کوین ساخته شده است: شبکهٔ لایتنینگ (که اغلب با نام «LN» شناخته می‌شود). هدف آن ساده است: امکان انجام پرداخت‌های BTC با نهایی‌شدن تقریباً آنی، بدون اشباع بلاکچین و با کارمزدهایی که معمولاً بسیار پایین هستند.

### بلاکچین نمی‌تواند همه‌چیز را انجام دهد

بلاکچین بیت‌کوین به‌گونه‌ای طراحی شده است که برای بیشترین تعداد ممکن از افراد، بدون نیاز به مجوز و بدون اعتماد، قابل راستی‌آزمایی باشد. این الزام، محدودیت‌های ساختاری به‌همراه دارد: بلاکچین نمی‌تواند تعداد نامحدودی از تراکنش‌ها را پردازش کند، زیرا بلوک‌ها باید از نظر دانلود، ذخیره‌سازی و راستی‌آزمایی توسط نودهای مستقل، در اندازه‌ای معقول باقی بمانند، بدون آن‌که نیاز به سرمایه‌گذاری روی سخت‌افزار بسیار گران باشد. این سازش اغلب با «سه‌گانه» خلاصه می‌شود: تمرکززدایی، امنیت و مقیاس‌پذیری. یک سیستم مبتنی بر بلاکچین نمی‌تواند هر سه ویژگی را به‌طور هم‌زمان به حداکثر برساند. بیت‌کوین تمرکززدایی و امنیت را در اولویت قرار می‌دهد و این موضوع به‌طور طبیعی توان عملیاتی تراکنش‌های [onchain](https://planb.academy/resources/glossary/onchain) را محدود می‌کند.

![image](assets/fa/081.webp)

در بیت‌کوین، توسعه‌دهندگان آگاهانه چنین انتخاب‌هایی را برای حفظ این اولویت‌ها انجام داده‌اند. از یک‌سو، اندازهٔ بلوک محدود به 1 مگابایت و فاصلهٔ زمانی متوسط 10 دقیقه بین هر دو بلوک، امکان اجرای یک نود بیت‌کوین با هزینهٔ پایین را فراهم می‌کند که به تمرکززدایی شبکه کمک می‌کند. از سوی دیگر، تولید بلوک‌ها از طریق اثبات کار، هرگونه تلاش برای تقلب را به‌شدت پرهزینه می‌کند و در عین حال، راستی‌آزمایی توسط نودها را ساده‌تر کرده و امنیت کلی پروتکل را افزایش می‌دهد.

با این حال، این انتخاب‌ها یک محدودیت مهم نیز به‌همراه دارند: تعداد تراکنش‌هایی که می‌توان در هر بلوک گنجاند محدود است. این مقدار تنها به چند تراکنش در ثانیه می‌رسد. این عدد در مقایسه با ظرفیت سیستم‌های پرداخت متمرکز مانند VISA (که ظرفیت نظری حداکثری حدود 65٬000 تراکنش در ثانیه دارد) ناچیز است، اما این محدودیت بهایی است که برای امکان انجام تراکنش‌های بدون سانسور و بدون واسطهٔ مورد اعتماد باید پرداخت.

در عمل، این موضوع برای استفادهٔ روزمره از بیت‌کوین دو پیامد بسیار مهم دارد:
* زمانی که تقاضا برای فضای بلوک افزایش می‌یابد، کارمزدهای onchain می‌توانند بسیار بالا بروند؛
* پرداخت‌های onchain نیازمند تأیید هستند، که همیشه برای خریدهای روزمره مناسب نیست.

شبکهٔ لایتنینگ دقیقاً پاسخی به این چالش‌ها است. ایدهٔ لایتنینگ بر یک رویکرد لایه‌ای استوار است: بیت‌کوین لایهٔ پایه باقی می‌ماند (لایهٔ تسویه، مستحکم و بسیار امن)، در حالی که لایتنینگ به‌عنوان یک لایهٔ پرداخت سریع بر روی آن عمل می‌کند.

![image](assets/fa/080.webp)

### کانال‌های پرداخت متصل به بیت‌کوین

لایتنینگ بر [کانال‌های پرداخت](https://planb.academy/resources/glossary/payment-channel) دوطرفه متکی است. یک کانال، یک رابطهٔ فنی میان دو شرکت‌کننده است که به آن‌ها اجازه می‌دهد [سات](https://planb.academy/resources/glossary/satoshi-sat)‌ها را به‌صورت [offchain](https://planb.academy/resources/glossary/offchain) مبادله کنند، یعنی بدون ثبت هر پرداخت روی بلاکچین.

از دیدگاه بیت‌کوین (onchain)، باز کردن یک کانال به معنای قفل‌کردن وجوه در یک تراکنش ویژه است. می‌توان این وضعیت را شبیه به سپرده‌گذاری دانست: وجوه به‌گونه‌ای قفل می‌شوند که تنها از طریق بستن معتبر کانال قابل توزیع مجدد باشند.

از دیدگاه لایتنینگ، همین سازوکار به یک کانال تبدیل می‌شود که در آن هر دو طرف می‌توانند وضعیت توزیع سات‌ها را هر تعداد بار که بخواهند، تقریباً به‌صورت آنی و بدون ثبت هر پرداخت در بلاکچین اصلی، به‌روزرسانی کنند.

بنابراین، سازوکار به شکل زیر است:
* باز کردن و بستن یک کانال لایتنینگ، تراکنش‌های بیت‌کوین هستند (و در نتیجه onchain منتشر می‌شوند)؛
* پرداخت‌هایی که بین باز شدن و بسته شدن کانال انجام می‌شوند، به‌روزرسانی‌های offchain هستند که در بلاکچین اصلی دیده نمی‌شوند.

![image](assets/fa/083.webp)

به این ترتیب، دو نفری که یک کانال لایتنینگ مشترک دارند می‌توانند تعداد بسیار زیادی پرداخت انجام دهند، بدون آن‌که هر بار یک تراکنش onchain ثبت کنند. اینجا نیز منطق مقیاس‌پذیری دیده می‌شود: بلاکچین برای عملیات نادر و مهم (باز و بسته شدن کانال، یعنی تسویهٔ نهایی) نگه داشته می‌شود و پرداخت‌های کوچک و میانی به یک لایهٔ کارآمدتر منتقل می‌گردند.

### شبکه‌ای از کانال‌های به‌هم‌پیوسته

لایتنینگ تنها مجموعه‌ای از کانال‌های جدا از هم نیست. این یک شبکه است: هزاران نود از طریق کانال‌ها به یکدیگر متصل شده‌اند و یک گراف ارتباطی را تشکیل می‌دهند.

![image](assets/fa/082.webp)

به لطف این شبکه، می‌توانید به گیرنده‌ای پرداخت کنید حتی اگر کانال مستقیمی با او نداشته باشید، به شرط آن‌که مسیری از کانال‌ها برای انتقال پرداخت وجود داشته باشد. در این حالت، پرداخت از چندین نود واسطه عبور می‌کند، گام‌به‌گام.

در اینجا یک مفهوم مهم در لایتنینگ ظاهر می‌شود: نقدینگی. ظرفیت یک کانال برابر است با مجموع وجوه قفل‌شده در آن کانال، و نقدینگی به توزیع این وجوه بین دو سمت کانال اشاره دارد، و در نتیجه به جهتی که سات‌ها می‌توانند در آن حرکت کنند. به بیان دیگر، یک کانال می‌تواند ظرفیت بالایی داشته باشد، اما اگر نقدینگی در سمت نامناسب قرار گرفته باشد، در یک جهت خاص غیرقابل استفاده باشد. بنابراین، موفقیت پرداخت‌ها نه‌تنها به وجود مسیر، بلکه به نقدینگی موجود در سراسر آن مسیر نیز وابسته است.

### مسیریابی پرداخت بدون اعتماد به واسطه‌ها

لایتنینگ به‌گونه‌ای طراحی شده است که امکان انجام پرداخت از طریق واسطه‌ها را بدون نیاز به اعتماد به آن‌ها فراهم کند. برای این منظور، پروتکل از قراردادهای هوشمندی به نام [HTLC](https://planb.academy/resources/glossary/htlc) (*Hashed Time-Locked Contracts*) استفاده می‌کند. بدون ورود به تمام جزئیات، سازوکار کلی به این شکل است:
* پرداخت مشروط به افشای یک راز (پیش‌تصویر) است؛
* اگر گیرندهٔ نهایی این راز را افشا کند، وجوه را دریافت می‌کند و واسطه‌ها نیز به نوبهٔ خود آنچه به آن‌ها تعلق دارد را دریافت می‌کنند؛
* اگر پرداخت ناموفق باشد، مهلت‌ها منقضی شده و هر طرف وجوه خود را پس می‌گیرد.

این سازوکار یک ویژگی اساسی ایجاد می‌کند: پرداخت اتمی است. یا به‌طور کامل انجام می‌شود، یا بدون هیچ زیان میانی شکست می‌خورد.

در نهایت، لایتنینگ یک سازوکار جریمه نیز دارد: اگر یکی از طرفین تلاش کند با انتشار یک وضعیت قدیمی کانال (که دیگر بازتاب‌دهندهٔ واقعیت نیست) تقلب کند، طرف مقابل می‌تواند او را جریمه کرده و تمام وجوه را تصاحب کند. این قاعده حتی در محیط‌های خصمانه نیز انگیزهٔ قوی برای رفتار صادقانه ایجاد می‌کند.

### نود لایتنینگ، کیف پول لایتنینگ: معنای آن چیست؟

در بیت‌کوین onchain، یک کیف پول نرم‌افزاری است که کلیدها را مدیریت کرده و تراکنش‌ها را می‌سازد. در لایتنینگ، وضعیت مبهم‌تر است، زیرا استفادهٔ واقعاً غیرامانی (non-custodial) بر یک نود لایتنینگ متکی است (حتی اگر این نود پشت یک رابط ساده پنهان شده باشد).

در عمل، دو دستهٔ اصلی از برنامه‌ها برای استفاده از لایتنینگ وجود دارد:
* خدمات امانی: برنامه موجودی شما را نمایش می‌دهد، اما وجوه توسط یک ارائه‌دهنده کنترل می‌شود. موجودی شما یک ثبت حسابداری در سیستم آن‌هاست، مشابه یک پلتفرم صرافی؛
* راهکارهای غیرامانی: شما واقعاً کنترل کلیدها و امکان بازیابی وجوه خود را در اختیار دارید. این می‌تواند یک برنامه باشد که یک نود با مدیریت حداقلی را در خود جای داده و تجربهٔ کاربری را ساده می‌کند (مانند Phoenix، Zeus...) یا یک نود لایتنینگ کامل که خودتان آن را به‌طور کامل مدیریت می‌کنید.

https://planb.academy/tutorials/wallet/mobile/phoenix-0f681345-abff-4bdc-819c-4ae800129cdf

https://planb.academy/tutorials/wallet/mobile/zeus-embedded-c67fa8bb-9ff5-430d-beee-80919cac96b9

امروزه همچنین کیف پول‌های خودامانی‌ای وجود دارند که می‌توانند پرداخت‌های لایتنینگ را به‌صورت غیرمستقیم پشتیبانی کنند، با تکیه بر سواپ‌های اتمی که به‌صورت درخواستی برای هر پرداخت ورودی یا خروجی انجام می‌شوند (مانند Bull Bitcoin Wallet، Aqua...). این کیف پول‌ها معمولاً از سایدچین Liquid به‌عنوان لایهٔ تسویه استفاده می‌کنند (در فصل بعد خواهیم دید که این به چه معناست).

https://planb.academy/tutorials/wallet/mobile/bull-bitcoin-2c72127c-a228-4f50-b833-c6183d56aaf6

https://planb.academy/tutorials/wallet/mobile/aqua-8e6d7dd3-8c03-45cc-90dd-fe3899a7d125

### موارد استفادهٔ عملی: آنچه لایتنینگ ممکن می‌سازد

لایتنینگ مجموعه‌ای از کاربردها را ممکن می‌کند که پیش‌تر تنها با بیت‌کوین onchain، غیرعملی یا حتی غیرممکن بودند.

- **پرداخت‌های روزمره (آنلاین و حضوری)**

برای پرداخت در صندوق یا خرید آنلاین، لایتنینگ نهایی‌شدن تقریباً آنی با کارمزدهای معمولاً پایین را فراهم می‌کند. این امر استفاده از بیت‌کوین را برای مبالغ کوچک ممکن می‌سازد، حتی زمانی که بلاکچین اصلی شلوغ است.

- **ریزپرداخت‌ها و پول جریانی**

امکان ارسال مبالغ بسیار کوچک، مدل‌های اقتصادی جدیدی را باز می‌کند: پرداخت بر اساس استفاده، پرداخت دقیقه‌ای، کمک‌های مالی تکرارشونده، انعام‌ها... این همان ایدهٔ «پول جریانی» است: پرداخت بر اساس مصرف واقعی یک محتوا یا خدمت، به‌جای اشتراک ثابت.

- **تولیدکنندگان محتوا، پادکست‌ها و کمک‌های مالی**

لایتنینگ اغلب برای ریزکمک‌ها یا سازوکارهای پاداش‌دهی استفاده می‌شود. برنامه‌هایی مانند Fountain یا Rumble این منطق را به‌خوبی نشان می‌دهند: پرداخت به بخشی طبیعی و جزئی از تجربه تبدیل می‌شود، نه یک اقدام سنگین و گاه‌به‌گاه. ما این منطق را در Plan ₿ Academy نیز پیاده‌سازی کرده‌ایم، جایی که می‌توانید به‌راحتی کمک‌های کوچکی برای قدردانی از اساتید مورد علاقهٔ خود ارسال کنید.

- **بازی‌ها و اقتصادهای دیجیتال**

بازی‌های ویدیویی و محیط‌های دیجیتال به‌طور طبیعی برای ریزتراکنش‌ها مناسب‌اند: شرط‌های کوچک، پاداش‌ها، آیتم‌های مجازی... افزودن یک مشوق مالی کوچک می‌تواند هزینهٔ اسپم و برخی سوءاستفاده‌ها (ربات‌ها) را افزایش دهد، در حالی که همچنان دسترس‌پذیر باقی می‌ماند.

![image](assets/fa/085.webp)

### پیاده‌سازی‌های اصلی لایتنینگ

همانند بیت‌کوین، لایتنینگ یک پروتکل است، نه یک نرم‌افزار واحد. چندین پیاده‌سازی در کنار هم وجود دارند و به لطف مشخصات مشترک (BOLT) با یکدیگر سازگار هستند:
* LND (Lightning Labs)؛
...
### جایگاه لایتنینگ در تکامل بیت‌کوین

لایتنینگ جایگزین بلاکچین بیت‌کوین نمی‌شود، بلکه آن را تکمیل می‌کند. بلاکچین همچنان لایهٔ تسویهٔ نهایی باقی می‌ماند؛ کند اما بسیار مستحکم. لایتنینگ لایهٔ پرداخت سریع است که برای استفاده‌های مکرر و مبالغ کوچک طراحی شده است.

در سال 2025، لایتنینگ نسبت به سال‌های اولیهٔ خود دسترس‌پذیرتر شده است، به لطف کیف پول‌ها و خدماتی که بخشی از پیچیدگی را پنهان می‌کنند. با این حال، همچنان سازش‌هایی دارد: نقدینگی، هزینه‌های onchain کانال‌ها، و گاهی انتخاب میان سادگی، حاکمیت فردی و حریم خصوصی.

اگر می‌خواهید لایتنینگ را به‌طور عمیق درک کنید (کانال‌ها، نقدینگی، مسیریابی، مدیریت ریسک)، دورهٔ نظری جامع LNP 201 اثر Fanis Michalakis را توصیه می‌کنم:

https://planb.academy/courses/34bd43ef-6683-4a5c-b239-7cb1e40a4aeb

و اگر می‌خواهید وارد ماجرای راه‌اندازی و بهره‌برداری از نود لایتنینگ خود شوید، دورهٔ عملی LNP 202 نیز وجود دارد که به‌طور ویژه به این موضوع اختصاص یافته است:

https://planb.academy/courses/593e483e-1785-4e83-aa7e-32b99056844c


## فراتر از لایتنینگ: پروتکل‌های دیگر برای تکامل بیت‌کوین

<chapterId>684e31f9-ebd1-51b6-91c0-1e6a315f1141</chapterId>

همان‌طور که در فصل‌های پیشین دیدیم، بیت‌کوین به‌عنوان یک لایهٔ پایهٔ بسیار مستحکم طراحی شده است: یک دفترکل عمومی، ساده و امن، اما به‌طور طبیعی محدود از نظر سرعت، برنامه‌پذیری و توان پرداخت. به‌جای وادار کردن این لایه به انجام همه‌چیز (مانند آنچه در اتریوم دیده می‌شود)، اکوسیستم بیت‌کوین به‌تدریج رویکردی لایه‌ای را پذیرفته است: بلاکچین به‌عنوان پی (تسویهٔ نهایی) عمل می‌کند، در حالی که لایه‌های بالاتر ویژگی‌های جدیدی مانند پرداخت‌های سریع‌تر، حریم خصوصی بیشتر یا صدور دارایی‌ها (استیبل‌کوین‌ها، اوراق بهادار توکن‌شده و ...) را اضافه می‌کنند.

بیت‌کوین تنها با تغییر پروتکل پایهٔ خود تکامل نمی‌یابد. بلکه با ساختن بر روی آن نیز رشد می‌کند، از طریق راهکارهایی که بسته به هدف، سازش‌های متفاوتی انجام می‌دهند. برخی به‌دنبال مقیاس‌پذیری پرداخت‌ها هستند، برخی دیگر به‌دنبال برنامه‌پذیری (در معنای گسترده) و صدور دارایی‌ها، و برخی تلاش می‌کنند هر دو را ترکیب کنند.

در این فصل، چهار پروتکل مهم را معرفی می‌کنیم که هر یک امکانات جدیدی را بر بستر بیت‌کوین فراهم می‌کنند: [سایدچین‌ها](https://planb.academy/resources/glossary/sidechain) (به‌ویژه Liquid)، Ark، RGB و Taproot Assets.

### سایدچین‌ها: بلاکچین‌های موازی متصل به بیت‌کوین

سایدچین یک بلاکچین مجزا از بیت‌کوین است که برای کار به‌صورت موازی، با قوانین و سازوکار اجماع خاص خود طراحی شده است. این بلاکچین از طریق یک سازوکار اتصال دوطرفه (*2WP*) به بیت‌کوین متصل است که در عمل امکان استفاده از بیت‌کوین‌ها را در سایدچین به‌صورت نماینده فراهم می‌کند (معمولاً بیت‌کوینی که روی بیت‌کوین قفل شده و در سایدچین بازآفرینی می‌شود)، و سپس بازگشت به زنجیرهٔ اصلی را ممکن می‌سازد.

مزیت یک سایدچین ارائهٔ قابلیت‌هایی است که دستیابی به آن‌ها در خود بیت‌کوین دشوار است: تراکنش‌های سریع‌تر، قابلیت‌های مربوط به دارایی‌ها، حریم خصوصی تقویت‌شده یا انعطاف‌پذیری بیشتر در توسعه. در مقابل، یک سایدچین همواره نسبت به بیت‌کوین سازش‌هایی انجام می‌دهد، به‌ویژه در مدل اعتماد یا میزان تمرکززدایی.

شناخته‌شده‌ترین سایدچین بیت‌کوین احتمالاً **Liquid** است که توسط Blockstream توسعه یافته است. این سایدچین به‌ویژه برای تسریع برخی کاربردها طراحی شده است: انتقال‌های سریع بین پلتفرم‌ها، تسویه‌های پرتکرار و صدور دارایی‌ها (استیبل‌کوین‌ها، اوراق بهادار و ...)، همراه با حریم خصوصی بیشتر. در Liquid، بیت‌کوین‌های استفاده‌شده L-BTC نام دارند و قرار است از طریق سازوکار اتصال دوطرفه، به‌صورت 1 به 1 به BTC متصل باشند.

![image](assets/fa/088.webp)

تفاوت اصلی با بیت‌کوین در مدل امنیت و تمرکززدایی است: Liquid به اثبات کار بیت‌کوین متکی نیست، بلکه بر یک فدراسیون از اپراتورها (یک گروه مشخص) تکیه دارد که تولید بلوک‌ها و عملکرد پل‌ها بین BTC و L-BTC را تضمین می‌کنند.

https://planb.academy/courses/d3ca6943-b22c-4e50-b62d-9431460525bc

### Ark: اشتراک UTXOها برای کاهش هزینه‌ها و بهبود تجربهٔ کاربری

Ark به خانواده‌ای از پیشنهادها و پیاده‌سازی‌ها اشاره دارد که هدف آن‌ها بهبود مقیاس‌پذیری بیت‌کوین از طریق تجمیع تعداد زیادی از عملیات کاربران در تعداد کمی تراکنش بیت‌کوین است. ایده نسبتاً ساده است: به‌جای ایجاد یک تراکنش onchain برای هر کاربر، یک تراکنش onchain ایجاد می‌شود که نمایندهٔ یک بسته است، و سپس حقوق هر فرد عمدتاً خارج از زنجیره تکامل می‌یابد تا زمانی که بخواهیم به‌طور نهایی روی بیت‌کوین تسویه کنیم.

این ایدهٔ پروتکل لایهٔ دوم توسط Burak در ماه مه 2023 معرفی شد. مانند شبکهٔ لایتنینگ، Ark سیستمی است که بر روی زنجیرهٔ اصلی بیت‌کوین مستقر می‌شود. این سیستم امکان انجام پرداخت‌های بیت‌کوینی خارج از زنجیره، به‌صورت سریع، ناشناس و با کارمزد پایین را فراهم می‌کند. در مقایسه با لایتنینگ، Ark برای دریافت پرداخت‌ها نیازی به نقدینگی ورودی ندارد، که تجربهٔ کاربری را به‌طور قابل توجهی بهبود می‌بخشد. علاوه بر این، سطحی از حریم خصوصی نزدیک به تراکنش‌های [coinjoin](https://planb.academy/resources/glossary/coinjoin) ارائه می‌دهد. Ark همچنین می‌تواند در صورت افزودن covenantها به بیت‌کوین، غیرتعاملی باشد.

Burak اغلب توانایی لایتنینگ در مقیاس‌پذیری را به دلیل وابستگی آن به زنجیرهٔ اصلی مورد انتقاد قرار می‌دهد و پیشنهاد می‌کند که Ark از نظر تئوریک می‌تواند کل جمعیت جهان را در حالت خودامانی پوشش دهد. اگرچه Ark می‌تواند به‌عنوان یک پروتکل رقیب برای شبکهٔ لایتنینگ دیده شود، اما در واقع این دو می‌توانند در کنار هم وجود داشته باشند و حتی مکمل یکدیگر باشند.

Ark همچنان حوزه‌ای بسیار فعال اما جوان است: هدف آن امیدوارکننده است (کاهش شدید ردپای onchain به‌ازای هر کاربر)، اما باید در نظر داشت که این یک معماری پیچیده‌تر با فرضیات و ریسک‌هایی متفاوت از بیت‌کوین و لایتنینگ است.

### RGB: قراردادها و دارایی‌ها با اعتبارسنجی سمت کاربر

RGB سیستمی از قراردادهای هوشمند و دارایی‌ها بر بستر بیت‌کوین است که رویکردی کاملاً متفاوت از بلاکچین‌های همه‌منظوره اتخاذ می‌کند. ایدهٔ مرکزی آن اعتبارسنجی سمت کاربر است: به‌جای انتشار وضعیت کامل یک قرارداد روی یک بلاکچین جهانی، شرکت‌کنندگان تاریخچه‌هایی را که برایشان اهمیت دارد به‌صورت محلی نگه‌داری و اعتبارسنجی می‌کنند، در حالی که بلاکچین بیت‌کوین تنها برای لنگر کردن تعهدات رمزنگاری‌شده و جلوگیری از خرج دوباره به کار می‌رود.

به بیان دیگر:
* بلاکچین بیت‌کوین نقش زیرساخت زمان‌سنجی و داور حداقلی را ایفا می‌کند؛
* داده‌های تفصیلی (قوانین قرارداد، وضعیت‌ها، انتقال‌ها) خارج از زنجیره و بین طرف‌های ذی‌ربط مبادله می‌شوند؛
* اعتبارسنجی به‌صورت محلی انجام می‌شود، که مقیاس‌پذیری را بهبود می‌بخشد و می‌تواند حریم خصوصی را افزایش دهد، زیرا هیچ دفترکل جهانی از تمام فعالیت‌های RGB که برای همه قابل مشاهده باشد وجود ندارد.

![image](assets/fa/089.webp)

RGB می‌تواند به‌عنوان پایه‌ای برای صدور و مدیریت طیف گسترده‌ای از دارایی‌ها به کار رود: توکن‌ها (از جمله استیبل‌کوین‌ها)، NFTها یا اوراق بهادار دیجیتال، و حتی برای ساخت منطق‌های قراردادی پیچیده‌تر، بدون آن‌که لایهٔ پایه را سنگین کند.

نکتهٔ منفی این رویکرد، مدیریت داده‌هاست: اگر اعتبارسنجی سمت کاربر انجام می‌دهید، باید داده‌هایی را که حقوق شما را اثبات می‌کنند نیز به‌درستی نگه‌داری و پشتیبان‌گیری کنید.

RGB پروتکلی است که سال‌هاست در حال توسعه است. پیشرفت‌ها تدریجی بوده‌اند، اما امروزه برنامه‌های عملی وجود دارند که از RGB بهره می‌برند. برای深入‌تر شدن، ما در Plan ₿ Academy یک دورهٔ سطح پیشرفته ارائه می‌دهیم که عملکرد این پروتکل را به‌طور کامل شرح می‌دهد:

https://planb.academy/courses/3ce1d37c-05ba-4f54-aa15-7586d37b2bb7

### Taproot Assets: صدور دارایی‌ها روی بیت‌کوین و انتقال آن‌ها روی لایتنینگ

Taproot Assets (که پیش‌تر با نام «Taro» شناخته می‌شد) پروتکلی است که توسط Lightning Labs توسعه داده شده و هدف آن امکان صدور دارایی‌ها روی بیت‌کوین و سپس انتقال آن‌ها از طریق شبکهٔ لایتنینگ برای مبادلات سریع و کم‌هزینه است.

این پروتکل اغلب به‌عنوان بخشی از روایت «پول برنامه‌پذیر» در بیت‌کوین مطرح می‌شود: نه به این دلیل که بیت‌کوین به یک رایانهٔ جهانی تبدیل می‌شود، بلکه به این دلیل که می‌توان ابزارهای مالی (دارایی‌ها) را بر روی پایهٔ بیت‌کوین سوار کرد و سپس آن‌ها را به‌طور کارآمد از طریق لایتنینگ جابه‌جا نمود.

### بیت‌کوین با نوآوری در لایه‌های بالاتر تقویت می‌شود

امروزه، دقیق‌ترین تصویر از اکوسیستم بیت‌کوین نه یک پروتکل ثابت است و نه یک ابر‌بلاکچین همه‌کاره مانند اتریوم. بلکه یک پایهٔ آگاهانه محافظه‌کار است که با لایه‌ها و پروتکل‌هایی احاطه شده که آزمایش می‌کنند و امکان نوآوری را با حداقل ریسک فراهم می‌سازند.
