...
O Seedkeeper é um smartcard desenvolvido pela Satochip, uma empresa belga especializada em soluções de hardware para gestão e proteção de segredos digitais. Reconhecida pela sua gama de smartcards para o ecossistema Bitcoin, a Satochip concebeu o Seedkeeper como uma alternativa aos métodos tradicionais de armazenamento de frases Mnemonic e outros segredos digitais.



Em termos concretos, o Seedkeeper assume a forma de um cartão inteligente multifuncional, certificado EAL6, com um processador seguro e uma memória inviolável (ou seja, um "*secure element*"). Como o nome sugere, a sua função é armazenar as mnemónicas e as palavras-passe da carteira Bitcoin de forma encriptada e protegida. Com o Seedkeeper, pode generate, importar, organizar e guardar os seus segredos diretamente na componente segura do cartão.
...
- Armazenamento de frases Bitcoin** Mnemonic: em vez de escrever as suas 12 ou 24 palavras em papel, pode importá-las para o cartão inteligente e protegê-las com um código PIN.
...
Neste tutorial, abordaremos apenas o uso do SeedKeeper para senhas tradicionais, à maneira de um gerenciador de senhas. Se quiser usar o SeedKeeper para salvar frases Bitcoin Wallet Mnemonic, consulte este outro tutorial:
...
Selecione "generate secret*". A opção "*Importar um segredo*" permite-lhe guardar um segredo existente (por exemplo, uma palavra-passe que tenha criado no passado).
...
Atribua um "*Rótulo*" a este segredo para que possa ser facilmente identificado se armazenar várias informações no seu Seedkeeper. Pode também adicionar um nome de utilizador associado à palavra-passe e ao URL do sítio.
...
Escolha o comprimento e os parâmetros da sua palavra-passe e, em seguida, clique em "*generate*" e depois em "*Import*".
...
Isto leva-o a uma lista de todos os seus segredos registados. Neste exemplo, quero mostrar a palavra-passe da minha conta Plan ₿ Network, por isso clico nela.
...
É tudo o que há para fazer! Agora você sabe como usar o Seedkeeper para armazenar suas senhas. Num futuro tutorial, veremos como usar o Seedkeeper para fazer backup de um portfólio Bitcoin. Convido-o também a descobrir a sua utilização combinada com o SeedSigner :
