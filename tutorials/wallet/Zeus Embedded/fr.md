...
Sur l'écran suivant copiez votre invoice dans le champ dédié, ou scannez la en cliquant sur l'icone en haut à droite. Enfin glissez le bouton "Slide to Pay" vers la droite pour payer
...
Zeus vous permet ensuite d'ajouter une note pour libeller votre paiement, ou de visualiser la route qu'ont emprunté vos satoshis avant d'atteindre leur destination (et les frais prélevés par tous les noeuds intermédiaires). C'est le genre de fonctionnalité qu'on aime sur ce wallet.
...
Il est également possible en cliquant sur la petite flèche en bas de l'écran d'accueil, de visualiser l'historique de nos paiements. Ici nous voyons en vert les 212121 sats reçus on-chain, puis en rouge respecitvement les 211756 sats utilisés pour ouvrir notre canal, puis les 121212 satoshis utilisés pour régler notre invoice lightning
...
Sur l'écran suivant vous est présenté l'invoice à régler pour recevoir les satoshis. On nous indique que le LSP retiendra 10000 sats de frais si le paiement est réglé par Lightning. Nous verrons par la suite comment sont justifiés ces frais d'ouverture de canal.
...
En effet comme vous avez payé pour établir ce canal, le Lightning Service Provider (LSP) s'engage à maintenir le canal 3 mois, et vous offre de la "liquidité entrante". Sur le canal du bas, on voit que la capacité de réception est 96383 satoshis. Le LSP a donc immobilité du capital afin de vous permettre de recevoir des paiements directement après ouverture du canal.

Donc les 10000 satoshi de frais payés couvrent: les fais d'ouverture du canal (transaction bitcoin on-chain, la garantie de maintient du canal pendant 3 mois, et l'immobilisation du capital)
