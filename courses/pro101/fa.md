...
Bitcoin چیزی فراتر از یک ارز دیجیتال است. این یک ابزار برای حفاظت از حریم خصوصی و تضمین آزادی مالی است. با استفاده از **کلیدهای خصوصی**، که مانند رمزهای عبور اصلی عمل می‌کنند، کاربران می‌توانند Bitcoin خود را به‌طور امن مدیریت کرده و کنترل کامل بر روی وجوه خود داشته باشند.
...
در اولین جلسه دوره 'How Bitcoin'، ما به بررسی فناوری‌های پایه‌ای که شبکه Bitcoin را پشتیبانی می‌کنند، پرداختیم. موضوعاتی مانند **Hashcash**، **تراکنش‌ها**، **Blockchain**، **Lightning Network** و دیگر اجزای کلیدی پروتکل Bitcoin را پوشش دادیم.
...
起منشأ Bitcoin بر اساس چندین نوآوری کلیدی است که با **هش‌کش آدام بک** آغاز می‌شود، یک سیستم Proof-of-Work (PoW) که برای جلوگیری از هرزنامه‌های ایمیل و حملات انکار سرویس طراحی شده بود و از ارسال‌کنندگان می‌خواست تا وظایف محاسباتی را انجام دهند. این مفهوم PoW به سنگ بنای امنیت Bitcoin تبدیل شد.


Bitcoin بر اساس **امضاهای دیجیتال** با استفاده از **رمزنگاری منحنی بیضوی** برای ایمن‌سازی و تأیید تراکنش‌ها عمل می‌کند. **الگوریتم امضای دیجیتال منحنی بیضوی (ECDSA)** تضمین می‌کند که تنها مالک قانونی Bitcoin می‌تواند تراکنش‌ها را بدون افشای کلیدهای خصوصی خود مجاز کند.


**Satoshi ناکاموتو**، خالق مستعار Bitcoin، با انتقال مدل PoW به یک **Blockchain** غیرمتمرکز، این ایده‌ها را گسترش داد. این امر امکان ایجاد یک شبکه توزیع‌شده از نودها را فراهم کرد تا تراکنش‌ها را بدون نیاز به یک مرجع مرکزی اعتبارسنجی و ثبت کنند، که نشان‌دهنده یک تحول مهم نسبت به تلاش‌های قبلی در زمینه ارز دیجیتال بود.
...
تراکنش‌های Bitcoin توسط **ماینرها** اعتبارسنجی و به بلاک‌ها اضافه می‌شوند، که برای حل یک معمای رمزنگاری با استفاده از الگوریتم Proof-of-Work رقابت می‌کنند. این فرآیند شامل یافتن یک Hash با تعداد مشخصی از صفرهای پیشرو با تنظیم مقدار **Nonce** تا زمانی که Hash صحیح کشف شود، می‌باشد.
...
توسعه Bitcoin برای بهبود عملکرد و امنیت تکامل یافته است. ارتقاء‌های عمده شامل **Segregated Witness (SegWit)** است که به مسئله تغییرپذیری تراکنش‌ها می‌پردازد و اندازه بلوک مؤثر را افزایش می‌دهد، و **Taproot** که حریم خصوصی را بهبود می‌بخشد و امکان قراردادهای پیچیده‌تر را با استفاده از **Merkleized Abstract Syntax Trees (MAST)** فراهم می‌کند.
...
در این سخنرانی، به بررسی و رفع افسانه‌های رایج پیرامون **Bitcoin**، **بلاکچین‌ها** و **ارزهای دیجیتال** می‌پردازیم. بیایید به اشتباهات Address درباره مصرف انرژی Bitcoin، استفاده‌های مجرمانه و گسترش گسترده "FUD" (ترس، عدم اطمینان، شک) در مورد این فناوری بپردازیم.
...
**حریم خصوصی** و **قابلیت تعویض** ویژگی‌های اساسی Bitcoin هستند. حریم خصوصی از کاربران در رژیم‌های سرکوبگر محافظت می‌کند و قابلیت تعویض تضمین می‌کند که هر Bitcoin برابر است، صرف‌نظر از تاریخچه‌اش. این ویژگی‌ها Bitcoin را به شکلی قابل اعتماد و منصفانه از پول تبدیل می‌کنند.
...
!خوش آمدید دوباره در جلسه قبلی، ما مفاهیم اساسی پشت معماری Bitcoin را پوشش دادیم، از جمله مبانی رمزنگاری آن و ساختار شبکه همتا به همتا. امروز، از تئوری به عمل می‌رویم و نحوه نصب و پیکربندی یک نود Bitcoin را نشان خواهیم داد.
...
اجرای یک نود Bitcoin شامل اعتبارسنجی تراکنش‌ها و بلوک‌ها، اجرای قوانین اجماع و حمایت از تمرکززدایی شبکه است. راه‌اندازی یک نود تضمین می‌کند که شما یک ارتباط مستقیم با شبکه Bitcoin دارید و به امنیت و یکپارچگی آن کمک می‌کنید.
...
**رمزنگاری منحنی بیضوی (ECC)**: طرح‌های امضا از پروتکل‌های هویتی به طرح‌هایی مانند امضاهای اشنور تکامل یافته‌اند که در حال حاضر در Bitcoin (BIP 340) استفاده می‌شوند. دانش منحنی‌های بیضوی و حساب فیلدهای متناهی، پیاده‌سازی‌های رمزنگاری امن را تضمین می‌کند.
