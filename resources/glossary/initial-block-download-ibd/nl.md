---
term: INITIËLE BLOKDOWNLOAD (IBD)
---
...
> in het Frans is het algemeen geaccepteerd om direct naar een IBD te verwijzen. De vertaling die soms wordt gebruikt is "synchronisation initiale", of "téléchargement initial des blocs".*