...
**توجه**: اگر در طول دوره با اصطلاحات ناآشنا برخورد کردید، لطفاً برای تعاریف به [واژه‌نامه](https://planb.academy/resources/glossary) مراجعه کنید.
...
- [عبارت بازیابی](https://planb.academy/resources/glossary/recovery-phrase) **خود را** با دقت محافظت کنید؛
...
به زبان ساده، هر شرکت‌کننده در شبکه Bitcoin (که به آن "[گره](https://planb.academy/resources/glossary/node)" گفته می‌شود) یک نسخه کامل از تراکنش Ledger دارد که به عنوان Blockchain شناخته می‌شود. هنگامی که یک تراکنش جدید اتفاق می‌افتد، به شبکه پخش می‌شود. سپس ماینرها این تراکنش‌ها را با گروه‌بندی آن‌ها در بلوک‌هایی تأیید می‌کنند که سپس به انتهای زنجیره اضافه می‌شوند (به همین دلیل به آن "Blockchain" گفته می‌شود).
...
به دلیل ماهیت غیرمتمرکز خود، Bitcoin به صورت ۲۴/۷ عمل می‌کند و تحت تأثیر مرزها یا مناطق زمانی قرار نمی‌گیرد. در مناطقی که زیرساخت‌های بانکی سنتی کمبود دارند، Bitcoin اغلب به عنوان یک راه‌حل سریع و کم‌هزینه برای ارسال یا دریافت وجوه بدون اتکا به واسطه‌های گران‌قیمت استفاده می‌شود. در حالی که کارمزدهای تراکنش می‌تواند بر اساس تراکم شبکه متفاوت باشد، به طور کلی بسیار کمتر از کارمزدهایی است که بانک‌ها برای انتقالات بین‌المللی دریافت می‌کنند. علاوه بر این، راه‌حل‌های Layer-2 مانند [Lightning Network](https://planb.academy/resources/glossary/lightning-network) امکان تراکنش‌های Bitcoin را حتی سریع‌تر و ارزان‌تر فراهم می‌کنند.
...
**فناوری‌دوست یا عملی؟** ممکن است راه‌حل‌های پیشرفته‌تری مانند کیف‌پول‌های [Multisig](https://planb.academy/resources/glossary/multisig) را ترجیح دهید که کنترل و امنیت بیشتری ارائه می‌دهند.
...
- **Hot Wallet**: کیف پول‌های موبایل یا دسکتاپ که برای مبتدیان ایده‌آل هستند، به شما امکان می‌دهند به راحتی Sats دریافت کرده و پرداخت‌ها را انجام دهید. با این حال، آن‌ها برای مقادیر کم مناسب‌تر هستند. کیف پول‌های On-Chain به دلیل مدیریت بهتر [UTXO](https://planb.academy/resources/glossary/utxo) برای انباشت نسبت به کیف پول‌های Lightning ترجیح داده می‌شوند. کیف پول‌های نرم‌افزاری توصیه‌شده: Green Wallet، Blue Wallet، Sparrow wallet، Bitkit، Nunchuk، Aqua، Proton
