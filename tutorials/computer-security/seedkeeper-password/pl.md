...
W tym samouczku omówimy tylko użycie SeedKeepera do tradycyjnych haseł, w sposób menedżera haseł. Jeśli chcesz użyć SeedKeeper do zapisywania fraz Bitcoin Wallet Mnemonic, zapoznaj się z tym innym samouczkiem:
...
Przypisz "*Label*" do tego sekretu, aby można go było łatwo zidentyfikować, jeśli przechowujesz kilka informacji w Seedkeeper. Możesz również dodać nazwę użytkownika powiązaną z hasłem i adresem URL witryny.
...
Spowoduje to wyświetlenie listy wszystkich zarejestrowanych haseł. W tym przykładzie chcę wyświetlić hasło do mojego konta Plan ₿ Network, więc klikam na nie.
...
To już wszystko! Teraz już wiesz, jak używać Seedkeeper do przechowywania haseł. W przyszłym samouczku przyjrzymy się, jak używać Seedkeeper do tworzenia kopii zapasowych portfela Bitcoin. Zapraszam również do odkrycia jego połączonego zastosowania z SeedSigner :
