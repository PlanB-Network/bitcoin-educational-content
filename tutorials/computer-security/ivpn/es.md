---
name: IVPN
description: Configuración de una VPN pagada con Bitcoin
---
...
A diferencia de los proveedores de VPN más populares, IVPN opera en un modelo de compra de tiempo de acceso al servicio, en lugar de en una suscripción recurrente. Pagas en Bitcoin una vez por la duración elegida. Por ejemplo, si compras un año de acceso, puedes usar el servicio durante ese período, después del cual necesitarás volver al sitio web de IVPN para comprar más tiempo de acceso.
...
Luego selecciona tu método de pago. En esta ocasión, realizaremos el pago a través de Lightning Network, así que hacemos clic en el botón "*Bitcoin*".
![IVPN](assets/notext/11.webp)
Comprueba que todo esté correcto y luego haz clic en el botón "*Pagar con Lightning*".
![IVPN](assets/notext/12.webp)
Se te presentará un cobro de Lightning en su servidor BTCPay. Escanea el código QR con tu billetera Lightning y procede con el pago.
![IVPN](assets/notext/13.webp) Una vez pagado el recibo, haz clic en el botón "*Volver a IVPN*".
...
En la pestaña "*General*", hay varias configuraciones del cliente. Te aconsejamos que marques las opciones "*Launch at login*" y "*On launch*" en la sección "*Autoconnect*" para establecer automáticamente la conexión con la VPN al iniciar tu dispositivo.
...
![IVPN](assets/notext/28.webp)La pestaña "*IVPN Firewall*" te permite activar el firewall de manera sistemática al iniciar tu dispositivo, asegurando que no se establezca ninguna conexión fuera de la VPN.
...
Y ahí lo tienes, ahora estás equipado para disfrutar plenamente de IVPN. Si también quieres mejorar la seguridad de tus cuentas en línea usando un gestor de contraseñas local, te invitamos a consultar nuestro tutorial sobre KeePass, una solución gratuita y de código abierto:

https://planb.network/tutorials/computer-security/authentication/keepass-f8073bb7-5b4a-4664-9246-228e307be246

Si estás interesado en descubrir otro proveedor de VPN similar a IVPN, tanto en términos de características como de precios, también te recomendamos consultar nuestro tutorial sobre Mullvad:
