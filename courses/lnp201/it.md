...
Un altro modo per immaginare l'allocazione dei fondi è immaginare un **cursore** che indichi dove si trovano i fondi nel canale. All'inizio, con 100.000 satoshi per Alice e 30.000 per Bob, il cursore è più spostato verso Bob, poiché Alice ha molti più fondi. Dopo la transazione di 40.000 satoshi, il cursore si sposterà leggermente verso Alice, che ora possiede 70.000 satoshi.
