...
# Costruisci il tuo primo riscaldatore Bitcoin fai-da-te




Questo corso è costruito attorno ad Attakai, un progetto pratico fai-da-te che trasforma un miner S9 usato in un riscaldatore Bitcoin domestico.

Inizierai con una panoramica concisa del mining di Bitcoin e delle realtà dell'industria mineraria, per poi passare direttamente alla costruzione: reperire l'hardware giusto, installare e configurare BraiinsOS+, configurare la rete, sostituire le ventole, unirsi a un pool di mining e ottimizzare le prestazioni in termini di calore, rumore ed efficienza.

Le guide passo dopo passo ti accompagnano attraverso l'intero processo in modo da poter costruire Attakai a casa e minare i tuoi primi sats mentre riscaldi il tuo spazio.
...
**Sezione 2: Il mining, il suo funzionamento, la sua industria e le sue sfide**
...
**Sezione 4: Modifica del software di un Antminer S9**
...
**Sezione 5: Modifica delle ventole**
...
**Sezione 6: Impostazione del riscaldamento DIY**
...
# Il mining, il suo funzionamento, la sua industria e le sue sfide
...
Per spiegare in modo semplificato il concetto di [mining](https://planb.academy/resources/glossary/mining), si può utilizzare un'analogia pertinente: quella del puzzle. Come un puzzle, il mining è un compito complesso da eseguire, ma facile da verificare una volta completato. Nel contesto del mining di Bitcoin, i minatori cercano di risolvere rapidamente un puzzle digitale. Il primo [minatore](https://planb.academy/resources/glossary/miner) a risolvere il puzzle presenta la sua soluzione all'intera rete, che può quindi verificarne facilmente la validità. Questa verifica di successo consente al minatore di convalidare un nuovo [blocco](https://planb.academy/resources/glossary/block) e aggiungerlo alla [blockchain](https://planb.academy/resources/glossary/blockchain) di Bitcoin. In riconoscimento del loro lavoro, che comporta costi significativi, il minatore viene ricompensato con un certo numero di bitcoin. Questa [ricompensa](https://planb.academy/resources/glossary/block-reward) costituisce un incentivo finanziario per i minatori a continuare il loro lavoro di convalida delle [transazioni](https://planb.academy/resources/glossary/transaction-tx) e di sicurezza della rete Bitcoin.
...
Nel contesto del mining di Bitcoin, il ruolo del software è altrettanto cruciale quanto quello dell'hardware. Un esempio di ciò è illustrato dal ruolo di Bitmain, un produttore prolifico che ha sviluppato l'Antminer S9. Oltre all'hardware di mining, l'industria si basa fortemente sulle pool di mining collaborativi, come Braiinspool, che controlla circa il 5% dell'hashrate globale della rete Bitcoin.

Gli attori di questa industria cercano costantemente di aumentare l'efficienza attraverso l'hardware e il software. Ad esempio, un software popolare utilizzato in questo contesto è BraiinsOS Plus. Questo software sostituisce il sistema operativo originale della macchina di mining, consentendo di eseguire le stesse operazioni in modo più efficiente. Con un tale software, un minatore può aumentare l'efficienza della sua macchina del 25%. Ciò significa che con la stessa quantità di elettricità, la macchina può produrre un hash rate aggiuntivo del 25%, aumentando così le ricompense ricevute dal minatore. Questa ottimizzazione del software è un elemento essenziale per la competitività nel mining di Bitcoin, dimostrando l'importanza di un approccio integrato che combini miglioramenti hardware e software per massimizzare l'efficienza e i rendimenti.
...
La centralizzazione del mining viene affrontata come una sfida significativa. Grandi attori, come Foundry, dominano il mercato, il che potrebbe potenzialmente portare alla censura delle transazioni. Questa centralizzazione può anche rendere la rete vulnerabile ad attacchi, in particolare l'[attacco del 51%](https://planb.academy/resources/glossary/51-percent-attack), in cui un attore o un gruppo controlla più del 50% della potenza di hash della rete, consentendo loro di controllare e manipolare la rete.
...
Il ruolo dei minatori nella rete Bitcoin è stato un argomento di intenso dibattito durante la guerra dei blocchi. Sebbene siano essenziali per la sicurezza e la funzionalità della rete, i minatori non detengono necessariamente il potere ultimo nell'ecosistema Bitcoin. L'equilibrio tra i minatori, i [nodi](https://planb.academy/resources/glossary/node) e gli utenti finali garantisce l'integrità e la distribuzione della rete.
...
La guerra dei blocchi ha rivelato l'incertezza e le tensioni intrinseche nella gestione della rete Bitcoin. Sebbene [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core) sia attualmente la catena dominante, il dibattito sulla governance e la gestione della rete persiste.
...
![image](assets/en/067.webp) 3. È ora di installare le parti 3D!
...
Successivamente, copia l'indirizzo [Stratum](https://planb.academy/resources/glossary/stratum) e il tuo nome utente:
