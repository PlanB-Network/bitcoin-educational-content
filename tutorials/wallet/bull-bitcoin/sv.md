...
- **Säkra din återställningsfras**:
 - Självstudier: [Save your Mnemonic phrase](https://planb.academy/fr/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270)
...
- **Liquid Network** :
- [Ordlista](https://planb.academy/resources/glossary/liquid-network)
...
- **Lightning Network**:
- [Ordlista](https://planb.academy/resources/glossary/lightning-network)
