...
Blockhuvudet innehåller flera element som tiden, svårighetsmålet, numret på det senaste blocket, den använda versionen och Merkel-roten för de tidigare transaktionerna.
...
### En Blockchain Kan Inte Växa Obegränsat
...
Som Morpheus sa till Neo: "Du tar det blå pillret, historien tar slut, du vaknar upp i din säng och tror vad du vill tro. Du tar det röda pillret, du stannar i Underlandet och jag visar dig hur djupt kaninhålet går." Är du redo att utforska Bitcoin-kaninhålet? Var försiktig, för du kan upptäcka din ekonomiska frihet på nytt!

### Den teknologiska framtiden och dess konsekvenser

Tekniken utvecklas exponentiellt och ingen kan med säkerhet förutsäga dess framtida utveckling. Världens anslutning och artificiell intelligens fortsätter att utvecklas. Kunskapen som en individ kan få genom internet blir alltmer obegränsad över tiden.

Låt oss ta AI som ett exempel. Dessa teknologier har redan överträffat eller närmar sig mänsklig prestation inom ett växande antal områden, som videospel, bild- och textproduktion samt dataanalys. En potentiell konsekvens är att över 80% av jobben kommer att försvinna på grund av AI och automation. Flera alternativ finns tillgängliga för oss, som att begränsa teknologisk utveckling eller utnyttja den ökade kapitalen från produktivitetsvinster som skapas av AI.

De viktiga frågorna att ställa är:

- Hur hanterar vi ett samhälle där över 80% av jobben kommer att försvinna?
- Hur återupplivar vi en befolkning?
- Behövs det lika många lärare?
- De geopolitiska, politiska och mänskliga konsekvenserna av automation diskuteras inte tillräckligt.
  Datorer, internet, streaming och VR kommer att förändra utbildningen. Vi skulle kunna ha en universell kurs för alla franska elever som hanteras av regeringen och lärare som inte längre håller föreläsningar utan direkt följer eleverna. Barnen skulle kunna gå in i en virtuell värld och få hjälp med att lära sig historia.

- Var går gränsen mellan en lärare och en AI?
- Hur kan vi garantera ett samhälle som lever i välstånd?

Dessa grundläggande frågor för vår framtid måste debatteras och beslutas gemensamt. Men vad är kopplingen till Bitcoin? Precis som internet för kommunikationsformer är Bitcoin en teknologisk revolution för nya sätt att organisera i stor skala, vilket ger oss möjligheten att utbyta värde utan någon betrodd tredje part. Vill vi hindra den teknologiska utvecklingen av monetära system eller dra nytta av ökningen av kapital genom den tiofaldiga produktivitetsvinsten från att använda Bitcoin och Lightning-protokollen?

### Vad är framtidens finans?

Dessa reflektioner väcker också frågor om vem som bör äga, godkänna och spåra de pengar vi använder. Målet är att välja mellan ett slutet system med icke-valda ledare eller ett öppet system utan betrodda tredje parter, där neutralitet råder.

- Är valutan en form av privat egendom?
- Kan protesterandes konton blockeras utan en domstolsorder?
- Vem garanterar det finansiella systemet?
- Hur kan en individ vara suverän över sina pengar och lita på en betrodd tredje part?
- Kan pengar skickas till andra sidan av världen utan avgifter eller mellanhänder?

Att acceptera dessa nya teknologier kan generera massiva stordriftsfördelar över hela världen. Ska vi tillåta fri rörlighet för kapitalflöden? Internationella blockader har ekonomiska och politiska konsekvenser. Är det etiskt att använda finansiella mellanhänder som Western Union, som ibland tar upp till 25% i avgifter? Vi anser att i en alltmer digital värld bör pengar demokratiseras och betraktas som en allmän egendom som tillhör folket snarare än staten eller ogenomskinliga finansiella institutioner.

Frågan om vem som ska kontrollera banksystemet är avgörande eftersom reglerna för bankspelet inte är transparenta och förståeliga för alla, vilket gör att en kast av politiker och reglerare kan behålla sitt grepp om systemet. Det är viktigt att ifrågasätta om det är den fria marknaden eller en grupp intellektuella som bör kontrollera banksystemet.

### Våra friheter står på spel.

Censuren måste också ifrågasättas, för vem har kunskapen att besluta vad som ska censureras eller inte? Medierna har ändrat sin ståndpunkt om viss information och de personer som tidigare blev censurerade är inte längre censurerade idag.

- Vem bestämmer vad som är censur eller propaganda?
- Vem har den gudomliga handen över vårt system?
  Att tolerera censur kan förstöra yttrandefriheten och rätten att samlas. Att implementera censur är tekniskt svårt utan att skapa en fullständig dystopi. Vilken enhet bör ha makten att censurera? Frågan om censur är komplicerad och det är svårt att veta vem som bör censureras eller inte. Censur kan ha en negativ inverkan på innovation och frihet att agera.
  Det finns 2,4 miljarder människor i världen utan bankkonto, vilket nödvändigtvis skapar geografiska ojämlikheter. Bitcoin möjliggör jämlikhet i transaktioner, oavsett din sociala status eller politiska ställning. Bitcoin-protokollet är apolitiskt och ger inte specifika privilegier till presidenten eller andra aktörer. Ledare bör ha samma privilegier som vanliga människor för att driva utvecklingen uppåt istället för att lämna vissa på toppen och andra på botten. Bör alla ha samma valuta, oavsett sin sociala status? Det är viktigt att tänka på vilken värld vi vill lämna till våra barn. Vi önskar att lämna en öppen värld där de är fria att göra vad de vill med sina pengar.

Bitcoin är viktigt och bör inte betraktas som bara ett chansspel. Det är avgörande att fortsätta ställa frågor om Bitcoin.

### Bitcoin: ett revolutionerande protokoll

![Slutsats](https://youtu.be/BoZL_D7uLAg)

Som vi har sett i det tidigare kapitlet är Bitcoin-protokollet neutralt gentemot alla sina användare. Tack vare konsensusregler och kryptografi kan vi oåterkalleligt registrera transaktioner i en global offentlig huvudbok och garantera överföring av monetära värden utan någon betrodd tredje part. Infrastrukturen på andra nivån (och snart även tredje nivån, med RGB) möjliggör nätverksskalbarhet och utveckling av nya funktioner, särskilt för att hantera skalningsproblem.

Bitcoin har alla nödvändiga egenskaper för att vara en effektiv och sund valuta: delbar, omedelbart transportabel, omöjlig att censurera, försumbar kostnad för verifiering och med en penningpolitik som redan är fastställd för århundraden framöver med dessa 21 miljoner enheter. Bitcoin är pseudonymt och kan utbytas var som helst i världen utan någon auktorisation från någon enhet, du behöver bara ha dina egna privata nycklar - som det heter "Inte dina nycklar, inte dina bitcoins".

Bitcoin antas av olika grupper av människor, från kryptografer till libertarians till traditionella företag och till och med ett land. Men Bitcoin är för alla, och antalet användare ökar, liksom antalet Bitcoin-noder som fungerar som förvaltare av transaktionshistoriken och säkerställer dess decentralisering.

Bitcoin kan inte längre stoppas och kan inte längre censureras. Det är en fredlig revolution för att förändra det monetära systemet och möjliggöra finansiell inkludering. Användare kan skaffa Bitcoins genom att acceptera dem som betalning eller genom att köpa dem via reglerade eller oreglerade plattformar. Bitcoins kan lagras i plånböcker, mobilapplikationer eller fysiska enheter. Ingen betrodd mellanhand i Bitcoin, Bitcoin förespråkar transparens, frihet och individuellt ansvar - som det heter "Lita inte, verifiera".

Förändring av det finansiella systemet kräver förändring av valutan. Satoshi skapade Bitcoin 2008 för att föreslå ett försök till detta. Att ha tillgång till enkel och "magisk" pengar korrumperar. Bitcoin är därför ett alternativ för att bygga ett nytt neutralt monetärt system. Bitcoin möjliggör frigörelse från banksystemet. Det är ett socialt fenomen som leder oss att delta i en fredlig revolution. Är du redo att ansluta dig?

## Tack och fortsätt gräva i kaninhålet

### Gå vidare

![Tack och fortsätt gräva i kaninhålet](https://youtu.be/A2P5GdkgB-M)

Grattis till att ha slutfört denna BTC 101-kurs! Jag hoppas innerligt att du har haft nytta av den och att den har öppnat dörrar för dig. Din upptäckt av bitcoin har bara börjat, och jag uppmanar dig att utforska alla de andra kurser som finns tillgängliga vid universitetet.

- [BTC 102](https://sovereignuniversity.org/course/btc102/fr) kommer att hjälpa dig att skapa din bitcoin-plan
- [LN 201](https://sovereignuniversity.org/course/ln201/fr) och [LN 202](https://sovereignuniversity.org/course/ln202/fr) kommer att låta dig upptäcka Lightning Network, ett betalningsnätverk på andra nivån
- [ECON 201](https://sovereignuniversity.org/course/econ201/fr) kommer att täcka österrikisk ekonomi
- [SECU 101](https://sovereignuniversity.org/course/secu101/fr) kommer att låta dig uppdatera din digitala säkerhet
- [MINAGE 201](https://sovereignuniversity.org/course/min201/fr) för att lära dig mer om gruvdrift
- och många fler...

## Stöd oss

Den här kursen, liksom allt innehåll på detta universitet, har erbjudits gratis av vår gemenskap. För att stödja oss kan du dela det med andra, bli medlem i universitetet och till och med bidra till dess utveckling via [vår GitHub](https://github.com/DecouvreBitcoin/sovereign-university-data). På hela teamets vägnar, tack!

## Observera utbildningen

Ett betygssystem för utbildningen kommer snart att integreras i denna nya E-learning-plattform! Tills vidare, tack så mycket för att du tar kursen och om du tyckte om den, överväg att dela den med andra.

Ett stort tack till våra Patreon-supportrar, medlemmar och donatorer för deras ekonomiska stöd, tack till personerna som delar och tack till dem som gjorde denna utbildning möjlig: Rachel, Muriel, StackinSat-teamet, JohnOnChain, Fanis, Guillaume, Lounes, korrekturläsarna och granskarna.
