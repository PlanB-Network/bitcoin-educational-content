...
Dalam menu "*Privacy*" (Privasi), Anda dapat mengaktifkan atau menonaktifkan berbagai fitur (hati-hati, beberapa fitur dapat mengekspos IP Address Anda). Saya juga merekomendasikan untuk mengaktifkan opsi "*Lock App*" (Mengunci app), yang memerlukan autentikasi untuk mengakses aplikasi.
![Image](assets/fr/09.webp)

Pada menu "*Notification*" (Notifikasi), Anda akan menemukan pilihan antara "*Fast Mode*" dan "*Slow Mode*" (lihat bagian tutorial sebelumnya). Anda juga dapat menyesuaikan notifikasi agar sesuai dengan preferensi Anda.
![Image](assets/fr/10.webp)

Terakhir, masuk ke menu "*Appearance*" (Penampilan) untuk menyesuaikan Interface dengan selera Anda. Menu "*Recovery Password*" (Pemulihan kata sandi) memungkinkan Anda untuk mengambil frasa Mnemonic jika Anda ingin membuat cadangan baru.
...
Tersedia beberapa opsi. Jika Anda ingin membuat atau bergabung dengan grup, pilih "*Create Group*" (Buat grup) atau "*Join Community*" (Gabung Komunitas).
![Image](assets/fr/13.webp)

Jika Anda ingin seseorang menambahkan Anda sebagai kontak, Anda dapat meminta mereka memindai ID Session Anda sebagai kode QR.
![Image](assets/fr/14.webp)

Untuk mengirim informasi Anda dari jarak jauh, klik "*Invite a Friend"*" (Undang teman). Anda kemudian dapat menyalin ID Session Anda dan mengirimkannya melalui saluran komunikasi lain. Anda juga dapat mengambil informasi ini dengan mengeklik foto profil Anda dari halaman utama.
![Image](assets/fr/15.webp)

Jika Anda memiliki ID Session orang lain dan ingin menambahkannya, klik "*New Message*" (Pesan baru).
...
Kemudian kirimkan pesan singkat ke orang ini.
