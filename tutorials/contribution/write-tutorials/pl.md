...
Dwie główne sekcje naszej platformy to kursy i samouczki. Kursy zapewniają teoretyczne zasoby edukacyjne, podczas gdy samouczki oferują praktyczne treści pokazujące, jak korzystać z określonego narzędzia (na przykład Hardware Wallet lub oprogramowania) lub określonej praktyki (takiej jak zabezpieczanie frazy Mnemonic lub sprawdzanie autentyczności oprogramowania).
...
## Jak mogę zaproponować nowy kurs?


Jeśli masz pomysł na kurs Bitcoin, którego nie ma jeszcze na platformie i chciałbyś go napisać, możesz skontaktować się z nami pod następującym adresem Address:


contact@planb.network


W wiadomości prosimy o krótkie przedstawienie się i opisanie pomysłu na kurs. Jeśli masz już pomysł na strukturę kursu, dołącz również poszczególne rozdziały. Skontaktujemy się z Tobą tak szybko, jak to możliwe, aby wyjaśnić, jak postępować i, jeśli to konieczne, omówić strukturę kursu.
...
Poszukujemy przede wszystkim samouczków dotyczących narzędzi związanych z Bitcoin lub jego ekosystemem. Treści te można podzielić na sześć głównych kategorii:
...
Przedstaw się krótko i określ konkretną treść, którą chciałbyś napisać, a także język, w którym chciałbyś pisać, wysyłając wiadomość na kanale "Ogólne". Członek zespołu utworzy wówczas zgłoszenie na GitHub odpowiadające twojemu przyszłemu wkładowi.


Jeśli nie masz konta Telegram i wolisz go nie zakładać, możesz również skontaktować się z nami za pośrednictwem poczty elektronicznej pod następującym adresem Address
