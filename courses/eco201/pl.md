...
Ważne jest, aby pamiętać, że cherry-picking, czyli selektywny wybór danych w celu ustalenia relacji między zmiennymi, jest w ekonomii metodą nienaukową i nierygorystyczną. Na przykład kreacja pieniądza niekoniecznie powoduje inflację, do zrozumienia złożonych mechanizmów ekonomicznych niezbędne jest bardziej zniuansowane podejście. Aksjomaty odgrywają kluczową rolę w austriackim rozumowaniu ekonomicznym. Są to elementy fundamentalne, z których można wyciągać logiczne wnioski. Ważne jest jednak, aby zdać sobie sprawę, że precyzyjne prognozowanie przyszłości w ekonomii jest często trudne ze względu na złożoność zjawisk gospodarczych i nieodłączną niepewność.
