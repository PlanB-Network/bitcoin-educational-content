...
#### 1.2.3. Instalar o Node.js e o npm via NVM
...
#### 1.2.6. Teste das peras com Keet
...
### 1.3. Como instalar o Pears no Windows


A instalação do Pears no Windows é tão simples quanto no Linux, mas requer algumas ferramentas específicas.


*Se estiver a utilizar Linux e já tiver instalado o Pears, pode passar diretamente para o **Passo 2**.*


#### 1.3.1. Abrir o PowerShell como Administrador
...
#### 1.3.5. Instalar o Pears com o npm
...
#### 1.3.6. Verificar e inicializar as peras
...
#### 1.3.7. Teste das peras com Keet
...
*Se estiver a utilizar Linux ou Windows e já tiver instalado o Pears, pode passar diretamente para o **Passo 2**.*


#### 1.4.1. Verificar os pré-requisitos do sistema
...
#### 1.4.3. Instalar o Node.js e o npm
...
#### 1.4.6. Teste das peras com Keet
...
## 2. Como utilizar o Plan ₿ Academy em peras
...
## 3. Como fazer o plano seed ₿ Academia de peras
