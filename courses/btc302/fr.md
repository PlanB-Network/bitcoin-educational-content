...
Cependant, il est évident qu'**il est plus pertinent d'unir ses forces plutôt que de multiplier les communautés proches ; et donc, de diminuer la capacité d'impact de chacune**. En ce sens, créer une nouvelle communauté dans une ville en possédant déjà une peut créer une forme de concurrence, même involontaire.
...
- À Saint-Malo, l'hermine - emblême de la ville - est mise en valeur :
...
D'autres CMS ou plateformes permettent également de créer des sites internet. Bien que certaines soient plus simples de par leur interface agréable, les sites internet qui en sortent sont également bien moins personnalisables. **WordPress semble donc être le plus pertinent pour se lancer**.
