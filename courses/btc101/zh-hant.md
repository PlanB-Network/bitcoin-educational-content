...
對於一些人來說，比特幣被定義為像[菌絲體]一樣的真菌實體(https://brandonquittem.com/bitcoin-is-the-mycelium-of-money/)，而另一些人則把它描述為[黑洞](https://dergigi.com/)。無論你愛它還是恨它，比特幣繼續存在著，以每 10 分鐘產出一個區塊的節奏，持續跳動，如同新貨幣體系的心跳。
...
比特幣擁有成為高效健康貨幣的所有必要特徵：可分割、可即時傳輸、不可檢查、驗證成本可忽略不计，且貨幣政策已設定為未來幾個世紀的 2100 萬個單位。比特幣是假名的，可以在世界任何地方進行交換，不需要任何實體的授權。您只需要持有自己的私鑰，並記住「不是您的鑰匙，就不是您的比特幣」這句話。
