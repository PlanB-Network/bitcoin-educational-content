...
Nel contesto generale della crittografia e dell'informazione, l'entropia è una misura quantitativa dell'incertezza o dell'imprevedibilità associata ad una fonte di dati o ad un processo casuale. In altre parole, l'entropia misura quanto sia difficile prevedere o indovinare informazioni.
Nel contesto specifico di chain analysis (pratica che comprende tutti i metodi utilizzati per tracciare il flusso dei bitcoin sulla blockchain), l'entropia è anche il nome di un indicatore, derivato dall'entropia di Shannon e [inventato da LaurentMT](https://gist.github.com/LaurentMT/e758767ca4038ac40aaf), che viene calcolato con lo strumento di Boltzmann.
