...
> **⚠️ HITNO BEZBEDNOSNO OBAVEŠTENJE (jul 2026) — Coldcard novčanici se aktivno prazne.** Greška u firmveru pri generisanju seed-a na Coldcard uređajima omogućava napadačima da pronađu vašu seed frazu bez ikakve akcije s vaše strane. **Pogođeni su svi Coldcard modeli: Mk3, Mk4, Mk5 i Q.** Dana 30. jula 2026. ukradeno je oko 594 BTC iz približno 500 novčanika, a napad i dalje traje. Bezbednim se smatraju samo novčanici generisani metodom bacanja kockica, i to samo ako ste bacili najmanje 50 kockica. Ako ne znate, ne sećate se ili niste sigurni kako je vaš seed generisan, smatrajte ga kompromitovanim i **odmah premestite svoja sredstva** u novčanik čiji seed nije generisan na Coldcard-u. Pratite zvanična obaveštenja kompanije Coinkite. Pogledajte naš poseban vodič za migraciju:
