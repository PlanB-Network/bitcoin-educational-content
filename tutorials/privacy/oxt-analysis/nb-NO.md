...
Andre verktøy har blitt utviklet for å møte personvernsbehov i mer spesifikke bruksområder. For eksempel har vi [PayJoin](https://planb.academy/tutorials/privacy/on-chain/payjoin-848b6a23-deb2-4c5f-a27e-93e2f842140f), en slags mini-CoinJoin, som involverer kun to deltakere og er basert på en struktur som tillater betaling.
...
Utover PayJoin og CoinJoin, finnes det mange andre Bitcoin transaksjonsstrukturer som enten blokkerer kjedeanalyse eller bedrar den. Blant disse, kunne jeg nevne [Stonewall](https://planb.academy/tutorials/privacy/on-chain/stonewall-033daa45-d42c-40e1-9511-cea89751c3d4) og [StonewallX2](https://planb.academy/tutorials/privacy/on-chain/stonewall-x2-05120280-f6f9-4e14-9fb8-c9e603f73e5b) transaksjoner, som tillater enten å lage en fleksibel mini Coinjoin eller å imitere en fleksibel mini Coinjoin. Det finnes også [Ricochet](https://planb.academy/tutorials/privacy/on-chain/ricochet-e0bb1afe-becd-44a6-a940-88a463756589) transaksjoner som simulerer en endring av eierskap av bitcoins ved å gjøre en mengde falske overføringer til seg selv.
