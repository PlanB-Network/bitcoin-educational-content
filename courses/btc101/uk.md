...
Сатоші Накамото випустив протокол Біткоїну в січні 2009 року, який з тих пір еволюціонував завдяки зростаючій спільноті розробників, майнерів та користувачів вузлів Біткоїну. Зберігаючи власну копію блокчейну Біткоїн, публічного реєстру всіх транзакцій Біткоїну, ці вузли можуть забезпечити достовірність транзакцій відповідно до правил консенсусу Біткоїну. Це включає забезпечення того, що майнери виробляють дійсні блоки, які містять тисячі непідтверджених транзакцій.
