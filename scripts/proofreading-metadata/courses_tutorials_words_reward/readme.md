This script is used to get the word count of all the courses and tutorials in the repo, in order to extract all the rewards for any language factor. It inserts the results in an Excel file.
