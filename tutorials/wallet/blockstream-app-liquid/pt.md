...
- No ecrã inicial do Wallet, clique no separador "Settings" (Definições), depois em "Wallet Details" (Detalhes do Wallet) e copie a zPub ([extended public key](https://planb.academy/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f):
