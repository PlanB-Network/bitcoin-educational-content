...
Bitcoini töötas välja isik (või rühm), kes kasutas pseudonüümi Satoshi Nakamoto. 31. oktoobril 2008 jagas ta oma mudelit kirjeldavat valget raamatut vähetuntud interneti e-posti meililisti kaudu. 8. jaanuaril 2009 rakendas ta oma kontseptsiooni, avaldades tarkvara lähtekoodi ja käivitades võrgu ahela esimeste plokkide kaevandamise teel. Soovides meelitada kriitilist hulka kasutajaid, tutvustas ta oma loomingut erinevate suhtluskanalite kaudu.
...
Enne kui sukeldume Bitcoin'i loomise tegelikku lugu [Satoshi Nakamoto](https://planb.academy/resources/glossary/nakamoto-satoshi) poolt, on asjakohane arutada, mis seda eelnes. Käsitleme teemat kolmes etapis: esiteks tutvustame Chaumiani digitaalse sularaha kontseptsiooni, mida tavaliselt nimetatakse _[eCash](https://planb.academy/resources/glossary/ecash-david-chaum)_; seejärel räägime era-valuutadest, mis põhinevad tsentraliseeritud süsteemidel nagu e-gold; lõpuks kirjeldame tehnilisi mudeleid, mis kujutati ette enne Bitcoin'i robustse hajutatud süsteemi rakendamist.
Alustame esimesest kontseptsioonist, eCash. eCash pärineb David Chaumi tööst, kes on Ameerika arvutiteadlane ja krüptograaf, sündinud 1955. aastal, peetakse anonüümse suhtluse valdkonna pioneeriks ja [krüptopunkide](https://planb.academy/resources/glossary/cypherpunks) eelkäijaks. Ta andis olulise panuse [krüptograafia](https://planb.academy/resources/glossary/cryptography) arengusse 1980. aastatel. Ta töötas välja oma digitaalse sularaha mudeli (tuntud kui "Chaumiani") samal ajal ja üritas seda 1990. aastatel oma ettevõtte DigiCash kaudu rakendada.
...
[Digitaalallkirjad](https://planb.academy/resources/glossary/digital-signature) seevastu tuginevad privaatvõtme kasutamisele allkirjavõtmena ja avaliku võtme kasutamisele kinnitamisvõtmena. Kasutaja genereerib võtmepaari, allkirjastab sõnumi privaatvõtmega ja saadab selle oma korrespondentidele, kes saavad selle autentsust kontrollida avaliku võtmega. Seega ei pea nad kunagi teadma privaatvõtit.
![Digitaalallkiri](assets/et/002.webp)

Asümmeetriline krüptograafia avastati 1970. aastatel mitmete uurimisrühmade poolt sõltumatult. Esimestena esitlesid oma tulemusi siiski Whitfield Diffie ja Martin Hellman, kaks Stanfordi ülikooli krüptograafi. 1976. aasta novembris avaldasid nad artikli pealkirjaga „ [New Directions in Cryptography](https://ee.stanford.edu/~hellman/publications/24.pdf) “ ajakirjas *IEEE Transactions on Information Theory*, milles kirjeldati võtmevahetusalgoritmi (mõeldud salajaste võtmete edastamiseks sümmeetriliseks krüpteerimiseks) ning digitaalallkirja meetodit. Artikli sissejuhatuses kirjutasid nad:
...
Asümmeetrilise krüptograafia avastamine motiveeris ka ühesuunaliste funktsioonide loomist, mida iseloomustab kujutise (edasisuunal) arvutamine väga lihtsaks ja eelkujutise (tagasisuunal) saamine väga raskeks. Eelkõige viis see esimeste krüptograafiliste [räsifunktsioonide](https://planb.academy/resources/glossary/hash-function) arendamiseni, mis muutsid muutuva suurusega sõnumi fikseeritud suurusega kokkuvõtteks. Aastatel 1989 kuni 1991 kujundas Ronald Rivest MIT jaoks mitu räsialgoritmi (MD2, MD4 ja MD5).
Bitcoini põhilised krüptograafilised elemendid pärinevad sellest uurimusest. [ECDSA](https://planb.academy/resources/glossary/ecdsa) allkirjastamise skeem, mis võimaldab traditsioonilise tehingu kulutamise autoriseerimist, loodi 1992. aastal NISTi jaoks. [SHA-256](https://planb.academy/resources/glossary/sha256) räsifunktsioon, mida kasutatakse protokollis mitmes kohas, avaldati 2001. aastal osana SHA-2 algoritmide komplektist, mille tegi avalikuks NSA. Lisateavet selle teema kohta leiate kursuselt CYP201 mida esitleb Loïc Morel.
...
Seejärel inspireeris eCash krüptopunkte, kes arendasid oma mudeleid nagu [b-money](https://planb.academy/resources/glossary/bmoney), [bit gold](https://planb.academy/resources/glossary/bit-gold) ja [RPOW](https://planb.academy/resources/glossary/rpow). Nad lisasid [töötõenduse](https://planb.academy/resources/glossary/proof-of-work) ja teisi elemente, mis hiljem leiti Bitcoinist. Neid kontseptsioone uurime 3. peatükis.

Lõpuks mõjutas David Chaumi mudel oluliselt Satoshi Nakamotot, kui ta arendas oma valuuta kontseptsiooni. Seda tõendavad mitmed viited [valges raamatus](https://github.com/PlanB-Network/bitcoin-educational-content/blob/dev/courses/his201/assets/bitcoin-20090324.pdf) (pealkiri, probleemi kirjeldus jaotises 2, PDF-i nimi [saadetud](https://gwern.net/doc/bitcoin/2008-nakamoto) Wei Daile augustis 2008), samuti tema privaatsed ja avalikud sekkumised. Selles mõttes on eCash Bitcoin'i peamine eelkäija, kuigi see pole ainus.
...
Meeste nägemused läksid aga lahku. Bit goldis tähendas digitaalse kulla tükkide tootmisviis, et need ei olnud asendatavad, st neid ei saanud omavahel segada: seetõttu tuli neid hinnata süsteemivälisel turul, et need saaksid olla aluseks tegelikule homogeensele arvestusühikule. Bit gold mudel oli seega mõeldud arveldussüsteemiks, mis võimaldas hallata haruldast reservvaluutat ja mille kohale ehitatakse vaba pangandusmajandus, kasutades võimalusel Chaumi mudelit. Seega, 2008. aasta aprillis, oma blogi [kommentaaris](https://web.archive.org/web/20171227190431/http://unenumerated.blogspot.com/2008/04/bit-gold-markets.html?showComment=1207799580000#c3741843833998921269), palus Nick Szabo endiselt abi oma kontseptsiooni rakendamiseks. Seda rakendamist aga kunagi ei toimunud.
...
Bitcoin koondab tõepoolest kõik need kontseptsioonid geniaalsesse kooslusesse. See põhineb digitaalsel allkirjal, mis tuleneb Diffie ja Hellmanni poolt 1976. aastal pakutud asümmeetrilisest krüptograafiast. See on "elektrooniline raha", nagu David Chaumi 90ndatel rakendatud eCash mudel ette nägi. Oma uuendusliku konsensuse algoritmiga lahendab see tugevalt Bütsantsi kindralite probleemi, mille tõstatasid Lamport, Shostak ja Pease 1982. aastal. Oma plokiahela haldamisega võrdõigusvõrgus on see "jaotatud ajatempli serveri" vorm, mis vaatab üle Haberi ja Stornetta 1991. aasta kontseptsiooni. [Tehinguplokkide](https://planb.academy/resources/glossary/block) valimiseks ja üksuste tootmiseks kasutab see töötõendit, kasutades protsessi, mis sarnaneb Hashcash'iga, mida pakkus välja Adam Back 1997. aastal. Lõpuks, oma kujunduses, meenutab see b-money, bit gold, RPOW ja Ripple projekte, millele Satoshi Nakamoto ühel või teisel viisil austust avaldas.
...
Tänu sellele raskusastme kohandamisele saab Bitcoinil seega olla rahapoliitika, mis tähendab, et protokolli poolt emiteeritud uute ühikute hulk saab olla ette määratud. Algselt on kavandatud, et rahaline emissioon on püsiv, et julgustada tootvaid sõlmi panustama oma arvutusvõimsust võrku, ja [tehingutasusid](https://planb.academy/resources/glossary/transaction-fees) ei ole. Nagu Satoshi Nakamoto kirjutab valge raamatu "Incentive" (Stiimul) jaotises [valge raamat](https://github.com/PlanB-Network/bitcoin-educational-content/blob/dev/courses/his201/assets/bitcoin-20081003.pdf):
...
See omadus, mille Satoshi kinnitas [postiloendis](https://www.metzdowd.com/pipermail/cryptography/2008-November/014831.html) ja [oma privaatses kirjavahetuses](https://mmalmi.github.io/satoshi/#email-3), ei jää märkamata James A. Donaldile. 9. novembril [kritiseerib](https://www.metzdowd.com/pipermail/cryptography/2008-November/014837.html) ta "tööd, mis seisneb selles, et jälgitakse, kes mida omab" (st [kaevandamine](https://planb.academy/resources/glossary/mining)) selle eest, et see on "makstud seigniorage'iga" ja "nõuab inflatsiooni", kuigi ta märgib, et "ennustatav inflatsioon on vähem vastuvõetav kui inflatsioon, mis aeg-ajalt kõigutatakse, et ümber jaotada rikkust ühelt hääletusplokilt teisele." Lisaks [märgib](https://www.metzdowd.com/pipermail/cryptography/2008-November/014841.html) ta, et kaevandussõlm, mis "ignoreerib kõiki kulutusi, millest ta ei hooli", ei kannata "mingeid negatiivseid tagajärgi", tuues sellega esile tsensuuri probleemi.
Need märkused panid ilmselt Satoshi mõistma, et ta võiks rakendada [tehingutasu mehhanismi](https://www.metzdowd.com/pipermail/cryptography/2008-November/014842.html), mis lahendab mõlemad probleemid, asendades uute ühikute loomise ja [julgustades](https://www.metzdowd.com/pipermail/cryptography/2008-November/014843.html) [kaevureid](https://planb.academy/resources/glossary/miner) "kaasama kõik tasulised tehingud, mida nad saavad." (_originaal: "nodes would have an incentive to include all the paying transactions they receive."_)
Samal ajal ajendasid tema vestluskaaslaste küsimused teda jagama oma mudeli lähtekoodi. 16. novembril saatis Satoshi koodi Hal Finneyle, James A. Donaldile ja Ray Dillingerile. 17. novembril, vastuseks James A. Donaldile meililistis, [kirjutas](https://www.metzdowd.com/pipermail/cryptography/2008-November/014863.html) ta, et oli saatnud talle "peamised failid," mis olid "hetkel saadaval päringu alusel" ja et nende "täielik avaldamine" toimub "varsti." (_originaal: "I sent you the main files. &nbsp;(available by request at the moment, full release soon)"_) Selles koodi osas, mis [avalikustati](https://bitcointalk.org/index.php?action=printpage;topic=382374.0) 2013. aastal Ray Dillingeri poolt, võib näha, et kõik Bitcoini aluselemendid on olemas: plokiahel (siis veel nimetatud "ajakett"), töötõend, mündi esitlusmudel ([UTXO](https://planb.academy/resources/glossary/utxo)), tehingute programmeeritavus, tehingutasud ja [poolitamine](https://planb.academy/resources/glossary/halving).
...
2009. aasta 1. jaanuaril kell 19:27 avaldas Satoshi Nakamoto tarkvara esimese versiooni (numbriga 0.1.0) Metzdowd.com meililistis. C++ lähtekood avaldati avatult MIT litsentsi alusel, nii et igaüks võis seda kopeerida, muuta ja kasutada, nagu soovis. See sisaldab märkimisväärselt andmeid [algsest plokist](https://planb.academy/resources/glossary/genesis-block), ahela esimesest plokist, millest hiljem tuleb laiendada. Tarkvara töötab ainult Windowsis. Oma [e-kirjas](https://www.metzdowd.com/pipermail/cryptography/2009-January/014994.html) teatas Satoshi:
...
16 . jaanuaril kordab Satoshi seda «pikaajalise investeeringu» ideed meililistile saadetud e-kirjas, kus ta kirjeldab Bitcoini potentsiaalseid kasutusjuhtumeid. Ta [väidab](https://www.metzdowd.com/pipermail/cryptography/2009-January/015014.html) siis, et «võib olla mõistlik hankida neid juhuks, kui see levima hakkab» ja et «kui piisavalt inimesi arvab samamoodi, saab sellest isetäituv ennustus». Ta [kordas](https://p2pfoundation.ning.com/xn/detail/2003008:Comment:9562) seda väidet kuu aega hiljem, selgitades, et piiratud ühikute arv loob tõenäoliselt «positiivse tagasisideahela» selles mõttes, et «mida rohkem kasutajaid on, seda rohkem väärtus suureneb, mis võib meelitada ligi rohkem kasutajaid, kes soovivad kasvavast väärtusest kasu saada». Seetõttu on spekulatiivne element algusest peale olemas, eesmärgiga süsteem käivitada.
...
- "Kaitse end [fraktsionaalreservpangandusest](https://planb.academy/resources/glossary/fractional-reserves) ja keskpankade halbadest poliitikatest põhjustatud ebastabiilsuse eest. Bitcoini süsteemi rahapakkumise piiratud inflatsioon jaotub ühtlaselt (arvutusvõimsuse alusel) kogu võrgustikus, mitte ei monopoliseerita pankade poolt."
...
2009. aasta kevadel nägi samuti esmakordselt "[krüptoraha](https://planb.academy/resources/glossary/cryptocurrency)" sõna kasutuselevõttu, mida algselt kasutati Bitcoin'i viitamiseks. 11. mail kirjutas Satoshi Martti Malmile:
...
Sel ajal, kui kergeid rahakotte (tuntud kui "[SPV](https://planb.academy/resources/glossary/spv-node-light-node)") ei eksisteerinud, pidas Satoshi Nakamoto ise seda tüüpi tarkvara kasutamist vastuvõetavaks, kuigi see kasutus läks vastuollu Bitcoin'i südames oleva disintermediatsiooni põhimõttega. 18. mail 2010 [kirjutas](https://bitcointalk.org/index.php?topic=125.msg1149#msg1149) ta foorumis:
...
Pealegi ei ole Satoshi kaevandamise domineerimise langus pelgalt passiivne: ta ise aeglustab oma tootmist samal perioodil. Tõepoolest, Satoshi väljendatud eesmärk on, et kõik osaleksid: ta ei kaeva finantskasu saamiseks, vaid tagamaks võrgu toimimist, kuni stiimulid hakkavad mõjuma. Seega vähendab ta oma [hash rate'i](https://planb.academy/resources/glossary/hashrate) (sekundis tehtavate arvutuste arv) kolm korda selle kaevandamisperioodi jooksul: esimest korda 4,5-lt 2,5 MH/s juunis 2009, teist korda 2,5-lt 1 MH/s oktoobris ja kolmandat korda 1-lt 0 MH/s mais 2010. Siin on graafik tema hash rate'i arengust sellel perioodil ([Organofcorti](https://organofcorti.blogspot.com/2014/08/167-satoshis-hashrate.html)):
...
Gavin hakkas samuti tarkvara arenduses osalema, [rakendades](https://sourceforge.net/p/bitcoin/code/101/) Linuxis automaatset käivitamist süsteemi käivitamisel, keskendudes API-le (ta saaks [tunnustatud](https://bitcointalk.org/index.php?topic=570.msg5707#msg5707) selle parandamise eest versioonis 0.3.3) ja osaledes [testimisvõrgustiku](https://planb.academy/resources/glossary/testnet) väljatöötamises (mille ta [välja mõtles](https://bitcointalk.org/index.php?topic=240.msg2104#msg2104) 9. juunil). Ta vahetas Satoshi'ga privaatselt ideid, saades järk-järgult tema paremaks käeks, kuna Martti Malmi oli [väga hõivatud](https://mmalmi.github.io/satoshi/#email-191) oma uue täiskohaga tööga.
...
Gavin ja Satoshi parandavad ka mitu viga. Peamine neist on “*1 RETURN bug*” (1 TAGASTUS viga), skriptisüsteemi haavatavus, mis teeb võimalikuks bitcoinide kulutamise mis tahes aadressilt tänu spetsiifilisele skriptile. Sellest haavatavusest teatab ArtForz 28. juulil, kes selle asemel, et viga ära kasutada ja diskreetselt rikastuda, otsustab oma avastuse Satoshiga ja Gaviniga jagada. Satoshi kiirustab paranduse lisamisega tarkvarasse ([v0.3.6](https://bitcointalk.org/index.php?topic=626.msg6451#msg6451)) ja soovitab kõigil kasutajatel uuendada. Bitcoin pääseb seega hullemast. See haavatavus registreeritakse hiljem MITRE korporatsioonis identifikaatoriga [CVE-2010-5141](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2010-5141).
...
Samal ajal avaldatakse ka teisi algoritme. 9. septembril [jagab](https://bitcointalk.org/index.php?topic=1009.msg12264#msg12264) foorumi liige nimega nelisky oma CUDA-d kasutavat kaevandamisalgoritmi. 1. oktoobril [avaldab](https://web.archive.org/web/20101206143359/http://www.bitcoin.org/smf/index.php?topic=1334.0) keegi Momchil Georgiev, kes liitus foorumiga veebruaris ja kasutab pseudonüümi m0mchil, oma algoritmi (POCLBM), nimetades seda „OpenCL kaevandajaks massidele“.
...
1 . oktoobril [avaldab](https://bitcointalk.org/index.php?topic=1333.msg14840#msg14840) Momchil API muudatuse, mis võimaldab kliendisõlmedel uue funktsiooni `getwork` kaudu kandidaatploki alla laadida ja lahenduse leidmisel tagastada töö tõendi. Ta kirjutab, et see parandus „avab tee välistele Bitcoini kaevandajatele“ ja „võimaldab ühe kliendi jaoks paigaldada mitu kaevandajat“.

2 . oktoobril pakkus puddinpop välja [selle tüüpi mudeli](https://bitcointalk.org/index.php?topic=1458.msg16906#msg16906). Kaevuri arvutusvõimsust mõõdetakse meta-hash'iga, mis on puhvri jäljend, mis sisaldab iga ploki hash'i esimest baiti. Server saab seejärel perioodiliselt kontrollida, kas klient teostab arvutust nagu määratletud. See mudel on keeruline ja [ei võimalda vigu](https://bitcointalk.org/index.php?topic=1458.msg17015#msg17015).
...
Mõlemad hindamismudelid rakendatakse detsembris. Esiteks rakendatakse puddinpopi kontseptsiooni 1. detsembril kasutaja doublec poolt, kes [kutsub](https://bitcointalk.org/index.php?topic=2027.msg25859#msg25859) inimesi ühinema tema grupeeritud kaevandamise serveriga. Nii moodustunud grupeering [toodab](https://bitcointalk.org/index.php?topic=2027.msg26688#msg26688) oma esimese ploki (95 420) 4. detsembril. Pärast täiendava ploki tootmist mõni päev hiljem [peatatakse](https://bluishcoder.co.nz/bitcoin-pool/) doublec server 15. kuupäeval. Teenus sulgeb lõplikult oma uksed 17. kuupäeval, kuna esile kerkib palju tõhusam kooperatiiv: BitcoinCZ Mining.

Pärast foorumi küsitlemist otsustab Marek Palatinus rakendada oma kaevanduskooperatiivi mudeli ja teeb eriti katseid testvõrgus. Ta tagab ka selle, et server oleks kättesaadav nii CPU kaevandajatele (kes kasutavad Jeff Garziku tarkvara) kui ka GPU kaevandajatele (kes kasutavad Momchili ja puddinpopi kliente).
...
Seega ei takista Satoshi liidriroll kriitika tekkimist. Seepärast tekivad kogukonnas järk-järgult pinged alates juulist. Näiteks ilmnevad vastuväited augustis toimunud hoiatussüsteemi [juurutamise](https://bitcointalk.org/index.php?topic=898.msg10745#msg10745) või novembris tehtud Momchili `getwork`-funktsiooni [muutmise](https://bitcointalk.org/index.php?topic=1901.msg24050#msg24050) puhul. Frustratsiooni selle diktaatorliku otsustusprotsessi üle väljendatakse IRC-s mõnikord [palju avatumalt](https://buildingbitcoin.org/bitcoin-dev/log-2010-11-24.html#l-384).
