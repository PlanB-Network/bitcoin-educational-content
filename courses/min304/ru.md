---
name: Отапливайте свой дом, добывая биткойны
goal: Переделать Antminer S9 в самодельный обогреватель для домашнего майнинга с пошаговой настройкой.
objectives:
  - Понять основы майнинга биткойна
  - Безопасно приобрести подержанный Antminer S9
  - Постройте самодельный обогреватель для домашнего майнинга
  - Настроить BraiinsOS+ и присоединиться к майнинг-пулу
---

# Создайте свой первый DIY-биткоин-обогреватель




Этот курс построен вокруг Attakai — практического DIY-проекта, который превращает использованный майнер S9 в домашний биткоин-обогреватель.

Вы начнете с краткого обзора майнинга Биткойна и реалий майнинговой индустрии, затем перейдете прямо к сборке: поиск подходящего оборудования, прошивка и настройка BraiinsOS+, настройка сети, замена вентиляторов, присоединение к майнинг-пулу и оптимизация производительности с точки зрения тепла, шума и эффективности.

Пошаговые руководства проведут вас через весь процесс, чтобы вы могли построить Attakai дома и намайнить свои первые сатоши, обогревая при этом свое пространство.
...
Добро пожаловать в MIN 304, курс по проекту Attakai. Jim и Rogzy познакомят вас с основными элементами майнинга Bitcoin, а затем шаг за шагом помогут вам в создании вашего Attakai, самодельной системы домашнего отопления, изготовленной из использованного S9. Мы надеемся, что курс вам понравится и вы отправитесь в приключение домашнего майнинга!

Этот курс погружает вас в индустрию майнинга Биткоина, предоставляя как теоретические, так и практические знания. Независимо от того, являетесь ли вы новичком или уже знакомы с темой, этот курс поможет вам понять экономические и технические аспекты, связанные с майнингом, а также выполнить практический проект по повторному использованию ASIC для домашнего отопления.

**Раздел 2: Майнинг, его работа, его индустрия и его проблемы**
В этом разделе мы предоставим вам углубленное понимание майнинга Биткоина. Мы рассмотрим технические аспекты работы майнинга, его роль в протоколе Биткоина, а также экономические и геополитические последствия. Вы также узнаете о сложных взаимоотношениях между ценой биткоина и хешрейтом, а также о проблемах, связанных с суверенитетом и регулированием этой индустрии.

**Раздел 3: Домашний майнинг и повторное использование тепла**  
Далее мы перейдем к практическому применению концепции Attakai, которая направлена на демократизацию домашнего майнинга путем преобразования использованных майнеров S9 в устройства для домашнего отопления. Вы узнаете, как приобрести и модифицировать подержанный ASIC и подготовить необходимое оборудование для аппаратных изменений.

**Раздел 4: Модификация программного обеспечения Antminer S9**
Здесь вы научитесь настраивать свой Antminer S9 для домашнего использования. Мы проведем вас через шаги настройки моста Wi-Fi/Ethernet, сброса устройства, установки BraiinsOS+ и оптимальной настройки для майнинга.

**Раздел 5: Модификация вентиляторов**
Чтобы оптимизировать использование вашего Antminer S9 в качестве дополнительного обогревателя, этот раздел научит вас, как заменять вентиляторы блока питания и основные вентиляторы. Эти модификации необходимы для снижения шума и повышения тепловой эффективности устройства.

**Раздел 6: Настройка DIY-отопления**
Наконец, вы узнаете, как присоединиться к пулу майнинга и оптимизировать производительность вашего Antminer S9. Вы откроете для себя, как достичь оптимальной энергоэффективности и эффективно майнить свои первые сатоши.

Готовы открыть для себя мир майнинга Биткоина и справиться с практическим вызовом Attakai? Приступим!


# Майнинг, его работа, его индустрия и его проблемы
...
Для упрощенного объяснения концепции [майнинга](https://planb.academy/resources/glossary/mining) можно использовать соответствующую аналогию: аналогию с пазлом. Так же, как и пазл, майнинг - это сложная задача для выполнения, но легко проверяемая после завершения. В контексте майнинга Биткойна, [майнеры](https://planb.academy/resources/glossary/miner) стремятся быстро решить цифровой пазл. Первый майнер, решивший пазл, представляет свое решение всей сети, которая затем может легко проверить его правильность. Эта успешная проверка позволяет майнеру подтвердить новый [блок](https://planb.academy/resources/glossary/block) и добавить его в цепочку Биткойна. В знак признания за проделанную работу, которая требует значительных затрат, майнер вознаграждается определенным количеством биткойнов. Это вознаграждение служит финансовым стимулом для майнеров продолжать свою работу по подтверждению [транзакций](https://planb.academy/resources/glossary/transaction-tx) и обеспечению безопасности сети Биткойн.
...
Войны за размер блока выявили неопределенность и напряженность, присущие управлению сетью Биткойн. Хотя в настоящее время доминирующей цепью является [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core), дебаты об управлении и управлении сетью продолжаются.
...
Attakai, что в переводе с японского означает "идеальная температура", - это название инициативы, направленной на изучение майнинга биткойнов через повторное использование тепла, запущенной @jimzap21 совместно с Découvre Bitcoin.
...
![изображение](assets/software/014.webp)
...
![изображение](assets/software/015.webp)
...
![изображение](assets/software/016.webp)

### Система

![изображение](assets/software/017.webp)

### Быстрые действия

![изображение](assets/software/018.webp)

# Модификация вентиляторов
...
![image](assets/hardware/010.webp)
![image](assets/hardware/011.webp)
...
![image](assets/hardware/012.webp)
...
![image](assets/hardware/013.webp)
![image](assets/hardware/014.webp)
...
![image](assets/hardware/015.webp)
![image](assets/hardware/016.webp)
...
![изображение](assets/hardware/019.webp)
...
![изображение](assets/hardware/020.webp)
![изображение](assets/hardware/021.webp) 
...
![изображение](assets/hardware/022.webp)
...
![изображение](assets/hardware/023.webp)
![изображение](assets/hardware/024.webp)
![изображение](assets/hardware/025.webp)
...
![изображение](assets/hardware/026.webp)
![изображение](assets/hardware/027.webp)
...
- Linecoin: Преимущество Linecoin заключается в большом количестве предлагаемых функций, таких как подробная панель управления, возможность совершения выводов с использованием [Paynym](https://planb.academy/resources/glossary/paynym) (BIP 47) для лучшей защиты конфиденциальности, а также интеграция Telegram-бота и напрямую настраиваемых автоматизаций в мобильном приложении. Этот пул добывает только блоки Биткойн, но минимальная сумма для вывода остается высокой и составляет 100 000 сатоши. Мы рассмотрим интерфейс одного из этих пулов более подробно в следующей статье.
...
![изображение](assets/software/019.webp)

После создания аккаунта нажмите на "Connect To Pool"

Затем скопируйте адрес [Stratum](https://planb.academy/resources/glossary/stratum) и ваше имя пользователя:

![изображение](assets/software/020.webp)
...
![изображение](assets/software/021.webp)
