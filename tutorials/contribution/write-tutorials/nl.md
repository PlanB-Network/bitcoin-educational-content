...
description: Hoe stuur ik nieuwe inhoud naar Plan ₿ Network?
---
...
[Ontdek Plan ₿ Network opleidingen](https://planb.network/courses)
...
Wat u ook kiest, houd er rekening mee dat alle inhoud die gepubliceerd wordt op Plan ₿ Network gelicenseerd is onder een vrije [CC-BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) licentie. Deze licentie geeft iedereen toestemming om uw inhoud te kopiëren en eventueel aan te passen, op voorwaarde dat de originele bron naar behoren wordt gecrediteerd.


## 2 - Neem contact op met het Plan ₿ Network team
...
Om bij te dragen aan Plan ₿ Network heb je 3 opties, afhankelijk van je niveau van ervaring met GitHub:




- **Ervaren gebruikers**: Ga verder met je gebruikelijke methodes en raadpleeg gewoon de korte tutorial hieronder die de Plan ₿ Network repository bestandsstructuur, specifieke vereisten en werkwijze samenvat:
...
Kies een van deze drie opties op basis van je kennisniveau en ga aan de slag met het schrijven van je eerste Plan ₿ Network tutorial!