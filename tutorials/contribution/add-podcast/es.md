...
- Ve al [repositorio de GitHub de PlanB dedicado a datos](https://github.com/Plan ₿ Academy/bitcoin-educational-content/tree/dev/resources/podcasts) en la sección `resources/podcasts/`:
...
- Regresa a la carpeta `resources/podcast/` y selecciona la carpeta del podcast que acabas de crear en el commit anterior:
