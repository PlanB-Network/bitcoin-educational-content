...
Tässä video-opetuksessa käydään läpi Bitcoin Keeper Wallet:n ja Tapsignersin käyttöönotto ja käyttö perintösuunnitelman luomiseksi. Käymme läpi tapahtumien lähettämisen/vastaanottamisen, avainten hallinnan, varmuuskopioinnin ja paljon muuta.
...
- Bitcoin Keeper -sovelluksen lataus [täällä](bitcoinkeeper.app)
