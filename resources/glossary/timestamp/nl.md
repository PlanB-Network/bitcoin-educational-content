...
In het specifieke geval van Bitcoin worden tijdstempels gebruikt om de chronologie van transacties en blokken vast te stellen. Elk blok in Blockchain bevat een Timestamp die de geschatte tijd aangeeft waarop het is aangemaakt. Satoshi Nakamoto heeft het in zijn witboek zelfs over een "Timestamp server", om aan te geven wat we vandaag de dag "Blockchain" zouden noemen. De rol van tijdstempels op Bitcoin is het bepalen van de chronologie van transacties, zodat zonder tussenkomst van een centrale autoriteit bepaald kan worden welke transactie als eerste aankwam. Dit mechanisme stelt elke gebruiker in staat om te verifiëren of een transactie in het verleden niet heeft plaatsgevonden, en zo te voorkomen dat een kwaadwillende gebruiker een dubbele uitgave doet. Dit mechanisme wordt gerechtvaardigd door Satoshi Nakamoto in zijn Witboek met de beroemde zin: *"Deze standaard is gebaseerd op de Unix-tijd, die staat voor het totale aantal seconden dat is verstreken sinds 1 januari 1970."*


> ► *Bloktijdstempels zijn relatief flexibel op Bitcoin, want om een Timestamp als geldig te beschouwen, is het simpelweg noodzakelijk dat deze groter is dan de mediaan van de tijd van de 11 blokken die eraan voorafgaan (MTP) en kleiner dan de mediaan van de tijden die door de knooppunten worden geretourneerd (voor netwerk gecorrigeerde tijd) plus 2 uur.*