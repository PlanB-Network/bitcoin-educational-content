...
Para explicar de manera simplificada el concepto de la [minería](https://planb.academy/resources/glossary/mining), se puede utilizar una analogía relevante: la del rompecabezas. Al igual que un rompecabezas, la minería es una tarea compleja de realizar, pero fácil de verificar una vez completada. En el contexto de la minería de Bitcoin, los [mineros](https://planb.academy/resources/glossary/miner) se esfuerzan por resolver rápidamente un rompecabezas digital. El primer minero en resolver el rompecabezas presenta su solución a toda la red, que luego puede verificar fácilmente su validez. Esta verificación exitosa permite al minero validar un nuevo [bloque](https://planb.academy/resources/glossary/block) y agregarlo a la cadena de bloques de Bitcoin. Como reconocimiento a su trabajo, que implica costos significativos, el minero es recompensado con una cierta cantidad de bitcoins. Esta recompensa es un incentivo financiero para que los mineros continúen su trabajo de validación de [transacciones](https://planb.academy/resources/glossary/transaction-tx) y aseguren la red Bitcoin.
...
La centralización de la minería se considera un gran desafío. Grandes actores, como Foundry, dominan el mercado, lo que puede potencialmente llevar a la censura de transacciones. Esta centralización también puede hacer que la red sea vulnerable a ataques, como el [ataque del 51%](https://planb.academy/resources/glossary/51-percent-attack), donde un actor o grupo controla más del 50% del poder de hash de la red, lo que les permite controlar y manipular la red, a su vez está presente el riesgo de regulación, este se destaca en el caso que un país como Estados Unidos decidiera regular o prohibir ciertas transacciones de Bitcoin, esto podría tener un impacto considerable en la red, especialmente si gran parte del poder de hash está centralizado en ese país.
...
La guerra de los bloques puso de manifiesto la incertidumbre y la tensión inherentes a la gestión de la red Bitcoin. Aunque [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core) es actualmente la cadena dominante, el debate sobre la gobernanza y la administración de la red persiste.
...
Luego copia la dirección [Stratum](https://planb.academy/resources/glossary/stratum) y su nombre de usuario:
