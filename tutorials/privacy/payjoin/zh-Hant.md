...
PayJoin 的獨特之處在於它能夠 generate 一種乍看之下很普通的交易，但實際上是雙方之間的迷你 [CoinJoin](https://planb.academy/resources/glossary/coinjoin)。為了達到這個目的，交易結構讓收款人與實際寄款人一起參與輸入。收款人在交易中間包含了對自己的付款，這使得他們可以獲得付款。
