...
Logaritma diskrit juga digunakan dalam kriptografi kurva elips (ECC), termasuk dalam ECDSA (*Eliptic Curve Digital Signature Algorithm*). Dalam konteks kurva eliptik, masalah logaritma diskrit mencakup menemukan sebuah nilai skalar $k$ sedemikian rupa sehingga $k \cdot G = K$, di mana $G$ dan $K$ adalah titik-titik pada kurva, dan $\cdot$ merepresentasikan operasi perkalian titik. Dalam konteks Bitcoin, skrip dapat menggunakan ECDSA atau protokol Schnorr untuk mengunci UTXO. Keduanya bergantung pada ketidakmungkinan untuk menghitung logaritma diskrit.
