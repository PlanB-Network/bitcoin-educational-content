...
- `bc`: część czytelna dla człowieka (HRP);
- `1`: separator ;
- `q`: Wersja SegWit. To jest wersja 0;
- `c2eukw7reasfcmrafevp5dhv8635yuqa`: ładunek, w tym przypadku Hash klucza publicznego;
- `ys50gj`: suma kontrolna.