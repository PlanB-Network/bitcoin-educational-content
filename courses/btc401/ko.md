...
탈중앙화와 보안을 보장하려면 **Full node**를 실행하는 것이 필수적이지만, **간단결제인증(SPV) 노드를 사용하면 일부 보안을 희생하는 대신 더 가볍게 참여할 수 있습니다.
...
**프라이버시**와 **대체 가능성은 Bitcoin의 필수 기능입니다. 프라이버시는 억압적인 체제에서 사용자를 보호하고, 대체 가능성은 이력에 관계없이 모든 Bitcoin이 동등하다는 것을 보장합니다. 이를 통해 Bitcoin은 신뢰할 수 있고 공정한 형태의 화폐가 될 수 있습니다.
