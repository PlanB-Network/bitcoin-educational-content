...
幾個世紀以來，傳統借貸讓許多專案得以融資。然而，這種方式仍是緩慢、昂貴且不具包容性，尤其是對於那些無法使用穩固銀行基礎設施的人而言。



Bitcoin 協定的興起開啟了一個新的金融時代，同時也帶來了許多挑戰。其中一項挑戰是如何在不被迫出售 Bitcoin 的情況下獲得流動資金，從而失去其增長潛力。



結果就是 **Debifi**，一個將自己定位為銀行的現代替代品的平台。其目的很明確：結合傳統金融體系的優勢與 Bitcoin 所提供的自由，盡可能讓信貸變得簡單、透明。Debifi 這個名字就反映了這個願景：**分散式 Bitcoin 金融**，這個縮寫說明了分散式金融與 Bitcoin 創新的結合。
...
- **發放費**是在貸款發放時收取的一次性費用，以借款金額的某個百分比計算。這些費用涵蓋行政、營運及管理成本。





- 抵押品**是您存入以擔保貸款的資產**。在 Debifi 的案例中，抵押品是 Bitcoin (BTC)，借款人將其存入 Multisig 3/4 託管。
...
- 穩定幣是一種價值與穩定資產 (例如美元) 掛鉤的加密貨幣，可避免 **Bitcoin** 的波動性。舉例來說，1 USDC 永遠值 ~$1，因為它有法定儲備作為後盾。





- 貸款的 Loan-to-Value (LTV)** 比率決定您可以借多少現金作為 Bitcoin 的抵押品。LTV 比率 = 貸款金額 / 抵押品金額 *100。例如，LTV 為 50%，表示貸款價值等於 Bitcoin 存款價值的 50%。
...
- KYC (*Know Your Customer*)：根據所選擇的貸款報價，可能需要進行身份驗證。在 Debifi 上，每項貸款都會說明是否需要 KYC。因此，請做好相應的準備。KYC 由可靠的第三方服務提供商進行，如 Sumsub。
...
- 您需要使用 Debifi 手機應用程式 (iOS/Android) 來申請貸款。您必須下載該應用程式，創建帳戶，並 「鏈接 」您的設備（將設備註冊到您的帳戶）。Debifi 應用程式支援雙因素認證 (2FA)，如果沒有智能手機，您將無法在 Debifi 上確認交易。
...
請造訪 [Debifi 官方網站](https://debifi.com/app)。
...
您將透過電子郵件收到驗證碼。將此驗證碼複製並粘貼到應用程式中。然後在您的智能手機上打開 Debifi 應用程式並登入。
...
- 首先，您需要設定強大的 PIN 碼，以便稍後存取您的應用程式。
...
- 接下來，設定雙重因素驗證 (2FA)，使用 2FA 代碼將裝置與您的帳戶聯繫起來。
...
- 最後，將私人密碼匙的 12 個字寫在可靠的媒介上，並保存在安全的地方。這個階段對於恢復您的帳戶和管理您的資金非常重要。
...
當您完成這些步驟後，點擊**Offers**菜單來查看可用的貸款優惠。當您點擊一個優惠時，它會將您重定向到 Debifi 網站。
...
當您的裝置連線後，請前往 [Debifi 網站](https://debifi.com/)。登錄以建立 Debifi 移動應用程式和網路平台之間的安全連接。這將使您更容易與可用的貸款優惠互動（清晰地查看每個優惠的詳細內容）和管理您的帳戶。
...
該平台讓您接觸到機構品質的流動性，並提供一系列選項以滿足您的需求。請瀏覽了解有哪些選擇。您還可以根據個人的風險承受能力和財務狀況，靈活調整貸款參數。
...
Debifi 依靠透明和靈活的貸款條件來滿足各方（貸款人和借款人）的需求。主要條款包括 ：
...
利率釐定一般取決於您所選擇的 LTV、貸款年期長短、抵押品波動性及平台特定風險評估。利率在貸款期間保持固定。
...
當您對報價感到滿意，並填妥必要資訊後，請按一下「Contract request」。
...
然後，您會收到 Debifi 的通知，要求您支付貸款費用或佣金，以便改善您的貸款狀態。
...
您所要做的就是簽署一份交易，允許 Debifi 從擔保中扣除其傭金。就其本身而言，您的貸款人也需要簽署費用扣除交易，否則 Debifi 將無法收到其傭金。
...
在抵押品價格上漲的情況下，借款人保留抵押品的任何資本收益。他只欠貸款金額，而貸款金額是預先決定的，與 Bitcoin 價格無關。
...
監控您的貸款抵押率 (LTV)。如果可能的話，設定警報（BTC 價格、LTV）。不要讓您的比率接近 90%。如有疑問，請增加抵押品或提早還款。
...
如果可能的話，從小額開始。對於您的第一筆貸款，請先測試小額貸款，以便熟悉貸款流程。
...
另外，如果您是貸款人，這段教學視頻將引導您使用 Debifi 平台。從選擇對您的要約感興趣的借款人，到提供公鑰、簽署協議、轉移穩定幣等等。
