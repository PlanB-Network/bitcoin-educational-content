...
**Lưu ý: việc quản lý và Assignment của các phiên bản giao thức IP được xử lý bởi **IANA**. Một trường 4 bit cho phép 16 tổ hợp nhị phân (giá trị từ 0 đến 15). Assignment hiện tại của họ là:
