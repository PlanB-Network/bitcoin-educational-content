...
## Hatua ya 1: Sakinisha Desktop ya GitHub



- Nenda kwa https://desktop.github.com/ ili kupakua programu ya Desktop ya GitHub. Programu hii hukuruhusu kuingiliana kwa urahisi na GitHub, bila kulazimika kutumia terminal:

![github-desktop](assets/1.webp)


- Unapozindua programu kwa mara ya kwanza, utaulizwa kuunganisha akaunti yako ya GitHub. Ili kufanya hivyo, bofya kwenye `Ingia kwenye GitHub.com`:
...
- Bofya kwenye `Idhinisha eneo-kazi` ili kuthibitisha muunganisho kati ya akaunti yako na programu:

![github-desktop](assets/4.webp)


- Utaelekezwa kiotomatiki kwa programu ya Desktop ya GitHub. Bofya kwenye `Maliza`: ![github-desktop](assets/5.webp)
- Ikiwa umeunda akaunti yako ya GitHub, utaelekezwa kwenye ukurasa unaoonyesha kuwa bado haujaunda hazina zozote. Katika hatua hii, tenga programu ya Desktop ya GitHub; tutairejea baadaye: ![github-desktop](assets/6.webp)
...
- Nenda kwa https://obsidian.md/download na upakue programu: ![github-desktop](assets/7.webp)
- Sakinisha Obsidian, zindua programu, chagua lugha yako, kisha ubofye `Anza Haraka`: ![github-desktop](assets/8.webp)
- Utafika kwenye programu ya Obsidian. Kwa sasa, huna faili zilizofunguliwa: ![github-desktop](assets/9.webp)


## Hatua ya 3: Fork hazina ya Mtandao wa PlanB
...
## Hatua ya 4: Funga Fork



- Rudi kwa programu ya Desktop ya GitHub. Kufikia sasa, Fork yako inapaswa kuonekana katika sehemu ya `Hala zako`. Ikiwa huioni mara moja, tumia kitufe cha vishale viwili ili kuonyesha upya orodha. Wakati Fork yako inaonekana, bofya juu yake ili kuichagua:

![github-desktop](assets/15.webp)


- Kisha ubofye kitufe cha bluu: `Clone [jina la mtumiaji]/Bitcoin-educational-content`:

![github-desktop](assets/16.webp)


- Weka njia chaguo-msingi. Ili kuthibitisha, bofya kitufe cha bluu `Clone`:

![github-desktop](assets/17.webp)


- Subiri wakati GitHub Desktop inatengeneza Fork yako ndani ya nchi:
...
- Eneo-kazi lako la GitHub sasa limesanidiwa ipasavyo. Sasa, unaweza kuacha programu wazi chinichini ili kufuata marekebisho tutakayofanya.
...
## Hatua ya 5: Unda vault mpya ya Obsidian



- Fungua programu ya Obsidian na ubonyeze ikoni ndogo ya vault chini kushoto ya dirisha:

![github-desktop](assets/22.webp)


- Bofya kitufe cha `Fungua` ili kufungua folda iliyopo kama hifadhi: ![github-desktop](assets/23.webp)
- Kichunguzi chako cha faili kitafungua. Unahitaji kupata na kuchagua folda inayoitwa `GitHub`, ambayo inapaswa kuwa katika saraka yako ya `Nyaraka` kati ya faili zako. Njia hii inafanana na ile uliyoanzisha wakati wa hatua ya 4. Baada ya kuchagua folda, thibitisha uteuzi wake. Uundaji wa vault yako kwenye Obsidian kisha utazinduliwa kwenye ukurasa mpya wa programu:


![github-desktop](assets/24.webp)

-> **Tahadhari**, ni muhimu kutochagua folda ya `Bitcoin-educational-content` wakati wa kuunda vault mpya katika Obsidian. Badala yake, chagua folda kuu, `GitHub`. Ukichagua folda ya `Bitcoin-educational-content`, folda ya usanidi `.obsidian`, iliyo na mipangilio ya ndani ya Obsidian, itaunganishwa kiotomatiki kwenye hifadhi. Tunataka kuepuka hili, kwani si lazima kuhamisha usanidi wako wa Obsidian kwenye hazina ya Mtandao wa PlanB. Njia mbadala ni kuongeza folda ya `.obsidian` kwenye faili ya `.gitignore`, lakini mbinu hii pia ingerekebisha faili ya `.gitignore` ya hazina ya chanzo, jambo ambalo halifai.



- Upande wa kushoto wa dirisha, unaweza kuona mti wa faili na hazina zako tofauti za GitHub ambazo zimeundwa ndani.
- Kwa kubofya mishale iliyo karibu na majina ya folda, unaweza kuipanua ili kufikia folda ndogo za hazina na hati zao:

![github-desktop](assets/25.webp)


- Usisahau kuweka Obsidian kwa hali ya giza: "Nuru huvutia mende";)
