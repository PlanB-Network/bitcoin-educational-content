...
*Les établissements boostés sont ceux ayant reçu le pourboire d’un visiteur ou d’un utilisateur satisfait, leur assurant pour un temps une visibilité améliorée 
...
Concernant "Add Community" (ajouter une communauté)

![[add commu.png]]

1 la zone correspondant à votre communauté
2 nom de votre communauté
3 URL du site internet
...
Concernant "Add Location" (ajouter un établissement)
...
"Wiki" vous emmène sur la page GitHub du projet

"Support Us" vous indique comment faire un don (en sats) ou devenir sponsor du projet
