...
- Linux (Debian)** → Avsnitt **1.2**
- Windows** → Avsnitt **1.3**
- macOS** → Avsnitt **1.4**


### 1.2. Hur installerar man Pears på Linux (Debian)?
...
### 1.3. Hur man installerar Pears på Windows


Det är lika enkelt att installera Pears på Windows som på Linux, men det krävs några specifika verktyg.


*Om du använder Linux och redan har installerat Pears kan du hoppa direkt till **Steg 2**.*


#### 1.3.1. Öppna PowerShell som administratör
...
#### 1.3.4. Verifiera installationer
...
#### 1.3.6. Verifiera och initiera Pears
...
### 1.4. Hur man installerar Pears på macOS
...
*Om du använder Linux eller Windows och redan har installerat Pears kan du hoppa direkt till **Steg 2**.*


#### 1.4.1. Kontrollera systemförutsättningar
...
Detta kommando laddar Keet-appen direkt från Pears-nätverket, utan att använda en central server. Om Keet startas framgångsrikt betyder det att din Pears-installation är fullt fungerande.


Ditt macOS-system är nu redo att köra och vara värd för peer-to-peer-program med Pears.


## 2. Hur man använder Plan ₿ Academy på päron
...
## 3. Hur man gör seed Plan ₿ Akademi på päron
