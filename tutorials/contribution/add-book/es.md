...
- Ve a [el repositorio de GitHub de PlanB dedicado a datos](https://github.com/Plan ₿ Academy/bitcoin-educational-content/tree/dev/resources/books) en la sección `resources/books/`:
...
- Regresa a la carpeta de tu libro:
