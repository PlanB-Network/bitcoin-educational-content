...
![Descargar imagen de disco RoninOS](assets/2.jpeg)
...
![Grabar imagen de disco con Etcher](assets/3.jpeg)
...
![Configuración del teclado de Manjaro](assets/4.jpeg)
...
![Configuración del nombre de usuario de Manjaro](assets/5.jpeg)
...
![Configuración de la zona horaria de Manjaro](assets/6.jpeg)

![Configuración de la localidad de Manjaro](assets/7.jpeg)

Luego elige un nombre de host.

![Configuración del nombre de host de Manjaro](assets/8.jpeg)

Finalmente, verifica la información de configuración de Manjaro y confirma.

![Verificación de la información de configuración de ManjaroOS](assets/9.jpeg)
...
![Conexión SSH a RoninOS](assets/10.jpeg)
...
![Clonación de RoninDojo](assets/11.jpeg)
...
![Verificación de la contraseña del nodo Bitcoin](assets/12.jpeg)
...
![Animación de inicio de RoninCLI](assets/13.jpeg)
...
![Navegación del menú RoninCLI hacia System](assets/14.jpeg)

Luego ve al menú "System Setup & Install".

![Navegación del menú RoninCLI hacia la instalación del sistema de RoninDojo](assets/15.jpeg)
...
![Confirmación de la instalación de RoninDojo](assets/16.jpeg)
...
![Interfaz web de inicio de sesión de RoninUI](assets/20.jpeg)
...
![Panel de administración de RoninUI en la interfaz web](assets/21.jpeg)
...
![Indexador sincronizado al 100%, nodo funcional](assets/22.jpeg)
...
![Interfaz de conexión de Sparrow Wallet a un electrs](assets/23.jpeg)
...
![Obtener el código QR de conexión al Dojo](assets/24.jpeg)
...
![Conexión a Dojo desde la aplicación Samourai Wallet](assets/25.jpeg)
...
![Obtención de la dirección Tor de Mempool](assets/26.jpeg)
...
![Interfaz de Mempool Space](assets/27.jpeg)
...
![Página de inicio de Whirlpool Stats Tool](assets/28.jpeg)
...
![Descarga de datos del pool 0001 desde OXT](assets/29.jpeg)
...
![Cargando datos del pool 0001](assets/30.jpeg)
...
![Impresión de las puntuaciones retrospectivas y prospectivas de la TXID dada](assets/31.jpeg)
...
![Esquema de una transacción Coinjoin en kycp.org](assets/32.jpeg)
...
![Esquema de transacción de Bitcoin en oxt.me](assets/34.jpeg)
...
![Página de inicio del software Boltzmann Calculator](assets/35.jpeg)
...
![Ingresar un TXID para estudiar en Boltzmann Calculator](assets/36.jpeg)

El calculador le devolverá todos los indicadores que hemos visto anteriormente:

![Impresión de los datos de Boltzmann Calculator para este TXID](assets/37.jpeg)
...
![Obtener dirección TorV3 Bitcoin Daemon en RoninUI](assets/38.jpeg)

Para conectar tu nodo desde Bisq, accede al menú:

> Configuración > Información de red

![Acceder a la interfaz de conexión del nodo desde el software Bisq](assets/39.jpeg)
...
![Campo para ingresar la dirección TorV3 de tu nodo en el software Bisq](assets/40.jpeg)
...
![Herramienta XPUB desde RoninUI](assets/41.jpeg)

Si tu xpub está siendo rastreada correctamente por el nodo, verás esto:

![Herramienta XPUB resultado favorable del análisis](assets/42.jpeg)
...
![Cambiar el tipo de derivación de la xpub estudiada desde RoninUI](assets/43.jpeg)

Si su xpub no está rastreada por su nodo, verá aparecer esta pantalla que le invita a importarla:

![Importar una xpub con la herramienta XPUB Tool en RoninUI](assets/44.jpeg)
...
![Herramienta de difusión de transacciones firmadas desde RoninUI](assets/45.jpeg)
