---
name: Coincards
description: Comment acheter des biens et des services en BTC avec Coincards ?
---
...
Coincards a à cœur de préserver au maximum votre vie privée. Ils vous permettent bien sûr de payer en Bitcoin on-chain et Lightning, mais aussi en Monero, le seul shitcoin bénéficiant d'un capital sympathie élevé au sein de la communauté Bitcoin, dû aux proximités idéologiques et aux nombreux objectifs partagés par les deux communautés. Pour rappel, Monero est un cryptoactif qui permet de dissimuler ses transactions et de les rendre difficiles, voire impossibles à suivre sur le registre public qu'est la blockchain. 

![Coincards](assets/fr/02.webp)

C'est l'occasion de rappeler à ceux qui souhaiteraient payer leurs cartes-cadeaux en Bitcoin tout en bénéficiant d'une bonne préservation de leur vie privée de privilégier le Lightning Network pour ce faire.
...
Tout d'abord, notons que Coincards ne nécessite pas la création d'un compte. Tout ce dont vous avez besoin pour acheter vos cartes-cadeaux est une adresse mail valide qui vous permettra de les recevoir au format numérique.
...
Pour ce tutoriel, nous choisirons la zone Europe et plus spécifiquement la France.

![Coincards](assets/fr/04.webp)

Vous pouvez grâce au menu en haut à droite ordonner les références dans un ordre préférentiel. Par exemple, "Sort by popularity" permet de voir quelles cartes sont plébiscitées par les utilisateurs.

![Coincards](assets/fr/05.webp)

Nous choisirons pour l'exemple la marque Monoprix, qui est une grande enseigne française de grande distribution alimentaire principalement.
...
Sur la page récapitulative de la commande, cliquez sur  "PROCEED TO CHECKOUT".
...
Une page web s'ouvre et vous permet de révéler les codes de sécurité de votre carte et des explications détaillées en langue locale du pays sur la manière d'utiliser et de dépenser votre carte.
...
Pour ce faire, cliquez en haut sur "Login /Register".
...
Renseignez vos coordonnées et cliquez là encore sur "Register".

![Coincards](assets/fr/17.webp)

Vous obtenez alors un tableau de bord vous permettant de suivre et de rassembler en un endroit unique l'ensemble de vos transactions sur la plateforme.
