---
name: Mostro
description: Platform Bitcoin P2P Exchange bebas KYC melalui Lightning dan Nostr
---
...
Bagaimana cara Anda memperoleh atau menjual bitcoin tanpa mengorbankan kedaulatan finansial Anda? Platform terpusat memberlakukan prosedur KYC invasif yang mengekspos data pribadi Anda, dengan kemungkinan pembekuan akun yang sewenang-wenang atau pengawasan negara.



**Mostro P2P** menawarkan alternatif terdesentralisasi yang menggabungkan Lightning Network, protokol Nostr, dan faktur penahanan. Inovasi utamanya: sistem escrow otomatis di mana bitcoin Anda tetap berada di bawah kendali Anda selama Exchange, menghilangkan risiko pencurian, kebangkrutan Exchange, atau penyitaan sewenang-wenang.
...
Mostro P2P adalah protokol open source Bitcoin Exchange yang dibuat oleh **grunch**, pengembang bot Telegram populer **lnp2pbot** yang diluncurkan pada tahun 2021. Meskipun lnp2pbot telah mengaktifkan pertukaran P2P bebas KYC melalui Lightning, namun hal ini menimbulkan kerentanan yang besar: **Telegram merupakan titik kegagalan terpusat** yang rentan terhadap penyensoran oleh pemerintah.
...
**Fleksibilitas pembayaran**: Dukungan untuk banyak mata uang fiat melalui layanan kurs yadio.io Exchange. Menerima transfer SEPA, PayPal, Revolut, uang tunai, dan metode apa pun yang disetujui oleh kedua belah pihak.
...
**Mostro CLI** adalah klien yang paling matang dan fungsional. Ditulis dalam Rust, ia menawarkan berbagai fitur Mostro melalui baris perintah Interface. Kompatibel dengan macOS, Linux dan Windows.
...
- 'lepaskan': Lepaskan escrow dan selesaikan Exchange
- `getdm`: Melihat pesan langsung
- `rate`: Mengevaluasi rekanan Anda setelah Exchange
...
- Opsional, tetapi direkomendasikan**: Koneksi VPN atau Tor untuk menyamarkan IP Anda Address
...
Kompilasi membutuhkan waktu 1-2 menit. Eksekusi `mostro-CLI` akan diinstal di `~/.cargo/bin/`.
...
- Beberapa relai**: Mengkonfigurasi 3-5 relai yang beragam secara geografis
- Perlindungan jaringan**: Aktifkan VPN atau Tor untuk menyembunyikan IP Anda Address
- Wallet aman **: Aktifkan kunci otomatis pada Wallet Lightning Anda
...
Mostro akan meminta Anda untuk memberikan **Lightning Invoice** untuk menerima BTC. Jumlah yang tepat dalam satoshi akan ditunjukkan (di sini: 4715 Sats).
...
### Langkah 3: Sediakan Lightning Invoice Anda



generate Lightning Invoice dari Wallet Anda (Phoenix, Breez, dll.) untuk jumlah yang tepat, kemudian kirimkan:
...
Sistem akan mengonfirmasi pengiriman dan memberi tahu Anda untuk menunggu penjual membayar penahanan Invoice sebelum mengaktifkan escrow.
...
Segera setelah penjual mengonfirmasi penerimaan fiat dan melepaskan escrow dengan perintah `release`, Anda akan langsung menerima bitcoin di Lightning Invoice yang Anda berikan.
...
Tekan tombol **"+"** Green di kanan bawah, lalu pilih **JUAL** (tombol merah).
...
**Instruksi penting**: Anda sekarang harus **membayar penahanan Invoice** yang ditampilkan untuk mengunci bitcoin Anda (di sini 4674 Sats seharga 1-5 EUR) di escrow. Anda memiliki waktu **15 menit maksimum** jika tidak, maka Exchange akan dibatalkan.



Salin penahanan Invoice dan bayar dari Wallet Lightning Anda (Phoenix, Breez, dll.).
...
Setelah Anda memiliki **konfirmasi penerimaan** pembayaran fiat di akun Anda, tekan tombol **RELEASE** Green dan konfirmasikan untuk mengirimkan Satss ke pembeli.
...
Bitcoin langsung ditransfer ke pembeli melalui Lightning Invoice miliknya.
...
4. Sediakan Lightning Invoice Anda (yang dihasilkan dari Wallet Anda)
...
9. Dapatkan bitcoin secara instan di Lightning Invoice Anda
...
**Kedaulatan finansial**: Bitcoin Anda tidak akan pernah lepas dari kendali langsung Anda berkat mekanisme penahanan Invoice, sehingga menghilangkan risiko kebangkrutan atau pembajakan Exchange.
...
Mostro P2P merupakan alternatif yang menjanjikan untuk bursa terpusat, menggabungkan Lightning Network, Nostr, dan eskro otomatis untuk perdagangan yang benar-benar terdesentralisasi. Meskipun masih dalam tahap awal pengembangan dan likuiditas yang terbatas, platform ini telah menawarkan kedaulatan keuangan, ketahanan terhadap sensor, dan anonimitas default.



Bagi para pengguna bitcoin yang lebih menyukai otonomi dan kerahasiaan, Mostro merupakan pilihan yang layak untuk dieksplorasi secara progresif. Arsitekturnya yang terdesentralisasi menjamin evolusi komunitas daripada komersial, membuka jalan bagi masa depan pertukaran Bitcoin yang benar-benar gratis.
