...
- Idite na [GitHub repozitorijum PlanB posvećen podacima](https://github.com/PlanB-Network/Bitcoin-educational-content/tree/dev/resources/projects) u sekciji `resources/project/`:
...
- U ovom folderu, kreiraćete prvi YAML fajl pod nazivom `project.yml`:
...
- Vratite se u folder `resources/projects/` i izaberite folder vašeg poslovanja koji ste upravo kreirali u prethodnom commitu:
...
- Ostavite naslov commita kao podrazumevani, i proverite da je opcija `Commit directly to the patch-1 branch` označena, zatim kliknite na `Commit changes`: ![project](assets/23.webp)
