...
LNbits ni urubuga rwuguruye rwa Interface ruhindura urubuga rwose rw’inyuma rw’umuravyo (LND, Umuravyo w’ishimikiro, PHOENIXD) mu rubuga rw’ibikorwa rwuzuye. Uyu muti wikorera ushobora kugufasha gucunga ibiharuro vyinshi vya Lightning wiherereye, gushiramwo ibibanza vyo kugurishako, guhingura uburyo bwo gutanga canke ibikorwa vyo gutanga amafaranga, mu gihe uguma ugenzura amahera yawe yose.



Iyi nyigisho ivuga uburyo bubiri bwo gushiramwo: **VPS Ubuntu ifise PHOENIXD** (umuti woroshe udafise node ya Bitcoin yuzuye) na **Umbrel** (ugushiramwo node yawe ya LND iriho). Udakunze inyigisho rusangi ya LNbits ya Plan B Network, ivuga ku vyiyumviro n’ivyo kwagura, iyi nkuru yibanda ku buryo bwo gushiramwo ubuhinga intambwe ku yindi.
...
LNbits ni uburyo bwo guharura amafaranga bw’umuravyo bwateguwe muri Python (FastAPI) bufatanya n’inyuma busanzweho (LND, Umuravyo w’ishimikiro, PHOENIXD). Udakunze ama node ya Lightning asanzwe, LNbits itanga Interface ishobora gushikirwa, igufasha gucunga ibitabo vyinshi vyihariye n’imfunguruzo zavyo bwite za API. Ushobora gukora ama sub-accounts y’umuryango wawe, abakozi canke imigambi yawe, utabahaye uburenganzira bwo kuronka amahera yawe yose.



Ubwubatsi butandukanye bubika amakuru muri SQLite (imbere) canke PostgreSQL (uguhingura), mu gihe amahera aguma acungiwe n'inyuma yawe ya Lightning. Ukwo gutandukanya gutuma ushobora gutwara: ushobora kuva kuri PHOENIXD ukaja kuri LND utatakaje amakuru yawe y’ukoresha.
...
LNbits itanga uburyo bwinshi bwo kwagura **uburyo bwo kwagura**: TPoS (aho ugurisha), Paywall (ugutanga amahera mu birimwo), Ivyabaye (ugutanga amatike), LndHub (server ya BlueWallet), Amakarata ya Bolt (Ukwishura kwa NFC), Ukwishura kw’Ibice (ugukwiragiza ubwavyo), n’Umucungerezi w’Ukoresha (ugucungera abakoresha n’ukwemeza).



**Dashboard** yerekana amafaranga y'igihe nyaco, amateka y'ibikorwa n'ibikoresho vyo gutanga amafaranga. Wallet yose ifise URL yihariye irimwo imfunguruzo zayo za API, zituma umuntu ashobora kuyironka ata kwinjira mu buryo busanzwe. Urutonde rw'urufunguzo rwa API rw'urugero rutatu** (admin, Invoice, gusoma gusa) rutanga ubugenzuzi bw'uruhusha rwo gukorana n'abandi mu buryo butekanye.



LNbits ishira mu ngiro **LNURL** (LNURL-pay, LNURL-Withdraw, LNURL-auth) kandi ishigikira **Umuravyo Address**, igatanga icemeza ko ihuye n’ibipapuro vy’umuravyo vy’ubu kandi igatuma habaho ugukoresha ibikorwa vy’umwuga.
...
Aha niho hari uburongozi burambuye bwo kugufasha gutangura: **[Itunganywa rya mbere rya server ya Ubuntu - Intambwe ku yindi](https://danielpcostas.



Iyi nkuru ivuga ku mitunganyirize y’abakoresha, SSH itekanye, uruhome rw’umuriro (UFW), fail2ban, guhindura ibintu bishasha, n’imigenzo myiza yo gucungera umutekano wa sisitemu.
...
Igihe server yawe itekanye, ukeneye gushiramwo no gutunganya PHOENIXD. Plan B Network itanga inyigisho yuzuye yihariye yerekeye gushiramwo, seed uruvyaro n'ugutunganya ibikorwa vya systemd:



https://planb.academy/tutorials/node/lightning-network/phoenixd-beb86edd-f9c0-4bec-ad36-db234c88e7b1

Igihe PHOENIXD izoba iriko irakora (suzuma na `./Phoenix-CLI getinfo`), menya **Ijambobanga rya HTTP** muri `~/.Phoenix/Phoenix.conf` - uzoyikenera kugira ngo uhuze LNbits na PHOENIXD.
...
Kugena inyuma y'inyuma ya PHOENIXD:
...
Gukoresha umuyobozi wa Interface muri `.env` :
...
Kuva ku buyobozi bwa SuperUser Interface, genda kuri "Ivyagezwe" hanyuma uja ku gice ca "Ubuyobozi bw'Ukoresha". Uzosanga "Kwemera kurema abakoresha bashasha" uburyo.
...
- Umuntu ashobora gutera yoshobora gukora amakonti maze agakoresha amahera yawe yo muri LIGHTNING NODE ataco uzi .
- Uzokenera gukora konti z'abakoresha n'amaboko ukoresheje Interface SuperUser
...
Iyo imaze gutunganirizwa, umuyobozi wa SuperUser wenyene niwe ashobora gukora konti nshasha z'abakoresha biciye ku Interface "Abakoresha". Ubu buryo buratanga ububasha bwose ku bashobora gushika ku bikorwa remezo vyawe vya Lightning no gukoresha amahera yawe.
...
PHOENIXD igenzura ubwayo imirongo biciye ku nzira y’amahera. generate umuravyo Invoice y'ama Sats ~30.000 uva kuri LNbits ukayihemba ukoresheje uwundi Wallet. PHOENIXD ihita ifungura umurongo kuri ACINQ. Amafaranga yo gufungura (~20-23k Sats) arakurwako, amahera asigaye (~7-10k Sats) aboneka inyuma y’aho On-Chain yemeje.
...
Gukoresha: `sudo LN -s /n'ibindi/nginx/imbuga-ziboneka/lnbits /n'ibindi/nginx/imbuga-zishobojwe/ && sudo nginx -t && sudo systemctl gusubiramwo nginx && sudo certbot --nginx -d urubuga rwawe.com`
...
Umutaka uhita ugenzura ibikenewe. LNbits bisaba LIGHTNING NODE (LND) kugira ngo ikore. Niba LIGHTNING NODE yawe isanzwe ikora, fyonda ku "Install LNbits" kugira ngo wemeze.
...
Umbrel irakuraho ishusho ya Docker, ihita itunganya amahuzu na LND, maze igatangura igikoresho (iminota 2-5). Gushiraho ibintu vyose bibera inyuma.
...
Ku gutangura kwa mbere, LNbits iragusaba gukora konti y'umuyobozi wa SuperUser. Injira izina ry’ukoresha maze ushireho ijambobanga ry’umutekano kugira ngo ukinge uburenganzira bwo gukoresha uburyo bwo gutwara Interface.
...
Iyo umaze gukora konti, uca uja mu karere k’ubuyobozi kakuru ka Interface. Umbrel yaramaze gushinga LND nk'isoko yawe y'amahera - amahera yose Lightning yishura azoca mu nzira zawe zisanzwe.



### Ukwinjira ku muyobozi wa Interface
...
Igice ca "Uburongozi bw'amasakoshi" kigaragaza amakuru y'ingenzi yerekeye imiterere yawe:
...
- Igiciro ca LNbits**: Amahera agenewe ubuhinga bwa LNbits (mu ntango 0 Sats)
...
Ivyatsi vy'amahitamwo (Urufunguzo rwa Nostr, Imeyili, Izina rya Mbere, Izina ry'Umuryango) bishobora gusigara ubusa kugira ngo haboneke imiterere mikeyi. Fyonda kuri "REMA KONTI" kugira ngo wemeze.
...
**Iciyumviro gihambaye**: Umuntu wese ashobora kwinjira yigenga rwose akoresheje ijambo banga ryiwe. Umuyobozi wa SuperUser aguma afise ububasha bwose biciye ku gikoresho co gutwara Interface.
...
None ko umukoresha wa "Satoshi" yaremwe, ukeneye kumuha umuravyo wa Wallet. Fyonda ku kimenyetso ca Wallet (ikimenyetso ca kabiri) c'uwukoresha, hanyuma kuri "REMA Wallet NSHASHA".
...
Uwukoresha "Satoshi" ubu afise Wallet imwe, igaragara neza. Buri muntu wese akoresha Wallet akora yigenga, mu gihe akoresha amahera y’uruzitiro rwawe rwa LND.



**Iciyumviro nyamukuru**: Izo nkweto zose zisangira amahera y’isi yose y’uruzitiro rwawe rwa Umbrel. Ntushobora kurema imirongo mishasha ya Lightning kuri Wallet yose - LNbits ikora nk'ubuhinga bw'ubuhinga bwo guharura Layer bucungera ugutanga amafaranga mu bikorwa remezo vyawe vya Lightning biriho. Ubwo ni bwo bubasha bw’ubuhinga bwa LNbits bufise Wallet nyinshi.
...
Injira izina ry'ukoresha ("Satoshi") n'ijambobanga ryasobanuwe mbere, hanyuma ukande kuri "LOGIN". Uwukoresha ashobora gushika ku Wallet yiwe bwite, yitandukanije n'ubuyobozi Interface.
...
Iyo amaze gufatanya, uwukoresha ashobora gushika kuri Interface yiwe akoresheje Wallet Lightning.
...
Ibirango vya Interface :




- Igiciro kiri muri iki gihe**: Kigaragazwa muri Sats no mu mafaranga yatowe (CUC muri aka karorero)
- Ibikorwa nyamukuru**: "GUSHIRAMWO IKIBAZO" (shiramwo fagitire yo kwishura), "REMA Invoice" (generate ni ikimenyetso c'uko wakiriye), ikimenyetso ca QR (gucapura vuba)
- Amateka y'ibikorwa** : Urutonde rw'amahera yose yishuwe n'ivyo yakiriye
- Uruhande rw'iburyo**: Gutunganya no gushikira



### Wallet gushikira kuri telefone ngendanwa
...
- Scan kode ya QR ya LndHub ukoresheje porogarama ya telefone ngendanwa kugira ngo uhuze Wallet
...
- Kode ya QR yerekanwa muri "Irungika kuri telefone ukoresheje Kode ya QR" irimwo URL yuzuye ya Wallet n'ivyemezo vy'ukuri
- Scan iyi kode ya QR kuri telefone yawe kugira ngo ufungure Wallet mu mucukumbuzi wawe wa telefone ngendanwa
- Kwongera urupapuro ku mugaragaro w'intango kugira ngo uyironke ningoga



**Umutekano uhambaye**: Iyi URL irimwo imfunguruzo za API kugira ngo ushobore gushika kuri Wallet. Ntukigere ubisangiza abandi ku mugaragaro. Fata iyi kode ya QR nk'uko wobifata ku mfunguruzo zawe z'ibanga za Bitcoin - umuntu wese akoresheje iyi kode ya QR arashobora gushika kuri Wallet.



Iyi nzira y’amatelefone ngendanwa ihindura urugero rwawe rwa LNbits Umbrel mu server nyayo ya Lightning Wallet kuri wewe n’abagenzi bawe, mu gihe uguma ufise ubusegaba bwose ku mahera yawe biciye ku nzira yawe yikorera.
...
Iyi Layer ibiri y'uburinzi (ugushika ku rubuga + kwemeza umukoresha) ituma uburyo bwo "Kwemera kurema abakoresha bashasha" butagira akamaro kanini kuri Umbrel. Abantu basanzwe bafise uburenganzira bwo gukoresha urubuga rwawe canke VPN ni bo bonyene bashobora gushika ku nzira yo kwinjira muri Interface.



**Ivyiyumviro bisanzwe**: Ukora konti ya "papa", konti ya "mama", konti ya "ubucuruzi" n'ibindi. Buri muntu wese mu muryango afise umuravyo wiwe Wallet, mu gihe yungukira ku bushobozi bwo gusangira bw’uruzitiro rwawe rwa Umbrel. Gusa gusangira izina ry’ukoresha n’ijambobanga - uwukoresha ashobora rero kwifatanya n’igikoresho cose kiri ku rubuga rwawe rw’aho uba canke biciye kuri VPN yawe ya Tailscale. Raba inyigisho yacu yihariye y'umurizo kugira ngo uronke ibindi bisobanuro:
...
Subira kuri Interface SuperUser maze winjire ku rutonde rwa "Ivyagutse" biri ku ruhande rw'ibubamfu kugira ngo ubone ibidukikije vyose vy'ivyagutse vya LNbits.
...
- Amatike y’ugufasha**: Uburyo bwo gufasha bwishyurwa (kwakira Satss kugira wishure ibibazo)
...
- SMTP**: Gushoboza abakoresha kohereza ubutumwa kuri email no kuronka Satss
...
Buri kwagura gukoreshwa n'ugukanda rimwe kuri iyi Interface. Ivyungura vyerekanwa ko "FREE" ni ubuntu, mu gihe bimwe bimwe biboneka mu buryo bwa "PAID". Raba urutonde kugira umenye izo zihuye n’ivyo ukeneye - haba mu bucuruzi, mu bijanye no kurongora umuryango, canke mu kugerageza ubushobozi bwa Lightning Network.
...
**Ivyiza**: Ubusegaba bw'ivy'amahera (ubugenzuzi bushitse ku mahera/imfunguruzo/amakuru), uguhinduranya ubuhinga bw'ubwubatsi (ukwimuka kwa VPS→Full node ataco gutakaza), uburyo bwo kwagura ubuhinga, Interface igaragara.



**Imipaka** : Porogaramu iri muri beta (ukwiyubara ku mahera), umutekano uri munsi y’inshingano z’umuyobozi, URLs zirimwo imfunguruzo z’agaciro za API (HTTPS ni ngombwa), uburongozi bw’abakoresha benshi busobanura inshingano yo kubungabunga.
...
**Ivyiyumviro**: seed PHOENIXD/ivyemezo LND, urutonde rw'amakuru rwa LNbits, amadosiye `.env`. Ikora buri musi, igumye kure ya server, ipfutse. Igerageza rigarukana ubudasiba.
...
Kwiyakira bisigura inshingano: gusubiza inyuma imbuto, kurinda uburyo bwo kuzironka, gutangura n’amahera makeyi. Ivyo vyitonderwa, LNbits iba umuti ukomeye w’ubutunzi bwa Lightning, mu gihe izigama ukwegereza ubutegetsi abaturage n’ukwigenga.
...
- [Inyandiko za LNbits](inyandiko.Inyandiko.LNbits.org)
- [Ikibanza c'ibice vya LN](ibice vy'ibice/ibice vy'ibice)
- [PHOENIXD Ikibanza c'Ivy'Imibano]
...
- [Imitunganyirize y'intango y'umuserukira wa Ubuntu](intambwe-ku-intambwe-y'uburongozi/) na Daniel P. Costas (umutekano wa VPS intambwe ku yindi)
- [LNbits + PHOENIXD gushirwa kuri Ubuntu VPS](gushiramwo-lnbits-PHOENIXD-vps-ubuntu/) na Daniel P. Costas (uburongozi bushitse)
- [Serveri ya LNbits kuri Clearnet] (https/Igikoresho c'ibice/ru/) na Axel
- [Ibice vya LN kuri VPS] (Ibice vy'Igihugu) vyanditswe na Hannes