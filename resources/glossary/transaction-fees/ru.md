---
term: Комиссии за транзакцию

definition: Сумма, вознаграждающая майнеров за включение транзакции в блок, рассчитываемая как разница между входами и выходами.
---
