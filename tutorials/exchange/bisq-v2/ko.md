...
이 가이드는 현재 사용 가능한 유일한 프로토콜인 "Bisq Easy"에만 초점을 맞추고 있습니다. Bisq Easy는 새로운 비트코인 사용자를 위해 특별히 설계되었습니다. 이 프로토콜은 사용자가 탈중앙화된 P2P 플랫폼에서 비트코인을 법정화폐와 교환할 수 있도록 합니다. 거래는 600달러 상당(최소 6달러)으로 제한되며, 거래의 안전성은 BTC 판매자의 평판에 기반합니다. Bisq Easy는 거래 수수료나 보증금 요구 사항이 없습니다. Bisq Easy는 600달러(또는 동등한 금액) 이하의 법정화폐 거래에서 Bisq 1을 대체할 것으로 예상됩니다.
