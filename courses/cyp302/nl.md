...
Laten we ons onderzoek op het gebied van [cryptografie](https://planb.academy/resources/glossary/cryptography) beginnen met een van de charmantere en vermakelijkere episodes uit de geschiedenis: dat van de Beale cijfers. [1]
...
Ten tweede is er bij klassieke versleutelingsschema's zoals de Beale-sleutels altijd sprake van één sleutel die gedeeld wordt door alle betrokken partijen. Veel moderne cryptografische schema's bevatten echter niet slechts één, maar twee sleutels: een **private** en een **[publieke sleutel](https://planb.academy/resources/glossary/public-key)**. Terwijl de eerste in alle toepassingen privé moet blijven, is de tweede meestal publiekelijk bekend (vandaar hun respectievelijke namen). Op het gebied van encryptie kan de publieke sleutel worden gebruikt om het bericht te versleutelen, terwijl de [privésleutel](https://planb.academy/resources/glossary/private-key) kan worden gebruikt om het bericht te ontsleutelen.
...
De eerste oplossing die ze aanboden was een *key-Exchange protocol* op afstand, dat wil zeggen een set regels voor de Exchange van één of meer symmetrische sleutels over een onveilig communicatiekanaal. Dit protocol staat nu bekend als *[Diffie-Helmann](https://planb.academy/resources/glossary/diffiehellman) sleutel Exchange* of *Diffie-Helmann-Merkle sleutel Exchange*. [2]
...
Schema's op basis van discrete logaritmen zijn gebaseerd op twee belangrijke soorten cyclische groepen: vermenigvuldigingsgroepen van gehele getallen en groepen die de punten op [elliptische krommen](https://planb.academy/resources/glossary/elliptic-curve) bevatten. De originele Diffie Helmann-sleutel Exchange zoals gepresenteerd in "New Directions in Cryptography" werkt met een cyclische vermenigvuldigingsgroep van gehele getallen. Het [digitale handtekeningalgoritme](https://planb.academy/resources/glossary/digital-signature) van Bitcoin en het recent geïntroduceerde [Schnorr-handtekeningenschema](https://planb.academy/resources/glossary/schnorr-protocol) (2021) zijn beide gebaseerd op het discrete logaritmeprobleem voor een bepaalde cyclische groep van elliptische krommen.
...
Een voorbeeld van een populaire Hash functie is **[SHA-256](https://planb.academy/resources/glossary/sha256)** (veilig Hash algoritme 256). Ongeacht de grootte van de invoer (bijvoorbeeld 15 bits, 100 bits of 10.000 bits), zal deze functie een 256-bits Hash waarde opleveren. Hieronder zie je een paar voorbeelduitgangen van de SHA-256 functie.
