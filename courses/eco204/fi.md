...
Kelluvan vaihtokurssin omaksumisen jälkeen vuonna 1983 seurasi useita uudelleenarvostuksia:

- Vuonna 2008: bolivar fuerte, eli "vahva bolivar", otettiin käyttöön, saavuttaen jopa 100 000 ennen uudelleenarvostusta tuhannesta yhteen. Vuonna 2018: Soberano otettiin käyttöön seteleillä, jotka saavuttivat 1 miljoonan. Vuonna 2021 se korvattiin digitaalisella bolivarilla, joka myös saavutti miljoonan, ennen uutta uudelleenarvostusta miljoonasta yhteen. Tänään 10 tai 20 setelin arvo vastaa 10 miljoonaa tai 20 miljoonaa Soberanossa.
  Tältä ajalta, alkaen vuodesta 2018, seteleitä jaetaan eri Bitcoin-konferensseissa Biarritzissa, Torontossa ja Miamissa. Nämä Soberano-setelit saavuttivat enimmäisarvon 1 miljoona. Sen jälkeen tehtiin uudelleenarvostus, joka alensi miljoonan arvon noin 3 senttiin. Tällä hetkellä 10 kpl 1 miljoonan seteleitä vastaa yhtä 10 seteliä. Vuodesta 2016 lähtien Venezuela on kokenut hyperinflaation, joka edustaa 57. jaksoa tietyssä taulukossa.

Seuraavassa videossa esitellään hyperinflaation setelikokoelma, keskittyen Venezuelaan ja muihin listattuihin maihin. Tämä kokoelma sisältää lähes kaikki Venezuelan setelit. Tutkimus keskittyy kunkin mainitun maan eri uudelleenarvostuksiin. Lisäksi tutkitaan Zimbabwen uudelleenarvostuksia, mikä on merkittävä aihe.

### Johtopäätökset

Olemme nähneet, että hyperinflaatio ei ole ainoa talouskatastrofin indikaattori. Useat uudelleenarvostukset, nollien poistaminen tai valuutan nimen muuttaminen aiheuttavat suoria seurauksia väestölle, vaihdellen avun menetyksestä ruokaongelmiin. Vaikka hyperinflaatio on huolestuttavaa, useat uudelleenarvostukset, kuten Brasiliassa havaittu, osoittavat monimutkaisemman todellisuuden.

Perustuen 50 %:n inflaatioon kuukaudessa, useita jaksoja olisi voitu luokitella hyperinflaatioksi. Tämä on erityisen totta tutkittaessa kansainvälisen kirjanpitojärjestön kriteerejä, jotka ottavat huomioon ominaisuuksia kuten valuutan nopean hylkäämisen väestön toimesta, palkkojen indeksoinnin ja korkeakorkoisten lainojen käytön inflaation kompensoimiseksi.

Yhteenvetona voidaan todeta, että hyperinflaatio on vain yksi taloudellisten haasteiden näkökulma. Korkea inflaatio yksinään voi olla yhtä vahingollista. Seuraavassa osiossa tutkitaan mahdollisia ratkaisuja hyperinflaation voittamiseksi.

## Miten hyperinflaatio voitetaan
...
Näin ollen vuoden 2009 jälkeen, jatkuvan rahakriisin ja hillittömän hyperinflaation edessä, Zimbabwe luopui kansallisesta valuutastaan ja salli ulkomaisten valuuttojen käytön, pääasiassa Yhdysvaltain dollarin. Vaikka tämä päätös oli radikaali, se lopetti hyperinflaation. Tärkeä oppi on, että liiallisen rahan liikkeeseenlaskun pysäyttäminen ja keskuspankin budjettialijäämän rahoituksen lopettaminen voi päättää hyperinflaation.
...
## Hyperinflaation setelikokoelman esittely
...
## Toisen rahan kerroksen ja keskuspankkien esiinmarssi
...
#### Vaihtovelkakirjat (1200-luku)

Tuohon aikaan yleinen käytäntö oli seuraava: kultasepät myönsivät vaihtovelkakirjoja vastineeksi talletetuista floriineista. Nämä floriinit säilytettiin huolellisesti heidän holveissaan. Näin ollen todellinen kulta, jota floriini edusti, muodosti rahan ensimmäisen kerroksen, kun taas vaihtovelkakirjat muodostivat toisen kerroksen. Tämän järjestelmän likviditeetti oli kuitenkin rajallinen. Jos joku halusi lunastaa kultansa vaihtovelkakirjaansa vastaan, toimenpide oli yksinkertainen. Mutta näiden vaihtovelkakirjojen vaihtaminen yksilöiden välillä ei ollut yleistä.

#### Antwerpenin Pörssi (1500-luku)

Antwerpenin pörssi merkitsi merkittävää virstanpylvästä paperirahan kehityksessä. Siellä otettiin käyttöön velkakirjojen diskonttauskäytäntö. Nämä velkakirjat olivat paperisia instrumentteja, jotka edustivat rahallista arvoa, mutta niiden erityispiirre oli, että niihin oli merkitty nimet ja eräpäivät. Tämä teki niiden vaihtamisesta vaikeaa ennen eräpäivää.
Antwerpenin pörssin mukanaan tuoma vallankumous piili mahdollisuudessa diskontata nämä velkakirjat ennen niiden eräpäivää. Esimerkiksi, jos velkakirja erääntyi kuukauden kuluttua, oli mahdollista ostaa se alennettuun hintaan ottaen huomioon aika ennen eräpäivää. Tämä innovaatio ei ainoastaan tehnyt paperivaluutasta likvidimpää, vaan toi myös esille rahan aika-arvon käsitteen.

Vaikka tämä käsite yhdistetään Nick Belliin hänen Twitter-pseudonyyminsa "time value of BTC" kautta, se ei ole hänen keksintönsä. Hän kuitenkin käsittelee sitä yksityiskohtaisesti teoksissaan. Pääidea on, että ajalla on arvo. Näin ollen, jos joku päättää maksaa 100 dollarin arvoisen velkakirjan kuukautta etukäteen, hän voi saada sen esimerkiksi 98 dollarilla ja vastaanottaa 100 dollaria eräpäivänä. Tämä rahauudistus sai alkunsa Antwerpenin pörssissä.
...
Englannin Pankin perustaminen oli motivoitunut tarpeesta rahoittaa sotaa 1600-luvun lopussa. Kuten Amsterdamin Pankki, se määräsi talletukset asetuksella. Englannin Pankin erityispiirre oli yksityisten pankkien siirtäminen toissijaiseen asemaan rahajärjestelmässä, luoden näin mitä voitaisiin kutsua "kolmanneksi valuuttakerrokseksi".
Alun perin ensimmäinen valuuttakerros edusti kultaa. Yksityispankkien tekemät talletukset muodostivat toisen kerroksen. Kuitenkin, kun näitä talletuksia ei enää voitu muuttaa kullaksi, ilmestyi kolmas valuuttakerros. Tästä lähtien yksityispankkien liikkeelle laskemat setelit eivät enää olleet vaihdettavissa kultaan, vaan Englannin Pankin paperirahaan, joka puolestaan oli vaihdettavissa kultaan. Tämä kehitys johti rahajärjestelmän monimutkaistumiseen lisäkerrosten myötä.
...
Hyperinflaatio on kiehtova aihe, jota on tutkittu eri historiallisten tapahtumien kautta. Jos haluat syventyä tähän aiheeseen, tässä on lista 10 olennaisesta resurssista lukemiseen ja opiskeluun:

- "When Money Dies: The Nightmare of Deficit Spending, Devaluation, and Hyperinflation in Weimar Germany" kirjoittanut Adam Fergusson. Tämä kirja käsittelee hyperinflaatiokriisiä Saksassa ensimmäisen maailmansodan jälkeen.

- "The Economics of Inflation - A Study of Currency Depreciation in Post-War Germany" kirjoittanut Costantino Bresciani-Turroni. Syvällinen analyysi Saksan hyperinflaatiosta 1920-luvulla.
- "This Time Is Different: Eight Centuries of Financial Folly" Carmen M. Reinhartin ja Kenneth S. Rogoffin kirjoittama. Vaikka kirja käsittelee monenlaisia rahoituskriisejä, se käy laajasti läpi hyperinflaation historiaa.
- "Zimbabwen hyperinflaatio, analyysi ja opitut läksyt" Steve Hanken kirjoittama. Tutkimus Zimbabwen hyperinflaatiosta 2000-luvun alussa.

- "Rahajärjestelmät ja inflaatio: Historia, taloudelliset ja poliittiset suhteet" Peter Bernholzin kirjoittama. Kirja tutkii hyperinflaation tapauksia läpi historian ja pyrkii ymmärtämään taustalla olevia tekijöitä.

- "Hyperinflaation selviytymisopas: Strategioita amerikkalaisille yrityksille" Gerald Swansonin kirjoittama. Käytännön opas siitä, miten yritykset voivat navigoida hyperinflaatioympäristössä.

- "Kuolema rahasta: Oppitunteja suurista saksalaisista ja amerikkalaisista inflaatioista" Jens O. Parssonin kirjoittama. Vertaileva analyysi inflaatiokriiseistä Saksassa ja Yhdysvalloissa.
