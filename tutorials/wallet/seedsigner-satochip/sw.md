...
Satochip ni Hardware Wallet katika umbizo la kadi mahiri, iliyo na kipengele cha usalama kilichoidhinishwa na EAL6+, mojawapo ya viwango vya juu zaidi vya usalama. Imeundwa na kuzalishwa na kampuni ya Ubelgiji ya jina moja: Satochip.



Bei ya takriban €25, Satochip inajitokeza kutoka kwa shindano kwa thamani yake bora ya pesa. Shukrani kwa chip yake salama, inatoa upinzani dhidi ya mashambulizi ya kimwili. Zaidi ya hayo, msimbo wa chanzo wa applet yake ni chanzo huria kabisa, iliyopewa leseni chini ya *AGPLv3*.
...
- Satochip inagharimu takriban €25, na kwa kuwa applet ni chanzo huria, unaweza kuisakinisha mwenyewe kwenye smartcard tupu. Kisha itabidi uongeze gharama ya vipengele vya SeedSigner na kiendelezi cha kusoma smartcards: kulingana na mahali unaponunua maunzi haya, jumla inapaswa kuwa kati ya €70 na €100.
...
- Hatimaye, hifadhi nakala ya seed kwenye vyombo vya habari vya kimwili na uangalie chelezo kwa uangalifu.
...
Mbinu mbadala iliyochaguliwa hapa inategemea mapendeleo yako, lakini ni muhimu kuwa na angalau nakala moja ya maneno yako ya Mnemonic, ama kwenye vyombo vya habari halisi (karatasi au chuma) au, kama hapa, kwa Mtunza Mbegu. Unaweza pia kuzidisha idadi ya chelezo kama inavyohitajika. Kwa habari zaidi juu ya mikakati ya kuhifadhi kwingineko, ninapendekeza usome mafunzo haya:



https://planb.academy/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270

Ili kuhifadhi nakala ya seed yako kwenye Mtunza mbegu, nenda moja kwa moja kwenye menyu ya `Chelezo seed`.
...
Chagua `Lebo` ili kutambua kwa urahisi siri zako tofauti zilizohifadhiwa kwenye Seedkeeper. Unaweza, kwa mfano, kuweka tu alama ya kidole ya Wallet au uonyeshe kwa uwazi `seed`. Chaguo inategemea upendeleo wako na hatari.
...
Kwa kuwa sasa kwingineko yako imetolewa, kuhifadhiwa na kuangaliwa, tutaihamisha hadi kwenye Satochip. Ili kufanya hivyo, hakikisha kwamba seed imepakiwa kwenye RAM ya SeedSigner. Kisha nenda kwa `Zana > Zana za Smartcard > Kazi za Satochip`.
...
Ingiza Satochip yako kwenye kisoma kadi mahiri, kisha uchague `Anzisha ukitumia seed`.
...
Kisha unaweza kuweka msimbo wa PIN wa Satochip, kutoka kwa vibambo 4 hadi 16. Ili kuimarisha usalama wa Wallet yako, chagua msimbo mrefu na nasibu: ndiyo ulinzi pekee dhidi ya ufikiaji wa kimwili kwa maneno yako ya Mnemonic.



Kumbuka kuhifadhi PIN hii mara tu inapoundwa, ama katika kidhibiti salama cha nenosiri au kwa njia halisi, kulingana na mkakati wako wa kibinafsi. Katika kesi ya pili, hakikisha kuwa hauhifadhi kifaa kilicho na PIN katika sehemu sawa na Satochip yako, vinginevyo ulinzi hautakuwa na maana. Ni muhimu kuwa na nakala mbadala: **bila PIN hii, hutaweza tena kufikia seed yako, na bitcoins zako zitapotea kabisa**.
...
Kwa kuwa sasa jalada lako limeanza kutumika, tutaleta taarifa zake za umma ("*keystore*") kwenye Sparrow wallet au programu nyingine ya usimamizi wa kwingineko. Programu hii itatumika kuunda, kusambaza na kufuatilia miamala yako. Hata hivyo, haitaweza kuzitia sahihi, kwa kuwa ni Satochip pekee (na chelezo zozote) hushikilia funguo za faragha zinazohitajika kwa operesheni hii.
...
Ingiza kadi ya microSD iliyo na mfumo wa uendeshaji, kisha uwashe SeedSigner yako. Kwa sasa, haiwezi kufanya chochote, kwani bado haijui seed yako. Itabidi uanze kwa kuingiza Satochip kwenye kisoma kadi mahiri, kwa kuwa ndicho kinachoshikilia seed yako.
...
Hatimaye, chagua `Mratibu`, yaani, programu ya usimamizi wa kwingineko unayotaka kutumia. Hapa, tutatumia Sparrow wallet.
...
SeedSigner kisha hutengeneza xpub yako katika mfumo wa msimbo unaobadilika wa QR, ulio na data yote unayohitaji ili kudhibiti kwingineko yako katika Sparrow wallet. Unaweza kurekebisha mwangaza wa skrini kwa kutumia kijiti cha kufurahisha ili kurahisisha kuchanganua msimbo wa QR.
...
Hakikisha kwamba programu ya Sparrow wallet imewekwa kwenye kompyuta yako. Ikiwa hujui jinsi ya kuipakua, angalia uhalisi wake na usakinishe kwa usahihi, angalia mafunzo yetu kamili juu ya somo:
...
Weka jina kwa kwingineko yako, kisha ubofye kwenye `Unda Wallet`. Sparrow itakuuliza uweke nenosiri ili kufunga ufikiaji wa ndani kwa Wallet hii. Chagua nenosiri thabiti: hulinda data yako katika Sparrow (funguo za umma, anwani, lebo na historia ya muamala). Hata hivyo, nenosiri hili halihitajiki kurejesha Wallet katika siku zijazo: tu maneno yako ya Mnemonic (na ikiwezekana passphrase yako) yatakuwa.
...
Kisha SeedSigner itakuuliza uchanganue Address inayopokea bila mpangilio kutoka kwa Sparrow wallet yako ili kuthibitisha uhalali wa uagizaji.
...
Satochip yako (kupitia SeedSigner) na Sparrow wallet sasa zimeunganishwa kwa usalama. Sparrow hutumika kama usimamizi kamili wa Interface, huku Satochip kikisalia kuwa kifaa pekee chenye uwezo wa kutia saini miamala yako. Sasa uko tayari kupokea na kutuma bitcoins katika usanidi usio na hewa kabisa.
...
Bitcoin Address mpya inaonekana. Utapata:
...
Ninapendekeza sana uongeze lebo kwa kila risiti ya Bitcoin katika Wallet yako. Hii itakusaidia kutambua kwa urahisi asili ya kila UTXO na kudhibiti vyema faragha yako. Ili kujua zaidi kuhusu mada hii muhimu, angalia mafunzo maalum kuhusu Plan ₿ Academy :
...
Kabla ya kuwasiliana na mlipaji Address unayopokea, ni muhimu kuangalia ikiwa ni ya seed yako. Hatua hii inahakikisha kwamba Satochip yako itaweza kutia sahihi katika miamala inayohusishwa na Address hii. Pia huzuia mashambulizi yanayoweza kutokea ambapo Sparrow ingeonyesha Address ya ulaghai. Kumbuka kwamba Sparrow inaendeshwa kwenye mazingira yasiyo salama (kompyuta yako), ambayo eneo lake la mashambulizi ni kubwa zaidi kuliko la Satochip yako, ambayo imetengwa kabisa. Hii ndiyo sababu hupaswi kamwe kuamini kwa upofu anwani zinazoonyeshwa kwenye Sparrow kabla ya kuziangalia kwenye Hardware Wallet yako.



Katika Sparrow, bofya kwenye msimbo wa QR wa Address ili kuikuza: basi itaonyeshwa skrini nzima.
...
Basi unaweza kuwa na uhakika kwamba Address ni mali ya kwingineko yako.
...
Sasa unaweza kutuma Address hii kwa njia ya maandishi au kupitia msimbo wake wa QR kwa mtu au huduma inayohitaji kukutumia Satss. Baada ya shughuli hiyo kutangazwa kwenye mtandao, itaonekana kwenye kichupo cha `Miamala` cha Sparrow wallet.
...
Angalia maelezo ya muamala mara ya mwisho kwa usahihi, kisha ubofye `Maliza Muamala kwa Kutia Sahihi`.
...
Washa SeedSigner yako na uweke Satochip yako kama kawaida. Kutoka skrini ya kwanza, chagua `Scan`, kisha uchanganua msimbo wa QR unaoonyeshwa kwenye Sparrow.
...
Sasa kwa kuwa shughuli hiyo imetiwa saini na kuthibitishwa, kilichobaki ni kuitangaza kwenye mtandao wa Bitcoin ili Miner iweze kuijumuisha kwenye BLOCK. Katika Sparrow, bofya `Scan QR`.
...
Wasilisha msimbo wa QR unaoonyeshwa kwenye SeedSigner yako (ile iliyo na shughuli iliyotiwa saini) kwenye kamera ya wavuti. Sparrow itaonyesha maelezo yote ya muamala. Fanya ukaguzi wa mwisho kwamba maelezo yote ni sahihi, kisha ubofye "Muamala wa Matangazo" ili uyatangaze kwenye mtandao wa Bitcoin.
...
Muamala wako sasa umetumwa kwa mtandao. Unaweza kufuata uthibitisho wake katika kichupo cha `Miamala` cha Sparrow wallet.
...
Ikiwa bado una Satochip yako lakini SeedSigner yako imevunjwa au kupotea, hali ni rahisi kudhibiti, kwa kuwa Wallet yako bado iko kwenye Satochip.
...
Ikiwa hutaki kuunda tena, unaweza pia kutumia Satochip yako kwa njia ya kawaida, yaani moja kwa moja kutoka kwa kompyuta yako, bila kupitia SeedSigner. Njia hii inafanya kazi kikamilifu, lakini inapunguza sana usalama wa Bitcoin Wallet yako: unapoteza kutengwa kwa "*hewa-pengo*" na sasa inabidi utie sahihi kwa upofu, kwa kuwa SeedSigner ilifanya kazi kama skrini inayoaminika. Hata hivyo, hili linaweza kuwa suluhu la muda katika dharura, au ikiwa huwezi kujenga upya SeedSigner.
...
Hatimaye, weka PIN yako ya smartcard ili kuifungua. Kisha utaweza kufikia Wallet yako, ufanye miamala na utie sahihi moja kwa moja ukitumia Satochip iliyounganishwa.
...
Hali nyingine, nyeti zaidi ni wakati unapoteza ufikiaji wa Satochip yako iliyo na seed: iwe imevunjwa, imepotea, imeibiwa, au umesahau msimbo wake wa PIN. Iwapo Satochip yako imeibiwa au kupotoshwa, tunapendekeza kwamba, mara tu ufikiaji wa pesa zako umerejeshwa, uhamishe bitcoins zako mara moja kwa Wallet mpya kabisa, iliyotengenezwa kwa seed tofauti. Hii inahakikisha kwamba mshambulizi anayewezekana hawezi kamwe kufikia Satss yako.



Ili kupata tena ufikiaji wa kwingineko yako na kuhamisha pesa zako, pakia tu seed yako kwenye SeedSigner. Kulingana na media mbadala uliyotumia, una chaguzi kadhaa:





- Weka maneno yako ya Mnemonic wewe mwenyewe katika menyu ya `Mbegu > Weka maneno 12 ya seed`.
