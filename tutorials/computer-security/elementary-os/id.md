...
Elementary OS adalah sistem operasi berbasis Ubuntu, yang dirancang untuk menjadi sederhana, cepat, dan stabil untuk berbagai penggunaan sehari-hari. Ini merupakan alternatif Linux yang seimbang untuk MacOS dan Windows. Interface grafisnya yang lancar, intuitif, dan rapi membuatnya mudah dipelajari, bahkan untuk pemula. Sistem operasi ini juga berfokus pada ergonomi, keamanan, dan kinerja.



https://planb.network/tutorials/computer-security/operating-system/ubuntu-78a3be56-5d51-4ec3-8629-0dd27c352ab5

## Mengapa memilih OS Dasar
...
Kunjungi situs web sistem operasi resmi [elementary] (https://elementary.io/) dan pilih jumlah yang akan diberikan untuk mendukung proyek ini. Langkah ini bersifat opsional.


Jika Anda ingin mengunduh citra ISO secara gratis, masukkan 0 pada kolom **"Lainnya "** dan mulai mengunduh citra ISO sistem.
...
Setelah Anda mengunduh citra ISO, Anda harus membuatnya dapat di-boot pada kunci USB untuk melanjutkan instalasi.



Unduh perangkat lunak, seperti [Balena Etcher](https://etcher.balena.io/) atau alat yang serupa, kemudian jalankan perangkat lunak tersebut.


Pilih citra ISO **Elementary OS** yang telah diunduh sebelumnya, lalu tetapkan kunci USB Anda sebagai target.



Klik tombol **flash** untuk memulai proses, dan tunggu sampai proses selesai sebelum melepas kunci USB.
...
Matikan komputer yang ingin Anda instal Elementary OS, lalu colokkan kunci USB.
...
Instalasi dimulai secara otomatis jika kunci USB dikonfigurasi dengan benar.
...
Pilih tata letak yang sesuai dengan keyboard Anda. Sebuah bidang disediakan untuk memeriksa apakah tuts menghasilkan karakter yang benar.
...
Elementary OS memungkinkan Anda menguji sistem sebelum menginstalnya. Mode ini memungkinkan Anda menjelajahi Interface tanpa memodifikasi apa pun pada disk Hard.
...
- Klik **"Hapus disk dan instal "** untuk menginstal secara langsung pada seluruh disk.
- Klik **"Installasi khusus "** jika Anda ingin mengelola partisi secara manual.
...
Sebelum meluncurkan penginstalan, Anda dapat mengesahkan penginstalan otomatis driver perangkat keras tambahan, tergantung pada kompatibilitas mesin Anda.





- Klik "Hapus dan pasang" untuk memulai pemasangan.
...
Setelah selesai, klik tombol **enter** untuk memulai ulang, kemudian lepaskan kunci USB pada saat yang tepat untuk menghindari pengulangan instalasi.
...
Masuk ke **AppCenter** dan klik ikon pembaruan di sudut kanan atas. Tunggu hingga pembaruan terdaftar, lalu klik **"Perbarui Semua "** untuk memulai penginstalan.
...
OS Dasar hanya menyertakan alat yang penting. Untuk menyesuaikan lingkungan Anda dengan kebutuhan Anda, terutama jika Anda adalah seorang pengembang, kami sarankan untuk menginstal alat tambahan.
...
Elementary OS sekarang sudah aktif dan berjalan di mesin Anda. Filosofi kesederhanaan, ringan, dan elegan membuatnya menjadi pilihan yang sangat baik untuk penggunaan pribadi dan profesional. Anda mendapatkan sistem yang stabil, lancar, dan rapi, siap untuk dikustomisasi sesuai dengan preferensi Anda. Baik untuk pengembangan, penggunaan kantor, atau penjelajahan sehari-hari, semuanya tersedia untuk membangun lingkungan kerja yang efisien, intuitif, dan menyenangkan. Lihat juga tutorial kami tentang Fedora, distribusi Linux yang juga sederhana, tangguh, dan modular.
