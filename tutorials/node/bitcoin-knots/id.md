...
Kunjungi [situs web resmi Bitcoin Knot] (https://bitcoinknots.org/#download) untuk mengunduh versi untuk sistem operasi kamu. Jangan lupa untuk mengunduh sidik jari dan tanda tangan untuk memverifikasi perangkat lunak. File-file ini juga tersedia [di repositori GitHub Bitcoin Knots](https://github.com/bitcoinknots/Bitcoin).
...
Temukan IP Address dari mesin yang menghosting Bitcoin Knot di jaringan lokal. Untuk melakukan ini, kamu dapat menggunakan alat seperti [Angry IP Scanner] (https://angryip.org/). Mari kita asumsikan, untuk kepentingan argumen, bahwa IP Address dari node adalah `192.168.1.18`.
