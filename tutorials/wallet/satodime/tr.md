...
**Satochip](https://satochip.io/fr/)** tarafından geliştirilen *Satodime**, Bitcoin'i somut ve basit bir şekilde saklamak için güvenli bir taşıyıcı karttır. Üçüncü bir tarafa bağlı olmadan özel anahtarlarınız üzerinde tam kontrole sahip olduğunuz, kendi kendine emanet edilen bir Hardware Wallet görevi görür. Açık kaynaklı ve EAL6+ sertifikalı olan bu ürün, üç adede kadar bağımsız kasayı destekler.
...
Satodime, bir **carte au porteur, önceden kayıt veya kimlik tespiti gerekmeksizin fiziksel olarak sahip olan kişiye aittir**. Güvenli, taşınabilir Bitcoin depolama ihtiyacını karşılayarak, kartı elinde bulunduran herkesin onu kullanmasına veya kasaları ele geçirmek veya mühürlerini açmak için mobil uygulama aracılığıyla tarayarak bitcoin transfer etmesine olanak tanır. Kağıt bir banknottan farklı olarak, Seal özel anahtarları için güvenli bir çip kullanır ve bu anahtarlar yalnızca mühür açıldıktan sonra ortaya çıkar, bu da kartı Ownership'nin fiziksel sahiplikle belirlendiği nakit paraya benzer hale getirir. Hediye olarak bitcoin vermek için ideal olan bu kart, bitcoinlerin elden ele güvenli bir şekilde aktarılmasını kolaylaştırırken, mobil uygulama da erişilebilir akıllı telefon etkileşimi için NFC'den yararlanıyor.
...
- Özellikler**: Doğrudan uygulama üzerinden bitcoin satın alın (Paybis ortağı); Mainnet ve Testnet'yı yönetin.
...
- Uyarı**: Bu adım geri döndürülemez. Lütfen [*Ownership* makalesine] (https://satochip.io/satodime-Ownership-explained/) bakın.
...
Satodime en fazla 3 kasayı destekler. Bitcoin'u saklamak için bir tane oluşturun:
...
- Blockchain'i (Bitcoin) seçin.
- "*Create & Seal*" üzerine tıklayın.
- Kartı generate ve Seal'e özel anahtarı tarayın (mühür açılana kadar bilinmiyor).
...
- Genel Address'yı kopyalayın veya QR kodunu tarayın.
- Başka bir Wallet'den fon gönderin.
- Blockchain'de onayladıktan sonra bakiyeyi kontrol edin.
...
- Güvenlik**: Özel anahtarınızı asla paylaşmayın. Çevrimdışı saklayın.
- Fon yönetimi ile uyumlu bir Wallet yazılım programına (örneğin Sparrow wallet veya Electrum) aktarın.
...
Kasanın sıfırlanması, ilgili özel anahtarı geri döndürülemez şekilde siler. Başka bir deyişle, özel anahtarınızın bir kopyasını güvence altına almadıysanız veya başka bir Wallet'e aktarmadıysanız, kasayı sıfırlamak içindeki fonların geri döndürülemez şekilde kaybolmasına neden olacaktır.
...
- Kartın Ownership'sını alın,
- Bir Bitcoin kasası oluşturun,
- Satss'i oraya transfer edin,
- Transfer kartı Ownership: kartı tarayan bir sonraki kişi kartın sahibi olur,
- Satodime kartını seçtiğiniz kişiye verin ve uygulamayı indirmesini ve ardından kartı tarayarak Ownership'unu almasını ve böylece üzerinde 'depolanan' bitcoinlere erişmesini isteyin.
...
- Durumu kontrol edin**: Ownership kartını ve kasaların mühürlü/mühürsüz durumunu onaylamak için her zaman tarayın.
...
- Kurtarma**: Kart kaybolur ancak sahiplenilirse, fonlar Blockchain'dedir; mühürlenmemişse özel anahtarı kullanın.
...
kendi kendine saklama, özel anahtarlar vb. hakkında eğitimler için [Plan ₿ Network](https://planb.network/).
...
**Satochip** bitcoin ve diğer kripto para birimlerini yönetmek ve saklamak için donanım ve yazılım çözümleri geliştiren Belçikalı bir şirkettir. Amiral gemisi ürünü Satochip Hardware Wallet, EAL6+ sertifikalı bir secure element ile donatılmış bir NFC kartıdır. Mnemonic ifade ve sır yöneticisi Seedkeeper ve hamiline kart Satodime ile tamamlanan Satochip, kullanıcıların ihtiyaçlarına göre uyarlanmış kapsamlı bir ürün yelpazesi sunmaktadır. Açık kaynak yazılımla çalışan cihazları, Bitcoin'da güvenliği demokratikleştirmeyi amaçlıyor.