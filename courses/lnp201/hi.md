...
LNP201 पाठ्यक्रम में आपका स्वागत है!

यह प्रशिक्षण आपको लाइटनिंग नेटवर्क की गहन तकनीकी समझ प्रदान करने का उद्देश्य रखता है, जो एक ओवरले नेटवर्क है जिसे बिटकॉइन लेन-देन को तेजी से और अक्सर कम लागत पर निष्पादित करने के लिए डिज़ाइन किया गया है। आप धीरे-धीरे उन मौलिक अवधारणाओं की खोज करेंगे जो इस प्रणाली को नियंत्रित करती हैं, भुगतान चैनलों के उद्घाटन से लेकर रूटिंग तकनीकों और तरलता प्रबंधन तक।

**खंड 1: मूल बातें**  
हम लाइटनिंग नेटवर्क का सामान्य परिचय देकर शुरुआत करेंगे, जिसमें बिटकॉइन, उसके पते, UTXO और लेन-देन के काम करने के तरीकों के बारे में महत्वपूर्ण नींव स्थापित की जाएगी। यह मौलिक पुनरावलोकन यह समझने के लिए आवश्यक है कि लाइटनिंग नेटवर्क कैसे ब्लॉकचेन के बुनियादी तंत्रों का उपयोग करके सुरक्षित रूप से संचालित होता है।

**खंड 2: चैनल खोलना और बंद करना**  
इस खंड में, हम चैनलों को खोलने की प्रक्रिया का अन्वेषण करेंगे, जो कि लाइटनिंग नेटवर्क की आधारशिला है। आप सीखेंगे कि कमिटमेंट ट्रांज़ेक्शन कैसे बनाए जाते हैं, सुरक्षा के लिए रेवोकेशन कीज़ की भूमिका क्या होती है, और चैनल्स को सहकारी या एकतरफा तरीके से कैसे बंद किया जा सकता है। हर चरण को सटीक और तकनीकी रूप से समझाया जाएगा ताकि आप सभी बारीकियों को समझ सकें।

**खंड 3: एक तरलता नेटवर्क**  
लाइटनिंग नेटवर्क केवल व्यक्तिगत चैनलों तक सीमित नहीं है; यह वास्तव में एक भुगतान नेटवर्क है। हम देखेंगे कि कैसे लेन-देन को HTLC के माध्यम से मध्यवर्ती नोड्स के माध्यम से रूट किया जा सकता है। यह भाग आपको इनबाउंड और आउटबाउंड तरलता की चुनौतियों से भी परिचित कराएगा।

**खंड 4: लाइटनिंग नेटवर्क के उपकरण**  
यह खंड लाइटनिंग नेटवर्क के व्यावहारिक उपकरणों को प्रस्तुत करता है, जैसे कि *Invoices*, *LNURL*, और *Keysend*। आप अपने चैनलों की तरलता को प्रबंधित करने का तरीका भी सीखेंगे, जो कि आपके लाइटनिंग नेटवर्क लेनदेन की दक्षता को अधिकतम करने और भुगतान की सुगमता सुनिश्चित करने के लिए एक महत्वपूर्ण पहलू है।

**खंड 5: आगे बढ़ें**  
अंत में, हम उन अवधारणाओं का पुनरावलोकन करेंगे जिन्हें हमने कवर किया है और उन लोगों के लिए और अधिक उन्नत विषयों की ओर जाने का रास्ता खोलेंगे जो लाइटनिंग नेटवर्क के बारे में अपने ज्ञान को गहरा करना चाहते हैं।

क्या आप लाइटनिंग नेटवर्क की तकनीकी प्रक्रियाओं को समझने के लिए तैयार हैं? तो चलिए शुरू करते हैं!
