...
# Baue deinen ersten DIY-Bitcoin-Heizkörper




Dieser Kurs basiert auf Attakai, einem praxisnahen DIY-Projekt, das einen gebrauchten S9-Miner in eine Bitcoin-Heizung für zu Hause verwandelt.

Sie beginnen mit einem prägnanten Überblick über das Bitcoin-Mining und die Realitäten der Mining-Industrie und gehen dann direkt zum Aufbau über: Beschaffung der richtigen Hardware, Flashen und Konfigurieren von BraiinsOS+, Einrichten des Netzwerks, Austauschen der Lüfter, Beitritt zu einem Mining-Pool und Optimierung der Leistung hinsichtlich Wärme, Lärm und Effizienz.

Schritt-für-Schritt-Anleitungen führen Sie durch den gesamten Prozess, sodass Sie Attakai zu Hause bauen und Ihre ersten Sats minen können, während Sie Ihren Raum heizen.
...
Heutzutage verwenden Miner ausschließlich für diese Operation entwickelte ASICs, die optimiert sind, um mit dem geringstmöglichen Energieverbrauch und so schnell wie möglich eine maximale Anzahl von Kombinationen zu testen. Diese Computer, die keine anderen Aufgaben als das Bitcoin-Mining ausführen können, sind ein greifbarer Beweis für die kontinuierliche Entwicklung und zunehmende Spezialisierung der Bitcoin-Mining-Industrie. Diese ständige Evolution spiegelt die intrinsische Dynamik von Bitcoin wider, wo eine Anpassung der Schwierigkeit die Produktion eines Blocks alle zehn Minuten garantiert, trotz der exponentiellen Steigerung der Mining-Kapazität.
Um die Intensität dieses Prozesses zu veranschaulichen, betrachten Sie einen typischen Miner, der in der Lage ist, 14 TeraHash pro Sekunde zu erreichen, das entspricht 14 Billionen Versuchen pro Sekunde, um den richtigen Hash zu finden. Im gesamten Bitcoin-Netzwerk erreicht man heute etwa 300 ExaHash pro Sekunde, was die kollektive Kraft, die im Bitcoin-Mining mobilisiert wird, unterstreicht.
...
- Home Mining: Die Idee des Home Mining basiert auf der Dezentralisierung der Mining-Aktivitäten. Sie ermutigt Einzelpersonen, am Mining-Prozess von zu Hause aus teilzunehmen, wodurch die Hashrate breiter verteilt wird.
...
Mit dem erwarteten Wachstum des Lightning Network und der damit einhergehenden Zunahme von Kanalöffnungen und -schließungen wird der Platz in den Bitcoin-Blöcken immer wertvoller. Die Bitcoin-Community neigt bereits dazu, die Bewahrung dieses Speicherplatzes zu schätzen, in Anerkennung seiner inhärenten Begrenzung. Diese Erkenntnis hat zu Diskussionen über die legitime oder nicht legitime Nutzung des Blockspace geführt, mit Bedenken hinsichtlich des „Spams“ auf der Blockchain durch Transaktionen, die als nicht wesentlich angesehen werden.

![image](assets/en/008.webp)
Die Spekulation um die zukünftige Nutzung des Blockspaces ist weit verbreitet, doch es wird allgemein anerkannt, dass dies eine seltene Ressource ist, die weise genutzt werden sollte. Auch wenn das Verlangen besteht, ihn zu füllen, ist es entscheidend, ihn zu bewahren, um die langfristige Zukunftssicherheit des Bitcoin-Netzwerks zu sichern, in Erwartung eines zukünftigen Anstiegs der Nachfrage nach Blockspace. Wie in jedem freien Markt werden Angebot und Nachfrage die Nutzung des Blockspaces regulieren. Mit einem begrenzten Angebot müssen die Stakeholder kluge Entscheidungen über die Nutzung dieses wertvollen Speicherplatzes treffen, um die Effizienz und Sicherheit des Bitcoin-Netzwerks langfristig zu gewährleisten.
...
Die Möglichkeit, jungfräuliche Bitcoins zu schürfen, während man die Know your Customer (KYC) Verfahren umgeht, ist ein weiterer Mehrwert. Viele Mining-Pools verlangen nicht die Identität der Miner, was es ermöglicht, Bitcoins zu erwerben, ohne sich umständlichen Identitätsprüfungen zu unterziehen. Jungfräuliche Bitcoins gelten als "sauber", ohne jegliche vorherige Geschichte oder Assoziation. Sie sind besonders bei großen institutionellen Akteuren gefragt, die die Legitimität ihrer digitalen Vermögenswerte gegenüber den Regulierungsbehörden garantieren können. Trotz dieser Vorteile ist es entscheidend zu erkennen, dass die Mining-Industrie extrem wettbewerbsfähig und volatil bleibt und unvorhergesehene Vorfälle die Mining-Operationen stören können.
...
### Wird das Mining in Europa verboten?
