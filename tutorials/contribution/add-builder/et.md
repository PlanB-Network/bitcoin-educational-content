...
- Minge [PlanB-le pühendatud GitHub'i andmerepositooriumisse](https://github.com/PlanB-Network/bitcoin-educational-content/tree/dev/resources/projects) jaotisesse `resources/project/`:
...
- Selles kaustas loote esimese YAML-faili nimega `project.yml`:
...
- Minge tagasi kausta `resources/projects/` ja valige äri, mille te just eelmises commit'is lõite:
...
- Jätke commit'i pealkiri vaikimisi, veenduge, et ruut `Commit directly to the patch-1 branch` oleks märgitud, seejärel klõpsake `Commit changes`: ![project](assets/23.webp)
...
![project](assets/30.webp)- Faili juures olles klõpsake paremas ülanurgas kolmel väikesel punktil ja seejärel valige `Delete file`:
