...
description: Seadistage Blockstream App mobiilis ja hallake onchain tehinguid
---
...
- Selles õpetuses selgitatakse, kuidas kasutada **Blockstream App** mobiilirakendust Bitcoin **onchain** Wallet haldamiseks, st otse peamisel Blockchain Bitcoin-l salvestatud tehingute haldamiseks.
- See hõlmab paigaldamist, esialgset konfigureerimist, Software Wallet loomist ning bitcoinide vastuvõtmise ja saatmise toiminguid.
- Märkus: Muud lisades olevad õpetused hõlmavad Liquid, Watch-Only ja töölauaversiooni.
...
### 1.3. Meeldetuletused Hot rahakottide kohta
...
- Kui soovite hallata **Cold Wallet** (offline Wallet): klõpsake **"Connect Jade "**, et kasutada Hardware Wallet Blockstream Jade või teisi ühilduvaid Cold rahakotte.
...
- (2) **"Taastamine varukoopiast "**: Olemasoleva portfelli importimine, kasutades Mnemonic fraasi (12 või 24 sõna). Ettevaatust: Ärge importige Cold Wallet fraasi, sest see paljastub ühendatud seadmes, mis muudab selle turvalisuse kehtetuks.
- (3) **"Ainult valvega "**: Importige olemasolev ainult lugemiseks mõeldud portfell, et vaadata saldot (nt teie Cold Wallet) ilma Mnemonic fraasi avaldamata. Vt ainult jälgimise õpetust lisas.
...
### 4.2. Salvesta seed lause





- Wallet avakuval klõpsake vahekaardil "Turvalisus" ja seejärel menüüs "Varundamine" või "Taastamisfraas":
...
Enne selle seed lausega seotud Address-le vahendite saatmist peate testima oma 12 sõna varundust.



Selleks kirjutame üles viite, kustutame Wallet, taastame selle varukoopiaga ja kontrollime, et viide ei muutu.





- Klõpsake Wallet avakuval vahekaardil "Settings" (Seaded), seejärel "Wallet Details" (Wallet andmed) ja kopeerige zPub ([extended public key](https://planb.academy/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f/0488ec38-da31-46a1-b31e-04b5c05fb6e8):
...
- Kustutage rakendus, seejärel taastage Wallet **"Restore from Backup "** kaudu, sisestades Mnemonic fraasi, ja kontrollige, et zpub on muutmata. Kui jah, siis on teie varukoopia õige ja te saate Wallet-le raha saata.
...
- Avakuvalt Wallet avakuvalt valige **"Turvalisus "** ja seejärel klõpsake **"PIN "**
...
**Märkus**: PIN-kood kindlustab seadme, kuid raha kättesaamiseks saab kasutada ainult seed fraasi.





## 5. Onchain Wallet kasutamine
...
- Rakendus kuvab **tühja vastuvõtu Address** (SegWit v0 formaat, mis algab sõnaga `bc1q...`). Uue Address kasutamine iga kord, kui saate Bitcoin, parandab teie konfidentsiaalsust.
...
- **Valikud**:
    ...
    - (4) Konkreetse summa taotlemiseks klõpsake paremal üleval olevatel kolmel punktil, valige "Request amount" ja sisestage soovitud summa. QR ajakohastatakse ja Address asendatakse Bitcoin makse URIga.
...
Minimaalne summa (dush-limiit) 03/08/2025 on 546 Sats.




    - (4) Valige **tehingutasud** :
        - Valige pakutud valikute hulgast (nt kiire, keskmine, aeglane) sõltuvalt kiireloomulisusest ja kuvatakse ligikaudne ülekande aeg.
        - Kohandatud tasude puhul kohandage käsitsi Satoshi arvu vbiti kohta (vt [Mempool.space](https://Mempool.space/) turuhindade kohta).
...
- Kuni tehing ei ole kinnitatud, võimaldab funktsioon "Replace by fee" (vt lisa) kiirendada selle käsitlemist, suurendades tehingutasusid:
...
**Määratlus**: Replace-by-fee (RBF) on Bitcoin võrgu funktsioon, mis võimaldab saatjal kiirendada **ahela** tehingu kinnitamist, nõustudes maksma kõrgemat tasu.
...
- Esialgne tehing tuleb selle loomisel märkida RBF-ga ühilduvaks, mida Blockstream App teeb automaatselt.
