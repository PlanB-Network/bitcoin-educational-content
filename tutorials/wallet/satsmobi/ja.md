...
Walletは確認を求めるメッセージを送る。**Pay**をクリックすると、Invoiceに支払いが行われる。
...
- **/send** は、LN Addressまたはテレグラム・ハンドルを受取人に指定して資金を送る；
...
**OK**をクリックするとInvoiceが表示され、QRコードで顧客に見せることもできるし、インスタント・メッセージで文字列として送信し、支払いを済ませることもできる。
