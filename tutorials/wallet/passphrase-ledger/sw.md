...
description: Jinsi ya kuongeza passphrase kwa Ledger Wallet yako?
---
...
Kwenye ukurasa wa nyumbani wa Ledger yako, bofya kwenye gurudumu la gia la mipangilio.
...
Hii ndiyo hatua ambapo unaweza kuchagua kati ya chaguo la "iliyounganishwa kwa PIN" au chaguo la "muda" tulilozungumzia katika sehemu iliyotangulia. Hapa, nitaelezea jinsi ya kuanzisha passphrase ya muda, kwa hiyo bonyeza "Weka passphrase ya muda".


![PASSPHRASE BIP39](assets/notext/06.webp)

Kisha unaulizwa kuingiza passphrase yako. Chagua passphrase dhabiti na uendelee mara moja kwa nakala rudufu, kwenye nyenzo kama vile karatasi au chuma. Katika mfano huu, nilichagua passphrase: `fH3&kL@9mP#2sD5qR!82`. Baada ya kuingiza passphrase yako, bofya kitufe cha "*Endelea*".

![PASSPHRASE BIP39](assets/notext/07.webp)


Thibitisha kuwa passphrase yako inalingana na ulichobainisha kwenye nakala yako halisi, kisha ubofye kitufe cha "*Ndiyo, ni sahihi*" ili kuthibitisha.
...
Chagua jina la Wallet yako inayolindwa na passphrase. Kwa mfano huu, nilichagua jina kwa uwazi ikijumuisha neno "*passphrase*". Hata hivyo, ikiwa ungependa kuweka uamuzi wa Wallet hii kwenye kompyuta yako, unaweza kuchagua jina lisilo la kusisimua.


![PASSPHRASE BIP39](assets/notext/11.webp)


Chagua aina ya hati ya Wallet yako. Ninakushauri kuchagua "*Taproot*" au vinginevyo "*Native SegWit*".
...
Bofya kwenye kitufe cha "*Scan....*".


![PASSPHRASE BIP39](assets/notext/14.webp)


Bofya kwenye "*Leta Duka la Vitufe*" karibu na Ledger yako.


![PASSPHRASE BIP39](assets/notext/15.webp)


Wallet yako iliyolindwa na passphrase sasa imeundwa kwenye Sparrow. Ili kuthibitisha, bofya kitufe cha "*Tekeleza*".
...
Na hapo unayo, Wallet yako sasa imeundwa! Katika menyu ya "*Mipangilio*", Sparrow itakupatia "*Alama yako kuu ya kidole*". Hii inawakilisha alama ya kidole ya ufunguo mkuu wako, unaotumika kama msingi wa kupata Wallet yako. Ninapendekeza sana kuweka nakala ya alama hii ya vidole. Katika mfano wangu, inalingana na: `281ee33a`.


![PASSPHRASE BIP39](assets/notext/18.webp)


Kumbuka kile tulichotaja katika sehemu zilizopita: kosa, hata ndogo, katika kuingiza passphrase yako itakuwa generate Wallet mpya kabisa na funguo tofauti. Kila wakati unahitaji kuhakikisha kuwa unafikia Wallet sahihi ukitumia passphrase sahihi, hakikisha kuwa alama ya kidole ya ufunguo mkuu wako inalingana na uliyoandika. Habari hii, yenyewe, haileti hatari kwa usalama wa pesa zako au faragha yako.


Kabla ya kutumia Wallet yako na passphrase, ninakushauri sana kufanya mtihani wa kurejesha kavu. Andika sehemu ya marejeleo kama vile xpub yako au alama ya kidole ya ufunguo mkuu wako, kisha uweke upya Ledger yako huku Wallet ingali tupu. Kisha, jaribu kurejesha Wallet yako kwenye Ledger kwa kutumia nakala zako za karatasi za maneno 24 na passphrase. Hakikisha kuwa maelezo yaliyotolewa baada ya urejeshaji yanalingana na uliyobainisha hapo awali. Ikiwa ndivyo ilivyo, unaweza kuhakikishiwa kuwa nakala zako za karatasi ni za kuaminika.


## Jinsi ya kuanzisha passphrase iliyounganishwa na PIN na Ledger?
...
Hii ndiyo hatua ambapo unaweza kuchagua kati ya chaguo la "*iliyounganishwa kwa PIN*" au "*muda*" tulilozungumzia katika sehemu iliyotangulia. Hapa, nitaelezea jinsi ya kusanidi passphrase iliyoambatishwa kwa PIN, kwa hivyo bofya "*Weka passphrase na uiambatishe kwa PIN mpya*".
...
Ili kukamilisha uundaji wa passphrase yako, weka msimbo mkuu wa PIN wa Ledger yako (sio ile inayohusishwa na passphrase).
...
Chagua aina ya hati ya Wallet yako. Ninakushauri kuchagua "*Taproot*" au, bila hivyo, "*Native SegWit*".
...
Na hapo unayo, Wallet yako sasa imeundwa! Katika menyu ya "*Mipangilio*", Sparrow itakupatia "*Alama yako kuu ya kidole*". Hii inawakilisha alama ya kidole ya ufunguo mkuu wako, unaotumiwa chini ya chimbuko la Wallet yako. Ninapendekeza sana kuweka nakala ya alama hii ya vidole. Katika mfano wangu, inalingana na: `281ee33a`.
...
Hongera, Bitcoin Wallet yako sasa imelindwa na passphrase! Ikiwa umepata mafunzo haya kuwa ya manufaa, ningeshukuru ikiwa unaweza kuacha dole gumba hapa chini. Jisikie huru kushiriki nakala hii kwenye mitandao yako ya kijamii. Asante sana!
