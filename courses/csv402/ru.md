...
- **Свидетелем** является сама сделка, которая доказывает, что вы закрыли печать с таким содержанием;
...
Мы не будем подробно останавливаться на каждой из этих конфигураций, поскольку в RGB мы решили использовать **аутпоинт** в качестве определения печати, а **коммитмент** поместить в выход транзакции, расходующей этот **аутпоинт**. Поэтому мы можем ввести следующие понятия для продолжения:
