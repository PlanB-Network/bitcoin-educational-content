...
Действительно, для лучшего противодействия анализу блокчейна, что может быть лучше, чем ознакомление с методами, используемыми в анализе блокчейна? Если вы хотите знать, как улучшить свою конфиденциальность в Биткойн, вы должны понимать эти методы. Это позволит вам лучше освоить техники, такие как [coinjoin](https://planb.network/tutorials/privacy/on-chain/coinjoin-samourai-wallet-e566803d-ab3f-4d98-9136-5462009262ef) или [payjoin](https://planb.network/fr/tutorials/privacy/on-chain/payjoin-848b6a23-deb2-4c5f-a27e-93e2f842140f) (техники, которые мы изучим в последних частях обучения), и сократить количество ошибок, которые вы могли бы совершить.
...
---
*В следующих разделах этой главы, посвященной BIP47, мы подробно рассмотрим его работу, уделяя особое внимание используемым криптографическим методам. Чтобы полностью понять эти довольно технические объяснения, важно сначала разобраться в структуре HD-кошельков, процессах производных ключей и основных принципах криптографии на основе эллиптических кривых. Если вы хотите углубить свои знания, доступно бесплатное обучение на Plan ₿ Network:*

https://planb.network/courses/cyp201

*Я настоятельно рекомендую пройти его, так как понимание технической работы BIP47 значительно упростит восприятие других подобных предложений, которые мы обсудим в следующих главах.*
