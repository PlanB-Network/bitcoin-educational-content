...
## Dolandırıcılıklar ve Finansal Dolandırıcılıklar

<chapterId>8af2948b-2ab5-54c4-862c-3414b8a285a2</chapterId>

"Kripto para" sektöründe iki ana kolun ortaya çıktığı bir sektördeyiz:
...
Finansal yatırım alanında, piramit satış sistemleri ve saadet zincirleri yasadışı modeller olarak öne çıkmaktadır. Yeni yatırımcıların parasını eski katılımcılara ödeme yapmak için kullanarak çalışırlar. Bununla birlikte, sürdürülemez yapıları ve sistemi devam ettirmek için yeni gelenlere bağımlı olmaları, kaçınılmaz olarak çökmelerini muhtemel kılmaktadır.
...
Pompala ve Boşalt stratejisi tipik olarak iyi tanımlanmış bir model izler:

1. Bir kanaat önderi veya bir grup yatırımcı önce hedeflenen çok sayıda hisse senedini veya diğer varlıkları satın alır.

2. Daha sonra bu varlıklar etrafında bir aldatmaca yaratırlar ve diğer yatırımcıları çekmek için abartılı veya yanıltıcı bilgiler yayarlar.

3. Bu yutturmaca, bu varlıkları kitlesel olarak satın almaya başlayan insan yatırımcılar ve yatırım botları arasında FOMO'yu (Fear Of Missing Out) tetikler.

4. Fiyat yeterince yükseldiğinde, liderler varlıklarını toplu olarak satar ve böylece önemli bir kâr elde ederler.

5. Büyük satışlar, varlığın fiyatında keskin bir düşüşe yol açarak birçok yatırımcının önemli kayıplar yaşamasına neden olur.

Bu tür stratejilere katılmanın yasa dışı olduğunu ve piyasa manipülasyonu suçlamalarıyla sonuçlanabileceğini anlamak önemlidir. Ayrıca, bu stratejiler genellikle üyelik ücreti alan etkili gruplar tarafından düzenlenir. Bazı katılımcılar kısa vadeli kazançlar elde edebilirken, Pompala ve Boşalt stratejileri genellikle uzun vadede kârlı değildir.
...
Son olarak, çevrimiçi dolandırıcılıktan kaçınmak için bazı ipuçları:


- Dürüst kişiler sizden asla doğrudan para göndermenizi istemeyecektir.
- Bilinmeyen bir Address'e asla bitcoin göndermeyin.
- Gerçekçi olmayan getiri vaatleri her zaman şüphelidir.
- Yarışmaların hileli olması muhtemeldir.
- Öğrenerek her zaman oynayarak kazandığınızdan daha fazlasını kazanırsınız.
- Şüpheye düştüğünüzde hemen harekete geçmeyin. Düşünmek ve araştırma yapmak için zaman ayırın. FOMO (Fear Of Missing Out) en büyük düşmanınız olabilir.
...
Kendinizi korumanın en iyi yolu kendi araştırmanızı yapmak ve bilgi kaynaklarını doğrulamaktır. YouTube'da bir video izlemek kaynakları doğrulamak için yeterli değildir.

Ben de dahil olmak üzere herkesin bir gündemi olduğunu unutmamak gerekir. Bitcoin'e inanıyorum ve amacım bunu teşvik etmek. Bu tanıtımdan hem siyasi hem de finansal olarak fayda sağlamayı umuyorum. Hiçbir içerik asla tamamen ücretsiz değildir - eğer bir ürün ya da hizmet ücretsiz görünüyorsa, bunun nedeni büyük olasılıkla ürünün siz olmanızdır.

Herkesin niyetleri konusunda şeffaf olmayabileceğini her zaman aklınızda bulundurun. Her zaman birinin eylemlerinin amacını sorgulayın ve onlara körü körüne güvenmeyin.
...
- Bilgisayarınızı güncel tutun ve kötü amaçlı yazılımlardan arındırın,
- Özel araçlar (Signal, Tor, ProtonMail) kullanarak gizliliğinize değer verin.

Bu konu sizin için tamamen bilinmezse, SCU 101 kursu bu konuyu ayrıntılı olarak incelemek için ilginç olabilir.

https://planb.network/courses/99c46148-7080-4915-a7e0-9df0e145cd47
Bitcoin ile ilgilenseniz de ilgilenmeseniz de bilgisayarınızı en iyi çalışır durumda tutmak çok önemlidir. Bir güncelleme sadece yeni özellikler eklemek için değildir: aynı zamanda hataları düzeltir ve yazılımınızın güvenliğini artırır. Bu yüzden şunları yaptığınızdan emin olun:


- Yazılımınızı her zaman güncelleyin,
- Güvenilir antivirüs yazılımı kullanın,
- Dosya indirirken dikkatli olun,
- Verilerinizi düzenli olarak yedekleyin,
- Şifrelerinizi asla paylaşmayın.

Ek bir ipucu: harici bir Hard sürücü satın almayı düşünün ve önemli dosyalarınızın tam yedeğini alın. Bu, bilgisayar arızası durumunda çok değerli olabilir.

Şifre yöneticisi, şifrelerinizi saklayan ve yöneten bir yazılımdır. Aynı parolayı asla iki kez kullanmamanıza, karmaşık ve güvenli parolalar seçmenize yardımcı olur ve çevrimiçi güvenlik yönetiminizi kolaylaştırır. Yalnızca bir ana parolayı hatırlamanız gerekir. Herkesin yararlanması gereken ücretsiz bir araçtır. Yavaş yavaş kullanmaya başlayabilirsiniz ve bir kez alıştığınızda, son derece kullanışlı ve kullanımı kolay olduğunu göreceksiniz.

![password manager](assets/prerequis/12.webp)

2FA, ister kripto para platformları, ister Google/E-posta hesapları, bankalar veya çevrimiçi alışveriş siteleri olsun, en hassas hesaplarınız için ek bir Layer güvenlik sağlar. Giriş yapmak için genellikle telefonunuzdan erişilebilen 6 haneli bir kod olan ikinci bir kimlik gereklidir. Telefonunuzu kaybetmeniz ihtimaline karşı anahtarın yedek bir kopyasını bir yerde saklamayı unutmayın.
...
- Para transferleri için Samurai Wallet.

Bir kez daha, bu konuyla ilgileniyorsanız, SECU 101 kursu size rehberlik etmek için hazırdır.

## Yeni Başlayanlar İçin İpuçları

<chapterId>33134b3f-92c1-5185-afb6-88599e47e801</chapterId>

Örgün eğitim bize yatırım hakkında çok az şey öğretir. Sonuç olarak, bu yeni ve karmaşık yatırım ortamına genellikle tek başımıza giriyoruz.

Bu bölümde, yeni başlayan yatırımcıların Bitcoin dünyasına girerken yaptıkları bazı yaygın hatalara ve aynı tuzaklara düşmekten nasıl kaçınabileceğinize bakacağız. Ayrıca Bitcoin yatırımınızı akıllıca nasıl planlayacağınızı da tartışacağız. Ele alacağımız konular şunlardır:


- "Shitcoins" veya gerçek değeri olmayan diğer kripto paralara karşı dikkatli olmak.
- Sadece kaybetmeyi göze alabileceğiniz kadar yatırım yapın.
- Ticaret ve yatırım arasındaki farkı anlamak.
- Vergi sonuçlarının farkında olmak.
- Özel anahtarınızı doğru şekilde yönetmek.
- Alçakgönüllü ve sağduyulu kalmanın önemi.
- Uzun vadeli bir bakış açısı benimsemek.

![password manager](assets/prerequis/0.webp)

Bitcoin yatırımına dalmadan önce, kendinizi eğitmek için zaman ayırmanız çok önemlidir.

Bitcoin sektöründe hata yapmak kolaydır ve her hata maliyetli olabilir. Yatırım yolculuğumda karşılaştığım ve başkalarında gözlemlediğim bazı tuzakları paylaşarak, bu alanda gezinmek için değerli tavsiyeler vermeyi umuyorum. Bu hatalardan bazıları şunlardır:

| Teknik Sorunlar                                         | Finansal Sorunlar                                               |
| ------------------------------------------------------ | -------------------------------------------------------------- |
...
| Çevrimiçi güvenlik sorunları                           | Ticaret ve yatırım arasındaki farkı anlamamak                 |
| Yanlış kullanım                                        | Vergi etkilerinin göz ardı edilmesi                           |
| Bilgisayar sorunları                                   | Yatırım zaman çizelgelerinin dikkate alınmaması               |
...
- Düzenli ortalama alımlar iyi bir uygulamadır.
- Yatırım yapmak için borç para almak gibi kaldıraç kullanımı genellikle tavsiye edilmez.
- Düşüncesiz yatırımlara yol açabilecek FOMO'dan (Fear Of Missing Out) kaçının.
- Yatırımınız için belirli bir bütçe ayırmak iyi bir uygulamadır.

Amaç mükemmel bir plana sahip olmak değil, daha ziyade takip edilecek ve uyulacak bir yapıya sahip olmaktır. Duygularınıza ya da korkunuza göre satın almak istemezsiniz. Gereksiz stresten kaçınmak için önceden yazdığınız bir stratejiyi takip etmek istersiniz.

Yatırım yapmayı öğrenmenin yaş sınırı yoktur; çok küçük bir miktarla başlayabilir ve zaman içinde ilerleyebilirsiniz. Eğitim bir yolculuktur.


- Yatırımın altın kuralı: asla kaybetmeyi göze alabileceğinizden daha fazla yatırım yapmayın! Buradaki fikir, tüm aylık gelirinizi almak, zorunlu giderlerinizi (borçlar ve konut gibi diğer aylık giderler) düşmek, yaşam maliyetlerinizi (gıda) düşmektir. Geriye tasarruf bütçeniz kalır. Bundan daha fazla yatırım yaparsanız, er ya da geç sorunlarla karşılaşırsınız!
- Altın yatırım kuralı #2: Moda olan şeylerden kaçının. Rasyonel kararlar vererek ilerleme kaydetmeye odaklanın. Şüpheleriniz varsa, üzerinde uyuyun ve sevdiklerinizle tartışın. Acele etmektense zaman ayırmak daha iyidir. En iyi strateji adım adım ilerlemektir.
- Altın yatırım kuralı #3: Finans alanında başarı için planlama ve uzun vadeli bir vizyona sahip olmak şarttır. Plan yapın ve çok fazla risk almayın. Amaç, başarıları biriktirirken ölümcül başarısızlıklardan kaçınmaktır.

Şüpheye düştüğünüzde: Kendinizi eğiterek başlayın. Birkaç saatliğine Bitcoin dünyasını keşfedin (bu platformda çok sayıda kaynak mevcuttur). 2 veya 3 kitap okuyun. Denemek için 5 Euro değerinde satın alın. Belgeseller ve videolar izleyin. Açık fikirli olun.

Her yatırımda olduğu gibi, piyasanızı tanımanız gerekir. Bitcoin çok genç ve değişken, yani her şey hızla değişiyor ve belirli bir risk seviyesi söz konusu. Bitcoin yok olabilir, sıfıra düşebilir veya yıllarca durgun kalabilir. Yalnızca kaybetmeyi göze alabileceğiniz kadar yatırım yapmanız gerektiğini söylemeye gerek yok! Henüz tam olarak anlamadığınız bir para birimine yatırım yapmak için borca girmeyin.

Bitcoin konusunda daha rahat hale geldiğinizde, eylem planınızı gözden geçirebilirsiniz. Benzer şekilde, bu dünyada yeniyseniz, alım satım, uzun vadeli yatırım ve birçok Bitcoin kullanıcısı tarafından kullanılan "tutma" adı verilen çok çok uzun vadeli bir strateji arasındaki farkları anlamak önemlidir.

Genel olarak:

|                     | Ticaret      | Yatırım          | Holding        |
| ------------------- | ------------ | ---------------- | -------------- |
...
| Potansiyel kayıplar | Sınırsız     | Sınırlı          | Sınırlı        |
| Bazıları için daha uygun | Çoğu   | Bazıları         |                |
...
Yatırım yapmayı öğrenmek genellikle okulda öğretilen bir şey değildir. Bu nedenle birçok kişi yatırım yapmayı riskli, çılgınca ve erişilemez bir faaliyet olarak görür. Kendilerini korumak için birçok kişi bir bankacıya başvurur... ki bu bir hataya dönüşebilir.

Yatırım konusunda kendini eğitmeye, paranın ve finansal sistemin nasıl işlediğini anlamaya başlamanın yaşı yoktur. Kendinizi tamamen kaptırmanız gerekmez; genel bir bakışa sahip olmak, cehalet yerine gerçeklere dayalı uygun kararlar almak için yeterlidir. Birisi size kötü bir yatırım ürünü satmaya çalıştığında (örneğin bir banka) bunu fark edebileceğiniz için bu, hayatınız boyunca çok faydalı olabilir.

Ticaretle uğraşmamalısınız. Evet, ticaret çok fazla stres, risk ve özdenetim içeren tam zamanlı bir iştir. Herkes için uygun bir faaliyet değildir ve ciddi riskler içerebilir. Yine de denemek istiyorsanız, en azından Ukspreadbetting'deki Mark gibi güvenilir ve mantıklı bir kişiyi takip edin.

İki iyi kaynak:


- Zengin Baba, Yoksul Baba - Robert T Kiyosaki - Bu kitap yatırım dünyasına iyi bir giriş kitabıdır. Herkes için mükemmel.
- The Investors Podcast - Bu podcast daha tekniktir, ancak finans dünyasındaki karmaşıklık düzeyi hakkında size iyi bir fikir verecektir. Finans sektöründe zaten çalışıyorsanız ya da bu konuda tutkuluysanız, bazı bölümlerini dinleyin. Bazıları Bitcoin hakkında konuşuyor.

Ön koşullarla ilgili bu bölümü sonlandırmak için, sektörümüzdeki mali kaybın ilk nedenine geri dönelim: özel anahtarın kötü yönetimi.
...
Bu iki özellik, Bitcoin'ü sadece dünyamızda yenilik yapmakla kalmayıp aynı zamanda normları da yıkan güçlü bir teknolojik ve parasal araç haline getirmektedir.

Bu özellikleri nedeniyle, ben de dahil olmak üzere pek çok bitcoin kullanıcısı, Bitcoin'in toplumumuz için tekerlek, çift girişli muhasebe, elektrik ve hatta internet ile aynı seviyede büyük bir yenilik olduğunu söylemeye hazır.

Bitcoin bu nedenle normlarımızı ve alışkanlıklarımızı bozan bir "0'dan 1'e "dir.

Bu sizin için yeniyse, rolünü ve amacını iyi anlamayabileceğiniz bir teknolojiye kendinizi maruz bırakmaya devam etmeden önce BTC 101'i takip etmenizi şiddetle tavsiye ederim.
...
1. Ücretsiz ve sınırsız hesap oluşturma.

2. Her yere ve herkese para gönderebilme.

3. Kimlik veya evrak işlerine gerek yok.

4. Yaş, cinsiyet, din, ülke veya gelir düzeyinden bağımsız olarak herkes için erişilebilirlik.

5. Talep üzerine gizlilik ve şeffaflık.

6. Aracıların veya gizli ücretlerin olmaması.

7. Bitcoin internete özgüdür ve internet erişimi olan herkes tarafından erişilebilir hale gelir.

![in a nutshell](assets/section2/1.webp)

Özetle, Bitcoin "halkın para birimi" olarak kabul edilebilir.

Günün felsefi sorusu: Bitcoin dünyasında iki ideoloji çatışıyor. Bankacılık sistemine dahil olmayan milyarlarca insanı sisteme dahil etmek mi istiyorsunuz? Yoksa bankacılık sisteminde olan milyarlarca insanı sistemin dışına mı çıkarmak istiyorsunuz?

Bu soru üzerinde düşünmeyi hak ediyor ve bu konuya daha sonra tekrar döneceğiz.

Milyarlarca insan, kötü yönetilen para politikalarının zararlı etkileri altında yaşamakta ve bu da uzun vadede ciddi finansal krizlere yol açmaktadır. Bu tür krizler tarihimizde yüzlerce kez yaşanmıştır ve paranın ve zamanın değeri manipüle edildiği sürece de yaşanmaya devam edecektir. Bu krizler hiperenflasyon, parasal kontrol ve para biriminin devalüasyonu şeklinde ortaya çıkabilir.
...
Dünyada giderek kötüleşen refah eşitsizlikleri aşırılıkçılığın artmasına yol açmış, bu da bazen diktatörlük rejimlerinin kurulmasıyla sonuçlanmıştır. Kim olursanız olun, bir gün ailenizi, kendinizi ve birikimlerinizi korumak için gizliliğe ihtiyaç duyabilirsiniz. Siyasi olarak tehdit altında olsaydınız varlıklarınızı nerede saklayabilirdiniz?


- Banka hesabınız dondurulabilir, el konulabilir veya boşaltılabilir.
- Altının bölünmesi zordur, taşınması ve kullanılması karmaşıktır.
- Nakit para hacimlidir, çalınması kolaydır ve enflasyona tabidir.

Bitcoin, insanların birikimlerini güvence altına almalarını ve hükümet tarafından herhangi bir kontrol olmaksızın yanlarında taşımalarını sağlayarak bu sorunlara bir çözüm sunmaktadır. Dünya nüfusunun neredeyse yarısı düşman bir rejim altında yaşıyor ve bu insanların Bitcoin'e herkesten daha fazla ihtiyacı var.
...
Bir banka hesabında paranız varsa, bu para artık size ait değildir. Gerçekte, o parayı kullanması için bankaya ödünç vermişsinizdir. Bu gerçeği anlamak ve farkında olmak çok önemlidir. Bir banka hesabında paranız varsa, aslında bankadan alacaklısınız demektir. Bu iki anlama gelir:

1. Banka iflas ederse, paranızı kaybetme riskiyle karşı karşıya kalırsınız.

2. Banka paranızı iade etmeyi reddederse, paranızı kaybetme riskiyle de karşı karşıya kalırsınız.
...
Bitcoin son derece felsefi, etik ve siyasi bir boyuta sahip olmakla birlikte bu hususlara tamamen kayıtsızdır. Aslında Bitcoin aynı süreci tekrar tekrar üreten basit bir protokoldür. Onu mevcut finansal sisteme karşı bir kurtuluş silahına dönüştürenler ise kullanıcılarıdır. Şifreserseri (Cypherpunk)perspektifinden bakıldığında, Bitcoin nakitsiz bir topluma karşı çıkmaktadır. Tamamen özel ve aracısız dijital finansal işlemlerin yaratılmasına olanak tanır. Şifreserseri (Cypherpunk)hareketi için Bitcoin nakit paranın elektronik eşdeğeridir.
...
| Benimseme (gerçek)   | Yüksek ve küresel       | Düşük                    |
| Takım                 | Sağlam ve merkezi olmayan | Zayıf ve merkezi         |
| İtibar                | Yüksek ve küresel       | Düşük                    |
| Altyapı              | Sağlam ve istikrarlı     | Zayıf                    |
| Yerinden Yönetim      | Evet                     | Hayır                    |
| Dolandırıcılık mı?    | Hayır                    | Muhtemelen               |
| Değer mi?            | Evet                     | Tartışılabilir           |
...
| --------------------- | ------- | -------- | ------------- | -------- |
| Kamu                  | Evet   | Değişir  | Hayır         | Hayır    |
| Açık                  | Evet   | Değişir  | Hayır         | Hayır    |
| Sınırsız              | Evet   | Değişir  | Hayır         | Hayır    |
| Nötr                  | Evet   | Değişir  | Hayır         | Hayır    |
| Sansüre dayanıklı     | Evet   | Değişir  | Hayır         | Hayır    |


Bitcoin ile rekabet ettiklerini iddia etseler de, bu projeler kontrolü sağlamak ve yerel düzenlemelere uymak için merkezi olmaya devam etmektedir. Mahremiyet koruması sağlamayacaklar, aksine kitlesel gözetimi arttıracaklar. Facebook'un "Libra" projesi kendisini Bitcoin'e değil bankalara rakip olarak konumlandırmıştır. Dahası, iş kanıtı (proof-of-work) olmadan, bir "Blokzincir'in" gerçek bir değeri yoktur. Libra'nın o zamandan beri terk edildiği ve Bitcoin'in aksine şu anda küresel olarak gerçek bir özel Blokzincir projesinin kullanılmadığı unutulmamalıdır.

![blockchain](assets/industrie/1.webp)

Bitcoin protokolü düzenlemelerin erişiminin ötesindedir. Yalnızca etrafında dönen aktörler düzenlenebilir ve Bitcoin merkezi olmadığı için yasalar, vergiler ve düzenlemeler ülkeden ülkeye değişir. Örneğin Çin, Bitcoin'un kullanımını birçok kez yasaklarken, Kanada, İsviçre ve Malta gibi ülkeler buna karşı daha olumlu bir tutum sergilemiştir. Çoğu ülke yeni kurallar ve düzenlemeler geliştirmek için kriptografi görev güçleri kurmuştur. Ancak bu süreç yavaştır ve kurallar oldukça sık değişebilmektedir. Bu yavaş tempoya rağmen, Bitcoin ve kripto paralar birçok konuşmanın merkezinde yer almaktadır.
...
Bitcoinler, paranız için dijital bir kasa olan "cüzdan" (EN: wallet) adı verilen bir yerde saklanır. Buna yalnızca anahtar sahibi erişebilir. Bu bir donanım cihazı, bir uygulama yazılımı ya da bir kağıt parçası bile olabilir. Bu cüzdanlar bitcoinleriniz ile dış dünya arasındaki boşluğu doldurur.
...
- Donanım cüzdan (EN: Hardware wallet) üreticileri. Burada bu alanda rekabet eden birçok şirket var. Bazıları açık kaynaklıdır, diğerleri daha fazla veya daha az özelliğe sahip daha fazla veya daha az pahalı donanım cüzdanları sunar (örneğin, Ledger, Trezor, Coinkite, Shiftcrypto).
- yazılım cüydan (EN: Software wallet) üreticileri; bunlar mobil veya bilgisayar için yazılım cüzdanları oluşturmak isteyen şirketler veya bağımsız aktörlerdir (örneğin, Wizard Sardine, Galoy, Synonyme, Blockstream).
...
Madenciler ağın güvenliğinden sorumludur. Yeni bir blok oluşturan Bitcoin'ın 'iş kanıtı (proof-of-work)' işlemlerini gerçekleştirmek için elektrik kullanırlar. Gerekirse madenciler konusunu BTC 101 kursunda ayrıntılı olarak ele almıştık. Daha ileri gitmek için Mining 201 kursunu sunuyoruz.
...
Bitcoin geliştiricileri farklı bölümlere ayrılabilir:


- Bitcoin Çekirdek geliştiricileri: Bitcoin protokolünün ve temel özelliklerinin ana gelişiminden sorumludurlar.
- Yardımcı protokol geliştiricileri (Lightning Network veya RGB gibi): Bitcoin ekosistemine entegre olan ve işlevlerini genişleten ek protokoller üzerinde çalışırlar.
- Araçlar ve uygulamalar (Mempool veya Alby gibi) yaratan amatör geliştiriciler: Kullanımını kolaylaştıran araçlar, hizmetler veya uygulamalar geliştirerek Bitcoin ekosistemine katkıda bulunurlar.

Herkes koda katkıda bulunmaya başlayabilir, ancak Bitcoin kodunu gerçekten değiştirmenin uzun ve karmaşık bir süreç olduğunu unutmamak önemlidir. Ayrıca, birçok Bitcoin geliştiricisi, hiçbir zaman kullanılmayacak olan Bitcoin İyileştirme Önerilerini (BIP'ler) geliştirmek için yıllarını adayan meraklılardır. Bu nedenle karmaşık ve bazen öngörülemez bir sektördür. Bu hususları ayrıntılı olarak inceleyeceğiz.

![blockchain](assets/industrie/6.webp)

Sınırsız güç mü? Çekirdek geliştiriciler sınırsız güce sahip değildir ve Bitcoin'u tek başlarına değiştiremez veya kontrol edemezler. Gücü elinde tutan düğümlerdir. Bitcoin'u kimse kontrol edemez.
...
Lightning şebekesi (EN: Lightning Network), Bitcoin'un ikinci katman'ıdır. Bitcoin'un genişlemesini ve daha fazla özellik elde etmesini sağlar. İşlemlerin kağıt üzerinde kaldığı ve sonunda halledildiği bir bardaki sekme gibi çalışır. Bunu daha sonra ayrıntılı olarak inceleyeceğiz.
...
- OpenNode
- İsviçre Bitcoin Ödeme
- BTCPay

Sektörde öyle bir noktaya geldik ki, ister Bitcoin'ü günlük yaşamlarında harcayarak, ister işlerinde kabul ederek, ister eğitime veya koda katkıda bulunarak ya da ötesinde inovasyon yaparak olsun, herkes katılabilir. Kısacası, Bitcoin artık durdurulamaz.

![blockchain](assets/industrie/7.webp)

"Bitcoin otoyolu" metaforu, sektörün geleceğini ve Bitcoin altyapısını tanımlamak için bana en doğru örneklerden biri gibi görünüyor. Bitcoin kendisini alternatif bir finansal sistem olarak konumlandırıyor. Genç, olgunlaşma sürecinde ve kendi kusurlarıyla birlikte, yine de sağlamdır. Yok olmayacak ve bir kara delik gibi zaman içinde yoluna çıkan her şeyi içine çekecektir.

BTC, üzerinde seyahat ettiğiniz bir yol olarak görülebilir. Arabanızı tamir etmeniz, yakıt almanız ya da yiyecek satın almanız gerektiğinde, ihtiyaçlarınız için eski finansal sisteme dönmek üzere bu BTC yolundan ayrılmak zorunda kalırsınız.

Ancak altyapı yeterince verimli olduğunda, temel ihtiyaçlarınızı karşılamak için artık bu yoldan ayrılmanıza gerek kalmayacaktır. O zaman yol, trafiğin %90'ının tam hızda seyrettiği ve sadece %10'unun yavaşladığı veya durduğu bir otoyola dönüşmüş olacaktır. Bitcoin böyle bir otoyola dönüştüğünde, insanlar alışverişlerini yapmak için artık bu yoldan ayrılmayacaklar. Mal ve hizmetlere bu otoyol üzerinden doğrudan erişilebilecek ve eski sisteme geri dönmek nadir, riskli ve sıkıcı hale gelecektir.

Bitcoin için gelecek vizyonum bu. İnternet trafiği ve dünya nüfusunun %90'ı için bir otoyol haline gelecek. Eski sistem ve altyapı yok olmayacak, ancak Bitcoin otoyoluna uyum sağlayamazlarsa modası geçmiş olacaklar.

Bitcoin için gelecek vizyonum bu. İnternet trafiği ve dünya nüfusunun %90'ı için bir otoyol haline gelecek. Eski sistem ve altyapı yok olmayacak, ancak Bitcoin otoyoluna uyum sağlayamazlarsa modası geçmiş olacaklar.

Yanılmıyorsam Andreas Antonopoulos beni bu fikirle tanıştırmıştı. @aantonop
...
- Küçük miktarlar için ücretsiz sıcak cüzdan (EN. Hot Wallet)
- Büyük miktarlar için soğuk cüzdan (EN. Soft Wallet)
...
İster yatırımlarda ister Bitcoin'de olsun, uzun vadeli elde tutma genellikle normdur. İstatistiksel olarak uzun vadede en kârlı ve uygulaması en basit olanıdır:
...
Exchange Seçenekleri:

https://planb.network/tutorials/exchange/centralized/bitstamp-5a36c896-bff5-46d7-b505-ff069c3ac47c
https://planb.network/tutorials/exchange/centralized/bitfinex-dc306d39-bd96-4ab9-a278-a322316716db
https://planb.network/tutorials/exchange/centralized/kraken-1ef03e25-9b42-49bd-a47d-249e1a13cfc6
Eğer hodler daha ileri gitmek istiyorsa: istifleyici gibi bir DCA planı uygulayın ve bir miktar Bitcoin harcamak için bir Hot LN Wallet kullanın.

### Senin için mi?

İşte Hodler'ın kısa bir psikolojik profili, eğer kendinizi tanıyorsanız, bu sizin için olabilir!
...
Hodler son derece disiplinlidir. En zor kısım, belirtildiği gibi, hiçbir şey yapmamaktır ve kısa vadeli fiyat zirveleri sırasında satma isteğine direnmek büyük bir öz disiplin gerektirir.


- Esneklik:

Fiyat düşüşleri ve piyasa dalgalanmalarıyla karşı karşıya kalan hodler, yatırımlarına ve Bitcoin'ün gelecekteki büyümesine olan inancını koruyarak dirençli olmaya devam ediyor.


- Teknolojiye İnanç:

Basit kâr arayışının ötesinde, hodler genellikle Blockchain teknolojisine ve Bitcoin'nin dünyada olumlu bir değişim yaratma yeteneğine inanır.

Özetle, hodler, Bitcoin'ün uzun vadeli değerine sıkı sıkıya inanan ve gelecekte önemli kazançlar elde etmek için kısa vadeli dalgalanmalara katlanmaya istekli, sabırlı, disiplinli ve vizyon sahibi bir yatırımcıdır. Yatırım stratejilerinde metodiktirler ve güvenlik ve uzun vadeli planlamaya özen gösterirler.

## İstifleyici

<chapterId>0daf450d-1b91-5d99-9c31-b52ab52a5e21</chapterId>

Bitcoin'te "Stacker" kavramı oldukça iyi bilinmektedir. Fikir basittir: sadece 21 milyon bitcoin vardır ve her küçük Bitcoin önemlidir! Bu küçük Bitcoin aslında bir Satoshi (veya SAT) olarak adlandırılır. İstifleyicinin amacı mümkün olduğunca çok biriktirmektir.
...
Diğer çözümler, daha fazla birikim sağlamak için Bitcoin'da mal veya hizmet satmaya başlamayı içerebilir. Arkadaşlardan Bitcoin'da geri ödeme yapılmasını istemek veya devrime daha yakın olmak için ekosisteme dahil olmaya başlamak.
...
Uzun vadeli güvenlik için bir Cold Wallet
...
İstifçinin Psikolojik Portresi


- Stratejik ve Organize:

İstifleyici, Bitcoin biriktirme yaklaşımında stratejiktir. Yatırımlarını dikkatle planlamakta ve DCA (Dolar-Maliyet Ortalaması) planlarını uygularken organize olmaktadırlar.


- Hedef Odaklı:

Ana hedefleri açıktır: mümkün olduğunca çok satoshi biriktirmek. Bu odak noktası, fiyatın fırlamasına veya düşmesine bakılmaksızın eylemlerine ve yatırım kararlarına rehberlik eder.


- Finansal Bilgi:

Çeşitlendirmenin ve düzenli yatırımın önemini anlarlar, böylece riski en aza indirir ve potansiyel getirileri optimize ederler. Bu, fiyat ortalaması alma ve dolayısıyla kısa vadeli fiyat hareketlerine ilgi göstermeme yoluyla elde edilir.
...
Bu tür bir profil için, yeni başlayanlar için çözüm oldukça basittir:


- Bitcoin ATM'lerini kullanın
...
Paranoyak bireyler gizliliklerine ve çevrimiçi güvenliklerine büyük önem verirler. Bu dikkat, özellikle Bitcoin ve kripto para birimleri ile ilgili olanlar olmak üzere tüm etkileşimlerini kapsar.


- Bağımsız:

Varlıklarının ve güvenliklerinin özerk yönetimini tercih ederek, kendi düğümlerini kuruyor ve çevrimiçi güvenlikleri üzerinde proaktif olarak çalışarak güçlü bir bağımsızlık ve kontrol arzusu sergiliyorlar.


- Güvensiz:

Merkezi sistemlere ve KYC süreçlerine güvensizlik, Paranoid bireyin ayırt edici bir özelliğidir. Kişisel bilgilerini paylaşma konusundaki isteksizlikleri, seçimlerini anonimliğe saygı duyan ve anonimliği koruyan platformlara ve hizmetlere doğru yönlendirir.


- Bilgili ve Çalışkan:

Kripto para birimlerinin karmaşıklığının farkında olan Paranoyak birey, coin karıştırma ve UTXO yönetimi gibi varlıklarını korumak ve yönetmek için en iyi uygulamalar konusunda kendilerini eğitmek için zaman ayırır.
...
- Mirasçılarınızın kripto varlıklarınıza zamanında sahip olabilmelerini sağlayın, ancak daha önce değil.
- Sevdiklerinize teslim edilmeden önce birinin kripto varlıklarınızı çalma riskini ve olasılığını en aza indirin.
- Sevdiklerinize, isterlerse varlıkları güvenli bir şekilde tutma seçeneği sunun.
- Mirasçılarınız arasındaki anlaşmazlıkları önleyin ve yasal sorunları mümkün olduğunca önleyin.
...
Bu derste, kitabının sadece ilk bölümüne odaklanacağız. Kendi halefiyet mektuplarını oluşturmak için tipik bir Bitcoin kullanıcısının rolünü üstleneceğim. Süreç şimdilik basit olacak ve daha sonra farklı profil türleriyle daha karmaşık bir versiyon oluşturacağız.

Cédric'in yolculuğunu takip edelim:
...
- Dikkat dağıtıcı unsurların olmadığı bir huzur anı
- 4-5 yaprak beyaz kağıt
- Bir kalem
- İki zarf
- Bir telefon/Address kitabı
- Bir bilgisayar (bence isteğe bağlı)

![pamela morgan](assets/heritage/1.webp)

Pamela Morgan'ın 18. sayfadaki "Kripto Varlık Miras Planlaması" başlıklı yazısına göre, yaygın yanlış anlamalar şunlardır:


- Bir avukat tutmam gerek.
- Üçüncü bir tarafa güvenmem gerekiyor.
...
Teknik uzmanlık, ulaşılabilirlik ve güven arasında her zaman bir denge olacaktır. Bu rolü kimin üstlenmesi gerektiğinden emin değilseniz, karar vermenize yardımcı olacak basit bir tablo oluşturun.

Sorumlulukların ayrılması: Güvenilir kişinin özel anahtarınıza ASLA erişimi olmamalıdır. Tek görevleri sevdiklerinizin Bitcoin'lerinizin güvenlik sistemini anlamalarına ve güven kazanmalarına yardımcı olmaktır. Bu yüzden iki güvenilir kişi seçmelisiniz. Gerekirse, üçüncü taraf bir kuruluşa da başvurabilirsiniz (uzman avukat veya emlak planlama hizmetleri).

| Güvenilir Kişi                     | Güven      | BTC Bilgisi      | Güven Bilgisi                     | Not                                                                                     |
| ----------------------------------- | ---------- | ---------------- | --------------------------------- | --------------------------------------------------------------------------------------- |
| Kardeşim Bob                       | Çok uzun   | Kısa             | Telefon ve e-posta               | "Bob BTC hakkında pek bir şey bilmiyor ama yardım konusunda ona %100 güvenebiliriz."   |
| Kuzenim Nathan                     | Uzun boylu | Orta boylu       | Telefon ve insta                 | Konuşulacak 1 numaralı kişi. Size yardımcı olabilir. Kendisine bilgi verildi.          |
| Ricco (Kripto arkadaşı)           | Medium     | Çok uzun boylu   | Twitter & e-posta & fotoğraf     | Teknik sorularda ona güvenin. Asla para konusunda değil. Onunla iletişime geçmeniz gerekecek. |
| YouTuber ve influencer             | Kısa       | Uzun             | YouTube bağlantısı               | Onu takip ederek kendinizi eğitin. Size doğrudan yardım edemez.                         |

### Adım 2: Basit ve hızlı bir envanter gerçekleştirin
...
| Genel                | Yazılım / Donanım      | Varlıklar       | Konum                     | Yedekleme (özel anahtar) | Şifre (PIN, passphrase) | Not                                                                                      |
| -------------------- | ---------------------- | ---------------- | ------------------------- | ------------------------- | ----------------------- | ---------------------------------------------------------------------------------------- |
...
DİKKATİNİZİ DAĞITMAYIN! Bu varlıkları devretme ihtiyacı hissedebilirsiniz:


- Güvenliğinizi artırmak mı?
- Bazı varlıkları satmak mı?
- Diğerlerini satın almak mı?

HİÇBİR ŞEY YAPMAYIN! Devam eden projeyi unutabilirsiniz. ODAKLANIN! Portföyünüzü daha sonra her zaman gözden geçirebilir ve değiştirebilirsiniz.

### 3. Adım: Mektubu yazın.

Güvenlik nedeniyle, sevdiklerinize mektup yazmak için kalem ve kağıt kullanın.


- Biraz kriptom var
- Bu danışmanlarla iletişime geçin
- Bu varlıklar burada - seni seviyorum

İşte başlamanıza yardımcı olacak bir şablon. Mektubu kendiniz yazmak istemiyorsanız, bir şablon indirebilir ve sadece boşlukları doldurabilirsiniz. (bağlantı burada)

Mektubun amacını açıklayarak başlayın ve sevdiklerinizi kendi kendini yöneten kriptonun tehlikeleri konusunda uyarın.
...
Sizi çok seviyorum ve güçlü olacağınızı biliyorum.

Bu mektubu, değeri olabilecek kripto varlıklara sahip olduğumu size bildirmek için yazıyorum.

Lütfen herhangi bir işlem yapmadan önce bu mektubu dikkatlice ve tamamını okuyun. Bu varlıklar diğer varlıklardan farklıdır, çünkü bir kez devredildiklerinde geri alınmaları mümkün değildir."

Ardından, "danışmanlar bölümünü" ekliyoruz. Bu bölüm mirasçılarınız için kafa karıştırıcı olabilir, özellikle de aşina olmadıkları kişi veya kuruluşlardan bahsediyorsanız. Şu konularda spesifik olun:


- Onlarla nasıl iletişime geçilir
- Nasıl tanımlanırlar
- Uzmanlık alanlarının ne olduğu.
- Kendilerini nasıl eğitebilecekleri.

"Aşağıda, sorularınızı yanıtlayacağına ve bu varlıkların ortaya çıkarılması ve aktarılması sürecinde size yardımcı olacağına inandığım kişilerin bir listesi bulunmaktadır. Listedeki kişilerle irtibata geçin, ancak süreci yönetmek için tek bir kişiye güvenmeyin. Bu listedekiler de dahil olmak üzere tüm danışmanlara karşı dikkatli olun. Herkes hata yapabilir, bu nedenle ne yaptıklarını en iyi şekilde anladığınızdan emin olun ve soru sormaktan ve cevapları kendiniz doğrulamaktan korkmayın.

İşte sorularınızı yanıtlamanıza yardımcı olabilecek ve bu süreçte size rehberlik edebilecek kişiler:

(Danışmanlarınızın adlarını, bir kuruluşla ilişkilerini (varsa), iletişim bilgilerini ve kimliklerini nasıl doğrulamaları gerektiğini (örneğin, keybase, fotoğraflar) buraya ekleyin


- Kardeşim Bob; +33 09 XX 68 18 36; Bobmybrother@gmail.com. Bu süreçte size yardımcı olması için Bob'a güvenebilirsiniz. Teknik açıdan en yetenekli kişi olmasa da, her şeyi sorgulayacak ve güvenli bir şekilde başarılı olmanızı sağlamak için dikkatli davranacak doğru kişidir. - Kuzenim Nathan; +33 09 XX 29 35; NathanDeladzcroix@Hotmail.com. Beni Bitcoin ile tanıştıran kişi Nathan'dı. Teknoloji konusunda çok bilgilidir ve sorularınızın çoğunu yanıtlayabilir. Kendisi aynı zamanda biraz bitcoin sahibidir ve teknik konularda size rehberlik edebilir. Onu aile toplantılarında birkaç kez görmüşsünüzdür ve ben de buraya bir fotoğrafını ekledim.
- Ricco; Twitter'da @RiccoSFC; Ricco425@protonmail.com. Ricco ile uzun yıllardır yakın çalışıyorum. Onunla hiç tanışmadınız, bu yüzden ona "Cédric'in köpeğinin adı ne?" diye sorarak doğru kişiyle konuştuğunuzdan emin olun Eğer "12" diye cevap verirse, sorun yok demektir. Ricco, Bitcoin konusunda çok samimi ve bilgili bir uzmandır. Tüm sorularınızı yanıtlayacaktır ve bitcoinlerin güvenliğine ilişkin kararlarına güvenebilirsiniz. Onunla iletişime geçmekten çekinmeyin, onunla birkaç kez görüştüm ve sizi ve Maia'yı ilgilendiren her şeyin farkında.
- Garip görünebilir ama hepsiyle iletişime geçin. Ayrıca, YouTube'da Andreas Antonopoulos'u dinleyerek ve Pamela Morgan'ın "Cryptoasset Inheritance Planning" kitabını satın alarak kendinizi eğitebilirsiniz."
...
"Aşağıda bu varlıklara erişmek için kullandığım cihazların, yazılımların ve cüzdanların bir listesi bulunmaktadır. Lütfen tüm bu cihazları güvenli bir yerde saklayın ve varlıklar mirasçılarıma devredilene kadar muhafaza edin. Kimsenin gözetimsiz olarak bunlara erişmesine izin vermeyin.
...
"Lütfen dikkat: 17 Nisan 2018 tarihli vasiyetimin bir kopyasını belge klasörümde bulacaksınız. Scranton, Pennsylvania'da bulunan avukatım Dwight Schrute'da da bir kopyası var. Dikkatli ol ve sana olan sevgimi daima hatırla." 06/26/2023, Cedric"

Şimdi çalışmamızı gözden geçirelim (Pamela Morgan tarafından yazılan "Cryptoasset Inheritance Planning", sayfa 44 (Découvre Bitcoin tarafından çevrilmiştir)):


- Yardım edin: İsimleri, iletişim bilgilerini ve mümkünse fotoğrafları sağladığınızdan emin olun.
- Cihazlar: Telefonunuzu, bilgisayarınızı, fiziksel cüzdanlarınızı ve kağıt cüzdanlarınızı listelediğinizden emin olun.
- Varlıklar: Varlıklarınızın bir listesini eklediğinizden emin olun.
- Borsalar: Sizin için fon tutan tüm borsaları listelediğinizi kontrol edin.
- Erişim: Depolama yerinizi bulmak için ihtiyaç duyacakları bilgileri ve gerekli tüm erişim kodlarını listeleyin.

Tüm kutuları işaretlediyseniz, son adımlar için hazırsınız demektir! Bu mektubun bir kopyasını alın ve her iki kopyayı da bir zarfın içinde saklayın. Seal yazın, Seal'yi imzalayın ve bu zarfı güvenli ancak erişilebilir bir yerde saklayın. Mirasçılarınızın gerektiğinde bu zarfı almaları gerektiğini bildiklerinden emin olun. Bu konuyu daha derinlemesine incelemek ve miras planınızı geliştirmek için bir zaman planlamak için Pamela'nın kitabını satın almaktan çekinmeyin. Ayrıca, bu planı yasal olarak resmi vasiyetinize dahil etmek için noterinizle görüşün.

Tebrikler! Miras planınızın ilk versiyonuna sahipsiniz ve bu harika bir başlangıç!

_Cryptoasset Miras Planlaması, Mal sahipleri için basit bir rehber, Pamela Morgan, ESQ. Telif Hakkı 2018 Merkle Bloom LLC, Tüm hakları saklıdır. CC-BY_ Pamela Morgan'a değerli çalışması ve bunu paylaşmama izin verdiği için çok teşekkür ederim. Ayrıca yazımına katkıda bulunan herkese teşekkürler.

Siz en iyisisiniz :D Ekibim ve öğrencilerim de size teşekkür ediyor!

## Tebrikler! ILK %0.1'DESINIZ
