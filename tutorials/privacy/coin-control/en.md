...
In the Bitcoin protocol, items such as _account_ or _monetary units_ do not exist. The concept of [UTXO](https://planb.academy/resources/glossary/utxo) is explained excellently in the following course, which I highly recommend:
