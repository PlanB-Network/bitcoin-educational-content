...
Если вы хотите принять участие в рецензировании и исправлении контента для Plan ₿ Academy, присоединяйтесь к [нашей группе в Telegram](https://t.me/PlanBNetwork_ContentBuilder), посвященной вкладу. Кратко представьтесь, затем укажите контент, который вы хотели бы просмотреть, и язык. Внесите исправления в рабочую ветку и отправьте PR после завершения проверки.
...
Plan ₿ Academy - это платформа для изучения биткоина с помощью многочисленных курсов и обучающих программ для всех желающих. В настоящее время весь наш контент имеет открытый исходный код, размещен в репозитории GitHub и открыт для участия в обзоре и создании контента.

Plan ₿ Academy стремится стать общественной площадью киберпространства биткоина, соединяя и поощряя биткоин-сообщества по всему миру.

## Зачем вносить вклад?

Plan ₿ Academy в основе своей многоязычна, поскольку наша цель - сделать ресурсы Биткойна доступными для всех по всему миру. Мы считаем, что язык не должен быть барьером на пути к суверенным деньгам.
...
- Присоединяйтесь к [группе Plan ₿ Academy Content Builder](https://t.me/PlanBNetwork_ContentBuilder) в Telegram.
...
NB. Рекомендуется просматривать в окне кода, при этом оригинальное содержимое должно отображаться в отдельном окне. Например, вы можете просмотреть текст на сайте Plan ₿ Academy или в предварительном просмотре GitHub на вкладке браузера. Используйте `ctrl + F`, чтобы находить ошибки и вносить исправления в окне кода по ходу работы.
...
- Чтобы возобновить работу, зайдите в свой форк репозитория содержимого Plan ₿ Academy через свой профиль GitHub.
...
Чтобы узнать больше о рекомендациях, которые следует соблюдать при корректуре в Plan ₿ Academy в отношении языковых или форматных правил, пожалуйста, обратитесь к учебному пособию "contribution-proofreading-guidelines" в этом же разделе!
...
- Большое спасибо за ваш вклад! После одобрения член команды Plan ₿ Academy свяжется с вами, чтобы отправить ваше вознаграждение. \**Платежи осуществляются исключительно через сеть Lightning Network\**.
