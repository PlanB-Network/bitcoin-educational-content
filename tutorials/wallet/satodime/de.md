...
**Satodime**, entwickelt von **[Satochip](https://satochip.io/fr/)**, ist eine sichere Trägerkarte zur Speicherung von Bitcoin in einer greifbaren und einfachen Weise. Sie fungiert als selbstverwahrender Hardware Wallet, bei dem Sie die volle Kontrolle über Ihre privaten Schlüssel haben, ohne von einer dritten Partei abhängig zu sein. Sie ist Open-Source und EAL6+-zertifiziert und unterstützt bis zu drei unabhängige Tresore.
...
Satodime, eine **carte au porteur, gehört demjenigen, der sie physisch besitzt**, ohne dass eine vorherige Registrierung oder Identifizierung erforderlich ist. Sie erfüllt den Bedarf an einer sicheren, tragbaren Bitcoin-Speicherung und ermöglicht es jedem, der die Karte besitzt, sie zu benutzen oder Bitcoins zu übertragen, indem er sie über die mobile App scannt, um sie in Besitz zu nehmen oder Tresore zu entsiegeln. Im Gegensatz zu einer Papierrechnung verwendet sie einen sicheren Chip, um Seal die privaten Schlüssel zu speichern, die erst nach dem Entsiegeln offengelegt werden, wodurch die Karte dem Bargeld ähnelt, bei dem Ownership durch den physischen Besitz bestimmt wird. Sie eignet sich ideal zum Verschenken von Bitcoins und erleichtert die sichere Übertragung von Bitcoins von Hand zu Hand, während die mobile Anwendung NFC für die Interaktion mit dem Smartphone nutzt.
...
- Warnung**: Dieser Schritt ist nicht umkehrbar. Bitte lesen Sie [den Artikel *Ownership*] (https://satochip.io/satodime-Ownership-explained/).
...
- Scannen Sie die Karte an generate und Seal den privaten Schlüssel (unbekannt, bis er entsiegelt wird).
...
- Kopieren Sie die öffentliche Address oder scannen Sie den QR-Code.
- Senden Sie Geldmittel von einem anderen Wallet.
- Überprüfen Sie den Saldo nach der Bestätigung auf dem Blockchain.
...
Beim Zurücksetzen des Tresors wird der zugehörige private Schlüssel unwiderruflich gelöscht. Mit anderen Worten: Wenn Sie keine Kopie Ihres privaten Schlüssels gesichert oder ihn in einen anderen Wallet importiert haben, führt das Zurücksetzen des Tresors zum unwiderruflichen Verlust der darin enthaltenen Mittel.
...
- Nehmen Sie Ownership von der Karte,
- Erstellen Sie einen Bitcoin-Tresor,
- Transfer Satss dorthin,
- Übertragung der Karte Ownership: die nächste Person, die die Karte scannt, wird ihr Besitzer,
- Geben Sie die Satodime-Karte einer Person Ihrer Wahl und laden Sie sie ein, die Anwendung herunterzuladen und die Karte zu scannen, um Ownership zu übernehmen - und damit Zugriff auf die darauf "gespeicherten" Bitcoins zu erhalten.
...
- Status prüfen**: Scannen Sie immer, um die Karte Ownership und den versiegelten/unversiegelten Status der Tresore zu überprüfen.
...
- Wiederherstellung**: Wenn die Karte verloren geht, aber im Besitz ist, befindet sich das Guthaben auf der Blockchain; verwenden Sie den privaten Schlüssel, wenn er entsiegelt ist.
...
[Plan ₿ Network] (https://planb.network/) für Anleitungen zu Selbstverwahrung, privaten Schlüsseln usw.
...
**Satochip** ist ein belgisches Unternehmen, das Hardware- und Softwarelösungen für die Verwaltung und Speicherung von Bitcoins und anderen Kryptowährungen entwickelt. Das Flaggschiffprodukt, der Satochip Hardware Wallet, ist eine NFC-Karte, die mit einem EAL6+-zertifizierten secure element ausgestattet ist. Ergänzt durch den Seedkeeper, einen Mnemonic Phrasen- und Geheimhaltungsmanager, und den Satodime, eine Inhaberkarte, bietet Satochip ein umfassendes Angebot, das auf die Bedürfnisse der Nutzer zugeschnitten ist. Seine Geräte, die auf Open-Source-Software basieren, zielen darauf ab, die Sicherheit auf Bitcoin zu demokratisieren.