...
Trezor は 12 語のニーモニック フレーズを表示します。**このニーモニック フレーズは、すべてのビットコインへの完全かつ無制限のアクセスを提供します**。 このフレーズを所持している人は、Trezor への物理的アクセスがなくてもあなたの資金を盗むことができます。 12 語のフレーズは、ハードウェア ウォレットの紛失、盗難、または破損の場合にビットコインへのアクセスを復元することができます。 したがって、このフレーズを慎重に保存し、安全な場所に保管することが非常に重要です。

箱に付属している厚紙に書き留めることもできますが、より安全にするために、火災、洪水、または崩壊から保護するために、このフレーズをステンレス鋼のプレートに刻印することをお勧めします。

ニーモニック フレーズを適切にバックアップおよび管理する方法については、特に初心者の場合、次のチュートリアルを参照することを強くお勧めします:
...
次のステップは、PINコードの設定です。PINコードは、Trezor をアンロックするために使用されます。これは、不正な物理的アクセスに対する保護として機能します。この PIN コードは、ウォレットの暗号鍵の導出には関与しません。したがって、この PIN コードにアクセスできなくても、12 または 24 語のニーモニック フレーズを所有することで、ビットコインへのアクセスを取り戻すことができます。

可能な限りランダムな PIN コードを選択することをお勧めします。また、このコードを Trezor が保管されている場所とは別の場所に保存するようにしてください (例: パスワードマネージャーに保存するなど)。

最大9桁のPINコードを選択できます。できるだけ長いコードにすることをお勧めします。
...
続行する前に、必要に応じて BIP39 パスフレーズを追加することができます。BIP39 パスフレーズは任意のパスワードで、自由に選択でき、ウォレットのセキュリティを強化するためにニーモニック フレーズに追加されます。この機能を有効にすると、ビットコインウォレットにアクセスするには、ニーモニック フレーズとパスフレーズの両方が必要になります。いずれかが欠けていると、ウォレットを復元することはできません。

Trezor でこのオプションを設定する前に、パスフレーズの理論的な動作を完全に理解し、ビットコインを失う可能性のあるエラーを回避するために、この記事を読むことを強くお勧めします：

https://planb.network/tutorials/wallet/backup/passphrase-a26a0220-806c-44b4-af14-bafdeb1adce7

有効にするには、「Hidden wallet」オプションを選択し、対応するフィールドにメモを取ります。Trezor Suite を通じてウォレットにアクセスするたびに、パスフレーズを適用するかどうかを尋ねられます。


![image](assets/14.webp)

この passphrase は、ニーモニック フレーズと同様に適切にバックアップすることが重要です。 これを失うと、ビットコインへのアクセスを失うことになります。 このパスフレーズを記憶だけに頼ることはお勧めできません。 それでは、紛失するリスクが不合理に高くなります。 理想的には、ニーモニック フレーズとは別に、物理的な媒体 (紙または金属) に書き留めてください。 このバックアップは、ニーモニック フレーズが保存されている場所とは異なる場所に保管する必要があります。 これにより、両方が同時に危険にさらされることを防げます。

効果的にするためには、すべての種類の文字を含む十分に長いランダムなパスフレーズ (強力なパスワードのように) を選択する必要があります。
