...
Так же, как и при переводе, этот тип паттерна также может раскрыть самоперевод на счет платформы обмена. Изучение известных адресов и контекст транзакции позволит нам узнать, является ли это консолидацией в кастодиальный кошелек или выводом на платформу.
