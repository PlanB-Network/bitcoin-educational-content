...
Rust's cross-platform mogelijkheden gaan verder dan traditionele besturingssystemen en omvatten mobiele platformen zoals Android en iOS, evenals WebAssembly voor browsergebaseerde toepassingen. Deze platformoverschrijdende ondersteuning is handig voor Bitcoin-toepassingen die in verschillende omgevingen moeten draaien. Bijvoorbeeld, projecten zoals Mutiny Wallet maken gebruik van Rust's WebAssembly compilatie om Lightning [wallets](https://planb.academy/resources/glossary/wallet) te maken die direct in webbrowsers draaien, iets wat onpraktisch zou zijn met traditionele webtechnologieën alleen.
...
UniFFI is geadopteerd in de gemeenschap voor de ontwikkeling van cryptocurrency en [blockchain](https://planb.academy/resources/glossary/blockchain), met grote projecten zoals BDK (Bitcoin Development Kit), LDK (Lightning Development Kit) en verschillende wallet-implementaties die het gebruiken om mobiele SDK's aan te bieden. Deze projecten demonstreren het gebruik van UniFFI in productieomgevingen.
...
De kanaalmanager dient als centrale coördinator voor Lightning-kanaaloperaties en werkt nauw samen met de peermanager om kanaalopenings-, -sluitings- en -betalingsoperaties uit te voeren. Wanneer een ontwikkelaar een [kanaal](https://planb.academy/resources/glossary/payment-channel) opent, creëert de kanaalbeheerder de nodige protocolberichten en coördineert hij met de peer manager om het onderhandelingsproces in meerdere stappen af te handelen. Deze scheiding van zorgen zorgt voor een zuivere abstractie tussen Lightning protocollogica en netwerkcommunicatiedetails.
