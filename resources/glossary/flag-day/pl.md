...
Metoda ta jest jednak obecnie bardzo ryzykowna, ponieważ wymaga znacznej koordynacji i konsensusu w społeczności, bez którego sieć może zostać podzielona, a zaktualizowany łańcuch może nie być najdłuższy (z największą ilością zgromadzonej pracy). Metoda Dnia Flagi nadal może być stosowana w przypadku niekontrowersyjnych zmian lub pilnych poprawek technicznych.