...
Bittr 是一款簡單直接的工具，適合任何希望在 Bitcoin 中增加儲蓄的人 - 不需要複雜的應用程式、身份檢查或第三方保管。它專為偏好簡單、隱私和完全掌控自己資金的人所設計。


只需從您的帳戶定期發送銀行轉帳，您就會收到 Bitcoin，直接轉入您自己的 Wallet。無論您想每週、每月或任何適合您的時間儲蓄，Bittr 的設計都能符合您的作息習慣，不會妨礙您的生活。


讓我們來看看使用 Bittr 開始堆疊 Sats 有多簡單。
...
- 無帳號：** 您無需建立帳號即可購買 Bitcoin
- 無需經過 KYC 程序：** 您無需經過 KYC（每 30 天最多 999CHF）
- 直接開始：** 您可以立即開始工作，並在幾分鐘內收到您的 Sats
...
Bittr 可與任何類型的 Wallet 搭配使用，包括應用程式錢包、軟體錢包或硬體錢包。


我們先從 BlueWallet 開始入門，稍後教學中我們要用 BitBox 來設定。


## 直接到 BlueWallet 購買 Bitcoin
...
Wuhuu, 就是這樣！🤩當錢到達Bittr的銀行帳戶後，Bittr會立即購買您的Bitcoin，將Bitcoin直接發送至您的Wallet，並將交易詳情（包括兌換時的Exchange匯率）以電子郵件發送給您。