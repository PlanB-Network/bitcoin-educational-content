---
term: Bitcoin Core
definition: Open-source reference software implementing the Bitcoin protocol, serving as a full node and wallet.
---
...
Bitcoin Core software serves several purposes. First and foremost, it acts as a full node client. Bitcoin Core also includes a wallet for users who wish to store, manage, and conduct transactions directly with Bitcoin Core.
