...
- Na domovské obrazovce Wallet klikněte na kartu "Nastavení", poté na "Podrobnosti o Wallet" a zkopírujte zPub ([rozšířený veřejný klíč](https://planb.academy/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f):
...
- **Výuka a výukové programy:** **[Plan ₿ Academy](https://planb.academy/)**
...
- **Liquid Network** :
- [Slovník pojmů](https://planb.academy/fr/resources/glossary/liquid-network)
...
- **Lightning Network**:
- [Slovník pojmů](https://planb.academy/fr/resources/glossary/lightning-network)
