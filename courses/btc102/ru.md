...
- Потеря фразы seed: **Ваша [фраза восстановления](https://planb.academy/resources/glossary/recovery-phrase) (обычно 12 или 24 слова) - единственный способ получить доступ к вашему Bitcoin, если что-то случится с вашим Wallet. Если вы потеряете ее, ваши средства исчезнут навсегда;**
...
**Вы можете предпочесть более продвинутые решения, такие как кошельки [Multisig](https://planb.academy/resources/glossary/multisig), которые обеспечивают больший контроль и безопасность.**
