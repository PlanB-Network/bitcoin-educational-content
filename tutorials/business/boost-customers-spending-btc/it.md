---
name: Spingere i clienti a pagare in bitcoin

description: Breve tutorial per incentivare i clienti del proprio negozio a spendere bitcoin al posto di valute meno pregiate
---
...
Se finora è tutto fantastico, allora qual è il problema? Ecco, quello che potresti notare è che le persone non comprano in bitcoin presso il tuo negozio! Quasi sicuramente molti non sapranno neanche che cosa sia, molti altri lo conosceranno ma non l'avranno mai usato per una spesa quotidiana, ma una piccola parte della popolazione lo conosce bene, eppure non lo usa per le proprie spese.

Come mai? Semplice, le persone tenderanno a spendere la moneta che considerano più debole! Lo stesso motivo che ti fa desiderare più bitcoin, per proteggerti contro l'inesorabile svalutazione di tutte le altre valute, incentiva gli altri a spendere qualunque altra cosa prima di vendere i propri bitcoin.

Ecco, in questo tutorial cercheremo di far leva su quella molto ridotta minoranza, affinché queste persone siano più invogliate a spendere bitcoin, e che voi siate coloro che li riceveranno.
...
Tutti i paesi europei sono soggetti ad un'imposta sul consumo, denominata in inglese "Value-added Tax", di seguito [VAT](https://en.wikipedia.org/wiki/Value-added_tax). Quest'imposta è stata inventata in Francia nel 1954, nel 1970 aveva già cominciato a diffondersi nella primitiva Comunità Europea; già nel 2020 si era diffusa a buona parte del globo.

Per questo esempio, supponiamo quindi di essere in Europa, all'interno di uno stato in cui l'aliquota VAT è pari al 20% per qualunque categoria merceologica. Siamo ad un negozio di scarpe, vediamo che un paio di scarpe in pelle costa 120 USD se paghiamo con una carta bancaria di debito.

Il negoziante potrebbe applicare uno sconto pari all'aliquota VAT per i pagamenti in bitcoin, quindi il paio di scarpe costerà ```120 / 1,20``` ovvero 100 USD. Questo che abbiamo visto è mediamente l'esempio di imposta più semplice ed immediato; ma si può utilizzare come politica di sconto una qualsiasi altra tassa, più questa sarà conosciuta nella tua giurisdizione specifica migliore sarà l'incentivo per il cliente a spendere bitcoin.
