---
name: BitSpenda
description: Il modo più veloce per convertire Bitcoin in Mobile Money.
---
...
*Per oltre due settimane, abbiamo lavorato per inviare valuta al Ghana per il progetto @freeAfricaRouthing Ghana Lightning Development* - utente X (ex Twitter).
...
BitSpenda si basa su due innovazioni finanziarie e tecnologiche: Bitcoin e Mobile Money. La prima consente agli utenti di riacquistare la propria sovranità finanziaria effettuando transazioni pseudonime senza l'intermediazione di un'istituzione centrale, in qualsiasi parte del mondo e in modo istantaneo, attraverso il Lightning Network Layer. Il secondo, invece, affronta il problema del bassissimo livello di penetrazione bancaria nelle società africane.
...
### Denaro mobile in Ghana



È possibile utilizzare BitSpenda in Ghana tramite MTN Mobile Money nello stesso modo in cui si utilizza M-Pesa in Kenya.
...
## Popolarizzazione del Bitcoin in Africa



Attraverso BitSpenda, [Bitcoin Dua](https://www.bitcoindua.org/) mira a creare un quadro ideale per l'adozione del Bitcoin in Africa. BitSpenda si distingue soprattutto per :
...
Ora è possibile utilizzare Bitcoin quotidianamente nei Paesi serviti da BitSpenda.



Molte altre iniziative e soluzioni come BitSpenda stanno nascendo nelle comunità africane: vi invitiamo a scoprire Banxaas, una soluzione senegalese per l'uso quotidiano del Bitcoin.
