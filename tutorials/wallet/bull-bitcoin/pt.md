...
- **Utilização**: Copie o Address para o partilhar with o remetente ou deixe-o ler o código QR.
...
- **Liquid Network** :
- [Glossário](https://planb.academy/resources/glossary/liquid-network)
...
- **Lightning Network**:
- [Glossário](https://planb.academy/resources/glossary/lightning-network)
