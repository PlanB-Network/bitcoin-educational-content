...
The attacker continues submitting partial proofs of work (shares) to appear as an active and honest participant, while withholding the valid block solution. This prevents the pool from receiving the block reward, effectively reducing its overall earnings.
