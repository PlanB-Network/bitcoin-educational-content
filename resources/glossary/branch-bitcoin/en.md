...
When two competing branches are present, honest nodes synchronize with the one that has the most accumulated work. A branch is sometimes called "strong" if it has more accumulated work than another, and "weak" if it has less.