---
term: 算力
definition: Bitcoin 網路算力的指標，以每秒雜湊數衡量。
---

網路運算能力的指標，以每秒哈希值 (H/s) 計量。它表示礦工執行雜湊運算的能力，是 Proof of Work 的一部分。高 Hashrate 表示 Bitcoin 的經濟歷史安全性更高，並能增加抵禦攻擊的能力，因為需要大量的計算能力才能危及網路。
