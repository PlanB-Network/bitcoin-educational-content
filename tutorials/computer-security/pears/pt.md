...
Este comando carrega a aplicação Keet diretamente a partir da rede Pears, sem passar por um servidor central. Se o Keet for iniciado corretamente, a sua instalação Pears está totalmente funcional.
