...
- Sul web o sul cellulare andare su [getbittr.com](https://getbittr.com/buy-Bitcoin?utm_source=planb&utm_medium=tutorial&utm_campaign=step1) e cliccare su "Acquista Bitcoin"
...
- Inserire l'IBAN da cui si invierà il messaggio
...
- Fare clic su "Aggiungi un Wallet" (se si dispone già di un Wallet, passare alla fase successiva).


![image4](assets/en/04.webp)


- Selezionate il vostro Wallet e andate al messaggio di firma


![image5](assets/en/05.webp)


- Completare la firma del messaggio e incollare la propria firma sul sito web
...
- Fare clic per aprire l'applicazione BitBox sul computer


![image9](assets/en/09.webp)


- Sbloccare il BitBox e seguire i passaggi per completare la firma del messaggio


![image10](assets/en/10.webp)


- Impostare il bonifico bancario con la descrizione personale del pagamento
