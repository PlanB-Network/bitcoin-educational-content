...
अब हम एक RGB एसेट बना सकते हैं। कमांड उस एसेट के प्रकार पर निर्भर करेगा जिसे आप बनाना चाहते हैं और उसके पैरामीटर। यहाँ मैं 1000 इकाइयों के Supply के साथ "Plan ₿ Academy" नामक एक NIA (*नॉन इन्फ्लेटेबल एसेट*) टोकन बना रहा हूँ। `परिशुद्धता` आपको इकाइयों की विभाज्यता को परिभाषित करने की अनुमति देता है।
...
इसके बाद, हम संबंधित एसेट (`Plan ₿ Academy`) निर्दिष्ट करके चैनल खोलेंगे। `/openchannel` कमांड आपको चैनल का आकार सातोशी में परिभाषित करने और RGB एसेट को शामिल करने का विकल्प चुनने देता है। यह इस बात पर निर्भर करता है कि आप क्या बनाना चाहते हैं, लेकिन मेरे मामले में, कमांड है:
...
लाइटनिंग चैनल अब खुला है और इसमें नोड n°1 की तरफ़ 500 `Plan ₿ Academy` टोकन भी हैं। यदि नोड n°2 `Plan ₿ Academy` टोकन प्राप्त करना चाहता है, तो उसे generate या Invoice करना होगा। इसे करने का तरीका यहां बताया गया है:
...
अब हम इस Invoice का भुगतान पहले नोड से करेंगे, जिसमें `Plan ₿ Academy` टोकन के साथ आवश्यक नकदी मौजूद है:
