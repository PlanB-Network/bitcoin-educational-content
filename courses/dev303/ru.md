...
Rust обладает тремя важнейшими свойствами, которые делают его особенно подходящим для разработки Bitcoin: статической системой сильных типов, богатым современным инструментарием и кроссплатформенной совместимостью. Каждая из этих характеристик способствует тому, что язык помогает разработчикам писать более безопасный и надежный код для обработки [криптовалютных](https://planb.academy/resources/glossary/cryptocurrency) операций.
...
UniFFI был принят в сообществе разработчиков криптовалют и [блокчейна](https://planb.academy/resources/glossary/blockchain): такие крупные проекты, как BDK (Bitcoin Development Kit), LDK (Lightning Development Kit) и различные реализации wallet, используют его для создания мобильных SDK. Эти проекты демонстрируют возможность использования UniFFI в производственных средах.
