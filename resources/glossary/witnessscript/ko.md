...
> 주의, `witnessScript`를 `scriptWitness`와 혼동해서는 안 됩니다. `witnessScript`는 P2WSH 또는 P2SH-P2WSH UTXO의 지출 조건을 정의하고 그 자체로 스크립트를 구성하는 반면, `scriptWitness`는 모든 SegWit 입력의 위트니스 데이터를 포함합니다.