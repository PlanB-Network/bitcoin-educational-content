...
最初のビットコインを購入した後、プラットフォーム上に残しておくという選択肢も当然ありますが、自己保管で自分のウォレットに移すことを強くお勧めします。ビットコイン・ウォレットの使い方をまだご存知でない方は、[Plan ₿ Networkの「ウォレット」セクション](https://planb.academy/tutorials/wallet)をご覧ください。
