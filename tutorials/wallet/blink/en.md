...
Formerly known as Bitcoin Beach Wallet, Blink is a user-friendly mobile app that brings Bitcoin to everyone—anywhere in the world. It was originally [built for the Bitcoin Beach community](https://bitcoinmagazine.com/business/bitcoin-beach-wallet-renamed-to-blink) in El Salvador, and it’s now helping people across the globe send, receive, and use Bitcoin effortlessly.
...
- Download Blink Wallet
	- Search for “Blink Wallet” on the [App Store](https://apps.apple.com/ng/app/bitcoin-beach-wallet/id1531383905) (iOS), [Google Play](https://play.google.com/store/apps/details?id=com.galoyapp) (Android)  or  [App Gallery](https://appgallery.huawei.com/app/C105387593) (Huawei), depending on your device.
	- You can also download it directly from the [Blink Wallet website](https://blink.sv).  
- Create a Wallet
...
When you open [Blink Wallet](https://blink.sv/) for the first time, you'll see something refreshingly clean. No charts screaming at you, no flashing numbers, just your balance and some simple buttons.

### Main Screen Overview

- Total Balance: Shows combined value of Bitcoin and USD balances
- Account Balances:
	- Bitcoin: Shown in sats (smallest Bitcoin unit)
	- Dollar:  Your value stable in USD

- Action Buttons: Four buttons you need to know.
	- Convert
	- Receive
	- Send
	- Scan QR
- Transaction History: All your previous transactions
- Price Chart: Bitcoin price tracking (tap the chart icon)
...
- Choose your custom address (e.g., "yourname@pay.blink.sv")
...
- Share your lightning address (yourname@pay.blink.sv) with anyone
...
Get more insight on [Blink POS](https://www.blink.sv/blog/transform-your-payment-experience-with-the-blink-pos), and explore valuable merchant resources in the [Blink Branding and Onboarding resources](https://www.blink.sv/en/brand).
...
- Cons: You don’t control your [private keys](https://www.blink.sv/blog/not-your-keys-not-your-coins), which means you're relying on Blink to manage your funds
...
- Check Blink's documentation and [FAQ](https://faq.blink.sv/)
- Contact customer support through the app
- Check [Blink support page](https://www.blink.sv/en/support)
- Join the [Blink Telegram community](https://t.me/blinkbtc) for general questions
...
[Blink Wallet](https://blink.sv/) provides an excellent entry point into the world of Bitcoin. Its combination of ease-of-use, dual-currency support, and [Lightning Network](https://www.blink.sv/blog/what-is-the-lightning-network) integration makes it ideal for:
