...
- Güncellemeyi uygulayan düğümler olduğunda UASF (Kullanıcı Tarafından Etkinleştirilen Soft Fork);
- Aktivasyonu tetikleyen madenciler olduğunda MASF (Miner-Aktive Soft Fork).


Bitcoin geliştikçe test edilen birçok farklı aktivasyon yöntemi vardır. Satoshi'nin zamanında aktivasyon süreci resmi olarak belirlenmemişti. Değişiklikler genellikle keyfi ve hatta bazen topluluğa bilgi verilmeden yapılıyordu. Daha sonra *Bayrak Günü* yöntemi benimsendi. Satoshi'nin ayrılmasından sonra, başta BIP34, BIP9, BIP8 ve son olarak *Speedy Trial* olmak üzere diğer yöntemler kullanılmaya başlandı.