...
Kui *npm* on saadaval, saate Pears CLI globaalselt oma süsteemi paigaldada. See võimaldab teil käivitada käsku `pear` mis tahes kataloogist.
...
Pearsi paigaldamine macOS-i on sarnane Linuxi paigaldamisele, kuid nõuab mõningaid Apple'i keskkonnale omaseid kohandusi. Avastame need sammud koos.
