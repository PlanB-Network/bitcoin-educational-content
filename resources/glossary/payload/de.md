---
term: Payload
definition: Wesentliche Daten, die in einem größeren Datenpaket transportiert werden.
---
...
- bc": der vom Menschen lesbare Teil (HRP) ;
- 1": das Trennzeichen ;
- `q`: SegWit-Version. Dies ist Version 0;
- c2eukw7reasfcmrafevp5dhv8635yuqa": die Nutzlast, in diesem Fall die Hash des öffentlichen Schlüssels;
- `ys50gj`: Prüfsumme.