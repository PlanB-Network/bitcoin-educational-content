...
| --------------------- | ---------------------------------------------------------------------------------- | ------------- | ---------- | --------------- | ------------ |
| Free                  | ✅ Sì                                                                              | ✅ Sì         | ✅ Sì      | ✅ Bundle       | ✅ Sì        |
| Open Source           | ✅ GPLv3                                                                           | ✅ Multi      | ✅ LGPL    | ❌ No           | ✅ GPLv3     |
| Cross-Platform        | ✅ Sì                                                                              | ✅ Sì         | ❌ No      | ❌ No           | ✅ Sì        |
| Dimensione            | ✅ 3 MB                                                                            | ❌ 20 MB      | ✅ 2 MB    | ✅ N/A          | ❌ 50 MB     |
| Portabilità           | ✅ Sì                                                                              | ✅ Sì         | ❌ No      | ✅ Sì           | ❌ No        |
| Autorizzazioni        | ✅ Nessuna                                                                         | ❌ Admin      | ❌ Admin   | ❌ Admin        | ❌ Admin     |
| Facile da usare       | ✅ Facile                                                                          | ❌ Difficile  | ✅ Facile  | ✅ Facile       | 🟧 Media     |
| Cifratura             | ✅ XChaCha20                                                                       | ✅ AES-256    | ✅ AES-256 | 🟧 AES-128      | ✅ AES-256   |
| Chiave di derivazione | ✅ Argon2                                                                          | 🟧 PBKDF2     | ❌ SHA-256 | ❓ Sconosciuto  | ✅ Scrypt    |
| Integrità dei dati    | ✅ Sempre                                                                          | ❌ No         | ❌ No      | ❓ Sconosciuto  | ✅ Sempre    |
| Deniability           | ✅ Supportato                                                                      | ✅ Supportato | ❌ No      | ❌ No           | ❌ No        |
| Reed-Solomon          | ✅ Sì                                                                              | ❌ No         | ❌ No      | ❌ No           | ❌ No        |
| Compressione          | ✅ Sì                                                                              | ❌ No         | ✅ Sì      | ✅ Sì           | ❌ No        |
| Telemetria            | ✅ Nessuna                                                                         | ✅ Nessuna    | ✅ Nessuna | ❓ Sconosciuto  | ✅ Nessuna   |
| Audit                 | ✅ [Sì](https://github.com/Picocrypt/storage/blob/main/Picocrypt.Audit.Report.pdf) | ✅ Sì         | ❌ No      | ❓ Sconosciuto  | ✅ Sì        |

_Fonte: [Github.com](https://github.com/Picocrypt/Picocrypt)_
...
Apri l'applicazione per visualizzare la suo interfaccia minimalista sullo schermo. Per crittografare i dati, siano essi **un file, più file o una cartella**, è sufficiente **trascinarli e rilasciarli nell'nterfaccia di Picocrypt**. In questo modo si selezioneranno i dati da crittografare.

![Image](assets/fr/020.webp)

Per la crittografia dei dati si ha accesso a diverse opzioni, tra cui la chiave di crittografia. Può essere **una password forte** o **una chiave di crittografia sotto forma di key file**, o **entrambi**. Se prendiamo l'esempio di una password, si può scegliere tra la creazione di una password personale o la generazione di una password con Picocrypt.

La password deve essere forte, in quanto può essere utilizzata per decifrare i dati. Inseriscila in "**Password**" e "**Confirm Password**", quindi fai clic su "**Encrypt**" per criptare i dati! Prima di ciò, è possibile fare clic sul pulsante "**Change**" accanto a "**Save output as**" per specificare la directory di output.

**Nota**: per utilizzare una chiave in formato file, fai clic su "**Create**" a destra di "**Keyfiles**" per creare una chiave. Quindi selezionala facendo clic su "**Modifica**" e trascina il file della chiave nell'area appropriata.
...
- **Compress Files**: comprime i file per ridurre le dimensioni dei file criptati.
- **File eliminati**: elimina i file sorgente per mantenere solo la versione criptata.

### B. Decrittazione dei dati con Picocrypt

Se è necessario decriptare i dati, non sarà più complicato che criptarli. È sufficiente aprire Picocrypt e **trascinare il file PCV da decifrare**. Quindi inserire la password e/o selezionare il file chiave prima di fare clic su "**Decrypt**".
...
**Siete stati avvertiti: Picocrypt è molto facile da usare e funziona! Sebbene l'interfaccia sia minimalista, incorpora alcune opzioni molto utili per personalizzare la crittografia! E poiché è disponibile in versione portatile, potrai portarlo con te ovunque vai, in modo da poter decifrare i tuoi dati in tutta tranquillità**
