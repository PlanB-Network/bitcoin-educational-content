...
Bland Bitcoin-implementeringarna är Bitcoin Core den överlägset mest utbredda, eftersom den representerar cirka 99% av nodnätverket. Det finns dock också minoritetsimplementeringar som BTCsuite, Bcoin och Bitcoin Knots. Trots mångfalden av tillgängliga programvaruklienter ger Bitcoin Core:s dominans i nätverket det ett nästan exklusivt inflytande över tillämpningen av Bitcoin-protokollet. Därför sägs det att Bitcoin Core effektivt representerar själva Bitcoin-protokollet.