...
definition: Versi baru dari protokol P2P Bitcoin dengan enkripsi untuk meningkatkan privasi.
---
...
P2P Transport V2 disertakan sebagai opsi (dinonaktifkan secara bawaan) pada versi 26.0 Bitcoin Core, yang digunakan pada bulan Desember 2023. Opsi ini dapat diaktifkan dengan opsi `v2transport=1` di file konfigurasi.
