...
| Aplikacja            | E2EE 1:1       | E2EE grupy   | Rejestracja anonimowa | Licencja klienta open-source | Licencja serwera open-source | Serwer zdecentralizowany | Rok powstania   |
| -------------------- | -------------- | -------------- | --------------------- | --------------------------- | ---------------------------- | ---------------------- | --------------- |
| WhatsApp             | ✅              | ✅              | ❌                     | ❌                           | ❌                            | ❌                      | 2009            |
| WeChat               | ❌              | ❌              | ❌                     | ❌                           | ❌                            | ❌                      | 2011            |
