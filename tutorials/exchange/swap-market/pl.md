...
| ------------ | -------------------- | ------------------------------------ |
| Charakter     | Unikalna usługa      | Agregator wielu dostawców            |
| Dostawcy      | Tylko Boltz          | Boltz, ZEUS, Eldamar, Middle Way     |
| Konkurencja   | Stałe opłaty         | Wolna konkurencja                    |
| Interfejs     | boltz.exchange       | swapmarket.github.io (do samodzielnego hostowania) |
| Bezpieczeństwo| Non-custodial (HTLC) | Non-custodial (HTLC)                 |
