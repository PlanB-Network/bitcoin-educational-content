...
"Bitcoin"이라는 용어가 디지털 화폐 및 금융 혁신의 대명사가 되기 전에는 일련의 아이디어, 혁신, 사회 운동이 그 탄생의 토대를 마련했습니다. 그중에서도 [Cypherpunk](https://planb.academy/resources/glossary/cypherpunks) 운동은 Bitcoin의 탄생에 있어 핵심적인 요소로 꼽힙니다.
...
1980년대와 1990년대 기술 발전의 한가운데서 한 무리의 사람들이 디지털 시대에서 프라이버시와 자유의 역할에 대해 깊은 의문을 갖기 시작했습니다. 훗날 '사이퍼펑크'로 불리게 된 이들은 [암호화](https://planb.academy/resources/glossary/cryptography)가 정부와 대기업의 간섭으로부터 개인의 권리를 보호하는 도구가 될 수 있다고 굳게 믿었습니다.
...
Bitcoin이 등장하기 전에도 디지털 화폐를 만들려는 시도는 여러 차례 있었습니다. 예를 들어, 1980년대에 데이비드 차움은 "익명 전자 화폐"라는 개념을 도입한 프로젝트 "[DigiCash](https://planb.academy/resources/glossary/ecash-david-chaum)"를 선보였습니다. 안타깝게도 여러 가지 제약으로 인해 DigiCash는 번창하지 못했습니다.


또 다른 중요한 선구자로는 웨이 다이의 "[B-money](https://planb.academy/resources/glossary/bmoney)"가 있습니다. 비록 구현되지는 않았지만, 중앙 기관이 아닌 평가자 커뮤니티가 사기 감지를 수행하는 익명의 디지털 화폐라는 아이디어를 제시했습니다.
...
이러한 비옥한 환경에서 2008년 미스터리한 [Satoshi 나카모토](https://planb.academy/resources/glossary/nakamoto-satoshi)가 Bitcoin [백서](https://planb.academy/resources/glossary/white-paper)를 발표했습니다. 이 문서에서 그는 [proof of work](https://planb.academy/resources/glossary/proof-of-work) 및 암호화 [타임스탬프](https://planb.academy/resources/glossary/timestamp)와 같은 Cypherpunk 운동의 여러 아이디어를 결합하여 검열에 저항하는 [탈중앙화된](https://planb.academy/resources/glossary/distributed) 디지털 화폐를 만들었습니다.
...
화폐의 기능은 인위적으로 복제하기 어렵습니다. 사실 화폐는 시장과 자발적인 [합의](https://planb.academy/resources/glossary/consensus)를 통해 생겨나는 자연스러운 현상이기 때문에 개인이나 집단이 만들 수 없습니다. 이런 의미에서 가격은 사회의 자원 배분을 안내하는 신호이자 정보 역할을 합니다.
...
반대로 국가 신탁 통화([법정화폐](https://planb.academy/resources/glossary/fiat))는 쉽게 사용할 수 있지만 이를 통제하는 주체(왕, 중앙은행, 황제, 독재자)에 의해 지속적으로 평가절하됩니다.
...
- [대체성](https://planb.academy/resources/glossary/fungibility)**: 가치 손실 없이 같은 종류의 다른 단위와 교환할 수 있는 것을 의미합니다;
...
화폐는 오늘날까지도 다양한 사용 사례에 맞게 형태를 바꾸며 진화하고 있습니다. 앞서 말했듯이 금은 훌륭한 가치 저장 수단이지만 현재의 글로벌화된 경제에는 더 이상 적합하지 않습니다. 마찬가지로 달러와 유로와 같은 기축 통화는 현재 대부분 디지털화되어 있기 때문에 이동이 쉽지만 통화 [인플레이션](https://planb.academy/resources/glossary/inflation)으로 인해 가치가 지속적으로 낮아지고 있습니다.
...
새로운 비트코인의 생성은 [Mining](https://planb.academy/resources/glossary/mining) 프로세스의 결과입니다. 간단히 말해, 채굴자는 거래를 검증하고 보호하는 복잡한 수학 문제([Hash](https://planb.academy/resources/glossary/hash-function))를 푸는 강력한 컴퓨터를 사용합니다. 문제가 해결되면(또는 유효한 Hash가 발견되면) Miner은 네트워크에서 이루어진 모든 거래를 기록하는 탈중앙화 분산형 Blockchain에 새로운 트랜잭션 [블록](https://planb.academy/resources/glossary/block)을 추가합니다. Blockchain는 각 블록이 이전 블록에 연결되어 있어 네트워크의 합의 없이는 과거 데이터를 변경하는 것이 거의 불가능하기 때문에 투명성과 보안을 보장합니다.
...
2,100만 개라는 제한은 Bitcoin 희소성의 기초이며, Mining [난이도 조정](https://planb.academy/resources/glossary/difficulty-adjustment)과 게임 이론이라는 두 가지 주요 메커니즘에 의해 보장됩니다.
...
채굴자는 [블록 보조금](https://planb.academy/resources/glossary/block-subsidy)과 해당 블록에 포함된 거래에서 발생하는 [거래 수수료](https://planb.academy/resources/glossary/transaction-fees)를 통해 새로운 비트코인을 얻기 위해 블록을 채굴하도록 인센티브를 받는다는 사실을 알고 계셨나요?
...
실제로 누구나 다음 명령어를 입력하기만 하면 Bitcoin [노드](https://planb.academy/resources/glossary/node)(즉, 트랜잭션 검증자)를 통해 이 작업을 수행할 수 있습니다: 'bitcoin-cli gettxoutsetinfo`. 이러한 투명성은 중앙 기관이나 개인이 아닌 프로토콜에 내재된 수학적, 암호학적 보장에 기반한 Bitcoin 시스템에 대한 신뢰를 강화합니다(LNP201에서 이 작업을 수행하는 방법을 쉽게 배울 수 있습니다).
...
섹션 2에서는 이 유명한 비트코인의 위치와 상호 작용하는 방법을 이해하기 위해 [지갑](https://planb.academy/resources/glossary/wallet)을 사용하여 Bitcoin의 저장 및 보안을 살펴볼 것입니다!
...
Bitcoin '은행원'이든 본인이든, 대부분의 Bitcoin 지갑은 비대칭 암호화에 기반한 유사한 기술로 작동하며, 이는 지출용 [개인 키](https://planb.academy/resources/glossary/private-key)와 수신용 [공개 키](https://planb.academy/resources/glossary/public-key)로 구성된 키 쌍 시스템으로 이루어져 있습니다.
...
Wallet를 초기화할 때 Mnemonic 구문(개인 키)이라고도 하는 [비밀 복구 구문](https://planb.academy/resources/glossary/recovery-phrase)이 생성되어 12개 또는 24개 단어의 형태로 제공됩니다.
...
공개 키는 개인 키에서 생성되며 개인 키와 연결되어 있습니다. 공개 키를 공유하면 개인 정보 보호(다른 사용자가 잔액을 볼 수 있기 때문에)에는 위험하지만 보안(개인 키가 없으면 자금을 사용할 수 없기 때문에)에는 위험하지 않습니다. 공개 키는 [Bitcoin 주소](https://planb.academy/resources/glossary/receiving-address)를 생성하는 데 사용되며, 따라서 돈을 받는 데 사용됩니다.
...
키는 Wallet에 저장되어 있지만, 비트코인 자체는 실제로 Bitcoin [피어투피어](https://planb.academy/resources/glossary/peertopeer-p2p) 네트워크 내의 공개적으로 분산된 Ledger인 Blockchain에 "저장"됩니다(섹션 3에서 자세히 설명하겠습니다). 즉, Wallet이 들어 있는 장치를 분실해도 비트코인을 잃는 것은 아닙니다. Wallet을 다시 생성하고 Bitcoin을 사용할 수 있는 것은 실제로 개인 키이므로 항상 적절하게 보호하는 것을 잊지 마세요!
...
누군가 실수로 12개 또는 24개의 단어 목록을 맞히면 어떻게 되나요? 짧은 대답은 Wallet를 만드는 데 사용된 암호화 기술 덕분에 그럴 가능성은 거의 없다는 것입니다. 다시 말해, 실수로 동일한 Mnemonic 구문을 발견하는 것은 1과 2 사이에서 256의 거듭제곱으로 증가한 '올바른' 숫자를 찾는 것과 비슷하며, 이는 우주에서 '올바른' 원자를 찾는 것과 거의 같습니다. 그러나 이 기본 보안이 만족스럽지 않다면 언제든지 Bitcoin Wallet에 [passphrase](https://planb.academy/resources/glossary/passphrase-bip39)(추가 단어)를 추가하여 보안을 강화할 수 있습니다.
...
- 레벨 0**의 경우, 비트코인을 단독으로 보유하지 않는 이른바 '[수탁 서비스](https://planb.academy/resources/glossary/custody)'를 이용합니다. 이 신뢰할 수 있는 제3자가 언제든지 회원님의 자금에 대한 접근을 제한할 수 있다는 점에 유의하시기 바랍니다. 이 경우 귀하의 금융 주권 수준은 은행 계좌가 있는 기존 은행 시스템과 비슷합니다.
...
- 레벨 4**에서는 지갑 세트를 사용해 "[Multisig](https://planb.academy/resources/glossary/multisig)" Wallet를 생성하는데, 이는 거래를 수행하기 위해 여러 서명이 필요하다는 의미입니다. 이 경우 Multisig의 각 부분을 서로 다른 위치에 저장해야 한다는 점에 유의하세요. 이 접근 방식은 주로 많은 양을 관리하고 기업 목적으로 Bitcoin의 고급 사용법으로 간주되는 경우가 많습니다.
...
거래를 완료하려면 Bob는 송금하려는 비트코인의 소유자임을 [확인](https://planb.academy/resources/glossary/confirmation)하기 위해 개인 키로 서명해야 합니다. 이 단계는 보통 모바일 지갑에서 자동으로 이루어지거나, 실물 Wallet에서 확인하는 형태로 이루어집니다: "X를 Y에게 정말 보내시겠습니까? 예 또는 아니오".


![image](assets/ko/045.webp)


**수수료를 지불하는 이유** 수수료는 블록에 트랜잭션을 포함하기 위한 자유 시장을 만드는 데 필수적입니다. 실제로 블록의 크기는 1MB([SegWit](https://planb.academy/resources/glossary/segwit) 업데이트 이후 4MB로 확장됨)이므로 블록에 '삽입'할 수 있는 트랜잭션의 수는 블록당 수천 개로 제한됩니다. 트랜잭션의 크기는 트랜잭션의 복잡성에 따라 달라집니다. 따라서 일반적으로 트랜잭션이 복잡할수록 수수료가 더 많이 발생합니다.
...
이 시점에서 이 트랜잭션은 [Mempool](https://planb.academy/resources/glossary/mempool)이라는 도구를 통해 모든 사람에게 알려지더라도, Miner가 블록에 삽입할 때까지는 확정된 것으로 간주할 수 없으며, Blockchain에 포함시켜 트랜잭션을 검증하는 유일한 사람인 Miner가 이를 확인할 수 있습니다.
...
시도 횟수를 최적화하기 위해 초당 수십억 개의 가능성을 계산하는 유일한 역할을 하는 ASIC이라는 특정 기계를 사용합니다(총 시도 횟수를 "[Hashrate](https://planb.academy/resources/glossary/hashrate)"이라고 함). 이러한 기계를 작동하려면 대량의 전기가 소비되어야 합니다. 따라서 POW는 에너지를 화폐로 변환하여 현실 세계와 디지털 세계를 연결하여 최초의 에너지 기반 화폐를 만들어냅니다.
...
Hashrate 네트워크의 Bitcoin은 다음 블록을 찾기 위한 초당 시도 횟수를 나타냅니다. 현재 Hashrate는 초당 500,000억 번의 시도인 500 TH/s를 넘어섰습니다! 글로벌 Hashrate가 높을수록 악의적인 행위자가 Mining 전력의 대부분을 확보하는 데 필요한 자원을 독점하고 자금을 두 번 이상 지출하는 것이 더 어려워집니다([이중 지출](https://planb.academy/resources/glossary/double-spending-attack) 문제). 따라서 Bitcoin 프로토콜의 규칙을 위반하는 것보다 이를 따르는 것이 경제적으로 더 유리합니다.
...
[Coinbase Transaction](https://planb.academy/resources/glossary/coinbase-transaction)**은 항상 블록에 포함된 첫 번째 트랜잭션으로, Proof-of-Work 수행에 대한 Miner의 보상이 포함되어 있습니다. 그 다음에는 검증된 트랜잭션이 나옵니다. 채굴자는 가장 많은 수익을 가져다주는 트랜잭션, 즉 최대 수수료를 가진 작은 규모의 트랜잭션을 삽입합니다.
...
각 유효한 블록에 대해 받는 보상에 의존하는 비즈니스 모델을 안정화하기 위해 채굴자들은 종종 "[Mining 풀](https://planb.academy/resources/glossary/pool-mining)"을 통해 그룹을 생성하여 컴퓨팅 리소스를 풀링합니다.
...
비트코인 채굴이라는 특정 주제를 더 깊이 있게 탐구하고자 한다면, 당사의 MIN 101 강의를 참고하실 수 있습니다. 그곳에서 작업 증명 원리와 그 작동 방식에 대한 상세한 이론적 설명과 함께 관련된 모든 개념을 확인하실 수 있습니다.

https://planb.academy/courses/d1ce86d9-c983-49bc-92b3-e3c5269f239e

또한 더 고급 수준의 이 실습 과정도 확인해 보시길 권합니다. 이 과정에서는 채굴로 발생하는 열을 활용하여 첫 사토시를 벌 수 있도록 ASIC을 DIY 가정용 난방 시스템으로 전환하는 방법을 설명합니다.
...
과거 주기로 볼 때, Bitcoin의 경제 주기는 두 번의 반감기 사이의 기간과 동일한 것으로 보이며, 이는 아마도 [Halving](https://planb.academy/resources/glossary/halving) 이벤트가 새로운 비트코인의 배출을 절반으로 줄이는 트리거 역할을 하기 때문일 수 있습니다.
...
비트코인을 획득하는 방법에는 여러 가지가 있으며, 각 방법에는 관할권에 따라 다를 수 있는 자체 규정이 적용됩니다. 일부 플랫폼은 본인 확인([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer))을 위해 신분증을 요구하는 반면, 그렇지 않은 플랫폼도 있습니다. 따라서 각 플랫폼과 관련된 규정을 이해하는 것이 중요합니다.
...
위에서 소개한 것처럼 비트코인을 모으는 일반적인 방법은 정기적으로 소량을 구매하는 [달러 코스트 애버리징(DCA)](https://planb.academy/resources/glossary/dollar-cost-averaging-dca)입니다. 전용 페이지](https://planb.academy/tutorials/exchange)에 나열된 것과 같은 여러 플랫폼에서 이 서비스를 제공합니다. DCA를 설정하는 것이 간단할 뿐만 아니라 일반적으로 Wallet으로 인출이 자동으로 이루어지므로 자산을 항상 통제할 수 있습니다.
...
## 라이트닝 네트워크: 낮은 수수료로 빠르게 비트코인을 결제하기

<chapterId>b403f1e4-f1ff-572b-a242-9b58cb3736d0</chapterId>

이제 비트코인 프로토콜의 기본을 이해했으므로, 비트코인 위에 구축된 주요 결제 네트워크인 라이트닝 네트워크(Lightning Network, 흔히 "LN"으로 약칭)를 소개하겠습니다. 그 목적은 매우 단순합니다. 블록체인을 포화시키지 않으면서, 거의 즉각적인 확정성을 갖는 BTC 결제를 일반적으로 매우 낮은 수수료로 가능하게 하는 것입니다.

### 블록체인은 모든 것을 할 수 없다

비트코인 블록체인은 가능한 한 많은 사람이 허가 없이, 그리고 신뢰에 의존하지 않고 검증할 수 있도록 설계되었습니다. 이러한 요구사항은 구조적인 한계를 수반합니다. 즉, 블록은 독립적인 노드가 과도하게 비싼 하드웨어에 투자하지 않고도 다운로드, 저장, 검증할 수 있을 만큼 합리적인 크기를 유지해야 하므로, 블록체인은 무제한의 거래를 처리할 수 없습니다. 이는 흔히 트릴레마로 요약됩니다: 탈중앙화, 보안, 확장성. 블록체인을 기반으로 한 시스템은 이 세 가지 속성을 동시에 극대화할 수 없습니다. 비트코인은 탈중앙화와 보안을 우선시하며, 그 결과 [온체인](https://planb.academy/resources/glossary/onchain)에서 처리 가능한 거래 처리량은 자연스럽게 제한됩니다.

![image](assets/ko/081.webp)

비트코인에서는 이를 우선하기 위해 개발자들이 명확한 선택을 해왔습니다. 한편으로 블록 크기를 1MB로 제한하고 블록 간 평균 생성 시간을 10분으로 설정함으로써, 낮은 비용으로 비트코인 노드를 운영할 수 있고 이는 네트워크의 탈중앙화를 촉진합니다. 다른 한편으로, 작업증명 방식에 의한 블록 생성은 어떠한 사기 시도도 극도로 높은 비용을 요구하게 만들며, 동시에 노드에 의한 검증을 용이하게 하고 프로토콜 전체의 보안을 강화합니다.

그러나 이러한 선택에는 중요한 제약도 따릅니다. 각 블록에 포함될 수 있는 거래 수가 제한된다는 점입니다. 이는 초당 몇 건의 거래에 불과합니다. 이 수치는 이론적으로 초당 약 65,000건의 거래를 처리할 수 있는 VISA와 같은 중앙화된 결제 시스템과 비교하면 매우 미미합니다. 하지만 이러한 제한은 검열 없이, 그리고 신뢰할 제3자 없이 거래를 가능하게 하기 위해 치러야 하는 대가입니다.

구체적으로 이는 비트코인의 일상적인 사용에 있어 매우 중요한 두 가지 의미를 가집니다.
* 블록 공간에 대한 수요가 증가하면 온체인 수수료가 매우 높아질 수 있습니다.
* 온체인 결제는 확인을 필요로 하며, 이는 일상적인 구매에 항상 적합하지는 않습니다.

라이트닝 네트워크는 바로 이러한 문제들에 대한 해답입니다. 라이트닝의 개념은 계층적 접근 방식에 기반합니다. 비트코인은 여전히 기본 계층(견고하고 매우 안전한 결제 계층)으로 남아 있고, 라이트닝은 그 위에서 빠른 결제를 담당하는 계층으로 기능합니다.

![image](assets/ko/080.webp)

### 비트코인에 앵커링된 결제 채널

라이트닝은 양방향 [결제 채널](https://planb.academy/resources/glossary/payment-channel)에 기반합니다. 채널이란 두 참여자 간의 기술적 관계로, 각 결제를 블록체인에 기록하지 않고도 [오프체인](https://planb.academy/resources/glossary/offchain)에서 [사토시](https://planb.academy/resources/glossary/satoshi-sat)(sats)를 교환할 수 있게 해줍니다.

비트코인(온체인)의 관점에서 채널을 여는 것은 특수한 거래를 통해 자금을 잠그는 것을 의미합니다. 이는 일종의 에스크로로 볼 수 있으며, 유효한 채널 종료를 통해서만 자금이 재분배될 수 있도록 잠겨 있습니다.

라이트닝의 관점에서 동일한 메커니즘은 두 당사자가 사토시의 분배 상태를 원하는 만큼, 거의 즉각적으로, 그리고 메인 블록체인에 각 결제를 기록하지 않고도 업데이트할 수 있는 채널이 됩니다.

따라서 메커니즘은 다음과 같습니다.
* 라이트닝 채널의 개설과 종료는 비트코인 거래이며, 온체인에 게시됩니다.
* 개설과 종료 사이의 결제는 오프체인 업데이트로, 메인 블록체인에서는 볼 수 없습니다.

![image](assets/ko/083.webp)

이렇게 라이트닝 채널을 공유하는 두 사람은 매번 온체인 거래를 하지 않고도 매우 많은 결제를 수행할 수 있습니다. 여기에서도 확장성의 논리를 확인할 수 있습니다. 블록체인은 드물고 중요한 작업(채널 개설과 종료, 즉 최종 결제)에만 사용하고, 나머지 소액의 중간 결제는 보다 효율적인 계층으로 이동시킵니다.

### 상호 연결된 채널의 네트워크

라이트닝은 고립된 채널들의 단순한 집합이 아닙니다. 이는 네트워크입니다. 수천 개의 노드가 채널로 서로 연결되어 연결 그래프를 형성합니다.

![image](assets/ko/082.webp)

이 네트워크 덕분에, 직접적인 채널이 없는 상대에게도 결제가 가능합니다. 결제를 전달할 수 있는 채널 경로가 존재하기만 하면 됩니다. 이 경우 결제는 여러 중간 노드를 거쳐 홉 단위로 전달됩니다.

여기서 라이트닝의 중요한 개념인 유동성이 등장합니다. 채널의 용량은 해당 채널에 잠겨 있는 자금의 총액을 의미합니다. 유동성은 이 자금이 채널의 어느 쪽에 분포되어 있는지를 나타내며, 즉 사토시가 어느 방향으로 이동할 수 있는지를 의미합니다. 다시 말해, 채널이 큰 용량을 가지고 있더라도 유동성이 반대편에 몰려 있다면 특정 방향으로는 사용할 수 없습니다. 결제의 성공 여부는 경로의 존재뿐만 아니라, 그 경로 전체에 걸쳐 उपलब्ध한 유동성에도 달려 있습니다.

### 중개자를 신뢰하지 않고 결제 전달하기

라이트닝은 중개자를 신뢰하지 않고도 결제를 전달할 수 있도록 설계되었습니다. 이를 위해 프로토콜은 [HTLC](https://planb.academy/resources/glossary/htlc)(Hashed Time-Locked Contracts)라 불리는 스마트 컨트랙트를 사용합니다. 모든 세부 사항을 다루지는 않지만, 일반적인 메커니즘은 다음과 같습니다.
* 결제는 비밀값(프리이미지)의 공개를 조건으로 합니다.
* 최종 수취인이 이 비밀을 공개하면 자금을 받게 되며, 중개자들도 각자 받을 몫을 회수할 수 있습니다.
* 결제가 실패하면 타임락이 만료되고 각자는 자신의 자금을 되돌려받습니다.

이 작동 방식은 하나의 핵심적인 속성을 제공합니다. 바로 원자성입니다. 결제는 전부 성공하거나, 중간 손실 없이 실패합니다.

마지막으로 라이트닝에는 패널티 메커니즘이 포함되어 있습니다. 참여자 중 한 명이 더 이상 유효하지 않은 과거의 채널 상태를 게시하여 속이려 할 경우, 다른 참여자는 이를 처벌하고 자금 전체를 회수할 수 있습니다. 이 규칙은 적대적인 환경에서도 정직하게 행동하도록 강하게 유도합니다.

### 라이트닝 노드와 라이트닝 지갑의 의미

비트코인 온체인에서 지갑은 키를 관리하고 거래를 생성하는 소프트웨어입니다. 라이트닝에서는 상황이 더 모호합니다. 진정한 비수탁(non-custodial) 사용은 라이트닝 노드에 기반하기 때문이며, 이 노드는 단순한 인터페이스 뒤에 숨겨져 있을 수도 있습니다.

실제로 라이트닝을 사용하기 위한 애플리케이션은 크게 두 가지 범주로 나뉩니다.
* 수탁형 서비스: 애플리케이션은 잔액을 보여주지만, 자금은 서비스 제공자가 통제합니다. 잔액은 거래소와 마찬가지로 그들의 시스템 내 회계 기록입니다.
* 비수탁형 솔루션: 사용자가 키와 자금 회수 능력을 직접 통제합니다. 관리가 최소화된 노드를 내장한 애플리케이션(예: Phoenix, Zeus 등)이거나, 사용자가 완전히 직접 운영하는 실제 라이트닝 노드일 수 있습니다.

https://planb.academy/tutorials/wallet/mobile/phoenix-0f681345-abff-4bdc-819c-4ae800129cdf

https://planb.academy/tutorials/wallet/mobile/zeus-embedded-c67fa8bb-9ff5-430d-beee-80919cac96b9

또한 כיום에는, 각 입출금 결제마다 요청 시 실행되는 아토믹 스왑을 활용하여 간접적으로 라이트닝 결제를 처리할 수 있는 셀프 커스터디 지갑도 존재합니다(예: Bull Bitcoin Wallet, Aqua 등). 이러한 지갑은 일반적으로 Liquid 사이드체인을 결제 계층으로 사용합니다(이에 대해서는 다음 장에서 다룹니다).

https://planb.academy/tutorials/wallet/mobile/bull-bitcoin-2c72127c-a228-4f50-b833-c6183d56aaf6

https://planb.academy/tutorials/wallet/mobile/aqua-8e6d7dd3-8c03-45cc-90dd-fe3899a7d125

### 구체적인 사용 사례: 라이트닝이 가능하게 하는 것들

라이트닝은 과거에 비트코인 온체인만으로는 불편하거나 불가능했던 다양한 사용 사례를 열어줍니다.

- **일상적인 결제(온라인 및 오프라인)**

계산대에서의 결제나 온라인 구매 시, 라이트닝은 거의 즉각적인 확정성과 일반적으로 낮은 수수료를 제공합니다. 이를 통해 메인 블록체인이 혼잡할 때에도 소액 결제에 비트코인을 사용할 수 있습니다.

- **마이크로 결제와 스트리밍 머니**

극소액을 전송할 수 있다는 점은 새로운 경제 모델을 가능하게 합니다. 사용량 기반 보상, 분 단위 결제, 정기 기부, 팁 등이 그것입니다. 이는 "스트리밍 머니"라는 개념으로, 정액 구독이 아니라 실제 콘텐츠나 서비스 소비에 따라 지불하는 방식입니다.

- **콘텐츠 제작자, 팟캐스트, 기부**

라이트닝은 마이크로 기부나 보상 메커니즘에 자주 사용됩니다. Fountain이나 Rumble과 같은 애플리케이션은 이러한 논리를 잘 보여줍니다. 결제는 무겁고 일회성인 행위가 아니라, 경험에 자연스럽게 통합된 세밀한 요소가 됩니다. Plan ₿ Academy에서도 이와 같은 방식을 도입하여, 좋아하는 교수에게 감사의 의미로 소액 기부를 쉽게 보낼 수 있습니다.

- **게임과 디지털 경제**

비디오 게임과 디지털 환경은 마이크로 트랜잭션에 자연스럽게 어울립니다. 소액 베팅, 보상, 가상 아이템 등이 그 예입니다. 소액의 금전적 요소를 도입함으로써 스팸이나 일부 악용(봇)의 비용을 높이면서도 접근성은 유지할 수 있습니다.

![image](assets/ko/085.webp)

### 라이트닝의 주요 구현체들

비트코인과 마찬가지로, 라이트닝은 단일 소프트웨어가 아니라 프로토콜입니다. 공통 사양(BOLT)을 통해 여러 구현체가 상호 운용 가능한 상태로 공존합니다.
* LND (Lightning Labs)
...
라이트닝은 비트코인 블록체인을 대체하지 않습니다. 오히려 이를 보완합니다. 블록체인은 느리지만 매우 견고한 최종 결제 계층으로 남아 있습니다. 라이트닝은 빈번한 사용과 소액 결제를 위해 설계된 빠른 결제 계층입니다.

2025년 현재, 라이트닝은 초기보다 훨씬 접근하기 쉬워졌습니다. 일부 복잡성을 숨겨주는 지갑과 서비스 덕분입니다. 그러나 여전히 유동성, 채널의 온체인 비용, 그리고 때로는 단순성, 주권성, 프라이버시 사이의 절충이라는 타협점이 존재합니다.

라이트닝을 깊이 이해하고 싶다면(채널, 유동성, 라우팅, 리스크 관리), Fanis Michalakis의 이론 과정인 LNP 201을 추천합니다.

https://planb.academy/courses/34bd43ef-6683-4a5c-b239-7cb1e40a4aeb

또한 자체 라이트닝 노드를 운영하는 여정을 시작하고 싶다면, 이에 특화된 실습 과정 LNP 202도 제공하고 있습니다.

https://planb.academy/courses/593e483e-1785-4e83-aa7e-32b99056844c


## 라이트닝을 넘어서: 비트코인을 진화시키는 다른 프로토콜들

<chapterId>684e31f9-ebd1-51b6-91c0-1e6a315f1141</chapterId>

앞선 장들에서 살펴보았듯이, 비트코인은 극도로 견고한 기본 계층으로 설계되었습니다. 즉, 공개적이고 단순하며 안전한 원장이지만, 속도, 프로그래머빌리티, 결제 처리량 측면에서는 본질적인 한계를 가집니다. 이 계층에 모든 것을 억지로 담으려 하기보다는(예: 이더리움), 비트코인 생태계는 점진적으로 계층적 접근 방식을 채택해 왔습니다. 블록체인은 기반(최종 결제)으로 기능하고, 상위 계층은 더 빠른 결제, 더 높은 프라이버시, 자산 발행(스테이블코인, 토큰화된 증권 등)과 같은 새로운 속성을 추가합니다.

비트코인은 기본 프로토콜을 수정하는 방식으로만 진화하지 않습니다. 그 위에 구축됨으로써, 목표에 따라 서로 다른 절충을 가진 솔루션들이 등장합니다. 어떤 것은 결제 확장성을 추구하고, 어떤 것은 (넓은 의미의) 프로그래머빌리티와 자산 발행을 지향하며, 또 어떤 것은 이 둘을 결합하려 합니다.

이 장에서는 비트코인 위에서 각각 새로운 가능성을 제공하는 네 가지 중요한 프로토콜을 소개합니다. [사이드체인](https://planb.academy/resources/glossary/sidechain)(특히 Liquid), Ark, RGB, 그리고 Taproot Assets입니다.

### 사이드체인: 비트코인에 연결된 병렬 블록체인

사이드체인은 비트코인과는 별개의 블록체인으로, 자체 규칙과 합의 메커니즘을 가지고 병렬로 작동하도록 설계되었습니다. 이는 양방향 페그(*2WP*)라는 메커니즘을 통해 비트코인과 연결되며, 실제로는 비트코인에서 잠긴 비트코인을 사이드체인 상의 대표 형태로 사용한 뒤, 다시 메인 체인으로 되돌릴 수 있습니다.

사이드체인의 장점은 비트코인 자체에서는 구현하기 어려운 기능을 제공할 수 있다는 점입니다. 더 빠른 거래, 자산 기능, 강화된 프라이버시, 또는 더 큰 개발 유연성이 그 예입니다. 반면, 사이드체인은 항상 비트코인 대비 일정한 타협을 수반하며, 특히 신뢰 모델이나 탈중앙화 측면에서 그러합니다.

비트코인에서 가장 잘 알려진 사이드체인은 Blockstream이 개발한 **Liquid**입니다. 이는 플랫폼 간 빠른 이전, 더 빈번한 결제, 자산 발행(스테이블코인, 증권 등)을 가속화하기 위해 설계되었으며, 강화된 프라이버시를 제공합니다. Liquid에서 사용되는 비트코인은 L-BTC라 불리며, 양방향 페그를 통해 BTC와 1대1로 연동됩니다.

![image](assets/ko/088.webp)

비트코인과의 가장 큰 차이는 보안과 탈중앙화 모델에 있습니다. Liquid는 비트코인의 작업증명에 의존하지 않고, 블록 생성과 BTC와 L-BTC 간 브리지 운영을 담당하는 식별된 운영자 집단, 즉 연합체에 기반합니다.

https://planb.academy/courses/d3ca6943-b22c-4e50-b62d-9431460525bc

### Ark: UTXO를 공유하여 비용을 줄이고 사용자 경험을 개선하기

Ark는 많은 사용자 작업을 소수의 비트코인 거래로 묶어 비트코인의 확장성을 개선하려는 제안과 구현들의 집합을 의미합니다. 아이디어는 매우 단순합니다. 사용자마다 온체인 거래를 생성하는 대신, 하나의 온체인 거래로 묶고, 각자의 권리는 주로 오프체인에서 갱신하다가 최종적으로 비트코인에서 결제하고 싶을 때만 온체인으로 돌아옵니다.

이 세컨드 레이어 프로토콜의 개념은 2023년 5월 Burak에 의해 공개되었습니다. 라이트닝 네트워크와 마찬가지로 Ark는 비트코인 메인 체인 위에 배포되는 시스템입니다. 이는 빠르고, 익명적이며, 저렴한 비용으로 오프체인 비트코인 결제를 가능하게 합니다. 라이트닝과 비교했을 때, Ark는 결제를 받기 위해 인바운드 유동성을 필요로 하지 않아 사용자 경험을 크게 개선합니다. 또한 [코인조인](https://planb.academy/resources/glossary/coinjoin) 거래에 가까운 프라이버시를 제공합니다. 더 나아가 비트코인에 커버넌트가 추가된다면, Ark는 비대화형(non-interactive)으로도 작동할 수 있습니다.

Burak은 라이트닝이 메인 체인에 대한 의존성 때문에 확장성에 한계가 있다고 자주 비판하며, Ark가 이론적으로 전 세계 인구 전체를 셀프 커스터디로 통합할 수 있을 것이라고 제안합니다. Ark는 라이트닝 네트워크의 경쟁 프로토콜로 보일 수 있지만, 실제로는 두 시스템이 공존할 수 있으며 오히려 상호 보완적일 수 있습니다.

Ark는 매우 활발하지만 아직 초기 단계에 있는 분야입니다. 목표는 매력적이지만(사용자당 온체인 footprint를 대폭 줄이는 것), 비트코인과 라이트닝과는 다른 가정과 리스크를 가진 더 복잡한 아키텍처라는 점을 염두에 두어야 합니다.

### RGB: 클라이언트 측 검증을 통한 계약과 자산

RGB는 비트코인 상의 스마트 컨트랙트 및 자산 시스템으로, 범용 블록체인과는 근본적으로 다른 접근 방식을 채택합니다. 핵심 아이디어는 클라이언트 측 검증입니다. 글로벌 블록체인에 계약의 전체 상태를 게시하는 대신, 참여자들은 자신에게 필요한 이력만을 로컬에서 보관하고 검증하며, 비트코인 블록체인은 암호학적 커밋을 앵커링하고 이중 지불을 방지하는 역할만 수행합니다.

다시 말해:
* 비트코인 블록체인은 타임스탬프 기반과 최소한의 중재자 역할을 합니다.
* 상세 데이터(계약 규칙, 상태, 전이)는 관련 당사자 간에 오프체인으로 교환됩니다.
* 검증은 로컬에서 이루어지므로 확장성이 향상되며, 모든 RGB 활동을 전 세계가 볼 수 있는 글로벌 원장이 존재하지 않기 때문에 프라이버시 또한 개선될 수 있습니다.

![image](assets/ko/089.webp)

RGB는 토큰(스테이블코인 포함), NFT, 디지털 증권 등 다양한 자산을 발행하고 관리하는 기반으로 사용될 수 있으며, 더 복잡한 계약 로직을 구축하는 데에도 활용될 수 있습니다. 이 모든 과정에서 기본 계층을 비대하게 만들지 않습니다.

단점은 데이터 관리입니다. 클라이언트 측 검증을 수행해야 하므로, 자신의 권리를 증명하는 데이터를 적절히 보관하고 백업해야 합니다.

RGB는 수년간 개발되어 온 프로토콜입니다. 발전은 점진적이지만, 이미 RGB를 활용한 구체적인 애플리케이션들이 존재합니다. 더 깊이 배우고 싶다면, Plan ₿ Academy에서 이 프로토콜의 작동 원리를 상세히 다루는 전문가 수준의 과정을 제공합니다.

https://planb.academy/courses/3ce1d37c-05ba-4f54-aa15-7586d37b2bb7

### Taproot Assets: 비트코인에서 자산을 발행하고 라이트닝으로 이동하기

Taproot Assets(이전 명칭 "Taro")는 Lightning Labs가 주도하는 프로토콜로, 비트코인 상에서 자산을 발행하고 이를 라이트닝 네트워크를 통해 빠르고 저렴하게 이전할 수 있도록 하는 것을 목표로 합니다.

이는 비트코인에서의 "프로그래머블 머니" 서사에서 자주 언급되는 구성 요소입니다. 비트코인이 글로벌 컴퓨터가 되기 때문이 아니라, 비트코인이라는 기반 위에 금융 상품(자산)을 얹고 이를 라이트닝을 통해 효율적으로 유통시킬 수 있기 때문입니다.

### 상위 계층의 혁신을 허용함으로써 강화되는 비트코인

오늘날 비트코인 생태계를 가장 정확하게 표현하는 이미지는 고정된 프로토콜도, 이더리움처럼 모든 것을 처리하는 슈퍼 블록체인도 아닙니다. 오히려 의도적으로 보수적인 기반 위에, 최소한의 위험으로 실험과 혁신을 가능하게 하는 여러 계층과 프로토콜이 둘러싸고 있는 구조입니다.
