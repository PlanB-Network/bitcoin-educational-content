...
Para çekme işleminin otomatik olarak yapılacağı CoinJoin eşiğini seçin. Kişisel durumunuza ve gizlilik hedeflerinize göre değiştiğinden, size gerçekleştirmeniz gereken kesin bir remiks sayısı veremem, ancak çok düşük bir eşik seçmekten kaçının. Remiksleme süreci hakkında daha fazla bilgi edinmek için bu diğer makaleye başvurmanızı tavsiye ederim: [REMIX - Whirlpool](https://planb.academy/tutorials/privacy/analysis/remix-whirlpool-2b887bd9-8a6a-4dca-8aa9-a1c33682b0aa)
