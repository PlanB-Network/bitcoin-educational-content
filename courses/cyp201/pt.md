...
| --------------- | -------------------------------------------------------------------------------------------------- |
| *pubkey hash*   | Hash da [chave pública](https://planb.academy/resources/glossary/public-key) (usado para gerar um endereço Bitcoin).                                       |
