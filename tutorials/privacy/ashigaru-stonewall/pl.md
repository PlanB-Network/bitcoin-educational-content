...
description: Zrozumienie i używanie transakcji Stonewall na Ashigaru
---
...
Wróćmy do naszego przykładu z Alice w piekarni. Gdyby chciała dokonać transakcji Stonewall x2, Alice musiałaby współpracować z Bob (stroną trzecią) podczas konfigurowania transakcji. Każdy z nich przyniósłby UTXO. Bob otrzymałby wtedy cały swój wkład z powrotem. Piekarz otrzymałby zapłatę za swoją bagietkę w taki sam sposób, jak w transakcji Stonewall, podczas gdy Alice odzyskałby swoje saldo początkowe, pomniejszone o koszt bagietki.
...
[**-> Dowiedz się więcej o transakcjach Stonewall x2**](https://planb.academy/tutorials/privacy/on-chain/stonewall-x2-05120280-f6f9-4e14-9fb8-c9e603f73e5b)
...
Ta interpretacja jest niedokładna, ponieważ, jak wiadomo, jeden UTXO został wysłany do piekarza, 2 przychodzące UTXO pochodziły od Alices, a ona odzyskała 3 wyjścia kursu wymiany.
...
Nawet jeśli zewnętrzny obserwator zdoła zidentyfikować stronę transakcji Stonewall, nie będzie miał wszystkich informacji. Nie będzie w stanie określić, który z dwóch UTXO o tych samych kwotach odpowiada płatności. Ponadto nie będzie w stanie ustalić, czy dwa wprowadzone UTXO pochodzą od dwóch różnych osób, czy też należą do jednej osoby, która je połączyła. Ten ostatni punkt wynika z faktu, że wspomniane powyżej transakcje Stonewall x2 przebiegają dokładnie według tego samego schematu, co transakcje Stonewall. Patrząc z zewnątrz i bez dodatkowych informacji kontekstowych, nie można odróżnić transakcji Stonewall od transakcji Stonewall x2. Te pierwsze nie są transakcjami opartymi na współpracy, podczas gdy te drugie są. Dodaje to jeszcze więcej wątpliwości do wydatków.
...
## Jak mogę dokonać transakcji Stonewall na Ashigaru?



Pierwotnie opracowane przez zespół Samourai Wallet, transakcje Stonewall zostały przejęte przez aplikację Ashigaru, fork oryginalnego wallet stworzonego po aresztowaniu deweloperów Samourai. Musisz zainstalować Ashigaru i utworzyć wallet:



https://planb.academy/tutorials/wallet/mobile/ashigaru-9f903b55-2e55-4b06-9627-80f8e178158f

W przeciwieństwie do transakcji Stowaway lub Stonewall x2 (*cahoots*), transakcje Stonewall nie wymagają korzystania z Paynyms. Mogą być wykonywane bezpośrednio, bez wcześniejszego przygotowania lub współpracy z innym użytkownikiem.



W rzeczywistości nie potrzebujesz samouczka, aby dokonywać transakcji Stonewall, ponieważ Ashigaru generuje je automatycznie za każdym razem, gdy wydajesz, gdy tylko wallet zawiera wystarczającą ilość UTXO.



Kliknij przycisk `+` w prawym dolnym rogu ekranu, a następnie wybierz `Wyślij`.
...
Wybierz konto, z którego chcesz dokonać wydatku.
...
Następnie wprowadź szczegóły transakcji: adres odbiorcy i kwotę do wysłania, a następnie naciśnij strzałkę, aby potwierdzić.
...
W tym miejscu można oczywiście dostosować domyślne opłaty transakcyjne do warunków rynkowych. Jednak najbardziej interesującym elementem na tej stronie jest typ transakcji. Zauważysz, że Ashigaru automatycznie wybrał `STONEWALL`. Kliknij przycisk `PREVIEW`, aby dowiedzieć się więcej.
...
Widać, że transakcja jest rzeczywiście typu Stonewall: zawiera 2 wejścia o tej samej kwocie, 2 wyjścia o tej samej kwocie, a także wyjścia wymiany i, w moim przypadku, dodatkowe wejście w celu zaspokojenia sumy płatności.
...
Jeśli nie chcesz dokonywać transakcji Stonewall, ale wolisz konwencjonalną płatność, kliknij ikonę ołówka w prawym górnym rogu ekranu, a następnie wybierz `Simple` zamiast `STONEWALL`.
...
Po sprawdzeniu wszystkich szczegółów przeciągnij zieloną strzałkę u dołu ekranu, aby podpisać i zwolnić transakcję.
...
Wiesz już, jak przeprowadzić transakcję Stonewall, a co ważniejsze, jak to działa. Jeśli chcesz dowiedzieć się więcej, zapoznaj się z moim samouczkiem na temat Ashigaru Terminal, który wyjaśnia, jak dokonywać coinjoinów za pośrednictwem Whirlpool.
