...
> ► *"Speedy Trial" terimi "hızlandırılmış yargılama" anlamına gelen hukuk terminolojisinden ödünç alınmıştır Bu, iyileştirme önerisinin, niyetlerini belirlemek üzere madencilerin mahkemesi önüne hızla getirildiği gerçeğini çağrıştırmaktadır. Genellikle İngilizce terimin doğrudan Fransızca olarak kullanılması kabul edilmektedir.*