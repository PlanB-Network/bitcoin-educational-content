...
![Télécharger image disque RoninOS](assets/2.jpeg)
...
![Graver l'image disque avec Etcher](assets/3.jpeg)
...
![Configuration Manjaro du clavier](assets/4.jpeg)
...
![Configuration Manjaro du nom d'utilisateur](assets/5.jpeg)
...
![Configuration Manjaro de la zone temporelle](assets/6.jpeg)

![Configuration Manjaro de la localité](assets/7.jpeg)

Ensuite choisissez un nom d'hôte.

![Configuration Manjaro du nom d'hôte](assets/8.jpeg)

Enfin, vérifiez les informations de configuration de Manjaro puis validez.

![Vérification des informations de configuration ManjaroOS](assets/9.jpeg)
...
![Connection SSH à RoninOS](assets/10.jpeg)
...
![Clonage de RoninDojo](assets/11.jpeg)
...
![Vérification mot de passe du nœud Bitcoin](assets/12.jpeg)
...
![Animation de lancement de RoninCLI](assets/13.jpeg)
...
![Navigation menu RoninCLI vers System](assets/14.jpeg)

Puis allez dans le menu "System Setup & Install".

![Navigation menu RoninCLI vers installation system RoninDojo](assets/15.jpeg)
...
![Confirmation installation RoninDojo](assets/16.jpeg)
...
![Interface web de connexion à RoninUI](assets/20.jpeg)
...
![Panneau de gestion de RoninUI interface web](assets/21.jpeg)
...
![Indexer synchronisé à 100% nœud fonctionnel](assets/22.jpeg)
...
![Interface de connexion de Sparrow Wallet à un electrs](assets/23.jpeg)
...
![Récupération du QRcode de connexion au Dojo](assets/24.jpeg)
...
![Connexion à Dojo depuis l'application Samourai Wallet](assets/25.jpeg)
...
![Récupération adresse Tor Mempool](assets/26.jpeg)
...
![Interface Mempool Space](assets/27.jpeg)
...
![Accueil logiciel Whirlpool Stats Tool](assets/28.jpeg)
...
![Téléchargement des données de la pool 0001 depuis OXT](assets/29.jpeg)
...
![Chargement des données de la pool 0001](assets/30.jpeg)
...
![Impression des scores prospectifs et rétrospectifs de la TXID donnée](assets/31.jpeg)
...
![Schéma d'une transaction Coinjoin sur kycp.org](assets/32.jpeg)
...
![Transaction schéma bitcoin sur oxt.me](assets/34.jpeg)
...
![Accueil du logiciel Boltzmann Calculator](assets/35.jpeg)
...
![Taper une TXID à étudier sur Boltzmann Calculator](assets/36.jpeg)

Le calculateur vous renvoie alors tous les indicateurs que nous avons vu précédemment :

![Impression des données de Boltzmann Calculator pour cette TXID](assets/37.jpeg)
...
![Récupérer adresse TorV3 Bitcoin Daemon sur RoninUI](assets/38.jpeg)

Pour connecter votre nœud depuis Bisq, accèdez au menu :

> Paramètres > Info sur le réseau

![Accéder l'interface de connexion au nœud depuis le logiciel Bisq](assets/39.jpeg)
...
![Case pour entrer l'adresse TorV3 de son nœud sur le logiciel Bisq](assets/40.jpeg)
...
![Outil XPUB Tool depuis RoninUI](assets/41.jpeg)

Si votre xpub est bien traquée par le nœud, vous verrez apparaitre cela :

![Outil XPUB Tool résultat favorable de l'analyse](assets/42.jpeg)
...
![Changer le type de dérivation de la xpub étudiée depuis RoninUI](assets/43.jpeg)

Si votre xpub n'est pas traquée pas votre nœud, vous verrez apparaitre cet écran qui vous invite à l'importer :

![Importer une xpub avec outil XPUB Tool sur RoninUI](assets/44.jpeg)
...
![Outil de diffusion d'une transaction signée depuis RoninUI](assets/45.jpeg)
