...
definition: Новый формат сетевого сообщения (BIP155), позволяющий транслировать адреса узлов Bitcoin. Поддерживает более длинные адреса, такие как Tor v3 или I2P.
---
