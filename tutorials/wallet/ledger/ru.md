...
*Ledger объявила о прекращении программной поддержки классического Nano S с 25 июня 2025 года: это устройство больше не будет получать обновления безопасности и совместимость с новыми функциями, что подвергает пользователей риску уязвимостей и будущей несовместимости. Тем не менее, средства остаются доступны благодаря мнемонической фразе, однако настоятельно рекомендуется перейти на более новую модель для обеспечения безопасности и долгосрочного доступа к вашим биткоинам. Важно: речь идет именно о **старом Nano S**, а не о **Nano S Plus**, который продолжает поддерживаться.*
