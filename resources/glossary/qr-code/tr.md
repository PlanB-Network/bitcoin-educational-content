...
QR kodu, iki cihaz arasında bilgi aktarımını kolaylaştırmak için Bitcoin'da yaygın olarak kullanılmaktadır. Öncelikle BIP21'e uygun olarak URI formatında kodlanmış alıcı adreslerini paylaşmak için kullanılır. Bununla birlikte, kullanımı genişletilmiş anahtarlara, PSBT'lere, Yıldırım faturalarına vb. de uzanır.


> ► *QR kodu "Hızlı Yanıt Kodu" anlamına gelir.*