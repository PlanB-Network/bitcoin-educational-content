...
Когда мы падаем в кроличью нору, наше восприятие жизни меняется.  
Это побуждает нас – глубоко внутри себя – идти дальше; открывать других людей, которые выполняют ту же умственную работу, что и мы, и которые также это поняли.

Это мотивирует нас и даёт нам ещё большее желание **внести свою лепту**, делясь своим открытием: Биткоином.

Но также заставляет **размышлять о мире завтрашнего дня, о том, который мы хотим построить, и о сообществах, которые его создают**.

**В этой длинной галерее, которая есть создание сообщества, вам нужно проявить мотивацию, стратегию, самоотверженность и время**. Это иногда неблагодарная работа; и в этом приключении лучше идти шаг за шагом, чтобы не навредить себе.  
**Поэтому думайте о себе, о своих пределах**. И хотя Биткоин может вдохновлять вас день и ночь, **не пытайтесь делать всё в одиночку, иначе вы истощитесь**.

Наоборот, **просите помощи у биткоинеров, которые уже прошли через эту же галерею, которые исследовали те же пути и построили те же инструменты**. Это сэкономит вам много времени.

**Также предложите тем, кто последует за вами в этом путешествии, помочь вам, даже если это означает делегирование некоторых задач**, и что эти задачи займут больше времени. В долгосрочной перспективе ваше сообщество станет сплочённее и зрелее.

![image](assets/fr/60.webp)

В одиночку, действительно, можно быстро исследовать одну из многих галерей кроличьей норы, которой является Биткоин. Но нельзя забывать, что ещё есть много других направлений для исследования.

В то время как **создавая и/или присоединяясь к сообществу биткоинеров, делясь и регулярно обмениваясь с ними, вы будете продвигаться одновременно во всех направлениях норы**.

## Обучение BTC302, продолжение
<chapterId>8bf10b77-80ee-5d50-87bc-0ef32574a675</chapterId>

В этом обучении BTC302 мы подробно описали шаги по созданию сообщества, организации митапа; а также запуску множества проектов.

Когда ваше сообщество почувствует, что готово перейти на следующий уровень, **можно создать ассоциацию**.  
Во Франции, например, из примерно шестидесяти сообществ и митапов насчитывается почти десяток ассоциаций.

Преимущество создания ассоциации двояко:  
- с одной стороны, статус ассоциации позволяет иметь официальный статус, открыть банковский счёт ассоциации и получить признание со стороны прессы, СМИ, а также грантов;  
- с другой стороны, это позволяет серьёзнее организовать работу сообщества и реализацию проектов, в частности определяя конкретные роли.

С целью помочь вашему сообществу ещё больше развиваться, **не исключено, что в ближайшие месяцы на [planb.network](https://planb.network/) будет выпущено продолжение этого обучения**.

В рамках этого продолжения **мы подробно расскажем об организации масштабных мероприятий с участием около ста человек**. Основные вопросы, такие как: «Почему?», «Какая организация?», «Где?», «Какой бюджет?», «Как?» и «Как это работает?» будут рассмотрены.

Для этого мы опираемся на опыт нескольких французских сообществ, которые уже провели собственные мероприятия, таких как **BEF (Bitcoin Economic Forum, в мае, Бретань), B-only (в ноябре, Анси) и Be On Lille (в сентябре, Лилль)**.

![image](assets/fr/chapter38/62.webp)

Разумеется, **в других странах законодательство и функционирование ассоциаций отличаются**.  
**Поэтому мы надеемся, что другие международные биткоинеры дополнят это обучение информацией, специфичной для их стран**.
