...
> ► *Fransızcada "antlaşma" kelimesinin anlamını tam olarak karşılayan bir terim yoktur. "Madde", "anlaşma" veya "Commitment "ten bahsedilebilir, ancak bunlar "antlaşma" terimine tam olarak karşılık gelmez. Bu terim, bir mülk üzerinde kalıcı yükümlülükler getiren bir sözleşme maddesini tanımlamaya izin veren yasal terminolojiden ödünç alınmıştır.*