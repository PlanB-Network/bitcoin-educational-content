...
Dobrodošli na kurs ECO204!


Cilj ovog kursa je da vam pomogne da razumete osnovne uzroke, mehanizme i posledice hiperinflacije u kontekstu fiat monetarnog sistema. Kroz konkretne primere i istorijsku analizu, naučićete da prepoznate ponavljajuće obrasce koji prethode periodima hiperinflacije i identifikujete poluge akcije kako biste se zaštitili.


**Section 2: Šta je Inflacija?**

Pre nego što zaronimo u srž teme, ponovo ćemo se osvrnuti na osnove: šta je inflacija? Ovaj deo će predstaviti njeno monetarno poreklo, različite tipove inflacije i kako se uklapaju u širu ekonomsku dinamiku. Ovo je ključni korak u razumevanju kako redovna inflacija može evoluirati u hiperinflaciju.


**Sekcija 3: Šta je Hiperinflacija?**

U ovom odeljku ćete proučavati precizne definicije hiperinflacije i nekoliko značajnih istorijskih epizoda, uključujući Vajmarsku Nemačku i Zimbabve. Analiziraćemo njihove zajedničke osobine, razlike i savremene paralele. Takođe ćete otkriti manje poznate slučajeve, kao što su uzastopne redenominacije u Latinskoj Americi, i strategije izlaska koje su primećene u određenim zemljama.


**Section 4: Kako Smo Dosli Ovde?**

Ovaj deo ima za cilj da razume strukturne mehanizme koji omogućavaju hiperinflaciju, posebno kroz razvoj monetarnog "drugog Layer" i ulogu centralnih banaka. Dodatni resursi i predlozi za čitanje biće obezbeđeni za dalje istraživanje.


Šta ako se monetarna istorija ponavljala pred našim očima? Vi budite sudija u narednim poglavljima!
...
- Definicija od Roberta: Inflacija je prekomerno povećanje platnih instrumenata (novčanica, kapitala) koje uzrokuje rast cena i deprecijaciju valute.
...
U našoj studiji o hiperinflaciji, usvojićemo drugu definiciju, onu o generalizovanom porastu cena, jer je relevantnija i jasnija za našu temu. Međutim, ključno je zapamtiti da je ovaj porast cena generalno rezultat ekspanzije novca Supply.

Poznati ekonomista Milton Friedman je slavno izjavio:


> "Inflacija je uvek i svuda monetarni fenomen."

Ova izjava ističe intrinzičnu vezu između monetarnog širenja i inflacije. U narednim odeljcima ćemo istražiti interakcije između inflacije i ekonomskog rasta, na osnovu ovih fundamentalnih definicija.


### Razumevanje Monetarnog Fenomena


Kada se govori o monetarnom fenomenu, mislimo na to kako je novac Supply jedne ekonomije pod uticajem. Milton Friedman je to suštinski video kao povećanje ovog Supply. Istorijski gledano, postojale su dve glavne metode za povećanje novca Supply:


1. Monetarno štampanje:

U tradicionalnim monetarnim sistemima, povećanje novca Supply postizano je fizičkim štampanjem novih novčanica. Iako se danas, sa prevlašću digitalne valute, ovo štampanje uglavnom vrši elektronski (putem baza podataka centralnih banaka i drugih finansijskih institucija), istorija nam pokazuje periode kada je doslovno štampanje novčanica dovelo do hiperinflacije.


2. Smanjenje sadržaja metala:
...
Kroz istoriju, razne civilizacije su doživljavale periode monetarne devalvacije. Neki od tih perioda poklapaju se sa velikim događajima ili ratovima koji su vršili pritisak na ekonomiju.


#### 1. Peloponeski rat i Drugi punski rat:
...
#### 2. Drevni Rim tokom Carstva:


Nakon ere Rimske Republike, tokom Carstva, 3. i 4. vek su doživeli značajnu devalvaciju valute. Ovo je ilustrovano smanjenjem sadržaja srebra u kovanicama, kao što je prikazano na prethodnom grafikonu. Studija pokazuje da je cena pšenice u Egiptu, merena u drahmama, porasla za faktor od milion tokom perioda od oko 400 godina, od 40. godine pre nove ere do 360. godine nove ere. Tokom ovog perioda, to predstavlja prosečnu godišnju inflaciju od oko 4,4%. Međutim, ova inflacija nije bila ravnomerno raspoređena. Zaista je počela oko 238. godine nove ere. Od 250. do 293. godine nove ere, stopa inflacije je bila oko 3,65%, a povećala se na 22,28% između 293. i 301. godine nove ere.
...
- Denarije Marka Aurelija (160. godine nove ere):

Jedan od najpoznatijih novčića antičkog Rima je denar, srebrna valuta. Imam specifičan novčić iz vremena Marka Aurelija koji datira iz 160. godine nove ere, pre velike devalvacije. Iako kamera može imati poteškoća da uhvati fine detalje, golim okom se može videti da je to prelep srebrni novčić, koji odražava relativno visok sadržaj srebra.



- Antoninijan (kasni 3. vek n.e.):

Sa monetarnom devalvacijom, pojavila se nova valuta, Antoninijan. Ova valuta je trebalo da vredi dva denara, ali je sadržala mnogo manje srebra. Moj Antoninijan novčić jasno pokazuje da je sadržaj srebra značajno smanjen. Ukrašen je krunom, tipičnom za rimske novčiće ovog perioda, nazvanom "radijati". Poređenjem boje i kvaliteta, može se videti da Antoninijan nije ni blizu čistog srebrnog novčića.
...
Monetarna devalvacija je alat koji države često koriste za finansiranje svojih troškova ili stimulisanje ekonomije. Međutim, Španija se našla u delikatnoj situaciji. Razvodnjavanje španskog dolara bi ugrozilo njen položaj u međunarodnoj trgovini. Da bi prevazišla ovu dilemu, Španija se okrenula Maravediju.


Za razliku od dragocenog španskog srebrnog dolara, Maravedis je bila bakarna valuta koja se uglavnom koristila unutar lokalnog stanovništva. Ova valuta je bila cilj devalvacije. Kada je Maravedis novčić prvobitno vredeo dva maravedisa, država bi ga povukla, ponovo ga žigosala novom vrednošću, na primer "četiri", i vratila vlasniku samo jedan novčić. Novčić pomenut sa žigom "osam" je dokaz ovog procesa, pošto je prošao kroz nekoliko ciklusa devalvacije.


Ova strategija je omogućila državi da efikasno devalvira valutu, stvarajući inflaciju i indirektno se finansirajući, dok je očuvala integritet španskog dolara na međunarodnoj sceni. Međutim, ova ciljana devalvacija imala je posledice po lokalno stanovništvo, koje je videlo kako se vrednost njihove uobičajene valute razvodnjava.
...
#### 4. Revolucija cena od 15. do 17. veka


Između 15. i 17. veka, Evropa je bila svedok izuzetnog ekonomskog fenomena, često nazivanog "revolucija cena." Ovaj period inflacije je uglavnom bio izazvan masovnim prilivom plemenitih metala, posebno zlata i srebra, iz Amerika. Sa evropskom ekonomijom koja je u to vreme bila uglavnom zasnovana na metalnom standardu, ovo dodatno Supply metala je povećalo novčanu Supply. Kao rezultat, pojavila se inflaciona stopa od oko 1 do 2% godišnje. Na prvi pogled, ova inflacija može delovati skromno. Međutim, u to vreme, takve fluktuacije cena su bile dovoljno neobične da se smatraju "revolucijom." Ovo naglašava kako promene u monetarnim rezervama mogu uticati na ceo ekonomski sistem.


#### 5. John Law i asignati
...
Ove novčanice su živi svedok prvog velikog perioda hiperinflacije u istoriji. Prvobitno osmišljene kao odgovor na uzastopne finansijske krize, asignati su brzo postali simbol monetarne nestabilnosti. Vlada, oslanjajući se prekomerno na ovu papirnu valutu za finansiranje svojih troškova, izazvala je neviđenu ekonomsku krizu i stvorila veliki period hiperinflacije u Francuskoj nakon revolucije.


#### 6. Izvršna naredba 6102 i devalvacija dolara


Izvršna naredba 6102 i devalvacija dolara


U Sjedinjenim Američkim Državama, početkom 1930-ih godina došlo je do značajne promene u monetarnoj politici. Evo detaljnog pregleda ove transformacije:
...
Ono što je fascinantno u vezi sa ovom tranzicijom je strategija vlade. Godine 1934, cena zlata je revalorizovana na $35 po unci, umesto $20.67. U suštini, vlada je devalvirala dolar koji su ljudi posedovali. Kupovinom zlata od stanovništva po $20.67 po unci 1933. godine, a zatim revalorizacijom cene zlata 1934. godine, vlada je ostvarila značajan profit dok je devalvirala ušteđevinu svojih građana.


Ukratko, u roku od godinu dana, vlada je efikasno zaplenila zlato građana, zatim promenila pravila igre revalorizacijom vrednosti zlata kako bi koristila trezoru i nanela štetu onima koji su prvobitno zamenili svoje zlato za novčanice.


### SAD menja istoriju.


Sjedinjene Američke Države su napravile istorijsku prekretnicu postavši prve koje su devalvirale svetsku rezervnu valutu, američki dolar, suprotno prethodnim praksama koje su primećene u malim trgovinskim nacijama.


Ranije, tokom renesanse, italijanski florin izdat od strane Firence u 13. veku bio je međunarodna rezervna valuta, i nije zabeležena nikakva devalvacija tokom perioda njegove upotrebe, što odražava važnost monetarne stabilnosti za međunarodnu trgovinu.
...
### Poslednji primer za put: Swiss Dinner
...
#### Da, zapravo smo izmerili novčiće!
...
Ova analiza pokazuje da je poverenje u valutu, a samim tim i njena vrednost, bilo usidreno u njenoj opipljivoj supstanci, a ne samo u tvrdnji države. Naglašava dualnost između nominalne vrednosti koju nameće država i intrinzične vrednosti koju diktira sadržaj plemenitog metala. Tako, valuta prevazilazi da bude samo državni instrument, sa njenom fundamentalnom vrednošću koja je intrinzično povezana sa opipljivim i merljivim Elements.


#### Zaključak


Zaključno, ova studija o monetarnoj devalvaciji otvara vrata ka dubokom razumevanju mehanizama inflacije, koji će biti istraženi u narednim video zapisima. Diskutovaćemo o različitim tipovima inflacije i pragu na kojem prelaze u visoku ili hiperinflaciju. Ova čvrsta osnova će nam omogućiti da Address složenosti inflacije u predstojećim sesijama. Hvala vam na pažnji i vidimo se u sledećem videu kako bismo nastavili ovo istraživanje monetarne dinamike.
...
### Inflacija nije multifaktorski fenomen
...
- Razlika između povećanja cena i inflacije:


Povećanje cena može biti specifično za sektor i izazvano raznim faktorima kao što su smanjenje proizvodnje OPEC-a za naftu ili nepovoljni vremenski uslovi za pšenicu.

Inflacija, s druge strane, je definisana kao opšti porast cena u različitim dobrima i uslugama, ne samo u specifičnom sektoru.



- Monetarna Suština Inflacije:

Sa fiksnim novcem Supply, povećanje cena u jednom sektoru rezultiralo bi smanjenjem cena u drugim sektorima, jer bi količina novca dostupna za trošenje drugde bila smanjena. Inflacija je usko povezana sa povećanjem novca Supply, što omogućava istovremeno povećanje cena u svim sektorima.



- Uticaj novca Supply na inflaciju i deflaciju:


U fiksnom novčanom sistemu Supply, povećanje proizvodnje bi teoretski trebalo dovesti do deflacije, tj. smanjenja cena, jer bi bilo više dostupnih dobara i usluga.

U trenutnom fiat monetarnom sistemu, povećanje novčane mase Supply poništava potencijalnu deflaciju uzrokovanu povećanjem proizvodnje.



- Negativni Efekti Novčane Supply Prilagodbe:


Povećanje novca Supply, bez odgovarajućeg povećanja proizvodnje, dovodi do inflacije, jer ima više novca u opticaju za istu količinu robe i usluga.

Iako je povećanje proizvodnje trebalo da dovede do deflacije, istovremeno povećanje novca Supply poništilo je ovaj efekat, što je rezultiralo inflacijom.



- Inflacija, Deflacija i Novac Supply: Komunicirajući Sudovi:


Inflacija i deflacija su poput spojenih sudova u ekonomiji. Povećanje proizvodnje može dovesti do deflacije, ali ako se istovremeno poveća količina novca Supply, deflacijski efekat se poništava, što rezultira inflacijom.


Ova diskusija ističe važnost razumevanja osnovnih mehanizama inflacije i deflacije, i kako manipulacija novcem Supply može imati duboke uticaje na ekonomiju. Verovatno ćemo se kasnije vratiti ovim konceptima radi dubljeg razumevanja njihove međusobne povezanosti i njihovog uticaja na globalnu ekonomiju.


### Zašto štampanje novca ne izaziva uvek inflaciju?


#### Inflacija ≠ CPI


Inflacija, iako se često povezuje sa povećanjem novčane mase Supply, ne mora uvek imati direktnu korelaciju sa štampanjem novca, kao što je ilustrovano periodom nakon finansijske krize 2008. godine. Uprkos značajnom štampanju novca kako bi se spasile banke, naredna decenija nije doživela visoku inflaciju, prosečno između 0 i 2% godišnje. Ova situacija postavlja pitanje: zašto masovno štampanje novca nije rezultiralo proporcionalnom inflacijom? Odgovor leži u nekoliko nijansi vezanih za merenje inflacije i Indeks potrošačkih cena (CPI).

![image](assets/fr/018.webp)

Prvo objašnjenje leži u načinu na koji se meri inflacija. Indeks potrošačkih cena (CPI), koji se koristi kao glavni pokazatelj inflacije, ima određena ograničenja. Na primer, ne uzima sveobuhvatno u obzir evoluciju cena nekretnina. Iako CPI uključuje komponentu vezanu za kirije, značajno povećanje cena kuća nije u potpunosti odraženo. Kao rezultat toga, značajna povećanja troškova stanovanja mogu se desiti bez da budu u potpunosti obuhvaćena CPI-jem, što potencijalno dovodi do potcenjivanja stvarne inflacije.
...
Ovaj scenario ističe važnost mehanizama monetarnog prenosa u određivanju inflatornog uticaja štampanja novca. Kreiranje novca od strane centralne banke je samo jedan deo slagalice. Ponašanje privatnih banaka, koje odlučuju o obimu kredita koje će odobriti, i ponašanje zajmoprimaca, koji odlučuju kako će potrošiti pozajmljeni novac, takođe su ključni Elements u ovoj dinamici.


#### Inflacija je društvena!
...
Ovaj primer ističe važnost tajminga i ponašanja agenata u manifestaciji inflacije. Inflacija se ne javlja samo kao odgovor na povećanje novca Supply, već i u zavisnosti od toga kako i kada se taj novac troši u ekonomiji. Ekonomske neizvesnosti i očekivanja ekonomskih agenata igraju ključnu ulogu u ovoj dinamici i mogu ili ubrzati ili odložiti inflatorne efekte štampanja novca.
...
- Indeks potrošačkih cena (CPI): CPI je strukturisan na način koji potcenjuje inflaciju, što može dati iskrivljenu sliku inflacione stvarnosti.



- Sektorska Apsorpcija: Monetarno ubrizgavanje u sektore sposobne da ga apsorbuju ne dovodi uvek do inflacije. Glavni primer je američki vojno-industrijski kompleks, koji može apsorbovati velike sume novca bez izazivanja inflacije.



- Slučaj Japana: Uprkos značajnom štampanju novca, inflacija ostaje niska u Japanu jer se sredstva često štede ili ulažu u nekretnine ili berze. Ovi sektori apsorbuju štampani novac, a CPI ne odražava nužno povećanje cena u ovim oblastima.
- Korelacija između štampanja novca i tržišta: Primećeno je da krive tržišta nekretnina i berzi često prate štampanje novca, što ukazuje na to gde je usmeren štampani novac.
- Monetarne rezerve banaka: Kada štampani novac ostaje na bilansima banaka i ne cirkuliše u ekonomiji, ne izaziva inflaciju. Ovo je ilustrovano primerom iz 2008. godine, kada je štampani novac uglavnom ostao na bilansima banaka, odlažući inflatorni uticaj.



- Vajmarska Republika: Ovaj istorijski period pokazuje kako je ekonomska neizvesnost dovela do gomilanja novca, odlažući inflaciju. Međutim, kada je poverenje bilo obnovljeno i novac potrošen, inflacija je eksplodirala.
...
Ključno je razumeti razliku između različitih tipova inflacije, razumevanje koje nam omogućava da shvatimo različite manifestacije ovog ekonomskog fenomena. Evo objašnjenja ovih različitih tipova:



- Puzajuća inflacija: Ovo je tip inflacije kojem centralne banke obično teže, postavljen na oko 2% godišnje. Ova meta je usvojena od 1990-ih i ima za cilj održavanje stabilnog ekonomskog rasta bez pregrevanja ili deflacije.
- Umjerena inflacija: Ovaj oblik inflacije se javlja kada inflacija premaši cilj od 2%. Često je povezana sa pregrejanom ekonomijom, stanjem u kojem prekomerna količina novca Supply podstiče opšti porast cena. Ovaj scenario otkriva granice monetarnih politika i ponekad otkriva kontradikcije u ekonomskom diskursu.
- Galopirajuća inflacija: Galopirajuća inflacija, često nazivana dvocifrenom inflacijom, javlja se kada godišnja stopa inflacije premaši 10%. Ona označava značajan porast cena koji može ugroziti ekonomsku stabilnost.
...
- Povlačenje potražnje:

Inflacija potražnje često se objašnjava kao situacija u kojoj potražnja u ekonomiji premašuje dostupnu proizvodnju. Međutim, bez odgovarajućeg povećanja novca Supply, ova situacija će jednostavno dovesti do preraspodele potrošnje. Potrošači mogu trošiti više na osnovne proizvode, a manje na druge, čime se neutralizuje ukupni inflatorni efekat.



- Troškovni pritisak:

S druge strane, inflacija izazvana troškovima (Cost Push) pripisuje se povećanju troškova proizvodnje, kao što su troškovi prirodnih resursa ili rada. Opet, bez povećanja novčane mase Supply, povećanje troškova u jednom sektoru može jednostavno smanjiti potrošnju u drugim sektorima, bez izazivanja široko rasprostranjene inflacije.

Ova tradicionalna objašnjenja često povezuju povećanje cena sa inflacijom, što može biti zbunjujuće. U stvarnosti, da bi došlo do široko rasprostranjene inflacije, neophodno je povećanje novca Supply. U ovom kontekstu, koncepti Demand Pull i Cost Push mogu objasniti sektorske varijacije cena, ali ne obuhvataju monetarnu prirodu inflacije. Ovo naglašava važnost razlikovanja između sektorskih povećanja cena i široko rasprostranjene inflacije, i potvrđuje potrebu za povećanjem novca Supply kako bi se inflacija manifestovala kroz celu ekonomiju. Ova analiza nudi nijansiraniju i precizniju perspektivu o stvarnim uzrocima inflacije i demistifikuje uobičajene interpretacije koje mogu prikriti osnovnu monetarnu dinamiku.


### Klasifikacija inflacije prema Bernholzu
...
Umerena inflacija se javlja kada je nivo novca Supply viši od normalnog, ali bez da država pribegava velikim deficitima finansiranim stvaranjem novca. Iako termin "umerena" može delovati beznačajno, ovaj oblik inflacije može izazvati značajne probleme, iako se ne klasifikuje kao visoka inflacija.



- Visoka inflacija:

Visoka inflacija se javlja kada stvarna vrednost novca Supply opada uprkos povećanju u nominalnim terminima. Ova paradoksalna situacija nastaje usled monetarne supstitucije, gde pojedinci gube poverenje u nacionalnu valutu i traže da je Exchange za robu, usluge ili strane valute. Ovaj proces dodatno smanjuje stvarnu vrednost valute, pogoršavajući inflaciju.



- Hiperinflacija:

Hiperinflacija je produžetak visoke inflacije, karakterizovana velikim budžetskim deficitima finansiranim stvaranjem novca. Istorijski, nijedan slučaj hiperinflacije nije zabeležen bez značajnog finansiranja deficita putem štampanja novca. Hiperinflacija stvara začarani krug: inflacija tako brzo erodira vrednost valute da poreski prihodi depreciraju pre nego što država uopšte može da ih prikupi, što primorava državu da štampa još više novca kako bi se finansirala. Ovaj samopojačavajući ciklus dovodi do astronomskih stopa inflacije, često prelazeći 50% mesečno.

Ova klasifikacija prema Bernholzu naglašava opasan prelaz sa umerene inflacije na hiperinflaciju, ističući ključnu važnost monetarne i budžetske kontrole u sprečavanju destruktivnih inflacionih spirala. Takođe pokazuje da štetne posledice po finansiranje države mogu nastupiti mnogo pre dostizanja faze hiperinflacije, pružajući nijansiranu perspektivu o implikacijama inflacije na različitim nivoima.


### Zaključak: Rezime tipova inflacije


U zaključku, istražili smo niz tipova inflacije, počevši od često korišćenih termina kao što su "puzeća inflacija," "hodajuća inflacija," i "galopirajuća inflacija," od kojih svaki označava različite nivoe inflacionih procenata unutar ekonomije. Međutim, za naše detaljno proučavanje hiperinflacije, kategorije umerene inflacije, visoke inflacije i hiperinflacije, kako ih opisuje Bernholz, pokazuju se kao ključne tačke.



- Umerena inflacija:

To ukazuje nivo novca Supply iznad normalnog, iako se ovaj nivo može održati bez značajnog deficitarnog finansiranja od strane države.



- Visoka inflacija:

To se dešava kada stvarna vrednost novca Supply opada, često zbog monetarne supstitucije, gde pojedinci nastoje da Exchange svoju valutu za robu, usluge ili druge valute.



- Hiperinflacija:

Predstavlja ekstremnu verziju visoke inflacije, gde prekomerno stvaranje novca za finansiranje velikih budžetskih deficita dovodi do brze erozije realne vrednosti valute.


Ono što proizlazi iz naše istraživanja je da je hiperinflacija složen i kontraintuitivan fenomen. Iako bi se moglo pretpostaviti da je hiperinflacija rezultat masovnog povećanja novčane mase Supply, u stvarnosti, ona proizlazi iz smanjenja realne vrednosti tog novca Supply. Ova nijansa je ključna za razumevanje zašto se neke zemlje bore da izađu iz hiperinflacije, čak i uz podršku međunarodnih institucija kao što su Svetska banka ili MMF. Pogrešno karakterisanje tipa inflacije može dovesti do primene neodgovarajućih rešenja, pogoršavajući ekonomske probleme umesto da ih rešava.


U našim budućim diskusijama, detaljnije ćemo istražiti hiperinflaciju, proučavajući njene definicije i manifestacije u različitim ekonomskim kontekstima. Naš cilj će biti da otkrijemo osnovne mehanizme hiperinflacije i istražimo potencijalna rešenja za Address to. Ovo nijansirano razumevanje omogućiće nam da bolje shvatimo povezane izazove i predložimo informisane strategije za upravljanje inflacijom.

Hvala na pažnji. Sledeća sesija će biti u potpunosti posvećena definisanju i demistifikaciji hiperinflacije, uzimajući u obzir različite akademske i praktične perspektive. Radujemo se nastavku ove istraživačke teme sa vama na našem sledećem sastanku.
...
- Početak i Kraj Hiperinflacije:
  - Hiperinflacija počinje kada mesečna inflacija premaši 50%.
  - Završava se kada stopa inflacije padne ispod 50% mesečno tokom najmanje jedne godine.


Na primer, ako inflacija padne na 40% u julu i ne poraste iznad 50% do jula naredne godine, tada se period hiperinflacije smatra završenim u julu prethodne godine. Ova definicija omogućava precizno karakterisanje epizoda hiperinflacije, omogućavajući strukturiranu analizu.
...
Caganova definicija datira iz 1956. godine i zasniva se na ograničenom broju epizoda hiperinflacije dostupnih u to vreme.



- Caganova zapažanja:

Prema Caganu, nijedna epizoda nije dostigla ovaj prag od oko 50% bez prelaska u ozbiljniju hiperinflaciju, što bi moglo opravdati izbor ovog praga.



- Kritika Caganove Definicije:

Drugi ekonomisti, kao što je Bernholz, autor knjige Monetary Regime and Inflation, takođe su opisali prag od 50% kao proizvoljan.
...
Ova refleksija nas dovodi do pitanja o krutosti tradicionalne definicije hiperinfacije i naglašava potrebu da se možda preispita ova granica, uključujući više epizoda i istorijskih podataka. Definicija hiperinfacije može zahtevati fleksibilnost kako bi obuhvatila različite manifestacije ekstremne inflacije u različitim ekonomskim i istorijskim kontekstima.

### Definicija Hiperinfacije Prema Međunarodnom Savetu za Računovodstvene Standarde (IASB)

IASB nudi jedinstvenu perspektivu na hiperinfaciju, fokusirajući se na računovodstvene prakse tokom perioda hiperinfacije. Ovaj pristup je od suštinske važnosti za računovođe i preduzeća koja rade u okruženjima hiperinfacije, gde moneterna vrednost brzo fluktuira. Uputstva IASB identifikuju različite indikatore hiperinfacije:

- **Preferencija za Nemonetarne Aktive:**  
  Pojedinci više vole da čuvaju vrednost u robama nego u novcu, zbog rapidnog deprecijacije novčane vrednosti.

- **Procena Roba i Usluga:**  
  Stanovnici ne procenjuju vrednost roba i usluga u lokalnoj valuti, što odražava gubitak poverenja u lokalnu valutu.

- **Kompenzacija za Gubitak Novčane Vrednosti:**  
  Cene uključuju kompenzaciju za gubitak novčane vrednosti prilikom kupovine na kredit, ilustrujući uticaj inflacije na svakodnevne transakcije.

- **Indeksacija Cena, Plata i Kamata:**  
  Cene, plate i kamate se prilagođavaju prema indeksu kako bi se kompenzovala inflacija.

- **Kumulativna Inflacija Tokom Tri Godine:**  
  Kumulativna inflacija tokom tri godine približava se 100% (oko 24% godišnje), u kontrastu sa Caganovom definicijom od 50% mesečne inflacije.

![image](assets/fr/037.webp)

Prema kriterijumima IASB, nekoliko zemalja, uključujući Argentinu, Etiopiju, Haiti, Iran, Liban, Sudan, Južni Sudan, Surinam, Siriju, Tursku, Venecuelu, Jemen i Zimbabve, trenutno se nalazi u periodu hiperinfacije.

![image](assets/fr/038.webp)

Ova definicija koju pruža IASB se udaljava od strogog kvantitativnog praga koji je predložio Cagan, uključujući kvalitativnu analizu ekonomskih ponašanja i praktičnih prilagođavanja u uslovima hiperinfacije. Ona pokazuje da je hiperinfacija kompleksna pojava koja zahteva multidimenzionalno razumevanje kako bi se shvatile njene prave implikacije, naročito u oblasti računovodstva koja je ključna za stabilnost i finansijsku transparentnost preduzeća i tržišta.

### Dakle, koliko hiperinfacije u ukupnom?

Uobičajene definicije hiperinfacije, kao što je ona koju je predložio Cagan, koja predstavlja mesečnu inflaciju od 50%, ponekad mogu biti zbunjujuće ili previše pojednostavljene. Na primer, dve zemlje koje imaju godišnje stope inflacije od 1000% i 3000% mogu se različito percipirati u zavisnosti od mesečne raspodele te inflacije. Ako nijedan mesec ne premaši prag od 50%, prema Caganovoj definiciji, te zemlje ne bi bile u stanju hiperinfacije. Ovaj pristup može, dakle, dovesti do anomalija u klasifikaciji hiperinfacije, posebno kada se upoređuju kumulativne inflacije tokom godine.
...
### Dve ere, dve katastrofe


U ovom poglavlju ćemo istražiti uticaje hiperinflacije, fokusirajući se na slučajeve Zimbabvea i Vajmarske Republike. Tokom mog istraživanja, prioritet sam dao istraživanju direktnih svedočenja pojedinaca koji su živeli kroz ove periode hiperinflacije, za razliku od isključivo ekonomskog ili statističkog pristupa.
...
### Uporedna analiza: Zimbabve i Vajmarska Republika
...
> Weimar: "Tokom ovog meseca, biće povećano na skoro 4 milijarde papirnih maraka, cifra sa kojom se nada da će se definitivno prevazići nedostatak valute."
...
> Weimar: "Trenutna ukupna emisija iznosi 63.000 milijardi. Za nekoliko dana, stoga ćemo moći izdati dve trećine ukupne cirkulacije u jednom danu."
...
> Weimar: "Celi apoeni novčanica maraka bili su gotovo bezvredni čim su izašli iz štamparije."
...
> Weimar: "Najobičnija kupovina u prodavnici zahtevala je tri ili četiri minuta računanja, a kada bi cena bila određena, obično je bilo potrebno još nekoliko minuta da se prebroje novčanice."

> Zimbabve: "Menadžerima prodavnica je takođe bilo dozvoljeno da angažuju privremenog radnika kako bi zamenili člana osoblja koji je ceo dan brojao novac. Naravno, brojanje novca u prodavnici za administraciju i bankarski depozit je bila jedna stvar, ali ceo proces je morao biti ponovljen u banci tokom depozita."
...
Weimar: "Spekulacija o inflaciji uključivala je zaduživanje u papirnim markama, njihovu konverziju u robu i fabrike, a zatim vraćanje zajmodavcima sa devalviranim papirom."
...
Weimar: "Kako su stare vrline štedljivosti, poštenja i Hard rada izgubile privlačnost, svi su nastojali brzo se obogatiti, posebno jer je špekulacija valutama ili akcijama očigledno mogla doneti mnogo više nego rad."
...
Weimar: "Njihove transakcije su se uglavnom obavljale preko takozvanih Winkelbankiers, uličnih operatera koji su se pojavili sa inflacijom i koji su, napredujući u bolesnoj ekonomiji, živeli isključivo iskorišćavajući razliku između kupovnih i prodajnih cena stranih valuta."

Zimbabve: "Bili su i menjači novca. Delovali su nekažnjeno između 2. i 6. Avenije i Fort ulice u Bulavaju, zahvaljujući svojim lukavim poslovnim veštinama koje su uključivale korupciju i druge prakse. Ovo područje grada bilo je poznato kao 'Svetska banka'."
...
Weimar: "Ljudi su pribegavali trampi i postepeno se okretali stranim valutama kao jedinom pouzdanom sredstvu Exchange. Uvedeni su novi dekreti u vezi sa kupovinom stranih menica i korišćenjem stranih valuta za domaća plaćanja. Pored zatvorske kazne, sada su mogle biti izrečene novčane kazne do deset puta veće od iznosa ilegalne transakcije."
...
Weimar: "Trgovci su nedavno bili primorani novim dekretom da prihvate državne novčanice; ali pošto je takođe bilo dozvoljeno dalje korišćenje stranih valuta za sve kupovine, trgovci su uglavnom nalazili izgovore da prihvate gotovo ništa drugo."
...
Weimar: "Trgovci koji su nastavili svoje aktivnosti bili su podložni novoj uredbi, donetoj 22. oktobra, koja je zahtevala da drže svoje prodavnice otvorene i nude robu u Exchange za papirne marke."
...
> Weimar: "Mannheimer, po instrukcijama svog šefa, izašao je u avgustu 1921. i počeo kupovati strane valute po bilo kojoj ceni - 'jer je Nemačka imala beskonačnu količinu papirnih maraka, ali ne i stranih valuta.' Ovo je bio prvi znak apsolutnog kolapsa vrednosti marke."

> Zimbabve: Navodno im je postavljen dnevni cilj koji su morali ispuniti, jer su neki od zahteva za devizama bili hitni i kupovali bi po bilo kojoj stopi kako bi akumulirali devize do roka. Ova navodna praksa je optužena za podsticanje devalvacije jer je vrednost zimbabveanskog dolara nastavila strmoglavo da opada.
...
Kao odgovor na ovu situaciju, vlada uvodi drakonske propise, uključujući kontrolu kapitala. Takođe nalaže trgovcima da prihvataju nacionalnu valutu i čekove. Vremenom se donose novi zakoni koji proširuju definiciju kriminalnog ponašanja. Na kraju, stopa Exchange eksponencijalno raste jer je vlada spremna da zameni svoju valutu, štampanu po nižoj ceni, za robusnije strane valute.
...
U ovom poglavlju istražićemo razlike i savremene paralele između prošlih i sadašnjih perioda hiperinflacije, uz anegdote i relevantna poređenja za današnje vreme.
...
Među Notgeldom, jedna posebna novčanica se ističe. Prikazuje dirljivu ilustraciju: u centru, pojedinac je prikazan kako vrši nuždu Marku. Na poleđini, tabela cena od 1913. do 1921. godine ilustruje rast inflacije tokom ovog perioda.
...
> Weimar: "Odluka o revalorizaciji državnih zajmova postala je zakon 1925. godine, što je rezultiralo time da su akcionari primili 2,5 posto svoje početne investicije pod uslovom da su sve reparacije bile plaćene."

> Zimbabve: "U julu 2007. (tri godine kasnije), mogao sam izvaditi iz džepa devalviranu novčanicu od ZDW 500,000 (bt "000"), koja je sada vredela $1.67 po kursu paralelnog tržišta, i otplatiti hipotekarni kredit, koji je trebalo da bude otplaćen tokom dvadeset godina. Štaviše, ova novčanica je predstavljala samo 0.49 procenata moje mesečne plate za isti mesec."
...
> Weimar: "Zato se aprecijacija marke veoma plašila, a čak i nekoliko nedelja 'stabilnosti' nakon Đenove izazvalo je stagnaciju poslovanja."

> Weimar: "Industrijski krugovi su se suočili s opasnošću da gotovina postane vrednija od robe, i došlo bi do kolapsa kada bi svi pokušali da pretvore svoju imovinu u gotovinu."

Savremena paralela može se povući sa izjavama Christine Lagarde, koje sugerišu da građani treba da daju prioritet izgledu za zaposlenje nad zaštitom svojih ušteđevina. Baš kao industrijalci Vajmara, čini se da ona zagovara štampanje novca kao alat za stimulisanje zaposlenja, na račun vrednosti ušteđevina.
...
> Weimar: "Sav nemački kapital koji se nalazi u inostranstvu je konfiskovan."
...
Sada ćemo pogledati različite periode redenominacije u latinoameričkim zemljama.
...
Nakon Argentine, naša studija će obuhvatiti Brazil, Boliviju, Peru, Nikaragvu i Venecuelu. Ispitaćemo denominacije koje su se dogodile u ovim zemljama.
...
Počevši od 1942. godine, Brazil je započeo seriju redenominacija. U većini slučajeva (1942, 1967, 1986, 1989, 1993), kurs konverzije je bio 1.000 prema 1. Godine 1990. došlo je do promene naziva bez konverzije. Redosled ovih valuta je sledeći:



- Réali (stara verzija) do 1942.
- Cruzeiros u 1942.
- Kruzeiros (nova verzija) 1967. godine.
- Cruzados 1986.
- Cruzados Novo u 1989.
- Povratak na Cruzeiros 1990. godine.
- Cruzeiros Reais u 1993.
- Konačno, brazilski real 1994. godine.


Najviša denominacija novčanice dostigla je 500,000, a poslednja redenominacija 1994. godine izvršena je po kursu 2,750 prema 1. Godine 1989. i 1990. obeležene su hiperinflacijom, dok su 1993-1994. zabeležene visoke stope inflacije bez dostizanja praga hiperinflacije (50% mesečno). Nakon ovog burnog perioda, Brazil je ponovo redenominovao svoju valutu uklanjanjem nekoliko nula.
...
Pre nego što je stekla nezavisnost 1825. godine, Bolivija je koristila španski dolar kao svoju valutu. Nakon nezavisnosti, zemlja je uvela Bolivijski Sol između 1827. i 1864. godine, zamenjujući španski dolar. Međutim, treba napomenuti da su se prve novčanice u Boliviji pojavile tek 1864. godine.


Godine 1864. uveden je prvi "Boliviano", sa kursom Exchange od 1.000 prema 1 u poređenju sa Bolivijskim Solom. Ova valuta je ostala u opticaju sve dok nije dostigla denominaciju od 10.000 Boliviana.

Nakon toga, Bolivija je promenila svoju valutu u "Bolivijski pezo", koji je doživeo tako ozbiljnu hiperinflaciju da je na kraju dostigao denominacije do 10 miliona. Ova epizoda inflacije dostigla je vrhunac u godinama 1984-1985, sa mesečnim stopama inflacije koje su često prilazile pragu hiperinflacije od 50%. Da bismo pružili perspektivu, konstantna stopa inflacije od 50% mesečno tokom cele godine rezultira godišnjom stopom inflacije od približno 12,800%. U 1985. godini, godišnja stopa inflacije u Boliviji dostigla je 11,749%, što ukazuje da je skoro svakog meseca inflacija bila blizu ili je prelazila prag od 50%.


Kao odgovor na ovu monetarnu krizu, 1987. godine, Bolivija je uvela novu valutu, jednostavno nazvanu "Boliviano," sa Exchange kursom od 1 milion bolivijskih pezosa za 1 Boliviano. Ova verzija Boliviana je i dalje u opticaju danas.


To je pregled burne monetarne istorije Bolivije, obeležene periodima hiperinflacije i redenominacija.
...
Ispitujući periode redenominacije, 1988. se smatra godinom hiperinflacije, posebno u septembru. Jul-avgust 1990. takođe su zabeležili period hiperinflacije. U 1988. godini, godišnja stopa inflacije bila je 667%, sa vrhuncem od 50% u septembru. Nasuprot tome, 1989. je zabeležila stopu inflacije od 3000% bez ijednog meseca koji je premašio 50%, pa nije klasifikovana kao hiperinflacija. U 1990. godini, inflacija je dostigla vrhunac od 7481%. Jasno je da pravilo od 50% može biti proizvoljno, jer je 1988. smatrana godinom hiperinflacije, za razliku od 1989. Ako bi se ovo pravilo preispitalo, možda bi bilo mudro sniziti prag kako bi se uključili periodi poput onog koji je Peru doživeo 1989. godine.


> Razumevanje onoga što se dešava
>

> Ključna stvar koju treba razumeti o redenominaciji valuta je da kada vrednost valute dostigne astronomske cifre, kao što su 5 ili 10 miliona, dolazi do redenominacije. Ovaj proces se može ponoviti više puta, uključujući promenu valute. Rezultat je da štednja pojedinaca može biti ozbiljno pogođena, čak i u odsustvu hiperinflacije. Na primer, ako neko uštedi $1,000 u jednoj godini i uspe da odvoji $100, sledeće godine najniža novčanica može biti $1,000, čineći prethodno ušteđenih $100 bezvrednim. Takva erozija štednje ne zahteva očiglednu hiperinflaciju. Čak i ako je osoba uštedela $10,000 tokom proteklih deset godina, taj iznos može postati beznačajan, nesposoban da kupi jednostavnu flašu vode. Ova realnost je očigledna u mnogim zemljama koje su doživele redenominacije, čak i ako je samo nekoliko meseci bilo klasifikovano kao hiperinflatorno. Nasuprot tome, neke zemlje, poput Nikaragve, doživele su uzastopne godine hiperinflacije.
...
Nakon usvajanja plutajuće stope Exchange 1983. godine, usledilo je nekoliko redenominacija:



- U 2008: bolivar fuerte, ili "jaki bolivar," je uveden, dostigavši do 100.000 pre nego što je izvršena redenominacija od hiljadu prema jedan.
- U 2018: Soberano je uveden sa novčanicama koje su dostizale 1 milion. U 2021, zamenjen je digitalnim bolivarom, koji je takođe dostigao milion, pre nego što je nova redenominacija od milion prema jedan izvršena. Danas, novčanica od 10 ili 20 je ekvivalentna 10 miliona ili 20 miliona u Soberano.

Računi iz ovog perioda, koji datiraju iz 2018. godine, distribuiraju se na raznim Bitcoin konferencijama u Biaricu, Torontu i Majamiju. Ovi Soberano računi dostigli su maksimalnu vrednost od 1 milion. Zatim je došlo do redenominacije, smanjujući vrednost od milion na oko 3 centa. Trenutno, 10 računa od 1 milion odgovara jednom računu od 10. Od 2016. godine, Venecuela doživljava hiperinflaciju, predstavljajući 57. period u specifičnoj tabeli.


U sledećem videu biće predstavljena kolekcija novčanica iz perioda hiperinflacije, sa fokusom na Venecuelu i druge navedene zemlje. Ova kolekcija sadrži skoro sve venecuelanske novčanice. Studija će se fokusirati na različite denominacije za svaku pomenutu zemlju. Pored toga, biće istražene i denominacije u Zimbabveu, tema od značajnog interesa.


### Zaključak


Videli smo da hiperinflacija nije jedini pokazatelj ekonomske katastrofe. Višestruka redenominacija, uklanjanje nula ili promena naziva valute ima direktne posledice na stanovništvo, od gubitka pomoći do problema sa hranom. Iako je hiperinflacija zabrinjavajuća, broj redenominacija, kao što je primećeno u Brazilu, pokazuje složeniju stvarnost.


Na osnovu kriterijuma od 50% inflacije mesečno, nekoliko perioda moglo bi biti klasifikovano kao hiperinflacija. Ovo je posebno tačno kada se ispituju kriterijumi međunarodne računovodstvene organizacije, koja uzima u obzir karakteristike kao što su brzo napuštanje valute od strane stanovništva, indeksacija plata i zajmovi sa visokim kamatnim stopama kako bi se nadoknadila inflacija.


U zaključku, hiperinflacija je samo jedan aspekt ekonomskih izazova. Visoka inflacija sama po sebi može biti jednako štetna. Sledeći deo će istražiti moguće rešenja za prevazilaženje hiperinflacije.


## Kako prevazići hiperinflaciju
...
- U Zimbabveu, rešenje usvojeno za suzbijanje inflacije bilo je dolarizacija, što znači da su usvojili američki dolar ili druge valute iz susednih zemalja. Ovaj pristup sprečava vladu da štampa novac po volji.
- U Nemačkoj, rešenje je bilo stvaranje nove valute, Rentenmark. Ova valuta je bila podržana teritorijalnom imovinom Rajha, i ova strategija se pokazala kao efikasna.
...
Stoga je, nakon 2009. godine, suočena sa upornom monetarnom krizom i galopirajućom hiperinflacijom, Zimbabve napustila svoju nacionalnu valutu i dozvolila upotrebu stranih valuta, uglavnom američkog dolara. Ova odluka, iako radikalna, zaustavila je hiperinflaciju. Ključna lekcija koju treba naučiti je da zaustavljanje prekomernog izdavanja novca i okončanje finansiranja budžetskog deficita od strane centralne banke može zaustaviti hiperinflaciju.


Međutim, dolarizacija nije čudotvorno rešenje. Iako može okončati hiperinflaciju, ona donosi druge ekonomske izazove. Jedna od posledica je gubitak autonomne monetarne politike. Bez sopstvene valute, zemlja ne može prilagoditi svoju monetarnu politiku kako bi odgovorila na unutrašnje ekonomske šokove.


Godine 2007, stopa inflacije u Zimbabveu dostigla je prag od 50% mesečno, zvanično označavajući zemlju kao onu koja je u hiperinflaciji. Nakon dolarizacije 2009. godine, hiperinflacija je prestala, ali se zemlja suočila sa drugim ekonomskim izazovima.

Zabrinjavajuće je primetiti da je Zimbabve od tada pokušao da ponovo uvede sopstvenu valutu, a znaci visoke inflacije su se ponovo pojavili. Prema određenim međunarodnim organizacijama, zemlja možda već ispunjava kriterijume za hiperinflaciju, čak i ako još nije dostigla zvanični prag od 50% mesečno. Ovo služi kao podsetnik na opasnosti prekomernog izdavanja novca i finansiranja deficita od strane centralne banke.
...
## Prezentacija kolekcije novčanica iz perioda hiperinflacije
...
## Pojava druge Layer novca i centralnih banaka
...
#### Računi Exchange (13. vek)


Uobičajena praksa u to vreme bila je sledeća: zlatari su izdavali račune Exchange u Exchange za deponovane florine. Ovi florini su pažljivo čuvani u njihovim trezorima. Tako je pravo zlato, predstavljeno florinom, činilo prvi Layer novca, dok su računi Exchange činili drugi Layer. Međutim, likvidnost ovog sistema bila je ograničena. Ako je neko želeo da Redeem svoje zlato u Exchange za svoj račun, transakcija je bila jednostavna. Ali razmena ovih računa između pojedinaca nije bila uobičajena.


#### Antverpenska berza Exchange (16. vek)


Antwerp Stock Exchange označio je ključnu prekretnicu u evoluciji papirnog novca. Tamo je uvedena praksa diskontovanja zadužnica. Ove zadužnice su bile papirni instrumenti koji su predstavljali novčanu vrednost, ali njihova jedinstvenost je bila u tome što su nosile imena i datume dospeća. To ih je činilo teškim za Exchange pre datuma dospeća.

Revolucija koju je donela Antwerp Stock Exchange leži u mogućnosti diskontovanja ovih beleški pre njihovog dospeća. Na primer, ako je menica dospevala za mesec dana, bilo je moguće kupiti je po sniženoj ceni kako bi se uzelo u obzir vreme pre dospeća. Ova inovacija ne samo da je učinila papirnu valutu više Liquid već je uvela i koncept vremenske vrednosti novca.


Ovaj koncept, iako je povezan sa Nick Bellom preko njegovog Twitter pseudonima "vremenska vrednost BTC-a," nije njegova izmišljotina. Ipak, on ga detaljno razmatra u svom radu. Glavna ideja je da vreme ima vrednost. Dakle, ako neko odluči da plati menicu vrednu $100 mesec dana unapred, može je dobiti, na primer, za $98 i primiti $100 na datum dospeća. Ova monetarna inovacija potiče sa Antverpske berze Exchange.
...
#### Kreiranje Banke Engleske za finansiranje rata


Stvaranje Banke Engleske bilo je motivisano potrebom za finansiranjem rata krajem 17. veka. Kao i Banka Amsterdama, nametnula je depozite dekretom. Posebnost Banke Engleske bila je da relegira privatne banke na sekundarnu poziciju u monetarnom sistemu, stvarajući tako ono što bi se moglo nazvati "trećim Layer" valute.

U početku, prvi Layer valute bio je predstavljen zlatom. Depoziti kod privatnih banaka formirali su drugi Layer. Međutim, kada se ti depoziti više nisu mogli konvertovati u zlato, pojavila se treća Layer valute. Od tada, novčanice koje su izdavale privatne banke više nisu bile konvertibilne u zlato, već u papirnu valutu Banke Engleske, koja je sama po sebi bila konvertibilna u zlato. Ova evolucija dovela je do komplikacije monetarnog sistema sa dodatkom dodatnih slojeva.
...
Nakon bankarske panike 1796. godine, dogodio se fenomen gde su svi pokušavali da se pomere naviše u "novčanoj piramidi". Ljudi su želeli da zamene svoju treću-Layer valutu za drugu-Layer valutu, i na kraju za prvu-Layer valutu, zlato. Suočena sa ovim masovnim naletom, Banka Engleske bila je primorana da preduzme mere kako bi stabilizovala situaciju. Da bi sprečila potencijalnu deflaciju zlatnih rezervi, odlučila je da obustavi konvertibilnost svojih novčanica u zlato. Ova suspenzija, prvobitno zamišljena kao privremena mera, trajala je dve decenije.


### Zaključak:


Centralne banke su evoluirale da postanu zajmodavci poslednjeg utočišta, suspendujući konvertibilnost svoje valute u zlato. Iako je ova akcija prvobitno bila zamišljena kao privremeno rešenje, na kraju je postala trajna, označavajući početak koncepta zajmodavca poslednjeg utočišta. Ova transformacija je oblikovala centralne banke kakve danas poznajemo. Međutim, u krhkijim ekonomijama, ova sposobnost da se novac štampa po volji može dovesti do neželjenih posledica, kao što je hiperinflacija, ako se koristi neodgovorno.
...
Hiperinflacija je fascinantna tema koja je proučavana kroz razne istorijske događaje. Ako želite da se dublje upustite u ovu temu, evo liste od 10 ključnih resursa za čitanje i proučavanje:



- "Kada novac umre: Noćna mora deficitarnog trošenja, devalvacije i hiperinflacije u Vajmarskoj Nemačkoj" od Adama Fergussona. Ova knjiga detaljno opisuje krizu hiperinflacije u Nemačkoj nakon Prvog svetskog rata.



- "The Economics of Inflation - A Study of Currency Depreciation in Post-War Germany" by Costantino Bresciani-Turroni. Detaljna analiza nemačke hiperinflacije 1920-ih.



- "Ovaj put je drugačije: Osam vekova finansijskih ludosti" od Carmen M. Reinhart i Kenneth S. Rogoff. Iako knjiga pokriva mnoge vrste finansijskih kriza, opširno raspravlja o hiperinflaciji kroz istoriju.



- "Zimbabveova Hiperinflacija, Analiza i Naučene Lekcije" od Stiva Henka. Studija o zimbabveovskoj hiperinflaciji početkom 2000-ih.



- "Monetarni režimi i inflacija: Istorija, ekonomski i politički odnosi" od Petera Bernholza. Knjiga ispituje slučajeve hiperinflacije kroz istoriju i nastoji da razume osnovne faktore.



- "The Hyperinflation Survival Guide: Strategies for American Businesses" by Gerald Swanson. Praktični vodič o tome kako preduzeća mogu navigirati kroz hiperinflaciono okruženje.



- "Dying of Money: Lessons of the Great German and American Inflations" by Jens O. Parsson. Komparativna analiza kriza inflacije u Nemačkoj i Sjedinjenim Američkim Državama.



- "The Downfall of Money: Germany’s Hyperinflation and the Destruction of the Middle Class" by Frederick Taylor. Narativno istraživanje društvenog i ekonomskog uticaja hiperinflacije na nemačko društvo.



- "Currency Boards for Developing Countries: A Handbook" by Steve Hanke and Kurt Schuler. Iako je fokus na valutnim odborima, ova knjiga nudi perspektivu o tome kako izbeći situacije hiperinflacije.
