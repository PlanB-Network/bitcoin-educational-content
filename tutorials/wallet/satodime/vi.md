...
**Satodime**, được phát triển bởi **[Satochip](https://satochip.io/fr/)**, là một thẻ mang an toàn để lưu trữ Bitcoin một cách hữu hình và đơn giản. Nó hoạt động như một Hardware Wallet tự quản lý, nơi bạn có toàn quyền kiểm soát khóa riêng của mình mà không cần phụ thuộc vào bên thứ ba. Được cấp chứng nhận mã nguồn mở và EAL6+, Satodime hỗ trợ tối đa ba két an toàn độc lập.
...
- Cảnh báo**: Bước này không thể đảo ngược. Vui lòng tham khảo [bài viết *Ownership*](https://satochip.io/satodime-Ownership-explained/).
...
- Nhấp vào "*Tạo & Seal*".
- Quét thẻ đến generate và Seal là khóa riêng (không xác định cho đến khi được mở niêm phong).
...
- Chọn két an toàn.
- Nhấp vào "*Thêm tiền*".
- Sao chép mẫu Address công khai hoặc quét mã QR.
...
- Lấy Ownership của thẻ,
- Tạo một két an toàn Bitcoin,
- Chuyển Satss đến đó,
- Chuyển thẻ Ownership: người tiếp theo quét thẻ sẽ trở thành chủ sở hữu của thẻ,
- Đưa thẻ Satodime cho người bạn chọn và mời họ tải ứng dụng xuống, sau đó quét thẻ để lấy Ownership - và do đó có thể truy cập vào số bitcoin được 'lưu trữ' trên thẻ.
...
- Kiểm tra trạng thái**: Luôn quét để xác nhận thẻ Ownership và trạng thái niêm phong/không niêm phong của két sắt.
- Tính bảo mật**: Sử dụng địa chỉ mới; tránh giao dịch tập trung.
- Cập nhật**: Cập nhật ứng dụng thông qua các cửa hàng.
- Khôi phục**: Nếu thẻ bị mất nhưng vẫn còn, số tiền sẽ nằm trong thẻ Blockchain; hãy sử dụng khóa riêng nếu thẻ chưa được niêm phong.
...
[Plan ₿ Network](https://planb.network/) để biết hướng dẫn về quyền tự quản, khóa riêng tư, v.v.
...
**Satochip** là một công ty Bỉ chuyên phát triển các giải pháp phần cứng và phần mềm để quản lý và lưu trữ bitcoin và các loại tiền điện tử khác. Sản phẩm chủ lực của công ty, Satochip Hardware Wallet, là một thẻ NFC được trang bị secure element đạt chứng nhận EAL6+. Cùng với Seedkeeper, một trình quản lý cụm từ và bí mật Mnemonic, và Satodime, một thẻ mang, Satochip cung cấp một danh mục sản phẩm toàn diện được thiết kế riêng theo nhu cầu của người dùng. Các thiết bị của công ty, được hỗ trợ bởi phần mềm nguồn mở, hướng đến mục tiêu dân chủ hóa bảo mật trên Bitcoin.