...
A Bitcoin [node](https://planb.academy/resources/glossary/node) is a computer that participates in the Bitcoin network by running Bitcoin Core software or an alternative client. Its role is essential to the operation and security of the network:



- **[Blockchain](https://planb.academy/resources/glossary/blockchain) storage**: Maintains a complete, up-to-date copy of the Blockchain Bitcoin
