...
Une fois l'application téléchargée, procédez à une installation manuelle puis accordez les droits d'installation d'applications à Aurora Store.
...
En vous connectant anonymement, Aurora Store vous crée une adresse mail temporaire qui change toutes les 24 heures. Aucune information personnelle n'est stockée et une session anonyme est générée à chacune de vos connexions.
Dans les paramètres de l'application, vous pouvez définir selon votre convenance la fréquence des mises à jour et définir le mode de mise à jour (automatique ou manuelle) que vous souhaitez utiliser.
...
Aurora Store vous permet de télécharger manuellement les applications mobiles en spécifiant le code de la version que vous souhaitez installer. Le contrôle du téléchargement est un avantage lorsque les mises à jour de vos applications réclament plus de données qu'il ne leur en faut : vous avez un contrôle sur vos données.

![manual](assets/fr/04.webp)

- **Les autorisations :**
Obtenez dans les descriptions de l'application que vous souhaitez installer, la liste complète des autorisations que vous accordez à cette application après l'installation.
