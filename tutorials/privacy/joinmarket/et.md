...
- `merge_algorithm` juhul, kui me teeme nagu tegija see väli reguleerib, kuidas agressiivselt tarkvara konsolideerib kasutamata väljundid. Juhul, kui meil on palju UTXOsid, mida konsolideerida, võib olla mõistlik lülitada _gradual_lt _greedy_le
