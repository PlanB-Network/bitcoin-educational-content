...
> DécouvreBitcoin (Rogzy) не предоставляет инвестиционных советов, и ничто из этого не должно рассматриваться как таковое.
...
- [LN 201](https://planb.network/courses/ln201) и [LN 202](https://planb.network/courses/ln202) позволит тебе открыть для себя сеть Lightning, второй уровень платежной сети
- [ECON 201](https://planb.network/courses/econ201) расскажет об австрийской экономике
- [SECU 101](https://planb.network/courses/secu101) поможет тебе обновить свою цифровую безопасность
...
Этот курс, как и весь контент в этом университете, предоставлен бесплатно нашим сообществом. Чтобы поддержать нас, ты можешь поделиться им с другими, стать членом университета и даже внести свой вклад в его развитие через [наш GitHub](https://github.com/DecouvreBitcoin/sovereign-university-data). От имени всей команды, спасибо!

## Оцените обучение
<chapterId>44d01865-5c89-55a5-a397-a014960eec0f</chapterId>

Система оценок для обучения скоро будет интегрирована в новую платформу электронного обучения! Тем временем, большое спасибо за прохождение курса, и если он тебе понравился, пожалуйста, рассмотри возможность поделиться им с другими.

Огромное спасибо те кто поддерживает нас на Patreon, членам и донорам за их финансовую поддержку, спасибо людям, которые делятся, и спасибо тем, кто сделал это обучение возможным: Rachel, Muriel, the StackinSat team, JohnOnChain, Fanis, Guillaume, Lounes, корректорам и рецензентам.
