...
Perhitungan akan dimulai dari label $1$, karena label $0$ dicadangkan untuk uang kembalian. Alice, yang ingin mengirim bitcoin ke alamat statis berlabel yang disediakan oleh Bob, akan mendapatkan alamat pembayaran unik $P_0$ menggunakan $B_1$ yang baru, bukannya $B_{\text{spend}}$:
