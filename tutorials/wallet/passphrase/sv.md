...
Enligt [en studie utförd av Trezor år 2019](https://blog.trezor.io/is-your-passphrase-strong-enough-d687f44c63af) kunde en angripare med tillgång till din seed och med en högpresterande GPU hyrd via AWS (NVIDIA Tesla V100) testa nästan 620 miljoner lösenfraser för 1 dollar. Som en uppskattning: med kapaciteten från 2019 skulle det i genomsnitt kosta **77 miljoner dollar** att knäcka en lösenfras bestående av 12 slumpmässiga små bokstäver.

Jag rekommenderar dock inte att du begränsar dig till 12 tecken. Satsa istället på de nuvarande standarderna för starka lösenord: år 2025 bör du minst använda 13 slumpmässiga tecken inklusive siffror, små och stora bokstäver samt symboler; eller 14 tecken om du bara använder små och stora bokstäver. Jag rekommenderar naturligtvis att sikta ännu högre, till exempel genom att använda en lösenfras med 20 tecken och symboler, för att förutse framtida utveckling och beakta mänskliga risker som inte tas upp i dessa studier.
