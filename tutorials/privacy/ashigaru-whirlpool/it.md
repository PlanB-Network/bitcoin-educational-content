...
- Dojo**, un'implementazione del [nodo](https://planb.academy/resources/glossary/node) Bitcoin che garantisce una connessione sovrana alla rete, senza dipendere da un server di terze parti.
