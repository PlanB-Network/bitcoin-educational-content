...
Evo najčešćih prevara na koje možete naići na svom putovanju:
...
- Nerealna obećanja zagarantovanih prinosa (npr. 20% zagarantovani prinos);
- Kašnjenja ili poteškoće prilikom pokušaja povlačenja vaših uloženih sredstava;
- Snažni podsticaji za regrutovanje novih članova kako bi sistem nastavio da funkcioniše;
...
Najbolja zaštita je uvek postaviti ovo jednostavno pitanje: Odakle zapravo dolazi obećani povrat? Ako je odgovor nejasan, odmah bežite.


#### Pump & Dump


Ova vrsta prevare uključuje veštačko naduvavanje cene imovine—često kriptovalute sa niskom likvidnošću token—putem koordinisane marketinške kampanje, obično predvođene grupom investitora. Tipična šema Pump & Dump prati ovaj obrazac:
...
Zaštita od prevara je ključni prvi korak u očuvanju vaše imovine; ali to nije dovoljno. Održavanje snažne digitalne higijene je jednako važno. Zato ćemo u narednom poglavlju istražiti kako ojačati vašu online sigurnost i najbolje prakse koje treba da usvojite kako biste se zaštitili u digitalnom svetu.
...
Jedan od najvećih razloga zašto ljudi bivaju hakovani je korišćenje slabih lozinki. Značajan broj korisnika i dalje koristi istu lozinku za više naloga, ili bira varijacije koje je lako pogoditi. Menadžeri lozinki su savršeno rešenje za ovaj problem.
...
- Korišćenje **platformi za enkriptovanu razmenu poruka** kao što su Signal, SimpleX ili Session;
...
Evo ključnih tačaka koje ćemo zajedno proći:
...
Ako vaše bogatstvo nije osigurano u nemonetarnim sredstvima (kao što su nekretnine, obveznice ili akcije); vaša štednja će neizbežno gubiti vrednost tokom vremena. U međuvremenu, oni koji imaju pristup finansijskim instrumentima nastavljaju da uvećavaju svoje bogatstvo, povećavajući jaz između ekonomske elite i ostatka društva.
...
Međutim, postoje alternative za sticanje bitkoina bez podvrgavanja KYC-u:
...
### Glavni kriterijumi za definisanje vašeg profila
...
Hardverski novčanici su fizički uređaji koji čuvaju vaše privatne ključeve potpuno van mreže. Oni su mnogo sigurniji od Hot novčanika jer smanjuju rizik od online napada.


Primeri: Ledger, Trezor, Coldcard, Jade, BitBox
...
- Sporije za korišćenje; potrebno je povezati uređaj i fizički potvrditi transakcije.
- Moraćete da kupite uređaj, što vas može koštati priličnu sumu novca.


Najbolje za: Dugoročne vlasnike i svakoga ko osigurava veće iznose.
...
- Veoma jaka zaštita; ako je jedan ključ kompromitovan, vaša sredstva su i dalje sigurna.
- Može smanjiti rizike od krađe, gubitka ili prinude.
- Možete distribuirati ključeve između ljudi ili lokacija.
...
- Visoke naknade za konverzije i isplate;
- Neke platforme su komplikovane i mogu vas preplaviti naprednim funkcijama trgovanja ili altkoinima;
...
U poslednjem delu ovog kursa detaljnije ćemo se baviti planiranjem nasledstva.


#### 4. Ostanite strpljivi kroz cikluse


Hodling znači igranje na duge staze. Moraćete ostati smireni tokom padova cena i euforičnih bikovskih tržišta podjednako.


Nekoliko najboljih praksi:
...
Ako se prepoznaješ u ovim osobinama ličnosti, verovatno si prirodni Hodler:
...
Aktivni korisnici treba da koriste dve različite vrste novčanika kako bi balansirali sigurnost i praktičnost:
...
Odabir načina razmišljanja koji stavlja privatnost na prvo mesto nudi nekoliko ključnih prednosti:
...
Usvajanje paranoične strategije nije neformalna odluka. Zahteva strogu disciplinu, stalnu pažnju i značajno ulaganje vremena da bi se savladali alati i najbolje prakse privatnosti.

Da li je ovaj pristup pravi za vas?

Evo ključnih osobina paranoičnog bitkoinera:
...
U sledećem delu kursa, razgovaraćemo o ključnoj temi koja se često zanemaruje: kako preneti svoje bitkoine u slučaju nužde.


# Zaštita vaših naslednika i vašeg bogatstva
...
Pobrinite se da imate mirno okruženje bez ometanja, a zatim prikupite ove alate:
...
Mnogi ljudi odlažu ovaj korak zbog zabluda koje ih sprečavaju da preduzmu akciju. Evo nekih uobičajenih mitova, koje je iznela Pamela Morgan u _Planiranje nasleđivanja kriptoimovine_ (strana 18):
...
Vreme je da preduzmete akciju. Provedite ovih 30 minuta postavljajući svoj plan nasledstva. To je jednostavan korak, ali može napraviti svu razliku za vaše voljene.
...
Kada se ovaj popis završi, biće mnogo lakše identifikovati slabe tačke i organizovati siguran i efikasan proces prenosa.


### Korak 3: Napišite pismo


#### Zašto rukom pisano pismo?
...
- Uvod koji objašnjava prirodu imovine koja treba da se povrati;
- Kontakti pouzdanih osoba koje mogu pomoći vašim naslednicima u procesu oporavka;
- Jasan popis imovine, uključujući metode skladištenja i detalje pristupa;
- Specifična sigurnosna uputstva za izbegavanje grešaka ili prevara;
- Završna poruka, zajedno sa svim pravnim uputstvima ako je primenljivo.


#### Primer pisma o nasledstvu


Evo model inspirisan planiranjem nasleđivanja kriptoimovine Pamele Morgan. Naravno, trebalo bi da ga prilagodite svojoj ličnoj situaciji:


---
**Datum: `Naznačite datum`**
...
#### 3. Bezbednosne mere predostrožnosti i uputstva
...
Posebna zahvalnost [Pamela Morgan](https://x.com/pamelawjd) za njen rad i što je omogućila adaptaciju ovog sadržaja.
...
Sada ste spremni da polažete završni ispit; test sa 40 pitanja koji će potvrditi vaše razumevanje i dodeliti vam sertifikat.
