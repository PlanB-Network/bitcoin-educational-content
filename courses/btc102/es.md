...
goal: Obtener tus primeros bitcoins y almacenarlos de manera segura en una billetera de Bitcoin utilizando una frase mnemotécnica y un plan de herencia.
objectives:
...
Para ayudarte a comenzar esta aventura, he creado este curso gratuito. Solo Bitcoin, sin tonterías, sin otras criptomonedas, un curso directo y sin rodeos. Este curso ha sido diseñado para adaptarse a ti y permitirte elegir el camino que mejor te convenga.
...
¡Bienvenido a BTC 102! ¡Un curso práctico que te guiará en la creación de tu plan de Bitcoin! A través de este curso, nos prepararemos para obtener tus primeros bitcoins, asegurarlos correctamente y asegurar una buena entrada en esta nueva industria.
...
Cuando hay una explosión de innovaciones y posibilidades, también hay estafas y riesgos. Es evidente que tu camino en Bitcoin no estará exento de contratiempos y errores. Sin embargo, para ayudarte a evitarlos en la medida de lo posible, este curso servirá como una guía práctica para comenzar bien. El curso BTC 101, por otro lado, es más teórico y te ayudará a comprender el funcionamiento de Bitcoin.
...
- Revisar fundamentalmente por qué Bitcoin es importante y comprender su industria. Esto fortalecerá nuestras convicciones y nos ayudará a comprender en qué nos estamos adentrando.
...
1. La industria de Bitcoin, centrada en una moneda sólida a través de un protocolo descentralizado de transferencia de valor (Bitcoin). Valora la privacidad y la soberanía individual, y está construyendo gradualmente proyectos a largo plazo con un alto nivel de resistencia y seguridad.
...
En el campo de la inversión financiera, los sistemas de venta piramidal y Ponzi se destacan como modelos ilegales. Funcionan utilizando el dinero de los nuevos inversores para pagar a los antiguos participantes. Sin embargo, su carácter no sostenible y su dependencia de los nuevos participantes para mantener el sistema en funcionamiento los hace propensos a colapsar inevitablemente.

![pirámide de Ponzi](assets/prerequis/7.JPG)

Estos sistemas a menudo se caracterizan por elementos cuestionables como la falta de valor intrínseco, promesas de rendimientos irreales y tácticas de marketing que fomentan las recomendaciones para atraer a nuevos inversores. Los plazos de retiro no negociables y el uso de perfiles falsos en las redes sociales para promoción también son señales reveladoras de estas estafas. Dado su carácter ilegal e inmoral y el riesgo financiero que representan, es esencial evitarlos.
En última instancia, estos sistemas están condenados al fracaso. Con el tiempo, el requisito de un número creciente de nuevos participantes para mantener el sistema en funcionamiento se vuelve insuperable. Cuando se alcanza este punto, la ilusión se desvanece, el sistema colapsa y los inversores a menudo se encuentran sin forma de recuperar su inversión.

Los esquemas Ponzi pueden manifestarse de diversas formas. A veces, se disfrazan como nuevas ofertas de tokens o Ofertas Iniciales de Monedas (ICO), combinaciones de contratos inteligentes, intentos de monopolizar la moneda fiduciaria o incluso programas de marketing sin un producto real. Sin embargo, una investigación exhaustiva y una debida diligencia revelan que estos sistemas no crean ningún valor real. Simplemente redistribuyen el dinero de los nuevos participantes para pagar a los antiguos.
...
2. Luego generan entusiasmo alrededor de estos activos y difunden información exagerada o engañosa para atraer a otros inversores.
3. Esta publicidad genera FOMO (Fear Of Missing Out), un miedo a perder una oportunidad, tanto en inversores humanos como en bots de inversión, que comienzan a comprar masivamente estos activos.
...
Las estafas relacionadas con concursos o donaciones en línea son muy comunes en el sector de las criptomonedas. Los anuncios que prometen bitcoins gratuitos a menudo se utilizan para engañar a usuarios inexpertos. Algunos principios clave a tener en cuenta son nunca enviar bitcoins con la expectativa de recibir algo a cambio y desconfiar de las promesas de rendimientos irreales. Es esencial no confiar ciegamente, especialmente cuando se trata de un anuncio en Internet.
...
Otra táctica comúnmente utilizada es regalar "shitcoins", o criptomonedas de bajo valor. Algunos proyectos de criptomonedas centralizadas hacen mucha publicidad y ofrecen tokens gratuitos como regalo. Hay que tener mucho cuidado con estas ofertas, ya que o bien el token no tiene valor alguno, o bien el regalo simplemente se utiliza para llamar la atención y promover el trading, el juego y otras estafas. Aunque estas ofertas no siempre son fraudulentas, ilegales o engañosas, se debe mantener la vigilancia.
En Twitter, por ejemplo, los bots pueden hacerse pasar por personalidades famosas y ofrecer ofertas increíbles para engañar a la gente. Estas cuentas utilizan el mismo nombre y foto de perfil que la personalidad en cuestión, y pueden engañar a los usuarios menos informados. Siempre asegúrate de verificar la legitimidad de la cuenta antes de interactuar con ella.
También es importante tener cuidado con los enlaces enviados por correo electrónico. Siempre verifica el enlace antes de hacer clic en él y presta atención a la identidad del remitente.

Por último, aquí tienes algunos consejos para evitar estafas en línea:
...
- En caso de duda, no actúes de inmediato. Tómate el tiempo para pensar y hacer investigaciones. El FOMO (Fear Of Missing Out, miedo a perderse algo) puede ser tu peor enemigo.
  Recuerda siempre hacer tus propias investigaciones antes de tomar una decisión de inversión.
...
- Siempre actualizar tus software,
...
Un consejo adicional: considera comprar un disco duro externo y realiza una copia de seguridad completa de tus archivos importantes. Esto podría ser valioso en caso de fallo de tu computadora.

Un administrador de contraseñas es un software que almacena y administra tus contraseñas. Te ayuda a no usar la misma contraseña dos veces, a elegir contraseñas complejas y seguras, y facilita tu gestión de la seguridad en línea. Solo necesitas recordar una contraseña maestra. Es una herramienta gratuita de la que todos deberían aprovecharse. Puedes comenzar a usarlo gradualmente y una vez que te acostumbres, lo encontrarás extremadamente práctico y fácil de usar.

![administrador de contraseñas](assets/prerequis/12.JPG)

La autenticación de dos factores (2FA) proporciona una capa adicional de seguridad a sus cuentas más sensibles, ya sean plataformas de criptomonedas, cuentas de Google/Correo electrónico, bancos o sitios de compras en línea. Se requiere una segunda identificación, generalmente un código de 6 dígitos accesible desde su teléfono, para iniciar sesión. No olvide guardar una copia de seguridad de la clave en algún lugar en caso de pérdida de su teléfono.

![gestionaire de mdp](assets/prerequis/3.JPG)
![gestionaire de mdp](assets/prerequis/4.JPG)

Una VPN, o red privada virtual, protege su privacidad al ocultar su dirección IP. Si bien esto no lo hace completamente anónimo, sigue siendo un paso sencillo y efectivo para mejorar su privacidad en línea. Elegir una VPN, descargarla y usarla es un proceso fácil de configurar.

El anonimato en línea es esencial para una sociedad libre y próspera. Permite la libertad de expresión, la protección de los testigos y la innovación. La privacidad es un derecho humano fundamental. Para seguir protegiendo su privacidad, considere utilizar:
...
Una vez más, si este tema le interesa, el curso SECU 101 está disponible para acompañarlo.
...
- Gestionar adecuadamente su clave privada.
...
Es fácil cometer errores en la industria de Bitcoin, y cada error puede ser costoso. Compartiendo algunos de los obstáculos que he encontrado en mi trayectoria como inversor, así como los que he observado en otros, espero proporcionar consejos valiosos para navegar en este espacio. Algunos de estos errores incluyen:
...
Cada persona es diferente y debe adaptar su estrategia de inversión a su situación financiera personal. Aquí hay algunas buenas y malas prácticas:

- Comprar de forma periódica es una buena práctica.
...
En caso de duda: comienza por informarte. Explora el mundo de Bitcoin durante unas horas (tienes muchas recursos disponibles en esta plataforma). Lee 2 o 3 libros. Compra 5 euros para probar. Mira documentales y videos. Mantén la mente abierta.
...
- Es fundamental ser extremadamente cauteloso en cuanto a la fiscalidad: Cada país tiene sus propias leyes con respecto a los Bitcoins. Es esencial informarse sobre la legislación vigente en su país, especialmente en lo que respecta a las obligaciones fiscales. Una mala planificación podría llevarle a tener que devolver más dinero a la administración fiscal de lo que ha ganado.
...
Como recordatorio, la clave privada es una lista de 24 palabras que representa la copia de seguridad de tus Bitcoins. Es esencial ser extremadamente cuidadoso al respecto. Cuando almacenas tus Bitcoins en una plataforma de intercambio, es la plataforma la que tiene el control, ¡no tú! Esta situación conlleva riesgos como la quiebra de la plataforma, la confiscación de tus Bitcoins o el pirateo de la plataforma.
...
¿Por qué la importancia de Bitcoin es tan crucial? Esta es la pregunta central de esta universidad. Ya sea en relación con tus estudios o tu estrategia de inversión, sin una comprensión clara de la importancia de Bitcoin, corres el riesgo de desviarte de tu plan de acción. Por lo tanto, el objetivo es siempre tener en cuenta los fundamentos de Bitcoin para asegurarse de que tu estrategia se mantenga en línea con tus convicciones.
...
![en pocas palabras](assets/section2/1.JPG)
...
Nunca habrá más de 21 millones de bitcoins y ningún político, banquero u otra persona malintencionada podrá cambiar eso. Este límite fue establecido en el protocolo de Bitcoin por Satoshi y no se puede cambiar hoy en día. Esto fija la tasa de inflación de Bitcoin para los próximos 100 años.
...
Bitcoin, por otro lado, es un sistema abierto e incorruptible. Las reglas son fijas y las mismas para todos. La famosa frase "No es tu clave, no son tus Bitcoins" destaca la importancia de poseer la clave privada de una billetera de Bitcoin. Al tener la clave privada, tienes control total sobre los Bitcoins que contiene. Si no tienes esta clave, significa que alguien más tiene tus Bitcoins por ti. En este caso, tus Bitcoins están expuestos a riesgos similares a los asociados con un banco tradicional.
...
## Comprendiendo la industria de Bitcoin
...
En esta sección, trataremos de hacer un rápido recorrido por los actores para comprender mejor cómo funciona la industria en la que buscamos ingresar.

Cualquiera puede diseñar su propia criptomoneda, una tarea que solo lleva unos minutos. Sin embargo, el valor de este token será exclusivamente determinado por el mercado. En diciembre de 2019, se enumeraron más de 5000 tokens en Coinmarketcap. Hoy, en 2023, ese número ha aumentado a más de 23,000, con NFT, DeFi y muchas otras cosas. Estos tokens criptográficos pueden tomar diferentes formas: moneda, título de seguridad, combustible para un ecosistema, sidechain, arte digital, etc.
Es crucial entender que el 99,8% de estas nuevas "criptomonedas" son estafas creadas por vendedores con el objetivo de robar tus bitcoins. Sin embargo, entre el escaso 0,2% de proyectos serios, se está haciendo un esfuerzo considerable para avanzar, experimentar y desarrollar tecnologías innovadoras que puedan brindar numerosas ventajas a los usuarios. Con el tiempo, el sector mejorará y surgirán empresas legítimas que ofrezcan productos reales. La pregunta de si esto sucederá en otras blockchains aparte de Bitcoin sigue en pie. Por ahora, una cosa es segura: Bitcoin es la única criptomoneda verdaderamente descentralizada, resistente a la censura, libre y lo suficientemente seria como para justificar miles de horas de trabajo.
...
**Precaución**: El "Gran Hermano" te está vigilando, supuestamente para tu seguridad, por supuesto. Sus datos pueden ser utilizados por su gobierno para rastrear sus actividades.

En el espectro de las plataformas de intercambio, se pueden distinguir 5 tipos principales:
...
Si bien comenzó de manera individual, los mineros de hoy en día suelen ser grandes empresas bien financiadas que compiten en un sector muy difícil. Buscan fuentes de energía baratas para obtener una ventaja competitiva. Pueden ser públicas o anónimas y pueden estar ubicadas en cualquier parte del mundo.
...
La minería es un campo en sí mismo, por lo que si estás interesado en el tema de la energía, estarás satisfecho.
...
Cualquiera puede comenzar a contribuir al código, pero es importante tener en cuenta que modificar realmente el código de Bitcoin es un proceso largo y complejo. Además, muchos desarrolladores de Bitcoin son entusiastas que dedican muchos años a desarrollar BIP (Bitcoin Improvement Proposals) que podrían nunca ser utilizados. Por lo tanto, es una industria compleja y a veces impredecible. Exploraremos estos aspectos en detalle.
...
BTC se puede considerar como una carretera por la que circulas. Cuando necesitas reparar tu coche, llenar el tanque o comprar comida, te ves obligado a abandonar esta carretera de BTC y volver al antiguo sistema financiero para tus necesidades.
...
Ahora que hemos repasado los conceptos básicos y aprendido cómo evitar estafas y pérdidas de dinero, podemos elaborar nuestro plan. El plan será bastante simple al principio, pero es importante comenzar. Siempre puedes modificarlo a medida que pasa el tiempo.
...
Con eso, deberías encontrar lo que necesitas, elegir el plan adecuado y seguir el tutorial correcto en la siguiente sección.
...
- Un intercambio grande y eficiente como Bitstamp, Binance, Kraken
...
Para este usuario, probablemente será necesario tener dos tipos de carteras:

- Una cartera fría para almacenar los bitcoins a largo plazo de forma segura.
- Una cartera caliente para enviar y recibir bitcoins regularmente para uso diario.

Este tipo de perfil probablemente optará por una cartera basada en la Lightning Network para transacciones comunes, así como una cartera de hardware para la conservación a largo plazo.
...
- Brindar a tus seres queridos la oportunidad de mantener los activos de manera segura, si así lo desean.
...
- No posee contratos inteligentes, ni Lightning Network (LN), ni alt-coins.
...
Es necesario designar a dos personas que ayudarán a su familia cuando usted ya no esté. De esta manera, sus seres queridos contarán con un usuario de Bitcoin de confianza, actualizado tecnológicamente, en quien podrán apoyarse durante el proceso de recuperación. Estas personas podrán:

- Brindar asesoramiento sobre la gestión de claves y billeteras.
- Ayudar a comprender cómo recuperar sus frases secretas (seeds) de manera segura.
...
| Ricco (amigo de cripto) | Medio     | Muy alto            | Twitter, correo y foto   | Confía en él para preguntas técnicas. Nunca con dinero. Deberás contactarlo.   |
...
La carta debe ser clara y útil. No es un testamento, ni una carta para hacerlos llorar. Tampoco es una carta para obligarlos a no vender nunca, ni una carta para escribir las claves privadas. Es una carta para ayudarles a entender lo que has hecho, para que puedan tomar la mejor decisión y actuar de forma segura.

Aquí tienes un extracto de la plantilla de carta a un ser querido, tomada del Apéndice E del libro de Pamela Morgan, "Cryptoasset Inheritance Planning". Para adaptarla a nuestro ejemplo, he modificado algunas partes, que he colocado entre paréntesis y marcadas en azul. El resto del texto es el texto original del libro. (Traducido por Découvre Bitcoin)

![pamela morgan](assets/heritage/0.JPG)

"Fecha: 26/06/2020
Queridas Liz y Maia,
Os quiero profundamente y sé que seréis fuertes.
Escribo esta carta para informaros de que poseo criptoactivos que podrían tener valor.
Por favor, leed esta carta atentamente y en su totalidad antes de tomar cualquier acción. Estos activos son diferentes de otros activos, ya que una vez transferidos, no hay forma de recuperarlos."

A continuación, incluimos la "sección de asesores". Esta parte puede resultar confusa para tus herederos, especialmente si mencionas personas u organizaciones que no conocen. Sé preciso sobre:
...
"A continuación se muestra una lista de personas en las que confío para responder a vuestras preguntas y ayudaros en el proceso de descubrimiento y transferencia de estos activos. Contactad a las personas indicadas, pero no confiéis en una sola persona para gestionar el proceso. Sed cautelosos con todos los asesores, incluidos los que aparecen en esta lista. Todo el mundo puede cometer errores, así que aseguraos de entender lo que están haciendo lo mejor que podáis y no tengáis miedo de hacer preguntas y verificar las respuestas por vosotros mismos.

Aquí están las personas que pueden ayudaros a responder preguntas y guiaros en este proceso:
...
- "J'ai également utilisé mon ordinateur de bureau (MacBook Pro) pour accéder à différentes plateformes d'échange, applications, jeux et sites web liés aux bitcoins. Les identifiants et mots de passe associés à ces comptes sont stockés dans un gestionnaire de mots de passe sécurisé sur mon ordinateur et une copie est également conservée chez mon cousin Nathan."

- "En ce qui concerne les portefeuilles physiques, j'en possède plusieurs. J'ai un portefeuille matériel Ledger Nano S que je garde dans un coffre-fort à la maison. J'ai également un portefeuille matériel Trezor Model T que j'ai confié à mon frère Bob pour qu'il le conserve en toute sécurité."

- "Enfin, j'ai mis en place une phrase secrète (passphrase) pour renforcer la sécurité de mes portefeuilles. Cette phrase secrète est écrite sur un morceau de papier que j'ai caché dans un endroit sûr à la maison."

- "En ce qui concerne la fonctionnalité multisig, je n'ai pas encore mis en place cette option pour mes bitcoins."

Veuillez noter que les informations fournies ci-dessus sont fictives et ne doivent pas être utilisées comme de véritables informations personnelles.

- Utilizo mi ordenador Dell 2018 para acceder a una plataforma de intercambio en línea llamada Bitstamp. Es posible que todavía tenga bitcoins o dólares en esta plataforma. Para acceder a mi cuenta, deberán contactar directamente con ellos o iniciar sesión en mi cuenta (ten en cuenta que esto puede ser ilegal, verifica la legislación local).
- He utilizado un gestor de contraseñas para acceder a ella, y encontrarán mi copia de seguridad en la caja fuerte del banco. La cuenta también está protegida por una autenticación de dos factores, a la que se puede acceder a través de mi teléfono (Samsung Galaxy S8) o utilizando el código de respaldo almacenado en casa.
- También tengo BTC en un dispositivo Trezor Model One. Accedo a él a través de mi PC y el sitio web Trezor.io. Las claves privadas de respaldo se almacenan en la caja fuerte del banco y en casa del tío Bob. El código PIN se guarda en casa y en casa de mi madre. El dispositivo en sí probablemente esté en una caja fuerte en mi oficina.
- Utilizo una frase secreta de seguridad avanzada para mi dispositivo Trezor. La copia de seguridad de esta frase secreta se encuentra en casa y en casa de mi madre".

Ahora vamos a concluir la carta con alguna información legal si es necesario, así como con palabras amables.

"Por favor, tenga en cuenta: Encontrará una copia de mi testamento, fechado el 17 de abril de 2018, en mi carpeta de documentos. Mi abogado, Dwight Schrute, con sede en Scranton, Pensilvania, también tiene una copia. Tengan cuidado y siempre recuerden mi amor por ustedes". 26/06/2023, Cedric"

Ahora vamos a verificar nuestro trabajo (Según "Cryptoasset Inheritance Planning" de Pamela Morgan, página 44 (traducido por Découvre Bitcoin)):

- Ayuda: Verifique que haya indicado correctamente los nombres, contactos y, si es posible, fotos.
- Dispositivos: Asegúrese de haber enumerado su teléfono, su ordenador, sus monederos físicos y sus monederos de papel.
- Activos: Asegúrese de haber incluido la lista de sus activos.
- Intercambios: Verifique que haya enumerado todos los intercambios que tienen fondos para usted.
- Acceso: Enumere la información que necesitarán para encontrar su lugar de almacenamiento, así como todos los códigos de acceso necesarios.
...
_Planificación de herencia de criptoactivos, una guía sencilla para propietarios, Pamela Morgan, ESQ. Copyright 2018 por Merkle Bloom LLC, Todos los derechos reservados. CC-BY_ Un gran agradecimiento a Pamela Morgan por su valioso trabajo y por permitirme compartirlo. ¡También gracias a todos los que contribuyeron a su escritura!
¡Eres los mejores! :D ¡Mi equipo y mis estudiantes también te agradecen!

# Agradecimientos y sigue profundizando en la madriguera del conejo

## ¡Felicidades! ESTÁS EN EL TOP 0,1%

Si has estado siguiendo nuestro contenido desde el principio, ¡ahora eres un verdadero ciudadano del siglo XXI y uno de los más experimentados en el campo de Bitcoin! Utilizas un administrador de contraseñas y la autenticación de dos factores (2FA). Entiendes qué es Bitcoin y por qué es importante. Posees bitcoins y tienes una forma segura de comprar o ganar más. Has almacenado tus bitcoins en una billetera "fría" y has establecido una gestión adecuada de claves. Has creado un plan de herencia para tus seres queridos. ¡Ahora estás seguro y puedes relajarte! ¡Disfruta de una cerveza y siéntete orgulloso de ti mismo!
...
- Nodo de Bitcoin y Lightning Network: la Lightning Network, como hemos visto varias veces, ofrece una visión completamente diferente de lo que es Bitcoin. A través de esta capa dos, las posibilidades son múltiples y se está construyendo toda una industria sobre ella. Para acompañarte en el descubrimiento, te invito a hacer LN 201 para un curso teórico o LN 202 para un curso práctico. Ambos cursos son accesibles para todos en esta etapa de tu aprendizaje y pueden ayudarte a comprender mejor este nuevo aspecto de Bitcoin.
...
- Solución para comerciantes: por último, si eres más del tipo que realmente quiere usar Bitcoin, puedes ir a nuestra sección de tutoriales y explorar las muchas soluciones para comerciantes. Esto puede ofrecerte oportunidades en nuestro entorno, pero también puede ayudarte a ayudar a tu empresa o amigos a aceptar Bitcoin en su negocio y así impulsar una economía local basada en Bitcoin en tu ciudad.
