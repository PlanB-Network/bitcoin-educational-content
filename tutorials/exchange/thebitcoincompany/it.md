...
A tal proposito, una breve digressione per sottolineare, a mio parere, l’importanza di usare Bitcoin come mezzo di pagamento, e non solo come riserva di valore. Infatti, mentre scrivo queste righe, il riflesso di troppi Bitcoiners, quando hanno la possibilità di spendere i loro preziosi Sats, è quello di astenersi e spendere invece euro o fiat imposti.


Apparentemente questo può sembrare ragionevole, ma mette in dubbio la logica dietro tale scelta. Bitcoin è progettato per essere usato senza permesso. Non è ovvio, quindi, che più attività accettano Bitcoin intorno a te, più scelte hai come Bitcoiner sovrano? In altre parole, più è facile spendere i tuoi Sats senza chiedere permesso, più i tuoi Bitcoin diventano preziosi. Quindi, in questo senso, è necessario incoraggiare l’adozione, favorendo le attività che accettano Bitcoin per dare loro un vantaggio competitivo che spinga altri a seguirne l’esempio.


Anche nell’ottica di preservare il valore dei propri risparmi in Bitcoin, partecipare all’adozione di Bitcoin per rendere più facile spenderlo è almeno altrettanto importante quanto "HODL".
...
In breve, "spendere" & "sostituire" sembrano essere la strada da seguire. Partecipa allo sviluppo dell’adozione, distribuisci satoshi in quante più attività possibile, poi riacquista i Sats spesi il prima possibile.


## Cos’è The Bitcoin Company?


**The Bitcoin Company** è simile al suo concorrente Bitrefill: permette di scambiare bitcoin per gift card di negozi. Grazie a questo tipo di soluzione puoi praticamente vivere con un "Bitcoin standard", creando un semplice account.
...
Troverai un’ampia selezione di rivenditori, a seconda del paese in cui vuoi fare shopping.
...
Per farlo, visita [il loro sito](https://thebitcoincompany.com/).
...
Ora puoi vedere il tuo *Username*, che è un numero casuale e sarà diverso per ogni sito visitato che supporta questo metodo di autenticazione. In basso viene specificato il metodo di autenticazione: LNURL Auth.
...
Clicca su "generate Invoice"(“generare fattura”).


![TheBitcoinCompany](assets/fr/15.webp)


Paga la fattura scegliendo On-Chain o Lightning.
...
Ed ecco fatto: ora sai come spendere i tuoi bitcoin senza KYC nei principali negozi per le spese quotidiane. Non è un metodo perfetto, ancora molto "fai-da-te", ma finché pochi commercianti realizzeranno che accettare denaro elettronico è nel loro interesse, resta molto utile...


Se vuoi aiutare a diffondere Bitcoin e incoraggiare un commerciante indipendente ad adottare questo metodo di pagamento, dai un’occhiata al nostro tutorial completo su Swiss Bitcoin Pay. È una soluzione tutto-in-uno per POS in BTC, facile da installare e gestire quotidianamente:
