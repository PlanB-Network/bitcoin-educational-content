---
name: Breez
description: Wallet ya Lightning inayokupa udhibiti kamili wa sarafu zako.
---

![breez-cover](assets/cover.webp)

Wallet za kujihifadhi (self-custodial) zinakuwa chaguo salama zaidi la kuhifadhi bitcoins zako huku ukifaidika na nguvu na faida za mtandao wa Lightning wa Bitcoin. Breez, kupitia mbinu yake, inajitokeza kwa kipekee kati ya pochi hizi.

## Breez ni nini?

Breez ni Wallet ya kujihifadhi iliyoundwa na kampuni ya Breez inayokupa udhibiti kamili wa bitcoins zako na inakupa vipengele vya ubunifu vyote ndani ya programu moja. Unaweza kupakua pochi ya Breez kwenye Android na iOS kutoka kwa majukwaa rasmi ya upakuaji. Katika mafunzo haya, tutafanya utangulizi wa programu kwenye jukwaa la Android. Mchakato wote ulioelezwa hapa chini pia unatumika kwa iOS.
...
## Utangulizi wa Wallet 

Breez inakupa uwezo wa kuunda wallet mpya au kurejesha Wallet ya Lightning ambayo tayari unamiliki. Katika mafunzo haya tutaunda Wallet mpya.
...
Breez inatanguliza urahisi wa matumizi katika programu yake. Kupokea bitcoins zako za kwanza na Wallet hii ni rahisi sana. Kwenye ukurasa wa mwanzo, bonyeza **Pokea**, kisha chagua njia unayotaka kupokea bitcoins zako. Breez inakupa chaguzi tatu:

- **Pokea kupitia invoice ya Lightning au ID**: Tengeneza ankara na upokee malipo.
- **Pokea kupitia Address ya Bitcoin**: Pokea bitcoins kupitia miamala kwenye mtandao mkuu wa Bitcoin.
...
Weka maelezo kwa ajili ya invoice yako, kisha ingiza kiasi unachotaka kupokea.

⚠️ Kwa muamala wa kwanza kwenye Breez, utalazimika kulipa ada ya kufungua na kudumisha njia ya malipo ya kiasi cha **2500 satoshis**. Tofauti na wallet nyingi za Lightning, Breez inakupa miundombinu kamili ya node ya Lightning inayokupa uhuru wa kusimamia bitcoins zako. Utalazimika kufungua njia zako za malipo mwenyewe na uhuru wa kuwasiliana moja kwa moja na node ya Lightning kutoka ndani ya programu.
...
- **Tuma kwa Address ya BTC**: Fanya miamala kwenye mtandao mkuu wa Bitcoin.
...
### Sifa Maalum za Wallet Hii

Zaidi ya kuwa Wallet rahisi ya kuhifadhi bitcoins zako, Breez ni mfumo wa kiubunifu. Unapata huduma muhimu moja kwa moja ndani ya programu.
...
- Point of Sale (POS): Breez inafaa kabisa kwa biashara yako na inakuwezesha kuwa na Point of Sale ndani ya programu. Unaweza kudumisha hesabu ya duka lako, kupokea malipo kutoka kwa wateja wako na kutengeneza ankara za kuchapisha kwa kila ununuzi uliofanywa. Zaidi ya hayo, unaweza kupata sarafu zako za ndani kati ya sarafu nyingi zinazoungwa mkono na Breez.

Unaweza kubinafsisha sarafu zako katika menyu Preferences > Fiat Currencies.

![custom-fiat](assets/fr/13.webp)

Katika menyu **point of sale (POS)**, unaweza kusanidi bidhaa unazouza katika biashara yako.
...
Breez inafanya uhuru wako kuwa nguvu yake. Miundombinu ya Breez, inakupa node inayofanya kazi ambayo unaweza kuingiliana nayo kutoka ndani ya programu (chaguo **Watengenezaji**). Pia una uhuru wa kubinafsisha usanidi wa msingi iwe ni juu ya:

- Muunganisho wa node ya Bitcoin/Lightning: Menyu Preferences > Network.
