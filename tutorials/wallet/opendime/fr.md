...
Vous devez donc déposer un ou plusieurs fichiers directement à la racine du périphérique, jusqu’à atteindre au minimum 256 kB de données provenant de vous. Par exemple, dans mon cas, j’ai déposé 2 images.

Dès que le volume de données dépasse 256 kB, l’OPENDIME génère automatiquement sa clé privée et supprime les données d’entropie que vous avez fournies.
