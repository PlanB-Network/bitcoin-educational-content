...
本指南專注於「Bisq Easy」，這是目前唯一可用的協議。Bisq Easy 專為新的比特幣使用者設計。此協議允許使用者在去中心化的點對點平台上以法定貨幣買賣比特幣。交易限額為 600 美元（最低 6 美元），交易安全性取決於 BTC 賣家的信譽。Bisq Easy 無需交易手續費或保證金要求。預計 Bisq Easy 將取代 Bisq 1，用於低於 600 美元（或等值）的法幣交易。
