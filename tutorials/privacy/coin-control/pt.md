...
A robustez do protocolo Bitcoin é assegurada por conceitos simples e fundamentais. Entre eles, destaca-se a transparência: todas as transacções Bitcoin são públicas e facilmente verificáveis por qualquer pessoa. Embora esta caraterística seja uma pedra angular do protocolo porque evita fraudes e garante a genuinidade dos fundos, também pode representar um desafio para a confidencialidade. **Já se perguntou se tanta transparência pode afetar a sua privacidade?
...
A pergunta que podemos fazer a nós próprios é a seguinte: **por que fazer tudo isto?** Existem, ou poderiam existir, várias razões para não utilizarmos o `UTXO1` **e todas elas estão subjacentes à razão pela qual - na fase de despesas - ativar o manual de controlo Coin é uma das melhores práticas a seguir**.
...
**Os fundos do Kyc conduziriam inevitavelmente ao rastreio da identidade do pagador. Se fosse o seu Wallet, gostaria que um observador externo pudesse identificar a sua identidade com uma certeza tão absoluta?
