...
#### 1.2.3. Instal Node.js dan npm melalui NVM
...
### 1.3. Cara Memasang Pir di Windows


Menginstal Pears di Windows sama mudahnya dengan di Linux, tetapi membutuhkan beberapa alat khusus.


*Jika Anda menggunakan Linux dan telah menginstal Pears, Anda dapat langsung melompat ke **Langkah 2**.*


#### 1.3.1. Buka PowerShell sebagai Administrator
...
#### 1.3.6. Verifikasi dan Inisialisasi Pir
...
### 1.4. Cara Memasang Pir di macOS
...
*Jika Anda menggunakan Linux atau Windows dan telah menginstal Pears, Anda dapat langsung melompat ke **Langkah 2**.*


#### 1.4.1. Periksa Prasyarat Sistem
...
Setelah instalasi, cukup jalankan perintah berikut ini di terminal Anda:
...
## 2. Cara Menggunakan Plan ₿ Academy on Pears
...
## 3. Bagaimana Cara Merencanakan Paket seed ₿ Akademi di Pir


Dalam jaringan Pears, untuk *seed* sebuah aplikasi berarti mendistribusikannya ke rekan-rekan lain dari komputer Anda sendiri. Dalam praktiknya, ketika Anda menggunakan Paket seed ₿ Academy, komputer Anda menjadi sumber data yang memungkinkan pengguna lain mengunduh aplikasi tanpa bergantung pada server pusat.
...
Terima kasih telah berkontribusi dalam distribusi Plan ₿ Academy on Pears yang terdesentralisasi dan membantu membuat pendidikan Bitcoin benar-benar tahan sensor!