...
本指南专注于“Bisq Easy”，这是目前唯一可用的协议。Bisq Easy 专为新的比特币用户设计。该协议允许用户在去中心化的点对点平台上用法定货币购买和出售比特币。交易限额为 600 美元（最低 6 美元），交易安全依赖于 BTC 卖家的信誉。Bisq Easy 无需交易手续费或保证金要求。预计 Bisq Easy 将取代 Bisq 1，用于 600 美元（或等值）以下的法币交易。
