...
definition: Introducción de las carteras HD (jerárquicas deterministas) que permiten generar todas las claves de una cartera a partir de una única semilla.
---
