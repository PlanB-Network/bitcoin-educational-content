...
Далее мы обсудим работу алгоритмов цифровой подписи, которые вы используете каждый день для защиты ваших UTXO. Биткойн использует два: [ECDSA](https://planb.academy/resources/glossary/ecdsa) и протокол Schnorr. Вы узнаете, какие математические примитивы лежат в основе этих алгоритмов и как они обеспечивают безопасность транзакций.
...
| *public key*    | [Публичный ключ](https://planb.academy/resources/glossary/public-key) (используется для получения средств, выводится из приватного ключа).                 |
...
| *Entropy*       | [Энтропия](https://planb.academy/resources/glossary/entropy) (мера случайности, используемая для генерации сидов кошелька).                             |
...
- $k$ - [личный ключ](https://planb.academy/resources/glossary/private-key) пользователя;
- $e$ - хеш сообщения;
