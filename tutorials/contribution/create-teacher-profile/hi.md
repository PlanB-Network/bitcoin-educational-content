---
name: प्रोफेसर Plan ₿ Academy
description: Plan ₿ Academy पर अपने शिक्षक प्रोफाइल को जोड़ने या संशोधित करने के लिए, आपको सबसे पहले अपने अकाउंट में लॉगिन करना होगा। लॉगिन करने के बाद, प्रोफाइल सेक्शन में जाएं। वहां आपको 'एडिट प्रोफाइल' या 'प्रोफाइल जोड़ें' का विकल्प मिलेगा। उस पर क्लिक करें और अपनी जानकारी जैसे नाम, विषय, अनुभव आदि को अपडेट या जोड़ें। सभी जानकारी सही से भरने के बाद 'सेव' बटन पर क्लिक करें। आपका प्रोफाइल अपडेट हो जाएगा।
---
![cover](assets/cover.webp)

यदि आप Plan ₿ Academy में एक नया ट्यूटोरियल या कोर्स लिखकर योगदान करने की योजना बना रहे हैं, तो आपको एक शिक्षक प्रोफ़ाइल की आवश्यकता होगी। यह प्रोफ़ाइल आपको उस सामग्री के लिए उचित क्रेडिट प्राप्त करने में सक्षम बनाएगी जो आप इस प्लेटफ़ॉर्म पर योगदान करते हैं।

जो लोग पहले से ही Plan ₿ Academy पर शैक्षिक सामग्री बनाने में शामिल हैं, उनके पास शायद पहले से ही एक शिक्षक प्रोफ़ाइल होगी। आप इसे हमारे GitHub रिपॉजिटरी के `/professors` फोल्डर में पा सकते हैं। अगर आपकी प्रोफ़ाइल पहले से मौजूद है, तो अपना लॉगिन `professor.yml` फाइल में देखें।
...
Plan ₿ Academy पर अपना शिक्षक प्रोफाइल बनाने का सबसे आसान तरीका है हमारे इंटीग्रेटेड पायथन टूल का उपयोग करना। यह ऐसे काम करता है।
...
होम पेज पर पहुँचने के बाद, अपने रिपॉजिटरी क्लोन का लोकल पथ, जिस भाषा में आप लिख रहे हैं, और अपना GitHub ID दर्ज करें। अगर आप यह प्रोफाइल किसी और के लिए बना रहे हैं और आपके पास पहले से एक प्रोफेसर की प्रोफाइल है, तो "*Plan ₿ Academy Professor's ID*" फील्ड में अपनी ID दर्ज करें। अगर आप अपनी खुद की प्रोफाइल बना रहे हैं, तो आपके पास अभी प्रोफेसर की ID नहीं होगी, क्योंकि आप इसे बनाने की प्रक्रिया में हैं, इसलिए इस फील्ड को खाली छोड़ दें।
...
अगर आपके पास पहले से Plan ₿ Academy रिपॉजिटरी से Fork नहीं है, तो GitHub आपको एक बनाने का सुझाव देगा। "*इस रिपॉजिटरी को Fork करें*" पर क्लिक करें।
...
पुल रिक्वेस्ट एक अनुरोध होता है जिसमें आप अपनी शाखा से किए गए बदलावों को Plan ₿ Academy रिपॉजिटरी की मुख्य शाखा में जोड़ने के लिए कहते हैं। इससे पहले कि ये बदलाव जोड़े जाएं, उनकी समीक्षा और चर्चा की जा सकती है।

![Image](assets/fr/10.webp)

सुनिश्चित करें कि Interface के शीर्ष पर, आपकी कार्यशील शाखा Plan ₿ Academy रिपॉजिटरी की `dev` शाखा (जो मुख्य शाखा है) के साथ मर्ज की गई हो।
...
आपका PR अब मुख्य Plan ₿ Academy रिपॉजिटरी के "*Pull Request*" टैब में दिखाई देगा। अब आपको बस एक प्रशासक के आपके संशोधन को मर्ज करने का इंतजार करना है।
