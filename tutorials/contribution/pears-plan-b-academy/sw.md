...
- Linux (Debian)** → Sehemu **1.2**
- Windows** → Sehemu **1.3**
- macOS** → Sehemu **1.4**


### 1.2. Jinsi ya kufunga Pears kwenye Linux (Debian)?
...
#### 1.2.3. Sakinisha Node.js na npm kupitia NVM
...
#### 1.2.4. Sakinisha Pears na npm


Mara tu *npm* inapopatikana, unaweza kusakinisha Pears CLI duniani kote kwenye mfumo wako. Hii hukuruhusu kuendesha amri ya `pear` kutoka saraka yoyote.
...
Mara tu upakuaji utakapokamilika, endesha amri tena ili kuthibitisha kila kitu kinafanya kazi:
...
### 1.3. Jinsi ya kufunga Pears kwenye Windows


Kusakinisha Pears kwenye Windows ni rahisi tu kama kwenye Linux lakini inahitaji zana mahususi.


*Ikiwa unatumia Linux na tayari umesakinisha Pears, unaweza kuruka moja kwa moja hadi **Hatua ya 2**.*


#### 1.3.1. Fungua PowerShell kama Msimamizi
...
#### 1.3.6. Thibitisha na Anzisha Pears
...
Mfumo wako wa Windows sasa uko tayari kuendesha na kukaribisha programu-tumizi za rika-kwa-rika na Pears.


### 1.4. Jinsi ya kufunga Pears kwenye macOS
...
*Ikiwa unatumia Linux au Windows na tayari umesakinisha Pears, unaweza kuruka moja kwa moja hadi **Hatua ya 2**.*


#### 1.4.1. Angalia Mahitaji ya Mfumo
...
Pears inasambazwa kupitia *npm*, kidhibiti kifurushi cha *Node.js*. Ingawa Pears haitegemei moja kwa moja *Node.js* kufanya kazi, inahitajika ili kusakinisha. Njia inayopendekezwa ya kusakinisha *Node.js* kwenye macOS ni *NVM* (*Kidhibiti cha Toleo la Nodi*), ambayo hukuruhusu kudhibiti matoleo mengi ya Node kwa wakati mmoja.
...
#### 1.4.3. Sakinisha Node.js na npm
...
Mfumo wako wa macOS sasa uko tayari kufanya kazi na kukaribisha programu-tumizi za rika-kwa-rika na Pears.


## 2. Jinsi ya Kutumia Mpango ₿ Academy on Pears
...
## 3. Jinsi ya Kupanga seed ₿ Chuo cha Pears
...
Utaratibu huu huimarisha uthabiti na upinzani wa udhibiti wa programu yetu kwenye mtandao wa Pears. Kadri seed inavyozidi kuwa na programu, ndivyo inavyopatikana zaidi na kugatuliwa, hata kama baadhi ya nodi asili zitatoka nje ya mtandao.
