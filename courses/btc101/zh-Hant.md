...
在「Bitcoin」一詞成為數位貨幣和金融變革的代名詞之前，一系列的想法、創新和社會運動為它的出現奠定了基礎。其中，[密碼龐克](https://planb.academy/resources/glossary/cypherpunks)（Cypherpunk）運動是比特幣誕生前的重要關鍵之一。

### Cypherpunks：數位世界的遠見者

![image](assets/zh-Hant/003.webp)

在 1980 和 1990 年代科技演進的核心時期，有一群人開始深刻質疑隱私和自由在數位時代的角色。這些人後來被稱為「密碼龐克（Cypherpunk）」，他們堅信[密碼學](https://planb.academy/resources/glossary/cryptography)可以作為一種工具，保護個人權利免受政府和大企業的干擾。
...
在比特幣出現之前，已經有人嘗試創造數位貨幣。例如，David Chaum 在 20 世紀 80 年代推出 「[DigiCash](https://planb.academy/resources/glossary/ecash-david-chaum)」 項目，提出「匿名電子貨幣」的概念。不幸的是，由於各種限制，DigiCash 最終未能成功推廣。

另一個重要的先驅是 Wei Dai 的「[B-money](https://planb.academy/resources/glossary/bmoney)」。儘管 B-money 從未真正實施，但它提出了匿名數位貨幣的構想，在這種貨幣中，欺詐檢測由評估者社群而非中央機構執行。

下方的圖片清楚展示了該運動的發展歷程及其眾多技術創新。

![image](assets/zh-Hant/005.webp)

正是在這樣充滿創新與思想碰撞的環境中，神秘的[中本聰](https://planb.academy/resources/glossary/nakamoto-satoshi)（Satoshi Nakamoto）才在 2008 年發表了《[比特幣白皮書](https://planb.academy/resources/glossary/white-paper)》。在這份白皮書中，他結合了幾個來自 cypherpunk 運動的想法，例如[工作量證明](https://planb.academy/resources/glossary/proof-of-work)（proof of work）和[加密時間戳](https://planb.academy/resources/glossary/timestamp)（Cryptographic Timestamps），創造一種[去中心化](https://planb.academy/resources/glossary/distributed)且可抗審查的數位貨幣。
...
貨幣在我們的世界中的功能是很難被人為複製的。事實上，任何個人或團體都無法創造貨幣，因為貨幣是一種自然現象，必須從市場和自願[共識](https://planb.academy/resources/glossary/consensus)中產生。在這個過程中，價格扮演訊號與資訊的角色，指引社會如何有效配置資源。
...
相反地，國家發行的[法定貨幣](https://planb.academy/resources/glossary/fiat)（Fiat）雖然很容易使用，但卻受到掌控它們的機構（國王、中央銀行、皇帝、獨裁者）不斷貶值。
...
- **[可替代性](https://planb.academy/resources/glossary/fungibility)**，意指可與其他同類單位互換而不會失去價值；
...
- 原石 -> 硬幣
- 鈔票 -> 銀行卡
- [區塊鏈](https://planb.academy/resources/glossary/blockchain) -> [閃電網路](https://planb.academy/resources/glossary/lightning-network)（Lightning Network）

時至今日，貨幣仍在不斷演變，以適應不同的應用場景。正如我們所說，黃金雖然是絕佳的價值儲存工具，但已不再適用於當前的全球化經濟。同樣地，美元和歐元等法定貨幣的流動性很高，也很容易運輸，因為它們現在大多數都是數位化的，但它們的價值卻因貨幣[通貨膨脹](https://planb.academy/resources/glossary/inflation)而不斷降低。

另一方面，比特幣開啟了新的前景。其特性，尤其是嚴格受限的供給量，使其成為一種極佳的價值儲存手段。此外，作為一種中立的網際網路貨幣，它構成了一種可行的**交換媒介**，能夠跨越國界。然而，儘管其採用程度持續提升（如 [BTCmap 地圖](https://btcmap.org/map) 所示），但目前在商業中仍未被廣泛接受。
...
事實上，比特幣提出了一個去中心化的解決方案和一個新的平行貨幣系統，以此作為對這些系統性問題的回應。從歷史上看，如果黃金因其抗偽造性而被青睞作為貨幣，那麼比特幣也同樣無法被偽造。此外，由於其去中心化和加密的特點，比特幣的發行量被限制在 [2100 萬枚](https://planb.academy/resources/glossary/limite-demission)。比特幣是一種依賴於透明度和中立性的貨幣，為當前的集中式貨幣體系提供了一個有吸引力的替代方案。
...
新比特幣的產生是[挖礦](https://planb.academy/resources/glossary/mining)過程的結果。簡單來說，礦工使用功能高效能電腦解決複雜的數學問題，這些問題會驗證交易並確保交易安全。一旦一個問題被解決，礦工就會在[區塊](https://planb.academy/resources/glossary/block)鏈上添加一個新的交易區塊，區塊鏈是一個去中心化的分散式帳本，記錄了網絡上的所有交易。區塊鏈可確保透明度和安全性，因為每個區塊都與之前的區塊相連，因此在未取得網路共識的情況下，幾乎不可能更改過去的資料。
...
| 減半次數 | 區塊高度 | 減半後的 BTC 獎勵  |  減半後流通中的 BTC 估計量 |
| -------------- | ------------ | ------------------------- | ------------------------------------------ |
...
2100 萬的上限是比特幣稀缺性的基礎，由兩個關鍵機制保證：[挖礦難度的調整](https://planb.academy/resources/glossary/difficulty-adjustment)和博弈論。


- 挖礦難度調整是每 2016 個區塊，也就是大約兩個星期進行一次，以確保平均每十分鐘就有一個新區塊加入到區塊鏈中。區塊產生頻率和比特幣總供應量都是比特幣協議的固定參數，無法像傳統貨幣那樣受到任意操控，除非獲得整個網絡的共識。

挖掘有效[雜湊](https://planb.academy/resources/glossary/hash-function)（Valid Hash） 的難度遵循一種週期性變化的機制：如果礦工數量增加，這意味著他們找到的區塊數量也會增加，從而導致找到一個區塊的平均時間減少。因此，難度也會增加。因此，礦工找到的區塊數量會減少，這意味著該機制回到平均每個區塊 10 分鐘的水平。請參閱下圖，以獲得直觀顯示。

![image](assets/zh-Hant/023.webp)

您是否知道，礦工挖出一個區塊的動機，是為了透過[區塊補貼](https://planb.academy/resources/glossary/block-subsidy)賺取新比特幣，還能從區塊內的[交易手續費](https://planb.academy/resources/glossary/transaction-fees)中獲得額外收入？
...
事實上，任何人都可以透過比特幣[節點](https://planb.academy/resources/glossary/node)（即交易驗證器）來查詢比特幣的供應量，只需輸入以下命令即可：`bitcoin-cli gettxoutsetinfo`.這種透明度增強了人們對比特幣系統的信任，比特幣系統不是基於中央機構或個人，而是建立在數學與密碼學的保證之上（您將在 LNP 201 中學習如何輕鬆地做到這一點）。
...
在第 2 節中，我們將探討比特幣的儲存與安全性，並透過[錢包](https://planb.academy/resources/glossary/wallet)來理解這些知名的比特幣究竟存放在哪裡，以及我們該如何與它們互動！
...
比特幣錢包的形式多種多樣：電腦上的軟體、手機應用、USB 隨身碟等實體裝置，甚至是一張寫有[私鑰](https://planb.academy/resources/glossary/private-key)的紙張。每一種都有不同的用途。事實上，有些是為大額交易而設計的，強調安全性，而有些則以隱私為優先，或者是用於日常的小額支付。
...
初始化錢包時，會生成一個[秘密恢復詞](https://planb.academy/resources/glossary/recovery-phrase)（私鑰），通常由 12 或 24 個單詞組成。
...
公鑰由私鑰產生，並與私鑰連結。共用公鑰會對隱私造成風險（因為其他用戶可以看到您的餘額），但不會對安全造成風險（因為他們沒有私鑰就不能使用您的資金）。反過來，公鑰被用來創建[比特幣地址](https://planb.academy/resources/glossary/receiving-address)，從而接收資金。
...
儘管您的私鑰儲存在您的錢包中，但比特幣本身實際上是「儲存」在比特幣區塊鏈中，它是比特幣[點對點](https://planb.academy/resources/glossary/peertopeer-p2p)網絡中公開的去中心化分佈式帳本（我們將在第 3 節中深入探討）。這意味著，丟失包含您錢包的設備不一定會導致您的比特幣丟失。實際上，允許您重新創建您的錢包並使用您的比特幣的是私鑰，所以請務必記住妥善保護它！
...
如果有人不小心猜中了我們的 12 或 24 個詞彙清單怎麼辦？簡短的答案是可能性極低，這要歸功於用來創建錢包的密碼技術。換個角度來看，不小心發現您相同的助記詞組，就等於在 1 和 2 的 256 次方 之間找到「正確」的數字，幾乎等同於在宇宙中找到「正確」的原子。但是，如果您不滿意這種預設的安全性，您可以隨時透過在您的比特幣錢包中添加一個「[額外密碼](https://planb.academy/resources/glossary/passphrase-bip39)」來增強它。
...
- **第 0 級**，您使用所謂的「[託管服務](https://planb.academy/resources/glossary/custody)」，您不是您比特幣的唯一持有人。請注意，這個可信賴的第三方可以隨時限制您存取您的資金。在這種情況下，您的金融主權等級與擁有銀行帳戶的傳統銀行系統相似。
...
- **第 2 級**，您使用實體硬體錢包，並已保護您的 12/24 個詞彙清單。它通常被稱為「[冷錢包](https://planb.academy/resources/glossary/cold-wallet)」，因為您的金鑰被儲存在未連接至網際網路的裝置上。在這種情況下，您總是需要用您的裝置簽署每筆交易，這使得您的資金在日常使用中較難存取。
...
- **第 4 級**，您使用一組錢包建立「[多重簽名](https://planb.academy/resources/glossary/multisig)」錢包，這表示進行交易時需要多重簽名。在這種情況下，要注意多重簽名的每一部分都應該儲存在不同的位置。這種方式通常被認為是比特幣的進階用途，主要用於管理大額資金和企業用途。
...
2009 年 1 月 3 日，中本聰透過創建第一個區塊（也稱為「[創世區塊](https://planb.academy/resources/glossary/genesis-block)」）正式啟動了比特幣網絡，標誌著比特幣區塊鏈的誕生。這個區塊內嵌了一條具有深遠意義的訊息：「03/jan/2009 Chancellor on brink of second bailout for banks.」（「2009 年 1 月 3 日，英國財政大臣正處於對銀行的第二輪紓困邊緣。」）。
...
要完成交易，Bob 必須用他的私鑰簽署，以驗證他是他要轉移的比特幣的擁有者。這一步驟通常在手機錢包上是自動進行的，或者在您的實體錢包上以[確認](https://planb.academy/resources/glossary/confirmation)的形式進行：「你確定要發送 X BTC 給 Y 嗎？是/否」。

![image](assets/zh-Hant/045.webp)

**為什麼我們要付費？** 手續費的存在是為了建立一個自由市場。事實上，比特幣區塊的大小最初為 1MB，在 [SegWit](https://planb.academy/resources/glossary/segwit)（隔離見證）更新後擴展至 4MB。因此每個區塊中可「插入」的交易數量僅限於幾千筆。交易的大小取決於其複雜性。因此，較複雜的交易通常會產生較高的費用。
...
如果所選的號碼正確：中大獎！否則繼續搜尋。為了最佳化嘗試的次數，他們會使用稱為 ASIC 的特定機器，這些機器的唯一作用是每秒計算數十億次的可能性（嘗試的總次數稱為「[算力 HashRate](https://planb.academy/resources/glossary/hashrate)」）。為了操作這些機器，必須消耗大量的電力。因此 PoW（工作量證明） 透過能源轉化為貨幣，連接現實世界與數字世界，創造出第一種基於能源的貨幣。
...
比特幣網絡的 Hashrate 代表每秒嘗試尋找下一個區塊的次數。今天，它甚至超過了 500 TH/s，也就是每秒嘗試 500,000 億次！全球 Hashrate 越高，對於惡意攻擊者而言，壟斷網絡資源以獲得大多數算力並進行[雙重支付](https://planb.academy/resources/glossary/double-spending-attack)（雙重花費問題）的難度也越高。因此，遵守比特幣協議的規則比違反規則更有經濟效益。
...
**[Coinbase 交易](https://planb.academy/resources/glossary/coinbase-transaction)**永遠是包含在區塊中的第一個交易：它包含了礦工執行驗證工作的報酬。接著是經過驗證的交易。礦工會選擇插入給他們帶來最大利潤的交易，即具有最大費用的小規模交易。
...
為了穩定他們的商業模式，礦工依賴於每個有效區塊的獎勵。礦工們通常會選擇加入「[礦池](https://planb.academy/resources/glossary/pool-mining)」（Mining Pools）來建立群體，將他們的計算資源集中起來。
...
如果您希望深入了解比特幣挖礦這一特定主題，您可以查閱我們的 MIN 101 課程。在課程中，您將找到關於工作量證明原理及其運作方式的詳細理論解釋，以及與之相關的所有概念。

https://planb.academy/courses/d1ce86d9-c983-49bc-92b3-e3c5269f239e

我也建議您了解這門更進階的實作課程，我們將在其中講解如何將 ASIC 改造成 DIY 家用供暖系統，以利用挖礦產生的熱量並賺取您的第一批聰！
...
根據過往的週期，比特幣經濟週期的週期性似乎等同於兩次[減半](https://planb.academy/resources/glossary/halving)之間的時間長度，這也許是因為減半事件作為一個觸發點，將新比特幣的發行量減半。
...
比特幣經濟在世界某些地區存在並發展，例如在薩爾瓦多，該國在2021年將比特幣定為法定貨幣。不幸的是，在2025年1月，議會通過了一項新法律，剝奪了比特幣的「法定貨幣」稱號，據稱是因為受到國際貨幣基金組織的壓力。根據新法律，人們不再有義務在他們的商業中接受比特幣，也不能再用比特幣支付稅款。接受仍然是自願的。
...
獲取比特幣有幾種方式，每種方式受不同的監管規範約束，而這些規範可能因國家或地區而異。有些平台需要身份驗證 ([KYC](https://planb.academy/resources/glossary/kyc-know-your-customer))，有些則不需要。因此，在選擇平台前，應先了解適用於該平台的法律與監管要求。


- 均值成本法（DCA）平台

正如我們上面所介紹的，累積比特幣的常用方法是[均值成本法 (DCA)](https://planb.academy/resources/glossary/dollar-cost-averaging-dca)，即定期買入少量比特幣。有幾個平台提供這項服務，例如我們 [專頁](https://planb.academy/tutorials/exchange) 上列出的平台。除了設定 DCA 的簡單性外，提款到您的錢包提現通常是自動進行，確保你始終掌控自己的資產。
...
## 閃電網路：以低手續費快速使用比特幣進行支付

<chapterId>b403f1e4-f1ff-572b-a242-9b58cb3736d0</chapterId>

現在您已經了解比特幣協議的基本原理，我們將介紹建立在比特幣之上的主要支付網路：閃電網路（Lightning Network，通常簡稱為「LN」）。其目標很簡單：在不使區塊鏈飽和的情況下，實現幾乎即時完成的 BTC 支付，並且通常只需支付極低的手續費。

### 區塊鏈無法承擔所有功能

比特幣區塊鏈的設計宗旨，是讓最多數的人能夠在無需授權、無需信任的前提下進行驗證。這一要求帶來了結構性的限制：區塊鏈無法處理無限數量的交易，因為區塊必須保持在合理的大小範圍內，才能讓獨立節點在不投資過於昂貴硬體的情況下完成下載、儲存與驗證。這種取捨通常被概括為「三難困境」：去中心化、安全性與可擴展性。任何基於區塊鏈的系統，都無法同時最大化這三種屬性。比特幣優先保障去中心化與安全性，這也自然限制了其[鏈上](https://planb.academy/resources/glossary/onchain)交易的吞吐量。

![image](assets/zh-Hant/081.webp)

在比特幣上，開發者明確地做出了這樣的選擇。一方面，將區塊大小限制為 1 MB，並將平均出塊時間設定為 10 分鐘，使得以較低成本運行比特幣節點成為可能，從而促進了網路的去中心化。另一方面，透過工作量證明來產生區塊，使任何欺詐行為都變得極其昂貴，同時也便於節點驗證，並強化了整個協議的安全性。

然而，這些選擇也帶來了一個重要限制：每個區塊中能夠包含的交易數量是有限的，僅相當於每秒幾筆交易。與 VISA 等中心化支付系統（其理論最大處理能力約為每秒 65,000 筆交易）相比，這一數字微不足道，但這正是實現無審查、無可信第三方交易所必須付出的代價。

具體而言，這對比特幣的日常使用意味著兩點非常重要的影響：
* 當區塊空間需求上升時，鏈上手續費可能會大幅提高；
* 鏈上支付需要等待確認，這並不總是適合日常消費場景。

閃電網路正是針對這些問題所提出的解決方案。閃電的理念採用了分層架構：比特幣仍然作為基礎層（最終結算層，穩健且高度安全），而閃電網路則作為其上的快速支付層。

![image](assets/zh-Hant/080.webp)

### 錨定在比特幣上的支付通道

閃電網路基於雙向[支付通道](https://planb.academy/resources/glossary/payment-channel)運作。一個通道，是兩個參與者之間的一種技術關係，使他們能夠在[鏈下](https://planb.academy/resources/glossary/offchain)（offchain）交換 [sats](https://planb.academy/resources/glossary/satoshi-sat)，也就是說，無需將每一筆支付都寫入區塊鏈。

從比特幣（onchain）的角度來看，開啟一個通道等同於在一筆特殊交易中鎖定資金。這可以被視為一種託管：資金被鎖定，只有在通道被正確關閉時，才能重新分配。

從閃電網路的角度來看，這一機制成為了一個通道，雙方可以在其中根據需要多次更新 sats 的分配狀態，幾乎即時完成，且無需將每一次支付記錄到主區塊鏈上。

其運作機制如下：
* 閃電通道的開啟與關閉都是比特幣交易（因此會發佈到鏈上）；
* 在通道開啟與關閉之間的支付，都是鏈下更新，不會出現在主區塊鏈上。

![image](assets/zh-Hant/083.webp)

因此，共享同一閃電通道的兩個人可以進行大量支付，而無需每次都建立一筆鏈上交易。這體現了一種可擴展性的邏輯：將區塊鏈保留給少數重要且關鍵的操作（通道的開啟與關閉，即最終結算），而把其餘頻繁的小額中間支付轉移到更高效的一層中完成。

### 一個互相連接的通道網路

閃電網路不僅僅是若干孤立通道的集合，而是一個真正的網路：成千上萬個節點透過通道彼此連接，形成一個連線圖。

![image](assets/zh-Hant/082.webp)

藉由這個網路，即使您與收款方之間沒有直接通道，只要存在一條由多個通道組成的路徑可以傳遞支付，您仍然可以完成付款。支付會在多個中介節點之間逐跳傳遞。

在此，閃電網路中一個關鍵概念便出現了：流動性。通道的容量是指鎖定在該通道中的資金總量，而流動性則是這些資金在通道兩側之間的分配情況，並決定了 sats 能夠流動的方向。換言之，即使一個通道具有很大的容量，如果流動性位於「錯誤」的一側，該通道在某個方向上仍然無法使用。因此，支付是否成功，不僅取決於是否存在一條路徑，也取決於整條路徑上是否具備足夠的流動性。

### 在不信任中介的情況下路由支付

閃電網路被設計為允許透過中介節點進行支付，而無需信任這些中介。為此，該協議使用了一種稱為 [HTLC](https://planb.academy/resources/glossary/htlc)（*Hashed Time-Locked Contracts*，雜湊時間鎖合約）的智慧合約。無需深入所有細節，只需記住其整體機制：
* 支付以揭示一個秘密（預映像）作為條件；
* 若最終接收方揭示該秘密，他便能收到資金，而中介節點也能依序取得其應得的款項；
* 若支付失敗，時間鎖到期，各方都能取回自己的資金。

這種運作方式賦予了一項關鍵特性：支付具有原子性。要麼完全成功，要麼在不產生任何中間損失的情況下失敗。

此外，閃電網路還整合了一種懲罰機制：如果某一參與者試圖透過發佈通道的舊狀態（不再反映真實情況）來作弊，另一方可以對其進行制裁並取得全部資金。這一規則強烈地激勵所有參與者保持誠實，即便是在對抗性的環境中。

### 閃電節點、閃電錢包：這意味著什麼

在比特幣鏈上，一個錢包是用來管理金鑰並建立交易的軟體。而在閃電網路中，情況則更加模糊，因為真正的非託管使用，依賴於一個閃電節點（即使這個節點被隱藏在簡單的使用者介面之後）。

在實務中，用於使用閃電網路的應用大致分為兩大類：
* 託管式服務：應用向您顯示一個餘額，但資金實際上由服務提供者控制。您的餘額只是其系統中的一筆帳目記錄，類似於交易所的情況；
* 非託管解決方案：您真正掌控金鑰以及取回資金的能力。這可以是一個內建節點、管理複雜度較低的應用，從而簡化使用者體驗（例如 Phoenix、Zeus 等），也可以是一個完全由您自行管理的真正閃電節點。

https://planb.academy/tutorials/wallet/mobile/phoenix-0f681345-abff-4bdc-819c-4ae800129cdf

https://planb.academy/tutorials/wallet/mobile/zeus-embedded-c67fa8bb-9ff5-430d-beee-80919cac96b9

如今也存在一些自我託管的錢包，能夠以間接方式支援閃電支付，透過按需觸發的原子交換來處理每一筆進出支付（例如 Bull Bitcoin Wallet、Aqua 等）。這些錢包通常使用 Liquid 側鏈作為結算層（我們將在下一章中說明這代表什麼）。
...
閃電網路解鎖了一系列使用場景，這些在過去僅依靠比特幣鏈上交易時，往往不實用，甚至幾乎不可能實現。

- **日常支付（線上與線下）**

無論是收銀台付款還是線上購物，閃電網路都能提供幾乎即時的最終確認，且手續費通常很低。即使在主區塊鏈擁堵時，也能讓比特幣適用於小額支付。

- **微支付與串流支付（streaming money）**

能夠發送極小金額，開啟了新的經濟模式：按使用付費、按分鐘付費、定期捐款、小費等。這正是「串流支付」的理念：根據實際消費的內容或服務持續支付，而不是採用固定訂閱制。

- **內容創作者、播客與捐贈**

閃電網路經常被用於微額捐贈或獎勵機制。像 Fountain 或 Rumble 這樣的應用，很好地體現了這一邏輯：支付變得細緻，並自然融入使用體驗之中，而不再是一個沉重且偶發的行為。我們也在 Plan ₿ Academy 中整合了這一機制，您可以輕鬆向喜愛的講師發送小額捐贈以表達感謝。

- **遊戲與數位經濟**

電子遊戲與數位環境天生適合微交易：小額投注、獎勵、虛擬物品等。引入一個微小的金錢成本，也能提高垃圾訊息與某些濫用行為（如機器人）的成本，同時仍保持良好的可及性。

![image](assets/zh-Hant/085.webp)

### 閃電網路的主要實作

與比特幣一樣，閃電網路是一種協議，而非單一軟體。多種實作並存，並透過共同的規範（BOLT）保持互通性：
* LND（Lightning Labs）；
...
閃電網路並不取代比特幣區塊鏈，而是對其進行補充。區塊鏈仍然是最終結算層，速度較慢但極為穩健；閃電網路則是快速支付層，專為高頻使用與小額金額而設計。

到了 2025 年，得益於錢包與服務對部分複雜性的隱藏，閃電網路已比早期更易於使用。但它仍然存在取捨：流動性、通道的鏈上成本，以及在簡便性、主權性與隱私性之間的權衡。

如果您希望深入理解閃電網路（通道、流動性、路由、風險管理），我推薦 Fanis Michalakis 的完整理論課程 LNP 201：

https://planb.academy/courses/34bd43ef-6683-4a5c-b239-7cb1e40a4aeb

如果您希望開始親自運行自己的閃電節點，我們也提供了專門針對此主題的實作課程 LNP 202：
...
如前幾章所述，比特幣被設計為一個極其穩健的基礎層：一個公開、簡單且安全的帳本，但在速度、可程式性與支付吞吐量方面天然受限。與其強迫這一層承擔所有功能（例如以太坊的做法），比特幣生態逐步採用了分層方法：區塊鏈作為基礎（最終結算），而上層則加入新的屬性，例如更快速的支付、更高的隱私性，或資產發行（穩定幣、代幣化證券等）。

比特幣的演進不僅體現在修改其基礎協議，也體現在在其之上構建解決方案，這些方案會根據目標不同而做出不同取捨。有的專注於支付的可擴展性，有的關注（廣義上的）可程式性與資產發行，還有的試圖將兩者結合。

在本章中，我們將介紹四種為比特幣帶來新可能性的關鍵協議：[側鏈](https://planb.academy/resources/glossary/sidechain)（特別是 Liquid）、Ark、RGB 以及 Taproot Assets。

### 側鏈：與比特幣相連的平行區塊鏈

側鏈是一條獨立於比特幣、並行運作的區塊鏈，擁有自身的規則與共識機制。它透過一種雙向錨定機制（*2WP*）與比特幣相連，使比特幣能以代表形式在側鏈上使用（通常是將比特幣鎖定在主鏈上，並在側鏈上重新建立），之後再返回主鏈。

側鏈的價值在於能提供比特幣本身難以實現的功能：更快的交易、資產功能、更強的隱私性，或更高的開發彈性。作為交換，側鏈始終需要在某些方面對比特幣做出妥協，特別是在信任模型或去中心化程度上。

比特幣上最知名的側鏈無疑是 **Liquid**，由 Blockstream 開發。它主要用於加速某些應用場景：平台之間的快速轉帳、更頻繁的結算，以及資產發行（穩定幣、證券等），並提供更強的隱私性。在 Liquid 上使用的比特幣稱為 L-BTC，透過雙向錨定機制與 BTC 保持 1:1 的對應關係。

![image](assets/zh-Hant/088.webp)

Liquid 與比特幣的主要差異在於其安全性與去中心化模型：Liquid 並不依賴比特幣的工作量證明，而是依賴一個由已知成員組成的營運者聯盟，負責區塊的產生，以及 BTC 與 L-BTC 之間橋接機制的運作。

https://planb.academy/courses/d3ca6943-b22c-4e50-b62d-9431460525bc

### Ark：共享 UTXO 以降低成本並改善體驗

Ark 指的是一系列提案與實作，旨在透過將大量使用者操作聚合到較少數量的比特幣交易中，來提升比特幣的可擴展性。其核心理念相當簡單：與其為每位使用者建立一筆鏈上交易，不如建立一筆代表「批次」的鏈上交易，然後主要在鏈下演進各自的權利，直到需要在比特幣上進行最終結算。

這一第二層協議的構想由 Burak 於 2023 年 5 月提出。與閃電網路類似，Ark 是部署在比特幣主鏈之上的系統，能夠在鏈下實現快速、匿名且低成本的比特幣支付。與閃電網路相比，Ark 不需要具備入帳流動性即可接收支付，從而顯著改善使用者體驗。此外，它還能提供接近 [CoinJoin](https://planb.academy/resources/glossary/coinjoin) 交易的隱私性。如果比特幣引入 covenant，Ark 甚至可以實現非互動式運作。

Burak 經常批評閃電網路因依賴主鏈而在擴展性上受限，並認為 Ark 在理論上可以讓全球所有人都實現自我託管。儘管 Ark 可被視為閃電網路的競爭協議，但實際上兩者可以共存，甚至可能彼此互補。

Ark 仍是一個非常活躍但尚屬早期的領域：其目標極具吸引力（大幅降低每位使用者的鏈上足跡），但必須意識到，這是一種更為複雜的架構，其假設與風險也不同於比特幣與閃電網路。

### RGB：以用戶端驗證為核心的合約與資產

RGB 是一個建立在比特幣之上的智慧合約與資產系統，採用了一種與通用區塊鏈截然不同的方法。其核心理念是用戶端驗證：不再將合約的完整狀態發佈到全球區塊鏈上，而是由參與者在本地保存並驗證其關心的歷史資料，而比特幣區塊鏈僅用於錨定加密承諾並防止雙重支付。

換言之：
* 比特幣區塊鏈扮演時間戳基礎與最小仲裁層的角色；
* 詳細資料（合約規則、狀態、狀態轉換）在相關方之間鏈下流通；
* 驗證在本地完成，從而提升可擴展性，並可能改善隱私性，因為不存在一個所有人都可見的 RGB 全域活動帳本。

![image](assets/zh-Hant/089.webp)

RGB 可作為發行與管理多種類型資產的基礎：代幣（包括穩定幣）、NFT 或數位證券，甚至可用於構建更複雜的合約邏輯，而不會增加基礎層的負擔。

其代價在於資料管理：既然採用用戶端驗證，就必須妥善保存並備份能夠證明自身權利的資料。

RGB 是一個已開發多年的協議，進展循序漸進，但如今已經出現了實際應用案例。若想進一步深入了解，Plan ₿ Academy 提供了一門專家級課程，詳細介紹該協議的運作方式：

https://planb.academy/courses/3ce1d37c-05ba-4f54-aa15-7586d37b2bb7

### Taproot Assets：在比特幣上發行資產並透過閃電網路轉移

Taproot Assets（原名「Taro」）是由 Lightning Labs 推動的一項協議，旨在允許在比特幣上發行資產，並能夠隨後透過閃電網路進行快速、低成本的轉移。

它經常被視為比特幣「可程式化貨幣」敘事中的一塊重要拼圖：並非因為比特幣成為了一台全球電腦，而是因為可以在比特幣這一基礎之上疊加金融工具（資產），再透過閃電網路高效流通。

### 比特幣透過讓上層創新而持續強化

如今，對比特幣生態最貼切的描述，既不是一個一成不變的協議，也不是像以太坊那樣試圖包攬一切的超級區塊鏈。相反，它更像是一個刻意保持保守的基礎層，周圍環繞著各種分層與協議，在風險最小化的前提下進行實驗與創新。
