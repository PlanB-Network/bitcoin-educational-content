...
Pears si basa su alcune librerie di sistema, in particolare `libatomic1`, utilizzata dal runtime Bare JavaScript. Installatela con il seguente comando:
...
### 3.3. installare Node.js e npm tramite NVM
...
*Se si utilizza Linux, si può saltare al passo 6.*



### 4.1. aprire PowerShell in modalità amministratore
...
### 4.4. Controllare le installazioni
...
### 4.6. Controllare e inizializzare Pears
...
*Se si utilizza Linux o Windows e si è già installato Pears, si può procedere direttamente al **passo 6**.*



### 5.1. Verificare i requisiti di sistema
...
Una volta che Pears è attivo e funzionante, potete eseguire l'applicazione di vostra scelta direttamente con il seguente comando:
...
È sufficiente sostituire `[KEY]` con il tasto dell'applicazione che si desidera utilizzare.
