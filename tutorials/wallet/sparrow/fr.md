...
Pour les utilisateurs d'un hardware wallet Air-Gap, la vérification de l'adresse varie selon le modèle de l'appareil. Consultez le tutoriel dédié sur Plan ₿ Academy pour obtenir des instructions précises.
