...
![LNP201](assets/en/076.webp)۲. **تراکنش‌ها در کانال**: در این کانال، امکان انجام تعداد زیادی تراکنش بدون نیاز به انتشار آن‌ها در بلاکچین وجود دارد. هر تراکنش در شبکه لایتنینگ یک وضعیت جدید از کانال ایجاد می‌کند که در یک تراکنش تعهد (commitment transaction) منعکس می‌شود.
