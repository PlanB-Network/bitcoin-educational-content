...
***Примечание:** Начиная с мая 2025 года, активация новых учетных записей, защищенных двухфакторной аутентификацией (2FA), будет невозможна. Эта функция доступна только пользователям, которые ранее уже активировали такой тип учетной записи.*
