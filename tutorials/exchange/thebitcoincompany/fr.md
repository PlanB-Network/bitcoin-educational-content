...
Plus besoin de mail ni de mot de passe pour chaque site votre wallet vous identifie, et cerise sur le gâteau, une nouvelle identité est générée pour chaque site visité. Pratique du point de vue de la préservation de la vie privée.

![TheBitcoinCompany](assets/fr/08.webp)

Ouvrons donc notre wallet Phoenix, et scannons le QR code présenté. Une fois scanné cliquez sur "Sign-in", puis "OK".
...
Vous pouvez ainsi observer votre *Username* qui est un nombre aléatoire et qui sera différent pour tous les sites visités supportant ce mode d'authentification. En bas de l'écran on voit effectivement que la méthode d'authentification est bien spécifié comme étant LNURL Auth.
