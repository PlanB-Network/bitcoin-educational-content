...
- Gå till [GitHub-arkivet för PlanB som är dedikerat till data] (https://github.com/Plan ₿ Academy/Bitcoin-educational-content/tree/dev/resources/projects) i avsnittet `resources/project/`:
