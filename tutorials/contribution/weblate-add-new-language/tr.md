...
Dilinizin halihazırda üzerinde çalıştığımız diller arasında olup olmadığını kontrol etmek için.
...
- Web Sitesi Elements` menüsünde, devam etmekte olan tüm dillerin bir listesini bulacaksınız:
...
- İlk adım, sağ üst köşedeki "Kayıt Ol" seçeneğine tıklayarak Weblate'te bir hesap oluşturmaktır (herhangi bir yardıma ihtiyacınız olursa, hemen yukarıda belirtilen eğitime geri dönebilirsiniz).



- Hesabınız oluşturulduktan sonra, `Web Sitesi Elements` menüsüne gidin ve `Diller` sekmesini seçin:

![language](assets/03.webp)


- Pencerenin sol üst köşesindeki `+` işaretine tıklayın:
...
- Yeni çeviri başlat` seçeneğine tıklayın:

![language](assets/06.webp)


- Daha sonra diliniz için çeviri yönetimi sayfasına ulaşacaksınız:

![language](assets/07.webp)


- Web sitesinin statik Elements'sini çevirmeye başlamak için `Çevir` düğmesine tıklayın: ![language](assets/08.webp)
