...
- Go to [the GitHub repository of PlanB dedicated to data](https://github.com/Plan ₿ Academy/bitcoin-educational-content/tree/dev/resources/projects) in the `resources/project/` section:
