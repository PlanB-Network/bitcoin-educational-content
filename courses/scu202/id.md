---
name: Meningkatkan keamanan digital pribadi Anda
goal: Mengatur lingkungan digital pribadi yang aman, stabil, dan efisien.
objectives: 


  - Memahami cara kerja sistem operasi modern dan membuat pilihan yang tepat
  - Dapatkan otonomi teknis di Linux
  - Menerapkan praktik keamanan terbaik pada komputer pribadi
  - Meningkatkan keamanan penjelajahan web dan penggunaan seluler melalui alat bantu sumber terbuka dan pengaturan yang sesuai
  - Menerapkan perlindungan yang diperlukan pada jaringan rumah
...
#### Pusat Aplikasi: penginstal grafis
...
- Geolokasi Anda,
- Browser Anda dan propertinya,
- Sistem operasi Anda,
- Versi perangkat lunak Anda,
- Jenis huruf yang terinstal,
...
- Port `22` digunakan untuk koneksi SSH
- Port `25`, `465`, dan `587` digunakan untuk mengirim email (SMTP)
- Port `110` digunakan untuk mengambil email melalui protokol POP3
- Port `143` digunakan untuk mengambil email melalui protokol IMAP
...
Jaringan Wi-Fi sering kali menjadi titik masuk yang disukai untuk masuk ke dalam lingkungan rumah tangga. Tidak terlihat dengan mata telanjang tetapi dapat diakses dari luar dinding rumah Anda, ini adalah target yang mudah bagi siapa saja yang berada dalam jangkauan.


Langkah penting pertama adalah memilih protokol enkripsi yang tepat. Selalu aktifkan "*WPA3-Personal*", standar terbaru dan paling aman. Protokol ini tidak hanya melindungi data yang dipertukarkan, tetapi juga mencegah serangan tertentu yang diketahui.


Nama jaringan Wi-Fi Anda, yang disebut "SSID" (*Service Set Identifier*), harus tetap netral. Hindari menyertakan nama Anda, Address atau merek router. Nama seperti `MaisonDupont_WiFi6` sudah memberikan terlalu banyak informasi kepada calon penyerang. Lebih suka nama yang umum, tanpa arti tertentu. Ini membatasi informasi yang tersedia untuk pelacakan pasif atau penargetan sosial.


Praktik terbaik lainnya adalah membuat jaringan tamu yang terpisah dari jaringan utama Anda. Jaringan paralel ini, yang sering ditawarkan secara bawaan pada router modern, memungkinkan Anda untuk menyediakan koneksi Internet kepada tamu Anda tanpa mereka memiliki akses ke perangkat Anda yang lain (komputer, printer, NAS, dll.). Ini juga berarti Anda tidak perlu memberikan kata sandi jaringan utama Anda kepada mereka. Untuk melangkah lebih jauh lagi, aktifkan isolasi klien pada jaringan tamu ini: Ini juga akan mencegah pengunjung berkomunikasi satu sama lain, sehingga mengurangi risiko yang terkait dengan perangkat yang disusupi.


Terakhir, sesuaikan daya pancar titik akses Wi-Fi Anda. Secara default, banyak router memancarkan sinyal yang sangat kuat, terkadang dapat dideteksi jauh di luar dinding Anda. Hal ini meningkatkan area pemaparan Anda. Dalam pengaturan lanjutan router Anda, kurangi daya transmisi ke minimum yang diperlukan untuk menjangkau rumah Anda. Jika router Anda mengizinkannya, Anda juga dapat mengonfigurasi pemutusan Wi-Fi otomatis saat tidak digunakan.
