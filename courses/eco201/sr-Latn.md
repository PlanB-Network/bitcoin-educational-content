...
Sa nižim kamatnim stopama, preduzetnici mogu pozajmiti više resursa i tako stvoriti proizvodne faze višeg reda. U ovom slučaju, takvo proširenje proizvodne strukture neće rezultirati smanjenom potrošnjom jer nije došlo do odlaganja trenutne potrošnje od strane potrošača. Drugim rečima, BDP raste. Posledično, naš trougao će se produžiti dok će zadržati sličnu visinu, što znači da će se njegova površina povećati.
...
Sada, preduzetnici uključeni u ove više faze proizvodnje ostvaruju veće monetarne prihode, i, kako je vremenska preferencija ostala ista, trebalo bi da vidimo i povećanu potražnju za potrošačkim proizvodima. Ali kako je, tokom ovog buma, relativna profitabilnost uloženog kapitala bila veća u sektorima daleko od potrošnje, došlo je do prenosa resursa iz aktivnosti bliskih potrošnji ka udaljenijim aktivnostima. Posledično, preduzetnici u nižim fazama proizvodnje nemaju resurse da zadovolje povećanu potražnju. Ovo stvara tenziju između ova dva dela strukture proizvodnje: svaki pokušava da dobije kapital na račun drugog, i pošto tražnja za potrošnjom predstavlja hitnije potrebe, u nekom trenutku, preduzetnici angažovani u aktivnostima udaljenim od potrošnje će ostati bez resursa potrebnih za završetak svojih investicija. Tada stopa profita u ovim sektorima počinje da opada, preduzeća bankrotiraju, a relativno povećanje cena potrošača motiviše brzu realokaciju kapitala ka proizvodnji dobara nižeg reda. Kada se ova iznenadna realokacija resursa manifestuje, ekonomija ulazi u recesiju: cene imovine padaju, realne plate opadaju, cene potrošačkih proizvoda padaju, a zalihe se gomilaju.
...
Generalno, recesiju pokreće sam bankarski sektor. Sve dok krediti rastu ubrzanim tempom, cene nastavljaju da rastu, a preduzetnici se takmiče za proizvodne resurse. Međutim, kako je primetio Hyman Minsky, dolazi trenutak kada bankarski sektor odluči da smanji svoj rizik, te smanjuje tok kredita. Depresija, dakle, rezultira mnogim bankrotstvima, stezanjem kredita, smanjenjem dostupne kupovne moći i finansijskim kolapsima.


TTakvo prilagođavanje se može posmatrati kao period tokom kojeg se nameću nedovoljna potrošnja i nedovoljna investicija kako bi se obnovila nedostajuća štednja. Za Hayeka, ova depresivna faza, iako bolna, je veoma neophodna jer omogućava oporavak ekonomske aktivnosti zasnovan na strukturi relativnih cena koje odražavaju stvarnu oskudicu proizvodnih faktora. Ako se ova depresija prekine, ekonomija ne može da se vrati na poželjnu putanju jer, u odsustvu informacionog sistema koji omogućava ekonomskim agentima da racionalizuju svoje odluke, pogrešna alokacija resursa će se samo nastaviti.
...
Posledice takve pogrešne alokacije uključuju finansijske i ekonomske krize, smanjenu ekonomsku aktivnost i deflaciju duga. Ovi makroekonomski efekti proizlaze iz neravnoteže između štednje i investicija koja je rezultat ekspanzije kredita. U SSSR-u i drugim komunističkim režimima, fiksiranje cena dovelo je do slične nekoordinacije, što je rezultiralo nestašicama nekih dobara i prekomernom proizvodnjom drugih. U oba slučaja, cene ne odražavaju stvarne preferencije potrošača, bilo u smislu vremenskih preferencija ili potrošačkih preferencija, što dovodi preduzetnike ili centralne planere odgovorne za alokaciju resursa da investiraju kapital u "pogrešne industrije."
...
Važno je napomenuti da biranje podataka, koje podrazumeva selektivno odabiranje podataka za uspostavljanje odnosa između varijabli, predstavlja nenaučnu i nerigoroznu metodu u ekonomiji. Kreiranje novca, na primer, ne uzrokuje nužno inflaciju, i potreban je nijansiraniji pristup za razumevanje složenih ekonomskih mehanizama. Aksiomi igraju ključnu ulogu u austrijskom ekonomskom razmišljanju. Oni su fundamentalni elementi iz kojih se mogu izvesti logički zaključci. Međutim, važno je prepoznati da je precizno predviđanje budućnosti u ekonomiji često teško zbog složenosti ekonomskih fenomena i inherentne neizvesnosti.
