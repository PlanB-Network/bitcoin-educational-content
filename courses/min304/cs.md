...
Vítejte v MIN 304, kurzu o projektu Attakai. Jim a Rogzy vás provedou základními prvky těžby Bitcoinu a poté vás krok za krokem doprovodí při výstavbě vašeho Attakai, DIY domácího topení vyrobeného z použitého S9. Doufáme, že se vám kurz bude líbit a že se pustíte do dobrodružství domácí těžby!
...
Pro zjednodušené vysvětlení konceptu [těžby](https://planb.academy/resources/glossary/mining) lze použít příhodnou analogii: puzzle. Stejně jako puzzle, těžba je složitý úkol, který je ovšem snadno ověřitelný po jeho dokončení. V kontextu těžby Bitcoinu se [těžaři](https://planb.academy/resources/glossary/miner) snaží rychle vyřešit digitální puzzle. První těžař, který puzzle vyřeší, prezentuje své řešení celé síti, která poté snadno ověří jeho platnost. Toto úspěšné ověření umožňuje těžaři validovat nový [blok](https://planb.academy/resources/glossary/block) a přidat ho do Bitcoinového časového řetězce. Jako uznání za jejich práci, která zahrnuje významné náklady, je těžař odměněn určitým počtem bitcoinů. Tato odměna slouží jako finanční pobídka pro těžaře, aby pokračovali ve své práci validace [transakcí](https://planb.academy/resources/glossary/transaction-tx) a zabezpečení Bitcoinové sítě.
...
Současná [těžební odměna](https://planb.academy/resources/glossary/block-reward) je dvojí. Na jedné straně zahrnuje vytváření nových bitcoinů, které se snížilo z původních 50 bitcoinů každých deset minut na dnešních 6,25 bitcoinu (2023). Na druhé straně zahrnuje [transakční poplatky](https://planb.academy/resources/glossary/transaction-fees), neboli těžební poplatky, z transakcí, které si těžař vybere pro zařazení do svého bloku. Když je provedena bitcoinová transakce, jsou zaplaceny transakční poplatky. Tyto poplatky fungují jako druh aukce, kde uživatelé udávají, kolik jsou ochotni zaplatit za zařazení své transakce do dalšího bloku. Těžaři, jednající ve svém vlastním zájmu, si proto vybírají nejvýnosnější transakce pro zařazení do svého bloku s ohledem na omezený dostupný prostor. Takto těžební odměna zahrnuje jak generování nových bitcoinů, tak transakční poplatky, čímž zajišťuje nepřetržitou motivaci pro těžaře a zajišťuje dlouhověkost a bezpečnost Bitcoinové sítě.
...
Centralizace těžby je adresována jako hlavní výzva. Velcí hráči, jako je Foundry, dominují trhu, což může potenciálně vést k cenzuře transakcí. Tato centralizace také může způsobit, že síť bude zranitelná vůči útokům, včetně [útoku 51%](https://planb.academy/resources/glossary/51-percent-attack), kdy aktér nebo skupina kontroluje více než 50% výpočetní síly sítě, což jim umožňuje kontrolovat a manipulovat se sítí.
...
Role těžařů v síti Bitcoin byla předmětem intenzivní debaty během tzv. "válek o velikost bloku". Ačkoliv jsou pro bezpečnost a funkčnost sítě nezbytní, těžaři nutně nevlastní konečnou moc v ekosystému Bitcoinu. Rovnováha mezi těžaři, [uzly](https://planb.academy/resources/glossary/node) a koncovými uživateli zajišťuje integritu a distribuci sítě.
...
Války o velikost bloku odhalily nejistotu a napětí, které jsou vlastní správě sítě Bitcoin. Ačkoliv je v současnosti dominantním řetězcem [Bitcoin Core](https://planb.academy/resources/glossary/bitcoin-core), debata o správě a řízení sítě pokračuje.
...
Attakai, což v japonštině znamená "ideální teplota", je název iniciativy zaměřené na objevování těžby bitcoinů prostřednictvím opětovného využití tepla, kterou spustili @jimzap21 s Découvre Bitcoin.
...
Poté zkopírujte [Stratum](https://planb.academy/resources/glossary/stratum) adresu a vaše uživatelské jméno:
