...
Satochip je Hardware Wallet ve formátu čipové karty s bezpečnostním prvkem certifikovaným podle EAL6+, což je jeden z nejvyšších bezpečnostních standardů. Je navržena a vyráběna stejnojmennou belgickou společností Satochip.



Satochip za cenu kolem 25 eur vyniká mezi konkurencí vynikajícím poměrem ceny a výkonu. Díky zabezpečenému čipu nabízí odolnost proti fyzickým útokům. Navíc je zdrojový kód jeho appletu zcela otevřený a licencovaný pod *AGPLv3*.
...
- Satochip stojí přibližně 25 eur, a protože jde o open-source applet, můžete si ho sami nainstalovat na prázdnou čipovou kartu. Pak je třeba připočítat náklady na komponenty SeedSigner a rozšíření pro čtení čipových karet: podle toho, kde tento hardware koupíte, by se celková částka měla pohybovat mezi 70 a 100 EUR.
...
- [A Satochip](https://satochip.io/product/satochip/), nebo alternativně [blank smartcard](https://satochip.io/product/card-for-diy-project/), na kterou lze nainstalovat applet Satochip (sada rozšíření prodávaná společností Satochip již obsahuje prázdnou kartu smartcard). Sada rozšíření Satochip podporuje také formát [SIM JavaCard](https://satochip.io/product/blank-sim-javacard-for-diy-project/). Pokud tedy dáváte přednost tomuto formátu, můžete se pro něj rozhodnout.
...
Nyní, když máte všechen hardware a software správně zprovozněn, můžete přistoupit k vytvoření portfolia Bitcoin. Za tímto účelem připojte svůj SeedSigner a poté generate svůj seed jako u běžného SeedSigneru, a to buď hodem kostkou, nebo pořízením fotografie:
...
- Nakonec zálohujte soubor seed na fyzické médium a zálohu pečlivě zkontrolujte.
...
Zvolená strategie zálohování závisí na vašich preferencích, ale je nutné mít alespoň jednu kopii fráze Mnemonic, a to buď na fyzickém médiu (papírovém nebo kovovém), nebo, jako v tomto případě, ve službě Seedkeeper. Počet záloh můžete také podle potřeby znásobit. Pro více informací o strategiích zálohování portfolia doporučuji přečíst si tento návod :



https://planb.academy/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270

Chcete-li zálohovat svůj přístroj seed v systému Seedkeeper, přejděte přímo do nabídky `Zálohovat seed`.
...
Zvolte si `Značku` pro snadnou identifikaci různých tajemství uložených ve službě Seedkeeper. Můžete například jednoduše ponechat otisk Wallet nebo výslovně uvést `seed`. Volba závisí na vašich preferencích a riziku.
...
Kód PIN Seedkeeper by měl být co nejdelší a náhodný, aby se zabránilo pokusům o hrubou sílu v případě fyzického zneužití karty. Měli byste si také ponechat záložní kopii tohoto kódu PIN, uloženou na jiném místě než v aplikaci Seedkeeper. Bez tohoto kódu PIN nebudete mít přístup ke kartě Mnemonic uložené ve službě Seedkeeper a vaše bitcoiny budou navždy ztraceny.



### 5.3. Uložení seed na Satochipu



Po vygenerování, uložení a kontrole vašeho portfolia jej přeneseme do systému Satochip. Za tímto účelem se ujistěte, že je v paměti RAM SeedSigneru načten soubor seed. Poté přejděte do `Nástroje > Nástroje čipové karty > Funkce Satochip`.
...
Vložte čip Satochip do čtečky čipových karet a vyberte možnost `Inicializovat pomocí seed`.
...
Poté se vás SeedSigner zeptá, který kód seed má být importován do Satochipu. Vyberte ten, jehož otisk prstu odpovídá právě vytvořenému portfoliu.
...
Pokud chcete použít BIP39 passphrase ke zvýšení bezpečnosti Wallet, přečtěte si část 6 tohoto návodu:



https://planb.academy/tutorials/wallet/hardware/seedkeeper-seedsigner-45cca4c4-1f22-46bb-87ae-9cddb68aa579

## 6. Importovat Wallet do Sparrow



Nyní, když je vaše portfolio spuštěno, naimportujeme jeho veřejné informace ("*keystore*") do Sparrow wallet nebo jiného softwaru pro správu portfolia. Tento software bude sloužit k vytváření, distribuci a sledování vašich transakcí. Nebude je však moci podepisovat, protože soukromé klíče potřebné pro tuto operaci má pouze Satochip (a případné zálohy).
...
Vložte kartu microSD s operačním systémem a zapněte SeedSigner. V tuto chvíli nemůže nic dělat, protože ještě nezná váš seed. Musíte začít tím, že vložíte Satochip do čtečky čipových karet, protože právě v ní je uložen váš seed.
...
Nakonec vyberte `Koordinátor`, tj. software pro správu portfolia, který chcete používat. Zde použijeme Sparrow wallet.
...
Zkontrolujte, zda je v počítači nainstalován software Sparrow wallet. Pokud nevíte, jak jej stáhnout, zkontrolovat jeho pravost a správně nainstalovat, podívejte se na náš kompletní návod na toto téma :



https://planb.academy/tutorials/wallet/desktop/sparrow-c674e2ac-d46f-4c82-92a7-7d1b0e262f5d

V počítači otevřete program Sparrow wallet a na panelu nabídek klikněte na možnost `Soubor → Importovat Wallet`.
...
Přiřaďte svému portfoliu název a klikněte na tlačítko `Vytvořit Wallet`. Poté vás Sparrow vyzve k nastavení hesla pro uzamčení místního přístupu k tomuto Wallet. Zvolte silné heslo: chrání vaše data v Sparrow (veřejné klíče, adresy, štítky a historii transakcí). Toto heslo však není nutné pro budoucí obnovení Wallet: bude vyžadováno pouze heslo Mnemonic (a případně passphrase).
...
Poté vás SeedSigner požádá o naskenování náhodného příjmu Address z vašeho Sparrow wallet, aby potvrdil platnost importu.
...
Váš Satochip (prostřednictvím SeedSigner) a Sparrow wallet jsou nyní bezpečně propojeny. Sparrow slouží jako kompletní správa Interface, zatímco Satochip zůstává jediným zařízením schopným podepisovat vaše transakce. Nyní jste připraveni přijímat a odesílat bitcoiny ve zcela vzduchem chráněné konfiguraci.
...
Objeví se nový Bitcoin Address. Najdete zde :




- Address v textovém formátu (začínajícím `bc1q...`, pokud používáte P2WPKH, jako v tomto příkladu) ;
- Související QR kód ;
- Pole `Label`, které je užitečné pro sledování transakcí.



Důrazně doporučuji přidat štítek ke každé účtence Bitcoin v Wallet. To vám pomůže snadno identifikovat původ každého UTXO a lépe spravovat své soukromí. Chcete-li se o tomto důležitém tématu dozvědět více, podívejte se na specializované školení na stránkách Plan ₿ Academy :
...
Váš štítek Address je nyní přiřazen k tomuto štítku ve všech sekcích Sparrow.
...
Než sdělíte plátci svůj příjem Address, je důležité zkontrolovat, zda patří k vašemu seed. Tento krok zajistí, že váš Satochip pak bude moci podepisovat transakce spojené s tímto Address. Zabrání se tím také případným útokům, kdy by se na displeji Sparrow zobrazil podvodný Address. Mějte na paměti, že Sparrow běží v nezabezpečeném prostředí (váš počítač), jehož útočný povrch je mnohem větší než u vašeho Satochipu, který je zcela izolovaný. Proto byste nikdy neměli slepě důvěřovat adresám zobrazeným v Sparrow dříve, než je zkontrolujete na svém Hardware Wallet.



V aplikaci Sparrow klikněte na QR kód Address a zvětšete jej: zobrazí se na celou obrazovku.
...
Poté potvrďte typ použitého skriptu (v tomto případě `Native SegWit`), zadejte kód Satochip PIN pro jeho odemčení a potvrďte informace `xpub`.
...
Pokud se naskenovaný kód Address shoduje s kódem seed, zobrazí SeedSigner zprávu: `Address ověřeno`.
...
Můžete si tak být jisti, že model Address patří do vašeho portfolia.
...
Nyní můžete tuto zprávu Address předat v textové podobě nebo prostřednictvím kódu QR osobě nebo službě, která vám má zaslat Satss. Jakmile bude transakce odvysílána v síti, objeví se v záložce `Transakce` v Sparrow wallet.
...
- Do pole `Platba příjemci` vložte kód Address příjemce nebo naskenujte jeho kód QR pomocí ikony fotoaparátu;
...
Transakce je nyní připravena, ale ještě nebyla podepsána. Chcete-li zobrazit [PSBT (*Partially Signed Bitcoin Transaction*)](https://planb.academy/en/resources/glossary/PSBT) jako kód QR, klikněte na `Show QR`.
...
Zapněte svůj SeedSigner a vložte svůj Satochip jako obvykle. Na domovské obrazovce vyberte možnost `Scan` a poté naskenujte QR kód zobrazený na displeji Sparrow.
...
Nyní, když je transakce podepsána a ověřena, zbývá ji pouze odvysílat v síti Bitcoin, aby ji Miner mohl zahrnout do BLOCK. V síti Sparrow klikněte na tlačítko `Scan QR`.
...
Předložte kód QR zobrazený na vašem SeedSigneru (ten, který obsahuje podepsanou transakci) webové kameře. Sparrow poté zobrazí všechny podrobnosti o transakci. Proveďte závěrečnou kontrolu, zda jsou všechny informace správné, a poté kliknutím na "Broadcast Transaction" (Vyslat transakci) ji odvysílejte v síti Bitcoin.
...
- Zaznamenáním fráze Mnemonic na fyzické médium;
...
Pokud máte stále svůj Satochip, ale váš SeedSigner je rozbitý nebo ztracený, je tato situace poměrně jednoduchá, protože váš Wallet je stále v Satochipu.
...
Pokud nechcete žádný přestavovat, můžete svůj Satochip používat i klasickým způsobem, tj. přímo z počítače, bez nutnosti procházet SeedSignerem. Tento způsob funguje bezvadně, ale výrazně snižuje bezpečnost vašeho Bitcoin Wallet: ztrácíte izolaci "*air-gapped*" a nyní musíte podepisovat naslepo, protože SeedSigner fungoval jako důvěryhodná obrazovka. Může se však jednat o dočasné řešení v případě nouze, nebo pokud nemůžete obnovit SeedSigner.



K tomu budete potřebovat čtečku čipových karet USB nebo NFC. V programu Sparrow otevřete zařízení Wallet, které chcete obnovit, přejděte na kartu `Nastavení` a klepněte na tlačítko `Nahradit`.
...
Druhý, choulostivější scénář nastane, když ztratíte přístup ke svému čipu Satochip obsahujícímu seed: ať už je rozbitý, ztracený, ukradený, nebo jste zapomněli jeho kód PIN. Pokud byl váš Satochip odcizen nebo ztracen, důrazně doporučujeme, abyste po obnovení přístupu k vašim prostředkům okamžitě převedli své bitcoiny na zcela nový čip Wallet, vygenerovaný pomocí jiného seed. Tím zajistíte, že potenciální útočník nikdy nezíská přístup k vašim Satsům.
...
- Zadejte frázi Mnemonic ručně v nabídce `Seeds > Enter 12-word seed`.
...
Nyní víte, jak pomocí Satochipu bezpečně spravovat portfolio Bitcoin v kombinaci se SeedSignerem.
