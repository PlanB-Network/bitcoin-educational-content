...
- Linux (Debian)** → Sección **1.2**
- Ventanas** → Sección **1.3**
- macOS** → Sección **1.4**


### 1.2. ¿Cómo instalar Pears en Linux (Debian)?
...
Pears depende de algunas librerías del sistema, entre ellas `libatomic1`, utilizada por el motor de ejecución Bare JavaScript. Instálela con el siguiente comando:
...
#### 1.2.3. Instalar Node.js y npm a través de NVM
...
Al iniciarse, Pears se conectará a la red peer-to-peer para descargar los componentes necesarios. Este proceso no depende de ningún servidor central: los archivos se recuperan directamente de otros pares.
...
#### 1.2.6. Peras de prueba con Keet
...
### 1.3. Cómo instalar Pears en Windows


La instalación de Pears en Windows es tan sencilla como en Linux, pero requiere algunas herramientas específicas.


*Si utilizas Linux y ya has instalado Pears, puedes pasar directamente al **Paso 2**.*


#### 1.3.1. Abra PowerShell como administrador
...
#### 1.3.4. Verificación de las instalaciones
...
#### 1.3.6. Verificar e inicializar las peras
...
#### 1.3.7. Peras de prueba con Keet
...
*Si utilizas Linux o Windows y ya has instalado Pears, puedes pasar directamente al **Paso 2**.*


#### 1.4.1. Comprobar los requisitos previos del sistema
...
#### 1.4.6. Peras de prueba con Keet
...
## 2. Cómo utilizar la Academia Plan ₿ en las peras
...
## 3. Cómo planificar seed ₿ Academia de la pera
