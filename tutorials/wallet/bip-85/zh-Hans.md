...
![image](assets/fr/03.webp)
  ...
  - 选择格式
    - 选择助记词格式：12、18 或 24 个单词。检查您要导入种子助记词的钱包可接受的字数。
      
![image](assets/fr/04.webp)

  - 选择索引
    - 输入 0 到 9999 之间的数字作为索引。该索引对于日后重新派生次级种子至关重要。请小心保存，并贴上标签，如 "索引 1 = 移动钱包"、"索引 2 = 家庭项目钱包"、"索引 4 = 混币测试"。如果丢失，您不会失去资金的使用权限，但您必须测试从 0 到 9999 的可能性才能恢复资金。
