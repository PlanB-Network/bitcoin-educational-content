...
![Speichererweiterungskarte RPI4](assets/de/1.png)
...
![writing micro SD completed](assets/de/23.png)
...
![root password](assets/de/26.png)
...
![confirm root password](assets/de/27.png)
...
![user credentials](assets/de/28.png)
...
![Pairing](assets/de/31.png)
![Electrs](assets/de/32.png)
Sie müssen dann die `Hostname`-Adresse, die auf `.onion` endet, in Ihrer Wallet-Software eingeben, begleitet von Port `50001`. ![hostname](assets/de/33.png)
Zum Beispiel in Sparrow Wallet, gehen Sie einfach zum Tab:
`Datei > Einstellungen > Server > Privater Electrum`

![Sparrow](assets/de/34.png)
...
Für ein tieferes Verständnis von Coinjoin und dessen Verwendung bei Bitcoin lade ich Sie auch ein, diesen anderen Artikel zu konsultieren: [Verständnis und Nutzung von Coinjoin bei Bitcoin](https://planb.network/tutorials/privacy/coinjoin), wo ich alles, was Sie über diese Technik wissen müssen, im Detail erkläre.
...
![Samourai Toolkit](assets/de/43.png)

Wählen Sie dann `Whirlpool Stat Tool`:

![WST](assets/de/44.png)
...
![WST Bewertung](assets/de/47.png)
...
![Kombinationen](assets/de/50.png)
