...
### 1.3 Kuanzisha Liquid



**Liquid** ni **Sidechain** ya Bitcoin, iliyotengenezwa na **[Blockstream](https://blockstream.com/Liquid/)**, iliyoundwa ili kutoa utendakazi wa haraka, zaidi wa Confidential Transactions na utendakazi wa hali ya juu, huku ikisalia kushikamana na Blockchain Bitcoin kuu.



Sidechain ni Blockchain inayojitegemea inayofanya kazi sambamba na Bitcoin, kwa kutumia utaratibu unaojulikana kama **kigingi cha njia mbili**. Mfumo huu hufunga bitcoins kwenye Blockchain kuu ili kuunda **Liquid-Bitcoins (L-BTC)**, tokeni zinazozunguka kwenye Liquid Network huku zikihifadhi usawa wa thamani na bitcoins asili. Pesa zinaweza kurejeshwa kwa Blockchain Bitcoin wakati wowote.
...
Liquid inategemea **shirikisho** la washiriki wanaoaminika (mabadilishano, makampuni yanayotambulika ya Bitcoin) wanaosimamia uthibitishaji wa vitalu na uwekaji nanga baina ya nchi mbili. Tofauti na Blockchain Bitcoin, ambayo imegatuliwa na kutegemea wachimbaji, Liquid ni mtandao wa **shirikisho**, kumaanisha kuwa usalama na utawala wake unategemea washiriki hawa. Ingawa hii inamaanisha maelewano katika ugatuaji, huwezesha utendakazi ulioboreshwa na utendakazi wa hali ya juu.
...
**Kumbuka: Mafunzo haya yanalenga kutumia Liquid kupitia Programu ya Blockstream. Kwa ufahamu wa kina wa Liquid Network, utapata nyenzo kwenye kiambatisho.



### 1.4. Kikumbusho cha Hot Wallet
...
- (2) **"Rejesha kutoka kwa Hifadhi Nakala "**: Ingiza kwingineko iliyopo kwa kutumia maneno ya Mnemonic (maneno 12 au 24). Onyo: Usiingize kifungu kutoka kwa Cold Wallet, kwani kitafichuliwa kwenye kifaa kilichounganishwa, na hivyo kubatilisha usalama wake.
- (3) **"Tazama Pekee "**: Leta jalada lililopo la kusoma pekee, ili kuona salio (k.m. ya Cold Wallet yako) bila kufichua maneno ya Mnemonic. Tazama mafunzo ya "Tazama Pekee" katika kiambatisho.
...
**Muhimu**: Programu ya Blockstream imerahisisha uundaji wa Wallet kwa kutoonyesha kiotomatiki maneno 12 ya seed. *Ingawa kwingineko sasa imeundwa kwa mbofyo mmoja, unaweza kupoteza ufikiaji wa pesa zako ikiwa hutahifadhi maneno yako ya seed*.



### 4.2. Hifadhi maneno ya seed





- Kwenye skrini ya kwanza ya Wallet, bofya kichupo cha "Usalama", kisha kwenye kidokezo cha "Hifadhi nakala" au menyu ya "Neno la Urejeshaji":
...
Kishazi cha maneno 12 cha seed kitaonyeshwa ili uhifadhi.
...
### 4.3. Angalia sentensi ya seed



Kabla ya kutuma pesa kwa Address inayohusishwa na maneno haya ya seed, lazima ujaribu nakala rudufu ya maneno yako 12.


Ili kufanya hivyo, tutaandika kumbukumbu, futa Wallet, uirejeshe kwa chelezo, na uangalie kuwa kumbukumbu haijabadilishwa.





- Kwenye skrini ya kwanza ya Wallet, bofya kichupo cha "Mipangilio", kisha kwenye "Maelezo ya Wallet", na unakili zPub ([iliyoongezwa umma ufunguo](https://planb.network/fr/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f/8dcffce1-31bd-5e0b-965b-735f5f9e4602):
...
- Futa programu, kisha urejeshe Wallet kupitia **"Rejesha kutoka kwa Hifadhi Nakala "** kwa kuingiza maneno ya Mnemonic, na uangalie kuwa zpub haijabadilishwa. Ikiwa ndio, basi nakala yako ni sahihi, na unaweza kutuma pesa kwa Wallet.
...
### 4.4. Kulinda ufikiaji wa programu
...
**Kumbuka**: PIN hulinda kifaa, lakini maneno ya seed pekee ndiyo yanaweza kutumika kurejesha pesa.





## 5. Kutumia Liquid Wallet



### 5.1. Pokea bitcoins za "L-BTC".



Ili kupokea Liquid-Bitcoins (L-BTC), chaguo kadhaa zinapatikana. Unaweza kumwomba mtu akutumie moja kwa moja kwa kushiriki Liquid kupokea Address, ambayo ni ya kina hapa chini.



Vinginevyo, Exchange bitcoins zako kwenye mnyororo au kupitia Lightning Network kwa L-BTC kwa kutumia [daraja kama vile Boltz](https://boltz.Exchange/): weka Liquid yako ikipokea Address, lipa upendavyo, na upokee L-BTC yako.
...
- Kwa chaguo-msingi, programu inaonyesha **risiti tupu ya Address, onchain** (umbizo la SegWit v0, linaloanza na `bc1q...`). Bofya kwenye "Bitcoin" ili kuchagua **Liquid Bitcoin** :
...
- Kutoka kwa skrini ya kwanza ya kwingineko, bofya "**Transact**" kisha **"Tuma "** :
...
Kwa kutumia mtandao wa Onchain
