...
- UASF (User-Activated Soft Fork) kada čvorovi nameću ažuriranje;
- MASF (Miner-Aktiviran Soft Fork) kada su rudari ti koji pokreću aktivaciju.


Postoji mnogo različitih metoda aktivacije koje su testirane kako se Bitcoin razvijao. U vreme Satoshi, proces aktivacije nije bio formalno uspostavljen. Promene su često bile proizvoljne i ponekad su čak pravljene bez obaveštavanja zajednice. Kasnije je usvojen metod *Flag Day*. Nakon odlaska Satoshi, korišćene su druge metode, posebno BIP34, BIP9, BIP8, i na kraju, *Speedy Trial*.