...
definition: Алгоритмическая оптимизация, позволяющая повысить эффективность майнинга примерно на 20% путём повторного использования части хеш-вычислений между несколькими попытками.
---
