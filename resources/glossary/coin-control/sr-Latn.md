...
Kontrola novčića je posebno korisna za upravljanje naknadama za transakcije i za poboljšanje privatnosti. Zaista, pažljivim odabirom UTXO-a za potrošnju, korisnici mogu izbeći spajanje UTXO-a iz različitih izvora, što bi moglo otkriti informacije o njihovim celokupnim sredstvima (CIOH). Ova funkcija često dolazi sa mogućnošću označavanja izlaza transakcija.