...
このプロトコルは、暗号技術、ネットワーク通信、有名な「[ブロックチェーン](https://planb.academy/resources/glossary/blockchain)」などの基礎技術を使用し、ビットコイン単位はこのプロトコルが適切に機能するために必要な通貨として機能する。日常生活では、サルバドリア人と世界中のビットコイナーがビットコイン通貨を使用して商品やサービスを売買し、この技術に頼って生活をより良くしている。
...
**セクション 6 - ビットコインの未来：[ライトニングネットワーク](https://planb.academy/resources/glossary/lightning-network)**  
...
2008 年 10 月 31 日、ビットコインという新しい金融技術が誕生した。この日、匿名のサトシ・ナカモトは、インターネット上のプライバシーを促進することを目的とした暗号技術愛好家のコミュニティである cypherpunks のメーリングリストに送られた電子メールを通じて、世界に向けて自身の革新的技術を発表した。このメールには「[ホワイトペーパー](https://planb.academy/resources/glossary/white-paper)」と呼ばれる文書が含まれており、ビットコインの仕組みが紹介されていた。
...
長年にわたり、マイナーは、最も費用対効果の高い方法で最小限のエネルギーを消費しながら、1 秒間に可能な限り多くのハッシュ（HashRate）を生成するために、ますます効率的なコンピュータハードウェアを装備してきました。サトシやハル・フィニーのような初期のマイナーは CPU だけで採掘を行い、その後他のマイナーはグラフィックカードで採掘を始めました。現在では、SHA256 アルゴリズムを適用するためだけに設計されたマシンである ASIC（[特定用途向け集積回路](https://planb.academy/resources/glossary/asic)）を使用しています。
...
ビットコインを取得する方法はいくつかあり、それぞれ管轄地域によって異なる規制の対象となる。プラットフォームの中には、本人確認（[KYC](https://planb.academy/resources/glossary/kyc-know-your-customer)）を必要とするものもあれば、そうでないものもあります。したがって、各プラットフォームに関連する規制を理解することが極めて重要です。
