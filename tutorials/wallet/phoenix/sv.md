...
Phoenix fungerar som en äkta Lightning-nod inbäddad i din telefon och öppnar automatiskt en kanal med ACINQ:s Lightning-nod. Applikationen är baserad på Lightning-KMP, en plattformsoberoende implementering av [Lightning Network](https://planb.academy/resources/glossary/lightning-network) i Kotlin, optimerad för mobila plånböcker. Till skillnad från andra Lightning-nodlösningar förenklar Phoenix hanteringen avsevärt. Användaren behöver inte hantera öppning och stängning av kanaler, köra en Bitcoin-nod eller hantera likviditeten på Lightning Network. Phoenix tar hand om alla dessa tekniska operationer i bakgrunden.
...
Och för att ta reda på mer om den tekniska driften av Lightning Network kan du hitta Fanis Michalakis utmärkta gratisutbildning om Plan ₿ Academy :
