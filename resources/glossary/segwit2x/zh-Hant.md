...
儘管 SegWit 已於 2017 年 8 月實施，但將規模擴大一倍的 2X 計畫並未成功取得共識，主要原因是反對運動「NO2X」，導致該計畫在 11 月初被取消。在 「Blockize 戰爭 」的背景下，這個插曲被許多使用者和開發人員認為是對 Bitcoin 的攻擊。


> ► *SegWit2x有時也稱為 "B2X" 或 "S2X"。最初，其名稱為 "SegWit2Mb"。*