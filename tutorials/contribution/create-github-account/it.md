...
Se desideri contribuire su Plan ₿ Network, avrai bisogno di un account GitHub. In questo tutorial, ti guideremo passo dopo passo su come creare il tuo account, configurarlo e proteggerlo adeguatamente.
...
- Se lo desideri, puoi personalizzare il tuo account cliccando sulla tua immagine del profilo situata in alto a destra dello schermo, poi accedendo al menu `Settings`:
...
- Raccomando anche di visitare il menu `Password and authentication` per configurare almeno l'autenticazione a due fattori:
