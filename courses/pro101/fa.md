...
به اولین جلسه از برنامه آموزشی **Cubo Plus** خوش آمدید. امروز به دنیای Bitcoin وارد می‌شویم، به رهبری ریکی، بنیان‌گذار **پادکست Bitcoin ایتالیا**. ریکی یک فعال پرشور حقوق بشر است که از Bitcoin به عنوان ابزاری برای حفاظت و ترویج حقوق بشر استفاده می‌کند. با بیش از شش سال تجربه، ریکی به طور گسترده سفر کرده و پذیرش Bitcoin در بازارهای نوظهور مانند السالوادور و گواتمالا را مستند کرده است. کار او فراتر از پادکست است؛ او همچنین در یوتیوب (**Bitcoin Explorers**) و توییتر (**BTC Explorer**، **Ricky6**) فعال است. حرکت ریکی از Commitment به Bitcoin ناشی از اعتقاد او به این است که این فناوری آزادی مالی و حریم خصوصی را ارائه می‌دهد و سیستم‌های بانکی متمرکز سنتی را به چالش می‌کشد.
