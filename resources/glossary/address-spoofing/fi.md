...
Toinen tapa esittää uhrille väärä osoite on käyttää vilpillistä lompakonhallintaohjelmistoa, joka jäljittelee laillista ohjelmistoa, tai muuttaa osoitetta silloin, kun laite on vaarantunut, kopioinnin ja tapahtuman muodostamisen välisenä aikana. Tätä kutsutaan joskus nimellä '"*address swapping*"'.
...
Tätä hyökkäystä kutsutaan joskus myös nimellä '"*address poisoning*"'.