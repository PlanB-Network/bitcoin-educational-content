...
description: Мобильная операционная система, ориентированная на безопасность и конфиденциальность, основанная на Android
---

![cover](assets/cover.webp)
> [GrapheneOS](https://grapheneos.org/) — это некоммерческая мобильная операционная система с открытым исходным кодом, созданная для обеспечения высокого уровня конфиденциальности и безопасности, при этом полностью совместимая с приложениями Android.
...
Если эти простые шаги кажутся вам слишком сложными, вы можете рассмотреть возможность покупки Pixel с предустановленным программным обеспечением GrapheneOS (есть компании, которые их продают). Только имейте в виду, что вы вносите небольшую долю доверия поставщику.
...
Вот два признанных варианта, которые позволяют оплатить услугу в биткойнах, не предоставляя никаких личных данных. Оба доступны на F-Droid.
...
- [Mercurygram](https://f-droid.org/en/packages/it.belloworld.mercurygram/) - неофициальный FOSS-форк официального приложения Telegram для Android. Telegram имеет E2EE "секретные чаты", но по умолчанию опция не является приватной. Mercurygram можно скачать с F-Droid.

![изображение](assets/fr/9.webp)
...
- [Syncthing Fork](https://f-droid.org/en/packages/com.github.catfriend1.syncthingfork/) — это форк программы для синхронизации файлов. Она синхронизирует файлы между двумя или более устройствами в реальном времени, надежно защищая их от посторонних глаз. Ваши данные принадлежат только вам, и только вы имеете право выбирать, где они будут храниться, будут ли они делиться с третьими сторонами и как они будут передаваться через интернет. Syncthing Fork доступен через F-Droid.
...
- [Breezy Weather](https://f-droid.org/en/packages/org.breezyweather/) — это многофункциональное приложение погоды с открытым исходным кодом и интерфейсом Material 3 Expressive; оно предлагает продуманные визуализации, прогнозы, условия в реальном времени, качество воздуха, пыльцу, погодные предупреждения из более чем 50 источников.
...
- [Cryptomator](https://f-droid.org/en/packages/org.cryptomator.lite/) — это бесплатный кроссплатформенный сервис (_платный только через Google Play на Android_), который шифрует ваши данные локально, чтобы вы могли безопасно загружать их в ваше любимое облачное хранилище. Cryptomator можно скачать через F-Droid.
