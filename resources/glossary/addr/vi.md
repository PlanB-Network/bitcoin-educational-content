...
definition: Một tin nhắn mạng Bitcoin cũ cho phép giao tiếp các địa chỉ IP của các nút chấp nhận kết nối. Được thay thế bằng addrv2 (BIP155) để hỗ trợ các định dạng địa chỉ dài hơn.
---
