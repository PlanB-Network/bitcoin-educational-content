...
> **⚠️ PILNY KOMUNIKAT BEZPIECZEŃSTWA (lipiec 2026) — portfele Coldcard są aktywnie opróżniane.** Błąd firmware w generowaniu seedów na urządzeniach Coldcard pozwala atakującym odnaleźć twoją frazę seed bez żadnego działania z twojej strony. **Dotknięte są wszystkie modele Coldcard: Mk3, Mk4, Mk5 i Q.** 30 lipca 2026 roku skradziono około 594 BTC z około 500 portfeli, a atak wciąż trwa. Za bezpieczne uznaje się wyłącznie portfele wygenerowane metodą rzutów kośćmi, i tylko jeśli wykonano co najmniej 50 rzutów. Jeśli nie wiesz, nie pamiętasz lub nie masz pewności, jak został wygenerowany twój seed, traktuj go jako skompromitowany i **natychmiast przenieś środki** do portfela, którego seed nie został wygenerowany na Coldcard. Śledź oficjalne komunikaty Coinkite. Zobacz nasz dedykowany tutorial migracji:
