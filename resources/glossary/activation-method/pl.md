...
- UASF (User-Activated Soft Fork), gdy to węzły narzucają aktualizację;
- MASF (Miner-Aktywowany Soft Fork), gdy to górnicy uruchamiają aktywację.


Istnieje wiele różnych metod aktywacji, które były testowane w miarę ewolucji Bitcoin. W czasach Satoshi proces aktywacji nie był formalnie ustalony. Zmiany były często arbitralne, a czasem nawet wprowadzane bez informowania społeczności. Później przyjęto metodę *Flag Day*. Po odejściu Satoshi sukcesywnie stosowano inne metody, w szczególności BIP34, BIP9, BIP8 i wreszcie *Speedy Trial*.