...
另一种想象资金分配的方式是想象一个**光标**，它指示资金在通道中的位置。一开始，Alice 拥有 100,000 个 satoshi，Bob 拥有 30,000 个 satoshi，光标更偏向 Bob 的一侧，因为 Alice 的资金多得多。在 40,000 个 satoshi 的交易之后，光标会稍微向 Alice 的一侧移动，她现在拥有 70,000 个 satoshi。
