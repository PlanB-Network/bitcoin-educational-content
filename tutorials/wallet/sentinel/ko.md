...
현재 가장 완성도 높은 watch-only 애플리케이션은 [Sentinel](https://github.com/wanderingking072/sentinel-android)로, 처음에는 Samourai Wallet 팀에 의해 개발되었으며 현재는 커뮤니티에 의해 유지되고 있습니다. 우수한 watch-only 지갑에 필수적인 모든 기능을 제공합니다:
...
먼저 Sentinel 애플리케이션을 설치하세요. [프로젝트의 github 저장소에서 다운로드할 수 있는 APK](https://github.com/wanderingking072/sentinel-android/releases)를 사용하여 이 작업을 수행할 수 있습니다.
...
그런 다음 Samourai Wallet 서버를 더 이상 사용할 수 없으므로 반드시 자신의 Dojo에 연결해야 합니다. 아직 자신의 Dojo가 없다면 [The Dojo Bay](https://dojobay.pw/) 사이트에서 커뮤니티가 제공하는 Dojo를 사용하거나, 직접 설치하기 위한 튜토리얼을 따르실 수 있습니다 :
