...
https://planb.network/tutorials/wallet/coldcard-q-advanced
...
Cliquez à nouveau sur "Choose PIN"
...
Municez-vous d'une carte microSD et transférez-y le fichier firmware (document en `.dfu`). Insérez la carte microSD dans l'un des ports de votre COLDCARD.
...
- Utiliser une combinaison du TRNG et de lancés de dés pour ajouter de l'entropie ;
- Utiliser uniquement des lancés de dés.
