...
Seedkeeper es una tarjeta inteligente desarrollada por Satochip, una empresa belga especializada en soluciones de hardware para la gestión y protección de secretos digitales. Conocida por su gama de tarjetas inteligentes para el ecosistema Bitcoin, Satochip concibió el Seedkeeper como alternativa a los métodos tradicionales de almacenamiento de frases Mnemonic y otros secretos digitales.



En concreto, el Seedkeeper adopta la forma de una tarjeta inteligente multifuncional, con certificación EAL6, dotada de un procesador seguro y una memoria a prueba de manipulaciones (es decir, una "*secure element*"). Como su nombre indica, su función es almacenar mnemónicos y contraseñas de la cartera Bitcoin de forma encriptada y protegida. Con Seedkeeper, puede generate, importar, organizar y guardar sus secretos directamente en el componente seguro de la tarjeta.
...
- Almacenamiento de frases Bitcoin** Mnemonic: en lugar de escribir sus 12 o 24 palabras en papel, puede importarlas a la tarjeta inteligente y protegerlas con un código PIN.
...
En este tutorial, sólo cubriremos el uso de SeedKeeper para contraseñas tradicionales, a la manera de un gestor de contraseñas. Si deseas utilizar SeedKeeper para guardar frases Bitcoin Wallet Mnemonic, consulta este otro tutorial:
...
Se le pedirá un código PIN para su Seedkeeper. Como se trata de una tarjeta nueva, aún no se ha definido ningún PIN. Introduzca cualquier código para omitir este paso y haga clic en "*Siguiente*".
...
Selecciona "generate secreto*". La opción "*Importar un secreto*" te permite guardar un secreto existente (por ejemplo, una contraseña que hayas creado en el pasado).
...
Asigna una "*Etiqueta*" a este secreto para poder identificarlo fácilmente si almacenas varios datos en tu Seedkeeper. También puedes añadir un nombre de usuario asociado a la contraseña y la URL del sitio.
...
Elige la longitud y los parámetros de tu contraseña, luego haz clic en "*generate*" y, a continuación, en "*Import*".
...
Esto te lleva a una lista de todos tus secretos registrados. En este ejemplo, quiero mostrar la contraseña de mi cuenta Plan ₿ Network, así que hago clic en ella.
...
Esto te lleva a la página de inicio, con una lista de tus secretos. Haz clic en los tres puntitos de la parte superior derecha de Interface.
...
¡Eso es todo! Ahora ya sabes cómo utilizar Seedkeeper para almacenar tus contraseñas. En un próximo tutorial, veremos cómo utilizar Seedkeeper para realizar copias de seguridad de una cartera Bitcoin. También te invito a descubrir su uso combinado con SeedSigner :
