...
Un page web s'ouvre et vous permet de révéler les codes de sécurité de votre carte et des explications détaillées en langue locale du pays, sur la manière d'utiliser et de dépenser votre carte.
...
Et voilà, vous savez maintenant comment dépenser vos bitcoins sans KYC dans de grandes enseignes pour vos dépenses quotidiennes. Ce n'est pas une méthode particulièrement satisfaisante, et cela reste "du bricolage". Mais en attendant que davantage de gens prennent conscience de l'intérêt pour eux d'accepter le cash électronique dans leur commerce, c'est tout de même très utile...
