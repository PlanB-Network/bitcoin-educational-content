...
# Verilerinizi korumaya yönelik bir yolculuk
...
Bu ders üç profesörümüzün ortak çalışmasıdır:
...
- Bölüm 1 - Çevrimiçi Tarama
- Bölüm 2 - İnterneti Güvenli Bir Şekilde Kullanmak
...
- Bölüm 6 - E-posta yönetimi
- Bölüm 7 - Parola yöneticisi
- Bölüm 8 - İki faktörlü kimlik doğrulama
...
# Çevrimiçi tarama hakkında bilmeniz gereken her şey
...
### Yazılım indirmeleri konusunda dikkatli olun:


Yazılımı genel siteler yerine yayıncının resmi web sitesinden indirmeniz önerilir.
...
Çerezler, bilgisayarınızda veya mobil cihazınızda bilgi depolamak için web siteleri tarafından oluşturulan dosyalardır. Bazı sitelerin düzgün çalışması için bu çerezlere ihtiyacı olsa da, özellikle reklam izleme amacıyla üçüncü taraf siteler tarafından da kullanılabilirler. GDPR gibi düzenlemeler kapsamında, sitenin düzgün çalışması için gerekli olanları kabul ederken üçüncü taraf izleme çerezlerini reddetmek mümkündür ve tavsiye edilir. Bir siteye yapılan her ziyaretten sonra, ilgili çerezleri manuel olarak veya bir uzantı ya da belirli bir program aracılığıyla silmek akıllıca olacaktır. Hatta bazı tarayıcılar çerezleri seçerek silme imkanı da sunmaktadır. Bu önlemlere rağmen, farklı siteler tarafından toplanan bilgilerin birbirine bağlı kalabileceğini, dolayısıyla kolaylık ve güvenlik arasında bir denge bulmanın önemini anlamak çok önemlidir.


> Not: Ayrıca, olası güvenlik ve performans sorunlarını önlemek için tarayıcınızda yüklü uzantıların sayısını sınırlayın.

### Web tarayıcıları: seçenekler, güvenlik


İki ana tarayıcı ailesi vardır: Chrome tabanlı olanlar ve Firefox tabanlı olanlar.
...
Gizli tarama, internet servis sağlayıcınızdan taramayı gizlemese de, bilgisayarınızda yerel izler bırakmaktan kaçınmanıza olanak tanır. Çerezler her oturumun sonunda otomatik olarak silinir ve izlenmeden tüm çerezleri kabul etmenize olanak tanır. Web siteleri arama alışkanlıklarımızı izlediğinden ve fiyatları buna göre ayarladığından, çevrimiçi hizmetleri satın alırken gizli tarama yararlı olabilir. Bununla birlikte, gizli taramanın genel internet taraması için değil, geçici ve belirli oturumlar için önerildiğini unutmamak önemlidir.
...
İnternet bağlantınızı korumak, çevrimiçi güvenliğin çok önemli bir yönüdür ve sanal özel ağları (VPN'ler) kullanmak, hem işletmeler hem de bireysel kullanıcılar için bu güvenliği artırmak için etkili bir yöntemdir.
...
İki temel VPN türü vardır: kurumsal VPN'ler ve Nordvpn gibi tüketici VPN'leri. Kurumsal VPN'ler daha pahalı ve karmaşık olma eğilimindeyken, tüketici VPN'leri genellikle daha erişilebilir ve kullanıcı dostudur. Örneğin, NordVPN kullanıcıların internete başka bir ülkede bulunan bir sunucu üzerinden bağlanmasını ve böylece coğrafi kısıtlamaları atlamasını sağlar.
...
Çevrimiçi güvenlik açısından, 4G'nin genellikle halka açık Wi-Fi'den daha güvenli olduğunu anlamak önemlidir. Ancak 4G kullanmak mobil veri planınızı hızla tüketebilir. HTTPS protokolü, web sitelerindeki verileri şifrelemek için standart haline gelmiştir. Kullanıcı ile web sitesi arasında değiş tokuş edilen verilerin güvenli olmasını sağlar. Bu nedenle, ziyaret ettiğiniz sitenin HTTPS protokolünü kullandığını doğrulamak çok önemlidir.


Avrupa Birliği'nde veri koruma, Genel Veri Koruma Yönetmeliği (GDPR) tarafından düzenlenmektedir. Bu nedenle, kullanıcı bağlantı verilerini yeniden satmayan SNCF gibi Avrupa Wi-Fi erişim noktası sağlayıcılarını kullanmak daha güvenlidir. Bununla birlikte, bir sitenin asma kilit göstermesi onun gerçekliğini garanti etmez. Sitenin gerçekliğini teyit etmek için bir sertifika sistemi kullanarak sitenin açık anahtarını doğrulamak önemlidir. Veri şifreleme üçüncü tarafların değiş tokuş edilen verileri ele geçirmesini engellese de, kötü niyetli bir kişinin siteyi taklit etmesi ve verileri düz metin olarak aktarması hala mümkündür.
...
# Bilgisayar Kullanımı için En İyi Uygulamalar
...
- Bilgisayar seçimi
- Optimum güvenlik için güncellemeler ve antivirüs
- Bilgisayarınızın ve verilerinizin güvenliği için en iyi uygulamalar.


### Bilgisayar ve İşletim Sistemi Seçimi
...
Güncellemelerle ilgili kural basittir: **İşletim sistemi ve uygulamaların düzenli olarak güncellenmesi esastır.**


Windows 10'da güncellemeler neredeyse süreklidir ve bunları engellememek veya geciktirmemek çok önemlidir. Her yıl yaklaşık 15.000 güvenlik açığı tespit ediliyor ve bu da kötü amaçlı yazılımlara ve diğer siber tehditlere karşı korunmak için yazılımı güncel tutmanın önemini vurguluyor. Genel olarak, yazılım desteği piyasaya sürüldükten sonra 3 ila 5 yıl arasında sona erer, bu nedenle güvenlik güncellemelerinden yararlanmaya devam etmek için daha yüksek bir sürüme yükseltmek gerekir.


Bu kural neredeyse tüm yazılımlar için geçerlidir. Aslında güncellemeler makinenizi eski ya da yavaş hale getirmek için değil, yeni tehditlere karşı korumak için tasarlanmıştır. Hatta bazı güncellemeler önemli olarak kabul edilir ve bunlar olmadan bilgisayarınız ciddi bir istismar riski altındadır.


Somut bir hata örneği vermek gerekirse, güncellenemeyen crackli yazılımlar çifte potansiyel tehdit oluşturmaktadır. Şüpheli bir web sitesinden yasadışı olarak indirilmesi sırasında bir virüsün gelmesi ve yeni saldırı biçimlerine karşı güvensiz bir kullanım.
...
- Bir antivirüse ihtiyacınız var mı? EVET
- Ödeme yapmak zorunda mısınız? Duruma göre değişir!
...
Sonuç olarak, ihtiyaçlarınıza uygun bir işletim sistemi seçmeniz ve yüklü uygulamaların yanı sıra bu işletim sistemini de düzenli olarak güncellemeniz çok önemlidir. Bilgisayarınızı ve verilerinizi korumak için etkili ve kullanıcı dostu bir antivirüs programı kullanmak ve iyi güvenlik uygulamalarını benimsemek de çok önemlidir.


## Bilgisayar Korsanlığı ve Yedekleme Yönetimi: Verilerinizi Koruma
...
### Kimlik avı, sahte e-postalara karşı tetikte olma:


Dikkat! E-postalar saldırının ilk vektörüdür. İşte bazı ipuçları:



- Kimlik bilgileriniz ve parolalarınız gibi hassas bilgileri elde etmeyi amaçlayan kimlik avı girişimlerine karşı dikkatli olun. Şüpheli bağlantılara tıklamaktan ve gönderenin meşruiyetini doğrulamadan kişisel bilgilerinizi paylaşmaktan kaçının.
- E-posta ekleri ve resimler konusunda dikkatli olun:

E-posta ekleri ve resimler kötü amaçlı yazılım içerebilir. Bilinmeyen veya şüpheli gönderenlerden gelen ekleri indirmeyin veya açmayın ve antivirüs yazılımınızın güncel olduğundan emin olun.
...
- Harici bir Hard sürücüsü satın alın ve verilerinizi buna kopyalayın. Bağlantısını kesin ve evin içinde güvenli bir yerde saklayın. (Bunu iki kez yapmak ve sürücülerden birini başka bir yerde saklamak olası yangına karşı korunmaya yardımcı olur)



- ProtonMail Drive, Sync veya Google Drive kullanarak bir bulut yedeklemesi oluşturun. Hassas verilerinizi bu çevrimiçi ana bilgisayara yükleyin. Ancak, verilerinizin potansiyel olarak internette olduğunu ve güvenilir bir üçüncü taraf tarafından tutulduğunu unutmayın.


### Hackerlara ödeme yapmalı mısınız?


HAYIR, fidye yazılımı veya diğer saldırı türlerinde bilgisayar korsanlarına ödeme yapılması genellikle önerilmez. Fidye ödemek verilerinizin kurtarılmasını garanti etmez ve siber suçluları kötü niyetli faaliyetlerine devam etmeye teşvik edebilir. Bunun yerine, kendinizi korumak için önleme ve düzenli veri yedeklemeye öncelik verin.
...
E-posta hesabı çevrimiçi faaliyetlerinizin merkezi noktasıdır: eğer ele geçirilirse, bir bilgisayar korsanı bunu kullanarak "şifremi unuttum" işlevi aracılığıyla tüm şifrelerinizi sıfırlayabilir ve diğer birçok siteye erişim sağlayabilir. Bu yüzden düzgün bir şekilde güvence altına almanız gerekir.


E-posta hesabı benzersiz ve güçlü bir şifreyle (ayrıntılar bölüm 7'de) ve ideal olarak iki faktörlü bir kimlik doğrulama sistemiyle (ayrıntılar bölüm 8'de) oluşturulmalıdır.


Hepimizin zaten bir e-posta hesabı olsa da, yeni bir başlangıç yapmak için yeni ve daha modern bir hesap oluşturmayı düşünmek çok önemlidir.


### Bir e-posta sağlayıcısı seçme ve e-posta adreslerini yönetme
...
- Karmaşık: büyük ve küçük harflerin, sayıların ve sembollerin bir karışımı.
- Benzersiz: aynı parolayı farklı hesaplar için tekrar kullanmayın.
...
- SMS yoluyla gönderilen geçici bir kod.
- Google Authenticator veya Authy gibi bir uygulama tarafından oluşturulan bir kod.
...
Güçlü kimlik doğrulama için çeşitli seçenekler farklı güvenlik seviyeleri sağlar.
...
Biyometri bir ikame olarak kullanılabilir, ancak bilgi ve sahip olma kombinasyonundan daha az güvenlidir. Biyometrik veriler kimlik doğrulama cihazında saklanmalı ve çevrimiçi olarak ifşa edilmemelidir. Farklı kimlik doğrulama yöntemleriyle ilişkili tehdit modelini dikkate almak ve uygulamaları buna göre ayarlamak önemlidir.


Son olarak, HOTP ve TOTP OTP'leri hakkında kısa bir bilgi vermek faydalı olabilir: HOTP, HMAC (Hash tabanlı Mesaj Kimlik Doğrulama Kodu) algoritmasına dayanan tek seferlik bir parolayken, TOTP zaman tabanlı bir OTP'dir. Bu algoritmaların temel özellikleri, parolaların yalnızca bir kez kullanılabilmesi, üretilen her değerin benzersiz olması ve kullanıcının cihazı (istemci) ile kimlik doğrulama hizmeti (sunucu) arasında paylaşılan bir anahtarın bulunmasıdır. İki sistem arasındaki temel fark faktörün nasıl oluşturulduğudur: TOTP zaman tabanlı iken HOTP sistemi sayaç tabanlıdır.


### Kursun sonucu:


Anladığınız gibi, iyi bir dijital hijyen uygulamak her zaman basit değildir, ancak erişilebilir olmaya devam etmektedir!
...
Öğrenmeye devam edin ve yavaş yavaş iyi uygulamaları hayata geçirin!
...
Parola yönetimi dijital çağda zorlu bir görevdir. Hepimizin güvenliğini sağlamamız gereken çok sayıda çevrimiçi hesabı var. Bir parola yöneticisi, her hesap için güçlü ve benzersiz parolalar oluşturmanıza ve saklamanıza yardımcı olur.
...
Çevrimiçi gizliliğinizi korumak da güvenliğinizi sağlamak için çok önemli bir noktadır. VPN kullanmak bunu başarmak için ilk çözüm olabilir.
...
## Siber güvenlik sektöründe nasıl çalışılır?
...
Sistemleri ve verileri koruma konusunda tutkuluysanız, siber güvenlik alanı çok sayıda fırsat sunar. Bu sektör ilginizi çekiyorsa, işte size yol gösterecek bazı önemli adımlar.


### Akademik Temeller ve Sertifikalar:


Bilgisayar bilimleri, bilgi sistemleri veya ilgili bir alanda sağlam bir eğitim genellikle ideal bir başlangıç noktasıdır. Bu çalışmalar, siber güvenliğin teknik zorluklarını anlamak için gerekli temeli sağlar. Bu eğitimi tamamlamak için, bu alanda tanınmış sertifikalar almak akıllıca olacaktır. Bu sertifikalar bölgelere göre değişiklik gösterse de, CISSP veya CEH gibi bazıları dünya çapında tanınmaktadır.


Siber güvenlik çok geniş ve sürekli gelişen bir alandır. Temel araçlara ve farklı sistemlere aşina olmak çok önemlidir. Ayrıca, olay müdahalesinden etik korsanlığa kadar çok sayıda alt alanla, nişinizi belirlemek ve bu konuda uzmanlaşmak faydalıdır.
...
### Derinleşmek için Beceriler ve Araçlar:



- Siber Güvenlik Araçları: Wireshark, Metasploit, Nmap.
- İşletim Sistemleri: Linux, Windows, MacOS.
- Programlama Dilleri: Python, C, Java.
- Ağlar: TCP/IP, VPN, güvenlik duvarı.
- Veritabanları: SQL, NoSQL.
- Kriptografi: SSL/TLS, simetrik ve asimetrik şifreleme.
- Olay Yönetimi: Günlük analizi, olay müdahalesi.
- Etik Bilgisayar Korsanlığı: Sızma testi teknikleri ve izinsiz giriş testi.
- Yönetişim: ISO standartları, GDPR ve CCPA düzenlemeleri.
...
Şifre yöneticilerinden bahsederken göz önünde bulundurulması gereken üç temel boyut vardır: web sitelerinde şifrelerin oluşturulması, güncellenmesi ve uygulanması.


Otomatik parola doldurma için tarayıcı uzantılarının kullanılması genellikle önerilmez. Bu araçlar kullanıcıyı kimlik avı saldırılarına karşı daha savunmasız hale getirebilir. Siber güvenlik alanında tanınmış bir uzman olan Renaud, KeePass kullanarak parolaları uygulamaya elle kopyalayıp yapıştırmayı içeren manuel yönetimi tercih ediyor. Uzantılar saldırı yüzeyini artırma eğilimindedir, tarayıcı performansını yavaşlatabilir ve bu nedenle önemli bir risk oluşturur. Bu nedenle, tarayıcıda uzantı kullanımının en aza indirilmesi önerilen bir uygulamadır.
...
Şifreler, her yerde bulunmasına rağmen, kimlik doğrulama işlemi sırasında iletim riski de dahil olmak üzere çeşitli dezavantajlara sahiptir. Microsoft ve Apple gibi önde gelen şirketler, biyometri ve donanım belirteçleri de dahil olmak üzere yenilikçi alternatifler sunarak şifrelerin terk edilmesine yönelik ilerici bir eğilime işaret etmektedir.


Örneğin Passkeys, bir sağlayıcının barındırdığı ancak erişimlerinin dışında kalan yerel bir faktörle (biyometri veya PIN gibi) birleştirilmiş şifrelenmiş rastgele anahtarlar sunar. Bu, web sitelerinin güncellenmesini gerektirse de, yaklaşım şifre ihtiyacını ortadan kaldırarak geleneksel şifrelerle ilişkili kısıtlamalar veya dijital bir kasayı yönetme sorunu olmadan yüksek düzeyde güvenlik sağlar.


Passkiz, parola yönetimi için başka bir uygulanabilir ve güvenli alternatiftir. Bununla birlikte, önemli bir soru devam etmektedir: sağlayıcı arızası durumunda kullanılabilirlik. Bu nedenle internet devlerinin bu kullanılabilirliği garanti edecek sistemler önermesi arzu edilir.


İlgili hizmete doğrudan kimlik doğrulama, üçüncü bir tarafa olan ihtiyacı ortadan kaldıran uygulanabilir bir seçenektir. Ancak, internet devleri tarafından sunulan Tek Oturum Açma (SSO) da kullanılabilirlik ve sansür riskleri açısından sorun teşkil etmektedir. Veri sızıntılarını önlemek için, kimlik doğrulama işlemi sırasında toplanan bilgi miktarını en aza indirmek çok önemlidir.


### Bilgisayar güvenliği: güvenli uygulamaların zorunlulukları ve insan ihmaline bağlı riskler


Bilgisayar güvenliği basit uygulamalar ve "admin" gibi varsayılan parolaların kullanılmasıyla tehlikeye atılabilir. Bilgisayar güvenliğini tehlikeye atmak için her zaman sofistike saldırılar gerekli değildir. Örneğin, bir YouTube kanalının yönetici şifreleri bir şirketin özel kaynak koduyla yazılmıştır. Güvenlik açıkları genellikle insan ihmalinin sonucudur.


İnternetin son derece merkezi ve büyük ölçüde Amerikan kontrolü altında olduğunu da belirtmek gerekir. DNS sunucusu sansüre maruz kalabilir ve genellikle belirli sitelere erişimi engellemek için aldatıcı DNS kullanır. DNS, güvenlik sorunlarına yol açabilen eski ve güvensiz bir protokoldür. DNSsec gibi yeni protokoller ortaya çıkmıştır ancak hala yaygın olarak kullanılmamaktadır. Sansürü ve reklam engellemeyi aşmak için alternatif DNS sağlayıcıları seçmek mümkündür


Müdahaleci reklamlara alternatifler arasında Google DNS, OpenDNS ve diğer bağımsız hizmetler bulunmaktadır. Standart DNS protokolü, DNS sorgularını İnternet servis sağlayıcısına görünür kılar. DOH (HTTPS üzerinden DNS) ve DOT (TLS üzerinden DNS) DNS bağlantısını şifreleyerek daha fazla gizlilik ve güvenlik sağlar. Bu protokoller, gelişmiş güvenlikleri nedeniyle işletmelerde yaygın olarak kullanılmaktadır ve Windows, Android ve iPhone tarafından yerel olarak desteklenmektedir. DOH ve DOT kullanmak için IP Address yerine bir TLS ana bilgisayar adı girilmelidir. Ücretsiz DOH ve DOT sağlayıcıları çevrimiçi olarak mevcuttur. DOH ve DOT, "ortadaki adam" saldırılarını önleyerek gizliliği ve güvenliği artırır.


Ayrıca, bir e-posta Address veya kişisel bilgi sağlamaya gerek kalmadan her hizmet için farklı bir tanımlayıcı üreten "Lightning kimlik doğrulama" adlı sistemden de bahsetmek gerekir. Kullanıcı kontrollü merkezi olmayan kimliklere sahip olmak mümkündür, ancak merkezi olmayan kimlik projelerinde standardizasyon ve normalizasyon eksikliği vardır. Kötü niyetli saldırılardan kaçınmak için Microsoft Store dışında açık kaynaklı yazılım indirmeye izin veren NuGet ve Chocolaté gibi paket yöneticileri önerilir. Özetle, DNS çevrimiçi güvenlik için çok önemlidir; ancak DNS sunucularına yönelik olası saldırılara karşı tetikte olmak çok önemlidir.
