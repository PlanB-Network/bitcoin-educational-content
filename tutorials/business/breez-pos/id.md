...
Breez POS adalah layanan penyimpanan mandiri yang disediakan oleh Breez Wallet. Kegunaan dari layanan ini adalah untuk memungkinkan pedagang untuk mengumpulkan pembayaran melalui Bitcoin sambil tetap menggunakan Interface yang sederhana, sangat mirip dengan berbagai dompet Lightning. Breez POS tersedia di platform unduhan [Google Play Store] (https://play.google.com/store/apps/details?id=com.breez.client) (Android) dan [App Store] (https://apps.apple.com/app/breez-lightning-client-pos/id1463604142) (iOS).
...
Dalam menu "*Point of Sale*", Anda akan menemukan Interface untuk mengumpulkan pembayaran. Alat ini dibagi menjadi dua bagian:
...
Bagian pertama adalah keyboard debit langsung. Interface ini berguna untuk mengumpulkan pembayaran tunggal ketika Anda mengetahui total pembelian pelanggan Anda, atau ketika Anda tidak memerlukan katalog produk tetap dalam bisnis Anda (mis. layanan lepas).
...
Untuk menggunakan Breez POS untuk pertama kalinya, Anda harus mengumpulkan pembayaran lebih dari 2.500 satoshi (sekitar 3 euro dengan nilai tukar Exchange hari ini). Jumlah ini, yang dibayarkan hanya pada pembayaran pertama Anda, merupakan biaya untuk membuat saluran pembayaran sehingga Anda dapat berkomunikasi dengan node Lightning Network lainnya dan mengirim dan menerima satoshi.
...
Bagian kedua adalah katalog produk. Interface ini sangat ideal jika Anda memiliki katalog produk dengan harga yang telah ditentukan sebelumnya. Di sini Anda dapat melakukan pra-konfigurasi produk Anda dan kemudian menggunakannya pada faktur generate untuk meningkatkan penelusuran penerimaan kas Anda.
...
Anda dapat mengonfigurasi secara manual setiap item dari Interface ini dengan mengklik tombol "**Plus**" dan kemudian menentukan nama, harga, dan pengenal untuk item ini.
...
Pada bagian yang sama, Anda dapat menentukan masa berlaku faktur Lightning Anda. Mulai sekarang, untuk semua faktur Anda, pelanggan Anda memiliki waktu `N` detik untuk melakukan pembayaran, jika tidak, Anda harus membuat ulang Lightning Invoice yang baru.
