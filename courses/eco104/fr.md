...
Cela dit, sans une personne... ou un groupe (nous ne savons pas avec certitude), Bitcoin n'existerait pas. Et c'est Satoshi Nakamoto. Le créateur énigmatique.
...
- **Sécurisé :** Les transactions Bitcoin sont sécurisées en utilisant la cryptographie, rendant la contrefaçon ou la double dépense des pièces difficile.
...
- **Divisible :** L'extrême divisibilité du bitcoin est l'un de ses principaux avantages en tant que monnaie. Chaque bitcoin étant divisible jusqu'à huit décimales, la plus petite unité, un Satoshi, vaut seulement une fraction de centime. Selon la méthode de transaction, c'est-à-dire via la couche une (Bitcoin) ou la deux (Lightning), cela rend le bitcoin hautement adaptable à des transactions de toute taille, des petits achats aux grands investissements.
...
Les stablecoins de Tether, tels que USDt, soutenus par des dollars américains, ou XAUt, soutenus par de l'or, offrent un avantage distinct par rapport aux monnaies traditionnelles en ce qu'ils fonctionnent de manière indépendante, en dehors des contraintes des heures bancaires traditionnelles et des limitations. En conséquence, ils sont accessibles 24/7, accordant aux individus un plus grand contrôle et une plus grande flexibilité sur leur argent.
...
Cela dit, les stablecoins offerts par Tether, comme USDt, diffèrent également des monnaies fiat traditionnelles. Bien qu'ils maintiennent un lien avec la valeur d'actifs comme l'USD, ils ne sont pas des monnaies émises par le gouvernement et n'ont aucune allégeance à une nation. Cette caractéristique leur accorde un avantage unique, surtout dans les pays aux prises avec l'inflation, où l'accès à des monnaies plus stables comme l'USD peut être difficile. Contrairement à l'argent physique, obtenir USDt ou d'autres stablecoins via un échange en ligne nécessite simplement une connexion internet, assurant l'accessibilité indépendamment de la localisation géographique de quelqu'un. Par conséquent, la distinction clé entre les monnaies fiat et les divers stablecoins de Tether réside dans l'indifférence juridictionnelle : cela fonctionne sans problème à travers les frontières, permettant un accès mondial à une monnaie numérique stable. De plus, les stablecoins offrent des avantages tels que des frais de transaction réduits, des transactions transfrontalières plus rapides et une inclusivité financière accrue, les rendant une alternative attrayante aux monnaies fiat traditionnelles.
...
- **Les stablecoins adossés à des fiat**, comme le USDt de Tether, sont soutenus par des monnaies traditionnelles comme le dollar américain ou l'euro, et leur valeur est directement liée à la valeur de la monnaie fiat sous-jacente.
...
Le but d'un stablecoin, comme USDt, est de fournir un magasin de valeur numérique relativement stable par rapport à la volatilité expérimentée non seulement par d'autres cryptomonnaies, mais aussi par d'autres monnaies fiat comme le peso argentin, qui a perdu [97%](https://www.statista.com/statistics/316750/inflation-rate-in-argentina/) de son pouvoir d'achat entre 2012 et 2022.
...
La majorité des stablecoins choisissent souvent d'utiliser une monnaie fiat comme leur étalon, le dollar américain étant l'une des monnaies fiat les plus populaires à laquelle s'adosser. Pour cette raison, nous allons d'abord explorer les stablecoins adossés à la fiat. Cependant, il existe plusieurs types de stablecoins, tels que ceux adossés à des matières premières et algorithmiques, que nous explorerons également.

### Adossés à la Fiat

Les stablecoins sont conçus pour maintenir une valeur stable par rapport à un actif adossé. En ce qui concerne les stablecoins adossés à la fiat, comme USDt, la manière la plus simple pour le jeton de maintenir sa valeur est que l'émetteur du jeton détienne la monnaie à laquelle le jeton est adossé dans un rapport de 1:1.

Cela semble un peu confus ? Ne vous inquiétez pas. Voici un exemple :
Supposons que vous ayez 50 $ US et que vous souhaitiez envoyer cet argent à vos amis et à votre famille en utilisant USDt. Pour initier ce processus, vous vous connectez à votre plateforme d'échange en ligne et échangez vos 50 $ US contre 50 USDt. Cependant, cet échange ne crée pas simplement 50 $ de USDt frais. Au contraire, périodiquement, lorsque les réserves de USDt de la plateforme d'échange sont basses, l'émetteur, dans ce scénario Tether, génère de nouveaux USDt pour la plateforme en échange de USD. Les USD soutiennent ces jetons USDt nouvellement créés. Cela garantit que chaque 1 $ USDt en circulation est étayé par un équivalent en espèces ou en équivalents de trésorerie.

Avec cela à l'esprit, lorsque vous acquérez des USDt, il ne s'agit pas d'une émission fraîchement mintée. Plutôt, à un moment antérieur, la plateforme d'échange a échangé des USD contre des USDt, que vous êtes maintenant en train d'acquérir de la plateforme. Au fur et à mesure que le temps passe et que plus d'utilisateurs achètent des USDt, les réserves de la plateforme diminuent tandis que ses avoirs en USD augmentent. Cela incite la plateforme à communiquer à nouveau avec Tether pour générer des USDt supplémentaires en échange de USD.
...
Considérez USDC, le deuxième stablecoin le plus populaire après USDt. Lorsque Silicon Valley Bank a fait faillite en mars 2023, USDC a temporairement perdu son ancrage 1:1 avec le USD et s'est échangé aussi bas que 0,88 $. C'est une perte de 12 % de pouvoir d'achat du jour au lendemain, ce qui est préoccupant pour quelque chose censé être stable en prix.
La raison de cette chute de prix était que Circle, l'émetteur de USDC, avait gardé une partie de ses réserves à Silicon Valley Bank. En conséquence, lorsque les gens ont commencé à vendre leurs avoirs en USDC par peur que Circle ne puisse pas honorer toutes les demandes de rachat, la panique s'est installée. Heureusement pour Circle, la Réserve Fédérale et la Federal Deposit Insurance Corporation (FDIC) sont intervenues et ont garanti tous les dépôts de la banque. Cela signifiait que Circle ne perdrait pas ses réserves, et USDC s'est rapidement rétabli à 1 $. Cependant, cela aurait pu facilement aller dans l'autre sens, laissant USDC comme un vestige du passé. Avec cela à l'esprit, il est important de rechercher les différents stablecoins disponibles avant de choisir d'investir ou de commercer.

Malgré ces lacunes, la majorité des stablecoins de confiance sont adossés à la monnaie fiduciaire. Des jetons comme le USDt de Tether utilisent cette méthode de soutien et déplacent régulièrement 5 milliards de dollars ou plus quotidiennement.
...
Au fur et à mesure qu'elle continue d'explorer les possibilités offertes par USDt, Adanna réalise que cette technologie peut potentiellement transformer la vie des personnes dans des situations similaires. Avec USDt, tout le monde a accès à la liberté et à la sécurité financières qui ont été principalement hors de portée pour tant de personnes.

Voici deux des nombreux avantages associés aux stablecoins, comme USDt :
...
En plus de l'USDt adossé au dollar américain, Tether propose le XAUt—garanti par l'or—offrant une alternative encore plus robuste pour les personnes cherchant à échapper aux taux d'inflation élevés. L'or a été un moyen de préservation de la valeur de confiance pendant des siècles, grâce à sa rareté et à sa stabilité des prix. Cependant, jusqu'à récemment, il n'était pas possible d'utiliser l'or comme moyen de paiement numérique. Le XAUt, soutenu par l'or, résout ce problème en fournissant une méthode de transaction en or sans nécessiter la possession physique. En conséquence, les gens peuvent protéger leur pouvoir d'achat, que ce soit leur monnaie ou le dollar américain qui subisse une inflation élevée.

Vous pourriez dire : Mais qu'en est-il de l'e-gold dans les années 90 ?

Premièrement, les structures opérationnelles et de réserve de l'eGold étaient fortement centralisées et manquaient de la transparence des stablecoins modernes comme le XAUt. Par conséquent, des doutes ont émergé concernant le véritable soutien en or des jetons eGold.

Deuxièmement, l'eGold a fait ses débuts pendant une période où le marché des cryptomonnaies était considérablement moins développé. Par conséquent, il a lutté pour obtenir une reconnaissance généralisée. Ces défis combinés ont conduit l'eGold à rencontrer d'importants obstacles réglementaires et complications légales, conduisant finalement à sa chute.
...
Les frais réduits, comme discuté ci-dessus, constituent un autre avantage majeur des stablecoins de Tether. Contrairement aux monnaies fiat traditionnelles, USDt, ainsi que toutes leurs autres offres, impliquent moins d'intermédiaires dans chaque transaction, ce qui signifie que nous conservons bien plus de notre pouvoir d'achat — avec les stablecoins, nous gardons plus de ce que nous gagnons.
...
Enfin et surtout, Tether joue un rôle essentiel dans l'augmentation de l'adoption du Bitcoin en agissant comme un pont entre la banque traditionnelle et les rails décentralisés, sans confiance et sans permission du Bitcoin.

Avant l'avènement des stablecoins, comme USDt, effectuer des transactions entrantes et sortantes en bitcoin était un processus complexe et risqué. Nous devions soit trouver quelqu'un prêt à échanger son bitcoin contre notre argent, soit localiser une banque ou une bourse favorable au Bitcoin. Cela rendait difficile l'achat et la vente de bitcoin, surtout si nous vivions dans une juridiction hostile à cet argent magique d'internet. Et même si nous trouvions un moyen de réaliser des transactions entrantes et sortantes, nous devions nous reposer lourdement sur le secteur bancaire traditionnel et espérer qu'ils ne gèleraient pas notre compte ou n'entraveraient pas notre capacité à acheter ou vendre du bitcoin.

Avec l'essor des différents stablecoins de Tether, la situation a changé. USDt et XAUt offrent désormais un moyen d'échange numérique fiable qui relie les rails bancaires traditionnels aux rails décentralisés et sans confiance du Bitcoin. En utilisant ces stablecoins, les individus peuvent désormais effectuer des transactions entrantes et sortantes en bitcoin facilement et sans avoir à revenir sur les rails bancaires traditionnels. Cela a conduit à une adoption accrue du Bitcoin, les gens pouvant désormais réaliser des transactions entrantes et sortantes sans se soucier des barrières imposées par le système financier traditionnel.
...
Avec cela à l'esprit, les stablecoins changent la manière dont nous effectuons des transactions avec des actifs souverains, comme le Bitcoin, en fournissant un pont transparent et facile à utiliser entre la banque traditionnelle et le monde numérique décentralisé. À mesure que l'adoption des stablecoins continue de croître, nous pouvons nous attendre à voir une adoption encore plus grande du Bitcoin alors que de plus en plus de personnes réalisent qu'il n'est pas nécessaire de réintégrer le monde bancaire traditionnel, étant donné l'utilisabilité et la nature numérique des stablecoins.
...
Prenons, par exemple, l'histoire d'Adanna, qui illustre comment le USDt peut aider des personnes comme elle à échapper à leur monnaie locale rapidement détériorée et à avoir plus de contrôle sur leur argent sans jamais avoir à s'inquiéter de l'instabilité monétaire ou du fait que le USDt offre une solution cruciale pour la population non bancarisée, permettant l'accès à une monnaie numérique, ce qui donne du pouvoir aux individus qui manquaient auparavant de telles opportunités.
...
Dans l'ensemble, les stablecoins, comme le USDt et le XAUt, ont le potentiel de transformer la vie de milliards de personnes en leur offrant l'accès à des services financiers inclusifs et très nécessaires.
...
Premièrement, le bitcoin a une offre limitée de 21 millions de pièces, ce qui signifie que, contrairement aux monnaies fiduciaires traditionnelles, il ne peut pas être dévalué par l'expansion monétaire. Cette rareté, combinée à l'adoption mondiale croissante du Bitcoin, a conduit à une augmentation régulière mais volatile de sa valeur au fil du temps. Cela est différent de tout autre actif, où, à mesure que les prix augmentent, l'offre augmente également. Cela signifie que l'offre submergera la demande à un certain point, et les prix devront s'effondrer.

Deuxièmement, intégrée dans le code du Bitcoin est une fonctionnalité appelée le halving. Environ tous les quatre ans, cet événement réduit de moitié la récompense de minage, impactant les revenus nominaux des mineurs. À moins que le prix du bitcoin ne double, les mineurs subissent une diminution substantielle de leurs gains. Cet aspect a conduit à caractériser le Bitcoin comme une technologie "le chiffre monte", car cette fonctionnalité exerce une pression à la hausse sur le prix tous les quatre ans pour garantir que les mineurs reçoivent une compensation adéquate pour sécuriser la blockchain. Par conséquent, nous assistons à ces fluctuations de prix volatiles environ tous les quatre ans.
...
Enfin, la valeur totale du marché du bitcoin se situe juste en dessous de 550 milliards de dollars américains. Cela peut sembler être un montant astronomique jusqu'à ce que vous réalisiez que l'or, selon les calculs, se situe quelque part entre 10 billions et 20 billions de dollars. Cela signifie que, bien que le Bitcoin offre bon nombre des mêmes avantages que l'or, il se négocie à 1/40ème de la valeur. Et lorsque nous regardons d'autres actifs, cette divergence est encore plus grande.
...
- Marché mondial des dérivés : Estimé à plus de [1 quadrillion de dollars](https://www.investopedia.com/ask/answers/052715/how-big-derivatives-market.asp)
...
#### Idée fausse numéro deux : Bitcoin est trop volatile pour avoir de la valeur
...
Premièrement, la volatilité de Bitcoin est un sujet brûlant de débat et a conduit certains à critiquer l'actif pour ses fluctuations de prix importantes. Nous pensons que c'est une vision étroite de la volatilité car la volatilité mesure le mouvement de prix d'un actif, pas seulement ses baisses. Ceux qui ont le courage de conserver Bitcoin malgré ses fluctuations ont été richement récompensés. Prenons les actifs A et B, par exemple. L'actif A augmente en moyenne de 10% par an avec un écart de 15%, tandis que l'actif B se déplace de 5% par an avec un écart de 10%. Bien que l'actif B ait une volatilité inférieure à celle de l'actif A, l'actif A surpasse l'actif B à long terme. Vous devez être prêt à supporter la volatilité pour récolter les récompenses des mouvements de prix de Bitcoin. De plus, le USD peut être moins volatile au jour le jour. Cependant, si vous avez détenu la monnaie au cours des 100 dernières années, vous avez perdu [96%](https://www.visualcapitalist.com/purchasing-power-of-the-u-s-dollar-over-time/) de votre pouvoir d'achat.

Deuxièmement, la volatilité est un phénomène naturel en ce qui concerne l'adoption technologique. Lorsqu'une nouvelle technologie est introduite, il est inévitable qu'il y ait de l'incertitude et des spéculations sur son potentiel, ce qui conduit à des fluctuations de prix. L'intelligence artificielle (AI) est un exemple parfait d'un secteur hautement volatile. De [2021 à 2022](https://www.precedenceresearch.com/artificial-intelligence-market#:~:text=The%20global%20artificial%20intelligence%20(AI,USD%2051%20billion%20in%202021.), la valeur totale de l'AI est passée de 51 milliards de dollars à 119 milliards de dollars. Cependant, malgré sa volatilité, les avantages d'investir dans l'AI ne peuvent pas être ignorés. Des voitures autonomes aux soins de santé personnalisés, les applications potentielles de l'AI sont immenses. Donc, si vous vous intéressez à l'AI, vous ne voudriez pas manquer les opportunités qu'elle présente juste à cause de sa volatilité.
...
Bitcoin choisit de privilégier la décentralisation et la sécurité plutôt que la scalabilité. Néanmoins, cette scalabilité est tout de même atteinte. Elle est simplement réalisée par des moyens alternatifs (discutés dans le prochain malentendu). D'autres cryptomonnaies, cependant, privilégient souvent la scalabilité, mais en faisant cela, elles sacrifient la décentralisation, les rendant vulnérables aux attaques ou sans différence par rapport à la monnaie fiduciaire ou à une sécurité.
...
#### Malentendu Cinq : Bitcoin est trop lent et coûteux pour être un moyen d'échange efficace

Si vous vous souvenez de la Section Quatre du Module Deux, la blockchain de Bitcoin est composée de blocs, chacun ayant une taille maximale d'environ 1mb. En raison de la taille limitée des blocs, la couche de base de Bitcoin a une limite supérieure de traitement d'environ sept transactions par seconde (tps), bien inférieure à des réseaux comme Visa ou Mastercard, qui traitent à 1 700 tps. Ainsi, on dit souvent que Bitcoin est trop lent pour fonctionner jamais comme un moyen d'échange viable.
Cependant, il est vital de souligner que Bitcoin ne cherche pas à concurrencer Visa ou Mastercard. Au lieu de cela, il est plus similaire à la couche un, capable de traiter des transactions de grande valeur mais à une fraction de la vitesse et du coût des méthodes traditionnelles de couche un tout en étant sans confiance, sans permission et offrant des transactions avec règlement final.
Mais Bitcoin concurrence également avec les méthodes de transaction de couche deux, avec des technologies comme Lightning construites au-dessus de la couche un. Lightning permet des transactions quasi-instantanées avec des frais minimaux, rendant les microtransactions et les petits achats possibles. Depuis que le Salvador a adopté Bitcoin comme monnaie légale, la population générale utilise Lightning pour effectuer des transactions en Bitcoin en raison de ses avantages inégalés, tels que des temps de transaction presque instantanés et des frais pour une fraction de centime. Cela en fait un choix parfait pour les petits commerçants et les individus.
...
De manière similaire à la consommation d'énergie dans l'extraction de l'or physique, les mineurs de Bitcoin consomment de l'énergie dans leur quête d'acquérir bitcoin. Cette exigence d'énergie réelle ancre un actif numérique autrement intangible au monde physique. De plus, avec le vaste réseau de mineurs dans le monde dépensant de l'énergie pour sécuriser le réseau Bitcoin, la consommation d'énergie pour obtenir bitcoin sert de puissant mécanisme de défense contre la centralisation et la manipulation indue. Pour cette raison, il est extrêmement difficile pour les entités centralisées de coopter le réseau ou de manipuler les règles en leur faveur, car elles devraient surpasser les innombrables mineurs répartis dans le monde.
...
#### Idée Fausses Un : La plupart des stablecoins ne sont pas entièrement couverts par des réserves

Lorsqu'il s'agit de comprendre les stablecoins, il est essentiel de reconnaître que chaque stablecoin fonctionne selon des principes et des cadres uniques. Certains projets de stablecoin font preuve d'une diligence et d'une transparence exceptionnelles en fournissant des informations détaillées sur leurs réserves et en publiant régulièrement des attestations les vérifiant. Par exemple, Tether soutient fortement la transparence, visible par leurs attestations, auxquelles on peut accéder pour obtenir un aperçu de leur réserve ici. Ces attestations servent de témoignage de leur engagement à privilégier le client.

Cependant, ce n'est pas le cas pour tous les stablecoins, nombreux étant ceux qui n'offrent pas le même niveau de transparence. Par conséquent, nous ne pouvons pas assez souligner l'importance de mener une recherche approfondie avant de confier une richesse significative à un stablecoin particulier. De plus, il y a un niveau de confiance que l'utilisateur doit placer chez l'émetteur du stablecoin, indépendamment du niveau de transparence.
