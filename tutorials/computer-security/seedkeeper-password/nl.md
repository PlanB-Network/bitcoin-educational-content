...
De Seedkeeper is een smartcard ontwikkeld door Satochip, een Belgisch bedrijf gespecialiseerd in hardware-oplossingen voor het beheren en beschermen van digitale geheimen. Satochip, bekend om zijn reeks smartcards voor het Bitcoin ecosysteem, bedacht de Seedkeeper als alternatief voor traditionele methodes om Mnemonic zinnen en andere digitale geheimen op te slaan.



Concreet heeft de Seedkeeper de vorm van een multifunctionele, EAL6-gecertificeerde smartcard met een beveiligde processor en een fraudebestendig geheugen (d.w.z. een "*secure element*"). Zoals de naam al suggereert, is het de taak van de kaart om Bitcoin portfoliomemonie en wachtwoorden versleuteld en beschermd op te slaan. Met Seedkeeper kun je je geheimen generate importeren, organiseren en direct opslaan in de beveiligde component van de kaart.
...
- Bitcoin** Mnemonic zinsdeelopslag: in plaats van je 12 of 24 woorden op papier te zetten, kun je ze importeren in de smartcard en ze beveiligen met een pincode.
...
In deze tutorial behandelen we alleen het gebruik van SeedKeeper voor traditionele wachtwoorden, op de manier van een wachtwoordmanager. Als je SeedKeeper wilt gebruiken om Bitcoin Wallet Mnemonic zinnen op te slaan, bekijk dan deze andere tutorial:
...
Selecteer "generate geheim*". Met de optie "*Importeer een geheim*" kun je een bestaand geheim opslaan (bijvoorbeeld een wachtwoord dat je in het verleden hebt aangemaakt).
...
Wijs een "*Label*" toe aan dit geheim, zodat het gemakkelijk kan worden geïdentificeerd als je meerdere gegevens in je Seedkeeper opslaat. Je kunt ook een gebruikersnaam koppelen aan het wachtwoord en de URL van de site.
...
Dit brengt je naar een lijst met al je geregistreerde geheimen. In dit voorbeeld wil ik het wachtwoord voor mijn Plan ₿ Network account tonen, dus klik ik erop.
...
Dat is alles! Nu weet je hoe je Seedkeeper kunt gebruiken om je wachtwoorden op te slaan. In een toekomstige tutorial zullen we kijken hoe je Seedkeeper kunt gebruiken om een back-up te maken van een Bitcoin portfolio. Ik nodig je ook uit om het gecombineerde gebruik met SeedSigner te ontdekken:
