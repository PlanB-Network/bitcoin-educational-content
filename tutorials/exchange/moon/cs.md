...
Moon umožňuje používat kryptoměny, jako je Bitcoin, k nákupu virtuálních karet Visa a dárkových karet bez nutnosti KYC, které lze používat u milionů online obchodníků stejně jako tradiční bankovní karty. Nabízí tak jednoduchý způsob, jak utrácet Sats všude, kde je přijímána Visa, aniž by bylo nutné procházet platformou Exchange.



Tento přístup ilustruje hlavní ambice společnosti Moon: zpřístupnit používání Bitcoin široké veřejnosti tím, že usnadní každodenní platby po celém světě, a zároveň čekat, až tento platební prostředek bude nativně přijímat více obchodníků. Je to jakýsi most mezi Bitcoin a tradičním bankovním světem. V tomto tutoriálu vás zveme k seznámení s touto inovativní službou, jejím konceptem a hlavními funkcemi, které nabízí.
...
Moon přináší zásadní inovaci: možnost používat k napájení těchto virtuálních bankovních karet Bitcoin a další kryptoměny. Služba využívá infrastrukturu společnosti Visa a umožňuje získat dobíjecí karty Bitcoin (Lightning), aniž byste si museli otevřít bankovní účet nebo poskytnout jakékoli identifikační údaje, a to až do výše stanovených limitů použití.
...
Přejděte na [oficiální platformu](https://paywithmoon.com), klikněte na tlačítko **"Registrovat "**, projděte lidským ověřením (CAPTCHA) a zaregistrujte se zadáním e-mailu Address a hesla.
...
Jak jste si možná všimli, získání této virtuální karty nevyžaduje žádné identifikační údaje: potřebujete pouze e-mail Address a heslo. KYC je vyžadováno pouze v případě, že překročíte měsíční výdajové limity.
...
Minimální částka na jedno dobití je stanovena na 5 USD, přičemž horní limit dobití karty Moon X není stanoven. Vložte částku, kterou si přejete dobít, a poté zaplaťte vygenerovanou částku Lightning Invoice.
...
Vaše karta bude automaticky připsána na účet, jakmile bude potvrzena platba za Invoice Lightning.
...
Zveme vás také na náš návod na Bitrefill, jak pomocí Bitcoin platit dárkovými kartami z vašich oblíbených služeb:
