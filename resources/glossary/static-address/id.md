...
Alamat ini terdiri dari dua kunci publik: $B_{\text{scan}}$ untuk pemindaian dan $B_{\text{spend}}$ untuk pengeluaran, yang digabungkan untuk membentuk alamat statis $B = B_{\text{scan}} \text{ ‖ } B_{\text{belanja}}$. Penerima mempublikasikan alamat ini, sehingga pengirim dapat memperoleh alamat pembayaran yang unik tanpa perlu berinteraksi lebih lanjut dengan penerima. Untuk mengelola beberapa sumber pembayaran yang berbeda, sebuah label dapat ditambahkan ke $B_{\text{spend}}$, sehingga menciptakan beberapa alamat statis berlabel dari $B_1$, $B_2$, dan seterusnya. Hal ini memungkinkan pemisahan pembayaran dengan menggunakan satu alamat dasar, sehingga mengurangi beban kerja untuk pemindaian _blockchain_. Akan tetapi, semua alamat statis dari sebuah entitas dapat dengan mudah dihubungkan karena penggunaan umum dari $B_{\text{scan}}$.
