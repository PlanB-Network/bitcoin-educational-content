...
在本教程中，我们将学习如何在**Pears**上运行应用程序，这是一种由**Holepunch**开发、**Tether**支持的点对点（P2P）技术。其目的很简单：使网络应用程序的发布和使用无需依赖任何集中式基础设施（无服务器、无主机、无中介）。换句话说，即使云提供商倒闭或某个国家封锁了某个域名，应用程序也能在网络对等方中继续运行。
...
- Secretstream**：E2E 加密协议，用于保护两个对等方之间的交换。
