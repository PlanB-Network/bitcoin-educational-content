...
Phoenix is a self-custodial [Lightning](https://planb.academy/resources/glossary/lightning-network) wallet and node developed by ACINQ, a French company specializing in Lightning-based software solutions. Unlike custodial Lightning wallets such as Wallet of Satoshi, where bitcoins are held by a third party, Phoenix enables users to retain full control of their [private keys](https://planb.academy/resources/glossary/private-key).
...
Before we get started, we need to save our 12-word [mnemonic phrase](https://planb.academy/resources/glossary/mnemonic-phrase). This phrase gives complete, unrestricted access to all your bitcoins. Anyone in possession of this phrase can steal your funds, even without physical access to your phone.
