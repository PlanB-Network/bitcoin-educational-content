...
definition: Klasifikasi BIP menjadi 4 kategori Consensus, Peer Services, API/RPC, dan Applications.
---
...
- *Konsensus*: menyangkut proposal yang membutuhkan perubahan konsensus dan mempengaruhi kompatibilitas antara versi protokol Bitcoin sebelumnya dan yang akan datang (_soft fork_ dan _hard fork_);
