---
name: Bitika
description: Comprar bitcoin através do M-Pesa em três passos simples
---
...
A solução **Bitika** é uma plataforma queniana concebida não para impor novos instrumentos às transacções quotidianas, mas para acompanhar a população local em direção ao Bitcoin através do M-Pesa, a que estão habituados há anos.



Os quenianos podem assim comprar satoshis em três passos simples, sem KYC ou plataformas de câmbio complexas.
...
2. o campo para colar o seu endereço Lightning (apenas endereços) ;


3. preço do gW-3 em tempo real em dólares ;
...
1. introduza o montante da sua compra (em **KES**) e o endereço Lightning do seu wallet;
...
Não se esqueça de verificar cuidadosamente os dados e de assinalar a caixa antes de iniciar o pagamento. Além disso, aplicam-se taxas de serviço.
...
Estes portefólios são apenas recomendações. Pode utilizar qualquer wallet que suporte Lightning Network, desde que possa generate um endereço.



Para se manter a par das notícias sobre a solução, pode subscrever a sua conta X (por exemplo, Twitter) ou escrever para o seu número WhatsApp, clicando nos ícones no canto inferior direito.
...
Consulte também o nosso tutorial sobre o Tando, outra solução queniana que lhe permite pagar bens e serviços, enviar dinheiro ou pagar contas com o Bitcoin.
