...
| 側面 | Wasabi | Whirlpool/Ashigaru | JoinMarket | **Joinstr** |
|--------|--------|--------------------|------------|-------------|
| **プール当たりの参加者** | 50-100 | 5-10 | 可変 (P2P) | **2-5** |
| **コーディネーター** | 中央集約化 (2024年閉鎖) | 中央集約化 (アクティブ) | P2P maker/taker | **なし (Nostr)** |
| **検閲耐性** | 弱い | 中程度 | 非常に高い | **非常に高い** |
| **コーディネーション手数料** | パーセンテージ | エントリー手数料 | メーカーに支払済み | **なし** |
| **UTXO差別** | はい (ブラックリスト) | いいえ | いいえ | **いいえ** |
