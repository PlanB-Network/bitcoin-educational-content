...
> ► *Urabe maso ntuvange `inyandikoIcabona` n'inyandikoIcabona`. Naho `scriptWitness` irimwo amakuru y'icabona ku vyo SegWit yose yinjiza, `witnessScript` isobanura ingene P2WSH canke P2SH-P2WSH UTXO ikoreshwa kandi ikaba igize inyandiko mu buryo bwayo bwite, isa n'iyi `redeemscript` ku vyo P2SH isohora.