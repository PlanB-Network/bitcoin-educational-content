...
Kuna aina mbalimbali za 2FA. Nambari za misimbo za SMS ni bora kuliko kitu chochote, lakini zinaendelea kuwa hatarini kwa uvamizi wa kubadilishana SIM na kuingiliwa. Hatupendekezi SMS kama 2FA msingi. Programu za uthibitishaji (TOTP) misimbo ya muda ya generate ndani ya kifaa chako, hivyo kuzifanya kuwa ngumu zaidi kuzipata. Funguo za usalama halisi hutoa usalama bora zaidi, lakini zinahitaji maunzi maalum.
...
Proton Authenticator inapatikana bila malipo kwenye mifumo yote. Ili kupakua programu, nenda kwenye ukurasa rasmi: [https://proton.me/fr/authenticator/download](https://proton.me/fr/authenticator/download)
...
Kwenye ukurasa huu, utapata viungo vya kupakua vya mifumo yote ya uendeshaji: Android, iOS, Windows, macOS na Linux. Bonyeza tu kwenye mfumo wa uendeshaji unaopenda na ufuate hatua za usakinishaji wa kawaida.



Katika somo hili, tutakuonyesha jinsi ya kusakinisha na kusanidi kwenye macOS, na kisha tutaangalia jinsi ya kusakinisha programu kwenye iOS na kusawazisha misimbo yako kati ya vifaa viwili.



### Ufungaji kwenye macOS
...
*Ingiza mchawi wa kuhamisha misimbo kutoka kwa programu zingine za uthibitishaji*
...
*Programu zinazooana za uingizaji: 2FAS, Aegis Authenticator, Authy, Bitwarden Authenticator, Ente Auth na Google Authenticator*



### Ulinzi wa maombi ya ndani



Weka PIN ya kufungua, au uwashe ufunguaji wa kibayometriki (Touch ID) ikiwa inapatikana. Hatua hii ni muhimu ili kuzuia mtu yeyote anayetumia Mac yako kupata ufikiaji bila malipo kwa misimbo yako ya 2FA.
...
*Skrini ya usanidi wa Kitambulisho cha Gusa na ujumbe wa "Linda data yako" na kitufe cha "Amilisha Kitambulisho cha Kugusa"*
...
Programu pia hukuruhusu kuamilisha ulandanishi wa iCloud ili kuhifadhi nakala ya data yako kwa usalama kati ya vifaa vyako vya Apple.
...
*Chaguo la maingiliano la ICloud na ujumbe "Hifadhi data yako kwa usalama na maingiliano ya iCloud iliyosimbwa"*
...
*Kithibitishaji kikuu tupu cha Interface chenye "Unda nambari mpya" na "Leta misimbo"* chaguzi



## Ongeza akaunti ya 2FA ukitumia ProtonMail



Sasa tutaangalia jinsi ya kuongeza msimbo wako wa kwanza wa 2FA, kwa kutumia ProtonMail kama mfano. Njia hii inafanya kazi sawa kwa huduma zote zinazotumia uthibitishaji wa vipengele viwili.



### Washa 2FA kwenye ProtonMail



Kwanza kabisa, unaweza kushauriana na mwongozo wetu kwa ProtonMail kwa habari zaidi:
...
*Ukurasa wa mipangilio ya ProtonMail na chaguo la "Programu ya Kithibitishaji" katika sehemu ya "Uthibitishaji wa sababu mbili"*



Bofya kwenye kitufe ili kuwezesha kithibitishaji na ProtonMail itakuhimiza kuchagua programu ya uthibitishaji.
...
*Dirisha la usanidi la ProtonMail 2FA lenye vitufe vya "Ghairi" na "Inayofuata"*



Kisha ProtonMail itaonyesha msimbo wa QR ili uchanganue ukitumia programu yako ya uthibitishaji.
...
*Msimbo wa QR wa ProtonMail ili kuchanganua ukitumia programu yako ya uthibitishaji, na chaguo la "Weka ufunguo mwenyewe badala yake" linapatikana*



Ikiwa ungependa kuingiza ufunguo wewe mwenyewe, bofya "Ingiza ufunguo mwenyewe badala yake" ili kuona ufunguo wa siri.
...
*Ingizo mwenyewe la taarifa za 2FA: Ufunguo, Muda (30) na Nambari (6)*
...
Tumia kamera ya Mac yako kuchanganua msimbo wa QR unaoonyeshwa kwenye skrini ya ProtonMail. Baada ya kuchanganua msimbo wa QR, utapelekwa kwenye skrini mpya ya usanidi wa msimbo.
...
*Msimbo wa TOTP umetolewa kwa ProtonMail (848 812) huku muda uliosalia ukionyeshwa*
...
ProtonMail itakuomba uweke msimbo wa tarakimu 6 unaozalishwa na Proton Authenticator ili kuthibitisha kuwa 2FA inafanya kazi ipasavyo.
...
*Skrini ya uthibitishaji ya ProtonMail ikikuuliza uweke msimbo wa tarakimu 6 (848812)*



Nakili msimbo kutoka kwa programu (kwa kubofya juu yake) na ubandike kwenye ProtonMail ili kukamilisha kuwezesha.



Baada ya kuthibitishwa, ProtonMail itakuomba upakue misimbo yako ya urejeshaji. Ni muhimu kuwaokoa kwa uangalifu.
...
*Skrini ya misimbo ya uokoaji ya ProtonMail iliyo na orodha ya misimbo ya uokoaji na kitufe cha "Pakua"*
...
## Ufungaji wa IOS na uingizaji wa msimbo
...
### Njia ya 1: Hamisha/Ingiza kupitia faili ya JSON



Ikiwa hutumii ulandanishi wa kiotomatiki (akaunti ya iCloud au Proton), utahitaji kuhamisha misimbo yako kutoka kwa Mac yako hadi kwa iPhone yako:



**Hatua ya 1 - Hamisha kutoka kwa macOS** :
...
*Hamisha dirisha na jina la faili "Proton_Authenticator_backup_2025" na "Hifadhi"* kitufe



Hifadhi faili ya JSON kwenye Mac yako. Unaweza kuituma kwa barua pepe salama au kuihifadhi katika Hifadhi ya iCloud kwa ufikiaji kutoka kwa iPhone yako.



**Hatua ya 2 - Leta kwenye iOS** :
...
*Mchakato wa kuagiza kwenye iOS: ujanibishaji wa faili ya JSON, uthibitishaji wa uingizaji na skrini za usanidi ukitumia Kitambulisho cha Uso na chaguo za iCloud*



### Njia ya 2: Usawazishaji otomatiki
...
Ikiwa bado haujafungua akaunti ya Proton na ungependa kusawazisha kati ya mifumo tofauti ya uendeshaji, programu itakuhimiza kuunda au kuunganisha akaunti ya Proton.
...
**Kupitia iCloud (kwa mfumo ikolojia wa Apple pekee)** :


Ikiwa unatumia vifaa vya Apple pekee, unaweza kuchagua maingiliano ya iCloud katika mipangilio ya programu. Njia hii itasawazisha kiotomatiki na kwa usalama misimbo yako kati ya vifaa vyako vyote vya Apple, bila kuhitaji akaunti ya Proton.



## Hifadhi rudufu iliyosimbwa na kurejesha



Moja ya vipengele muhimu vya Proton Authenticator ni uhifadhi wake wa mwisho-mwisho wa misimbo ya 2FA, kuhakikisha kuwa upotevu au mabadiliko ya kifaa haimaanishi kwamba unapaswa kuanza tena.
...
Kwenye iOS, ukichagua iCloud badala ya akaunti ya Proton, data yako imesimbwa kwa viwango vya Apple. Hifadhi rudufu ya ndani kwenye Android hukuwezesha kusimba faili chelezo kwa nenosiri ulilochagua.



### Marejesho katika kesi ya kupoteza



Simu yako ikipotea, kuibiwa au ukibadilisha simu :
...
Kutumia kithibitishaji cha 2FA huongeza usalama wako sana, lakini mbinu fulani bora lazima zizingatiwe:



### Hifadhi misimbo yako ya dharura



Unapowasha 2FA kwenye huduma, mara nyingi hupewa orodha ya misimbo ya uokoaji. Ziweke nje ya simu yako (kwenye karatasi, kwenye kidhibiti cha nenosiri kilichosimbwa kwa njia fiche, n.k.). Katika tukio la kupoteza jumla kwa kithibitishaji chako, misimbo hii tuli itakuokoa.



### Usichanganye manenosiri yako na misimbo ya 2FA
...
### Washa njia kadhaa za 2FA



Kwa kweli, tumia zaidi ya kipengele kimoja cha pili kwenye akaunti zako muhimu. Usisite kuongeza ufunguo halisi wa usalama ikiwa huduma inaruhusu. Tazama mafunzo yetu juu ya funguo za kimwili za Yubikey kwa habari zaidi:
...
### Kuwa mwangalifu na kulinda kifaa chako
...
Utapata mwongozo wetu kwa Authy hapa chini:
...
### Vipimo vya usalama vilivyopendekezwa
...
- [Have I Been Pwned](https://haveibeenpwned.com/) - Angalia kama akaunti zako zimeingiliwa
- [2FA Directory](https://2fa.directory/) - Orodha ya huduma zinazosaidia 2FA



### Jumuiya na majadiliano
