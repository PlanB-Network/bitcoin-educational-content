...
- Blockstream App** 是一款手機（iOS、Android）和桌面應用程式，用於管理 Bitcoin 錢包和 Liquid Network 上的資產。於2016年被Blockstream收購，原名為_GreenAddress_，後更名為_Blockstream Green_（2019年），現名為_Blockstream app_（2025年）。
- 主要功能** ：
