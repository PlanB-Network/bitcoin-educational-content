...
Jag råder dig också att spara ditt lösenord i en lösenordshanterare. Det gör det lättare att komma åt och eliminerar risken för att glömma bort det. I vårt specifika fall är en lösenordshanterare att föredra framför ett pappersmedium. Vid ett inbrott kan din lagringsenhet visserligen bli stulen, men lösenordet i hanteringen kan inte hittas av angriparen, vilket förhindrar åtkomst till uppgifterna. Om din lösenordshanterare däremot blir stulen, krävs det fortfarande fysisk tillgång till enheten för att kunna utnyttja lösenordet och få tillgång till uppgifterna.
