...
Quando avvi l'applicazione per la prima volta, fai clic sul pulsante "*Sono un nuovo utente*".
...
Per evitare di perdere l'accesso al tuo account Olvid, ti consigliamo di impostare dei backup automatici. A tal fine, apri le impostazioni facendo clic sui tre punti in alto a destra dell'interfaccia, quindi selezionare "*Impostazioni*".

⚠️ **Attenzione**: dalla versione 3.7 di Olvid, la procedura per salvare i tuoi profili e contatti è stata sostituita da una nuova. Questo tutorial presenta ancora la vecchia versione. Puoi scoprire la nuova versione nelle loro FAQ: [💾 Salvare i tuoi profili](https://www.olvid.io/faq/sauvegarder-vos-profils/)
...
Quindi fai clic su "*generate una chiave di backup*". Questa chiave cripterà i tuoi backup. Se devi ripristinare il tuo account su un altro dispositivo e non avrai più accesso ad esso, avrai bisogno sia di un backup che di questa chiave per decifrarlo.

![Image](assets/fr/08.webp)

Conserva la chiave in un luogo sicuro. Puoi anche farne una copia cartacea.

![Image](assets/fr/09.webp)

Puoi quindi scegliere di creare un backup locale o un backup automatico su un servizio cloud. Questa seconda opzione è altamente consigliata per garantire l'accesso al proprio account Olvid in ogni circostanza, anche in caso di smarrimento del telefono.

![Image](assets/fr/10.webp)

Assicurati che l'opzione "*Attiva il backup automatico*" sia selezionata.
...
Olvid visualizza quindi il tuo ID utente. Puoi quindi trasmetterlo alle persone con cui desideri comunicare, in modo che possano aggiungerti come contatto.

Per aggiungere una persona, scansiona il suo ID con la fotocamera o incollalo manualmente facendo clic sui tre puntini in alto a destra.

![Image](assets/fr/14.webp)

Una volta scansionato l'ID, è possibile chiedere al tuo contatto di scansionare il codice QR visualizzato, oppure inviagli una richiesta di connessione remota facendo clic su "*Contatto remoto*".
...
Ora puoi iniziare a scambiare messaggi e altri contenuti con il tuo contatto!

![Image](assets/fr/17.webp)

Dalla pagina iniziale, troverete tutte le tue conversazioni.
