...
- Napsauta Wallet:n aloitusnäytössä "Settings"-välilehteä, sitten "Wallet Details" ja kopioi zPub ([extended public key](https://planb.academy/courses/46b0ced2-9028-4a61-8fbc-3b005ee8d70f):
...
- **Liquid Network** :
- [Sanasto](https://planb.academy/fr/resources/glossary/liquid-network)
...
- **Lightning Network**:
- [Sanasto](https://planb.academy/fr/resources/glossary/lightning-network)
