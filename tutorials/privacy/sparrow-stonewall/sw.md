...
description: Kuelewa na kutumia miamala ya Stonewall kwenye Sparrow
---
...
## Je, ninawezaje kufanya muamala wa Stonewall kwenye Sparrow?



Iliyoundwa awali na timu ya Samurai Wallet, miamala ya Stonewall ilichukuliwa na programu ya Ashigaru, fork kutoka kwingineko asili iliyoundwa kufuatia kukamatwa kwa wasanidi wa Samurai, na pia kwenye Sparrow Wallet.



Utahitaji kusakinisha Sparrow na kuunda :
...
Kufanya muamala wa Stonewall kwenye Sparrow, utaratibu ni rahisi sana: anza kwa kuunda muamala kama kawaida, ama kupitia menyu ya `Tuma`, au kutoka kwa menyu ya `UTXOs` ikiwa ungependa kufanya *Coin Control*.
...
Kisha weka maelezo ya muamala: anwani ya mpokeaji, lebo, kiasi kitakachotumwa na kiasi au kiwango cha malipo, kulingana na hali ya soko.
...
Kabla ya kuthibitisha, hapa ndipo unaweza kuchagua muundo wa Stonewall. Katika sehemu ya chini ya kiolesura, badilisha `Ufanisi` na `Faragha`. Ikiwa chaguo hili halionekani, hii ina maana kwamba kwingineko yako haina idadi ya kutosha ya UTXO kujenga aina hii ya shughuli.
...
Baada ya kuchagua chaguo la `Faragha`, utaona kuwa muundo wa shughuli hiyo umebadilishwa kabisa: inakuwa shughuli ya Stonewall, inayotumia UTXO zako kadhaa kama pembejeo na kutoa matokeo mawili ya kiasi kinachofanana, ambayo moja inalingana na malipo halisi ya `100,000 sats`, pamoja na matokeo ya kubadilishana.
...
Ikiwa kila kitu ni sawa, bofya kwenye `Unda Muamala`.



Kisha unaweza kuangalia maelezo yako ya muamala mara ya mwisho, na ubofye `Maliza Muamala kwa Kutia Saini`.
...
Kisha utie sahihi muamala kulingana na mbinu mahususi ya kwingineko yako, na ubofye `Mamala wa Matangazo` ili kuutangaza kwenye mtandao wa Bitcoin, ukisubiri uthibitisho.
...
Sasa unajua jinsi muamala wa Stonewall unavyofanya kazi kwenye Sparrow Wallet na jinsi ya kuunda moja. Ili kuimarisha ujuzi wako wa zana hizi zilizoundwa ili kuimarisha usiri wako wa onchain, ninakualika ufuate mafunzo yangu ya BTC 204 kuhusu Plan ₿ Academy :
