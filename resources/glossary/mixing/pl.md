...
> w języku angielskim mówimy o "mieszaniu". Niektórzy bitcoinerzy odróżniają pojęcie mieszania od procesu CoinJoin. Twierdzą oni, że mieszanie odnosi się do mieszania monet wykonywanego przez podmiot będący właścicielem środków, w przeciwieństwie do coinjoinów, w których użytkownik zawsze pozostaje w posiadaniu środków. Jednak moim zdaniem to rozróżnienie jest nieprawidłowe, ponieważ CoinJoin koniecznie obejmuje mieszanie w matematycznym znaczeniu tego terminu.md#CoinJoin)***