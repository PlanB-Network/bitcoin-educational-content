---
name: Sellado de tiempo de diplomas en Plan ₿ Academy
description: Comprende cómo Plan ₿ Academy emite pruebas verificables para tu certificado y diplomas
---

![cover](assets/cover.webp)

Si estás leyendo esto, hay una alta probabilidad de que hayas recibido un Certificado Bitcoin o un diploma de finalización por alguno de los cursos que realizaste en Plan ₿ Academy, ¡Así que, felicitaciones por este logro!
...
1. La firma GPG se reporta como **"Buena firma de Plan ₿ Academy"**
...
Ahora que sabes cómo Plan ₿ Academy emite prueba verificable para cualquier Certificado de Bitcoin y Diploma de Finalización de Curso, puedes verificar fácilmente la integridad de este.
