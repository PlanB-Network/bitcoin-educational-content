...
In the "*Point of Sale*" menu, you'll find a Interface for collecting payments. It is divided into two parts:


### Direct debit


The first part is the direct debit keyboard. This Interface is handy for collecting a single payment when you know your customer's total purchases, or when you don't need a fixed product catalog in your business (e.g. freelance services).
