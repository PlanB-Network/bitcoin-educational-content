...
- Multisig 托管 (3/4)** 系统是一种安全的存款机制，借款人的比特币存放在多重签名的 Address 中。具体来说，四（4）方（借款人、出借人、Debifi、独立第三方）各持有一个密钥。要转移资金，至少需要 4 个签名中的 3 个签名。





- 稳定币**是一种价值与稳定资产（如美元）挂钩的加密货币，它避免了 Bitcoin 的波动性。例如，1 USDC 的价值始终为 1 美元，因为它有法定储备作为支撑。
