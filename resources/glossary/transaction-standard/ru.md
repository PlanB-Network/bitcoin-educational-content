---
term: Стандартная транзакция

definition: Транзакция, соответствующая как правилам консенсуса, так и правилам стандартизации узлов Bitcoin Core по умолчанию.
---
