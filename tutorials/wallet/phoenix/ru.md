...
По сути, Phoenix работает как настоящий узел Lightning, встроенный в ваш телефон, который автоматически открывает канал с узлом Lightning компании ACINQ. Приложение основано на Eclair, реализации Lightning, разработанной ACINQ. В отличие от других решений для узлов Lightning, Phoenix значительно упрощает управление. Пользователям не нужно управлять открытием и закрытием каналов, запускать узел Bitcoin или управлять ликвидностью в сети Lightning. Phoenix берет на себя все эти технические операции в фоновом режиме.
