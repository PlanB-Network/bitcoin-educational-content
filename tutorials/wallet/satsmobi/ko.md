...
Sats.Mobi는 모든 주요 기능을 나열하는 메시지를 보여주며 우리를 맞이합니다. 시작과 동시에, 봇은 텔레그램에서 선택한 핸들(기본적으로 고유한 핸들)에 연결된 LN Address도 생성했습니다. 이 Wallet으로 Sats을 보내고 받는 명령과 나중에 보게 될 다른 기능들을 볼 수 있습니다. **고급** 메뉴도 살펴보는 것도 흥미롭습니다
...
Wallet이 확인을 요청하는 메시지를 보냅니다. **결제하기**를 클릭하면 Invoice가 결제됩니다.
...
- 수도꼭지(**고급** 메뉴에 있음)를 클릭하면 그룹에서 가장 빠른 회원이 **수집**을 클릭하여 일련의 팁을 수집할 수 있습니다;
...
확인을 클릭하면 QR 코드를 통해 고객에게 보여주거나 인스턴트 메시지를 통해 문자열로 전송할 수 있는 Invoice이 표시되며, 이를 통해 결제할 수 있습니다.
