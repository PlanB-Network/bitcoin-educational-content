...
Таким чином, протокол Біткоїну є грошовою системою, яку неможливо цензурувати чи зупинити, оскільки кожен компонент протоколу розподілений географічно по всьому світу - наприклад, існує приблизно 40 000 вузлів Біткоїну на всіх континентах. Правила консенсусу Біткоїну такі, що економічно вигідніше дотримуватися їх, ніж намагатися порушити, і тому довіра між учасниками не потрібна. У Біткоїну немає лідера, і його неможливо зупинити. Можливо регулювати обмінні платформи, щоб обмежити Біткоїн, але це має обмежений вплив. Коротше кажучи, жоден суддя чи держава не може цензурувати або зупинити Біткоїн.
# Як отримати Біткоїн?
...
Ціна Біткоїну часто характеризується значною волатильністю. Його вартість може суттєво коливатися залежно від ринкових змін та фаз зростання і падіння ринку. Це присутнє на 100% фінансових ринків, включаючи Біткоїн.
...
Розвиток та еволюція Біткоїну значною мірою пов'язані з різними групами учасників, які поступово інтегрувалися в його екосистему.

![зображення](assets/en/chapter14/1.webp)

- Прихильники:

Першими користувачами Біткоїну здебільшого були технофіли, шифропанки, лібертаріанці та ентузіасти золота. Ці групи були залучені до Біткоїну через його здатність пропонувати рішення, такі як електронні гроші без довіри, стійкість до цензури та прозора й незмінна монетарна політика.

- Темна мережа та злочинці

Згодом використання Біткоїну поширилося на ринки темної мережі, такі як Silk Road, через його неконтрольовану та псевдонімну природу.  Цей сайт привернув увагу до цих характеристик Біткоїну, що спонукало деяких злочинців використовувати його. Однак слід зазначити, що використання інструменту, а не сам інструмент, визначає його законність або незаконність. Слід зазначити, що незаконне використання Біткоїну саме по собі не робить людину злочинцем. Це використання, а не інструмент, може бути класифіковане як незаконне. Наприклад, використання Біткоїну для купівлі певних наркотиків може бути законним або незаконним залежно від законодавчих обмежень у тому чи іншому регіоні.
...
У 2020 році ринок знову пережив спекулятивну бульбашку, яка підняла ціну Біткоїну до $60,000. Ця бульбашка відрізняється від попередніх більшою диверсифікацією інвесторів, включаючи фінансові установи та великі компанії. Однак, як і раніше, після спаду ейфорії відбулися сильні корекції ринку.
