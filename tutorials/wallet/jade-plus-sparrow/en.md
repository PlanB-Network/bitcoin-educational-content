...
It's therefore important, when configuring, to make a note of your master key fingerprint, which can be found in the bottom right-hand corner of the screen. For example, with my passphrase `Plan ₿ Academy`, my master key fingerprint is `3AD1AE65`.
