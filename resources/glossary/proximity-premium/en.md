...
The proximity bonus is an inherent flaw in Bitcoin's operation, stemming from two mechanisms: the linearity of the block order and the fact that the block reward is awarded exclusively to the miner who finds the block. This phenomenon encourages mining activities to be grouped together.