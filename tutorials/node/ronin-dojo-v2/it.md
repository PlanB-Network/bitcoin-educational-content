...
![scheda di espansione di memoria RPI4](assets/fr/1.png)
...
![materiale nodo](assets/fr/2.png)
...
![password root](assets/fr/26.png)
...
![conferma password root](assets/fr/27.png)
...
![credenziali utente](assets/fr/28.png)
...
![Associazione](assets/fr/31.png)
![Electrs](assets/fr/32.png)
Dovrai quindi inserire l'indirizzo `Hostname` che termina in `.onion` nel tuo software wallet, accompagnato dalla porta `50001`. ![hostname](assets/fr/33.png)
...
![Connessione Samourai Wallet](assets/fr/36.png)
...
![Gestisci mempool](assets/fr/37.png)
Poi clicca sul pulsante `Installa visualizzatore Mempool`:
![installa mempool](assets/fr/38.png)
...
Prendiamo un ulteriore esempio con una transazione più convenzionale, con un input e due output: [1b1b0c3f0883a99f1161c64da19471841ed12a1f78e77fab128c69a5f578ccce](https://mempool.space/fr/tx/1b1b0c3f0883a99f1161c64da19471841ed12a1f78e77fab128c69a5f578ccce)
...
![pagina iniziale boltzmann](assets/fr/51.png)
...
![risultato boltzmann](assets/fr/53.png)
...
![strumento xpub](assets/fr/54.png)
