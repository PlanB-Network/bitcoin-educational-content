...
이터레이터**는 항목 목록을 **한 번에 하나씩** 살펴볼 수 있도록 도와주는 자바스크립트의 특수 객체입니다.
...
1에서 5까지의 숫자 범위**를 나타내는 클래스가 필요하다고 가정해 보겠습니다.
...
콜백**은 다른 함수가 나중에 **호출**할 수 있도록 다른 함수에 부여하는 함수에 불과합니다.
...
콜백 API**는 비차단 방식으로, 파일 작업이 진행되는 동안 NodeJS가 다른 작업을 계속할 수 있게 해줍니다.
