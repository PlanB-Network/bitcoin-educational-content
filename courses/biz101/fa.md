...
objectives:
- بیت‌کوین را به عنوان یک ارز نوظهور و ابزار تجاری کشف کنید
- درک کنید که چرا و چگونه یک کسب‌وکار می‌تواند بیت‌کوین را در خزانه نگهداری کند یا از آن برای پرداخت‌ها استفاده کند
- ایده مشخصی از نحوه پذیرش پرداخت بیت‌کوین در عمل داشته باشید
- برای مدیریت الزامات مالیاتی و حسابداری آماده باشید
---
# سفر شرکت خود را در شبکه بیت‌کوین آغاز کنید

قابلیت‌های عملی بیت‌کوین و شبکه لایتنینگ را کشف کنید و بررسی کنید که چگونه، درست مانند اینترنت، می‌توانند عملیات تجاری شما را متحول کنند. از خزانه‌داری تا پرداخت‌های سریع، اقتصادی و مقیاس‌پذیر، بیت‌کوین طیف گسترده‌ای از موارد استفاده را برای کسب‌وکارها ارائه می‌دهد.

در طول این دوره، یاد خواهید گرفت که بیت‌کوین را به عنوان یک شبکه پولی جهانی، جهان‌شمول و بومی اینترنت درک کنید. با ویژگی‌های بنیادی منحصر به فرد خود، بیت‌کوین بهبودهای قابل توجهی نسبت به ارزهای سنتی ارائه می‌دهد. شما کشف خواهید کرد که چرا و چگونه از بیت‌کوین برای موارد استفاده مالی کلاسیک مانند ذخیره‌سازی سرمایه و سیستم‌های پرداخت استفاده کنید. علاوه بر این، این دوره به دست آوردن و نگهداری بیت‌کوین، از جمله الزامات حسابداری و مالیاتی مرتبط، و همچنین پیاده‌سازی راه‌حل‌های پرداخت بیت‌کوین ساده یا در مقیاس بزرگ را پوشش خواهد داد.

چه یک کسب‌وکار کوچک باشید یا یک شرکت بزرگ، ادغام بیت‌کوین در عملیات روزانه شما می‌تواند شرکت شما را انعطاف‌پذیرتر، بهره‌ورتر و رقابتی‌تر کند. هر شرکت مبتنی بر اینترنت به یک شرکت بیت‌کوین‌محور تبدیل خواهد شد و این دوره اطمینان می‌دهد که شما آماده هستید.
+++
# مقدمه
...
امروز، اصل درآمد ضرب پول توسط [ارز دیجیتال](https://planb.academy/resources/glossary/cryptocurrency) Bitcoin به چالش کشیده شده است، که بدون کنترل متمرکز عمل می‌کند. Bitcoin یک سیستم "بدون نیاز به مجوز" است که در آن هر کسی می‌تواند بدون درخواست مجوز در استفاده از ارز شرکت کند و از طریق [Mining](https://planb.academy/resources/glossary/mining)، آن را ایجاد کند. این تمرکززدایی، انحصار انتشار را از دولت‌ها می‌گیرد و سوالاتی را درباره بازگشت احتمالی به سیستم‌های ارزی رقابتی بازار آزاد مطرح می‌کند.
...
- **[قابل تعویض](https://planb.academy/resources/glossary/fungibility)**: تمام واحدهای یک ارز باید قابل تعویض و دارای ارزش برابر باشند. به عنوان مثال، یک اسکناس یک دلاری باید معادل هر اسکناس یک دلاری دیگر باشد. این یکنواختی، عدالت و سادگی در معاملات را تضمین می‌کند.
...
امروزه، ظهور Bitcoin به عنوان یک ارز غیرمتمرکز نمایانگر جهش بعدی در شبکه‌های ارزی است. پول الکترونیکی سنتی به مقامات متمرکز، مانند بانک‌ها یا دولت‌ها، برای مدیریت و تأیید تراکنش‌ها متکی است. در حالی که این سیستم‌ها مؤثر هستند، اما در برابر ناکارآمدی‌ها، سانسور و [نقاط شکست واحد](https://planb.academy/resources/glossary/spof) آسیب‌پذیرند. ارزهای غیرمتمرکز با **[توزیع](https://planb.academy/resources/glossary/distributed) اعتماد و حذف واسطه‌ها** این ویژگی‌های شبکه را بهبود می‌بخشند. این همچنین به این معناست که پول می‌تواند **سریع‌تر** و **ارزان‌تر** حرکت کند، زیرا هیچ مرحله تأییدیه‌ای وجود ندارد. در نهایت، هیچ انسانی نمی‌تواند وسوسه شود که برنامه زمانی ارز Bitcoin و Supply را تغییر دهد، زیرا این برنامه توسط نرم‌افزار اجرا می‌شود.


در سیستم‌های غیرمتمرکز، تراکنش‌ها توسط یک شبکه جهانی از شرکت‌کنندگان با استفاده از فناوری [Blockchain](https://planb.academy/resources/glossary/blockchain) تأیید می‌شوند که امنیت، شفافیت و مقاومت را تضمین می‌کند. این ساختار خطر تقلب را به حداقل می‌رساند، وابستگی به مقامات مرکزی را کاهش می‌دهد و به افراد قدرت می‌دهد تا کنترل بیشتری بر امور مالی خود داشته باشند. با حذف موانع جغرافیایی و نهادی، ارزهای غیرمتمرکز یک سیستم پولی واقعاً جهانی و فراگیر ارائه می‌دهند.
...
Bitcoin یک **سیستم ارز دیجیتال [همتا به همتا](https://planb.academy/resources/glossary/peertopeer-p2p) Exchange** (پول الکترونیکی) است. اصطلاح "Bitcoin" به اجزای زیر اشاره دارد:



- یک **پروتکل کامپیوتری** که ارزش Exchange را در اینترنت بدون واسطه‌ها، بدون نیاز به مجوز و به صورت مستعار تسهیل می‌کند. این پروتکل از اصول [رمزنگاری](https://planb.academy/resources/glossary/cryptography) پیشرفته استفاده می‌کند.
- **شبکه فیزیکی** از ماشین‌هایی که به اینترنت متصل هستند ([گره‌ها](https://planb.academy/resources/glossary/node)، [ماینرها](https://planb.academy/resources/glossary/miner) و غیره) که توسط افراد و کسب‌وکارها اداره می‌شوند و یک سیستم غیرمتمرکز را تشکیل می‌دهند (بدون مرجع مرکزی یا نقطه کنترل واحد).
- **واحد حساب** درون سیستم. هرگز بیش از 21 میلیون بیت‌کوین وجود نخواهد داشت. هر Bitcoin به 100 میلیون واحد به نام "[ساتوشی](https://planb.academy/resources/glossary/satoshi-sat)" تقسیم می‌شود که به افتخار خالق ناشناس آن نام‌گذاری شده است.


با هم، آنها Bitcoin را به یک **دارایی حامل** و یک ارز دیجیتال **بدون صادرکننده** تبدیل می‌کنند. Ownership تنها با نگه‌داشتن **[کلید رمزنگاری خصوصی](https://planb.academy/resources/glossary/private-key)** ایمن می‌شود و کنترل کامل را **بدون واسطه‌ها یا طرف‌های ثالث مورد اعتماد** اعطا می‌کند. هنگامی که منتقل می‌شود، **نهایی بودن** Ownership فوری است: دارنده جدید به طور کامل آن را مالک می‌شود بدون اینکه به یک مرجع مرکزی برای حفاظت یا تبدیل‌پذیری متکی باشد. [تراکنش‌ها](https://planb.academy/resources/glossary/transaction-tx) **غیرقابل تغییر** هستند—پس از ثبت در Blockchain، نمی‌توان آنها را تغییر داد یا حذف کرد.


![BIZ101](assets/fa/003.webp)


بیت‌کوین دارای یک سیاست پولی ثابت است، با **حداکثر ۲۱ میلیون بیت‌کوین**، که از این تعداد حدود ۱۹.۸ (۲۰۲۴) میلیون واحد قبلاً استخراج شده است. این ویژگی آن را **تورم‌زدا** می‌کند، به طوری که ارزش آن در طول زمان افزایش می‌یابد زیرا کاربران پس‌اندازها و سود حاصل از بهره‌وری خود را در آن ذخیره می‌کنند.
...
![BIZ101](assets/fa/004.webp)


Bitcoin به طور مؤثری ارزش را حفظ می‌کند زیرا [Ledger](https://planb.academy/resources/glossary/ledger) آن ضد دستکاری است. ارزش آن به دلیل Supply نادر و محدود، همراه با افزایش تعداد فرصت‌های Exchange، که ناشی از افزایش تعداد کاربران است، افزایش می‌یابد.
...
**کارت شناسایی بیت‌کوین (در سال ۲۰۲۴)**


- **سن:** ۱۵ سال (۳ ژانویه ۲۰۰۹)
- ارزش روزانه **Exchange:** ۱۰ میلیارد دلار (> CAC40)
- **[ارزش بازار](https://planb.academy/resources/glossary/market-cap-capitalization):** ۱.۸ تریلیون دلار (> متا، ویزا، نقره ; < اپل، گوگل، طلا)
...
- کاملاً **[متن‌باز](https://planb.academy/resources/glossary/foss)**
- **نهاد حقوقی:** هیچ کدام
- **مدیر عامل:** هیچکدام
...
- **حاکمیت:** توسط کاربران
- **مدل اقتصادی نوآورانه:** ایجاد بلاک توسط [کارمزدهای تراکنش](https://planb.academy/resources/glossary/transaction-fees) (بر اساس مزایده) [یارانه](https://planb.academy/resources/glossary/block-subsidy) داده می‌شود
...
[Lightning Network](https://planb.academy/resources/glossary/lightning-network) **یک پروتکل و یک شبکه** است که تراکنش‌های Bitcoin را با حداقل تعامل با Blockchain اصلی Bitcoin تسهیل می‌کند. در اینجا نحوه کار آن آمده است:



- **راه‌اندازی اولیه:** وجوه در Blockchain اصلی قفل (اسکرو) می‌شوند تا یک [کانال پرداخت](https://planb.academy/resources/glossary/payment-channel) بین 2 طرف ایجاد شود.
- **شبکه پرداخت:** یک شبکه از کانال‌های پرداخت بین چندین طرف، یک شبکه پرداخت را تشکیل می‌دهد (مسیر‌یابی و اتصال).
- معاملات [off-chain](https://planb.academy/resources/glossary/offchain):** معاملات بین طرفین انجام می‌شود اما **بلافاصله در Bitcoin اصلی Blockchain (**"off-chain"**) منتشر نمی‌شود.
- تسویه‌های [On-Chain](https://planb.academy/resources/glossary/onchain): **تنها** **تراز نهایی** تراکنش‌های یک کانال در Bitcoin اصلی Blockchain (**"On-Chain"**) منتشر می‌شود، که این امر اجازه می‌دهد تا در این میان تراکنش‌های متعددی انجام شود. این تجمیع پرداخت‌های متعدد باعث کاهش تراکم و در نتیجه کاهش هزینه‌ها در مقایسه با انجام تراکنش‌های متعدد On-Chain می‌شود.
...
![BIZ101](assets/fa/005.webp)


این رویکرد از کندی و پیچیدگی انجام هر تراکنش به‌طور مستقیم بر روی Bitcoin اصلی Blockchain جلوگیری می‌کند، تنها مانده‌های نهایی را ثبت کرده و امنیت آن را حفظ می‌کند. Lightning Network یک [Layer](https://planb.academy/resources/glossary/layer) "بر روی" Bitcoin است اما به آن متصل باقی می‌ماند.
...
**کارت شناسایی لایتنینگ (در سال ۲۰۲۴)**
...
به طور خلاصه، برای رایج‌ترین مورد استفاده—سرمایه‌گذاری خزانه اضافی برای حداقل یک دوره چهار ساله—Bitcoin به‌طور کامل مناسب است. ارزش دارد که آن را با [استراتژی ورود تدریجی](https://planb.academy/resources/glossary/dollar-cost-averaging-dca) ترکیب کنید: سرمایه‌گذاری مبالغ ثابت در فواصل منظم برای هموار کردن نقطه ورود یا خروج.
...
برای کسب اطلاعات بیشتر در مورد روش‌های کسب بیت‌کوین از طریق Exchange یا همتا به همتا، می‌توانید [بخش "Exchange" در آموزش‌های ما را مشاوره کنید](https://planb.academy/tutorials/exchange).


![BIZ101](assets/fa/012.webp)
...
این کلید رمزنگاری یک عدد تصادفی بسیار بزرگ است. برای ساده‌سازی تجربه کاربری، اغلب به صورت دنباله‌ای از ۱۲ یا ۲۴ کلمه نمایش داده می‌شود. این کلمات می‌توانند بر روی دستگاه فیزیکی به نام "[Hardware Wallet](https://planb.academy/resources/glossary/hardware-wallet)" بارگذاری شوند. اما توجه داشته باشید که بیت‌کوین‌ها "داخل" این دستگاه نیستند؛ این دستگاه صرفاً ابزاری برای امضای رمزنگاری تراکنش‌ها و پخش آن‌ها به شبکه است. آنچه واقعاً اهمیت دارد، ۱۲ یا ۲۴ کلمه است که باید به صورت امن نگهداری شوند.
...
- **[خود حضانتی](https://planb.academy/resources/glossary/selfcustody):**
...
پروفایل Starter برای کسب‌وکارها، خالقان محتوا و افرادی طراحی شده است که مایلند پرداخت‌های Bitcoin را بدون تعهد منابع یا تخصص قابل‌توجهی کاوش کنند. این پروفایل معمولاً برای کسانی است که حجم بسیار کمی از تراکنش‌ها (شاید چند انعام، کمک مالی یا فروش گاه‌به‌گاه) را مدیریت می‌کنند و به دنبال یک معرفی ساده و سبک به اکوسیستم Bitcoin و Lightning Network هستند. ارزش کلیدی رویکرد Starter در راه‌اندازی حداقلی آن نهفته است: در اکثر موارد، تنها چیزی که نیاز است، یک گوشی هوشمند یا تبلت مجهز به [Wallet](https://planb.academy/resources/glossary/wallet) سازگار با Lightning پایه است.


![BIZ101-profiles](assets/fa/017.webp)
...
![BIZ101-profiles](assets/fa/019.webp)
...
![BIZ101-profiles](assets/fa/020.webp)
...
![BIZ101-profiles](assets/fa/021.webp)
...
![BIZ101-profiles](assets/fa/022.webp)
...
![BIZ101-profiles](assets/fa/023.webp)
...
![BIZ101-profiles](assets/fa/024.webp)
...
![BIZ101-profiles](assets/fa/025.webp)
...
![BIZ101-profiles](assets/fa/026.webp)
...
![BIZ101-profiles](assets/fa/027.webp)
...
![BIZ101-profiles](assets/fa/028.webp)
...
![BIZ101-profiles](assets/fa/029.webp)
