...
definition: Протокол чаумовских электронных денег (ecash) с открытым исходным кодом, работающий поверх Биткоина и Lightning для обеспечения приватных платежей.
---
