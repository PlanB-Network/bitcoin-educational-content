...
Para explicar de forma simplificada o conceito de [mineração](https://planb.academy/resources/glossary/mining), uma analogia relevante pode ser usada: a do quebra-cabeça. Assim como um quebra-cabeça, a mineração é uma tarefa complexa de ser realizada, mas fácil de ser verificada uma vez concluída. No contexto da mineração de Bitcoin, os [mineradores](https://planb.academy/resources/glossary/miner) se esforçam para resolver rapidamente um quebra-cabeça digital. O primeiro minerador a resolver o quebra-cabeça apresenta sua solução para toda a rede, que pode então verificar facilmente sua validade. Essa verificação bem-sucedida permite que o minerador valide um novo [bloco](https://planb.academy/resources/glossary/block) e o adicione à cadeia de blocos do Bitcoin. Em reconhecimento ao seu trabalho, que envolve custos significativos, o minerador é recompensado com uma certa quantidade de bitcoins. Essa recompensa serve como um incentivo financeiro para os mineradores continuarem seu trabalho de validação de [transações](https://planb.academy/resources/glossary/transaction-tx) e segurança da rede Bitcoin.
...
A recompensa atual de mineração é dupla. Por um lado, inclui a criação de novos bitcoins, que passou de 50 bitcoins a cada dez minutos no início para 6,25 bitcoins hoje (2023). Por outro lado, inclui as [taxas de transação](https://planb.academy/resources/glossary/transaction-fees), ou taxas de mineração, das transações que o minerador escolhe incluir em seu bloco. Quando uma transação de bitcoin é feita, são pagas taxas de transação. Essas taxas funcionam como um tipo de leilão, onde os usuários indicam quanto estão dispostos a pagar para que sua transação seja incluída no próximo bloco. Para maximizar sua recompensa, os mineradores, agindo em seu próprio interesse, selecionam as transações mais lucrativas para incluir em seu bloco, levando em consideração o espaço limitado disponível. Assim, a [recompensa de mineração](https://planb.academy/resources/glossary/block-reward) é composta tanto pela geração de novos bitcoins quanto pelas taxas de transação, garantindo um incentivo contínuo para os mineradores e garantindo a sustentabilidade e segurança da rede Bitcoin.
...
![imagem](assets/en/032.webp)

identificador admin admin

![imagem](assets/en/033.webp)

Escolha o Assistente

![imagem](assets/en/034.webp)
...
![image](assets/en/067.webp) 3. É hora de instalar as peças 3D!
...
![imagem](assets/en/069.webp)
![imagem](assets/en/070.webp)
![imagem](assets/en/071.webp)
...
![imagem](assets/en/072.webp)
![imagem](assets/en/073.webp)
...
Em seguida, copie o endereço [Stratum](https://planb.academy/resources/glossary/stratum) e seu nome de usuário:
