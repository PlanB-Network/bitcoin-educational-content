---
name: SeedSigner
description: Hardware Wallet ambayo ni ya DIY, isiyo na uraia, nafuu na isiyo na hewa kabisa
---
...
SeedSigner ni chanzo huria cha Hardware Wallet Bitcoin ambacho mtu yeyote anaweza kujijenga kwa kutumia vipengele vya kielektroniki vya bei nafuu na vya madhumuni ya jumla. Tofauti na bidhaa za kibiashara kama vile Ledger, Coldcard au Trezor, hiki si kifaa kilicho tayari kutumika kilichotengenezwa na kampuni: ni mradi wa jumuiya ambao huruhusu kila mtu kuunda kifaa chake, kudhibiti kila hatua.



SeedSigner imeundwa kuwa 100% ***hewa-pengo***: haiunganishi kamwe kwenye Mtandao, haina Wi-Fi au Bluetooth (kwa upande wa Raspberry Pi Zero v1.3) na haijaunganishwa kamwe kwenye kompyuta kwa data ya Exchange. Mawasiliano ni kupitia mfumo wa Exchange pekee wa msimbo wa QR. Kwa maneno madhubuti, programu yako ya usimamizi wa kwingineko (kama vile Sparrow wallet) huonyesha muamala utakaotiwa saini katika mfumo wa misimbo ya QR; unazichanganua kwa kamera ya SeedSigner, kisha kifaa kitatia sahihi shughuli hiyo kwa kutumia funguo zako za faragha zilizohifadhiwa kwa muda kwenye RAM yake. Hatimaye, hutengeneza misimbo ya QR iliyo na shughuli iliyotiwa saini, ambayo unachanganua kwa programu yako ili kuituma kwa mtandao wa Bitcoin.
...
SeedSigner pia ni *** haina uraia***. Kwa maneno mengine, haihifadhi seed yako au funguo zako za kibinafsi kabisa, tofauti na pochi zingine za maunzi. Kila wakati unapowasha upya, kumbukumbu yake ni tupu kabisa, isipokuwa ukisanidi kifaa ili kuhifadhi mipangilio yako kwenye kadi ya microSD. Kwa hivyo inabidi uingize tena seed yako kila wakati unapoitumia, njia inayotumika zaidi ni kuihifadhi katika mfumo wa msimbo wa QR, ili kuchanganuliwa inapoanzishwa kwa kutumia kamera ya SeedSigner. Njia hii ya utendakazi hupunguza eneo la shambulio kwa kiasi kikubwa: hata mwizi akiiba kifaa chako, hatapata taarifa yoyote juu yake, kwa kuwa daima huwa tupu kwa chaguo-msingi.



Chaguo jingine la kuhifadhi seed yako na kuitumia kwa SeedSigner ni kutumia kadi mahiri ya *SeedKeeper* pamoja na kisomaji kinachooana. Hii hukupa *secure element* thabiti zaidi kuhifadhi seed yako, huku ukitumia skrini ya SeedSigner kusaini miamala. Lakini usanidi huu ni somo la mafunzo mengine ya kujitolea. Hapa, tutazingatia matumizi ya kimsingi ya SeedSigner:



https://planb.network/tutorials/wallet/hardware/seedkeeper-seedsigner-45cca4c4-1f22-46bb-87ae-9cddb68aa579

Mradi wa SeedSigner unachukua nafasi muhimu katika mfumo wa ikolojia wa Bitcoin, kwani inatoa kila mtu, kila mahali ulimwenguni, uwezekano wa kufaidika na usalama wa hali ya juu ili kulinda bitcoins zao. Faida yake kuu iko katika upatikanaji wake: vifaa vinavyohitajika vinaweza kununuliwa kwa chini ya $ 50. Zaidi ya hayo, inawawezesha watu wanaoishi katika nchi zilizowekewa vikwazo kuunda Hardware Wallet yao wenyewe kutoka kwa vipengele vya kawaida vya kompyuta, ambavyo ni rahisi kupata na chini ya vikwazo vya udhibiti.



Lakini hata nje ya miktadha hii mahususi, SeedSigner inaweza kuwa chaguo la kuvutia kwako: ni chanzo huria, inafanya kazi bila utaifa na hewa, na inapunguza vijidudu vya mashambulizi vilivyounganishwa na msururu wa Supply wa Hardware Wallet yako.
...
- Raspberry Pi Zero
    - Toleo la 1.3 linapendekezwa, kwa kuwa halina Wi-Fi wala Bluetooth, kuhakikisha kutengwa kabisa.
 - Matoleo ya W na v2 pia yanaoana, lakini yanajumuisha chipu ya Wi-Fi/Bluetooth. Kwa hiyo ni vyema kuizima kimwili kwa kuondoa moduli ya redio kutoka kwa kadi. Operesheni ni rahisi, lakini inahitaji usahihi (pliers nzuri ni ya kutosha kwa Zero W, wakati kalamu ya Hot inahitajika kwa v2 ili kuondoa sahani ya chuma inayoficha moduli). Sitazingatia maelezo katika mafunzo haya, lakini utapata maagizo yote katika hati hii: *[Kuzima WiFi/Bluetooth kwa maunzi](https://github.com/DesobedienteTecnologico/rpi_disable_wifi_and_bt_by_hardware)*.
 - Tafadhali kumbuka: baadhi ya miundo ya Raspberry Pi Zero inauzwa bila pini za GPIO zilizouzwa awali. Unaweza kununua toleo na pini zilizojumuishwa moja kwa moja (suluhisho rahisi), au ununue pini tofauti na uziuze mwenyewe (suluhisho ngumu zaidi).
 - Usisahau kujumuisha nishati ndogo ya USB Supply.
...
- Skrini ya Waveshare inchi 1.3 (240×240 px)** (kwa Kifaransa)
    ...
    - Onyesho linajumuisha vitufe vitatu na kijiti kidogo cha furaha kinachotumika kama Interface ya mtumiaji.
...
- Nyumba (ya hiari, lakini inapendekezwa)** (si lazima, lakini inapendekezwa)** (si lazima, lakini inapendekezwa)** (si lazima, lakini inapendekezwa)** (inapendekezwa)
    ...
    - Sanduku zinapatikana pia kutoka kwa [wauzaji huru waliounganishwa na mradi](https://seedsigner.com/hardware/).
...
Ili kufanya hivyo, linganisha herufi 16 za mwisho za alama ya vidole zinazoonyeshwa na zile zinazopatikana kwenye [Keybase.io/SeedSigner](https://keybase.io/seedsigner), kwenye [Twitter rasmi](https://twitter.com/SeedSigner/status/1530555252373704707), au katika faili iliyochapishwa [SeedSigner.com](https://seedsigner.com/keybase.txt). Ikiwa vitambulishi hivi vinalingana haswa, unaweza kuwa na uhakika kwamba ufunguo kwa hakika ni ule wa mradi. Ikiwa una shaka, acha mara moja na uulize jumuiya ya SeedSigner (Telegram, X, GitHub...) kwa usaidizi.
...
PowerShell kisha hukokotoa Hash SHA256 ya faili yako ya picha. Linganisha Hash hii na thamani inayolingana katika `seedsigner.0.8.6.sha256.txt`.
...
Ingiza kifuniko cha kamera. Sehemu ya kahawia/shaba inapaswa kutazama chini. Hakikisha kuwa imekaa imara kwenye kiunganishi, bila kupotosha.
...
Ikiwa umebadilisha uelekeo wa kamera au ungependa kubadilisha mipangilio mingine (kama vile lugha ya Interface) baadaye, utahitaji kuwasha uendelevu wa mipangilio kwenye microSD. Vinginevyo, mipangilio yako itarudi kwa chaguo-msingi kila wakati unapowasha tena, kwani Raspberry Pi Zero haina kumbukumbu inayoendelea.
...
Toleo la sasa la firmware inasaidia vifurushi kadhaa vya programu: Sparrow, Specter, BlueWallet, Nunchuk na Keeper. Katika kesi yangu, ninatumia **Sparrow wallet **, ambayo ninapendekeza hasa kwa unyenyekevu wake na utendaji tajiri.
...
- gW-20 (satoshis, au 1/100,000,000 BTC)
...
- gW-22 network`: kurekebishwa ikiwa tu ungependa kutumia SeedSigner kwenye Testnet.
...
Hatimaye, katika menyu ya `Lugha`, unaweza kubadilisha lugha ya Interface ili kuendana na mapendeleo yako.
...
Neno la seed (au Mnemonic) huunda msingi wa jalada lako la Bitcoin. Inatumika kupata funguo na anwani zako za kibinafsi, na hutoa ufikiaji wa pesa zako. SeedSigner inatoa mbinu kadhaa za kuizalisha, ambazo tutachunguza katika sehemu hii.
...
- Kifungu hiki cha maneno hukupa ufikiaji kamili, usio na kikomo wa bitcoins zako zote.** Mtu yeyote aliye na kifungu hiki cha maneno anaweza kuiba pesa zako, hata bila kufikia SeedSigner yako;
- Kawaida, maneno ya maneno 12 hutumiwa kurejesha Wallet ikiwa Hardware Wallet imepotea au kuibiwa. Lakini kwa kuwa SeedSigner ni kifaa *isiyo na utaifa*, haisajili seed yako. Kwa hivyo nakala zako halisi sio nakala rudufu tu, lakini **njia pekee ya kutumia Wallet** yako. Ukipoteza nakala hizi, bitcoins zako zitapotea kabisa. Kwa hiyo zihifadhi kwa uangalifu, kwenye vyombo vya habari kadhaa na katika maeneo salama;
- Ikiwa ndio kwanza unaanza, nakushauri sana usome mafunzo haya kwa ufahamu wa kina wa hatari zinazohusika katika kudhibiti maneno ya Mnemonic :



https://planb.network/tutorials/wallet/backup/backup-mnemonic-22c0ddfa-fb9f-4e3a-96f9-46e2a7954270

### 5.1 Fikia zana ya kuunda seed
...
- dice Rolls": unakunja kete ili kuunda entropy inayohitajika. Inatumia muda zaidi, lakini inazalishwa tena na kwa hivyo inaweza kuthibitishwa. Ukichagua njia hii, fuata ushauri katika mafunzo haya (hakuna haja ya kukokotoa checksum hapa, SeedSigner itashughulikia hilo):
...
Kisha chagua urefu wa maneno yako ya Mnemonic. Maneno 12 tayari yanatoa kiwango cha kutosha cha usalama, kwa hivyo hii ndio chaguo ninalopendekeza.
...
Ukikosea, SeedSigner itakujulisha, na itabidi uanze tena, ukihakikisha kuwa umezingatia maneno yako ya Mnemonic unapopewa. Hatua hii ya uthibitishaji inahakikisha kuwa nakala yako ni sahihi na imekamilika. Baada ya kuthibitishwa, skrini itaonyesha `Nakala Imethibitishwa`.
...
SeedSigner ni kifaa kisicho na kumbukumbu ya kudumu. Hii inamaanisha kuwa seed yako haihifadhiwi ndani ya kifaa (kwa mfano, Ledger, Trezor au Coldcard). Mara tu unapozima nguvu, seed hupotea kabisa kutoka kwa RAM yake. Wakati SeedSigner inaanza tena, inarudi katika hali tupu: utahitaji kuipa seed yako tena ili kutia sahihi shughuli zako.



Hii inatoa ulinzi muhimu. Tofauti na pochi zingine za maunzi, SeedSigner inategemea Raspberry Pi Zero bila ulinzi wa kimwili, ikiwa ni pamoja na *secure element*. Lakini kwa kuwa hakuna data nyeti iliyohifadhiwa, hata kifaa kilichoathiriwa hakiwezi kuruhusu mvamizi kutoa funguo zako za faragha au kutumia bitcoins zako.
...
Kila wakati unapotumia SeedSigner, unachanganua msimbo huu wa QR kwa kamera ya kifaa ili ipakie kwa muda seed yako kwenye kumbukumbu yake unapotia saini miamala yako. Nakala hii ya pili, inayokusudiwa matumizi ya kila siku, lazima pia itunzwe kwa uangalifu mkubwa: mtu yeyote aliye na msimbo huu wa QR ana ufikiaji kamili wa bitcoins zako.


Pia nakushauri uhifadhi msimbo wako wa QR na maneno yako ya Mnemonic katika sehemu mbili tofauti, ili kuepuka kupoteza kila kitu ikiwa kuna dai.
...
Pia ni katika hatua hii ambapo unaweza kuongeza **passphrase BIP39** ili kuimarisha usalama wa Wallet yako. Chaguo hili linaweza kuwa la maana, kulingana na mkakati wako wa kuhifadhi nakala, lakini pia linajumuisha hatari: ukipoteza passphrase, ufikiaji wa bitcoins zako utapotea kabisa.
...
Ili kufanya hivyo, utahitaji karatasi tupu au msimbo wa chuma wa QR unaolingana na urefu wa maneno yako ya Mnemonic. Ikiwa umenunua kifurushi kamili cha SeedSigner yako, violezo kawaida hujumuishwa. Ikiwa sivyo, unaweza kuzipakua na kuzichapisha (au kuzitoa kwa mkono) hapa:
...
Kutoka kwenye skrini yako ya seed, chagua `Chelezo seed`.
...
Tengeneza kwa uangalifu kila kitone cheusi kwenye laha lako, kisha utumie kijiti cha furaha ili kuendelea na BLOCK inayofuata. Chukua muda wako: upangaji vibaya rahisi unaweza kufanya msimbo wa QR kutotumika.
...
Hongera, jalada lako la Bitcoin sasa limeanza kutumika! Sasa tutaleta vipengele vyake vya umma kwenye **Sparrow wallet** ili kuidhibiti kwa urahisi.
...
Hakikisha kuwa umesakinisha programu ya Sparrow wallet kwenye kompyuta yako. Ikiwa hujui jinsi ya kupakua, angalia na usakinishe kwa usahihi, tafadhali angalia mafunzo yetu kamili juu ya somo:
...
Peana jina kwenye jalada lako, kisha ubofye kwenye `Unda Wallet`. Sparrow itakuuliza uweke nenosiri ili kufunga ufikiaji wa ndani kwa Wallet hii. Chagua nenosiri thabiti: hulinda ufikiaji wa data yako ya kwingineko katika Sparrow (funguo za umma, anwani, lebo na historia ya muamala). Nenosiri hili halihitajiki ili kurejesha kwingineko baadaye: maneno yako ya Mnemonic pekee (na ikiwezekana passphrase yako) ndiyo yanahitajika kwa madhumuni haya.
...
SeedSigner yako na Sparrow wallet sasa zimeunganishwa kwa usalama. Sparrow hufanya kazi kama usimamizi kamili wa Interface, huku SeedSigner ikisalia kuwa kifaa pekee chenye uwezo wa kusaini miamala yako. Sasa uko tayari kupokea na kutuma bitcoins katika usanidi usio na hewa kabisa.
...
#### 7.1.1 Kuzalisha mapokezi Address
...
Bitcoin Address mpya inaonyeshwa. Utaona:




- Maandishi Address (yakianza na `bc1p...` ikiwa unatumia P2TR kama mimi),
...
Kabla ya kushiriki kupokea kwako Address, ni muhimu sana kuangalia kwamba ni ya seed yako. Hatua hii inahakikisha kuwa SeedSigner yako itaweza kutia sahihi miamala inayohusishwa na Address hii. Pia hulinda dhidi ya mashambulizi yanayoweza kutokea ambapo Sparrow huonyesha Address ya ulaghai. Kumbuka kwamba Sparrow inaendeshwa kwenye mazingira yasiyo salama (kompyuta yako), ambayo ina sehemu kubwa ya mashambulizi kuliko SeedSigner yako, ambayo imetengwa kabisa. Ndiyo maana hupaswi kamwe kuamini kwa upofu mpokeaji yeyote Address inayoonyeshwa kwenye Sparrow hadi utakapoithibitisha kwa Hardware Wallet yako.



Kwenye Sparrow, bofya kwenye msimbo wa QR wa Address ili kuipanua: kisha itaonyeshwa skrini nzima.
...
Ikiwa Address iliyochanganuliwa inalingana na ile inayotokana na seed yako, skrini ya SeedSigner itaonyesha ujumbe: `Address Imethibitishwa`.
...
Hii inathibitisha kwamba Address ni ya Wallet yako na kwamba unaweza kupokea bitcoins kwa ujasiri kutoka kwayo.
...
Sasa unaweza kuwasiliana na Address hii (kwa maandishi au fomu ya msimbo wa QR) kwa mtu au idara inayohitaji kukutumia Satss. Muamala ukishatangazwa kwenye mtandao, utaonekana kwenye kichupo cha `Miamala` cha Sparrow wallet.
...
- Saini ya shughuli kwenye SeedSigner;
- Usambazaji wa mwisho wa shughuli kupitia Sparrow.
...
- Katika `Lipa kwa`, bandika Address ya mpokeaji au ubofye aikoni ya kamera ili kuchanganua msimbo wa QR;
- Katika `Lebo`, ongeza lebo ili kufuatilia gharama hii;
- Katika `Kiasi`, weka kiasi kitakachotumwa;
- Hatimaye, chagua kiwango cha ada kulingana na hali ya sasa ya soko (makadirio yanapatikana kwenye [Mempool.space](https://Mempool.space/)).
...
Angalia maelezo ya muamala ili kuhakikisha kuwa kila kitu ni sahihi, kisha ubofye `Maliza Muamala kwa Kutia Sahihi`.
...
Washa SeedSigner yako na uchanganue SeedQR yako ili kufikia kwingineko yako, kama kawaida. Kutoka kwa skrini ya kwanza, chagua `Scan`, kisha uchanganua msimbo wa QR unaoonyeshwa kwenye Sparrow.
...
Bofya kwenye `Maelezo ya Kagua` na uangalie kwa makini taarifa zote moja kwa moja kwenye skrini ya SeedSigner. Vipengee muhimu zaidi vya kuangalia ni kiasi kilichotumwa, Address ya mpokeaji na kiasi cha gharama zozote zinazotumika.
...
Baada ya kusainiwa, SeedSigner hutengeneza msimbo mpya wa QR ulio na shughuli iliyosainiwa, tayari kuchanganuliwa na Sparrow.
...
Sasa kwa kuwa shughuli hiyo ni halali, inahitaji kutangazwa kwenye mtandao wa Bitcoin, ili ifikie Miner ambaye ataongeza kwenye BLOCK.
