---
name: GrapheneOS
description: Un sistema operativo mobile incentrato sulla sicurezza e la privacy basato su Android
---

![cover](assets/cover.webp)

> [GrapheneOS](https://grapheneos.org/) è un sistema operativo mobile, open source senza scopo di lucro, progettato per offrire un alto livello di riservatezza e sicurezza, rimanendo pienamente compatibile con le applicazioni Android.

GrapheneOS, originariamente fondato nel 2014 come 'CopperheadOS', si basa sul tradizionale codice Android (AOSP), ma con molte modifiche e miglioramenti mirati a potenziare la privacy e la sicurezza dell'utente. GrapheneOS permette all'utente il controllo del proprio telefono, e non più alle grandi aziende tecnologiche.
...
GrapheneOS è stato creato appositamente per ridurre questa condivisione di dati e migliorare la sicurezza del dispositivo da potenziali vettori di attacco. Non ci sono queste cose in un account GrapheneOS. Non hai bisogno di ciò per scaricare app o interagire con il sistema operativo. In poche parole, tu non sei il prodotto.
...
8. Una volta completamente scaricato, passa al passaggio successivo e fai clic su 'Flash della versione'. Questo richiederà uno o due minuti e non è necessario toccare il telefono.
...
- Scelgo i colori di contesto utilizzati in tutta l'interfaccia utente.
...
Per rendere il tuo telefono utile, vorrai installare alcune applicazioni! Le opzioni seguenti sono incluse perché le ho usate personalmente o perché ricevono forti raccomandazioni dalla più ampia comunità sulla privacy. Ci sono molte altre ottime alternative disponibili che non sono menzionate e [Awesome Privacy](https://awesome-privacy.xyz) offre un elenco estremamente ampio di applicazioni per la privacy per tutti i tipi di dispositivi.

Il fatto che un'app sia un software libero e open source (FOSS) non significa che sia esente da possibili falle nella privacy. Utilizza [Exodus](https://reports.exodus-privacy.eu.org/it/) per vedere come le tue app preferite si comportano rispetto alle loro verifiche sulla privacy.
...
_Schermata principale di F-Droid_
...
_Schermata iniziale di Aurora Store_
...
Per proteggere dal monitoraggio della tua attività online da parte del tuo provider di servizi Internet (ISP), un'app di rete privata virtuale (VPN) è una buona opzione. Una VPN invia il tuo traffico Internet in un tunnel crittografato verso un indirizzo IP condiviso controllato dal provider di servizi VPN per garantire che l'attività del tuo dispositivo non possa essere collegata a te.
...
Negli ultimi anni le soluzioni di messaggistica crittografata sono diventate abbondanti. Il problema rimane però che puoi avere la migliore e più privata opzione installata sul tuo telefono, ma se non hai contatti che la utilizzano, a cosa serve?
...
_A sinistra: Magic Earth, a destra: Organic Maps_
...
_A sinistra: Proton Mail, a destra: Tutanota_
...
_A sinistra: Notesnook, a destra: KDE Connect_
...
_A sinistra: Proton Pass, a destra: Bitwarden_
...
Tuttavia, quando si passa a GrapheneOS, ci sono alcuni comfort a cui devi rinunciare a causa della mancanza di alternative. Questi includono:
...
Se scopri che semplicemente non puoi fare a meno di quelle notifiche push per la tua app preferita o se una certa app "indispensabile" è inutile senza i Servizi Google Play, GrapheneOS ti consente di installare questi servizi in un ambiente completamente isolato. Una volta installati, questi servizi non richiedono un account Google per funzionare e le autorizzazioni di ciascuno di essi possono essere strettamente controllati.

Prima di affrettarti ad installarli il primo giorno, ti consiglio di vedere fino a che punto riesci a fare a meno di loro. Probabilmente sarai sorpreso di scoprire quante app funzionano perfettamente normalmente senza di essi.
...
_Schermata di installazione dei Servizi Google Play_

### Profili

GrapheneOS ti consente di avere un'esperienza di utilizzo separata all'interno del tuo telefono. I profili aggiuntivi possono installare le proprie app e servizi e non possono accedere a file o dati dell'account proprietario.
...
_Schermata di gestione dei profili utente_
...
GrapheneOS è una tana del coniglio in cui chiunque potrebbe facilmente passare settimane. C'è così tanto da imparare e sperimentare per personalizzare l'esperienza in base alle tue esigenze e ai tuoi modelli di minaccia. Di seguito trovi alcuni link dove puoi continuare il tuo viaggio:
