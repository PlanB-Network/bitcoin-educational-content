...
Prenons l'exemple d'un coinjoin : une pièce mélangée sera marquée comme telle, identifiable par les outils d'analyse de blockchain qui reconnaissent les schémas de transactions coinjoin, attribuant ainsi une étiquette spécifique. Le coinjoin vise à briser les liens historiques d'une pièce, toutefois, son passage par ce processus reste détectable. Cela s'apparente au chiffrement d'un texte : bien qu'on ne puisse accéder au contenu original, on identifie facilement qu'un chiffrement a été appliqué.
...
Étant donné que le service est payant sur Samourai, un Ricochet implique un coût de `100 000 sats` en tant que frais de service, auxquels s'ajoutent les frais de minage. Ainsi, son utilisation est plutôt recommandée pour des transferts de montants significatifs.
