...
Všimněte si, že tento díl kurzu momentálně obsahuje pouze návody v francouzštině. Pracujeme na překladu videa do vašeho jazyka. Pokud nám chcete s překladem pomoci, kontaktujte nás prostřednictvím [GitHub](https://github.com/DecouvreBitcoin/sovereign-university-data)
