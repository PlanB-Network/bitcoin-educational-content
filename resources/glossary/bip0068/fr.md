---
term: BIP0068
definition: Introduction des timelocks relatifs via le champ nSequence, permettant de bloquer une transaction pendant un délai après confirmation de la transaction parente.
---
