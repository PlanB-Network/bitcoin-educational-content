...
Les critères d'une monnaie efficace sont multiples. Une bonne monnaie doit être fongible, c'est-à-dire interchangeable sans perte de valeur ; divisible, afin de faciliter les transactions de différentes tailles ; et liquide, c'est-à-dire facilement convertible en biens ou services.
Historiquement, ces critères ont été remplis par des objets physiques, tels que l'or. Cependant, avec le développement de l'infrastructure financière, l'or a été transformé en billets de banque, qui sont plus pratiques pour le commerce quotidien.

Aujourd'hui, les monnaies évoluent encore, adaptant leurs formes pour répondre à des fonctions différentes. Par exemple, alors que l'or est une excellente réserve de valeur, il n'est plus adapté à l'économie mondialisée actuelle. De même, des monnaies fiduciaires comme le dollar et l'euro sont très liquides, mais leur valeur est érodée par l'inflation.
Bitcoin, en tant que monnaie numérique, présente de nouvelles possibilités. Il offre une excellente réserve de valeur et est un bon moyen d'échange, mais n'est pas encore largement utilisé comme unité de compte. En raison de l'inflation, les monnaies fiduciaires comme l'euro et le dollar ne sont pas idéales comme réserves de valeur à long terme.
...
L'exploration des impacts des monnaies fiduciaires sur le système financier est un aspect essentiel de notre compréhension des dynamiques économiques contemporaines. Pour paraphraser George Santayana, "ceux qui ne retiennent pas les leçons de l'histoire sont condamnés à les revivre". C'est donc avec cette approche historique que nous abordons le sujet des monnaies fiduciaires.
Ces dernières reposent sur la confiance et l'assurance que leur valeur sera préservée. Cependant, cette confiance est actuellement ébranlée par l'inflation galopante et l'augmentation sans précédent de la dette. Les monnaies fiduciaires, en fin de compte, dépendent de la foi que nous accordons aux institutions qui les régulent, et cette foi semble s'étioler.

C'est dans ce contexte que la révolution Bitcoin prend de l'ampleur. Cette monnaie de confiance vise à séparer l'État de la monnaie, sapant ainsi le contrôle de l'État sur le système financier. La capacité de frapper de la monnaie a permis une dévaluation progressive de celle-ci, érodant le pouvoir d'achat de la population. Depuis l'introduction de l'euro, le pouvoir d'achat a diminué de 30%, tandis que le pouvoir d'achat américain a perdu 98% de sa valeur depuis 1900. Les monnaies fiduciaires n'ont plus de soutien solide, l'or ayant été abandonné. L'inflation agit comme une taxe subreptice qui rogne le pouvoir d'achat. Elle permet à un État de dévaluer sa monnaie pour rembourser sa dette et financer ses projets.

L'impression monétaire engendre de l'inflation, appauvrissant progressivement la population. En revanche, les institutions financières et les individus fortunés se sont enrichis grâce à cette pratique, creusant un fossé d'inégalités et favorisant l'autoritarisme. Les États sont contraints de maintenir leur pouvoir en dévaluant leur monnaie pour faciliter le remboursement de la dette. Le système financier actuel est régulé et restreint pour éviter son effondrement. Un bouleversement de ce système risquerait de provoquer une crise économique majeure. Les acteurs politiques manquent de volonté pour opérer un changement radical, laissant le système poursuivre sa course jusqu'à une éventuelle implosion.
...
Les hyperinflations sont des phénomènes potentiellement dévastateurs dans un système monétaire fiat, entraînées par des décisions humaines, qui peuvent conduire à l'éradication de la valeur monétaire. En résultat, les économies accumulées peuvent se dissiper en un laps de temps relativement court.
Il existe des cas notables d'hyperinflation à travers l'histoire, tels que l'Allemagne en 1923, le Zimbabwe, le Venezuela, parmi d'autres. Les monnaies fiduciaires, qui sont créées ex-nihilo, se distinguent des monnaies communes comme l'or. Par exemple, avec une inflation de 2%, vous perdez annuellement 2% de votre pouvoir d'achat. À 7%, vous perdez la moitié en 10 ans. À un taux de 20%, vous perdez pratiquement tout en moins de 3 ans. Ainsi, les hyperinflations peuvent éliminer rapidement les économies accumulées.
...
La centralisation du pouvoir monétaire facilite la création de monnaie et la régulation. Cependant, une perte de confiance dans une monnaie peut déclencher une hyperinflation. Les individus commencent alors à se questionner sur l'origine de l'argent et le processus de création monétaire.
Le premier stade de l'hyperinflation est la perte de confiance, généralement due à des facteurs externes tels que les guerres, les mesures sociales ou la chute des prix d'une ressource clé. Le deuxième stade est l'effondrement de la monnaie.
À mesure que les gouvernements perdent le contrôle de la confiance, les individus commencent à échanger leur monnaie pour une autre, plus stable, comme le dollar. Cela entraîne une hausse des prix, créant un cercle vicieux où les biens et services deviennent de plus en plus coûteux. Pour répondre à ces besoins, l'État imprime davantage de monnaie, entraînant une inflation exponentielle car l'État tente de contrôler les prix.
Lorsque la monnaie perd totalement la confiance, l'inflation devient astronomique. Une nouvelle monnaie est alors introduite pour remplacer l'ancienne, comme le dollar. Un exemple notable d'hyperinflation est l'Allemagne dans les années 1920-1923. Pour relancer l'économie, une nouvelle monnaie a été créée, adossée à la dette allemande, française et anglaise, et garantie par les terres allemandes.
La résolution d'une crise d'hyperinflation nécessite souvent des changements radicaux, tels que des révolutions, des changements de gouvernement, des changements de banquiers centraux, entre autres. La perte de confiance, l'effondrement de la monnaie et la reconstruction sont des phases essentielles pour relancer une nouvelle économie.
Il y a plusieurs autres exemples d'hyperinflation tout au long de l'histoire, dont la Hongrie, le Zimbabwe, la France en 1795, et le Chili. De nombreuses anecdotes illustrent la dévaluation de la monnaie et la fluctuation de la valeur des biens courants. Par exemple, pendant la guerre, les Français ont pu acheter des œuvres d'art allemandes à bas prix avec des francs en Allemagne.
...
Bitcoin est une monnaie numérique décentralisée avec une quantité maximale préétablie de 21 millions d'unités. Cette caractéristique intrinsèque de rareté est déterminée par son protocole informatique. En ce qui concerne son émission monétaire, elle peut être illustrée par une courbe qui représente la quantité de bitcoins créés et la fréquence de leur émission. Par exemple, en 2022, environ 18,5 millions de bitcoins étaient en circulation. Les prévisions indiquent qu'en 2025, il y aura environ 19,5 millions de bitcoins, et en 2037, ce chiffre atteindra 20,4 millions.

La création de nouveaux bitcoins est le résultat du processus de minage, une procédure de validation et d'exécution des transactions sur le réseau Bitcoin. Les mineurs, qui effectuent cette tâche, sont récompensés par l'émission de nouveaux bitcoins toutes les dix minutes. Cette récompense est programmée pour diminuer de moitié tous les quatre ans, un événement connu sous le nom de "halving". Cela donne à la courbe d'émission monétaire une forme d'escalier. En raison de ce mécanisme de halving, on peut prédire mathématiquement que la création de bitcoins cessera en 2140, lorsque le nombre total de bitcoins atteindra sa limite de 21 millions.

La rareté du Bitcoin est garantie par deux mécanismes clés : la limite fixée à 21 millions de bitcoins et le protocole informatique qui ne peut être modifié sans le consensus de la majorité du réseau. Deux autres éléments cruciaux contribuent à maintenir cette limite : la théorie du jeu et l'ajustement de la difficulté du minage. Les mineurs sont incités à valider les transactions et à créer de nouveaux bitcoins toutes les dix minutes. À mesure que le nombre de bitcoins émis se rapproche de la limite de 21 millions, le réseau sera maintenu par les frais de transaction et les bitcoins restants non encore minés.
L'ajustement de la difficulté du minage se fait toutes les deux semaines pour garantir que, en moyenne, un nouveau bloc est ajouté à la blockchain toutes les dix minutes. Cette fréquence de création de blocs et la quantité totale de bitcoins sont des aspects figés du protocole Bitcoin et ne peuvent être modifiés sans un consensus général, contrairement aux décisions arbitraires prises dans les systèmes monétaires traditionnels.

La quantité fixe de bitcoins, initialement définie à 21 millions, ne peut être modifiée. Toute modification du protocole Bitcoin nécessiterait l'accord de l'ensemble de la communauté des utilisateurs, ce qui est hautement improbable. L'idée de dévaluer la monnaie est contraire à la philosophie fondamentale du Bitcoin.
La rareté du Bitcoin est un atout majeur, car il y aura toujours un maximum de 21 millions d'unités. La quantité de bitcoins en circulation est publique et vérifiable par quiconque. En fait, n'importe qui peut vérifier la quantité de bitcoins en circulation entrant une commande simple sur un nœud Bitcoin. Cette transparence et vérifiabilité renforcent la confiance dans le système Bitcoin, qui ne repose pas sur des institutions centralisées ou des individus, mais sur une garantie mathématique inhérente à son protocole.
...
Bitcoin est une alternative monétaire réaliste car il est rare et limité à 21 millions de bitcoins qui ne peuvent pas être modifiés. La création monétaire est maintenue grâce à l'ajustement de la difficulté toutes les 2 semaines, garantissant une preuve mathématique vérifiable de sa rareté. Contrairement aux euros et aux dollars en circulation qui changent fréquemment à la volonté des décideurs politiques, Bitcoin est une monnaie mathématique avec une politique monétaire fixe. Elle est donc une excellente réserve de valeur car elle ne peut pas être modifiée. De plus, Bitcoin est une monnaie non humaine et non émotionnelle qui exécute bêtement.

Bitcoin remet en question le pouvoir des institutions financières sur la monnaie. C'est un combat philosophique et économique qui est en jeu. Pour comprendre Bitcoin, il est important de comprendre ses bases fondamentales et de démystifier les idées fausses qui l'entourent. Cela permettra d'engager un débat intellectuel constructif sur l'avenir de la monnaie.

En conclusion, Bitcoin est une alternative monétaire réaliste qui offre un défi philosophique et économique aux institutions financières. Il est important de comprendre ses bases fondamentales pour entamer un débat intellectuel constructif sur l'avenir de la monnaie.
...
Chaque portefeuille contient une paire de clés: une clé publique, qui est comme une adresse postale, et une clé privée, qui est comme la clé de votre boîte aux lettres. La clé publique est l'adresse que vous donnez aux gens pour qu'ils vous envoient des Bitcoins, et la clé privée est ce qui vous permet de dépenser les Bitcoins reçus à cette adresse.
Le coût d'un portefeuille Bitcoin peut varier en fonction de vos besoins spécifiques et du montant que vous souhaitez sécuriser. Il existe différents types de portefeuilles adaptés à différents usages, que vous soyez une petite ou grande entreprise, ou un particulier.
Bien que vos clés soient stockées dans votre portefeuille, les Bitcoins eux-mêmes sont en fait stockés dans la blockchain Bitcoin, qui est un registre public distribué dans le cloud. C'est pourquoi la perte de votre portefeuille ne signifie pas nécessairement la perte de vos Bitcoins, tant que vous avez sauvegardé votre clé privée ailleurs.

Les Bitcoins ne sont pas réellement "stockés" dans votre portefeuille, mais plutôt dans la blockchain Bitcoin dans le cloud. Pour accéder à vos Bitcoins, vous avez besoin de votre clé privée, qui est généralement une liste de 24 mots connue sous le nom de "phrase de récupération" ou "graine de récupération". La probabilité de deviner cette phrase est extrêmement faible, grâce à la puissance de la cryptographie.
Si quelqu'un était capable de craquer la cryptographie de Bitcoin, ils seraient capables de craquer à peu près n'importe quoi. Heureusement, la sécurité de Bitcoin peut être renforcée si nécessaire. En effet, la probabilité de deviner correctement votre phrase de récupération est à peu près la même que celle de trouver un grain de sable spécifique parmi tous les grains de sable sur Terre.
...
Il existe plusieurs types de portefeuilles pour sécuriser vos Bitcoins, et le choix dépendra du niveau de sécurité souhaité. Les normes de sécurité varient en fonction des niveaux.
Au niveau 1, nous avons la clé privée, qui débloque l'accès à vos fonds. C'est une liste de 24 mots, et une seule signature est nécessaire pour effectuer une transaction. Les différents types de portefeuilles comprennent les portefeuilles matériels (hardware wallets), les applications mobiles et les logiciels de bureau. Cependant, la valeur de l'argent est subjective, il est donc crucial d'adapter la sécurité au niveau de confort de chaque utilisateur.
Au niveau 2, en plus de la clé privée, une phrase de passe est nécessaire. Le niveau 3 est la sécurité multi-signature (Multi-sig), qui nécessite plusieurs signatures pour autoriser une transaction. Ce dernier est idéal pour les entreprises.
Les risques associés aux portefeuilles incluent la perte des clés, le vol et le piratage. La sécurité multi-signature permet de limiter ces risques et d'assurer la sécurité des fonds.

Le modèle "custodial" est un système traditionnel où vous confiez vos Bitcoins à une tierce partie de confiance pour sécuriser votre épargne. Le problème avec ce système est que vous perdez les avantages de la souveraineté financière que Bitcoin offre, tels que la propriété directe de vos économies et l'indépendance vis-à-vis des banques.
Les risques du modèle custodial incluent le fait de confier votre argent à quelqu'un d'autre, et le risque que cette plateforme soit piratée ou fasse faillite. Les erreurs humaines sont souvent à l'origine des piratages, pas les logiciels utilisés.
L'utilisation d'un portefeuille froid, qui n'est pas connecté à internet, est recommandée pour éviter les piratages. En utilisant des services custodiaux, nous risquons de recréer le système financier traditionnel où les banques contrôlent l'épargne de chacun et peuvent se permettre de créer plus d'argent qu'elles n'en détiennent réellement.

En conclusion, la possession directe de ses Bitcoins est un élément essentiel pour assurer sa souveraineté financière et se préparer à toute instabilité potentielle du système financier actuel. Il est recommandé d'utiliser un portefeuille mobile pour les dépenses quotidiennes et un portefeuille physique hors ligne, ou "froid", pour stocker des montants plus importants. Les entreprises, quant à elles, devraient envisager l'utilisation de systèmes de signatures multiples, ou "multisig", pour une sécurité accrue.
Il est essentiel d'éviter autant que possible les services de garde ("custodial services"), qui peuvent reproduire certaines des vulnérabilités du système financier traditionnel. Les étapes pratiques pour créer et gérer un portefeuille Bitcoin seront abordées dans notre prochaine session.
...
La sécurité de vos Bitcoins est d'une importance cruciale et une simple erreur peut avoir des conséquences coûteuses. C'est pourquoi nous allons progresser pas à pas et vous guider avec les meilleures pratiques de l'industrie.
Votre clé privée, souvent représentée par une liste de 24 mots (ou "seed"), est le sésame de vos fonds. Si cette clé est révélée à un tiers, considérez que les fonds associés ne sont plus en sécurité. Par conséquent, lors de l'initialisation de votre portefeuille, il est important de respecter ces règles :
...
Une méthode pour sécuriser vos bitcoins à long terme est de graver vos clés de récupération (par exemple, une phrase de 24 mots, connue sous le nom de seed phrase) dans un matériau résistant comme l'acier. Cela crée un backup physique de vos clés qui est résistant à la fois à la détérioration physique et au feu.

Conjointement à cela, la création d'un plan d'héritage est également une étape cruciale pour garantir que vos actifs numériques seront correctement gérés après votre mort. Ce plan peut inclure une lettre manuscrite détaillant vos actifs et identifiant des personnes de confiance à contacter. Il est également crucial de discuter de l'acquisition de bitcoins avec un notaire pour assurer la conformité fiscale, bien qu'il soit important de ne jamais confier directement vos bitcoins à un tiers, y compris à un notaire.
...
Les portefeuilles Bitcoin sont des logiciels permettant de stocker et gérer des Bitcoins. Il en existe plusieurs types :

- Les portefeuilles mobiles : ces applications sont disponibles sur votre smartphone et sont pratiques pour des petits montants. Cependant, ils sont moins sécurisés que d'autres portefeuilles.
- Les portefeuilles sur ordinateur : ces logiciels sont installés sur votre ordinateur et sont plus sécurisés que les portefeuilles mobiles. Cependant, ils peuvent être sensibles aux virus et aux attaques de hackers.
- Les clés USB : ces portefeuilles sont plus sûrs que les portefeuilles sur ordinateur, car ils ne sont pas connectés en permanence à internet.

Pour initialiser un portefeuille, vous devez écrire une liste de 24 mots ou 12 mots sur un bout de papier sans caméra. La clé privée représente votre droit de signer et d'envoyer des Bitcoins.

Pour garantir la sécurité de votre portefeuille Bitcoin, il est important de suivre certaines règles.

- Créer un plan d'héritage : pour garantir que vos proches puissent récupérer l'argent en cas de problème, vous devez créer un plan d'héritage et graver votre clé privée dans l'acier.
- Éviter les plateformes d'échange : il faut éviter de laisser vos Bitcoins sur des plateformes d'échange, car elles peuvent être sujettes à des attaques de hackers. Il est préférable d'utiliser des adresses de réception pour recevoir et envoyer des Bitcoins.
- Utiliser des portefeuilles froids : votre niveau de sécurité évolue en trois étapes : portefeuille mobile, portefeuille froid (hardware wallet) et système de multisignature. Les portefeuilles froids sont des dispositifs physiques qui stockent vos Bitcoins et sont plus sûrs que les portefeuilles mobiles ou sur ordinateur.
...
Une transaction Bitcoin implique un échange de Bitcoins entre deux parties. Prenons par exemple deux protagonistes, Alice et Bob. Alice souhaite acquérir des Bitcoins, tandis que Bob en détient déjà.

Pour que Bob puisse transférer des Bitcoins à Alice, celle-ci doit fournir à Bob son adresse Bitcoin, qui sert essentiellement de destination de réception pour les Bitcoins. Cette adresse, dérivée de la clé publique de Alice, est unique à son portefeuille Bitcoin.
Ensuite, Bob initie la transaction en utilisant l'adresse de réception de Alice. Il ajoute également des frais de transaction, qui sont une incitation pour les mineurs à inclure la transaction dans le bloc suivant. Ces frais sont essentiels pour empêcher le réseau d'être inondé de transactions sans valeur.
La taille de la transaction dépend du nombre de parties impliquées et de la complexité de la transaction. Pour finaliser la transaction, Bob doit la signer numériquement avec sa clé privée, ce qui permet de vérifier qu'il est bien le propriétaire des Bitcoins qu'il souhaite transférer.

Les mineurs ont pour rôle de prendre les transactions non confirmées, de les vérifier et de les compiler dans un bloc. Pour ce faire, ils doivent résoudre une énigme cryptographique dans un processus appelé "preuve de travail". C'est un processus computationnellement intensif qui nécessite une puissance de traitement considérable.
Cette preuve de travail nécessite de trouver une solution à une équation mathématique difficile, un processus qui peut nécessiter des milliards de tentatives. Après avoir trouvé une solution, les mineurs peuvent ajouter le bloc à la blockchain et sont récompensés pour leur travail avec des Bitcoins nouvellement créés et les frais de transaction.

Après la validation par les mineurs, le bloc est ajouté à la blockchain, qui est un registre public immuable de toutes les transactions Bitcoin. Chaque bloc est ajouté à la blockchain environ toutes les dix minutes.
Il est essentiel de noter que modifier l'historique de la blockchain nécessiterait une quantité de puissance de calcul supérieure à 51% de tout le réseau de minage de Bitcoin, ce qui est pratiquement impossible.
Cependant, si un mineur malveillant réussissait à insérer une transaction frauduleuse dans son bloc et à résoudre la preuve de travail, le bloc serait ajouté à la blockchain. Cependant, il serait rejeté par les autres nœuds du réseau qui valident les transactions en se référant à la règle de consensus du réseau.

En fin de compte, le système de transactions Bitcoin est décentralisé et fonctionne en peer-to-peer, sans intermédiaire de confiance. Les utilisateurs transmettent de l'argent en signant numériquement les transactions avec leurs clés privées. Les mineurs ne détiennent pas tout le pouvoir, car les utilisateurs ont également un contrôle significatif via les nœuds.
Pour que le réseau Bitcoin soit complètement détruit, il faudrait éliminer tous les mineurs, nœuds et utilisateurs - une tâche pratiquement impossible en raison de la nature décentralisée du réseau.
...
Le réseau Bitcoin est constitué de l'ensemble des nœuds connectés. Chaque nœud détient une copie de la blockchain, ce qui permet de vérifier les transactions et d'éviter toute tentative de fraude. L'aspect décentralisé du réseau confère à Bitcoin une résilience et une robustesse exceptionnelles - pour le détruire, il serait nécessaire d'éliminer tous les nœuds à travers le monde.
Les nœuds remplissent trois principales missions : conserver l'historique de la blockchain, transmettre les informations, et vérifier l'exactitude des transactions diffusées. Ils suivent les règles du consensus Bitcoin pour valider les transactions et les blocs. Ces règles sont simples et invariables. De plus, les nœuds supervisent les règles du consensus monétaire de Bitcoin pour s'assurer que les mineurs respectent les directives du minage.

Les nœuds agissent en quelque sorte comme le système juridique du réseau. Grâce à eux, tous les participants du réseau suivent les mêmes règles. Pour apporter des modifications au réseau, il est nécessaire d'obtenir l'approbation de l'ensemble des nœuds. Si la majorité approuve un changement, tous les nœuds sont mis à jour avec les nouvelles règles. Les modifications majeures sont rares et requièrent une coordination importante entre des milliers d'acteurs aux idéologies variées.
Coûts et hébergement des nœuds Bitcoin
Une fois que l'on comprend l'importance des nœuds dans le réseau Bitcoin, il convient d'examiner leur coût et leurs options d'hébergement. Le coût d'un nœud dépend du type de nœud, mais peut s'élever à environ 200-300 euros pour un nœud physique.

Les dépenses nécessaires pour faire fonctionner un nœud Bitcoin comprennent une connexion internet de 20 gigas de bande passante par mois, qui coûte en moyenne 150-200 euros, et environ 5 euros par an pour l'électricité. Il est possible d'acquérir des boîtiers spécifiques pour héberger le matériel nécessaire à la gestion d'un nœud Bitcoin.
Il existe deux options pour héberger un nœud : à domicile ou via un serveur d'hébergement, ce dernier coûtant en moyenne 12 euros par mois. L'intérêt des nœuds dans la décentralisation du réseau Bitcoin est crucial à comprendre. Des formations dédiées aux nœuds MRL existent pour ceux qui souhaitent approfondir leur compréhension.
Le coût abordable et l'accessibilité d'un nœud Bitcoin, comparativement à d'autres crypto-monnaies qui nécessitent des infrastructures plus coûteuses, constituent un avantage non négligeable.

L'un des principes fondamentaux de Bitcoin est l'utilisation de nœuds pour valider les transactions et diffuser les informations à travers le réseau. Cette structure garantit la décentralisation du système et l'indépendance financière des utilisateurs. Cette approche contraste avec d'autres crypto-monnaies qui n'offrent pas à tous la possibilité de posséder des nœuds, limitant ainsi leur décentralisation et leur résilience.

Un point clé du fonctionnement de Bitcoin réside dans la taille limitée de ses blocs. Cette restriction restreint le nombre de transactions qui peuvent être traitées en un temps donné. Si la taille des blocs était augmentée, cela pourrait entraîner une centralisation du réseau et élever les barrières à l'entrée pour les nouveaux participants. De plus, si les nœuds restent hors de portée d'interventions extérieures, Bitcoin peut résister efficacement à toute forme de censure.
L'année 2017 a été marquée par une intense controverse, connue sous le nom de "guerre des blocs". Ce conflit a opposé les acteurs souhaitant modifier Bitcoin en augmentant la taille des blocs pour augmenter la capacité de transaction, à ceux qui cherchaient à préserver l'indépendance et le pouvoir des utilisateurs. Finalement, les utilisateurs et les nœuds ont triomphé en rejetant la proposition de changement initiée par les mineurs, les plateformes d'échange et les institutions.
Suite à cette victoire, les nœuds ont activé le protocole SegWit, permettant des améliorations futures et ouvrant la voie à la mise en place du Lightning Network. Cette situation démontre que les utilisateurs, grâce à leurs nœuds, détiennent un pouvoir réel au sein de Bitcoin, leur permettant de faire face aux grandes institutions. Les véritables perdants de cette guerre ont été Bitcoin Cash et Bitcoin Satoshi Vision, qui ont perdu respectivement 80% et 90% de leur valeur monétaire par rapport à Bitcoin, et qui sont relativement peu utilisés.

En somme, les nœuds, qu'ils soient incarnés par des dispositifs physiques ou des logiciels en ligne, jouent un rôle central dans l'écosystème Bitcoin. Ils conservent l'historique de la blockchain, valident les transactions, diffusent l'information, maintiennent le consensus du réseau, votent sur les futures améliorations et assurent la décentralisation du système.
...
Le modèle économique des mineurs repose sur les récompenses qu'ils reçoivent pour leur travail. Pour maximiser leurs chances de succès, les mineurs collaborent souvent en groupes appelés "pools de minage", où ils combinent leurs ressources de calcul.
Les mineurs rassemblent les transactions en blocs candidats et cherchent à résoudre l'équation mathématique complexe qui validera le bloc. En cas de scission de la chaîne de blocs (fork), deux chaînes concurrentes coexistent jusqu'à ce qu'un nouveau bloc soit ajouté à l'une d'entre elles, déterminant ainsi la chaîne principale.

Bitcoin a innové en proposant une solution au problème de la double dépense grâce à l'utilisation de la blockchain. Dans le monde numérique, la notion de propriété diffère de celle du monde physique. Sur internet, tout peut être copié et collé, ce qui pose des problèmes en termes de double dépense pour les biens numériques de valeur.
Des intermédiaires de confiance, comme les banques, ont été créés pour résoudre ce problème technologique et garantir que lorsqu'un bien est transféré, il n'appartient plus à l'émetteur. Le problème des généraux byzantins, un problème de coordination de l'information dans un système décentralisé sans intermédiaire de confiance, se pose alors.
La preuve de travail et la blockchain sont les solutions apportées par Bitcoin pour résoudre ce problème. Les "généraux" de Bitcoin, ou mineurs, vérifient les transactions financières via la blockchain pour garantir l'authenticité de l'information. La dépense énergétique assure la fiabilité de l'information.

Les mineurs sont les gardiens de la sécurité du réseau Bitcoin. Ils dépensent de l'énergie pour résoudre des équations mathématiques complexes. En cas de tricherie, ils perdraient de l'argent et leur investissement serait inutile, ce qui les dissuade de se comporter de manière malhonnête.
Même dans le cas d'une attaque de 51%, le réseau reste sécurisé car l'attaquant doit dépenser autant d'énergie que l'ensemble des mineurs pour tenter de modifier la blockchain. C'est grâce à ce mécanisme de preuve de travail, qui nécessite de l'énergie pour être accompli, que le réseau est sécurisé.
La théorie du jeu appliquée à Bitcoin écarte les mineurs malhonnêtes. Les mineurs utilisent des machines ASIC pour miner et reçoivent une récompense en cas de succès. De plus, ils se regroupent souvent en pools de minage pour partager leur puissance de calcul et obtenir des récompenses plus rapidement.
...
Bitcoin, en tant qu'invention révolutionnaire, a donné aux individus vivant sous l'oppression financière ou sous un régime dictatorial un moyen de lutter pour leur liberté. En tant que dernier recours, Bitcoin offre une forme de liberté financière en échappant à la censure et aux restrictions bancaires. Bitcoin est plus qu'une simple monnaie. C'est une forme de communication et d'expression de la liberté. L'énergie dépensée par les mineurs contribue à la défense de notre liberté. Bitcoin permet l'émancipation du système financier actuel, dominé par la dette et la création monétaire excessive des banques centrales.
Pour ceux qui vivent dans des pays avec une inflation élevée, Bitcoin est une question de survie. Il fournit un moyen de survivre dans des situations financières précaires. De plus, Bitcoin offre un système financier plus juste et plus équitable. Il donne également l'opportunité à des milliards de personnes dans le monde d'accéder au système financier.

Les mineurs de Bitcoin sont des ordinateurs spécialisés qui résolvent des énigmes mathématiques pour sécuriser le réseau et valider les transactions. Ils sont récompensés pour leur travail par la création de nouveaux blocs et les transactions qui s'y trouvent.
Les machines ASIC, spécifiquement conçues pour miner du Bitcoin, sont couramment utilisées. Contrairement aux cartes graphiques utilisées pour miner d'autres cryptomonnaies, les ASIC sont plus efficaces et ont une plus grande durée de vie. Cependant, leur utilisation a suscité des préoccupations environnementales.
Les mineurs sont mobiles et peuvent se déplacer en fonction des lois et des taxes. L'électricité constitue 90 à 95% des coûts d'exploitation des mineurs, ce qui rend la source, le coût et la durabilité de l'électricité particulièrement importants.
Le risque d'une attaque à 51% est faible, car il est peu probable qu'un acteur unique puisse maintenir cette majorité suffisamment longtemps pour causer des dommages importants. Lorsque la production de bitcoins s'arrêtera, les frais de transaction augmenteront sur la blockchain principale. Cependant, les microtransactions et les transactions quotidiennes continueront à être traitées sur des couches secondaires, comme le Lightning Network.

Le débat sur l'impact écologique de Bitcoin est souvent mal orienté, principalement à cause d'une compréhension insuffisante de son utilité et de son fonctionnement. Bitcoin ne peut pas être évalué simplement en termes de coût énergétique par transaction, car les mineurs sécurisent à la fois le réseau actuel et historique, les transactions sont regroupées et ne sont pas toutes équivalentes, et l'impact du Lightning Network n'est pas pris en compte.
Ceux qui prétendent que Bitcoin consomme trop d'énergie peuvent avoir des motivations politiques ou cherchent à vendre leur propre solution blockchain. Le prétexte écologique est utilisé pour justifier le bannissement de Bitcoin.

Finalement, il est essentiel de discuter des enjeux économiques et environnementaux de l'adoption de Bitcoin.
Le système financier actuel, par son encouragement à la surconsommation et à l'endettement, pose de sérieux problèmes. La facilité d'accès au crédit, l'émission monétaire par les banques et le recours à la réserve fractionnaire sont autant de facteurs qui favorisent le surendettement.
Il est nécessaire de réformer le système monétaire afin de rendre l'argent et les ressources plus rares. Cela encouragera une consommation plus responsable et une vision à long terme. L'inflation, en incitant à la consommation et à l'investissement, a un impact négatif sur l'environnement.
L'économie keynésienne actuelle, contrairement à l'économie autrichienne, ne tient pas compte de l'aspect temporel. L'argent illimité ne peut coexister avec les ressources limitées de notre planète.
Les politiciens, en raison de leur vision à court terme et de leur besoin de croissance économique pour être réélus, ne sont pas en mesure de résoudre les problèmes écologiques à long terme. Adopter une monnaie saine comme Bitcoin pourrait permettre de rendre le pouvoir économique au peuple.
...
La fin du pétrodollar est nécessaire pour mettre fin aux guerres et à la surconsommation. Le système bancaire, basé sur le pétrodollar, favorise la guerre. En supprimant le pétrodollar, on peut mettre fin aux guerres et à l'émission excessive de monnaie.
L'industrie de l'or, avec ses machines polluantes, a un impact environnemental plus important que l'industrie du Bitcoin. La technologie du Bitcoin est souvent mal comprise, et les critiques concernant son impact écologique sont souvent simplistes. Ces critiques peuvent être motivées par des intérêts politiques.
...
## Résumé sur les aspects techniques de Bitcoin

![conclusion chapitre 3](https://youtu.be/gqILoXTUKdc)

Satoshi Nakamoto lança en Janvier 2009 le protocole Bitcoin, qui a évolué grâce aux mineurs, nœuds et améliorations. La communauté maintient Bitcoin anonyme et grâce à l'utilisation des nœuds, qui contrôlent le réseau. Les mineurs utilisent des machines ASICS et de l'électricité pour valider des blocs dans la blockchain.

Cependant, le débat écologique est tendu, certains défendent Bitcoin comme un système financier alternatif plus efficace pour les personnes n'ayant pas de compte bancaire, tandis que d'autres critiquent son impact environnemental. Les arguments contre Bitcoin polluant sont souvent infondés. Faire des recherches avant de débattre pour éviter de dire des âneries.

Le processus de transaction Bitcoin est décentralisé, incensurable et instoppable. Bitcoin n'a pas de leader et ne peut pas être arrêté. Il est possible de réguler les échanges pour limiter Bitcoin, mais cela est limité dans la fonctionnalité. Aucun juge ou état ne peut censurer ou arrêter Bitcoin.

# L'économie circulaire Bitcoin
...
Le développement et l'évolution de Bitcoin sont en grande partie liés aux différents groupes d'acteurs qui ont progressivement intégré son écosystème. Les premiers utilisateurs de Bitcoin étaient principalement des technophiles, des libertariens et des adeptes de l'or. Ces groupes ont été attirés par le Bitcoin en raison de sa capacité à résoudre des problèmes tels que la déréglementation financière et la censure. Plus tard, l'utilisation de Bitcoin s'est étendue à des sites de commerce illicite sur le dark web, comme Silk Road, en raison de sa nature incontrôlable et pseudo-anonyme.

La deuxième vague d'adoption a été largement stimulée par l'utilisation du Bitcoin sur Silk Road, un marché noir sur le dark web. Ce site a attiré l'attention sur le caractère non contrôlable et pseudo-anonyme du Bitcoin, ce qui a incité certains acteurs criminels à l'utiliser. Toutefois, il convient de noter que l'usage qui est fait d'un outil, et non l'outil lui-même, détermine sa légalité ou son illégalité.
Il convient de noter que l'utilisation illégale de Bitcoin ne fait pas d'une personne un criminel en soi. C'est l'utilisation, et non l'outil, qui peut être classée comme illégale. Par exemple, l'utilisation de Bitcoin pour des activités telles que la prostitution est légale ou illégale en fonction de la réglementation de chaque pays sur cette activité.
...
Le marché du Bitcoin est unique en ce sens qu'il fonctionne à l'échelle mondiale, 24 heures sur 24, 7 jours sur 7, rendant la régulation difficile pour les autorités financières. Contrairement aux monnaies traditionnelles, comme l'euro, qui peuvent perdre de la valeur, le Bitcoin a montré une tendance à la hausse en raison de sa rareté croissante. Cependant, l'industrie des crypto-monnaies n'est pas sans risques, en particulier pour les débutants. Les arnaques et les piratages sont fréquents. De plus, il existe de nombreux concepts et tendances émergentes à comprendre, comme les NFT (Non Fungible Tokens), qui existent depuis 2015 mais ont récemment gagné en popularité, le Metaverse, un univers virtuel, et la DeFi (Finance Décentralisée), qui est actuellement perçue comme spéculative. La compréhension et l'enthousiasme pour le marché des crypto-m

Pour résumer, il est important de noter que le Bitcoin est caractérisé par une volatilité inhérente. Par conséquent, il est généralement recommandé d'opter pour une stratégie d'investissement à long terme plutôt que de se lancer dans des activités de trading à court terme. Bien que le prix du Bitcoin puisse subir des fluctuations significatives, il a tendance à augmenter en moyenne sur une période de cinq ans.
Nous encourageons une approche d'épargne réfléchie qui inclut une allocation en Bitcoin, ajustée en fonction de votre tolérance au risque et de vos objectifs financiers. Pour ceux qui sont intéressés à acquérir du Bitcoin, diverses méthodes existent, y compris l'achat direct ou l'acquisition via l'exercice d'activités professionnelles.
Le monde du Bitcoin est riche et constamment en évolution, offrant de nombreuses opportunités d'apprentissage et de développement. Il est recommandé de poursuivre votre éducation et de rester informé des dernières tendances et développements dans ce domaine.

Il est important de souligner que cet avertissement n'est pas un conseil financier. Bitcoin, comme tout autre investissement, comporte des risques. Ne dépensez pas plus d'argent que vous ne pouvez vous permettre de perdre. Faites toujours preuve de diligence raisonnable et consultez un conseiller financier qualifié avant de faire tout investissement.
...
![Bitcoin ne dort jamais](assets/posters/fr/15_bitcoin_ne_dort_jamais_crop.png)

## Obtenir des bitcoins en travaillant

![obtenir des bitcoin en travaillant](https://youtu.be/sHkadVRUQF8)

Bitcoin peut être perçu comme une économie parallèle à celle des monnaies traditionnelles. Cela signifie qu'il est possible de vendre des biens ou des services et d'être payé en Bitcoin. Les transactions peuvent être effectuées directement en Bitcoin, sans avoir besoin de passer par une plateforme d'échange.
...
En outre, pour faciliter l'utilisation de Bitcoin dans les transactions du quotidien, un projet open-source et collaboratif a été lancé : BTCMap. Ce dernier recense tous les commerçants qui acceptent Bitcoin ainsi que les différentes communautés Bitcoin à travers le monde. Vous pouvez visiter leur site à l'adresse https://btcmap.org/ pour découvrir l'écosystème Bitcoin autour de vous. Ainsi, malgré les difficultés et les réticences, il existe des initiatives comme BTCMap qui contribuent à rendre l'économie du Bitcoin plus accessible et pratique pour tous.

Accepter le Bitcoin en tant que commerçant présente plusieurs avantages, dont l'absence de censure, des frais de transaction réduits, une efficacité accrue, une protection contre l'inflation, ainsi que la liberté et la souveraineté financière. En outre, l'activité commerciale et l'économie circulaire du Bitcoin peuvent contribuer au réseau Bitcoin tout en permettant d'acquérir des Bitcoins.
Pour accepter le Bitcoin, il est nécessaire d'étudier les différentes solutions disponibles et de choisir celle qui convient le mieux à votre entreprise. Plusieurs facteurs doivent être pris en compte, tels que le volume de transactions attendu, le budget alloué, le type de commerce (en ligne ou physique), entre autres.

Il existe trois niveaux d'acceptation du Bitcoin : le code QR statique, le portefeuille dédié aux factures, et l'utilisation du réseau Lightning. Le code QR statique permet de recevoir des paiements en Bitcoin simplement en scannant un code, tandis que le réseau Lightning permet des transactions quasi instantanées avec des frais extrêmement faibles.
...
Bitcoin est devenu un actif financier important, principalement en raison de son offre limitée et de sa demande croissante. Toutefois, l'achat de Bitcoin comporte des risques qui nécessitent une attention particulière. Il est donc recommandé de consulter un conseiller en investissement avant d'investir.
...
Une méthode courante d'accumulation de Bitcoins est le "Dollar Cost Averaging" (DCA), qui consiste à investir régulièrement de petits montants. Plusieurs plateformes offrent ce service, telles que Stacking Sat, Relay et PEMIUM. Le DCA peut aider à lisser les fluctuations de prix à court terme et est donc considéré comme une stratégie d'investissement viable pour la plupart des individus.
...
Retrait et Utilisation des Bitcoins, Aspects Juridiques et Futur Hypothétique
Après l'achat, il est conseillé de retirer immédiatement les Bitcoins des plateformes d'échange pour minimiser les risques de piratage et de blocage des fonds. Les frais de retrait peuvent être élevés, parfois jusqu'à 25 euros selon la plateforme, il est donc recommandé de procéder par étapes pour s'assurer de la sécurité des transactions.
L'utilisation de plateformes réglementées est essentielle pour éviter des accusations de blanchiment d'argent, de financement du terrorisme ou d'évasion fiscale. Il est important de noter que, bien que le système KYC (Know Your Customer) soit souvent critiqué, il joue un rôle crucial dans la prévention de ces activités illicites.
Les transactions Bitcoin sont traçables, ce qui peut potentiellement nuire à la vie privée des utilisateurs. Un système d'adresses vertes et rouges, rendu possible par le KYC, pourrait théoriquement entraver Bitcoin, mais il est peu probable que cela se produise à cause de la nature décentralisée et pair à pair de Bitcoin.
L'achat de Bitcoins peut se faire via des distributeurs automatiques de Bitcoin (ATM), même si ces derniers sont rares en France. Le nombre de ces distributeurs est en augmentation constante à travers le monde.
...
![epargne en bitcoin](assets/posters/fr/16_epargne_avec_bitcoin_crop.png)
...
Reconnu comme une couche de Bitcoin, le Lightning Network a été validé et adopté à grande échelle depuis 2021. Il permet de réaliser des microtransactions instantanées à faible coût, résolvant ainsi le problème de scalabilité de Bitcoin.
Le Lightning Network fonctionne grâce à des canaux de liquidité. La liquidité est transmise de droite à gauche et vice versa en fonction des besoins. Les transactions sont verrouillées via un système de signatures multiples (multisig) et sont régies par de nouvelles règles, lois, formes et flexibilités.

Le Lightning Network agit comme un réseau de canaux de paiement, permettant des transactions instantanées et sans frais entre les deux parties. Ce réseau de canaux de paiement rend possible des transactions entre individus qui n'ont pas de canal directement connecté.
Les utilisateurs du Lightning Network peuvent payer des frais d'ouverture de canaux pour créer un contrat intelligent multisig. Il n'y a pas de frais de transaction entre utilisateurs directement connectés, mais des frais sont payés aux nœuds de routage Lightning (hubs) pour les transactions entre utilisateurs non connectés.
Les services de transfert d'argent traditionnels, tels que Western Union, les banques centrales, Visa et Mastercard, pourraient disparaître s'ils n'adoptent pas la technologie Lightning Network. Le Lightning Network est plus efficace, moins cher et plus éthique que le système financier traditionnel.

En effet, le Lightning Network permet de réaliser des millions et des milliards de transactions entre deux personnes connectées sans frais et sans dépenses énergétiques sur la blockchain de base. Les transactions sont sécurisées par la technologie cryptographique et indirectement par l'énergie des mineurs et la blockchain de base. Les transactions peuvent être effectuées instantanément, sans limite géographique, et les frais sont extrêmement faibles.
Le Salvador est un exemple de pays utilisant principalement le Lightning Network. Des startups comme Strike tirent parti de cette technologie pour envoyer des euros et des dollars en une seconde et sans frais.

Le Lightning Network est l'avenir de Bitcoin. Les choix d'ingénierie pour Bitcoin sont minutieusement réfléchis, traitant Bitcoin comme du code nucléaire ou spatial. La perte de Bitcoin serait une perte de possibilité de libération financière.
Le Lightning Network est une nouvelle couche infrastructurelle pour résoudre le problème de la scalabilité de Bitcoin. Il permet de réaliser des millions et des milliards de transactions entre deux personnes connectées sans frais et sans dépenses énergétiques sur la blockchain de base. Il est essentiel de se tenir informé de cette technologie pour comprendre l'avenir de Bitcoin et de la finance en général.

![le lightnign network](assets/posters/fr/20_explication_lightning_network_crop.png)

## Cas d’usage du Lightning Network

![cas d'usage du LN](https://youtu.be/_UV2jmQ8TQM)

Le protocole Bitcoin, bien que révolutionnaire, a fait face à des défis importants en matière de scalabilité et d'efficacité des transactions. Pour résoudre ces problèmes, une solution de deuxième couche connue sous le nom de Lightning Network a été proposée et mise en œuvre. Cette technologie vise à faciliter les micro-transactions, c'est-à-dire les transactions de très faible valeur, qui seraient autrement impraticables en raison des frais élevés et des temps de confirmation longs sur la blockchain Bitcoin.

Le Lightning Network fonctionne en créant des canaux de paiement hors chaîne entre les parties qui souhaitent effectuer des transactions fréquentes. Ces canaux permettent des transactions quasi-instantanées et des frais minimaux, rendant viables les micro-transactions.
Cette technologie ouvre la porte à une gamme étendue d'applications potentielles pour Bitcoin, qui étaient auparavant hors de portée en raison des limitations inhérentes à la technologie blockchain. Parmi ces applications, on trouve les nœuds de routage pour l'efficacité du réseau, le streaming d'argent pour les paiements en temps réel, la messagerie pour les communications sécurisées et décentralisées, et les modèles commerciaux futuristes qui étaient auparavant inimaginables.
...
Le Lightning Network permet aux joueurs de mettre en jeu de très petits montants d'argent lorsqu'ils jouent à des jeux, comme 0,001 centime. Cela donne lieu à des systèmes de jeux vidéo monétaires, où la compétition n'est pas seulement pour le plaisir du jeu, mais aussi pour un gain financier réel.
Les parties peuvent être tarifées, avec des frais d'entrée allant de 1 centime à 10 euros. Cela ajoute un élément de compétitivité qui rend le jeu plus intéressant et engageant. De plus, les entreprises peuvent parrainer des parties pour de petits montants, créant ainsi de nouvelles opportunités pour les joueurs dans des régions comme l'Afrique, où le gain potentiel peut avoir un impact significatif.

En somme, l'avenir des micro-transactions avec Bitcoin semble prometteur grâce à des innovations comme le Lightning Network. Alors que ces technologies continuent à se développer et à mûrir, nous pouvons nous attendre à voir de nouvelles et passionnantes applications émerger dans un avenir proche.

Le concept de "streaming d'argent" est une vision pour l'avenir qui est rendue possible grâce au Lightning Network. Ce réseau permet des micro-transactions instantanées, ouvrant la voie à des modèles économiques où les consommateurs paient à la seconde pour le contenu qu'ils consomment.
Dans un tel système, l'argent est automatiquement divisé, en fonction d'un pourcentage prédéfini, entre les différents contributeurs à un service ou un produit. Cela pourrait révolutionner la façon dont nous envisageons les modèles de paiement. Par exemple, plutôt que de payer un abonnement mensuel à un service, les utilisateurs pourraient être facturés à la seconde pour le temps qu'ils passent à utiliser le service.
Ce modèle économique pourrait avoir des implications profondes pour les créateurs de contenu, qui seraient incités à produire du contenu de qualité pour retenir l'attention des utilisateurs. Les utilisateurs, à leur tour, ne paieraient que pour le contenu qu'ils consomment, éliminant ainsi les frais d'abonnement anticipés. Il est même envisageable d'utiliser ce système pour payer pour des services tels que le dépassement d'une voiture sur la route.
Bien que ce système puisse sembler injuste pour certains, il est important de considérer les avantages. Les micro-transactions rendues possibles par Bitcoin permettent des paiements instantanés sans intermédiaires. Ainsi, les voitures pourraient potentiellement effectuer des paiements entre elles pour faciliter le dépassement, grâce à l'utilisation d'une monnaie programmable.

En conclusion, le Lightning Network ouvre une multitude de cas d'utilisation passionnants pour les utilisateurs de Bitcoin. Les modèles économiques et les opportunités commerciales qui en découlent sont nombreux et variés.
...
La censure doit être questionnée car qui a la connaissance pour décider ce qui doit être censuré ou non ? Les médias ont changé leur position sur certaines informations (ex: transmission du virus) et les personnes qui ont été censurées avant ne le sont plus aujourd'hui. Qui décide de ce qui est de la censure ou de la propagande ? Qui a la main divine sur notre système ? Tolérer la censure peut détruire la liberté d'expression et le droit de rassemblement. La mise en place de la censure est techniquement difficile sans créer une dystopie complète. Quelle instance devrait avoir le pouvoir de la censure ? La question de la censure est compliquée et il est difficile de savoir qui devrait être censuré ou non. La censure peut avoir un impact négatif sur l'innovation et la liberté d'entreprendre. La religion est un exemple de censure ayant eu des conséquences négatives dans l'histoire.
