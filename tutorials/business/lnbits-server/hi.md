---
name: LNbits सर्वर
description: PHOENIXD के साथ Ubuntu VPS पर या Umbrel पर एक स्व-होस्टेड LNbits सर्वर की स्थापना और कॉन्फ़िगरेशन
---
...
LNbits एक ओपन सोर्स Interface वेब एप्लिकेशन है जो किसी भी लाइटनिंग बैकएंड (LND, Core Lightning, PHOENIXD) को एक संपूर्ण सेवा प्लेटफ़ॉर्म में बदल देता है। यह स्व-होस्टेड समाधान आपको अपने फंड पर पूर्ण नियंत्रण बनाए रखते हुए, अलग-अलग कई लाइटनिंग पोर्टफ़ोलियो प्रबंधित करने, बिक्री केंद्र स्थापित करने, दान प्रणालियाँ या बिलिंग सेवाएँ बनाने में सक्षम बनाता है।



यह ट्यूटोरियल दो इंस्टॉलेशन विधियों को कवर करता है: **PHOENIXD के साथ VPS Ubuntu** (पूर्ण Bitcoin नोड के बिना हल्का समाधान) और **अम्ब्रेल** (आपके मौजूदा LND नोड के साथ एकीकरण)। प्लान बी नेटवर्क के सामान्य LNbits ट्यूटोरियल के विपरीत, जो अवधारणाओं और एक्सटेंशन को कवर करता है, यह गाइड चरण-दर-चरण तकनीकी इंस्टॉलेशन प्रक्रियाओं पर केंद्रित है।
...
LNbits, Python (FastAPI) में विकसित एक लाइटनिंग अकाउंटिंग सिस्टम है जो किसी मौजूदा बैकएंड (LND, Core Lightning, PHOENIXD) से जुड़ता है। पारंपरिक लाइटनिंग नोड्स के विपरीत, LNbits एक सुलभ Interface प्रदान करता है, जिससे आप अपनी API कुंजियों के साथ कई अलग-अलग पोर्टफ़ोलियो प्रबंधित कर सकते हैं। आप अपने परिवार, कर्मचारियों या परियोजनाओं के लिए उप-खाते बना सकते हैं, बिना उन्हें अपने सभी फंड तक पहुँच दिए।
...
एलएनबिट्स एक बहुमुखी विस्तार प्रणाली प्रदान करता है: टीपीओएस (बिक्री का बिंदु), पेवॉल (सामग्री मुद्रीकरण), इवेंट्स (टिकटिंग), एलएनडीहब (ब्लूवॉलेट के लिए सर्वर), जीडब्ल्यू-13 कार्ड (एनएफसी भुगतान), स्प्लिट पेमेंट्स (स्वचालित वितरण), और उपयोगकर्ता प्रबंधक (प्रमाणीकरण के साथ उपयोगकर्ता प्रबंधन)।



**डैशबोर्ड** वास्तविक समय में शेष राशि, लेन-देन इतिहास और बिलिंग टूल प्रदर्शित करता है। प्रत्येक Wallet में एक विशिष्ट URL होता है जिसमें उसकी API कुंजियाँ होती हैं, जिससे पारंपरिक लॉगिन के बिना भी पहुँच संभव होती है। तीन-स्तरीय API कुंजी प्रणाली** (एडमिन, Invoice, केवल-पठन) सुरक्षित एकीकरण के लिए अनुमतियों का विस्तृत नियंत्रण प्रदान करती है।



LNbits मूल रूप से **LNURL** (LNURL-पे, LNURL-Withdraw, LNURL-प्रमाणन) को क्रियान्वित करता है और **लाइटनिंग Address** का समर्थन करता है, जो आधुनिक लाइटनिंग वॉलेट्स के साथ संगतता की गारंटी देता है और पेशेवर सेवाओं की तैनाती को सुविधाजनक बनाता है।
...
## PHOENIXD के साथ Ubuntu VPS पर इंस्टॉल करना
...
### चरण 2: PHOENIXD स्थापित करना



एक बार आपका सर्वर सुरक्षित हो जाने पर, आपको PHOENIXD को इंस्टॉल और कॉन्फ़िगर करना होगा। प्लान बी नेटवर्क इंस्टॉलेशन, seed जनरेशन और systemd सर्विस कॉन्फ़िगरेशन पर एक संपूर्ण समर्पित ट्यूटोरियल प्रदान करता है:



https://planb.academy/tutorials/node/lightning-network/phoenixd-beb86edd-f9c0-4bec-ad36-db234c88e7b1

एक बार जब PHOENIXD चालू हो जाए (`./Phoenix-CLI getinfo` से जांच करें), तो `~/.Phoenix/Phoenix.conf` में **HTTP पासवर्ड** नोट करें - आपको LNbits को PHOENIXD से कनेक्ट करने के लिए इसकी आवश्यकता होगी।
...
PHOENIXD बैकएंड कॉन्फ़िगर करें:
...
`.env` में Interface व्यवस्थापक को सक्रिय करें:
...
सुपरयूज़र एडमिनिस्ट्रेशन Interface से, "सेटिंग्स" और फिर "यूज़र मैनेजमेंट" सेक्शन में जाएँ। आपको "नए यूज़र्स बनाने की अनुमति दें" विकल्प मिलेगा।
...
- कोई हमलावर आपके खाते बना सकता है और आपकी जानकारी के बिना आपके LIGHTNING NODE की तरलता का उपयोग कर सकता है
- आपको Interface सुपरयूज़र से मैन्युअल रूप से उपयोगकर्ता खाते बनाने होंगे
...
एक बार कॉन्फ़िगर हो जाने के बाद, केवल सुपरयूज़र एडमिनिस्ट्रेटर ही Interface "यूज़र्स" के ज़रिए नए यूज़र अकाउंट बना सकता है। यह तरीका इस बात पर पूरा नियंत्रण सुनिश्चित करता है कि कौन आपके लाइटनिंग इंफ्रास्ट्रक्चर तक पहुँच सकता है और आपके फंड का इस्तेमाल कर सकता है।
...
PHOENIXD ऑटो-लिक्विडिटी के ज़रिए चैनलों का प्रबंधन अपने आप करता है। generate, LNbits से ~30,000 Sats का एक लाइटनिंग Invoice खरीदता है और उसका भुगतान दूसरे Wallet से करता है। PHOENIXD, ACINQ के लिए अपने आप एक चैनल खोल देता है। शुरुआती शुल्क (~20-23 हज़ार Sats) काट लिया जाता है, और शेष राशि (~7-10 हज़ार Sats) On-Chain की पुष्टि के बाद दिखाई देती है।
...
अम्ब्रेल स्वचालित रूप से आवश्यक निर्भरताओं की जाँच करता है। LNbits को चलाने के लिए LIGHTNING NODE (LND) की आवश्यकता होती है। यदि आपका LIGHTNING NODE पहले से ही चालू है, तो पुष्टि करने के लिए "LNbits इंस्टॉल करें" पर क्लिक करें।
...
पहली बार लॉन्च करने पर, LNbits आपको सुपरयूज़र एडमिनिस्ट्रेटर अकाउंट बनाने के लिए कहेगा। Interface एडमिनिस्ट्रेशन सिस्टम तक पहुँच सुरक्षित रखने के लिए एक यूज़रनेम दर्ज करें और एक सुरक्षित पासवर्ड सेट करें।
...
**महत्वपूर्ण**: इस सुपरयूज़र खाते को आपके LNbits इंस्टेंस पर पूर्ण विशेषाधिकार प्राप्त हैं। एक मज़बूत पासवर्ड चुनें और उसे सुरक्षित रखें।



खाता बनाने के बाद, आपको स्वचालित रूप से Interface मुख्य प्रशासन क्षेत्र में ले जाया जाएगा। अम्ब्रेल ने पहले ही LND को आपके फंडिंग स्रोत के रूप में सेट कर दिया है - सभी लाइटनिंग भुगतान आपके मौजूदा चैनलों के माध्यम से होंगे।



### Interface व्यवस्थापक तक पहुँच
...
आपका नया उपयोगकर्ता अब अपने विशिष्ट पहचानकर्ता और उपयोगकर्ता नाम के साथ उपयोगकर्ताओं की सूची में दिखाई देता है।
...
**महत्वपूर्ण बिंदु**: प्रत्येक उपयोगकर्ता अपने पासवर्ड से पूरी तरह स्वतंत्र रूप से लॉग ऑन कर सकता है। सुपरयूज़र व्यवस्थापक Interface व्यवस्थापन उपकरण के माध्यम से पूर्ण नियंत्रण बनाए रखता है।
...
अब जब "Satoshi" उपयोगकर्ता बन गया है, तो आपको उसे Wallet लाइटनिंग असाइन करना होगा। संबंधित उपयोगकर्ता के लिए Wallet आइकन (दूसरा आइकन) पर क्लिक करें, फिर "नया Wallet बनाएँ" पर क्लिक करें।
...
"CREATE" पर क्लिक करें। LNbits तुरन्त इस उपयोगकर्ता के लिए एक कार्यशील Wallet लाइटनिंग उत्पन्न कर देता है।
...
"Satoshi" उपयोगकर्ता के पास अब एक एकल, स्पष्ट रूप से पहचाना गया Wallet है। प्रत्येक उपयोगकर्ता Wallet पूरी तरह से स्वायत्त रूप से कार्य करता है, जबकि आपके अंतर्निहित LND नोड की तरलता का उपयोग करता है।



**मुख्य अवधारणा**: ये सभी वॉलेट आपके अम्ब्रेल नोड की वैश्विक तरलता को साझा करते हैं। आप प्रत्येक Wallet के लिए नए लाइटनिंग चैनल नहीं बनाते - LNbits एक बुद्धिमान अकाउंटिंग Layer के रूप में कार्य करता है जो आपके मौजूदा लाइटनिंग इंफ्रास्ट्रक्चर के भीतर धन के आवंटन का प्रबंधन करता है। यही LNbits के मल्टी-Wallet सिस्टम की ताकत है।
...
सुपरयूज़र अकाउंट (ऊपर दाईं ओर आइकन) से लॉग आउट करें और LNbits लॉगिन पेज पर वापस आएँ। अब आप नए यूज़र के क्रेडेंशियल्स से लॉग इन कर सकते हैं।
...
पहले से निर्धारित उपयोगकर्ता नाम ("Satoshi") और पासवर्ड दर्ज करें, फिर "लॉगिन" पर क्लिक करें। उपयोगकर्ता को अपने व्यक्तिगत Wallet तक सीधी पहुँच प्राप्त होती है, जो प्रशासन Interface से पूरी तरह अलग होता है।
...
एक बार कनेक्ट होने के बाद, उपयोगकर्ता Wallet लाइटनिंग से अपने Interface तक पहुंच सकता है।
...
- Wallet को कनेक्ट करने के लिए मोबाइल ऐप से LndHub QR कोड को स्कैन करें
...
- अपने मोबाइल ब्राउज़र में सीधे Wallet खोलने के लिए अपने स्मार्टफ़ोन से इस QR कोड को स्कैन करें
...
सुरक्षा का यह दोहरा Layer (नेटवर्क एक्सेस + उपयोगकर्ता प्रमाणीकरण) अम्ब्रेल पर "नए उपयोगकर्ताओं के निर्माण की अनुमति दें" विकल्प को कम महत्वपूर्ण बनाता है। केवल वे लोग ही Interface लॉगिन तक पहुँच सकते हैं जिनके पास पहले से ही आपके नेटवर्क या VPN तक पहुँच है।
...
Interface सुपरयूजर पर वापस लौटें और संपूर्ण LNbits एक्सटेंशन इकोसिस्टम की खोज के लिए बाएं साइड पैनल में "एक्सटेंशन" मेनू तक पहुंचें।
...
- सहायता टिकट**: सशुल्क सहायता प्रणाली (प्रश्नों के उत्तर देने के लिए Satss प्राप्त करें)
...
- एसएमटीपी**: उपयोगकर्ताओं को ईमेल भेजने और संतुष्टि अर्जित करने में सक्षम बनाता है
...
इस Interface से हर एक्सटेंशन एक क्लिक से सक्रिय हो जाता है। "मुफ़्त" चिह्नित एक्सटेंशन मुफ़्त हैं, जबकि कुछ "भुगतान" संस्करणों के रूप में उपलब्ध हैं। अपनी ज़रूरतों के हिसाब से उपयुक्त एक्सटेंशन चुनने के लिए कैटलॉग देखें - चाहे वह व्यवसाय के लिए हो, पारिवारिक प्रबंधन के लिए हो, या Lightning Network की क्षमताओं के साथ प्रयोग करने के लिए हो।
...
**लाभ**: वित्तीय संप्रभुता (धन/कुंजी/डेटा पर पूर्ण नियंत्रण), वास्तुशिल्प लचीलापन (दोषरहित VPS→Full node माइग्रेशन), पेशेवर विस्तार प्रणाली, सहज Interface।
...
**बैकअप**: seed PHOENIXD/क्रेडेंशियल्स LND, LNbits डेटाबेस, `.env` फ़ाइलें। प्रतिदिन स्वचालित करें, प्रोडक्शन सर्वर से दूर रखें, एन्क्रिप्टेड। नियमित रूप से रीस्टोर का परीक्षण करें।
...
- [PHOENIXD गिटहब](https://github.com/ACINQ/PHOENIXD)
