...
Qui dovremo decidere che pool utilizzare. In questo tutorial vi mostrerò due opzioni. La prima è collegarci alla mining pool braiins che viene utilizzata anche dai miners professionali, come si vede da questa guida:
...
Ecco che si apre la finestra con le informazioni che ci servono per connettere il nostro mini miner alla pool. Qui l’ unica modifica che possiamo fare è quella di scegliere stratum v2. Per sapere che cosa sia Stratum v2 consulta questa voce:

https://planb.network/en/resources/glossary/stratum-v2
